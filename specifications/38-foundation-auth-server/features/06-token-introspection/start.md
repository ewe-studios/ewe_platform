...
this_file: "specifications/38-foundation-auth-server/features/06-token-introspection/start.md"
feature_name: "06-token-introspection"
created: 2026-06-05
---

# Start: Feature 06 — Token Introspection

## Workflow

1. Read `requirements.md` and `feature.md`
2. Read `.agents/skills/rust-clean-code/skill.md`
3. Create `backends/foundation_auth/src/shared/introspection.rs`
4. Update `shared/mod.rs`
