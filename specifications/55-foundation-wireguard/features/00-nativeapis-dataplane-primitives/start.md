...
this_file: "specifications/55-foundation-wireguard/features/00-nativeapis-dataplane-primitives/start.md"
feature_name: "00-nativeapis-dataplane-primitives"
created: 2026-07-12
updated: 2026-07-12
---

# Start: nativeapis Data-Plane Primitives (smoltcp netstack + kernel TUN)
...
3. Read the governing decisions: decisions 02, 14 (under `../../decisions/`). Do not re-open resolved
   decisions; proposed ones (12, 13) may be adjusted at review.
4. Retrieval first — read before writing: foundation_nativeapis/src/native/net/udp.rs; @formulas smoltcp/src; boringtun device/tun_linux.rs (reference).
