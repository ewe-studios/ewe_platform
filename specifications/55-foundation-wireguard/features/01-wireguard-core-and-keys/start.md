...
this_file: "specifications/55-foundation-wireguard/features/01-wireguard-core-and-keys/start.md"
feature_name: "01-wireguard-core-and-keys"
created: 2026-07-12
updated: 2026-07-12
---

# Start: WireGuard Core & Keys
...
3. Read the governing decisions: decisions 01, 03, 02 (under `../../decisions/`). Do not re-open resolved
   decisions; proposed ones (12, 13) may be adjusted at review.
4. Retrieval first — read before writing: @formulas boringtun/boringtun/src/noise/mod.rs (Tunn); foundation_core valtron task/future_task.
