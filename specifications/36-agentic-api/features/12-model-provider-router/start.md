...
feature_directory: "specifications/36-agentic-api/features/12-model-provider-router"
this_file: "specifications/36-agentic-api/features/12-model-provider-router/start.md"
created: 2026-06-14
---
...
3. Read `../../LEARNINGS.md`. Resolve OD-12-1..5. **OD-12-1 (erased surface reshapes Decision 18's
...
**Workflow:** feature.md → real ModelProvider/Model traits → object-safety → Resolve OD-12 (flag 1) → Compact → ONE ITEM → fundamentals → Report → Verify → 25
