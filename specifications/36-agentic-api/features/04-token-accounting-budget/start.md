...
feature_directory: "specifications/36-agentic-api/features/04-token-accounting-budget"
this_file: "specifications/36-agentic-api/features/04-token-accounting-budget/start.md"
created: 2026-06-14
---
...
4. Resolve OD-04-1..4 (folding, hard cap, rolling definition, persistence) before coding.
...
**Workflow:** feature.md → Decisions 02/03 → Rust skill → UsageReport grounding → Resolve OD-04 → Compact → ONE ITEM → Report → Verify → 04
