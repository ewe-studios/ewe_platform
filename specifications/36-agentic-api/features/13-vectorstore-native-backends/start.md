...
feature_directory: "specifications/36-agentic-api/features/13-vectorstore-native-backends"
this_file: "specifications/36-agentic-api/features/13-vectorstore-native-backends/start.md"
created: 2026-06-14
---
...
1. Read `feature.md` + Decision 07. Confirm F12 (trait) + F09 (IVF) landed.
...
4. Read `../../LEARNINGS.md`. Resolve OD-13-1..5.
...
8. Report; verify; update `../../LEARNINGS.md`; move to Feature 14.

---

**Workflow:** feature.md → research pass → Decision 07 → Resolve OD-13 → Compact → ONE BACKEND AT A TIME → fundamentals → Report → Verify → 14
