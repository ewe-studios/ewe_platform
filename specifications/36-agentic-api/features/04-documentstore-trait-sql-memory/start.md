...
feature_directory: "specifications/36-agentic-api/features/04-documentstore-trait-sql-memory"
this_file: "specifications/36-agentic-api/features/04-documentstore-trait-sql-memory/start.md"
created: 2026-06-14
---
...
4. Read `../../LEARNINGS.md`. Resolve OD-04-1..3 before coding.
...
7. Report; verify; update `../../LEARNINGS.md`; move to Feature 05.

---

**Workflow:** feature.md → Decisions 13/10b → existing DocumentStore → Resolve OD-04 → Compact → ONE ITEM → Report → Verify → 05
