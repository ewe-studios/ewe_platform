...
feature_directory: "specifications/34-native-file-watchers/features/02-valtron-watcher-task"
this_file: "specifications/34-native-file-watchers/features/02-valtron-watcher-task/start.md"
created: 2026-06-01
---

# Start: Valtron Watcher Task Feature
...
**Prerequisites:** Feature 01 (native-apis) must be complete — `NativeWatcher` trait and platform backends must exist.
