...
this_file: "specifications/55-foundation-wireguard/features/10-deployment-platform-integration/start.md"
feature_name: "10-deployment-platform-integration"
created: 2026-07-12
updated: 2026-07-12
---

# Start: Deployment-Platform Integration
...
3. Read the governing decisions: decisions 11, 04, 14 (under `../../decisions/`). Do not re-open resolved
   decisions; proposed ones (12, 13) may be adjusted at review.
4. Retrieval first — read before writing: foundation_deployment_platform/src/docker/config.rs (env); spec 53/54 docker testbed.
