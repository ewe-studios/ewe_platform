...
feature_directory: "specifications/36-agentic-api/features/23-documentstore-cloudflare"
this_file: "specifications/36-agentic-api/features/23-documentstore-cloudflare/start.md"
created: 2026-06-14
---
...
3. Confirm F06 landed (`scan_from_async` signature, doc_id=scru128, `020`/`021` schema).
4. Read `../../LEARNINGS.md`. Resolve OD-23-1..5 before coding.
...
**Workflow:** feature.md → Decision 13 → D1/KV bindings → Resolve OD-23 → Compact → ONE ITEM → Report → Verify → 07
