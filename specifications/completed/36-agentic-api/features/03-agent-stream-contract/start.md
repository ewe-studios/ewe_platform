...
feature_directory: "specifications/36-agentic-api/features/03-agent-stream-contract"
this_file: "specifications/36-agentic-api/features/03-agent-stream-contract/start.md"
created: 2026-06-14
---
...
4. Resolve OD-03-1 (SessionRecord vs Messages) before coding — it shapes the public type.
...
**Workflow:** feature.md → Decision 11 → valtron skills → Resolve OD-03-1 → Compact → ONE ITEM → Report → Verify → 03
