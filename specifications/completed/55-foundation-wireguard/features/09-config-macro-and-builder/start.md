...
this_file: "specifications/55-foundation-wireguard/features/09-config-macro-and-builder/start.md"
feature_name: "09-config-macro-and-builder"
created: 2026-07-12
updated: 2026-07-12
---

# Start: Config, wireguard! Macro & Builder
...
3. Read the governing decisions: decisions 13, 04, 12 (under `../../decisions/`). Do not re-open resolved
   decisions; proposed ones (12, 13) may be adjusted at review.
4. Retrieval first — read before writing: foundation_proxy config.rs/lib.rs; foundation_macros/src/proxy.rs.
