...
this_file: "specifications/55-foundation-wireguard/features/02-bootstrap-and-tls-psk-join/start.md"
feature_name: "02-bootstrap-and-tls-psk-join"
created: 2026-07-12
updated: 2026-07-12
---

# Start: Bootstrap & TLS-PSK Join
...
3. Read the governing decisions: decisions 04, 06, 03 (under `../../decisions/`). Do not re-open resolved
   decisions; proposed ones (12, 13) may be adjusted at review.
4. Retrieval first — read before writing: @formulas boring (BoringSSL PSK); foundation_connectrpc shared/native; @formulas boringtun serialization.rs (KeyBytes).
