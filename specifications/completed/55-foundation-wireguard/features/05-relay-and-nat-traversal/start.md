...
this_file: "specifications/55-foundation-wireguard/features/05-relay-and-nat-traversal/start.md"
feature_name: "05-relay-and-nat-traversal"
created: 2026-07-12
updated: 2026-07-12
---

# Start: Relay & NAT Traversal
...
3. Read the governing decisions: decisions 07, 05 (under `../../decisions/`). Do not re-open resolved
   decisions; proposed ones (12, 13) may be adjusted at review.
4. Retrieval first — read before writing: Tailscale DERP design; feature 04 connectivity ladder hook.
