...
this_file: "specifications/55-foundation-wireguard/features/07-wasm-browser-and-webrtc/start.md"
feature_name: "07-wasm-browser-and-webrtc"
created: 2026-07-12
updated: 2026-07-12
---

# Start: wasm/Browser & WebRTC
...
3. Read the governing decisions: decisions 08, 07, 09 (under `../../decisions/`). Do not re-open resolved
   decisions; proposed ones (12, 13) may be adjusted at review.
4. Retrieval first — read before writing: foundation_connectrpc F51 WebSocket; @formulas web-transport-wasm; features 04,05,06.
