...
feature_directory: "specifications/34-native-file-watchers/features/04-ipc-bus"
this_file: "specifications/34-native-file-watchers/features/04-ipc-bus/start.md"
created: 2026-06-01
---

# Start: Interprocess Message Bus (IPC) Feature

## Agent Workflow

1. Read `feature.md` (detailed requirements + tasks)
2. **Identify language stack** — **Rust** + **C (FFI header)**
...
**Prerequisites:** Feature 01 (native-apis) must be complete — the poll/selector layer is reused for IPC IO multiplexing.

**Reference source:** `/home/darkvoid/Boxxed/@formulas/src.rust/src.bytedance/ipmb` — adapt from ipmb's architecture.
