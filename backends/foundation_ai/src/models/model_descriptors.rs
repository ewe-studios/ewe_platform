...
pub fn model_descriptors() -> Vec<ModelProviderDescriptor> {
    vec![
        ...
        ModelProviderDescriptor {
            id: "gpt-5.3-chat-latest".to_string(),
            name: "GPT-5.3 Chat (latest)".to_string(),
            reasoning: false,
            api: ModelAPI::OpenAICompletions,
            provider: ModelProviders::OPENCODE,
            base_url: Some("https://opencode.ai/zen/v1".to_string()),
        ...
        ModelProviderDescriptor {
            ...
            name: "Google: Gemma 4 26B A4B  (free)".to_string(),
            reasoning: true,
            api: ModelAPI::OpenAICompletions,
            provider: ModelProviders::OPENROUTER,
            base_url: Some("https://openrouter.ai/api/v1".to_string()),
        ...
        ModelProviderDescriptor {
            ...
            name: "Google: Gemma 4 31B (free)".to_string(),
            reasoning: true,
            api: ModelAPI::OpenAICompletions,
            provider: ModelProviders::OPENROUTER,
            base_url: Some("https://openrouter.ai/api/v1".to_string()),
        ...
        ModelProviderDescriptor {
            ...
            cost: ModelUsageCosting {
                input: 0.118,
                output: 0.990_000_000_000_000_1,
                cache_read: 0.059,
                cache_write: 0.0,
            },
            context_window: 196_608,
        ...
        ModelProviderDescriptor {
            ...
            inputs: MessageType::TextAndImages,
            cost: ModelUsageCosting {
                input: 0.229_999_999_999_999_98,
                output: 2.3,
                cache_read: 0.199_999_999_999_999_98,
                cache_write: 0.0,
            },
        ...
        ModelProviderDescriptor {
            id: "alibaba/qwen3.6-plus".to_string(),
        ...
        ModelProviderDescriptor {
            id: "arcee-ai/trinity-large-thinking".to_string(),
            name: "Trinity Large Thinking".to_string(),
            reasoning: true,
            api: ModelAPI::AnthropicMessages,
            provider: ModelProviders::VERCELAIGATEWAY,
            base_url: Some("https://ai-gateway.vercel.sh".to_string()),
        ...
        ModelProviderDescriptor {
            id: "kwaipilot/kat-coder-pro-v2".to_string(),
            name: "Kat Coder Pro V2".to_string(),
            reasoning: true,
            api: ModelAPI::AnthropicMessages,
            provider: ModelProviders::VERCELAIGATEWAY,
            base_url: Some("https://ai-gateway.vercel.sh".to_string()),
