//! Auto-generated API module for docker _ping.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `docker_ping `
...
/// Arguments for [`SystemPing_request`].
#[derive(Debug, Clone, Default, Serialize, JsonHash)]
pub struct SystemPingArgs {
}
...
///
/// ```ignore
/// let response = system_ping_request(client.clone(), &args, Some(|b: &mut PreparedRequestBuilder| {
///     b.header("X-Custom-Header", "value");
/// })).await?;
/// ```
pub async fn system_ping_request<F>(
    client: DynNetClient,
    _args: &SystemPingArgs,
