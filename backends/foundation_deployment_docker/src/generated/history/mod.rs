//! Auto-generated API module for docker history.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `docker_history `
...
/// Arguments for [`ImageHistory_request`].
#[derive(Debug, Clone, Default, Serialize, JsonHash)]
pub struct ImageHistoryArgs {
    /// Path parameter: `name`.
    pub name: String,
...
///
/// ```ignore
/// let response = image_history_request(client.clone(), &args, Some(|b: &mut PreparedRequestBuilder| {
