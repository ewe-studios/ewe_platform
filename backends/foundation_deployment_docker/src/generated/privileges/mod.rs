//! Auto-generated API module for docker privileges.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `docker_privileges `
...
/// Arguments for [`GetPluginPrivileges_request`].
#[derive(Debug, Clone, Default, Serialize, JsonHash)]
pub struct GetPluginPrivilegesArgs {
...
///
/// ```ignore
/// let response = get_plugin_privileges_request(client.clone(), &args, Some(|b: &mut PreparedRequestBuilder| {
///     b.header("X-Custom-Header", "value");
/// })).await?;
/// ```
pub async fn get_plugin_privileges_request<F>(
    client: DynNetClient,
    args: &GetPluginPrivilegesArgs,
    ...
    F: FnOnce(&mut PreparedRequestBuilder),
{
    let endpoint_url = format!(
        "http://localhost/v1.53/plugins/privileges",
    );
