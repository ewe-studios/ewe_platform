//! Auto-generated API module for docker join.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `docker_join `
...
/// Arguments for [`SwarmJoin_request`].
#[derive(Debug, Clone, Default, Serialize, JsonHash)]
pub struct SwarmJoinArgs {
}
...
///
/// ```ignore
/// let response = swarm_join_request(client.clone(), &args, Some(|b: &mut PreparedRequestBuilder| {
///     b.header("X-Custom-Header", "value");
/// })).await?;
/// ```
pub async fn swarm_join_request<F>(
    client: DynNetClient,
    _args: &SwarmJoinArgs,
    ...
    F: FnOnce(&mut PreparedRequestBuilder),
{
    let endpoint_url = format!(
        "http://localhost/v1.53/swarm/join",
    );
