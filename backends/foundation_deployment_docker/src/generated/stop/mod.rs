//! Auto-generated API module for docker stop.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `docker_stop `
...
/// Arguments for [`ContainerStop_request`].
...
///
/// ```ignore
/// let response = container_stop_request(client.clone(), &args, Some(|b: &mut PreparedRequestBuilder| {
