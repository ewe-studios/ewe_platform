//! Auto-generated API module for docker init.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `docker_init `
...
/// Arguments for [`SwarmInit_request`].
#[derive(Debug, Clone, Default, Serialize, JsonHash)]
pub struct SwarmInitArgs {
}
...
///
/// ```ignore
/// let response = swarm_init_request(client.clone(), &args, Some(|b: &mut PreparedRequestBuilder| {
///     b.header("X-Custom-Header", "value");
/// })).await?;
/// ```
pub async fn swarm_init_request<F>(
    client: DynNetClient,
    _args: &SwarmInitArgs,
    ...
    F: FnOnce(&mut PreparedRequestBuilder),
{
    let endpoint_url = format!(
        "http://localhost/v1.53/swarm/init",
    );
