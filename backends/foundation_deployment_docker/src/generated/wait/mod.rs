//! Auto-generated API module for docker wait.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `docker_wait `
...
/// Arguments for [`ContainerWait_request`].
#[derive(Debug, Clone, Default, Serialize, JsonHash)]
pub struct ContainerWaitArgs {
    /// Path parameter: `id`.
    pub id: String,
...
///
/// ```ignore
/// let response = container_wait_request(client.clone(), &args, Some(|b: &mut PreparedRequestBuilder| {
    ...
    F: FnOnce(&mut PreparedRequestBuilder),
{
    ...
    builder = builder.query("condition", args.condition.as_deref());
    ...
    let parsed: ContainerWaitResponse = serde_json::from_slice(&body_bytes).map_err(|e: serde_json::Error| super::shared::ApiError::ParseFailed(e.to_string()))?;
