//! Auto-generated API module for docker archive.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `docker_archive `
...
/// Arguments for [`ContainerArchive_request`].
#[derive(Debug, Clone, Default, Serialize, JsonHash)]
pub struct ContainerArchiveArgs {
    /// Path parameter: `id`.
    pub id: String,
...
/// Arguments for [`PutContainerArchive_request`].
#[derive(Debug, Clone, Default, Serialize, JsonHash)]
pub struct PutContainerArchiveArgs {
    /// Path parameter: `id`.
    pub id: String,
    /// Query parameter: `path`.
    pub path: Option<String>,
    /// Query parameter: `noOverwriteDirNonDir`.
    pub no_overwrite_dir_non_dir: Option<String>,
    /// Query parameter: `copyUIDGID`.
...
///
/// ```ignore
/// let response = container_archive_request(client.clone(), &args, Some(|b: &mut PreparedRequestBuilder| {
    ...
    F: FnOnce(&mut PreparedRequestBuilder),
{
    ...
    builder = builder.query("path", args.path.as_deref());
...
///
/// ```ignore
/// let response = put_container_archive_request(client.clone(), &args, Some(|b: &mut PreparedRequestBuilder| {
///     b.header("X-Custom-Header", "value");
/// })).await?;
/// ```
    ...
    F: FnOnce(&mut PreparedRequestBuilder),
{
    ...
    builder = builder.query("path", args.path.as_deref());
    builder = builder.query("noOverwriteDirNonDir", args.no_overwrite_dir_non_dir.as_deref());
    builder = builder.query("copyUIDGID", args.copy_uidgid.as_deref());
