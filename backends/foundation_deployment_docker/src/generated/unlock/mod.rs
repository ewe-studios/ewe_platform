//! Auto-generated API module for docker unlock.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `docker_unlock `
...
/// Arguments for [`SwarmUnlock_request`].
#[derive(Debug, Clone, Default, Serialize, JsonHash)]
pub struct SwarmUnlockArgs {
}
...
///
/// ```ignore
/// let response = swarm_unlock_request(client.clone(), &args, Some(|b: &mut PreparedRequestBuilder| {
///     b.header("X-Custom-Header", "value");
/// })).await?;
/// ```
pub async fn swarm_unlock_request<F>(
    client: DynNetClient,
    _args: &SwarmUnlockArgs,
    ...
    F: FnOnce(&mut PreparedRequestBuilder),
{
    let endpoint_url = format!(
        "http://localhost/v1.53/swarm/unlock",
    );
