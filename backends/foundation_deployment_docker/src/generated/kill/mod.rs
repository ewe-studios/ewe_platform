//! Auto-generated API module for docker kill.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `docker_kill `
...
/// Arguments for [`ContainerKill_request`].
#[derive(Debug, Clone, Default, Serialize, JsonHash)]
pub struct ContainerKillArgs {
    /// Path parameter: `id`.
    pub id: String,
...
///
/// ```ignore
/// let response = container_kill_request(client.clone(), &args, Some(|b: &mut PreparedRequestBuilder| {
///     b.header("X-Custom-Header", "value");
/// })).await?;
/// ```
pub async fn container_kill_request<F>(
    client: DynNetClient,
    args: &ContainerKillArgs,
    ...
    F: FnOnce(&mut PreparedRequestBuilder),
{
    let endpoint_url = format!(
        "http://localhost/v1.53/containers/{}/kill",
        args.id,
    );
