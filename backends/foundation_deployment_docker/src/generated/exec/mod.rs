//! Auto-generated API module for docker exec.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `docker_exec `
...
/// Arguments for [`ContainerExec_request`].
...
///
/// ```ignore
/// let response = container_exec_request(client.clone(), &args, Some(|b: &mut PreparedRequestBuilder| {
