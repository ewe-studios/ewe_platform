//! Auto-generated API module for docker pull.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `docker_pull `
...
/// Arguments for [`PluginPull_request`].
#[derive(Debug, Clone, Default, Serialize, JsonHash)]
pub struct PluginPullArgs {
...
///
/// ```ignore
/// let response = plugin_pull_request(client.clone(), &args, Some(|b: &mut PreparedRequestBuilder| {
