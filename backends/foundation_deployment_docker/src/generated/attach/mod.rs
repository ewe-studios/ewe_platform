//! Auto-generated API module for docker attach.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `docker_attach `
...
/// Arguments for [`ContainerAttach_request`].
...
///
/// ```ignore
/// let response = container_attach_request(client.clone(), &args, Some(|b: &mut PreparedRequestBuilder| {
///     b.header("X-Custom-Header", "value");
/// })).await?;
/// ```
pub async fn container_attach_request<F>(
    client: DynNetClient,
    args: &ContainerAttachArgs,
    ...
    F: FnOnce(&mut PreparedRequestBuilder),
{
    let endpoint_url = format!(
        "http://localhost/v1.53/containers/{}/attach",
        args.id,
    );
