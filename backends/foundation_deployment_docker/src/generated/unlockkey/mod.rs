//! Auto-generated API module for docker unlockkey.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `docker_unlockkey `
...
/// Arguments for [`SwarmUnlockkey_request`].
#[derive(Debug, Clone, Default, Serialize, JsonHash)]
pub struct SwarmUnlockkeyArgs {
}
...
///
/// ```ignore
/// let response = swarm_unlockkey_request(client.clone(), &args, Some(|b: &mut PreparedRequestBuilder| {
///     b.header("X-Custom-Header", "value");
/// })).await?;
/// ```
pub async fn swarm_unlockkey_request<F>(
    client: DynNetClient,
    _args: &SwarmUnlockkeyArgs,
    ...
    F: FnOnce(&mut PreparedRequestBuilder),
{
    let endpoint_url = format!(
        "http://localhost/v1.53/swarm/unlockkey",
    );
