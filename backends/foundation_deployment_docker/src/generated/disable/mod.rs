//! Auto-generated API module for docker disable.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `docker_disable `
...
/// Arguments for [`PluginDisable_request`].
...
///
/// ```ignore
/// let response = plugin_disable_request(client.clone(), &args, Some(|b: &mut PreparedRequestBuilder| {
