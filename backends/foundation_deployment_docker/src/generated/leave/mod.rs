//! Auto-generated API module for docker leave.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `docker_leave `
...
/// Arguments for [`SwarmLeave_request`].
#[derive(Debug, Clone, Default, Serialize, JsonHash)]
pub struct SwarmLeaveArgs {
...
///
/// ```ignore
/// let response = swarm_leave_request(client.clone(), &args, Some(|b: &mut PreparedRequestBuilder| {
