//! Auto-generated API module for supabase merge.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `supabase_merge `
...
///
/// ```ignore
/// let task = v1_merge_a_branch_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn v1_merge_a_branch_request<R, F>(
