//! Auto-generated API module for prisma_postgres promote.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `prisma_postgres_promote `
...
/// `ComputeservicesPromotePostResponse` type.
#[derive(Debug, Clone, Serialize, Deserialize, JsonHash)]
...
/// `ComputeservicesPromotePostRequest` type.
#[derive(Debug, Clone, Serialize, Deserialize, JsonHash)]
...
/// Arguments for [`postV1Compute-servicesByComputeServiceIdPromote_builder`].
...
///
/// ```ignore
/// let task = post_v1_compute_services_by_compute_service_id_promote_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_v1_compute_services_by_compute_service_id_promote_request<R, F>(
    ...
    impl TaskIterator<
            Ready = Result<
                ApiResponse<ComputeservicesPromotePostResponse>,
