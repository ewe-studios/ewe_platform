//! Auto-generated API module for prisma_postgres transfer.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `prisma_postgres_transfer `
...
/// `ProjectsTransferPostRequest` type.
#[derive(Debug, Clone, Serialize, Deserialize, JsonHash)]
pub struct ProjectsTransferPostRequest {
    /// recipientAccessToken property.
...
/// Arguments for [`postV1ProjectsByIdTransfer_builder`].
...
///
/// ```ignore
/// let task = post_v1_projects_by_id_transfer_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_v1_projects_by_id_transfer_request<R, F>(
...
{
    let endpoint_url = format!("https://api.prisma.io/v1/projects/{}/transfer", args.id,);
