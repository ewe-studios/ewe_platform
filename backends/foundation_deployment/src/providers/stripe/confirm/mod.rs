//! Auto-generated API module for stripe confirm.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_confirm `
...
///
/// ```ignore
/// let task = post_setup_intents_intent_confirm_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_setup_intents_intent_confirm_request<R, F>(
