//! Auto-generated API module for stripe scheduled_query_runs.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_scheduled_query_runs `
...
///
/// ```ignore
/// let task = get_sigma_scheduled_query_runs_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_sigma_scheduled_query_runs_request<R, F>(
...
///
/// ```ignore
/// let task = get_sigma_scheduled_query_runs_scheduled_query_run_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_sigma_scheduled_query_runs_scheduled_query_run_request<R, F>(
    client: &SimpleHttpClient<R>,
    args: &GetSigmaScheduledQueryRunsScheduledQueryRunArgs,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<ApiResponse<ScheduledQueryRun>, super::shared::ApiError>,
            Pending = super::shared::ApiPending,
            Spawner = super::shared::BoxedSendExecutionAction,
        > + Send
        + 'static,
