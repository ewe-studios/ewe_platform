//! Auto-generated API module for stripe activate.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_activate `
...
///
/// ```ignore
/// let task = post_billing_alerts_id_activate_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_billing_alerts_id_activate_request<R, F>(
...
///
/// ```ignore
/// let task = post_test_helpers_issuing_personalization_designs_personalization_design_activate_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_test_helpers_issuing_personalization_designs_personalization_design_activate_request<
    R,
    F,
>(
    client: &SimpleHttpClient<R>,
