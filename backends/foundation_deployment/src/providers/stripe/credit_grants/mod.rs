//! Auto-generated API module for stripe credit_grants.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_credit_grants `
...
///
/// ```ignore
/// let task = get_billing_credit_grants_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_billing_credit_grants_request<R, F>(
...
///
/// ```ignore
/// let task = post_billing_credit_grants_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_billing_credit_grants_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
...
///
/// ```ignore
/// let task = get_billing_credit_grants_id_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_billing_credit_grants_id_request<R, F>(
    client: &SimpleHttpClient<R>,
...
///
/// ```ignore
/// let task = post_billing_credit_grants_id_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_billing_credit_grants_id_request<R, F>(
    client: &SimpleHttpClient<R>,
