//! Auto-generated API module for stripe complete.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_complete `
...
///
/// ```ignore
/// let task = post_test_helpers_issuing_settlements_settlement_complete_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_test_helpers_issuing_settlements_settlement_complete_request<R, F>(
