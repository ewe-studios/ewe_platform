//! Auto-generated API module for stripe ephemeral_keys.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_ephemeral_keys `
...
///
/// ```ignore
/// let task = post_ephemeral_keys_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_ephemeral_keys_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<ApiResponse<EphemeralKey>, super::shared::ApiError>,
...
{
    let endpoint_url = format!("https://api.stripe.com//v1/ephemeral_keys",);
...
///
/// ```ignore
/// let task = delete_ephemeral_keys_key_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn delete_ephemeral_keys_key_request<R, F>(
    client: &SimpleHttpClient<R>,
...
where
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!("https://api.stripe.com//v1/ephemeral_keys/{}", args.key,);
