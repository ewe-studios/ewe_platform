//! Auto-generated API module for stripe verify_microdeposits.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_verify_microdeposits `
...
///
/// ```ignore
/// let task = post_setup_intents_intent_verify_microdeposits_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_setup_intents_intent_verify_microdeposits_request<R, F>(
