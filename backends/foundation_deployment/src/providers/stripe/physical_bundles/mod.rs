//! Auto-generated API module for stripe physical_bundles.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_physical_bundles `
...
///
/// ```ignore
/// let task = get_issuing_physical_bundles_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_issuing_physical_bundles_request<R, F>(
...
///
/// ```ignore
/// let task = get_issuing_physical_bundles_physical_bundle_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_issuing_physical_bundles_physical_bundle_request<R, F>(
    client: &SimpleHttpClient<R>,
    args: &GetIssuingPhysicalBundlesPhysicalBundleArgs,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<ApiResponse<IssuingPhysicalBundle>, super::shared::ApiError>,
            Pending = super::shared::ApiPending,
            Spawner = super::shared::BoxedSendExecutionAction,
        > + Send
        + 'static,
    ...
    Ok(builder
        ...
        .map_ready(|intro| match intro {
            super::shared::RequestIntro::Success {
                ...
                let parsed: IssuingPhysicalBundle =
