//! Auto-generated API module for stripe settlements.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_settlements `
...
use super::shared::IssuingSettlement;
...
///
/// ```ignore
/// let task = get_issuing_settlements_settlement_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_issuing_settlements_settlement_request<R, F>(
    client: &SimpleHttpClient<R>,
    args: &GetIssuingSettlementsSettlementArgs,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<ApiResponse<IssuingSettlement>, super::shared::ApiError>,
...
///
/// ```ignore
/// let task = post_issuing_settlements_settlement_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_issuing_settlements_settlement_request<R, F>(
    client: &SimpleHttpClient<R>,
...
///
/// ```ignore
/// let task = post_test_helpers_issuing_settlements_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_test_helpers_issuing_settlements_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
...
where
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!("https://api.stripe.com//v1/test_helpers/issuing/settlements",);
