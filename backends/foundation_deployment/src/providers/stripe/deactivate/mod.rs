//! Auto-generated API module for stripe deactivate.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_deactivate `
...
///
/// ```ignore
/// let task = post_billing_alerts_id_deactivate_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_billing_alerts_id_deactivate_request<R, F>(
...
///
/// ```ignore
/// let task = post_billing_meters_id_deactivate_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_billing_meters_id_deactivate_request<R, F>(
    client: &SimpleHttpClient<R>,
    args: &PostBillingMetersIdDeactivateArgs,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<ApiResponse<BillingMeter>, super::shared::ApiError>,
            Pending = super::shared::ApiPending,
            Spawner = super::shared::BoxedSendExecutionAction,
        > + Send
        + 'static,
...
///
/// ```ignore
/// let task = post_test_helpers_issuing_personalization_designs_personalization_design_deactivate_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_test_helpers_issuing_personalization_designs_personalization_design_deactivate_request<
    R,
    F,
>(
    client: &SimpleHttpClient<R>,
