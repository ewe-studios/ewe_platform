//! Auto-generated API module for stripe setup_attempts.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_setup_attempts `
...
///
/// ```ignore
/// let task = get_setup_attempts_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_setup_attempts_request<R, F>(
