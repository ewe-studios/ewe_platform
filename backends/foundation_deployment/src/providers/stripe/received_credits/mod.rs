//! Auto-generated API module for stripe received_credits.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_received_credits `
...
///
/// ```ignore
/// let task = post_test_helpers_treasury_received_credits_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_test_helpers_treasury_received_credits_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<ApiResponse<TreasuryReceivedCredit>, super::shared::ApiError>,
...
{
    let endpoint_url =
        format!("https://api.stripe.com//v1/test_helpers/treasury/received_credits",);
    ...
    Ok(builder
        ...
        .map_ready(|intro| match intro {
            super::shared::RequestIntro::Success {
                ...
                let parsed: TreasuryReceivedCredit =
...
///
/// ```ignore
/// let task = get_treasury_received_credits_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_treasury_received_credits_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
...
///
/// ```ignore
/// let task = get_treasury_received_credits_id_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_treasury_received_credits_id_request<R, F>(
    client: &SimpleHttpClient<R>,
