//! Auto-generated API module for stripe promotion_codes.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_promotion_codes `
...
///
/// ```ignore
/// let task = get_promotion_codes_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_promotion_codes_request<R, F>(
...
///
/// ```ignore
/// let task = post_promotion_codes_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_promotion_codes_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<ApiResponse<PromotionCode>, super::shared::ApiError>,
            Pending = super::shared::ApiPending,
            Spawner = super::shared::BoxedSendExecutionAction,
        > + Send
        + 'static,
...
///
/// ```ignore
/// let task = get_promotion_codes_promotion_code_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_promotion_codes_promotion_code_request<R, F>(
    client: &SimpleHttpClient<R>,
...
///
/// ```ignore
/// let task = post_promotion_codes_promotion_code_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_promotion_codes_promotion_code_request<R, F>(
    client: &SimpleHttpClient<R>,
