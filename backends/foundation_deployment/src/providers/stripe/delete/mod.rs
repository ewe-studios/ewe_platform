//! Auto-generated API module for stripe delete.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_delete `
...
///
/// ```ignore
/// let task = post_apps_secrets_delete_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_apps_secrets_delete_request<R, F>(
