//! Auto-generated API module for stripe mandates.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_mandates `
...
///
/// ```ignore
/// let task = get_mandates_mandate_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_mandates_mandate_request<R, F>(
    client: &SimpleHttpClient<R>,
    args: &GetMandatesMandateArgs,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<ApiResponse<Mandate>, super::shared::ApiError>,
...
{
    let endpoint_url = format!("https://api.stripe.com//v1/mandates/{}", args.mandate,);
