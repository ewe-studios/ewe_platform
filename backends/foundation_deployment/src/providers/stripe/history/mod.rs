//! Auto-generated API module for stripe history.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_history `
...
///
/// ```ignore
/// let task = get_balance_history_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_balance_history_request<R, F>(
...
///
/// ```ignore
/// let task = get_balance_history_id_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_balance_history_id_request<R, F>(
    client: &SimpleHttpClient<R>,
...
where
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!("https://api.stripe.com//v1/balance/history/{}", args.id,);
