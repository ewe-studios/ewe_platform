//! Auto-generated API module for stripe expire.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_expire `
...
///
/// ```ignore
/// let task = post_billing_credit_grants_id_expire_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_billing_credit_grants_id_expire_request<R, F>(
...
///
/// ```ignore
/// let task = post_test_helpers_issuing_authorizations_authorization_expire_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_test_helpers_issuing_authorizations_authorization_expire_request<R, F>(
    client: &SimpleHttpClient<R>,
