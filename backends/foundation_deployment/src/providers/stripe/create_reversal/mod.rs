//! Auto-generated API module for stripe create_reversal.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_create_reversal `
...
///
/// ```ignore
/// let task = post_tax_transactions_create_reversal_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_tax_transactions_create_reversal_request<R, F>(
