//! Auto-generated API module for stripe balance_transactions.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_balance_transactions `
...
use super::shared::BalanceTransaction;
...
///
/// ```ignore
/// let task = get_balance_transactions_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_balance_transactions_request<R, F>(
...
///
/// ```ignore
/// let task = get_balance_transactions_id_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_balance_transactions_id_request<R, F>(
    client: &SimpleHttpClient<R>,
    args: &GetBalanceTransactionsIdArgs,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<ApiResponse<BalanceTransaction>, super::shared::ApiError>,
            Pending = super::shared::ApiPending,
            Spawner = super::shared::BoxedSendExecutionAction,
        > + Send
        + 'static,
