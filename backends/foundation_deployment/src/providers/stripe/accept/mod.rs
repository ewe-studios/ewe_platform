//! Auto-generated API module for stripe accept.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_accept `
...
///
/// ```ignore
/// let task = post_quotes_quote_accept_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_quotes_quote_accept_request<R, F>(
...
{
    let endpoint_url = format!("https://api.stripe.com//v1/quotes/{}/accept", args.quote,);
