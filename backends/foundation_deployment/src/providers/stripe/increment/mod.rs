//! Auto-generated API module for stripe increment.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_increment `
...
///
/// ```ignore
/// let task = post_test_helpers_issuing_authorizations_authorization_increment_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_test_helpers_issuing_authorizations_authorization_increment_request<R, F>(
