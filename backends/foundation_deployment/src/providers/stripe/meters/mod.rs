//! Auto-generated API module for stripe meters.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_meters `
...
///
/// ```ignore
/// let task = get_billing_meters_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_billing_meters_request<R, F>(
...
///
/// ```ignore
/// let task = post_billing_meters_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_billing_meters_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
...
///
/// ```ignore
/// let task = get_billing_meters_id_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_billing_meters_id_request<R, F>(
    client: &SimpleHttpClient<R>,
...
where
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!("https://api.stripe.com//v1/billing/meters/{}", args.id,);
...
///
/// ```ignore
/// let task = post_billing_meters_id_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_billing_meters_id_request<R, F>(
    client: &SimpleHttpClient<R>,
