...
use super::shared::ClimateOrder;
use super::shared::Quote;
use super::shared::SetupIntent;
...
///
/// ```ignore
/// let task = post_climate_orders_order_cancel_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_climate_orders_order_cancel_request<R, F>(
    client: &SimpleHttpClient<R>,
    args: &PostClimateOrdersOrderCancelArgs,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<ApiResponse<ClimateOrder>, super::shared::ApiError>,
...
///
/// ```ignore
/// let task = post_quotes_quote_cancel_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_quotes_quote_cancel_request<R, F>(
    client: &SimpleHttpClient<R>,
    args: &PostQuotesQuoteCancelArgs,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<ApiResponse<Quote>, super::shared::ApiError>,
            Pending = super::shared::ApiPending,
            Spawner = super::shared::BoxedSendExecutionAction,
        > + Send
        + 'static,
...
where
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!("https://api.stripe.com//v1/quotes/{}/cancel", args.quote,);
...
///
/// ```ignore
/// let task = post_setup_intents_intent_cancel_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_setup_intents_intent_cancel_request<R, F>(
    client: &SimpleHttpClient<R>,
    args: &PostSetupIntentsIntentCancelArgs,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<ApiResponse<SetupIntent>, super::shared::ApiError>,
            Pending = super::shared::ApiPending,
            Spawner = super::shared::BoxedSendExecutionAction,
        > + Send
        + 'static,
...
///
/// ```ignore
/// let task = post_topups_topup_cancel_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_topups_topup_cancel_request<R, F>(
    client: &SimpleHttpClient<R>,
...
where
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!("https://api.stripe.com//v1/topups/{}/cancel", args.topup,);
