//! Auto-generated API module for stripe finalize.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_finalize `
...
///
/// ```ignore
/// let task = post_quotes_quote_finalize_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_quotes_quote_finalize_request<R, F>(
...
{
    let endpoint_url = format!("https://api.stripe.com//v1/quotes/{}/finalize", args.quote,);
