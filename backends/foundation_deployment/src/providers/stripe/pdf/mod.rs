//! Auto-generated API module for stripe pdf.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_pdf `
...
///
/// ```ignore
/// let task = get_quotes_quote_pdf_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_quotes_quote_pdf_request<R, F>(
...
{
    let endpoint_url = format!("https://api.stripe.com//v1/quotes/{}/pdf", args.quote,);
