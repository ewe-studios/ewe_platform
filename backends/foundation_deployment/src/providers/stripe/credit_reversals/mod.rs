//! Auto-generated API module for stripe credit_reversals.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_credit_reversals `
...
///
/// ```ignore
/// let task = get_treasury_credit_reversals_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_treasury_credit_reversals_request<R, F>(
...
///
/// ```ignore
/// let task = post_treasury_credit_reversals_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_treasury_credit_reversals_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<ApiResponse<TreasuryCreditReversal>, super::shared::ApiError>,
            Pending = super::shared::ApiPending,
            Spawner = super::shared::BoxedSendExecutionAction,
        > + Send
        + 'static,
    ...
    Ok(builder
        ...
        .map_ready(|intro| match intro {
            super::shared::RequestIntro::Success {
                ...
                let parsed: TreasuryCreditReversal =
...
///
/// ```ignore
/// let task = get_treasury_credit_reversals_credit_reversal_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_treasury_credit_reversals_credit_reversal_request<R, F>(
    client: &SimpleHttpClient<R>,
