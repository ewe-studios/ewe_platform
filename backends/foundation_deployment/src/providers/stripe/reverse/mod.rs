//! Auto-generated API module for stripe reverse.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_reverse `
...
///
/// ```ignore
/// let task = post_test_helpers_issuing_authorizations_authorization_reverse_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_test_helpers_issuing_authorizations_authorization_reverse_request<R, F>(
