//! Auto-generated API module for stripe country_specs.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_country_specs `
...
///
/// ```ignore
/// let task = get_country_specs_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_country_specs_request<R, F>(
...
///
/// ```ignore
/// let task = get_country_specs_country_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_country_specs_country_request<R, F>(
    client: &SimpleHttpClient<R>,
    args: &GetCountrySpecsCountryArgs,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<ApiResponse<CountrySpec>, super::shared::ApiError>,
            Pending = super::shared::ApiPending,
            Spawner = super::shared::BoxedSendExecutionAction,
        > + Send
        + 'static,
...
where
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!("https://api.stripe.com//v1/country_specs/{}", args.country,);
