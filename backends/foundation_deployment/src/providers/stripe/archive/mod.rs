//! Auto-generated API module for stripe archive.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_archive `
...
///
/// ```ignore
/// let task = post_billing_alerts_id_archive_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_billing_alerts_id_archive_request<R, F>(
