//! Auto-generated API module for stripe confirmation_tokens.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_confirmation_tokens `
...
///
/// ```ignore
/// let task = get_confirmation_tokens_confirmation_token_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_confirmation_tokens_confirmation_token_request<R, F>(
    client: &SimpleHttpClient<R>,
    args: &GetConfirmationTokensConfirmationTokenArgs,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<ApiResponse<ConfirmationToken>, super::shared::ApiError>,
...
///
/// ```ignore
/// let task = post_test_helpers_confirmation_tokens_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_test_helpers_confirmation_tokens_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
