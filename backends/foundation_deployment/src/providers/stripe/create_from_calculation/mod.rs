//! Auto-generated API module for stripe create_from_calculation.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_create_from_calculation `
...
///
/// ```ignore
/// let task = post_tax_transactions_create_from_calculation_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_tax_transactions_create_from_calculation_request<R, F>(
