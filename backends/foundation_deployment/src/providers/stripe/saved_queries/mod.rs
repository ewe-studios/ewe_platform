//! Auto-generated API module for stripe saved_queries.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `stripe_saved_queries `
...
///
/// ```ignore
/// let task = post_sigma_saved_queries_id_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn post_sigma_saved_queries_id_request<R, F>(
    client: &SimpleHttpClient<R>,
    args: &PostSigmaSavedQueriesIdArgs,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<ApiResponse<SigmaSigmaApiQuery>, super::shared::ApiError>,
...
{
    let endpoint_url = format!("https://api.stripe.com//v1/sigma/saved_queries/{}", args.id,);
