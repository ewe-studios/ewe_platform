//! Auto-generated API module for fly_io kms.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `fly_io_kms `
...
///
/// ```ignore
/// let task = tokens_request_kms_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn tokens_request_kms_request<R, F>(
