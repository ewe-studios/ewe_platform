//! Auto-generated API module for gcp/accesscontextmanager servicePerimeters:replaceAll.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_accesscontextmanager_service_perimeters_replace_all `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://accesscontextmanager.googleapis.com/v1/accessPolicies/{{accessPoliciesId}}/servicePerimeters:replaceAll",
    );
