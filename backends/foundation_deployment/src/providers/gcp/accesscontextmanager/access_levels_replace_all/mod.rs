//! Auto-generated API module for gcp/accesscontextmanager accessLevels:replaceAll.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_accesscontextmanager_access_levels_replace_all `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://accesscontextmanager.googleapis.com/v1/accessPolicies/{{accessPoliciesId}}/accessLevels:replaceAll",
    );
