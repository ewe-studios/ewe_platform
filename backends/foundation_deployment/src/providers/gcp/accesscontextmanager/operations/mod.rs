//! Auto-generated API module for gcp/accesscontextmanager operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_accesscontextmanager_operations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://accesscontextmanager.googleapis.com/v1/operations/{{operationsId}}:cancel",
    );
...
{
    let endpoint_url =
        format!("https://accesscontextmanager.googleapis.com/v1/operations/{{operationsId}}",);
