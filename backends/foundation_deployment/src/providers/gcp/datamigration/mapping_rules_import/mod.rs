//! Auto-generated API module for gcp/datamigration mappingRules:import.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_datamigration_mapping_rules_import `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://datamigration.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/conversionWorkspaces/{{conversionWorkspacesId}}/mappingRules:import",
    );
