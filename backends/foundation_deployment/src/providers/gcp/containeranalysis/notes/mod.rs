//! Auto-generated API module for gcp/containeranalysis notes.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_containeranalysis_notes `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://containeranalysis.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/notes",
    );
...
{
    let endpoint_url = format!(
        "https://containeranalysis.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/notes/{{notesId}}",
    );
...
{
    let endpoint_url = format!(
        "https://containeranalysis.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/notes/{{notesId}}:getIamPolicy",
    );
...
{
    let endpoint_url = format!(
        "https://containeranalysis.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/notes/{{notesId}}:setIamPolicy",
    );
...
{
    let endpoint_url = format!(
        "https://containeranalysis.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/notes/{{notesId}}:testIamPermissions",
    );
...
{
    let endpoint_url = format!(
        "https://containeranalysis.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/occurrences/{{occurrencesId}}/notes",
    );
...
{
    let endpoint_url =
        format!("https://containeranalysis.googleapis.com/v1/projects/{{projectsId}}/notes",);
...
{
    let endpoint_url = format!(
        "https://containeranalysis.googleapis.com/v1/projects/{{projectsId}}/notes/{{notesId}}",
    );
...
{
    let endpoint_url = format!(
        "https://containeranalysis.googleapis.com/v1/projects/{{projectsId}}/notes/{{notesId}}:getIamPolicy",
    );
...
{
    let endpoint_url = format!(
        "https://containeranalysis.googleapis.com/v1/projects/{{projectsId}}/notes/{{notesId}}:setIamPolicy",
    );
...
{
    let endpoint_url = format!(
        "https://containeranalysis.googleapis.com/v1/projects/{{projectsId}}/notes/{{notesId}}:testIamPermissions",
    );
...
{
    let endpoint_url = format!(
        "https://containeranalysis.googleapis.com/v1/projects/{{projectsId}}/occurrences/{{occurrencesId}}/notes",
    );
