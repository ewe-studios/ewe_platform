//! Auto-generated API module for gcp/ces tools.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_ces_tools `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://ces.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/apps/{{appsId}}/tools",
    );
...
{
    let endpoint_url = format!(
        "https://ces.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/apps/{{appsId}}/tools/{{toolsId}}",
    );
