//! Auto-generated API module for gcp/ces conversations:batchDelete.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_ces_conversations_batch_delete `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://ces.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/apps/{{appsId}}/conversations:batchDelete",
    );
