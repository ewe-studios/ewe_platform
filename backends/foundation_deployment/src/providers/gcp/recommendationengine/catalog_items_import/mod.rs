//! Auto-generated API module for gcp/recommendationengine catalogItems:import.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_recommendationengine_catalog_items_import `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://recommendationengine.googleapis.com/v1beta1/projects/{{projectsId}}/locations/{{locationsId}}/catalogs/{{catalogsId}}/catalogItems:import",
    );
