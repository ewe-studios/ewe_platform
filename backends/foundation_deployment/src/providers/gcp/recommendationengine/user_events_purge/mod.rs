//! Auto-generated API module for gcp/recommendationengine userEvents:purge.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_recommendationengine_user_events_purge `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://recommendationengine.googleapis.com/v1beta1/projects/{{projectsId}}/locations/{{locationsId}}/catalogs/{{catalogsId}}/eventStores/{{eventStoresId}}/userEvents:purge",
    );
