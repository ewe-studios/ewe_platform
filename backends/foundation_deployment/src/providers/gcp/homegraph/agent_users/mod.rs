//! Auto-generated API module for gcp/homegraph agentUsers.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_homegraph_agent_users `
...
{
    let endpoint_url = format!("https://homegraph.googleapis.com/v1/agentUsers/{{agentUsersId}}",);
