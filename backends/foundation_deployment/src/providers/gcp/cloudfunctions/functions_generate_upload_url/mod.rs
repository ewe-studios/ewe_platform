//! Auto-generated API module for gcp/cloudfunctions functions:generateUploadUrl.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_cloudfunctions_functions_generate_upload_url `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://cloudfunctions.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/functions:generateUploadUrl",
    );
