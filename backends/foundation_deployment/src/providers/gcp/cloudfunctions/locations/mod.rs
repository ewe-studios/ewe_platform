//! Auto-generated API module for gcp/cloudfunctions locations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_cloudfunctions_locations `
...
{
    let endpoint_url =
        format!("https://cloudfunctions.googleapis.com/v2/projects/{{projectsId}}/locations",);
