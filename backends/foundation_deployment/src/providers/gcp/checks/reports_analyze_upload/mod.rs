//! Auto-generated API module for gcp/checks reports:analyzeUpload.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_checks_reports_analyze_upload `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://checks.googleapis.com/v1alpha/accounts/{{accountsId}}/apps/{{appsId}}/reports:analyzeUpload",
    );
