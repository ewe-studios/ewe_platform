//! Auto-generated API module for gcp/checks scans:generate.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_checks_scans_generate `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://checks.googleapis.com/v1alpha/accounts/{{accountsId}}/repos/{{reposId}}/scans:generate",
    );
