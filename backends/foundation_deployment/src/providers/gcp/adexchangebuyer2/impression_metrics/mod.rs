//! Auto-generated API module for gcp/adexchangebuyer2 impressionMetrics.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_adexchangebuyer2_impression_metrics `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://adexchangebuyer.googleapis.com/v2beta1/bidders/{{biddersId}}/accounts/{{accountsId}}/filterSets/{{filterSetsId}}/impressionMetrics",
    );
...
{
    let endpoint_url = format!(
        "https://adexchangebuyer.googleapis.com/v2beta1/bidders/{{biddersId}}/filterSets/{{filterSetsId}}/impressionMetrics",
    );
...
{
    let endpoint_url = format!(
        "https://adexchangebuyer.googleapis.com/v2beta1/buyers/{{buyersId}}/filterSets/{{filterSetsId}}/impressionMetrics",
    );
