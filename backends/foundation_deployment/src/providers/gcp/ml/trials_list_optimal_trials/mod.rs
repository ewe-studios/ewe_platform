//! Auto-generated API module for gcp/ml trials:listOptimalTrials.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_ml_trials_list_optimal_trials `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://ml.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/studies/{{studiesId}}/trials:listOptimalTrials",
    );
