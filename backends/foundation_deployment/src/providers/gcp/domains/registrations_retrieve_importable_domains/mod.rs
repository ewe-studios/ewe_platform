//! Auto-generated API module for gcp/domains registrations:retrieveImportableDomains.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_domains_registrations_retrieve_importable_domains `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://domains.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/registrations:retrieveImportableDomains",
    );
