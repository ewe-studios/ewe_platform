//! Auto-generated API module for gcp/compute getVersion.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_compute_get_version `
...
/// Arguments for [`compute.reservationSlots.getVersion_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
pub struct ComputeReservationSlotsGetVersionArgs {
...
/// Arguments for [`compute.reservationSubBlocks.getVersion_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
pub struct ComputeReservationSubBlocksGetVersionArgs {
    /// Path parameter: `project`.
    pub project: String,
    /// Path parameter: `zone`.
    pub zone: String,
...
///
/// ```ignore
/// let task = compute_reservation_slots_get_version_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn compute_reservation_slots_get_version_request<R, F>(
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://compute.googleapis.com/compute/v1/projects/{}/zones/{}/reservations/{{reservationsId}}/reservationBlocks/{{reservationBlocksId}}/reservationSubBlocks/{{reservationSubBlocksId}}/reservationSlots/{}/getVersion",
        args.project,
        args.zone,
...
///
/// ```ignore
/// let task = compute_reservation_sub_blocks_get_version_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn compute_reservation_sub_blocks_get_version_request<R, F>(
    client: &SimpleHttpClient<R>,
...
{
    let endpoint_url = format!(
        "https://compute.googleapis.com/compute/v1/projects/{}/zones/{}/reservations/{{reservationsId}}/reservationBlocks/{{reservationBlocksId}}/reservationSubBlocks/{}/getVersion",
        args.project,
        args.zone,
