//! Auto-generated API module for gcp/compute reportFaulty.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_compute_report_faulty `
...
/// Arguments for [`compute.reservationSubBlocks.reportFaulty_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
pub struct ComputeReservationSubBlocksReportFaultyArgs {
...
///
/// ```ignore
/// let task = compute_reservation_sub_blocks_report_faulty_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn compute_reservation_sub_blocks_report_faulty_request<R, F>(
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://compute.googleapis.com/compute/v1/projects/{}/zones/{}/reservations/{{reservationsId}}/reservationBlocks/{{reservationBlocksId}}/reservationSubBlocks/{}/reportFaulty",
        args.project,
        args.zone,
