//! Auto-generated API module for gcp/androiddeviceprovisioning devices:applyConfiguration.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_androiddeviceprovisioning_devices_apply_configuration `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://androiddeviceprovisioning.googleapis.com/v1/customers/{{customersId}}/devices:applyConfiguration",
    );
