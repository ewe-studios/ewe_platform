//! Auto-generated API module for gcp/androiddeviceprovisioning devices:claimAsync.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_androiddeviceprovisioning_devices_claim_async `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://androiddeviceprovisioning.googleapis.com/v1/partners/{{partnersId}}/devices:claimAsync",
    );
