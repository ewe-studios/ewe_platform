//! Auto-generated API module for gcp/androiddeviceprovisioning dpcs.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_androiddeviceprovisioning_dpcs `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://androiddeviceprovisioning.googleapis.com/v1/customers/{{customersId}}/dpcs",
    );
