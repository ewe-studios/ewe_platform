//! Auto-generated API module for gcp/androiddeviceprovisioning devices:updateMetadataAsync.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_androiddeviceprovisioning_devices_update_metadata_async `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://androiddeviceprovisioning.googleapis.com/v1/partners/{{partnersId}}/devices:updateMetadataAsync",
    );
