//! Auto-generated API module for gcp/merchantapi merchantReviews:insert.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_merchantapi_merchant_reviews_insert `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://merchantapi.googleapis.com/reviews/v1beta/accounts/{{accountsId}}/merchantReviews:insert",
    );
