//! Auto-generated API module for gcp/migrationcenter settings.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_migrationcenter_settings `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://migrationcenter.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/settings",
    );
