//! Auto-generated API module for gcp/datafusion dnsPeerings.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_datafusion_dns_peerings `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://datafusion.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/instances/{{instancesId}}/dnsPeerings",
    );
...
{
    let endpoint_url = format!(
        "https://datafusion.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/instances/{{instancesId}}/dnsPeerings/{{dnsPeeringsId}}",
    );
