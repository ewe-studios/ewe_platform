//! Auto-generated API module for gcp/apihub runtimeProjectAttachments.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_apihub_runtime_project_attachments `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://apihub.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/runtimeProjectAttachments",
    );
...
{
    let endpoint_url = format!(
        "https://apihub.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/runtimeProjectAttachments/{{runtimeProjectAttachmentsId}}",
    );
