//! Auto-generated API module for gcp/apihub styleGuide:contents.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_apihub_style_guide_contents `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://apihub.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/plugins/{{pluginsId}}/styleGuide:contents",
    );
