//! Auto-generated API module for gcp/artifactregistry yumArtifacts:create.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_artifactregistry_yum_artifacts_create `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://artifactregistry.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/repositories/{{repositoriesId}}/yumArtifacts:create",
    );
