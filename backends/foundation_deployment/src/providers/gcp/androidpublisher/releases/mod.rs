//! Auto-generated API module for gcp/androidpublisher releases.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_androidpublisher_releases `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://androidpublisher.googleapis.com/androidpublisher/v3/applications/{{applicationsId}}/tracks/{{tracksId}}/releases",
    );
