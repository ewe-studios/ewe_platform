//! Auto-generated API module for gcp/discoveryengine locations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_discoveryengine_locations `
...
/// Arguments for [`discoveryengine.projects.locations.setUpDataConnector_builder`].
...
/// Arguments for [`discoveryengine.projects.locations.setUpDataConnectorV2_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
// -----------------------------------------------------------------------------
// POST v1/projects/{projectsId}/locations/{locationsId}:setUpDataConnector
// -----------------------------------------------------------------------------
...
///
/// ```ignore
/// let task = discoveryengine_projects_locations_set_up_data_connector_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn discoveryengine_projects_locations_set_up_data_connector_request<R, F>(
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://discoveryengine.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}:setUpDataConnector",
    );
...
///
/// ```ignore
/// let task = discoveryengine_projects_locations_set_up_data_connector_v2_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn discoveryengine_projects_locations_set_up_data_connector_v2_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
...
{
    let endpoint_url = format!(
        "https://discoveryengine.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}:setUpDataConnectorV2",
    );
