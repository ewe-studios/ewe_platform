//! Auto-generated API module for gcp/discoveryengine projects.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_discoveryengine_projects `
...
/// Arguments for [`discoveryengine.projects.provision_builder`].
...
// -----------------------------------------------------------------------------
// POST v1/projects/{projectsId}:provision
// -----------------------------------------------------------------------------
...
///
/// ```ignore
/// let task = discoveryengine_projects_provision_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn discoveryengine_projects_provision_request<R, F>(
...
{
    let endpoint_url =
        format!("https://discoveryengine.googleapis.com/v1/projects/{{projectsId}}:provision",);
