//! Auto-generated API module for gcp/discoveryengine siteSearchEngine:batchVerifyTargetSites.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_discoveryengine_site_search_engine_batch_verify_target_sites `
...
/// Arguments for [`discoveryengine.projects.locations.collections.dataStores.siteSearchEngine.batchVerifyTargetSites_builder`].
...
///
/// ```ignore
/// let task = discoveryengine_projects_locations_collections_data_stores_site_search_engine_batch_verify_target_sites_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn discoveryengine_projects_locations_collections_data_stores_site_search_engine_batch_verify_target_sites_request<
    R,
    F,
>(
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://discoveryengine.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/collections/{{collectionsId}}/dataStores/{{dataStoresId}}/siteSearchEngine:batchVerifyTargetSites",
    );
