//! Auto-generated API module for gcp/discoveryengine cmekConfigs.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_discoveryengine_cmek_configs `
...
/// Arguments for [`discoveryengine.projects.locations.cmekConfigs.delete_builder`].
...
/// Arguments for [`discoveryengine.projects.locations.cmekConfigs.get_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
/// Arguments for [`discoveryengine.projects.locations.cmekConfigs.list_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
/// Arguments for [`discoveryengine.projects.locations.cmekConfigs.patch_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
// -----------------------------------------------------------------------------
// DELETE v1/projects/{projectsId}/locations/{locationsId}/cmekConfigs/{cmekConfigsId}
// -----------------------------------------------------------------------------
...
///
/// ```ignore
/// let task = discoveryengine_projects_locations_cmek_configs_delete_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn discoveryengine_projects_locations_cmek_configs_delete_request<R, F>(
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://discoveryengine.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/cmekConfigs/{{cmekConfigsId}}",
    );
...
///
/// ```ignore
/// let task = discoveryengine_projects_locations_cmek_configs_get_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn discoveryengine_projects_locations_cmek_configs_get_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
...
///
/// ```ignore
/// let task = discoveryengine_projects_locations_cmek_configs_list_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn discoveryengine_projects_locations_cmek_configs_list_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<
                ApiResponse<GoogleCloudDiscoveryengineV1ListCmekConfigsResponse>,
                super::shared::ApiError,
            >,
            Pending = super::shared::ApiPending,
            Spawner = super::shared::BoxedSendExecutionAction,
...
{
    let endpoint_url = format!(
        "https://discoveryengine.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/cmekConfigs",
    );
    ...
    Ok(builder
        ...
        .map_ready(|intro| match intro {
            super::shared::RequestIntro::Success {
                ...
                let body =
                    foundation_core::wire::simple_http::client::body_reader::collect_string(stream);
                let parsed: GoogleCloudDiscoveryengineV1ListCmekConfigsResponse =
                    serde_json::from_str(&body).map_err(|e: serde_json::Error| {
                        super::shared::ApiError::ParseFailed(e.to_string())
                    })?;
                Ok(ApiResponse {
...
///
/// ```ignore
/// let task = discoveryengine_projects_locations_cmek_configs_patch_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn discoveryengine_projects_locations_cmek_configs_patch_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
