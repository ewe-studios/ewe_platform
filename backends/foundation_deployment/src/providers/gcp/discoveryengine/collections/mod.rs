//! Auto-generated API module for gcp/discoveryengine collections.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_discoveryengine_collections `
...
/// Arguments for [`discoveryengine.projects.locations.collections.delete_builder`].
...
// -----------------------------------------------------------------------------
// DELETE v1/projects/{projectsId}/locations/{locationsId}/collections/{collectionsId}
// -----------------------------------------------------------------------------
...
///
/// ```ignore
/// let task = discoveryengine_projects_locations_collections_delete_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn discoveryengine_projects_locations_collections_delete_request<R, F>(
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://discoveryengine.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/collections/{{collectionsId}}",
    );
