//! Auto-generated API module for gcp/discoveryengine batchGetDocumentsMetadata.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_discoveryengine_batch_get_documents_metadata `
...
/// Arguments for [`discoveryengine.projects.locations.collections.dataStores.branches.batchGetDocumentsMetadata_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
pub struct DiscoveryengineProjectsLocationsCollectionsDataStoresBranchesBatchGetDocumentsMetadataArgs
{
    /// Path parameter: `parent`.
    pub parent: String,
    /// Query parameter: `matcher.fhirMatcher.fhirResources`.
    pub matcher_fhir_matcher_fhir_resources: Option<String>,
    /// Query parameter: `matcher.urisMatcher.uris`.
    pub matcher_uris_matcher_uris: Option<String>,
}

/// Arguments for [`discoveryengine.projects.locations.dataStores.branches.batchGetDocumentsMetadata_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
///
/// ```ignore
/// let task = discoveryengine_projects_locations_collections_data_stores_branches_batch_get_documents_metadata_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn discoveryengine_projects_locations_collections_data_stores_branches_batch_get_documents_metadata_request<
    R,
    F,
>(
    ...
    impl TaskIterator<
            Ready = Result<
                ApiResponse<GoogleCloudDiscoveryengineV1BatchGetDocumentsMetadataResponse>,
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://discoveryengine.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/collections/{{collectionsId}}/dataStores/{{dataStoresId}}/branches/{{branchesId}}/batchGetDocumentsMetadata",
    );
    ...
    Ok(builder
        ...
        .map_ready(|intro| match intro {
            super::shared::RequestIntro::Success {
                ...
                let parsed: GoogleCloudDiscoveryengineV1BatchGetDocumentsMetadataResponse =
...
///
/// ```ignore
/// let task = discoveryengine_projects_locations_data_stores_branches_batch_get_documents_metadata_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn discoveryengine_projects_locations_data_stores_branches_batch_get_documents_metadata_request<
    R,
    F,
>(
    client: &SimpleHttpClient<R>,
...
{
    let endpoint_url = format!(
        "https://discoveryengine.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/dataStores/{{dataStoresId}}/branches/{{branchesId}}/batchGetDocumentsMetadata",
    );
