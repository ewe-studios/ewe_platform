//! Auto-generated API module for gcp/discoveryengine mcp.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_discoveryengine_mcp `
...
/// Arguments for [`discoveryengine.projects.locations.collections.dataConnector.mcp_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
pub struct DiscoveryengineProjectsLocationsCollectionsDataConnectorMcpArgs {
...
///
/// ```ignore
/// let task = discoveryengine_projects_locations_collections_data_connector_mcp_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn discoveryengine_projects_locations_collections_data_connector_mcp_request<R, F>(
