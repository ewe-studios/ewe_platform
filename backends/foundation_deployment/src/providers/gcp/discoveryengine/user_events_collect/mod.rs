//! Auto-generated API module for gcp/discoveryengine userEvents:collect.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_discoveryengine_user_events_collect `
...
/// Arguments for [`discoveryengine.projects.locations.collections.dataStores.userEvents.collect_builder`].
...
/// Arguments for [`discoveryengine.projects.locations.dataStores.userEvents.collect_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
/// Arguments for [`discoveryengine.projects.locations.userEvents.collect_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
///
/// ```ignore
/// let task = discoveryengine_projects_locations_collections_data_stores_user_events_collect_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn discoveryengine_projects_locations_collections_data_stores_user_events_collect_request<
    R,
    F,
>(
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://discoveryengine.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/collections/{{collectionsId}}/dataStores/{{dataStoresId}}/userEvents:collect",
    );
...
///
/// ```ignore
/// let task = discoveryengine_projects_locations_data_stores_user_events_collect_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn discoveryengine_projects_locations_data_stores_user_events_collect_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
...
{
    let endpoint_url = format!(
        "https://discoveryengine.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/dataStores/{{dataStoresId}}/userEvents:collect",
    );
...
///
/// ```ignore
/// let task = discoveryengine_projects_locations_user_events_collect_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn discoveryengine_projects_locations_user_events_collect_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
...
{
    let endpoint_url = format!(
        "https://discoveryengine.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/userEvents:collect",
    );
