//! Auto-generated API module for gcp/cloudtasks cmekConfig.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_cloudtasks_cmek_config `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://cloudtasks.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/cmekConfig",
    );
