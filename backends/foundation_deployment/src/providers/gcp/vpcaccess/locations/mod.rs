//! Auto-generated API module for gcp/vpcaccess locations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_vpcaccess_locations `

#![cfg(feature = "gcp_vpcaccess_locations")]
...
{
    let endpoint_url =
        format!("https://vpcaccess.googleapis.com/v1/projects/{{projectsId}}/locations",);
