//! Auto-generated API module for gcp/vpcaccess operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_vpcaccess_operations `

#![cfg(feature = "gcp_vpcaccess_operations")]
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://vpcaccess.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/operations/{{operationsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://vpcaccess.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/operations",
    );
