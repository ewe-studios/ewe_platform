//! Auto-generated API module for gcp/searchads360 customColumns.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_searchads360_custom_columns `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://searchads360.googleapis.com/v0/customers/{{customersId}}/customColumns/{{customColumnsId}}",
    );
...
{
    let endpoint_url =
        format!("https://searchads360.googleapis.com/v0/customers/{{customersId}}/customColumns",);
