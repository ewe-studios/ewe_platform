//! Auto-generated API module for gcp/searchads360 searchAds360Fields.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_searchads360_search_ads360fields `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://searchads360.googleapis.com/v0/searchAds360Fields/{{searchAds360FieldsId}}",
    );
