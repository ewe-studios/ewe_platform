//! Auto-generated API module for gcp/paymentsresellersubscription userSessions:generate.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_paymentsresellersubscription_user_sessions_generate `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://paymentsresellersubscription.googleapis.com/v1/partners/{{partnersId}}/userSessions:generate",
    );
