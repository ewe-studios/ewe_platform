//! Auto-generated API module for gcp/pubsublite cursors.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_pubsublite_cursors `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://pubsublite.googleapis.com/v1/cursor/projects/{{projectsId}}/locations/{{locationsId}}/subscriptions/{{subscriptionsId}}/cursors",
    );
