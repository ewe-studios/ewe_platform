//! Auto-generated API module for gcp/pubsublite reservations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_pubsublite_reservations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://pubsublite.googleapis.com/v1/admin/projects/{{projectsId}}/locations/{{locationsId}}/reservations",
    );
...
{
    let endpoint_url = format!(
        "https://pubsublite.googleapis.com/v1/admin/projects/{{projectsId}}/locations/{{locationsId}}/reservations/{{reservationsId}}",
    );
