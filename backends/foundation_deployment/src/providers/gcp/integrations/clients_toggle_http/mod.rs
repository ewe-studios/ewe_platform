//! Auto-generated API module for gcp/integrations clients:toggleHttp.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_integrations_clients_toggle_http `
...
// -----------------------------------------------------------------------------
// POST v1/projects/{projectsId}/locations/{locationsId}/clients:toggleHttp
// -----------------------------------------------------------------------------
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://integrations.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/clients:toggleHttp",
    );
