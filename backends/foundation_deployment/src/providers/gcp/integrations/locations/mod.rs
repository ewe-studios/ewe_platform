//! Auto-generated API module for gcp/integrations locations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_integrations_locations `
...
// -----------------------------------------------------------------------------
// POST v1/projects/{projectsId}/locations/{locationsId}:generateOpenApiSpec
// -----------------------------------------------------------------------------
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://integrations.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}:generateOpenApiSpec",
    );
