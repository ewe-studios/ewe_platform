//! Auto-generated API module for gcp/integrations runtimeActionSchemas.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_integrations_runtime_action_schemas `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://integrations.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/connections/{{connectionsId}}/runtimeActionSchemas",
    );
