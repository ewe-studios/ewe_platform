//! Auto-generated API module for gcp/integrations appsScriptProjects:link.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_integrations_apps_script_projects_link `
...
// -----------------------------------------------------------------------------
// POST v1/projects/{projectsId}/locations/{locationsId}/appsScriptProjects:link
// -----------------------------------------------------------------------------
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://integrations.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/appsScriptProjects:link",
    );
