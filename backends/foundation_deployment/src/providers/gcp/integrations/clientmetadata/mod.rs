//! Auto-generated API module for gcp/integrations clientmetadata.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_integrations_clientmetadata `
...
{
    let endpoint_url =
        format!("https://integrations.googleapis.com/v1/projects/{{projectsId}}/clientmetadata",);
