//! Auto-generated API module for gcp/servicemanagement consumers.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_servicemanagement_consumers `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://servicemanagement.googleapis.com/v1/services/{{servicesId}}/consumers/{{consumersId}}:getIamPolicy",
    );
...
{
    let endpoint_url = format!(
        "https://servicemanagement.googleapis.com/v1/services/{{servicesId}}/consumers/{{consumersId}}:setIamPolicy",
    );
...
{
    let endpoint_url = format!(
        "https://servicemanagement.googleapis.com/v1/services/{{servicesId}}/consumers/{{consumersId}}:testIamPermissions",
    );
