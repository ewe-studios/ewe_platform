//! Auto-generated API module for gcp/servicemanagement operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_servicemanagement_operations `
...
{
    let endpoint_url =
        format!("https://servicemanagement.googleapis.com/v1/operations/{{operationsId}}",);
