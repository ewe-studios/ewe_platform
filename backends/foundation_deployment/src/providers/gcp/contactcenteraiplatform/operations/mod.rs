//! Auto-generated API module for gcp/contactcenteraiplatform operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_contactcenteraiplatform_operations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://contactcenteraiplatform.googleapis.com/v1alpha1/projects/{{projectsId}}/locations/{{locationsId}}/operations/{{operationsId}}:cancel",
    );
...
{
    let endpoint_url = format!(
        "https://contactcenteraiplatform.googleapis.com/v1alpha1/projects/{{projectsId}}/locations/{{locationsId}}/operations/{{operationsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://contactcenteraiplatform.googleapis.com/v1alpha1/projects/{{projectsId}}/locations/{{locationsId}}/operations",
    );
