//! Auto-generated API module for gcp/mybusinessbusinessinformation categories:batchGet.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_mybusinessbusinessinformation_categories_batch_get `
