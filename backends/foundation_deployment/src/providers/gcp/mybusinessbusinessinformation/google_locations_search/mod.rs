//! Auto-generated API module for gcp/mybusinessbusinessinformation googleLocations:search.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_mybusinessbusinessinformation_google_locations_search `
