//! Auto-generated API module for gcp/mybusinessbusinessinformation chains.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_mybusinessbusinessinformation_chains `
...
{
    let endpoint_url =
        format!("https://mybusinessbusinessinformation.googleapis.com/v1/chains/{{chainsId}}",);
