//! Auto-generated API module for gcp/biglake namespaces.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_biglake_namespaces `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://biglake.googleapis.com/v1/projects/{{projectsId}}/catalogs/{{catalogsId}}/namespaces/{{namespacesId}}:getIamPolicy",
    );
...
{
    let endpoint_url = format!(
        "https://biglake.googleapis.com/v1/projects/{{projectsId}}/catalogs/{{catalogsId}}/namespaces/{{namespacesId}}:setIamPolicy",
    );
...
{
    let endpoint_url = format!(
        "https://biglake.googleapis.com/v1/projects/{{projectsId}}/catalogs/{{catalogsId}}/namespaces/{{namespacesId}}:testIamPermissions",
    );
