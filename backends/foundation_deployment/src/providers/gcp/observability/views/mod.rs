//! Auto-generated API module for gcp/observability views.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_observability_views `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://observability.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/buckets/{{bucketsId}}/datasets/{{datasetsId}}/views/{{viewsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://observability.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/buckets/{{bucketsId}}/datasets/{{datasetsId}}/views",
    );
