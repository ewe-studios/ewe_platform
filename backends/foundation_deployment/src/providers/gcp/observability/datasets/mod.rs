//! Auto-generated API module for gcp/observability datasets.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_observability_datasets `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://observability.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/buckets/{{bucketsId}}/datasets/{{datasetsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://observability.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/buckets/{{bucketsId}}/datasets",
    );
