//! Auto-generated API module for gcp/observability locations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_observability_locations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://observability.googleapis.com/v1/folders/{{foldersId}}/locations/{{locationsId}}",
    );
...
{
    let endpoint_url =
        format!("https://observability.googleapis.com/v1/folders/{{foldersId}}/locations",);
...
{
    let endpoint_url = format!(
        "https://observability.googleapis.com/v1/organizations/{{organizationsId}}/locations/{{locationsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://observability.googleapis.com/v1/organizations/{{organizationsId}}/locations",
    );
...
{
    let endpoint_url = format!(
        "https://observability.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}",
    );
...
{
    let endpoint_url =
        format!("https://observability.googleapis.com/v1/projects/{{projectsId}}/locations",);
