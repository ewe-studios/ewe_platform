//! Auto-generated API module for gcp/manufacturers products.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_manufacturers_products `

#![cfg(feature = "gcp_manufacturers_products")]
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://manufacturers.googleapis.com/v1/accounts/{{accountsId}}/products/{{productsId}}",
    );
...
{
    let endpoint_url =
        format!("https://manufacturers.googleapis.com/v1/accounts/{{accountsId}}/products",);
