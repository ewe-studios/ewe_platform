//! Auto-generated API module for gcp/manufacturers productCertifications.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_manufacturers_product_certifications `

#![cfg(feature = "gcp_manufacturers_product_certifications")]
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://manufacturers.googleapis.com/v1/accounts/{{accountsId}}/languages/{{languagesId}}/productCertifications/{{productCertificationsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://manufacturers.googleapis.com/v1/accounts/{{accountsId}}/languages/{{languagesId}}/productCertifications",
    );
