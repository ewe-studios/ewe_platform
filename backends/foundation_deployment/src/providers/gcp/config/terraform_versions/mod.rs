//! Auto-generated API module for gcp/config terraformVersions.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_config_terraform_versions `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://config.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/terraformVersions/{{terraformVersionsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://config.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/terraformVersions",
    );
