//! Auto-generated API module for gcp/monitoring timeSeries:createService.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_monitoring_time_series_create_service `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://monitoring.googleapis.com/v3/projects/{{projectsId}}/timeSeries:createService",
    );
