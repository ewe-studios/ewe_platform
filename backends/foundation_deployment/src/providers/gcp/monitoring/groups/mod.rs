//! Auto-generated API module for gcp/monitoring groups.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_monitoring_groups `
...
{
    let endpoint_url =
        format!("https://monitoring.googleapis.com/v3/projects/{{projectsId}}/groups",);
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://monitoring.googleapis.com/v3/projects/{{projectsId}}/groups/{{groupsId}}",
    );
