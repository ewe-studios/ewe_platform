//! Auto-generated API module for gcp/monitoring notificationChannelDescriptors.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_monitoring_notification_channel_descriptors `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://monitoring.googleapis.com/v3/projects/{{projectsId}}/notificationChannelDescriptors/{{notificationChannelDescriptorsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://monitoring.googleapis.com/v3/projects/{{projectsId}}/notificationChannelDescriptors",
    );
