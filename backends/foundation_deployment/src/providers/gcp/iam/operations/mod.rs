//! Auto-generated API module for gcp/iam operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_iam_operations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://iam.googleapis.com/v2/policies/{{policiesId}}/{{policiesId1}}/{{policiesId2}}/operations/{{operationsId}}",
    );
