//! Auto-generated API module for gcp/playdeveloperreporting errorCountMetricSet:query.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_playdeveloperreporting_error_count_metric_set_query `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://playdeveloperreporting.googleapis.com/v1beta1/apps/{{appsId}}/errorCountMetricSet:query",
    );
