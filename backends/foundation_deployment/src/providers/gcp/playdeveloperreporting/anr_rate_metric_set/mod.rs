//! Auto-generated API module for gcp/playdeveloperreporting anrRateMetricSet.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_playdeveloperreporting_anr_rate_metric_set `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://playdeveloperreporting.googleapis.com/v1beta1/apps/{{appsId}}/anrRateMetricSet",
    );
