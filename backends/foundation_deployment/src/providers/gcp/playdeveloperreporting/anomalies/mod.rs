//! Auto-generated API module for gcp/playdeveloperreporting anomalies.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_playdeveloperreporting_anomalies `
...
{
    let endpoint_url =
        format!("https://playdeveloperreporting.googleapis.com/v1beta1/apps/{{appsId}}/anomalies",);
