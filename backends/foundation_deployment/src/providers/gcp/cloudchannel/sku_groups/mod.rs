//! Auto-generated API module for gcp/cloudchannel skuGroups.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_cloudchannel_sku_groups `
...
{
    let endpoint_url =
        format!("https://cloudchannel.googleapis.com/v1/accounts/{{accountsId}}/skuGroups",);
