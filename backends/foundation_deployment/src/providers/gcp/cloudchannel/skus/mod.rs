//! Auto-generated API module for gcp/cloudchannel skus.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_cloudchannel_skus `
...
{
    let endpoint_url =
        format!("https://cloudchannel.googleapis.com/v1/products/{{productsId}}/skus",);
