//! Auto-generated API module for gcp/cloudchannel operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_cloudchannel_operations `
...
{
    let endpoint_url =
        format!("https://cloudchannel.googleapis.com/v1/operations/{{operationsId}}:cancel",);
...
{
    let endpoint_url =
        format!("https://cloudchannel.googleapis.com/v1/operations/{{operationsId}}",);
