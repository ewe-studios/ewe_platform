//! Auto-generated API module for gcp/connectors entities:updateEntitiesWithConditions.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_connectors_entities_update_entities_conditions `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://connectors.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/connections/{{connectionsId}}/entityTypes/{{entityTypesId}}/entities:updateEntitiesWithConditions",
    );
