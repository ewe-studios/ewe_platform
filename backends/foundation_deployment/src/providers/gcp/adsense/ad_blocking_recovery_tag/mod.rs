//! Auto-generated API module for gcp/adsense adBlockingRecoveryTag.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_adsense_ad_blocking_recovery_tag `
...
{
    let endpoint_url =
        format!("https://adsense.googleapis.com/v2/accounts/{{accountsId}}/adBlockingRecoveryTag",);
