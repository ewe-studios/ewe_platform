//! Auto-generated API module for gcp/adsense adcode.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_adsense_adcode `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://adsense.googleapis.com/v2/accounts/{{accountsId}}/adclients/{{adclientsId}}/adcode",
    );
...
{
    let endpoint_url = format!(
        "https://adsense.googleapis.com/v2/accounts/{{accountsId}}/adclients/{{adclientsId}}/adunits/{{adunitsId}}/adcode",
    );
