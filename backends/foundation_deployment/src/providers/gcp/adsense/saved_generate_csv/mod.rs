//! Auto-generated API module for gcp/adsense saved:generateCsv.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_adsense_saved_generate_csv `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://adsense.googleapis.com/v2/accounts/{{accountsId}}/reports/{{reportsId}}/saved:generateCsv",
    );
