//! Auto-generated API module for gcp/adsense reports:generate.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_adsense_reports_generate `
...
{
    let endpoint_url =
        format!("https://adsense.googleapis.com/v2/accounts/{{accountsId}}/reports:generate",);
