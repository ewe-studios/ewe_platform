//! Auto-generated API module for gcp/admob networkReport:generate.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_admob_network_report_generate `
...
{
    let endpoint_url =
        format!("https://admob.googleapis.com/v1/accounts/{{accountsId}}/networkReport:generate",);
