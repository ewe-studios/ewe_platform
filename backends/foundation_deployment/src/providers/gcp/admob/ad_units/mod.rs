//! Auto-generated API module for gcp/admob adUnits.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_admob_ad_units `
...
{
    let endpoint_url = format!("https://admob.googleapis.com/v1/accounts/{{accountsId}}/adUnits",);
