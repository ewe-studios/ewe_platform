//! Auto-generated API module for gcp/beyondcorp appConnections.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_beyondcorp_app_connections `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://beyondcorp.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/appConnections",
    );
...
{
    let endpoint_url = format!(
        "https://beyondcorp.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/appConnections/{{appConnectionsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://beyondcorp.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/appConnections/{{appConnectionsId}}:getIamPolicy",
    );
...
{
    let endpoint_url = format!(
        "https://beyondcorp.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/appConnections/{{appConnectionsId}}:setIamPolicy",
    );
...
{
    let endpoint_url = format!(
        "https://beyondcorp.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/appConnections/{{appConnectionsId}}:testIamPermissions",
    );
