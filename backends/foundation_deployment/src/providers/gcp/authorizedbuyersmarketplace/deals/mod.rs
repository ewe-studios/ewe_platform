//! Auto-generated API module for gcp/authorizedbuyersmarketplace deals.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_authorizedbuyersmarketplace_deals `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://authorizedbuyersmarketplace.googleapis.com/v1/buyers/{{buyersId}}/proposals/{{proposalsId}}/deals/{{dealsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://authorizedbuyersmarketplace.googleapis.com/v1/buyers/{{buyersId}}/proposals/{{proposalsId}}/deals",
    );
