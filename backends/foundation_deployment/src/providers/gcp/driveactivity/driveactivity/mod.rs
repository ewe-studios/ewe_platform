//! Auto-generated API module for gcp/driveactivity driveactivity.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_driveactivity_driveactivity `
...
/// `QueryDriveActivityRequest` type.
#[derive(Debug, Clone, Default, Serialize, Deserialize, JsonHash)]
pub struct QueryDriveActivityRequest {
    /// ancestorName property.
    pub ancestor_name: Option<String>,
    /// consolidationStrategy property.
...
/// Arguments for [`driveactivity.activity.query_builder`].
