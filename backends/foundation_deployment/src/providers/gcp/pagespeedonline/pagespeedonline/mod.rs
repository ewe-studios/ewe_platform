//! Auto-generated API module for gcp/pagespeedonline pagespeedonline.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_pagespeedonline_pagespeedonline `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    ...
    let endpoint_url = {
        ...
        let mut first = true;
        if let Some(ref v) = args.captcha_token {
            if first {
                url.push('?');
                first = false;
            } else {
        ...
        if let Some(ref v) = args.strategy {
            if first {
                url.push('?');
                first = false;
            } else {
        ...
        if let Some(ref v) = args.utm_campaign {
            if first {
                url.push('?');
                first = false;
            } else {
            ...
            url.push_str("utm_campaign=");
            url.push_str(&urlencoding::encode(v));
        }
        if let Some(ref v) = args.utm_source {
            if first {
                url.push('?');
                first = false;
            } else {
