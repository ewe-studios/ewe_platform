//! Auto-generated API module for gcp/keep permissions:batchDelete.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_keep_permissions_batch_delete `
...
{
    let endpoint_url =
        format!("https://keep.googleapis.com/v1/notes/{{notesId}}/permissions:batchDelete",);
