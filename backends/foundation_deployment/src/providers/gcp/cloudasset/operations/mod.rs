//! Auto-generated API module for gcp/cloudasset operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_cloudasset_operations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://cloudasset.googleapis.com/v1/{{v1Id}}/{{v1Id1}}/operations/{{operationsId}}/{{operationsId1}}",
    );
