//! Auto-generated API module for gcp/cloudasset feeds.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_cloudasset_feeds `
...
{
    let endpoint_url = format!("https://cloudasset.googleapis.com/v1/{{v1Id}}/{{v1Id1}}/feeds",);
...
{
    let endpoint_url =
        format!("https://cloudasset.googleapis.com/v1/{{v1Id}}/{{v1Id1}}/feeds/{{feedsId}}",);
