//! Auto-generated API module for gcp/oracledatabase dbServers.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_oracledatabase_db_servers `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://oracledatabase.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/cloudExadataInfrastructures/{{cloudExadataInfrastructuresId}}/dbServers",
    );
