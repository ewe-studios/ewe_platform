//! Auto-generated API module for gcp/oracledatabase odbSubnets.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_oracledatabase_odb_subnets `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://oracledatabase.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/odbNetworks/{{odbNetworksId}}/odbSubnets",
    );
...
{
    let endpoint_url = format!(
        "https://oracledatabase.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/odbNetworks/{{odbNetworksId}}/odbSubnets/{{odbSubnetsId}}",
    );
