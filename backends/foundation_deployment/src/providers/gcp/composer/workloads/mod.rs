//! Auto-generated API module for gcp/composer workloads.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_composer_workloads `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://composer.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/environments/{{environmentsId}}/workloads",
    );
