//! Auto-generated API module for gcp/serviceconsumermanagement operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_serviceconsumermanagement_operations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://serviceconsumermanagement.googleapis.com/v1/operations/{{operationsId}}:cancel",
    );
...
{
    let endpoint_url =
        format!("https://serviceconsumermanagement.googleapis.com/v1/operations/{{operationsId}}",);
