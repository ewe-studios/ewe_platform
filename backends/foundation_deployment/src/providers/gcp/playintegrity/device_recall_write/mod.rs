//! Auto-generated API module for gcp/playintegrity deviceRecall:write.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_playintegrity_device_recall_write `
...
{
    let endpoint_url =
        format!("https://playintegrity.googleapis.com/v1/{{v1Id}}/deviceRecall:write",);
