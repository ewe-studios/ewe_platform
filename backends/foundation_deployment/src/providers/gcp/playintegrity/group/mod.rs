//! Auto-generated API module for gcp/playintegrity v1.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_playintegrity_group `
...
{
    let endpoint_url =
        format!("https://playintegrity.googleapis.com/v1/{{v1Id}}:decodeIntegrityToken",);
...
{
    let endpoint_url =
        format!("https://playintegrity.googleapis.com/v1/{{v1Id}}:decodePcIntegrityToken",);
