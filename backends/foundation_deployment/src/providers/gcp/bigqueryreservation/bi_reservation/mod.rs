//! Auto-generated API module for gcp/bigqueryreservation biReservation.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_bigqueryreservation_bi_reservation `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://bigqueryreservation.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/biReservation",
    );
