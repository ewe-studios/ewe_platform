//! Auto-generated API module for gcp/groupsmigration groupsmigration.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_groupsmigration_groupsmigration `
...
/// Arguments for [`groupsmigration.archive.insert_builder`].
...
///
/// ```ignore
/// let task = groupsmigration_archive_insert_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn groupsmigration_archive_insert_request<R, F>(
