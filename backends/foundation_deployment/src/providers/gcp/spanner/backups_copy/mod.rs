//! Auto-generated API module for gcp/spanner backups:copy.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_spanner_backups_copy `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://spanner.googleapis.com/v1/projects/{{projectsId}}/instances/{{instancesId}}/backups:copy",
    );
