//! Auto-generated API module for gcp/spanner sessions:batchCreate.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_spanner_sessions_batch_create `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://spanner.googleapis.com/v1/projects/{{projectsId}}/instances/{{instancesId}}/databases/{{databasesId}}/sessions:batchCreate",
    );
