//! Auto-generated API module for gcp/spanner instanceConfigOperations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_spanner_instance_config_operations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://spanner.googleapis.com/v1/projects/{{projectsId}}/instanceConfigOperations",
    );
