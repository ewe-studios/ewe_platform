//! Auto-generated API module for gcp/datalabeling image:label.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_datalabeling_image_label `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://datalabeling.googleapis.com/v1beta1/projects/{{projectsId}}/datasets/{{datasetsId}}/image:label",
    );
