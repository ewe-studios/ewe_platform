//! Auto-generated API module for gcp/abusiveexperiencereport sites.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_abusiveexperiencereport_sites `

#![cfg(feature = "gcp_abusiveexperiencereport_sites")]
...
{
    let endpoint_url =
        format!("https://abusiveexperiencereport.googleapis.com/v1/sites/{{sitesId}}",);
