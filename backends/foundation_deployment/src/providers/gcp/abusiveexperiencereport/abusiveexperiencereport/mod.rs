//! Auto-generated API module for gcp/abusiveexperiencereport abusiveexperiencereport.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_abusiveexperiencereport_abusiveexperiencereport `

#![cfg(feature = "gcp_abusiveexperiencereport_abusiveexperiencereport")]
...
/// Arguments for [`abusiveexperiencereport.sites.get_builder`].
...
///
/// ```ignore
/// let task = abusiveexperiencereport_sites_get_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn abusiveexperiencereport_sites_get_request<R, F>(
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://abusiveexperiencereport.googleapis.com/v1/{}",
        args.name,
    );
