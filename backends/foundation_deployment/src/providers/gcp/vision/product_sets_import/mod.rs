//! Auto-generated API module for gcp/vision productSets:import.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_vision_product_sets_import `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://vision.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/productSets:import",
    );
