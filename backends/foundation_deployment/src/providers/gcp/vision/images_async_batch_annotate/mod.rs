//! Auto-generated API module for gcp/vision images:asyncBatchAnnotate.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_vision_images_async_batch_annotate `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://vision.googleapis.com/v1/projects/{{projectsId}}/images:asyncBatchAnnotate",
    );
...
{
    let endpoint_url = format!(
        "https://vision.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/images:asyncBatchAnnotate",
    );
