//! Auto-generated API module for gcp/vision files:asyncBatchAnnotate.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_vision_files_async_batch_annotate `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://vision.googleapis.com/v1/projects/{{projectsId}}/files:asyncBatchAnnotate",
    );
...
{
    let endpoint_url = format!(
        "https://vision.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/files:asyncBatchAnnotate",
    );
