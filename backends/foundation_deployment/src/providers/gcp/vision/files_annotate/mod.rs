//! Auto-generated API module for gcp/vision files:annotate.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_vision_files_annotate `
...
{
    let endpoint_url =
        format!("https://vision.googleapis.com/v1/projects/{{projectsId}}/files:annotate",);
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://vision.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/files:annotate",
    );
