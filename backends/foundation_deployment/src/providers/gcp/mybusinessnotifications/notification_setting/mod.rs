//! Auto-generated API module for gcp/mybusinessnotifications notificationSetting.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_mybusinessnotifications_notification_setting `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://mybusinessnotifications.googleapis.com/v1/accounts/{{accountsId}}/notificationSetting",
    );
