//! Auto-generated API module for gcp/clouderrorreporting groups.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_clouderrorreporting_groups `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://clouderrorreporting.googleapis.com/v1beta1/projects/{{projectsId}}/groups/{{groupsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://clouderrorreporting.googleapis.com/v1beta1/projects/{{projectsId}}/locations/{{locationsId}}/groups/{{groupsId}}",
    );
