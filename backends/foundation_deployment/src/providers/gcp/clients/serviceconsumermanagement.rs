//! Auto-generated API clients for Google Cloud Platform - serviceconsumermanagement.
//!
...
pub fn serviceconsumermanagement_services_search_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+parent}:search", parent,);
...
pub fn serviceconsumermanagement_services_tenancy_units_add_project_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+parent}:addProject", parent,);
...
/// GET v1/{+name}:applyProjectConfig
...
pub fn serviceconsumermanagement_services_tenancy_units_apply_project_config_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+name}:applyProjectConfig", name,);
...
pub fn serviceconsumermanagement_services_tenancy_units_attach_project_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+name}:attachProject", name,);
...
pub fn serviceconsumermanagement_services_tenancy_units_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+parent}/tenancyUnits", parent,);
...
pub fn serviceconsumermanagement_services_tenancy_units_delete_project_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+name}:deleteProject", name,);
...
pub fn serviceconsumermanagement_services_tenancy_units_remove_project_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+name}:removeProject", name,);
...
pub fn serviceconsumermanagement_services_tenancy_units_undelete_project_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+name}:undeleteProject", name,);
