//! Auto-generated API clients for Google Cloud Platform - firebaserules.
//!
...
pub fn firebaserules_projects_releases_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+name}/releases", name,);
...
pub fn firebaserules_projects_releases_get_executable_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+name}:getExecutable", name,);
...
pub fn firebaserules_projects_rulesets_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+name}/rulesets", name,);
