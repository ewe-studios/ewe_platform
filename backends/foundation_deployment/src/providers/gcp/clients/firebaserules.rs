...
pub fn firebaserules_projects_test_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<TestRulesetResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn firebaserules_projects_rulesets_create_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<Ruleset>, ApiError>, P = ApiPending> + Send + 'static,
    ApiError,
> {
    Ok(builder
        .build_send_request()
...
pub fn firebaserules_projects_rulesets_list_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ListRulesetsResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
