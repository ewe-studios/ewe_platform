//! Auto-generated API clients for Google Cloud Platform - alloydb.
//!
...
pub fn alloydb_projects_locations_list_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+name}/locations",
        name,
    );
...
> {
    ...
    let builder = alloydb_projects_locations_list_builder(client, name, extraLocationTypes, filter, pageSize, pageToken)?;
...
pub fn alloydb_projects_locations_backups_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/backups",
        parent,
    );
    ...
    client.get(&url)
        ...
        .query(
            "backupId",
            backupId.as_ref().map(|s| s.to_string()).unwrap_or_default().as_str(),
        )
        ...
        .query(
            "validateOnly",
            validateOnly.as_ref().map(|s| s.to_string()).unwrap_or_default().as_str(),
        )
...
> {
    ...
    let builder = alloydb_projects_locations_backups_create_builder(client, parent, backupId, requestId, validateOnly, body)?;
...
pub fn alloydb_projects_locations_backups_delete_builder(
    ...
    client.get(&url)
        ...
        .query(
            "etag",
            etag.as_ref().map(|s| s.to_string()).unwrap_or_default().as_str(),
        )
...
> {
    ...
    let builder = alloydb_projects_locations_backups_delete_builder(client, name, etag, requestId, validateOnly)?;
...
pub fn alloydb_projects_locations_backups_get_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<Backup>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
pub fn alloydb_projects_locations_backups_list_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<ListBackupsResponse>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = alloydb_projects_locations_backups_list_builder(client, parent, filter, orderBy, pageSize, pageToken, view)?;
...
pub fn alloydb_projects_locations_backups_patch_builder(
    ...
    client.get(&url)
        ...
        .query(
            "allowMissing",
            allowMissing.as_ref().map(|s| s.to_string()).unwrap_or_default().as_str(),
        )
...
> {
    ...
    let builder = alloydb_projects_locations_backups_patch_builder(client, name, allowMissing, requestId, updateMask, validateOnly, body)?;
...
pub fn alloydb_projects_locations_clusters_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/clusters",
        parent,
    );
    ...
    client.get(&url)
        ...
        .query(
            "clusterId",
            clusterId.as_ref().map(|s| s.to_string()).unwrap_or_default().as_str(),
        )
...
> {
    ...
    let builder = alloydb_projects_locations_clusters_create_builder(client, parent, clusterId, requestId, validateOnly, body)?;
...
> {
    ...
    let builder = alloydb_projects_locations_clusters_createsecondary_builder(client, parent, clusterId, requestId, validateOnly, body)?;
...
pub fn alloydb_projects_locations_clusters_delete_builder(
    ...
    client.get(&url)
        ...
        .query(
            "force",
            force.as_ref().map(|s| s.to_string()).unwrap_or_default().as_str(),
        )
...
> {
    ...
    let builder = alloydb_projects_locations_clusters_delete_builder(client, name, etag, force, requestId, validateOnly)?;
...
pub fn alloydb_projects_locations_clusters_export_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+name}:export",
        name,
    );
...
pub fn alloydb_projects_locations_clusters_get_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<Cluster>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
pub fn alloydb_projects_locations_clusters_import_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+name}:import",
        name,
    );
...
pub fn alloydb_projects_locations_clusters_list_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<ListClustersResponse>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = alloydb_projects_locations_clusters_list_builder(client, parent, filter, orderBy, pageSize, pageToken)?;
...
> {
    ...
    let builder = alloydb_projects_locations_clusters_patch_builder(client, name, allowMissing, requestId, updateMask, validateOnly, body)?;
...
pub fn alloydb_projects_locations_clusters_promote_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+name}:promote",
        name,
    );
...
> {
    ...
    let builder = alloydb_projects_locations_clusters_restore_from_cloud_sql_builder(client, parent, body)?;
...
pub fn alloydb_projects_locations_clusters_switchover_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+name}:switchover",
        name,
    );
...
pub fn alloydb_projects_locations_clusters_upgrade_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+name}:upgrade",
        name,
    );
...
pub fn alloydb_projects_locations_clusters_instances_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/instances",
        parent,
    );
    ...
    client.get(&url)
        ...
        .query(
            "instanceId",
            instanceId.as_ref().map(|s| s.to_string()).unwrap_or_default().as_str(),
        )
...
> {
    ...
    let builder = alloydb_projects_locations_clusters_instances_create_builder(client, parent, instanceId, requestId, validateOnly, body)?;
...
> {
    ...
    let builder = alloydb_projects_locations_clusters_instances_createsecondary_builder(client, parent, instanceId, requestId, validateOnly, body)?;
...
> {
    ...
    let builder = alloydb_projects_locations_clusters_instances_delete_builder(client, name, etag, requestId, validateOnly)?;
...
pub fn alloydb_projects_locations_clusters_instances_failover_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+name}:failover",
        name,
    );
...
> {
    ...
    let builder = alloydb_projects_locations_clusters_instances_failover_builder(client, name, body)?;
...
pub fn alloydb_projects_locations_clusters_instances_get_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<Instance>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
pub fn alloydb_projects_locations_clusters_instances_get_connection_info_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/connectionInfo",
        parent,
    );
...
pub fn alloydb_projects_locations_clusters_instances_get_connection_info_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<ConnectionInfo>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = alloydb_projects_locations_clusters_instances_get_connection_info_builder(client, parent, requestId)?;
...
pub fn alloydb_projects_locations_clusters_instances_inject_fault_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+name}:injectFault",
        name,
    );
...
> {
    ...
    let builder = alloydb_projects_locations_clusters_instances_inject_fault_builder(client, name, body)?;
...
pub fn alloydb_projects_locations_clusters_instances_list_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<ListInstancesResponse>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = alloydb_projects_locations_clusters_instances_list_builder(client, parent, filter, orderBy, pageSize, pageToken)?;
...
> {
    ...
    let builder = alloydb_projects_locations_clusters_instances_patch_builder(client, name, allowMissing, requestId, updateMask, validateOnly, body)?;
...
pub fn alloydb_projects_locations_clusters_instances_restart_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+name}:restart",
        name,
    );
...
> {
    ...
    let builder = alloydb_projects_locations_clusters_instances_restart_builder(client, name, body)?;
...
pub fn alloydb_projects_locations_clusters_users_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/users",
        parent,
    );
    ...
    client.get(&url)
        ...
        .query(
            "userId",
            userId.as_ref().map(|s| s.to_string()).unwrap_or_default().as_str(),
        )
...
> {
    ...
    let builder = alloydb_projects_locations_clusters_users_create_builder(client, parent, requestId, userId, validateOnly, body)?;
...
> {
    ...
    let builder = alloydb_projects_locations_clusters_users_delete_builder(client, name, requestId, validateOnly)?;
...
pub fn alloydb_projects_locations_clusters_users_list_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<ListUsersResponse>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = alloydb_projects_locations_clusters_users_list_builder(client, parent, filter, orderBy, pageSize, pageToken)?;
...
> {
    ...
    let builder = alloydb_projects_locations_clusters_users_patch_builder(client, name, allowMissing, requestId, updateMask, validateOnly, body)?;
...
pub fn alloydb_projects_locations_operations_list_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+name}/operations",
        name,
    );
...
> {
    ...
    let builder = alloydb_projects_locations_operations_list_builder(client, name, filter, pageSize, pageToken, returnPartialSuccess)?;
...
pub fn alloydb_projects_locations_supported_database_flags_list_builder(
    ...
    client.get(&url)
        ...
        .query(
            "scope",
            scope.as_ref().map(|s| s.to_string()).unwrap_or_default().as_str(),
        )
}
...
> {
    ...
    let builder = alloydb_projects_locations_supported_database_flags_list_builder(client, parent, pageSize, pageToken, scope)?;
