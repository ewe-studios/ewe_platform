...
pub fn licensing_license_assignments_get_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<LicenseAssignment>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn licensing_license_assignments_list_for_product_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<LicenseAssignmentList>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
