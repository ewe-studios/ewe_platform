...
pub fn cloudtasks_projects_locations_queues_create_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<Queue>, ApiError>, P = ApiPending> + Send + 'static,
    ApiError,
> {
    Ok(builder
        .build_send_request()
...
pub fn cloudtasks_projects_locations_queues_list_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ListQueuesResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn cloudtasks_projects_locations_queues_tasks_buffer_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<BufferTaskResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
