...
pub fn websecurityscanner_projects_scan_configs_create_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ScanConfig>, ApiError>, P = ApiPending> + Send + 'static,
    ApiError,
> {
    Ok(builder
        .build_send_request()
...
pub fn websecurityscanner_projects_scan_configs_list_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ListScanConfigsResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn websecurityscanner_projects_scan_configs_start_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ScanRun>, ApiError>, P = ApiPending> + Send + 'static,
    ApiError,
> {
    Ok(builder
        .build_send_request()
...
pub fn websecurityscanner_projects_scan_configs_scan_runs_list_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ListScanRunsResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn websecurityscanner_projects_scan_configs_scan_runs_crawled_urls_list_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ListCrawledUrlsResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
