//! Auto-generated API clients for Google Cloud Platform - language.
//!
...
pub fn language_documents_analyze_entities_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv2/documents:analyzeEntities",);
...
pub fn language_documents_analyze_sentiment_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv2/documents:analyzeSentiment",);
...
pub fn language_documents_annotate_text_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv2/documents:annotateText",);
...
pub fn language_documents_classify_text_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv2/documents:classifyText",);
...
pub fn language_documents_moderate_text_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv2/documents:moderateText",);
