//! Auto-generated API clients for Google Cloud Platform - addressvalidation.
//!
...
pub fn addressvalidation_provide_validation_feedback_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1:provideValidationFeedback",
    );
...
pub fn addressvalidation_provide_validation_feedback_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<GoogleMapsAddressvalidationV1ProvideValidationFeedbackResponse>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
    ...
    let task = builder
        ...
        .map_ready(|intro| match intro {
            RequestIntro::Success { stream, status } => {
                ...
                let parsed: GoogleMapsAddressvalidationV1ProvideValidationFeedbackResponse = serde_json::from_str(&body)
...
pub fn addressvalidation_validate_address_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1:validateAddress",
    );
    ...
    let task = builder
        ...
        .map_ready(|intro| match intro {
            RequestIntro::Success { stream, status } => {
                ...
                let body = body_reader::collect_string(stream);
                let parsed: GoogleMapsAddressvalidationV1ValidateAddressResponse = serde_json::from_str(&body)
                    .map_err(|e| ApiError::ParseFailed(e.to_string()))?;
