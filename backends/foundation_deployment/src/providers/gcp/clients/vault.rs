//! Auto-generated API clients for Google Cloud Platform - vault.
//!
...
pub fn vault_matters_add_permissions_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/matters/{}:addPermissions",
        matterId,
    );
...
pub fn vault_matters_close_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/matters/{}:close", matterId,);
...
pub fn vault_matters_count_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/matters/{}:count", matterId,);
...
pub fn vault_matters_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/matters",);
...
pub fn vault_matters_delete_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/matters/{}", matterId,);
...
pub fn vault_matters_remove_permissions_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/matters/{}:removePermissions",
        matterId,
    );
...
pub fn vault_matters_reopen_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/matters/{}:reopen", matterId,);
...
pub fn vault_matters_undelete_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/matters/{}:undelete", matterId,);
...
pub fn vault_matters_exports_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/matters/{}/exports", matterId,);
...
pub fn vault_matters_exports_delete_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/matters/{}/exports/{}",
        exportId, matterId,
    );
...
pub fn vault_matters_exports_delete(
    ...
    ApiError,
> {
    let builder = vault_matters_exports_delete_builder(client, exportId, matterId)?;
...
pub fn vault_matters_exports_get(
    ...
    ApiError,
> {
    let builder = vault_matters_exports_get_builder(client, exportId, matterId)?;
...
pub fn vault_matters_holds_add_held_accounts_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/matters/{}/holds/{}:addHeldAccounts",
        holdId, matterId,
    );
...
pub fn vault_matters_holds_add_held_accounts(
    ...
    ApiError,
> {
    let builder = vault_matters_holds_add_held_accounts_builder(client, holdId, matterId, body)?;
...
pub fn vault_matters_holds_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/matters/{}/holds", matterId,);
...
pub fn vault_matters_holds_delete_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/matters/{}/holds/{}",
        holdId, matterId,
    );
...
pub fn vault_matters_holds_delete(
    ...
    ApiError,
> {
    let builder = vault_matters_holds_delete_builder(client, holdId, matterId)?;
...
pub fn vault_matters_holds_get(
    ...
    ApiError,
> {
    let builder = vault_matters_holds_get_builder(client, holdId, matterId, view)?;
...
pub fn vault_matters_holds_remove_held_accounts_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/matters/{}/holds/{}:removeHeldAccounts",
        holdId, matterId,
    );
...
pub fn vault_matters_holds_remove_held_accounts(
    ...
    ApiError,
> {
    let builder = vault_matters_holds_remove_held_accounts_builder(client, holdId, matterId, body)?;
...
pub fn vault_matters_holds_update(
    ...
    ApiError,
> {
    let builder = vault_matters_holds_update_builder(client, holdId, matterId, body)?;
...
pub fn vault_matters_holds_accounts_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/matters/{}/holds/{}/accounts",
        holdId, matterId,
    );
...
pub fn vault_matters_holds_accounts_create(
    ...
    ApiError,
> {
    let builder = vault_matters_holds_accounts_create_builder(client, holdId, matterId, body)?;
...
pub fn vault_matters_holds_accounts_delete(
    ...
    ApiError,
> {
    let builder = vault_matters_holds_accounts_delete_builder(client, accountId, holdId, matterId)?;
...
pub fn vault_matters_holds_accounts_list(
    ...
    ApiError,
> {
    let builder = vault_matters_holds_accounts_list_builder(client, holdId, matterId)?;
...
pub fn vault_matters_saved_queries_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/matters/{}/savedQueries",
        matterId,
    );
