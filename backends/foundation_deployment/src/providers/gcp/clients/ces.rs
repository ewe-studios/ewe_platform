//! Auto-generated API clients for Google Cloud Platform - ces.
//!
...
pub fn ces_projects_locations_apps_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+parent}/apps", parent,);
...
pub fn ces_projects_locations_apps_execute_tool_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+parent}:executeTool", parent,);
...
pub fn ces_projects_locations_apps_export_app_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+name}:exportApp", name,);
...
pub fn ces_projects_locations_apps_import_app_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+parent}/apps:importApp", parent,);
...
/// GET v1/{+parent}:retrieveToolSchema
...
pub fn ces_projects_locations_apps_retrieve_tool_schema_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}:retrieveToolSchema",
        parent,
    );
...
pub fn ces_projects_locations_apps_agents_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+parent}/agents", parent,);
...
pub fn ces_projects_locations_apps_changelogs_list_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+parent}/changelogs", parent,);
...
/// GET v1/{+parent}/conversations:batchDelete
...
pub fn ces_projects_locations_apps_conversations_batch_delete_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/conversations:batchDelete",
        parent,
    );
...
pub fn ces_projects_locations_apps_examples_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+parent}/examples", parent,);
...
pub fn ces_projects_locations_apps_guardrails_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+parent}/guardrails", parent,);
...
pub fn ces_projects_locations_apps_sessions_generate_chat_token_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+name}:generateChatToken", name,);
...
pub fn ces_projects_locations_apps_sessions_run_session_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+session}:runSession", session,);
...
/// GET v1/{+session}:streamRunSession
...
pub fn ces_projects_locations_apps_sessions_stream_run_session_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+session}:streamRunSession",
        session,
    );
...
pub fn ces_projects_locations_apps_tools_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+parent}/tools", parent,);
...
pub fn ces_projects_locations_apps_toolsets_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+parent}/toolsets", parent,);
...
pub fn ces_projects_locations_apps_toolsets_retrieve_tools_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+toolset}:retrieveTools",
        toolset,
    );
