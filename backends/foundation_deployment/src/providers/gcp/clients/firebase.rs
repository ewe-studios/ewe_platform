//! Auto-generated API clients for Google Cloud Platform - firebase.
//!
...
pub fn firebase_available_projects_list_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1beta1/availableProjects",);
...
/// GET v1beta1/{+project}:addFirebase
...
pub fn firebase_projects_add_firebase_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1beta1/{+project}:addFirebase",
        project,
    );
...
/// GET v1beta1/{+parent}:addGoogleAnalytics
...
pub fn firebase_projects_add_google_analytics_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1beta1/{+parent}:addGoogleAnalytics",
        parent,
    );
...
pub fn firebase_projects_list_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1beta1/projects",);
...
/// GET v1beta1/{+parent}:removeAnalytics
...
pub fn firebase_projects_remove_analytics_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1beta1/{+parent}:removeAnalytics",
        parent,
    );
...
pub fn firebase_projects_search_apps_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1beta1/{+parent}:searchApps",
        parent,
    );
...
pub fn firebase_projects_android_apps_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1beta1/{+parent}/androidApps",
        parent,
    );
...
pub fn firebase_projects_android_apps_remove_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1beta1/{+name}:remove", name,);
...
pub fn firebase_projects_android_apps_undelete_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1beta1/{+name}:undelete", name,);
...
pub fn firebase_projects_android_apps_sha_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1beta1/{+parent}/sha", parent,);
...
pub fn firebase_projects_available_locations_list_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1beta1/{+parent}/availableLocations",
        parent,
    );
...
/// GET v1beta1/{+parent}/defaultLocation:finalize
...
pub fn firebase_projects_default_location_finalize_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1beta1/{+parent}/defaultLocation:finalize",
        parent,
    );
...
pub fn firebase_projects_ios_apps_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1beta1/{+parent}/iosApps", parent,);
...
pub fn firebase_projects_web_apps_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1beta1/{+parent}/webApps", parent,);
