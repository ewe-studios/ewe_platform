//! Auto-generated API clients for Google Cloud Platform - cloudsupport.
//!
...
pub fn cloudsupport_case_classifications_search_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv2/caseClassifications:search",);
...
pub fn cloudsupport_cases_close_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv2/{+name}:close", name,);
...
pub fn cloudsupport_cases_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv2/{+parent}/cases", parent,);
...
pub fn cloudsupport_cases_escalate_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv2/{+name}:escalate", name,);
...
pub fn cloudsupport_cases_search_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv2/{+parent}/cases:search", parent,);
...
pub fn cloudsupport_cases_attachments_list_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv2/{+parent}/attachments", parent,);
...
pub fn cloudsupport_cases_comments_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv2/{+parent}/comments", parent,);
...
pub fn cloudsupport_media_download_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv2/{+name}:download", name,);
