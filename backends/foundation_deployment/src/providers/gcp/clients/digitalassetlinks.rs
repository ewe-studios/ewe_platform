...
pub fn digitalassetlinks_assetlinks_bulk_check_builder(
    ...
    // Build URL
    let url = format!("https://digitalassetlinks.googleapis.com/v1/assetlinks:bulkCheck",);
...
pub fn digitalassetlinks_assetlinks_bulk_check_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<BulkCheckResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn digitalassetlinks_assetlinks_check_builder(
    ...
    // Build URL
    let url = format!("https://digitalassetlinks.googleapis.com/v1/assetlinks:check",);
    ...
    if let Some(val) = source_androidApp_packageName {
        query_parts.push(format!("source_androidApp_packageName={}", val));
    }
    if let Some(val) = source_web_site {
        query_parts.push(format!("source_web_site={}", val));
    }
    ...
    if let Some(val) = target_androidApp_packageName {
        query_parts.push(format!("target_androidApp_packageName={}", val));
    }
    if let Some(val) = target_web_site {
        query_parts.push(format!("target_web_site={}", val));
    }
...
pub fn digitalassetlinks_statements_list_builder(
    ...
    // Build URL
    let url = format!("https://digitalassetlinks.googleapis.com/v1/statements:list",);
...
pub fn digitalassetlinks_statements_list_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ListResponse>, ApiError>, P = ApiPending> + Send + 'static,
    ApiError,
> {
    Ok(builder
        .build_send_request()
