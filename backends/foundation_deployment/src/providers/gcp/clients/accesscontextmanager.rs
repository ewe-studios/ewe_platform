...
pub fn accesscontextmanager_access_policies_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/accessPolicies",);
...
pub fn accesscontextmanager_access_policies_access_levels_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+parent}/accessLevels", parent,);
...
pub fn accesscontextmanager_permissions_list_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/permissions",);
...
pub fn accesscontextmanager_services_get_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/services/{}", name,);
...
pub fn accesscontextmanager_services_list_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/services",);
