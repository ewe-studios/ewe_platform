//! Auto-generated API clients for Google Cloud Platform - accesscontextmanager.
//!
...
pub fn accesscontextmanager_access_policies_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/accessPolicies",
    );
...
pub fn accesscontextmanager_access_policies_get_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<AccessPolicy>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = accesscontextmanager_access_policies_get_iam_policy_builder(client, resource, body)?;
...
pub fn accesscontextmanager_access_policies_list_builder(
    ...
    client.get(&url)
        ...
        .query(
            "parent",
            parent.as_ref().map(|s| s.to_string()).unwrap_or_default().as_str(),
        )
}
...
> {
    ...
    let builder = accesscontextmanager_access_policies_list_builder(client, pageSize, pageToken, parent)?;
...
> {
    ...
    let builder = accesscontextmanager_access_policies_patch_builder(client, name, updateMask, body)?;
...
> {
    ...
    let builder = accesscontextmanager_access_policies_set_iam_policy_builder(client, resource, body)?;
...
> {
    ...
    let builder = accesscontextmanager_access_policies_test_iam_permissions_builder(client, resource, body)?;
...
pub fn accesscontextmanager_access_policies_access_levels_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/accessLevels",
        parent,
    );
...
> {
    ...
    let builder = accesscontextmanager_access_policies_access_levels_create_builder(client, parent, body)?;
...
pub fn accesscontextmanager_access_policies_access_levels_get_builder(
    ...
    client.get(&url)
        ...
        .query(
            "accessLevelFormat",
            accessLevelFormat.as_ref().map(|s| s.to_string()).unwrap_or_default().as_str(),
        )
}
...
pub fn accesscontextmanager_access_policies_access_levels_get_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<AccessLevel>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = accesscontextmanager_access_policies_access_levels_get_builder(client, name, accessLevelFormat)?;
...
pub fn accesscontextmanager_access_policies_access_levels_list_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<ListAccessLevelsResponse>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = accesscontextmanager_access_policies_access_levels_list_builder(client, parent, accessLevelFormat, pageSize, pageToken)?;
...
> {
    ...
    let builder = accesscontextmanager_access_policies_access_levels_patch_builder(client, name, updateMask, body)?;
    accesscontextmanager_access_policies_access_levels_patch_execute(builder)
}

/// GET v1/{+parent}/accessLevels:replaceAll
...
pub fn accesscontextmanager_access_policies_access_levels_replace_all_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/accessLevels:replaceAll",
        parent,
    );
...
> {
    ...
    let builder = accesscontextmanager_access_policies_access_levels_replace_all_builder(client, parent, body)?;
...
> {
    ...
    let builder = accesscontextmanager_access_policies_access_levels_test_iam_permissions_builder(client, resource, body)?;
...
pub fn accesscontextmanager_access_policies_authorized_orgs_descs_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/authorizedOrgsDescs",
        parent,
    );
...
> {
    ...
    let builder = accesscontextmanager_access_policies_authorized_orgs_descs_create_builder(client, parent, body)?;
...
> {
    ...
    let builder = accesscontextmanager_access_policies_authorized_orgs_descs_delete_builder(client, name)?;
...
pub fn accesscontextmanager_access_policies_authorized_orgs_descs_get_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<AuthorizedOrgsDesc>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = accesscontextmanager_access_policies_authorized_orgs_descs_get_builder(client, name)?;
...
> {
    ...
    let builder = accesscontextmanager_access_policies_authorized_orgs_descs_list_builder(client, parent, pageSize, pageToken)?;
...
> {
    ...
    let builder = accesscontextmanager_access_policies_authorized_orgs_descs_patch_builder(client, name, updateMask, body)?;
    accesscontextmanager_access_policies_authorized_orgs_descs_patch_execute(builder)
}

/// GET v1/{+parent}/servicePerimeters:commit
...
pub fn accesscontextmanager_access_policies_service_perimeters_commit_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/servicePerimeters:commit",
        parent,
    );
...
> {
    ...
    let builder = accesscontextmanager_access_policies_service_perimeters_commit_builder(client, parent, body)?;
...
pub fn accesscontextmanager_access_policies_service_perimeters_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/servicePerimeters",
        parent,
    );
...
> {
    ...
    let builder = accesscontextmanager_access_policies_service_perimeters_create_builder(client, parent, body)?;
...
> {
    ...
    let builder = accesscontextmanager_access_policies_service_perimeters_delete_builder(client, name)?;
...
pub fn accesscontextmanager_access_policies_service_perimeters_get_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<ServicePerimeter>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = accesscontextmanager_access_policies_service_perimeters_get_builder(client, name)?;
...
> {
    ...
    let builder = accesscontextmanager_access_policies_service_perimeters_list_builder(client, parent, pageSize, pageToken)?;
...
> {
    ...
    let builder = accesscontextmanager_access_policies_service_perimeters_patch_builder(client, name, updateMask, body)?;
    accesscontextmanager_access_policies_service_perimeters_patch_execute(builder)
}

/// GET v1/{+parent}/servicePerimeters:replaceAll
...
pub fn accesscontextmanager_access_policies_service_perimeters_replace_all_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/servicePerimeters:replaceAll",
        parent,
    );
...
> {
    ...
    let builder = accesscontextmanager_access_policies_service_perimeters_replace_all_builder(client, parent, body)?;
...
> {
    ...
    let builder = accesscontextmanager_access_policies_service_perimeters_test_iam_permissions_builder(client, resource, body)?;
...
pub fn accesscontextmanager_operations_cancel_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+name}:cancel",
        name,
    );
...
> {
    ...
    let builder = accesscontextmanager_operations_list_builder(client, name, filter, pageSize, pageToken, returnPartialSuccess)?;
...
pub fn accesscontextmanager_organizations_gcp_user_access_bindings_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/gcpUserAccessBindings",
        parent,
    );
...
> {
    ...
    let builder = accesscontextmanager_organizations_gcp_user_access_bindings_create_builder(client, parent, body)?;
...
> {
    ...
    let builder = accesscontextmanager_organizations_gcp_user_access_bindings_delete_builder(client, name)?;
...
pub fn accesscontextmanager_organizations_gcp_user_access_bindings_get_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<GcpUserAccessBinding>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = accesscontextmanager_organizations_gcp_user_access_bindings_get_builder(client, name)?;
...
> {
    ...
    let builder = accesscontextmanager_organizations_gcp_user_access_bindings_list_builder(client, parent, pageSize, pageToken)?;
...
pub fn accesscontextmanager_organizations_gcp_user_access_bindings_patch_builder(
    ...
    client.get(&url)
        ...
        .query(
            "append",
            append.as_ref().map(|s| s.to_string()).unwrap_or_default().as_str(),
        )
...
> {
    ...
    let builder = accesscontextmanager_organizations_gcp_user_access_bindings_patch_builder(client, name, append, updateMask, body)?;
...
pub fn accesscontextmanager_permissions_list_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/permissions",
    );
...
pub fn accesscontextmanager_services_get_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/services/{}",
        name,
    );
...
pub fn accesscontextmanager_services_get_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<SupportedService>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
