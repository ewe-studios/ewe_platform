...
pub fn parametermanager_projects_locations_parameters_create_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<Parameter>, ApiError>, P = ApiPending> + Send + 'static,
    ApiError,
> {
    Ok(builder
        .build_send_request()
...
pub fn parametermanager_projects_locations_parameters_list_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ListParametersResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn parametermanager_projects_locations_parameters_versions_create_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ParameterVersion>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
