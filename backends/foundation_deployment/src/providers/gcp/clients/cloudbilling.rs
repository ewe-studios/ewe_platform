//! Auto-generated API clients for Google Cloud Platform - cloudbilling.
//!
...
pub fn cloudbilling_billing_accounts_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/billingAccounts",);
...
pub fn cloudbilling_billing_accounts_projects_list_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+name}/projects", name,);
...
pub fn cloudbilling_billing_accounts_sub_accounts_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+parent}/subAccounts", parent,);
...
pub fn cloudbilling_organizations_billing_accounts_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/billingAccounts",
        parent,
    );
...
pub fn cloudbilling_organizations_billing_accounts_move_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+destinationParent}/{+name}:move",
...
pub fn cloudbilling_projects_get_billing_info_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+name}/billingInfo", name,);
