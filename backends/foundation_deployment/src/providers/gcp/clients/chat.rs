...
//!
//! Feature flag: `gcp/chat`

#![cfg(feature = "gcp/chat")]
...
pub fn chat_custom_emojis_create_builder(
    ...
    // Build URL
    let url = format!("https://chat.googleapis.com/v1/customEmojis",);
...
pub fn chat_custom_emojis_delete_builder(
    ...
    // Build URL
    let url = format!("https://chat.googleapis.com/v1/customEmojis/{}", name,);
...
pub fn chat_media_download_builder(
    ...
    // Build URL
    let url = format!("https://chat.googleapis.com/v1/media/{}", resourceName,);
...
pub fn chat_spaces_create_builder(
    ...
    // Build URL
    let url = format!("https://chat.googleapis.com/v1/spaces",);
...
pub fn chat_spaces_delete_builder(
    ...
    // Build URL
    let url = format!("https://chat.googleapis.com/v1/spaces/{}", name,);
...
pub fn chat_spaces_find_direct_message_builder(
    ...
    // Build URL
    let url = format!("https://chat.googleapis.com/v1/spaces:findDirectMessage",);
...
pub fn chat_spaces_search_builder(
    ...
    // Build URL
    let url = format!("https://chat.googleapis.com/v1/spaces:search",);
...
pub fn chat_spaces_setup_builder(
    ...
    // Build URL
    let url = format!("https://chat.googleapis.com/v1/spaces:setup",);
...
pub fn chat_spaces_members_create_builder(
    ...
    // Build URL
    let url = format!("https://chat.googleapis.com/v1/spaces/{}/members", parent,);
...
pub fn chat_spaces_members_delete_builder(
    ...
    // Build URL
    let url = format!("https://chat.googleapis.com/v1/spaces/{}/members/{}", name,);
...
pub fn chat_spaces_members_list_builder(
    ...
    if let Some(val) = showGroups {
        query_parts.push(format!("showGroups={}", val));
    }
    if let Some(val) = showInvited {
...
pub fn chat_spaces_messages_create_builder(
    ...
    // Build URL
    let url = format!("https://chat.googleapis.com/v1/spaces/{}/messages", parent,);
...
pub fn chat_spaces_messages_delete_builder(
    ...
    // Build URL
    let url = format!("https://chat.googleapis.com/v1/spaces/{}/messages/{}", name,);
...
pub fn chat_spaces_messages_attachments_get_builder(
    ...
    // Build URL
    let url = format!(
        "https://chat.googleapis.com/v1/spaces/{}/messages/{}/attachments/{}",
        name,
    );
...
pub fn chat_spaces_messages_reactions_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://chat.googleapis.com/v1/spaces/{}/messages/{}/reactions",
        parent,
    );
...
/// GET v1/spaces/{spacesId}/messages/{messagesId}/reactions/{reactionsId}
...
pub fn chat_users_sections_create_builder(
    ...
    // Build URL
    let url = format!("https://chat.googleapis.com/v1/users/{}/sections", parent,);
...
/// GET v1/users/{usersId}/sections/{sectionsId}
...
pub fn chat_users_sections_delete_builder(
    ...
    // Build URL
    let url = format!("https://chat.googleapis.com/v1/users/{}/sections/{}", name,);
...
/// GET v1/users/{usersId}/sections/{sectionsId}:position
...
pub fn chat_users_sections_position_builder(
    ...
    // Build URL
    let url = format!(
        "https://chat.googleapis.com/v1/users/{}/sections/{}:position",
        name,
    );
...
pub fn chat_users_sections_items_list_builder(
    ...
    // Build URL
    let url = format!(
        "https://chat.googleapis.com/v1/users/{}/sections/{}/items",
        parent,
    );
...
/// GET v1/users/{usersId}/sections/{sectionsId}/items/{itemsId}:move
...
pub fn chat_users_sections_items_move_builder(
    ...
    // Build URL
    let url = format!(
        "https://chat.googleapis.com/v1/users/{}/sections/{}/items/{}:move",
        name,
    );
...
pub fn chat_users_spaces_get_space_read_state_builder(
    ...
    // Build URL
    let url = format!(
        "https://chat.googleapis.com/v1/users/{}/spaces/{}/spaceReadState",
        name,
    );
...
pub fn chat_users_spaces_space_notification_setting_get_builder(
    ...
    // Build URL
    let url = format!(
        "https://chat.googleapis.com/v1/users/{}/spaces/{}/spaceNotificationSetting",
        name,
    );
...
pub fn chat_users_spaces_threads_get_thread_read_state_builder(
    ...
    // Build URL
    let url = format!(
        "https://chat.googleapis.com/v1/users/{}/spaces/{}/threads/{}/threadReadState",
        name,
    );
