...
pub fn chat_custom_emojis_create_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<CustomEmoji>, ApiError>, P = ApiPending> + Send + 'static,
    ApiError,
> {
    Ok(builder
        .build_send_request()
...
pub fn chat_custom_emojis_list_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ListCustomEmojisResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn chat_media_upload_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<UploadAttachmentResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn chat_spaces_complete_import_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<CompleteImportSpaceResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn chat_spaces_create(
    ...
    ApiError,
> {
    let builder = chat_spaces_create_builder(client, args.requestId.as_deref(), &args.body)?;
...
pub fn chat_spaces_find_direct_message(
    ...
    ApiError,
> {
    let builder = chat_spaces_find_direct_message_builder(client, args.name.as_deref())?;
...
pub fn chat_spaces_list_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ListSpacesResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn chat_spaces_search_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<SearchSpacesResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub struct ChatSpacesMembersListArgs {
    ...
    pub showGroups: Option<bool>,
    /// Query parameter: showInvited
    pub showInvited: Option<bool>,
    /// Query parameter: useAdminAccess
    pub useAdminAccess: Option<bool>,
}
...
> {
    let builder = chat_spaces_messages_create_builder(
        client,
        &args.parent,
        args.messageId.as_deref(),
        args.messageReplyOption.as_deref(),
        args.requestId.as_deref(),
        args.threadKey.as_deref(),
        &args.body,
    )?;
...
pub fn chat_spaces_messages_reactions_create_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<Reaction>, ApiError>, P = ApiPending> + Send + 'static,
    ApiError,
> {
    Ok(builder
        .build_send_request()
...
pub fn chat_spaces_messages_reactions_create(
    ...
    ApiError,
> {
    let builder = chat_spaces_messages_reactions_create_builder(client, &args.parent, &args.body)?;
...
pub fn chat_spaces_messages_reactions_list_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ListReactionsResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn chat_spaces_space_events_get_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<SpaceEvent>, ApiError>, P = ApiPending> + Send + 'static,
    ApiError,
> {
    Ok(builder
        .build_send_request()
...
pub fn chat_spaces_space_events_list_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ListSpaceEventsResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn chat_users_sections_create_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<GoogleChatV1Section>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn chat_users_sections_list_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ListSectionsResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn chat_users_sections_position_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<PositionSectionResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn chat_users_sections_position(
    ...
    ApiError,
> {
    let builder = chat_users_sections_position_builder(client, &args.name, &args.body)?;
...
pub fn chat_users_sections_items_list_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ListSectionItemsResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn chat_users_sections_items_move_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<MoveSectionItemResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn chat_users_sections_items_move(
    ...
    ApiError,
> {
    let builder = chat_users_sections_items_move_builder(client, &args.name, &args.body)?;
...
pub fn chat_users_spaces_get_space_read_state_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<SpaceReadState>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn chat_users_spaces_space_notification_setting_get_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<SpaceNotificationSetting>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn chat_users_spaces_threads_get_thread_read_state_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ThreadReadState>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
