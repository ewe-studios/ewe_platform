...
pub fn containeranalysis_projects_locations_notes_batch_create_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<BatchCreateNotesResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn containeranalysis_projects_locations_notes_occurrences_list_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ListNoteOccurrencesResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn containeranalysis_projects_locations_occurrences_create_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<Occurrence>, ApiError>, P = ApiPending> + Send + 'static,
    ApiError,
> {
    Ok(builder
        .build_send_request()
...
pub fn containeranalysis_projects_locations_occurrences_list_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ListOccurrencesResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn containeranalysis_projects_locations_resources_export_sbom_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ExportSBOMResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
