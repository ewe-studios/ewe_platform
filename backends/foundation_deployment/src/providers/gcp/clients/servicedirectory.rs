...
//!
//! Feature flag: `gcp/servicedirectory`

#![cfg(feature = "gcp/servicedirectory")]
...
pub fn servicedirectory_projects_locations_namespaces_get_iam_policy_builder(
    ...
    // Build URL
    let url = format!(
        "https://servicedirectory.googleapis.com/v1/projects/{}/locations/{}/namespaces/{}:getIamPolicy",
        resource,
    );
...
pub fn servicedirectory_projects_locations_namespaces_set_iam_policy_builder(
    ...
    // Build URL
    let url = format!(
        "https://servicedirectory.googleapis.com/v1/projects/{}/locations/{}/namespaces/{}:setIamPolicy",
        resource,
    );
...
pub fn servicedirectory_projects_locations_namespaces_test_iam_permissions_builder(
    ...
    // Build URL
    let url = format!(
        "https://servicedirectory.googleapis.com/v1/projects/{}/locations/{}/namespaces/{}:testIamPermissions",
        resource,
    );
...
pub fn servicedirectory_projects_locations_namespaces_services_get_iam_policy_builder(
    ...
    // Build URL
    let url = format!(
        "https://servicedirectory.googleapis.com/v1/projects/{}/locations/{}/namespaces/{}/services/{}:getIamPolicy",
        resource,
    );
...
pub fn servicedirectory_projects_locations_namespaces_services_resolve_builder(
    ...
    // Build URL
    let url = format!(
        "https://servicedirectory.googleapis.com/v1/projects/{}/locations/{}/namespaces/{}/services/{}:resolve",
        name,
    );
...
pub fn servicedirectory_projects_locations_namespaces_services_set_iam_policy_builder(
    ...
    // Build URL
    let url = format!(
        "https://servicedirectory.googleapis.com/v1/projects/{}/locations/{}/namespaces/{}/services/{}:setIamPolicy",
        resource,
    );
...
pub fn servicedirectory_projects_locations_namespaces_services_test_iam_permissions_builder(
    ...
    // Build URL
    let url = format!(
        "https://servicedirectory.googleapis.com/v1/projects/{}/locations/{}/namespaces/{}/services/{}:testIamPermissions",
        resource,
    );
...
pub fn servicedirectory_projects_locations_namespaces_services_endpoints_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://servicedirectory.googleapis.com/v1/projects/{}/locations/{}/namespaces/{}/services/{}/endpoints",
        parent,
    );
