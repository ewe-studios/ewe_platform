...
pub fn servicedirectory_projects_locations_namespaces_create_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<Namespace>, ApiError>, P = ApiPending> + Send + 'static,
    ApiError,
> {
    Ok(builder
        .build_send_request()
...
pub fn servicedirectory_projects_locations_namespaces_list_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ListNamespacesResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn servicedirectory_projects_locations_namespaces_services_resolve_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ResolveServiceResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
