//! Auto-generated API clients for Google Cloud Platform - analytics.
//!
...
pub fn analytics_data_ga_get_builder(
    ...
    client.get(&url)
        ...
        .query(
            "end_date",
            end_date.as_ref().map(|s| s.to_string()).unwrap_or_default().as_str(),
        )
        ...
        .query(
            "ids",
            ids.as_ref().map(|s| s.to_string()).unwrap_or_default().as_str(),
        )

        .query(
            "include_empty_rows",
            include_empty_rows.as_ref().map(|s| s.to_string()).unwrap_or_default().as_str(),
        )

        .query(
            "max_results",
            max_results.as_ref().map(|s| s.to_string()).unwrap_or_default().as_str(),
        )
        ...
        .query(
            "output",
            output.as_ref().map(|s| s.to_string()).unwrap_or_default().as_str(),
        )

        .query(
            "samplingLevel",
            samplingLevel.as_ref().map(|s| s.to_string()).unwrap_or_default().as_str(),
        )

        .query(
            "segment",
            segment.as_ref().map(|s| s.to_string()).unwrap_or_default().as_str(),
        )

        .query(
            "sort",
            sort.as_ref().map(|s| s.to_string()).unwrap_or_default().as_str(),
        )

        .query(
            "start_date",
            start_date.as_ref().map(|s| s.to_string()).unwrap_or_default().as_str(),
        )

        .query(
            "start_index",
            start_index.as_ref().map(|s| s.to_string()).unwrap_or_default().as_str(),
        )
}
...
pub fn analytics_data_ga_get_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<GaData>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_data_ga_get_builder(client, dimensions, end_date, filters, ids, include_empty_rows, max_results, metrics, output, samplingLevel, segment, sort, start_date, start_index)?;
...
pub fn analytics_data_mcf_get_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<McfData>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_data_mcf_get_builder(client, dimensions, end_date, filters, ids, max_results, metrics, samplingLevel, sort, start_date, start_index)?;
...
pub fn analytics_data_realtime_get_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comdata/realtime",
    );
...
pub fn analytics_data_realtime_get_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<RealtimeData>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_data_realtime_get_builder(client, dimensions, filters, ids, max_results, metrics, sort)?;
...
pub fn analytics_management_account_summaries_list_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.commanagement/accountSummaries",
    );
...
pub fn analytics_management_account_summaries_list_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<AccountSummaries>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_management_account_summaries_list_builder(client, max_results, start_index)?;
...
> {
    ...
    let builder = analytics_management_account_user_links_delete_builder(client, accountId, linkId)?;
...
pub fn analytics_management_account_user_links_insert_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<EntityUserLink>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
pub fn analytics_management_account_user_links_list_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<EntityUserLinks>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_management_account_user_links_list_builder(client, accountId, max_results, start_index)?;
...
> {
    ...
    let builder = analytics_management_account_user_links_update_builder(client, accountId, linkId, body)?;
...
pub fn analytics_management_accounts_list_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.commanagement/accounts",
    );
...
pub fn analytics_management_accounts_list_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<Accounts>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
pub fn analytics_management_client_id_hash_client_id_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.commanagement/clientId:hashClientId",
    );
...
pub fn analytics_management_client_id_hash_client_id_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<HashClientIdResponse>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
pub fn analytics_management_custom_data_sources_list_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<CustomDataSources>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_management_custom_data_sources_list_builder(client, accountId, webPropertyId, max_results, start_index)?;
...
pub fn analytics_management_custom_dimensions_get_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<CustomDimension>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_management_custom_dimensions_get_builder(client, accountId, customDimensionId, webPropertyId)?;
...
> {
    ...
    let builder = analytics_management_custom_dimensions_insert_builder(client, accountId, webPropertyId, body)?;
...
pub fn analytics_management_custom_dimensions_list_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<CustomDimensions>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_management_custom_dimensions_list_builder(client, accountId, webPropertyId, max_results, start_index)?;
...
pub fn analytics_management_custom_dimensions_patch_builder(
    ...
    client.get(&url)
        ...
        .query(
            ...
            ignoreCustomDataSourceLinks.as_ref().map(|s| s.to_string()).unwrap_or_default().as_str(),
        )
...
> {
    ...
    let builder = analytics_management_custom_dimensions_patch_builder(client, accountId, customDimensionId, webPropertyId, ignoreCustomDataSourceLinks, body)?;
...
> {
    ...
    let builder = analytics_management_custom_dimensions_update_builder(client, accountId, customDimensionId, webPropertyId, ignoreCustomDataSourceLinks, body)?;
...
pub fn analytics_management_custom_metrics_get_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<CustomMetric>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_management_custom_metrics_get_builder(client, accountId, customMetricId, webPropertyId)?;
...
> {
    ...
    let builder = analytics_management_custom_metrics_insert_builder(client, accountId, webPropertyId, body)?;
...
pub fn analytics_management_custom_metrics_list_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<CustomMetrics>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_management_custom_metrics_list_builder(client, accountId, webPropertyId, max_results, start_index)?;
...
> {
    ...
    let builder = analytics_management_custom_metrics_patch_builder(client, accountId, customMetricId, webPropertyId, ignoreCustomDataSourceLinks, body)?;
...
> {
    ...
    let builder = analytics_management_custom_metrics_update_builder(client, accountId, customMetricId, webPropertyId, ignoreCustomDataSourceLinks, body)?;
...
> {
    ...
    let builder = analytics_management_experiments_delete_builder(client, accountId, experimentId, profileId, webPropertyId)?;
...
pub fn analytics_management_experiments_get_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<Experiment>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_management_experiments_get_builder(client, accountId, experimentId, profileId, webPropertyId)?;
...
> {
    ...
    let builder = analytics_management_experiments_insert_builder(client, accountId, profileId, webPropertyId, body)?;
...
pub fn analytics_management_experiments_list_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<Experiments>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_management_experiments_list_builder(client, accountId, profileId, webPropertyId, max_results, start_index)?;
...
> {
    ...
    let builder = analytics_management_experiments_patch_builder(client, accountId, experimentId, profileId, webPropertyId, body)?;
...
> {
    ...
    let builder = analytics_management_experiments_update_builder(client, accountId, experimentId, profileId, webPropertyId, body)?;
...
pub fn analytics_management_filters_delete_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<Filter>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
pub fn analytics_management_filters_list_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<Filters>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_management_filters_list_builder(client, accountId, max_results, start_index)?;
...
pub fn analytics_management_goals_get_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<Goal>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_management_goals_get_builder(client, accountId, goalId, profileId, webPropertyId)?;
...
> {
    ...
    let builder = analytics_management_goals_insert_builder(client, accountId, profileId, webPropertyId, body)?;
...
pub fn analytics_management_goals_list_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<Goals>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_management_goals_list_builder(client, accountId, profileId, webPropertyId, max_results, start_index)?;
...
> {
    ...
    let builder = analytics_management_goals_patch_builder(client, accountId, goalId, profileId, webPropertyId, body)?;
...
> {
    ...
    let builder = analytics_management_goals_update_builder(client, accountId, goalId, profileId, webPropertyId, body)?;
...
> {
    ...
    let builder = analytics_management_profile_filter_links_delete_builder(client, accountId, linkId, profileId, webPropertyId)?;
...
pub fn analytics_management_profile_filter_links_get_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<ProfileFilterLink>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_management_profile_filter_links_get_builder(client, accountId, linkId, profileId, webPropertyId)?;
...
> {
    ...
    let builder = analytics_management_profile_filter_links_insert_builder(client, accountId, profileId, webPropertyId, body)?;
...
pub fn analytics_management_profile_filter_links_list_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<ProfileFilterLinks>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_management_profile_filter_links_list_builder(client, accountId, profileId, webPropertyId, max_results, start_index)?;
...
> {
    ...
    let builder = analytics_management_profile_filter_links_patch_builder(client, accountId, linkId, profileId, webPropertyId, body)?;
...
> {
    ...
    let builder = analytics_management_profile_filter_links_update_builder(client, accountId, linkId, profileId, webPropertyId, body)?;
...
> {
    ...
    let builder = analytics_management_profile_user_links_delete_builder(client, accountId, linkId, profileId, webPropertyId)?;
...
> {
    ...
    let builder = analytics_management_profile_user_links_insert_builder(client, accountId, profileId, webPropertyId, body)?;
...
> {
    ...
    let builder = analytics_management_profile_user_links_list_builder(client, accountId, profileId, webPropertyId, max_results, start_index)?;
...
> {
    ...
    let builder = analytics_management_profile_user_links_update_builder(client, accountId, linkId, profileId, webPropertyId, body)?;
...
> {
    ...
    let builder = analytics_management_profiles_delete_builder(client, accountId, profileId, webPropertyId)?;
...
pub fn analytics_management_profiles_get_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<Profile>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_management_profiles_get_builder(client, accountId, profileId, webPropertyId)?;
...
> {
    ...
    let builder = analytics_management_profiles_insert_builder(client, accountId, webPropertyId, body)?;
...
pub fn analytics_management_profiles_list_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<Profiles>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_management_profiles_list_builder(client, accountId, webPropertyId, max_results, start_index)?;
...
> {
    ...
    let builder = analytics_management_profiles_patch_builder(client, accountId, profileId, webPropertyId, body)?;
...
> {
    ...
    let builder = analytics_management_profiles_update_builder(client, accountId, profileId, webPropertyId, body)?;
...
> {
    ...
    let builder = analytics_management_remarketing_audience_delete_builder(client, accountId, remarketingAudienceId, webPropertyId)?;
...
pub fn analytics_management_remarketing_audience_get_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<RemarketingAudience>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_management_remarketing_audience_get_builder(client, accountId, remarketingAudienceId, webPropertyId)?;
...
> {
    ...
    let builder = analytics_management_remarketing_audience_insert_builder(client, accountId, webPropertyId, body)?;
...
pub fn analytics_management_remarketing_audience_list_builder(
    ...
    client.get(&url)
        ...
        .query(
            "type",
            type_rs.as_ref().map(|s| s.to_string()).unwrap_or_default().as_str(),
        )
}
...
pub fn analytics_management_remarketing_audience_list_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<RemarketingAudiences>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_management_remarketing_audience_list_builder(client, accountId, webPropertyId, max_results, start_index, type_rs)?;
...
> {
    ...
    let builder = analytics_management_remarketing_audience_patch_builder(client, accountId, remarketingAudienceId, webPropertyId, body)?;
...
> {
    ...
    let builder = analytics_management_remarketing_audience_update_builder(client, accountId, remarketingAudienceId, webPropertyId, body)?;
...
pub fn analytics_management_segments_list_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.commanagement/segments",
    );
...
pub fn analytics_management_segments_list_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<Segments>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_management_unsampled_reports_delete_builder(client, accountId, profileId, unsampledReportId, webPropertyId)?;
...
pub fn analytics_management_unsampled_reports_get_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<UnsampledReport>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_management_unsampled_reports_get_builder(client, accountId, profileId, unsampledReportId, webPropertyId)?;
...
> {
    ...
    let builder = analytics_management_unsampled_reports_insert_builder(client, accountId, profileId, webPropertyId, body)?;
...
pub fn analytics_management_unsampled_reports_list_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<UnsampledReports>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_management_unsampled_reports_list_builder(client, accountId, profileId, webPropertyId, max_results, start_index)?;
...
> {
    ...
    let builder = analytics_management_uploads_delete_upload_data_builder(client, accountId, customDataSourceId, webPropertyId, body)?;
...
pub fn analytics_management_uploads_get_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<Upload>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_management_uploads_get_builder(client, accountId, customDataSourceId, uploadId, webPropertyId)?;
...
pub fn analytics_management_uploads_list_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<Uploads>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_management_uploads_list_builder(client, accountId, customDataSourceId, webPropertyId, max_results, start_index)?;
...
> {
    ...
    let builder = analytics_management_uploads_upload_data_builder(client, accountId, customDataSourceId, webPropertyId)?;
...
> {
    ...
    let builder = analytics_management_web_property_ad_words_links_delete_builder(client, accountId, webPropertyAdWordsLinkId, webPropertyId)?;
...
pub fn analytics_management_web_property_ad_words_links_get_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<EntityAdWordsLink>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_management_web_property_ad_words_links_get_builder(client, accountId, webPropertyAdWordsLinkId, webPropertyId)?;
...
> {
    ...
    let builder = analytics_management_web_property_ad_words_links_insert_builder(client, accountId, webPropertyId, body)?;
...
pub fn analytics_management_web_property_ad_words_links_list_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<EntityAdWordsLinks>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_management_web_property_ad_words_links_list_builder(client, accountId, webPropertyId, max_results, start_index)?;
...
> {
    ...
    let builder = analytics_management_web_property_ad_words_links_patch_builder(client, accountId, webPropertyAdWordsLinkId, webPropertyId, body)?;
...
> {
    ...
    let builder = analytics_management_web_property_ad_words_links_update_builder(client, accountId, webPropertyAdWordsLinkId, webPropertyId, body)?;
...
pub fn analytics_management_webproperties_get_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<Webproperty>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
pub fn analytics_management_webproperties_list_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<Webproperties>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
> {
    ...
    let builder = analytics_management_webproperties_list_builder(client, accountId, max_results, start_index)?;
...
> {
    ...
    let builder = analytics_management_webproperties_patch_builder(client, accountId, webPropertyId, body)?;
...
> {
    ...
    let builder = analytics_management_webproperties_update_builder(client, accountId, webPropertyId, body)?;
...
> {
    ...
    let builder = analytics_management_webproperty_user_links_delete_builder(client, accountId, linkId, webPropertyId)?;
...
> {
    ...
    let builder = analytics_management_webproperty_user_links_insert_builder(client, accountId, webPropertyId, body)?;
...
> {
    ...
    let builder = analytics_management_webproperty_user_links_list_builder(client, accountId, webPropertyId, max_results, start_index)?;
...
> {
    ...
    let builder = analytics_management_webproperty_user_links_update_builder(client, accountId, linkId, webPropertyId, body)?;
...
pub fn analytics_metadata_columns_list_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.commetadata/{}/columns",
        reportType,
    );
...
pub fn analytics_metadata_columns_list_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<Columns>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
pub fn analytics_provisioning_create_account_ticket_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comprovisioning/createAccountTicket",
    );
...
pub fn analytics_provisioning_create_account_ticket_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<AccountTicket>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
pub fn analytics_provisioning_create_account_tree_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comprovisioning/createAccountTree",
    );
...
pub fn analytics_provisioning_create_account_tree_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<AccountTreeResponse>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
...
pub fn analytics_user_deletion_user_deletion_request_upsert_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comuserDeletion/userDeletionRequests:upsert",
    );
...
pub fn analytics_user_deletion_user_deletion_request_upsert_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<UserDeletionRequest>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
