//! Auto-generated API clients for Google Cloud Platform - gmailpostmastertools.
//!
...
pub fn gmailpostmastertools_domain_stats_batch_query_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv2/domainStats:batchQuery",);
...
pub fn gmailpostmastertools_domains_list_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv2/domains",);
...
/// GET v2/{+parent}/domainStats:query
...
pub fn gmailpostmastertools_domains_domain_stats_query_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv2/{+parent}/domainStats:query",
        parent,
    );
