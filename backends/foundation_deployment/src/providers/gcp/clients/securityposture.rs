...
pub fn securityposture_organizations_locations_posture_deployments_get_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<PostureDeployment>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn securityposture_organizations_locations_posture_templates_get_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<PostureTemplate>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn securityposture_organizations_locations_postures_get_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<Posture>, ApiError>, P = ApiPending> + Send + 'static,
    ApiError,
> {
    Ok(builder
        .build_send_request()
...
pub fn securityposture_organizations_locations_postures_list_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ListPosturesResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
