//! Auto-generated API clients for Google Cloud Platform - servicemanagement.
//!
...
pub fn servicemanagement_services_delete_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/services/{}", serviceName,);
...
pub fn servicemanagement_services_generate_config_report_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/services:generateConfigReport",);
...
pub fn servicemanagement_services_get_config_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/services/{}/config", serviceName,);
...
pub fn servicemanagement_services_undelete_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/services/{}:undelete",
        serviceName,
    );
...
pub fn servicemanagement_services_configs_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/services/{}/configs", serviceName,);
...
pub fn servicemanagement_services_configs_get_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/services/{}/configs/{}",
...
> {
    let builder =
        servicemanagement_services_configs_get_builder(client, configId, serviceName, view)?;
...
pub fn servicemanagement_services_configs_submit_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/services/{}/configs:submit",
        serviceName,
    );
...
pub fn servicemanagement_services_rollouts_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/services/{}/rollouts",
        serviceName,
    );
...
pub fn servicemanagement_services_rollouts_get(
    ...
    ApiError,
> {
    let builder = servicemanagement_services_rollouts_get_builder(client, rolloutId, serviceName)?;
