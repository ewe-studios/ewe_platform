...
pub fn reports_activities_list_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<Activities>, ApiError>, P = ApiPending> + Send + 'static,
    ApiError,
> {
    Ok(builder
        .build_send_request()
...
pub fn reports_customer_usage_reports_get_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<UsageReports>, ApiError>, P = ApiPending> + Send + 'static,
    ApiError,
> {
    Ok(builder
        .build_send_request()
