//! Auto-generated API clients for Google Cloud Platform - doubleclickbidmanager.
//!
...
pub fn doubleclickbidmanager_queries_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comqueries",);
...
pub fn doubleclickbidmanager_queries_delete_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comqueries/{}", queryId,);
...
pub fn doubleclickbidmanager_queries_run_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comqueries/{}:run", queryId,);
...
pub fn doubleclickbidmanager_queries_reports_get_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comqueries/{}/reports/{}",
        queryId, reportId,
    );
...
pub fn doubleclickbidmanager_queries_reports_list_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comqueries/{}/reports", queryId,);
