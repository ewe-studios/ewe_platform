//! Auto-generated API clients for Google Cloud Platform - travelimpactmodel.
//!
...
pub fn travelimpactmodel_flights_compute_flight_emissions_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/flights:computeFlightEmissions",);
...
/// For customization, use `travelimpactmodel_flights_compute_flight_emissions_builder()` then pass to this function.
///
/// # Arguments
///
/// * `builder` - ClientRequestBuilder from travelimpactmodel_flights_compute_flight_emissions_builder()
///
/// # Errors
///
...
pub fn travelimpactmodel_flights_compute_flight_emissions(
    ...
    ApiError,
> {
    let builder = travelimpactmodel_flights_compute_flight_emissions_builder(client, body)?;
...
pub fn travelimpactmodel_flights_compute_scope3_flight_emissions_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/flights:computeScope3FlightEmissions",);
...
///
/// Takes a `ClientRequestBuilder`, builds and executes the request.
/// For customization, use `travelimpactmodel_flights_compute_scope3_flight_emissions_builder()` then pass to this function.
///
/// # Arguments
///
/// * `builder` - ClientRequestBuilder from travelimpactmodel_flights_compute_scope3_flight_emissions_builder()
///
/// # Errors
///
/// Returns an error if the request cannot be built.
...
pub fn travelimpactmodel_flights_compute_scope3_flight_emissions(
    ...
    ApiError,
> {
    let builder = travelimpactmodel_flights_compute_scope3_flight_emissions_builder(client, body)?;
...
pub fn travelimpactmodel_flights_compute_typical_flight_emissions_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/flights:computeTypicalFlightEmissions",);
...
///
/// Takes a `ClientRequestBuilder`, builds and executes the request.
/// For customization, use `travelimpactmodel_flights_compute_typical_flight_emissions_builder()` then pass to this function.
///
/// # Arguments
///
/// * `builder` - ClientRequestBuilder from travelimpactmodel_flights_compute_typical_flight_emissions_builder()
///
/// # Errors
///
/// Returns an error if the request cannot be built.
...
pub fn travelimpactmodel_flights_compute_typical_flight_emissions(
    ...
    ApiError,
> {
    let builder = travelimpactmodel_flights_compute_typical_flight_emissions_builder(client, body)?;
