//! Auto-generated API clients for Google Cloud Platform - realtimebidding.
//!
...
pub fn realtimebidding_bidders_list_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/bidders",);
...
pub fn realtimebidding_bidders_creatives_list_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+parent}/creatives", parent,);
...
pub fn realtimebidding_bidders_creatives_watch_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/creatives:watch",
        parent,
    );
...
/// GET v1/{+pretargetingConfig}:addTargetedApps
...
pub fn realtimebidding_bidders_pretargeting_configs_add_targeted_apps_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+pretargetingConfig}:addTargetedApps",
        pretargetingConfig,
    );
...
/// GET v1/{+pretargetingConfig}:addTargetedPublishers
...
pub fn realtimebidding_bidders_pretargeting_configs_add_targeted_publishers_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+pretargetingConfig}:addTargetedPublishers",
        pretargetingConfig,
    );
...
/// GET v1/{+pretargetingConfig}:addTargetedSites
...
pub fn realtimebidding_bidders_pretargeting_configs_add_targeted_sites_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+pretargetingConfig}:addTargetedSites",
        pretargetingConfig,
    );
...
pub fn realtimebidding_bidders_pretargeting_configs_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/pretargetingConfigs",
        parent,
    );
...
/// GET v1/{+pretargetingConfig}:removeTargetedApps
...
pub fn realtimebidding_bidders_pretargeting_configs_remove_targeted_apps_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+pretargetingConfig}:removeTargetedApps",
        pretargetingConfig,
    );
...
/// GET v1/{+pretargetingConfig}:removeTargetedPublishers
...
pub fn realtimebidding_bidders_pretargeting_configs_remove_targeted_publishers_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+pretargetingConfig}:removeTargetedPublishers",
        pretargetingConfig,
    );
...
/// GET v1/{+pretargetingConfig}:removeTargetedSites
...
pub fn realtimebidding_bidders_pretargeting_configs_remove_targeted_sites_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+pretargetingConfig}:removeTargetedSites",
        pretargetingConfig,
    );
...
/// GET v1/{+parent}/publisherConnections:batchApprove
...
pub fn realtimebidding_bidders_publisher_connections_batch_approve_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/publisherConnections:batchApprove",
        parent,
    );
...
/// GET v1/{+parent}/publisherConnections:batchReject
...
pub fn realtimebidding_bidders_publisher_connections_batch_reject_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/publisherConnections:batchReject",
        parent,
    );
...
pub fn realtimebidding_bidders_publisher_connections_list_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/publisherConnections",
        parent,
    );
...
pub fn realtimebidding_buyers_get_remarketing_tag_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+name}:getRemarketingTag", name,);
...
pub fn realtimebidding_buyers_list_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/buyers",);
