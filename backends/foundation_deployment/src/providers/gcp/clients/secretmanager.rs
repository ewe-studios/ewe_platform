...
pub fn secretmanager_projects_locations_secrets_add_version_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<SecretVersion>, ApiError>, P = ApiPending> + Send + 'static,
    ApiError,
> {
    Ok(builder
        .build_send_request()
...
pub fn secretmanager_projects_locations_secrets_create_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<Secret>, ApiError>, P = ApiPending> + Send + 'static,
    ApiError,
> {
    Ok(builder
        .build_send_request()
...
pub fn secretmanager_projects_locations_secrets_list_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ListSecretsResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn secretmanager_projects_locations_secrets_versions_access_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<AccessSecretVersionResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn secretmanager_projects_locations_secrets_versions_list_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ListSecretVersionsResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
