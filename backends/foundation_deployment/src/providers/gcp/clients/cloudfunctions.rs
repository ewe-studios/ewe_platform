...
pub fn cloudfunctions_projects_locations_functions_generate_download_url_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<GenerateDownloadUrlResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn cloudfunctions_projects_locations_functions_generate_upload_url_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<GenerateUploadUrlResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn cloudfunctions_projects_locations_functions_get_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<Function>, ApiError>, P = ApiPending> + Send + 'static,
    ApiError,
> {
    Ok(builder
        .build_send_request()
...
pub fn cloudfunctions_projects_locations_functions_list_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ListFunctionsResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
