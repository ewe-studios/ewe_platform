//! Auto-generated API clients for Google Cloud Platform - iap.
//!
...
pub fn iap_projects_brands_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+parent}/brands", parent,);
...
pub fn iap_projects_brands_identity_aware_proxy_clients_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/identityAwareProxyClients",
        parent,
    );
...
pub fn iap_projects_brands_identity_aware_proxy_clients_reset_secret_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+name}:resetSecret", name,);
...
pub fn iap_projects_iap_tunnel_locations_dest_groups_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+parent}/destGroups", parent,);
...
pub fn iap_get_iap_settings_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+name}:iapSettings", name,);
...
/// GET v1/{+name}:validateAttributeExpression
...
pub fn iap_validate_attribute_expression_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+name}:validateAttributeExpression",
        name,
    );
