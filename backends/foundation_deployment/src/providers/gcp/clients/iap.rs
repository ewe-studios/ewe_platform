...
pub fn iap_projects_brands_create_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<Brand>, ApiError>, P = ApiPending> + Send + 'static,
    ApiError,
> {
    Ok(builder
        .build_send_request()
...
pub fn iap_projects_brands_list_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ListBrandsResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn iap_projects_brands_identity_aware_proxy_clients_create_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<IdentityAwareProxyClient>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn iap_projects_iap_tunnel_locations_dest_groups_create_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<TunnelDestGroup>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn iap_get_iap_settings_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<IapSettings>, ApiError>, P = ApiPending> + Send + 'static,
    ApiError,
> {
    Ok(builder
        .build_send_request()
