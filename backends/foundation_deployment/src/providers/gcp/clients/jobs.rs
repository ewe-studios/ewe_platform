...
pub fn jobs_projects_tenants_complete_query_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<CompleteQueryResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn jobs_projects_tenants_client_events_create_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ClientEvent>, ApiError>, P = ApiPending> + Send + 'static,
    ApiError,
> {
    Ok(builder
        .build_send_request()
...
pub fn jobs_projects_tenants_companies_list_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ListCompaniesResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn jobs_projects_tenants_jobs_search_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<SearchJobsResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
