//! Auto-generated API clients for Google Cloud Platform - cloudidentity.
//!
...
pub fn cloudidentity_customers_userinvitations_is_invitable_user_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+name}:isInvitableUser", name,);
...
pub fn cloudidentity_customers_userinvitations_list_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/userinvitations",
        parent,
    );
...
pub fn cloudidentity_customers_userinvitations_send_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+name}:send", name,);
...
pub fn cloudidentity_devices_cancel_wipe_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+name}:cancelWipe", name,);
...
pub fn cloudidentity_devices_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/devices",);
...
pub fn cloudidentity_devices_wipe_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+name}:wipe", name,);
...
pub fn cloudidentity_devices_device_users_block_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+name}:block", name,);
...
pub fn cloudidentity_devices_device_users_list_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+parent}/deviceUsers", parent,);
...
pub fn cloudidentity_devices_device_users_lookup_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+parent}:lookup", parent,);
...
pub fn cloudidentity_devices_device_users_client_states_list_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+parent}/clientStates", parent,);
...
pub fn cloudidentity_groups_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/groups",);
...
pub fn cloudidentity_groups_lookup_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/groups:lookup",);
...
pub fn cloudidentity_groups_search_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/groups:search",);
...
pub fn cloudidentity_groups_memberships_check_transitive_membership_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/memberships:checkTransitiveMembership",
        parent,
    );
...
pub fn cloudidentity_groups_memberships_get_membership_graph_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/memberships:getMembershipGraph",
        parent,
    );
...
pub fn cloudidentity_groups_memberships_lookup_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/memberships:lookup",
        parent,
    );
...
/// GET v1/{+name}:modifyMembershipRoles
...
pub fn cloudidentity_groups_memberships_modify_membership_roles_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+name}:modifyMembershipRoles",
        name,
    );
...
pub fn cloudidentity_groups_memberships_search_direct_groups_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/memberships:searchDirectGroups",
        parent,
    );
...
pub fn cloudidentity_groups_memberships_search_transitive_groups_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/memberships:searchTransitiveGroups",
        parent,
    );
...
pub fn cloudidentity_groups_memberships_search_transitive_memberships_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/memberships:searchTransitiveMemberships",
        parent,
    );
...
pub fn cloudidentity_inbound_oidc_sso_profiles_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/inboundOidcSsoProfiles",);
...
pub fn cloudidentity_inbound_saml_sso_profiles_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/inboundSamlSsoProfiles",);
...
/// GET v1/{+parent}/idpCredentials:add
...
pub fn cloudidentity_inbound_saml_sso_profiles_idp_credentials_add_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/idpCredentials:add",
        parent,
    );
...
pub fn cloudidentity_inbound_saml_sso_profiles_idp_credentials_list_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+parent}/idpCredentials", parent,);
...
pub fn cloudidentity_inbound_sso_assignments_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/inboundSsoAssignments",);
...
pub fn cloudidentity_policies_list_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/policies",);
