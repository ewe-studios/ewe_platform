//! Auto-generated API clients for Google Cloud Platform - memcache.
//!
...
pub fn memcache_projects_locations_instances_apply_parameters_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+name}:applyParameters", name,);
...
/// GET v1/{+instance}:rescheduleMaintenance
...
pub fn memcache_projects_locations_instances_reschedule_maintenance_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+instance}:rescheduleMaintenance",
        instance,
    );
...
pub fn memcache_projects_locations_instances_update_parameters_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+name}:updateParameters", name,);
