...
pub fn memcache_projects_locations_instances_get_tags_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<GetTagsResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn memcache_projects_locations_instances_set_tags_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<SetTagsResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
