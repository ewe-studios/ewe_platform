//! Auto-generated API clients for Google Cloud Platform - keep.
//!
...
pub fn keep_notes_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/notes",);
...
/// GET v1/{+parent}/permissions:batchCreate
...
pub fn keep_notes_permissions_batch_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/permissions:batchCreate",
        parent,
    );
...
/// GET v1/{+parent}/permissions:batchDelete
...
pub fn keep_notes_permissions_batch_delete_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+parent}/permissions:batchDelete",
        parent,
    );
