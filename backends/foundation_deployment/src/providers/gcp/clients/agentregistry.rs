...
pub fn agentregistry_projects_locations_agents_get_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<Agent>, ApiError>, P = ApiPending> + Send + 'static,
    ApiError,
> {
    Ok(builder
        .build_send_request()
...
pub fn agentregistry_projects_locations_agents_list_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ListAgentsResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
...
pub fn agentregistry_projects_locations_mcp_servers_get_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<McpServer>, ApiError>, P = ApiPending> + Send + 'static,
    ApiError,
> {
    Ok(builder
        .build_send_request()
...
pub fn agentregistry_projects_locations_mcp_servers_list_task(
    ...
    impl TaskIterator<D = Result<ApiResponse<ListMcpServersResponse>, ApiError>, P = ApiPending>
        + Send
        + 'static,
    ApiError,
> {
