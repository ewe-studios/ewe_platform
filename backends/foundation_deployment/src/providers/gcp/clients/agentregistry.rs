...
pub fn agentregistry_projects_locations_agents_list_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1alpha/{+parent}/agents", parent,);
...
pub fn agentregistry_projects_locations_endpoints_list_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1alpha/{+parent}/endpoints", parent,);
...
pub fn agentregistry_projects_locations_services_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1alpha/{+parent}/services", parent,);
