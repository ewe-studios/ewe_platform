...
pub fn analyticsadmin_account_summaries_list_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1beta/accountSummaries",);
...
pub fn analyticsadmin_accounts_list_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1beta/accounts",);
...
pub fn analyticsadmin_accounts_provision_account_ticket_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1beta/accounts:provisionAccountTicket",);
...
pub fn analyticsadmin_properties_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1beta/properties",);
...
pub fn analyticsadmin_properties_custom_dimensions_archive_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1beta/{+name}:archive", name,);
...
pub fn analyticsadmin_properties_key_events_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1beta/{+parent}/keyEvents", parent,);
