//! Auto-generated API clients for Google Cloud Platform - analyticsadmin.
//!
...
pub fn analyticsadmin_account_summaries_list_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1beta/accountSummaries",
    );
...
pub fn analyticsadmin_account_summaries_list_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<GoogleAnalyticsAdminV1betaListAccountSummariesResponse>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
    ...
    let task = builder
        ...
        .map_ready(|intro| match intro {
            RequestIntro::Success { stream, status } => {
                ...
                let parsed: GoogleAnalyticsAdminV1betaListAccountSummariesResponse = serde_json::from_str(&body)
...
pub fn analyticsadmin_accounts_delete_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<GoogleProtobufEmpty>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
    ...
    let task = builder
        ...
        .map_ready(|intro| match intro {
            RequestIntro::Success { stream, status } => {
                ...
                let body = body_reader::collect_string(stream);
                let parsed: GoogleAnalyticsAdminV1betaDataSharingSettings = serde_json::from_str(&body)
                    .map_err(|e| ApiError::ParseFailed(e.to_string()))?;
...
pub fn analyticsadmin_accounts_list_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1beta/accounts",
    );
    ...
    client.get(&url)
        ...
        .query(
            "showDeleted",
            showDeleted.as_ref().map(|s| s.to_string()).unwrap_or_default().as_str(),
        )
}
    ...
    let task = builder
        ...
        .map_ready(|intro| match intro {
            RequestIntro::Success { stream, status } => {
                ...
                let body = body_reader::collect_string(stream);
                let parsed: GoogleAnalyticsAdminV1betaListAccountsResponse = serde_json::from_str(&body)
                    .map_err(|e| ApiError::ParseFailed(e.to_string()))?;
...
pub fn analyticsadmin_accounts_provision_account_ticket_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1beta/accounts:provisionAccountTicket",
    );
...
pub fn analyticsadmin_accounts_provision_account_ticket_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<GoogleAnalyticsAdminV1betaProvisionAccountTicketResponse>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
    ...
    let task = builder
        ...
        .map_ready(|intro| match intro {
            RequestIntro::Success { stream, status } => {
                ...
                let body = body_reader::collect_string(stream);
                let parsed: GoogleAnalyticsAdminV1betaProvisionAccountTicketResponse = serde_json::from_str(&body)
                    .map_err(|e| ApiError::ParseFailed(e.to_string()))?;
...
/// GET v1beta/{+entity}:runAccessReport
...
pub fn analyticsadmin_accounts_run_access_report_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1beta/{+entity}:runAccessReport",
        entity,
    );
    ...
    let task = builder
        ...
        .map_ready(|intro| match intro {
            RequestIntro::Success { stream, status } => {
                ...
                let body = body_reader::collect_string(stream);
                let parsed: GoogleAnalyticsAdminV1betaRunAccessReportResponse = serde_json::from_str(&body)
                    .map_err(|e| ApiError::ParseFailed(e.to_string()))?;
...
/// GET v1beta/{+account}:searchChangeHistoryEvents
...
pub fn analyticsadmin_accounts_search_change_history_events_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1beta/{+account}:searchChangeHistoryEvents",
        account,
    );
...
pub fn analyticsadmin_accounts_search_change_history_events_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsResponse>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
    ...
    let task = builder
        ...
        .map_ready(|intro| match intro {
            RequestIntro::Success { stream, status } => {
                ...
                let body = body_reader::collect_string(stream);
                let parsed: GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsResponse = serde_json::from_str(&body)
                    .map_err(|e| ApiError::ParseFailed(e.to_string()))?;
...
> {
    ...
    let builder = analyticsadmin_accounts_search_change_history_events_builder(client, account, body)?;
    analyticsadmin_accounts_search_change_history_events_execute(builder)
}

/// GET v1beta/{+property}:acknowledgeUserDataCollection
...
pub fn analyticsadmin_properties_acknowledge_user_data_collection_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1beta/{+property}:acknowledgeUserDataCollection",
        property,
    );
...
pub fn analyticsadmin_properties_acknowledge_user_data_collection_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<GoogleAnalyticsAdminV1betaAcknowledgeUserDataCollectionResponse>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
    ...
    let task = builder
        ...
        .map_ready(|intro| match intro {
            RequestIntro::Success { stream, status } => {
                ...
                let body = body_reader::collect_string(stream);
                let parsed: GoogleAnalyticsAdminV1betaAcknowledgeUserDataCollectionResponse = serde_json::from_str(&body)
                    .map_err(|e| ApiError::ParseFailed(e.to_string()))?;
...
> {
    ...
    let builder = analyticsadmin_properties_acknowledge_user_data_collection_builder(client, property, body)?;
...
pub fn analyticsadmin_properties_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1beta/properties",
    );
    ...
    let task = builder
        ...
        .map_ready(|intro| match intro {
            RequestIntro::Success { stream, status } => {
                ...
                let body = body_reader::collect_string(stream);
                let parsed: GoogleAnalyticsAdminV1betaDataRetentionSettings = serde_json::from_str(&body)
                    .map_err(|e| ApiError::ParseFailed(e.to_string()))?;
    ...
    let task = builder
        ...
        .map_ready(|intro| match intro {
            RequestIntro::Success { stream, status } => {
                ...
                let body = body_reader::collect_string(stream);
                let parsed: GoogleAnalyticsAdminV1betaListPropertiesResponse = serde_json::from_str(&body)
                    .map_err(|e| ApiError::ParseFailed(e.to_string()))?;
...
> {
    ...
    let builder = analyticsadmin_properties_list_builder(client, filter, pageSize, pageToken, showDeleted)?;
...
> {
    ...
    let builder = analyticsadmin_properties_update_data_retention_settings_builder(client, name, updateMask, body)?;
...
pub fn analyticsadmin_properties_conversion_events_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1beta/{+parent}/conversionEvents",
        parent,
    );
...
pub fn analyticsadmin_properties_conversion_events_list_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<GoogleAnalyticsAdminV1betaListConversionEventsResponse>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
    ...
    let task = builder
        ...
        .map_ready(|intro| match intro {
            RequestIntro::Success { stream, status } => {
                ...
                let body = body_reader::collect_string(stream);
                let parsed: GoogleAnalyticsAdminV1betaListConversionEventsResponse = serde_json::from_str(&body)
                    .map_err(|e| ApiError::ParseFailed(e.to_string()))?;
...
> {
    ...
    let builder = analyticsadmin_properties_conversion_events_list_builder(client, parent, pageSize, pageToken)?;
...
> {
    ...
    let builder = analyticsadmin_properties_conversion_events_patch_builder(client, name, updateMask, body)?;
    analyticsadmin_properties_conversion_events_patch_execute(builder)
}

/// GET v1beta/{+name}:archive
...
pub fn analyticsadmin_properties_custom_dimensions_archive_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1beta/{+name}:archive",
        name,
    );
...
pub fn analyticsadmin_properties_custom_dimensions_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1beta/{+parent}/customDimensions",
        parent,
    );
...
pub fn analyticsadmin_properties_custom_dimensions_list_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<GoogleAnalyticsAdminV1betaListCustomDimensionsResponse>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
    ...
    let task = builder
        ...
        .map_ready(|intro| match intro {
            RequestIntro::Success { stream, status } => {
                ...
                let body = body_reader::collect_string(stream);
                let parsed: GoogleAnalyticsAdminV1betaListCustomDimensionsResponse = serde_json::from_str(&body)
                    .map_err(|e| ApiError::ParseFailed(e.to_string()))?;
...
> {
    ...
    let builder = analyticsadmin_properties_custom_dimensions_list_builder(client, parent, pageSize, pageToken)?;
...
> {
    ...
    let builder = analyticsadmin_properties_custom_dimensions_patch_builder(client, name, updateMask, body)?;
...
pub fn analyticsadmin_properties_custom_metrics_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1beta/{+parent}/customMetrics",
        parent,
    );
    ...
    let task = builder
        ...
        .map_ready(|intro| match intro {
            RequestIntro::Success { stream, status } => {
                ...
                let body = body_reader::collect_string(stream);
                let parsed: GoogleAnalyticsAdminV1betaListCustomMetricsResponse = serde_json::from_str(&body)
                    .map_err(|e| ApiError::ParseFailed(e.to_string()))?;
...
> {
    ...
    let builder = analyticsadmin_properties_custom_metrics_list_builder(client, parent, pageSize, pageToken)?;
...
> {
    ...
    let builder = analyticsadmin_properties_custom_metrics_patch_builder(client, name, updateMask, body)?;
...
pub fn analyticsadmin_properties_data_streams_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1beta/{+parent}/dataStreams",
        parent,
    );
    ...
    let task = builder
        ...
        .map_ready(|intro| match intro {
            RequestIntro::Success { stream, status } => {
                ...
                let body = body_reader::collect_string(stream);
                let parsed: GoogleAnalyticsAdminV1betaListDataStreamsResponse = serde_json::from_str(&body)
                    .map_err(|e| ApiError::ParseFailed(e.to_string()))?;
...
> {
    ...
    let builder = analyticsadmin_properties_data_streams_list_builder(client, parent, pageSize, pageToken)?;
...
> {
    ...
    let builder = analyticsadmin_properties_data_streams_patch_builder(client, name, updateMask, body)?;
...
pub fn analyticsadmin_properties_data_streams_measurement_protocol_secrets_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1beta/{+parent}/measurementProtocolSecrets",
        parent,
    );
    ...
    let task = builder
        ...
        .map_ready(|intro| match intro {
            RequestIntro::Success { stream, status } => {
                ...
                let body = body_reader::collect_string(stream);
                let parsed: GoogleAnalyticsAdminV1betaMeasurementProtocolSecret = serde_json::from_str(&body)
                    .map_err(|e| ApiError::ParseFailed(e.to_string()))?;
...
> {
    ...
    let builder = analyticsadmin_properties_data_streams_measurement_protocol_secrets_create_builder(client, parent, body)?;
...
> {
    ...
    let builder = analyticsadmin_properties_data_streams_measurement_protocol_secrets_delete_builder(client, name)?;
...
> {
    ...
    let builder = analyticsadmin_properties_data_streams_measurement_protocol_secrets_get_builder(client, name)?;
...
pub fn analyticsadmin_properties_data_streams_measurement_protocol_secrets_list_execute(
    ...
    impl StreamIterator<
        D = Result<ApiResponse<GoogleAnalyticsAdminV1betaListMeasurementProtocolSecretsResponse>, ApiError>,
        P = ApiPending
    > + Send + 'static,
    ApiError,
> {
    ...
    let task = builder
        ...
        .map_ready(|intro| match intro {
            RequestIntro::Success { stream, status } => {
                ...
                let body = body_reader::collect_string(stream);
                let parsed: GoogleAnalyticsAdminV1betaListMeasurementProtocolSecretsResponse = serde_json::from_str(&body)
                    .map_err(|e| ApiError::ParseFailed(e.to_string()))?;
...
> {
    ...
    let builder = analyticsadmin_properties_data_streams_measurement_protocol_secrets_list_builder(client, parent, pageSize, pageToken)?;
...
> {
    ...
    let builder = analyticsadmin_properties_data_streams_measurement_protocol_secrets_patch_builder(client, name, updateMask, body)?;
...
pub fn analyticsadmin_properties_firebase_links_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1beta/{+parent}/firebaseLinks",
        parent,
    );
    ...
    let task = builder
        ...
        .map_ready(|intro| match intro {
            RequestIntro::Success { stream, status } => {
                ...
                let body = body_reader::collect_string(stream);
                let parsed: GoogleAnalyticsAdminV1betaListFirebaseLinksResponse = serde_json::from_str(&body)
                    .map_err(|e| ApiError::ParseFailed(e.to_string()))?;
...
> {
    ...
    let builder = analyticsadmin_properties_firebase_links_list_builder(client, parent, pageSize, pageToken)?;
...
pub fn analyticsadmin_properties_google_ads_links_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1beta/{+parent}/googleAdsLinks",
        parent,
    );
    ...
    let task = builder
        ...
        .map_ready(|intro| match intro {
            RequestIntro::Success { stream, status } => {
                ...
                let body = body_reader::collect_string(stream);
                let parsed: GoogleAnalyticsAdminV1betaListGoogleAdsLinksResponse = serde_json::from_str(&body)
                    .map_err(|e| ApiError::ParseFailed(e.to_string()))?;
...
> {
    ...
    let builder = analyticsadmin_properties_google_ads_links_list_builder(client, parent, pageSize, pageToken)?;
...
> {
    ...
    let builder = analyticsadmin_properties_google_ads_links_patch_builder(client, name, updateMask, body)?;
...
pub fn analyticsadmin_properties_key_events_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1beta/{+parent}/keyEvents",
        parent,
    );
    ...
    let task = builder
        ...
        .map_ready(|intro| match intro {
            RequestIntro::Success { stream, status } => {
                ...
                let body = body_reader::collect_string(stream);
                let parsed: GoogleAnalyticsAdminV1betaListKeyEventsResponse = serde_json::from_str(&body)
                    .map_err(|e| ApiError::ParseFailed(e.to_string()))?;
...
> {
    ...
    let builder = analyticsadmin_properties_key_events_list_builder(client, parent, pageSize, pageToken)?;
...
> {
    ...
    let builder = analyticsadmin_properties_key_events_patch_builder(client, name, updateMask, body)?;
