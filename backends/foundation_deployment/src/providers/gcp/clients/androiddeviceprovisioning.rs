...
pub fn androiddeviceprovisioning_customers_list_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/customers",);
...
pub fn androiddeviceprovisioning_customers_configurations_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+parent}/configurations", parent,);
...
pub fn androiddeviceprovisioning_customers_dpcs_list_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+parent}/dpcs", parent,);
...
pub fn androiddeviceprovisioning_partners_vendors_list_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+parent}/vendors", parent,);
