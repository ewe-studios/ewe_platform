//! Auto-generated API clients for Google Cloud Platform - classroom.
//!
...
pub fn classroom_courses_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/courses",);
...
pub fn classroom_courses_create(
    ...
    ApiError,
> {
    let builder = classroom_courses_create_builder(client, body)?;
...
pub fn classroom_courses_delete_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/courses/{}", id,);
...
pub fn classroom_courses_delete(
    ...
    ApiError,
> {
    let builder = classroom_courses_delete_builder(client, id)?;
...
pub fn classroom_courses_get(
    ...
    ApiError,
> {
    let builder = classroom_courses_get_builder(client, id)?;
...
pub fn classroom_courses_get_grading_period_settings_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/gradingPeriodSettings",
        courseId,
    );
...
pub fn classroom_courses_get_grading_period_settings(
    ...
    ApiError,
> {
    let builder = classroom_courses_get_grading_period_settings_builder(client, courseId)?;
...
pub fn classroom_courses_patch(
    ...
    ApiError,
> {
    let builder = classroom_courses_patch_builder(client, id, updateMask, body)?;
...
pub fn classroom_courses_update(
    ...
    ApiError,
> {
    let builder = classroom_courses_update_builder(client, id, body)?;
...
> {
    let builder = classroom_courses_update_grading_period_settings_builder(
        client, courseId, updateMask, body,
    )?;
...
pub fn classroom_courses_aliases_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/courses/{}/aliases", courseId,);
...
pub fn classroom_courses_aliases_create(
    ...
    ApiError,
> {
    let builder = classroom_courses_aliases_create_builder(client, courseId, body)?;
...
pub fn classroom_courses_aliases_delete_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/aliases/{}",
        alias, courseId,
    );
...
pub fn classroom_courses_aliases_delete(
    ...
    ApiError,
> {
    let builder = classroom_courses_aliases_delete_builder(client, alias, courseId)?;
...
pub fn classroom_courses_aliases_list(
    ...
    ApiError,
> {
    let builder = classroom_courses_aliases_list_builder(client, courseId, pageSize, pageToken)?;
...
pub fn classroom_courses_announcements_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/announcements",
        courseId,
    );
...
pub fn classroom_courses_announcements_create(
    ...
    ApiError,
> {
    let builder = classroom_courses_announcements_create_builder(client, courseId, body)?;
...
pub fn classroom_courses_announcements_delete(
    ...
    ApiError,
> {
    let builder = classroom_courses_announcements_delete_builder(client, courseId, id)?;
...
pub fn classroom_courses_announcements_get(
    ...
    ApiError,
> {
    let builder = classroom_courses_announcements_get_builder(client, courseId, id)?;
...
pub fn classroom_courses_announcements_get_add_on_context_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/announcements/{}/addOnContext",
        courseId, itemId,
    );
...
pub fn classroom_courses_announcements_modify_assignees_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/announcements/{}:modifyAssignees",
        courseId, id,
    );
...
> {
    let builder =
        classroom_courses_announcements_modify_assignees_builder(client, courseId, id, body)?;
...
> {
    let builder =
        classroom_courses_announcements_patch_builder(client, courseId, id, updateMask, body)?;
...
pub fn classroom_courses_announcements_add_on_attachments_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/announcements/{}/addOnAttachments",
        courseId, itemId,
    );
...
> {
    let builder = classroom_courses_announcements_add_on_attachments_create_builder(
        client, courseId, itemId, addOnToken, postId, body,
    )?;
...
> {
    let builder = classroom_courses_announcements_add_on_attachments_list_builder(
        client, courseId, itemId, pageSize, pageToken, postId,
    )?;
...
pub fn classroom_courses_course_work_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/courses/{}/courseWork", courseId,);
...
pub fn classroom_courses_course_work_create(
    ...
    ApiError,
> {
    let builder = classroom_courses_course_work_create_builder(client, courseId, body)?;
...
pub fn classroom_courses_course_work_delete_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/courseWork/{}",
        courseId, id,
    );
...
pub fn classroom_courses_course_work_delete(
    ...
    ApiError,
> {
    let builder = classroom_courses_course_work_delete_builder(client, courseId, id)?;
...
pub fn classroom_courses_course_work_get(
    ...
    ApiError,
> {
    let builder = classroom_courses_course_work_get_builder(client, courseId, id)?;
...
pub fn classroom_courses_course_work_get_add_on_context_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/courseWork/{}/addOnContext",
        courseId, itemId,
    );
...
pub fn classroom_courses_course_work_modify_assignees_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/courseWork/{}:modifyAssignees",
        courseId, id,
    );
...
> {
    let builder =
        classroom_courses_course_work_modify_assignees_builder(client, courseId, id, body)?;
...
> {
    let builder =
        classroom_courses_course_work_patch_builder(client, courseId, id, updateMask, body)?;
...
pub fn classroom_courses_course_work_update_rubric_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/courseWork/{}/rubric",
...
pub fn classroom_courses_course_work_add_on_attachments_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/courseWork/{}/addOnAttachments",
        courseId, itemId,
    );
...
pub fn classroom_courses_course_work_add_on_attachments_student_submissions_get_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/courseWork/{}/addOnAttachments/{}/studentSubmissions/{}",
        attachmentId,
        courseId,
        itemId,
        submissionId,
...
pub fn classroom_courses_course_work_rubrics_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/courseWork/{}/rubrics",
        courseId, courseWorkId,
    );
...
> {
    let builder =
        classroom_courses_course_work_rubrics_create_builder(client, courseId, courseWorkId, body)?;
...
> {
    let builder =
        classroom_courses_course_work_rubrics_delete_builder(client, courseId, courseWorkId, id)?;
...
> {
    let builder =
        classroom_courses_course_work_rubrics_get_builder(client, courseId, courseWorkId, id)?;
...
pub fn classroom_courses_course_work_student_submissions_get_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/courseWork/{}/studentSubmissions/{}",
        courseId, courseWorkId, id,
    );
...
pub fn classroom_courses_course_work_student_submissions_modify_attachments_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/courseWork/{}/studentSubmissions/{}:modifyAttachments",
        courseId,
        courseWorkId,
        id,
    );
...
pub fn classroom_courses_course_work_student_submissions_reclaim_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/courseWork/{}/studentSubmissions/{}:reclaim",
        courseId, courseWorkId, id,
    );
...
pub fn classroom_courses_course_work_student_submissions_return_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/courseWork/{}/studentSubmissions/{}:return",
        courseId, courseWorkId, id,
    );
...
pub fn classroom_courses_course_work_student_submissions_turn_in_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/courseWork/{}/studentSubmissions/{}:turnIn",
        courseId, courseWorkId, id,
    );
...
pub fn classroom_courses_course_work_materials_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/courseWorkMaterials",
        courseId,
    );
...
pub fn classroom_courses_course_work_materials_create(
    ...
    ApiError,
> {
    let builder = classroom_courses_course_work_materials_create_builder(client, courseId, body)?;
...
pub fn classroom_courses_course_work_materials_delete(
    ...
    ApiError,
> {
    let builder = classroom_courses_course_work_materials_delete_builder(client, courseId, id)?;
...
pub fn classroom_courses_course_work_materials_get(
    ...
    ApiError,
> {
    let builder = classroom_courses_course_work_materials_get_builder(client, courseId, id)?;
...
pub fn classroom_courses_course_work_materials_get_add_on_context_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/courseWorkMaterials/{}/addOnContext",
        courseId, itemId,
    );
...
> {
    let builder = classroom_courses_course_work_materials_patch_builder(
        client, courseId, id, updateMask, body,
    )?;
...
pub fn classroom_courses_course_work_materials_add_on_attachments_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/courseWorkMaterials/{}/addOnAttachments",
        courseId, itemId,
    );
...
pub fn classroom_courses_posts_get_add_on_context_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/posts/{}/addOnContext",
        courseId, postId,
    );
...
pub fn classroom_courses_posts_add_on_attachments_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/posts/{}/addOnAttachments",
        courseId, postId,
    );
...
> {
    let builder = classroom_courses_posts_add_on_attachments_create_builder(
        client, courseId, postId, addOnToken, itemId, body,
    )?;
...
> {
    let builder = classroom_courses_posts_add_on_attachments_list_builder(
        client, courseId, postId, itemId, pageSize, pageToken,
    )?;
...
pub fn classroom_courses_posts_add_on_attachments_student_submissions_get_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/posts/{}/addOnAttachments/{}/studentSubmissions/{}",
...
pub fn classroom_courses_student_groups_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/studentGroups",
        courseId,
    );
...
pub fn classroom_courses_student_groups_create(
    ...
    ApiError,
> {
    let builder = classroom_courses_student_groups_create_builder(client, courseId, body)?;
...
pub fn classroom_courses_student_groups_delete(
    ...
    ApiError,
> {
    let builder = classroom_courses_student_groups_delete_builder(client, courseId, id)?;
...
> {
    let builder =
        classroom_courses_student_groups_list_builder(client, courseId, pageSize, pageToken)?;
...
> {
    let builder =
        classroom_courses_student_groups_patch_builder(client, courseId, id, updateMask, body)?;
...
pub fn classroom_courses_student_groups_student_group_members_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/studentGroups/{}/studentGroupMembers",
...
pub fn classroom_courses_students_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/courses/{}/students", courseId,);
...
> {
    let builder =
        classroom_courses_students_create_builder(client, courseId, enrollmentCode, body)?;
...
pub fn classroom_courses_students_delete_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/students/{}",
        courseId, userId,
    );
...
pub fn classroom_courses_students_delete(
    ...
    ApiError,
> {
    let builder = classroom_courses_students_delete_builder(client, courseId, userId)?;
...
pub fn classroom_courses_students_get(
    ...
    ApiError,
> {
    let builder = classroom_courses_students_get_builder(client, courseId, userId)?;
...
pub fn classroom_courses_students_list(
    ...
    ApiError,
> {
    let builder = classroom_courses_students_list_builder(client, courseId, pageSize, pageToken)?;
...
pub fn classroom_courses_teachers_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/courses/{}/teachers", courseId,);
...
pub fn classroom_courses_teachers_create(
    ...
    ApiError,
> {
    let builder = classroom_courses_teachers_create_builder(client, courseId, body)?;
...
pub fn classroom_courses_teachers_delete_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/teachers/{}",
        courseId, userId,
    );
...
pub fn classroom_courses_teachers_delete(
    ...
    ApiError,
> {
    let builder = classroom_courses_teachers_delete_builder(client, courseId, userId)?;
...
pub fn classroom_courses_teachers_get(
    ...
    ApiError,
> {
    let builder = classroom_courses_teachers_get_builder(client, courseId, userId)?;
...
pub fn classroom_courses_teachers_list(
    ...
    ApiError,
> {
    let builder = classroom_courses_teachers_list_builder(client, courseId, pageSize, pageToken)?;
...
pub fn classroom_courses_topics_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/courses/{}/topics", courseId,);
...
pub fn classroom_courses_topics_create(
    ...
    ApiError,
> {
    let builder = classroom_courses_topics_create_builder(client, courseId, body)?;
...
pub fn classroom_courses_topics_delete_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/courses/{}/topics/{}",
        courseId, id,
    );
...
pub fn classroom_courses_topics_delete(
    ...
    ApiError,
> {
    let builder = classroom_courses_topics_delete_builder(client, courseId, id)?;
...
pub fn classroom_courses_topics_get(
    ...
    ApiError,
> {
    let builder = classroom_courses_topics_get_builder(client, courseId, id)?;
...
pub fn classroom_courses_topics_list(
    ...
    ApiError,
> {
    let builder = classroom_courses_topics_list_builder(client, courseId, pageSize, pageToken)?;
...
pub fn classroom_courses_topics_patch(
    ...
    ApiError,
> {
    let builder = classroom_courses_topics_patch_builder(client, courseId, id, updateMask, body)?;
...
pub fn classroom_invitations_accept_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/invitations/{}:accept", id,);
...
pub fn classroom_invitations_accept(
    ...
    ApiError,
> {
    let builder = classroom_invitations_accept_builder(client, id)?;
...
pub fn classroom_invitations_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/invitations",);
...
pub fn classroom_invitations_create(
    ...
    ApiError,
> {
    let builder = classroom_invitations_create_builder(client, body)?;
...
pub fn classroom_invitations_delete_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/invitations/{}", id,);
...
pub fn classroom_invitations_delete(
    ...
    ApiError,
> {
    let builder = classroom_invitations_delete_builder(client, id)?;
...
pub fn classroom_invitations_get(
    ...
    ApiError,
> {
    let builder = classroom_invitations_get_builder(client, id)?;
...
> {
    let builder =
        classroom_invitations_list_builder(client, courseId, pageSize, pageToken, userId)?;
...
pub fn classroom_registrations_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/registrations",);
...
pub fn classroom_registrations_create(
    ...
    ApiError,
> {
    let builder = classroom_registrations_create_builder(client, body)?;
...
pub fn classroom_registrations_delete_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/registrations/{}", registrationId,);
...
pub fn classroom_registrations_delete(
    ...
    ApiError,
> {
    let builder = classroom_registrations_delete_builder(client, registrationId)?;
...
pub fn classroom_user_profiles_get_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/userProfiles/{}", userId,);
...
pub fn classroom_user_profiles_get(
    ...
    ApiError,
> {
    let builder = classroom_user_profiles_get_builder(client, userId)?;
...
pub fn classroom_user_profiles_guardian_invitations_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/userProfiles/{}/guardianInvitations",
        studentId,
    );
...
> {
    let builder =
        classroom_user_profiles_guardian_invitations_create_builder(client, studentId, body)?;
...
> {
    let builder =
        classroom_user_profiles_guardian_invitations_get_builder(client, invitationId, studentId)?;
...
pub fn classroom_user_profiles_guardians_delete_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/userProfiles/{}/guardians/{}",
...
pub fn classroom_user_profiles_guardians_delete(
    ...
    ApiError,
> {
    let builder = classroom_user_profiles_guardians_delete_builder(client, guardianId, studentId)?;
...
pub fn classroom_user_profiles_guardians_get(
    ...
    ApiError,
> {
    let builder = classroom_user_profiles_guardians_get_builder(client, guardianId, studentId)?;
