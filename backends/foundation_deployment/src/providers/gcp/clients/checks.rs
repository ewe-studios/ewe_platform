//! Auto-generated API clients for Google Cloud Platform - checks.
//!
...
pub fn checks_accounts_apps_list_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1alpha/{+parent}/apps", parent,);
...
pub fn checks_accounts_apps_operations_wait_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1alpha/{+name}:wait", name,);
...
pub fn checks_accounts_apps_reports_list_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1alpha/{+parent}/reports", parent,);
...
/// GET v1alpha/{+parent}/scans:generate
...
pub fn checks_accounts_repos_scans_generate_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1alpha/{+parent}/scans:generate",
        parent,
    );
...
pub fn checks_accounts_repos_scans_list_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1alpha/{+parent}/scans", parent,);
...
pub fn checks_aisafety_classify_content_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1alpha/aisafety:classifyContent",);
...
/// GET v1alpha/{+parent}/reports:analyzeUpload
...
pub fn checks_media_upload_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1alpha/{+parent}/reports:analyzeUpload",
        parent,
    );
