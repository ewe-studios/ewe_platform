//! Auto-generated API clients for Google Cloud Platform - cloudprofiler.
//!
...
pub fn cloudprofiler_projects_profiles_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv2/{+parent}/profiles", parent,);
...
/// GET v2/{+parent}/profiles:createOffline
...
pub fn cloudprofiler_projects_profiles_create_offline_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv2/{+parent}/profiles:createOffline",
        parent,
    );
