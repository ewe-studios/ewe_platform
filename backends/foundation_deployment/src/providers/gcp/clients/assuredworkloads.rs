//! Auto-generated API clients for Google Cloud Platform - assuredworkloads.
//!
...
pub fn assuredworkloads_organizations_locations_workloads_analyze_workload_move_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+target}:analyzeWorkloadMove",
        target,
    );
...
/// GET v1/{+name}:enableComplianceUpdates
...
pub fn assuredworkloads_organizations_locations_workloads_enable_compliance_updates_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+name}:enableComplianceUpdates",
        name,
    );
...
/// GET v1/{+name}:enableResourceMonitoring
...
pub fn assuredworkloads_organizations_locations_workloads_enable_resource_monitoring_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+name}:enableResourceMonitoring",
        name,
    );
...
/// GET v1/{+name}:mutatePartnerPermissions
...
pub fn assuredworkloads_organizations_locations_workloads_mutate_partner_permissions_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+name}:mutatePartnerPermissions",
        name,
    );
...
/// GET v1/{+name}:restrictAllowedResources
...
pub fn assuredworkloads_organizations_locations_workloads_restrict_allowed_resources_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv1/{+name}:restrictAllowedResources",
        name,
    );
...
pub fn assuredworkloads_organizations_locations_workloads_updates_list_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+parent}/updates", parent,);
...
pub fn assuredworkloads_organizations_locations_workloads_violations_acknowledge_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv1/{+name}:acknowledge", name,);
