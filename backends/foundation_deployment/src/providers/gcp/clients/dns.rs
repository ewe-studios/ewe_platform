//! Auto-generated API clients for Google Cloud Platform - dns.
//!
...
pub fn dns_changes_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comdns/v1/projects/{}/managedZones/{}/changes",
        managedZone, project,
    );
...
> {
    let builder =
        dns_changes_create_builder(client, managedZone, project, clientOperationId, body)?;
...
> {
    let builder =
        dns_changes_get_builder(client, changeId, managedZone, project, clientOperationId)?;
...
pub fn dns_dns_keys_get_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comdns/v1/projects/{}/managedZones/{}/dnsKeys/{}",
...
pub fn dns_managed_zone_operations_get_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comdns/v1/projects/{}/managedZones/{}/operations/{}",
...
pub fn dns_managed_zones_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comdns/v1/projects/{}/managedZones",
        project,
    );
...
> {
    let builder =
        dns_managed_zones_delete_builder(client, managedZone, project, clientOperationId)?;
...
pub fn dns_managed_zones_get(
    ...
    ApiError,
> {
    let builder = dns_managed_zones_get_builder(client, managedZone, project, clientOperationId)?;
    dns_managed_zones_get_execute(builder)
}

/// GET dns/v1/{+resource}:getIamPolicy
...
pub fn dns_managed_zones_get_iam_policy_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comdns/v1/{+resource}:getIamPolicy",
        resource,
    );
...
> {
    let builder =
        dns_managed_zones_patch_builder(client, managedZone, project, clientOperationId, body)?;
    dns_managed_zones_patch_execute(builder)
}

/// GET dns/v1/{+resource}:setIamPolicy
...
pub fn dns_managed_zones_set_iam_policy_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comdns/v1/{+resource}:setIamPolicy",
        resource,
    );
...
/// GET dns/v1/{+resource}:testIamPermissions
...
pub fn dns_managed_zones_test_iam_permissions_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comdns/v1/{+resource}:testIamPermissions",
        resource,
    );
...
> {
    let builder =
        dns_managed_zones_update_builder(client, managedZone, project, clientOperationId, body)?;
...
pub fn dns_policies_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comdns/v1/projects/{}/policies",
        project,
    );
...
pub fn dns_policies_delete(
    ...
    ApiError,
> {
    let builder = dns_policies_delete_builder(client, policy, project, clientOperationId)?;
...
pub fn dns_policies_get(
    ...
    ApiError,
> {
    let builder = dns_policies_get_builder(client, policy, project, clientOperationId)?;
...
pub fn dns_policies_patch(
    ...
    ApiError,
> {
    let builder = dns_policies_patch_builder(client, policy, project, clientOperationId, body)?;
...
pub fn dns_policies_update(
    ...
    ApiError,
> {
    let builder = dns_policies_update_builder(client, policy, project, clientOperationId, body)?;
...
pub fn dns_projects_get_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comdns/v1/projects/{}", project,);
...
pub fn dns_resource_record_sets_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comdns/v1/projects/{}/managedZones/{}/rrsets",
        managedZone, project,
    );
...
pub fn dns_resource_record_sets_delete_builder(
    ...
    let url = format!(
        "https://api.example.comdns/v1/projects/{}/managedZones/{}/rrsets/{}/{}",
        managedZone, name, project, type_rs,
    );
...
pub fn dns_response_policies_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comdns/v1/projects/{}/responsePolicies",
        project,
    );
...
pub fn dns_response_policy_rules_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comdns/v1/projects/{}/responsePolicies/{}/rules",
        project, responsePolicy,
    );
