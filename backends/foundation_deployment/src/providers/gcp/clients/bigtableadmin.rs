//! Auto-generated API clients for Google Cloud Platform - bigtableadmin.
//!
...
pub fn bigtableadmin_projects_instances_app_profiles_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv2/{+parent}/appProfiles", parent,);
...
pub fn bigtableadmin_projects_instances_clusters_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv2/{+parent}/clusters", parent,);
...
pub fn bigtableadmin_projects_instances_clusters_backups_copy_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv2/{+parent}/backups:copy", parent,);
...
pub fn bigtableadmin_projects_instances_clusters_backups_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv2/{+parent}/backups", parent,);
...
pub fn bigtableadmin_projects_instances_clusters_hot_tablets_list_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv2/{+parent}/hotTablets", parent,);
...
pub fn bigtableadmin_projects_instances_logical_views_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv2/{+parent}/logicalViews", parent,);
...
pub fn bigtableadmin_projects_instances_materialized_views_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv2/{+parent}/materializedViews",
        parent,
    );
...
pub fn bigtableadmin_projects_instances_tables_check_consistency_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv2/{+name}:checkConsistency", name,);
...
pub fn bigtableadmin_projects_instances_tables_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv2/{+parent}/tables", parent,);
...
pub fn bigtableadmin_projects_instances_tables_drop_row_range_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv2/{+name}:dropRowRange", name,);
...
/// GET v2/{+name}:generateConsistencyToken
...
pub fn bigtableadmin_projects_instances_tables_generate_consistency_token_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv2/{+name}:generateConsistencyToken",
        name,
    );
...
/// GET v2/{+name}:modifyColumnFamilies
...
pub fn bigtableadmin_projects_instances_tables_modify_column_families_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv2/{+name}:modifyColumnFamilies",
        name,
    );
...
pub fn bigtableadmin_projects_instances_tables_restore_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv2/{+parent}/tables:restore", parent,);
...
pub fn bigtableadmin_projects_instances_tables_authorized_views_create_builder(
    ...
    // Build URL
    let url = format!(
        "https://api.example.comv2/{+parent}/authorizedViews",
        parent,
    );
...
pub fn bigtableadmin_projects_instances_tables_schema_bundles_create_builder(
    ...
    // Build URL
    let url = format!("https://api.example.comv2/{+parent}/schemaBundles", parent,);
