//! Auto-generated API module for gcp/tpu runtimeVersions.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_tpu_runtime_versions `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://tpu.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/runtimeVersions/{{runtimeVersionsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://tpu.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/runtimeVersions",
    );
