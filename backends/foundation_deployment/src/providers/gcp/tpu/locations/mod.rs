//! Auto-generated API module for gcp/tpu locations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_tpu_locations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://tpu.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}:generateServiceIdentity",
    );
...
{
    let endpoint_url =
        format!("https://tpu.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}",);
...
where
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!("https://tpu.googleapis.com/v2/projects/{{projectsId}}/locations",);
