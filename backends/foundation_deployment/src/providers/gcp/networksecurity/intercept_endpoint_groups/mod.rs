//! Auto-generated API module for gcp/networksecurity interceptEndpointGroups.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_networksecurity_intercept_endpoint_groups `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://networksecurity.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/interceptEndpointGroups",
    );
...
{
    let endpoint_url = format!(
        "https://networksecurity.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/interceptEndpointGroups/{{interceptEndpointGroupsId}}",
    );
