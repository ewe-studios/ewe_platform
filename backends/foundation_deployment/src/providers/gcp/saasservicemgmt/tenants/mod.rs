//! Auto-generated API module for gcp/saasservicemgmt tenants.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_saasservicemgmt_tenants `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://saasservicemgmt.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/tenants",
    );
...
{
    let endpoint_url = format!(
        "https://saasservicemgmt.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/tenants/{{tenantsId}}",
    );
