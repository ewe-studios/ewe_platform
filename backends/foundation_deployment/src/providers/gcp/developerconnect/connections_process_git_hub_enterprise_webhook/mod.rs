//! Auto-generated API module for gcp/developerconnect connections:processGitHubEnterpriseWebhook.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_developerconnect_connections_process_git_hub_enterprise_webhook `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://developerconnect.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/connections:processGitHubEnterpriseWebhook",
    );
