//! Auto-generated API module for gcp/developerconnect users:fetchAccessToken.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_developerconnect_users_fetch_access_token `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://developerconnect.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/accountConnectors/{{accountConnectorsId}}/users:fetchAccessToken",
    );
