//! Auto-generated API module for gcp/developerconnect users:deleteSelf.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_developerconnect_users_delete_self `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://developerconnect.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/accountConnectors/{{accountConnectorsId}}/users:deleteSelf",
    );
