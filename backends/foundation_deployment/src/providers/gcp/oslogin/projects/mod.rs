//! Auto-generated API module for gcp/oslogin projects.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_oslogin_projects `
...
{
    let endpoint_url =
        format!("https://oslogin.googleapis.com/v1/users/{{usersId}}/projects/{{projectsId}}",);
