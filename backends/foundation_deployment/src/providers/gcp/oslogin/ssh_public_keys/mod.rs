//! Auto-generated API module for gcp/oslogin sshPublicKeys.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_oslogin_ssh_public_keys `
...
{
    let endpoint_url =
        format!("https://oslogin.googleapis.com/v1/users/{{usersId}}/sshPublicKeys",);
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://oslogin.googleapis.com/v1/users/{{usersId}}/sshPublicKeys/{{sshPublicKeysId}}",
    );
