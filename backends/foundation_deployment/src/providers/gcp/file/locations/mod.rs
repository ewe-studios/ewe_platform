//! Auto-generated API module for gcp/file locations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_file_locations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://file.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}",
    );
...
where
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!("https://file.googleapis.com/v1/projects/{{projectsId}}/locations",);
