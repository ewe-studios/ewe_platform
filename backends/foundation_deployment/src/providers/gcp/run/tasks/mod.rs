//! Auto-generated API module for gcp/run tasks.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_run_tasks `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://run.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/jobs/{{jobsId}}/executions/{{executionsId}}/tasks/{{tasksId}}",
    );
...
{
    let endpoint_url = format!(
        "https://run.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/jobs/{{jobsId}}/executions/{{executionsId}}/tasks",
    );
