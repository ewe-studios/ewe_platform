//! Auto-generated API module for gcp/run builds:submit.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_run_builds_submit `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://run.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/builds:submit",
    );
