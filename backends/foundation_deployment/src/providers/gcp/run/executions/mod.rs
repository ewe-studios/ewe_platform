//! Auto-generated API module for gcp/run executions.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_run_executions `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://run.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/jobs/{{jobsId}}/executions/{{executionsId}}:cancel",
    );
...
{
    let endpoint_url = format!(
        "https://run.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/jobs/{{jobsId}}/executions/{{executionsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://run.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/jobs/{{jobsId}}/executions/{{executionsId}}/{{executionsId1}}:exportStatus",
    );
...
{
    let endpoint_url = format!(
        "https://run.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/jobs/{{jobsId}}/executions",
    );
