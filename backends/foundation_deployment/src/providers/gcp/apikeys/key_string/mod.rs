//! Auto-generated API module for gcp/apikeys keyString.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_apikeys_key_string `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://apikeys.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/keys/{{keysId}}/keyString",
    );
