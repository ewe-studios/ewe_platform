//! Auto-generated API module for gcp/apikeys operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_apikeys_operations `
...
{
    let endpoint_url = format!("https://apikeys.googleapis.com/v2/operations/{{operationsId}}",);
