//! Auto-generated API module for gcp/bigquery serviceAccount.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_bigquery_service_account `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://bigquery.googleapis.com/bigquery/v2/projects/{{projectsId}}/serviceAccount",
    );
