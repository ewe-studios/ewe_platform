//! Auto-generated API module for gcp/apphub discoveredServices.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_apphub_discovered_services `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://apphub.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/discoveredServices/{{discoveredServicesId}}",
    );
...
{
    let endpoint_url = format!(
        "https://apphub.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/discoveredServices",
    );
