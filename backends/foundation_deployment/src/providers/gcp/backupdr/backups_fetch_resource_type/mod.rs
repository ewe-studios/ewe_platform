//! Auto-generated API module for gcp/backupdr backups:fetchForResourceType.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_backupdr_backups_fetch_resource_type `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://backupdr.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/backupVaults/{{backupVaultsId}}/dataSources/{{dataSourcesId}}/backups:fetchForResourceType",
    );
