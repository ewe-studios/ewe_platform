//! Auto-generated API module for gcp/backupdr backupPlanAssociations:fetchForResourceType.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_backupdr_backup_plan_associations_fetch_resource_type `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://backupdr.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/backupPlanAssociations:fetchForResourceType",
    );
