//! Auto-generated API module for gcp/dataform teamFolders:search.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_dataform_team_folders_search `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://dataform.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/teamFolders:search",
    );
