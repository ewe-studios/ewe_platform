//! Auto-generated API module for gcp/versionhistory channels.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_versionhistory_channels `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://versionhistory.googleapis.com/v1/{{v1Id}}/platforms/{{platformsId}}/channels",
    );
