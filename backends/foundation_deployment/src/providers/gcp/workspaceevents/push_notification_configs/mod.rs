//! Auto-generated API module for gcp/workspaceevents pushNotificationConfigs.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_workspaceevents_push_notification_configs `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://workspaceevents.googleapis.com/v1/tasks/{{tasksId}}/pushNotificationConfigs",
    );
...
{
    let endpoint_url = format!(
        "https://workspaceevents.googleapis.com/v1/tasks/{{tasksId}}/pushNotificationConfigs/{{pushNotificationConfigsId}}",
    );
