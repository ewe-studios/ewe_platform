//! Auto-generated API module for gcp/workspaceevents operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_workspaceevents_operations `
...
{
    let endpoint_url =
        format!("https://workspaceevents.googleapis.com/v1/operations/{{operationsId}}",);
