//! Auto-generated API module for gcp/realtimebidding buyers.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_realtimebidding_buyers `
...
{
    let endpoint_url = format!("https://realtimebidding.googleapis.com/v1/buyers/{{buyersId}}",);
...
{
    let endpoint_url =
        format!("https://realtimebidding.googleapis.com/v1/buyers/{{buyersId}}:getRemarketingTag",);
