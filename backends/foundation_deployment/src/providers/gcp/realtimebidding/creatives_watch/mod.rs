//! Auto-generated API module for gcp/realtimebidding creatives:watch.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_realtimebidding_creatives_watch `
...
{
    let endpoint_url =
        format!("https://realtimebidding.googleapis.com/v1/bidders/{{biddersId}}/creatives:watch",);
