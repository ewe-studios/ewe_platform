//! Auto-generated API module for gcp/realtimebidding publisherConnections:batchApprove.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_realtimebidding_publisher_connections_batch_approve `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://realtimebidding.googleapis.com/v1/bidders/{{biddersId}}/publisherConnections:batchApprove",
    );
