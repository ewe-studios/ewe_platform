//! Auto-generated API module for gcp/agentregistry mcpServers.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_agentregistry_mcp_servers `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://agentregistry.googleapis.com/v1alpha/projects/{{projectsId}}/locations/{{locationsId}}/mcpServers/{{mcpServersId}}",
    );
...
{
    let endpoint_url = format!(
        "https://agentregistry.googleapis.com/v1alpha/projects/{{projectsId}}/locations/{{locationsId}}/mcpServers",
    );
