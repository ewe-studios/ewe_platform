//! Auto-generated API module for gcp/retail products:purge.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_retail_products_purge `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://retail.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/catalogs/{{catalogsId}}/branches/{{branchesId}}/products:purge",
    );
