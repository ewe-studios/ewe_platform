//! Auto-generated API module for gcp/retail attributesConfig:replaceCatalogAttribute.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_retail_attributes_config_replace_catalog_attribute `
...
use super::shared::GoogleCloudRetailV2AttributesConfig;
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://retail.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/catalogs/{{catalogsId}}/attributesConfig:replaceCatalogAttribute",
    );
