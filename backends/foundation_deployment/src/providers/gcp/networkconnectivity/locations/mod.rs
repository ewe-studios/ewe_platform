//! Auto-generated API module for gcp/networkconnectivity locations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_networkconnectivity_locations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://networkconnectivity.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}:checkConsumerConfig",
    );
...
{
    let endpoint_url = format!(
        "https://networkconnectivity.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}",
    );
...
{
    let endpoint_url =
        format!("https://networkconnectivity.googleapis.com/v1/projects/{{projectsId}}/locations",);
