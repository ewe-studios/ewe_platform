//! Auto-generated API module for gcp/cloudprofiler profiles:createOffline.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_cloudprofiler_profiles_create_offline `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://cloudprofiler.googleapis.com/v2/projects/{{projectsId}}/profiles:createOffline",
    );
