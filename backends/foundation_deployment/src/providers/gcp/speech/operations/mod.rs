//! Auto-generated API module for gcp/speech operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_speech_operations `
...
{
    let endpoint_url = format!("https://speech.googleapis.com/v1/operations/{{operationsId}}",);
