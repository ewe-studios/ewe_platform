//! Auto-generated API module for gcp/acceleratedmobilepageurl ampUrls:batchGet.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_acceleratedmobilepageurl_amp_urls_batch_get `

#![cfg(feature = "gcp_acceleratedmobilepageurl_amp_urls_batch_get")]
