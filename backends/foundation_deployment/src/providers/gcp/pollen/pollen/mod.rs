//! Auto-generated API module for gcp/pollen pollen.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_pollen_pollen `
...
/// Arguments for [`pollen.mapTypes.heatmapTiles.lookupHeatmapTile_builder`].
#[derive(Debug, Clone, Default, Serialize, JsonHash)]
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    ...
    let endpoint_url = {
        ...
        if let Some(ref v) = args.plants_description {
            if first {
                url.push('?');
                first = false;
            } else {
            ...
            url.push_str("plantsDescription=");
            url.push_str(&urlencoding::encode(v));
        }
        url
    };
...
///
/// ```ignore
/// let task = pollen_map_types_heatmap_tiles_lookup_heatmap_tile_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn pollen_map_types_heatmap_tiles_lookup_heatmap_tile_request<R, F>(
    client: &SimpleHttpClient<R>,
