//! Auto-generated API module for gcp/securesourcemanager pullRequestComments:unresolve.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_securesourcemanager_pull_request_comments_unresolve `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://securesourcemanager.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/repositories/{{repositoriesId}}/pullRequests/{{pullRequestsId}}/pullRequestComments:unresolve",
    );
