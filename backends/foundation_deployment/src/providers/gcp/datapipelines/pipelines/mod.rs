//! Auto-generated API module for gcp/datapipelines pipelines.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_datapipelines_pipelines `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://datapipelines.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/pipelines",
    );
...
{
    let endpoint_url = format!(
        "https://datapipelines.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/pipelines/{{pipelinesId}}",
    );
...
{
    let endpoint_url = format!(
        "https://datapipelines.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/pipelines/{{pipelinesId}}:run",
    );
...
{
    let endpoint_url = format!(
        "https://datapipelines.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/pipelines/{{pipelinesId}}:stop",
    );
