//! Auto-generated API module for gcp/chat threadReadState.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_chat_thread_read_state `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://chat.googleapis.com/v1/users/{{usersId}}/spaces/{{spacesId}}/threads/{{threadsId}}/threadReadState",
    );
