//! Auto-generated API module for gcp/chat reactions.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_chat_reactions `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://chat.googleapis.com/v1/spaces/{{spacesId}}/messages/{{messagesId}}/reactions",
    );
...
{
    let endpoint_url = format!(
        "https://chat.googleapis.com/v1/spaces/{{spacesId}}/messages/{{messagesId}}/reactions/{{reactionsId}}",
    );
