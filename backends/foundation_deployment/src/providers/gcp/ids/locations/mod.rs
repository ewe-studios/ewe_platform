//! Auto-generated API module for gcp/ids locations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_ids_locations `
...
{
    let endpoint_url =
        format!("https://ids.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}",);
...
where
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!("https://ids.googleapis.com/v1/projects/{{projectsId}}/locations",);
