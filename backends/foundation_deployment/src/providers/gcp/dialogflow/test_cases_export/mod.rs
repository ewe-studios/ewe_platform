//! Auto-generated API module for gcp/dialogflow testCases:export.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_dialogflow_test_cases_export `
...
// -----------------------------------------------------------------------------
// POST v3/projects/{projectsId}/locations/{locationsId}/agents/{agentsId}/testCases:export
// -----------------------------------------------------------------------------
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://dialogflow.googleapis.com/v3/projects/{{projectsId}}/locations/{{locationsId}}/agents/{{agentsId}}/testCases:export",
    );
