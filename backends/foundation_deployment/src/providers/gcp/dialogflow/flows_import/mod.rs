//! Auto-generated API module for gcp/dialogflow flows:import.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_dialogflow_flows_import `
...
// -----------------------------------------------------------------------------
// POST v3/projects/{projectsId}/locations/{locationsId}/agents/{agentsId}/flows:import
// -----------------------------------------------------------------------------
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://dialogflow.googleapis.com/v3/projects/{{projectsId}}/locations/{{locationsId}}/agents/{{agentsId}}/flows:import",
    );
