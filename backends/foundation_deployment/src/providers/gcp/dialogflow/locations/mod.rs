//! Auto-generated API module for gcp/dialogflow locations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_dialogflow_locations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://dialogflow.googleapis.com/v3/projects/{{projectsId}}/locations/{{locationsId}}",
    );
...
{
    let endpoint_url =
        format!("https://dialogflow.googleapis.com/v3/projects/{{projectsId}}/locations",);
