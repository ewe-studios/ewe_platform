//! Auto-generated API module for gcp/runtimeconfig runtimeconfig.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_runtimeconfig_runtimeconfig `

#![cfg(feature = "gcp_runtimeconfig_runtimeconfig")]
...
/// Arguments for [`runtimeconfig.operations.cancel_builder`].
...
/// Arguments for [`runtimeconfig.operations.delete_builder`].
#[derive(Debug, Clone, Default, Serialize, JsonHash)]
...
/// Arguments for [`runtimeconfig.operations.list_builder`].
#[derive(Debug, Clone, Default, Serialize, JsonHash)]
...
///
/// ```ignore
/// let task = runtimeconfig_operations_cancel_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn runtimeconfig_operations_cancel_request<R, F>(
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://runtimeconfig.googleapis.com/v1/{}:cancel",
        args.name,
    );
...
///
/// ```ignore
/// let task = runtimeconfig_operations_delete_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn runtimeconfig_operations_delete_request<R, F>(
    client: &SimpleHttpClient<R>,
...
where
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!("https://runtimeconfig.googleapis.com/v1/{}", args.name,);
...
///
/// ```ignore
/// let task = runtimeconfig_operations_list_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn runtimeconfig_operations_list_request<R, F>(
    client: &SimpleHttpClient<R>,
