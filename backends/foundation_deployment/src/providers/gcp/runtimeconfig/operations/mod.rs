//! Auto-generated API module for gcp/runtimeconfig operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_runtimeconfig_operations `

#![cfg(feature = "gcp_runtimeconfig_operations")]
...
{
    let endpoint_url =
        format!("https://runtimeconfig.googleapis.com/v1/operations/{{operationsId}}:cancel",);
...
{
    let endpoint_url =
        format!("https://runtimeconfig.googleapis.com/v1/operations/{{operationsId}}",);
