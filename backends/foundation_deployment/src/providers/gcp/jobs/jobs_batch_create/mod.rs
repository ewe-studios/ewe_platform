//! Auto-generated API module for gcp/jobs jobs:batchCreate.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_jobs_jobs_batch_create `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://jobs.googleapis.com/v4/projects/{{projectsId}}/tenants/{{tenantsId}}/jobs:batchCreate",
    );
