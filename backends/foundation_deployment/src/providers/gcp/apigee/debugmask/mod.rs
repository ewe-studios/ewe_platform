//! Auto-generated API module for gcp/apigee debugmask.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_apigee_debugmask `
...
/// Arguments for [`apigee.organizations.environments.getDebugmask_builder`].
...
/// Arguments for [`apigee.organizations.environments.updateDebugmask_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
pub struct ApigeeOrganizationsEnvironmentsUpdateDebugmaskArgs {
    /// Path parameter: `name`.
    pub name: String,
    /// Query parameter: `replaceRepeatedFields`.
    pub replace_repeated_fields: Option<String>,
...
///
/// ```ignore
/// let task = apigee_organizations_environments_get_debugmask_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn apigee_organizations_environments_get_debugmask_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<ApiResponse<GoogleCloudApigeeV1DebugMask>, super::shared::ApiError>,
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://apigee.googleapis.com/v1/organizations/{{organizationsId}}/environments/{{environmentsId}}/debugmask",
    );
    ...
    Ok(builder
        ...
        .map_ready(|intro| match intro {
            super::shared::RequestIntro::Success {
                ...
                let parsed: GoogleCloudApigeeV1DebugMask =
...
///
/// ```ignore
/// let task = apigee_organizations_environments_update_debugmask_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn apigee_organizations_environments_update_debugmask_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
