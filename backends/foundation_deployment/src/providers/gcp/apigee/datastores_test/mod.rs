//! Auto-generated API module for gcp/apigee datastores:test.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_apigee_datastores_test `
...
/// `GoogleCloudApigeeV1TestDatastoreResponse` type.
...
/// Arguments for [`apigee.organizations.analytics.datastores.test_builder`].
...
// -----------------------------------------------------------------------------
// POST v1/organizations/{organizationsId}/analytics/datastores:test
// -----------------------------------------------------------------------------
...
///
/// ```ignore
/// let task = apigee_organizations_analytics_datastores_test_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn apigee_organizations_analytics_datastores_test_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<
                ApiResponse<GoogleCloudApigeeV1TestDatastoreResponse>,
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://apigee.googleapis.com/v1/organizations/{{organizationsId}}/analytics/datastores:test",
    );
