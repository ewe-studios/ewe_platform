//! Auto-generated API module for gcp/apigee deployments:generateDeployChangeReport.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_apigee_deployments_generate_deploy_change_report `
...
/// Arguments for [`apigee.organizations.environments.apis.revisions.deployments.generateDeployChangeReport_builder`].
...
///
/// ```ignore
/// let task = apigee_organizations_environments_apis_revisions_deployments_generate_deploy_change_report_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn apigee_organizations_environments_apis_revisions_deployments_generate_deploy_change_report_request<
    R,
    F,
>(
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://apigee.googleapis.com/v1/organizations/{{organizationsId}}/environments/{{environmentsId}}/apis/{{apisId}}/revisions/{{revisionsId}}/deployments:generateDeployChangeReport",
    );
