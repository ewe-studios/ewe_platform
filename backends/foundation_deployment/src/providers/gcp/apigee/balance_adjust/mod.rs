//! Auto-generated API module for gcp/apigee balance:adjust.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_apigee_balance_adjust `
...
/// Arguments for [`apigee.organizations.appgroups.balance.adjust_builder`].
...
/// Arguments for [`apigee.organizations.developers.balance.adjust_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
// -----------------------------------------------------------------------------
// POST v1/organizations/{organizationsId}/appgroups/{appgroupsId}/balance:adjust
// -----------------------------------------------------------------------------
...
///
/// ```ignore
/// let task = apigee_organizations_appgroups_balance_adjust_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn apigee_organizations_appgroups_balance_adjust_request<R, F>(
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://apigee.googleapis.com/v1/organizations/{{organizationsId}}/appgroups/{{appgroupsId}}/balance:adjust",
    );
...
// -----------------------------------------------------------------------------
// POST v1/organizations/{organizationsId}/developers/{developersId}/balance:adjust
// -----------------------------------------------------------------------------
...
///
/// ```ignore
/// let task = apigee_organizations_developers_balance_adjust_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn apigee_organizations_developers_balance_adjust_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
...
{
    let endpoint_url = format!(
        "https://apigee.googleapis.com/v1/organizations/{{organizationsId}}/developers/{{developersId}}/balance:adjust",
    );
