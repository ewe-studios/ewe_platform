//! Auto-generated API module for gcp/apigee create.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_apigee_create `
...
/// Arguments for [`apigee.organizations.developers.apps.keys.create.create_builder`].
...
// -----------------------------------------------------------------------------
// POST v1/organizations/{organizationsId}/developers/{developersId}/apps/{appsId}/keys/create
// -----------------------------------------------------------------------------
...
///
/// ```ignore
/// let task = apigee_organizations_developers_apps_keys_create_create_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn apigee_organizations_developers_apps_keys_create_create_request<R, F>(
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://apigee.googleapis.com/v1/organizations/{{organizationsId}}/developers/{{developersId}}/apps/{{appsId}}/keys/create",
    );
