//! Auto-generated API module for gcp/apigee datacollectors.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_apigee_datacollectors `
...
/// `GoogleCloudApigeeV1ListDataCollectorsResponse` type.
...
/// `GoogleCloudApigeeV1DataCollector` type.
#[derive(Debug, Clone, Serialize, Deserialize, JsonHash)]
...
/// Arguments for [`apigee.organizations.datacollectors.create_builder`].
...
/// Arguments for [`apigee.organizations.datacollectors.delete_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
/// Arguments for [`apigee.organizations.datacollectors.get_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
/// Arguments for [`apigee.organizations.datacollectors.list_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
/// Arguments for [`apigee.organizations.datacollectors.patch_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
///
/// ```ignore
/// let task = apigee_organizations_datacollectors_create_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn apigee_organizations_datacollectors_create_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<ApiResponse<GoogleCloudApigeeV1DataCollector>, super::shared::ApiError>,
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://apigee.googleapis.com/v1/organizations/{{organizationsId}}/datacollectors",
    );
...
// -----------------------------------------------------------------------------
// DELETE v1/organizations/{organizationsId}/datacollectors/{datacollectorsId}
// -----------------------------------------------------------------------------
...
///
/// ```ignore
/// let task = apigee_organizations_datacollectors_delete_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn apigee_organizations_datacollectors_delete_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
...
{
    let endpoint_url = format!(
        "https://apigee.googleapis.com/v1/organizations/{{organizationsId}}/datacollectors/{{datacollectorsId}}",
    );
...
///
/// ```ignore
/// let task = apigee_organizations_datacollectors_get_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn apigee_organizations_datacollectors_get_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
...
///
/// ```ignore
/// let task = apigee_organizations_datacollectors_list_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn apigee_organizations_datacollectors_list_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<
                ApiResponse<GoogleCloudApigeeV1ListDataCollectorsResponse>,
                super::shared::ApiError,
            >,
            Pending = super::shared::ApiPending,
            Spawner = super::shared::BoxedSendExecutionAction,
    ...
    Ok(builder
        ...
        .map_ready(|intro| match intro {
            super::shared::RequestIntro::Success {
                ...
                let body =
                    foundation_core::wire::simple_http::client::body_reader::collect_string(stream);
                let parsed: GoogleCloudApigeeV1ListDataCollectorsResponse =
                    serde_json::from_str(&body).map_err(|e: serde_json::Error| {
                        super::shared::ApiError::ParseFailed(e.to_string())
                    })?;
                Ok(ApiResponse {
...
///
/// ```ignore
/// let task = apigee_organizations_datacollectors_patch_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn apigee_organizations_datacollectors_patch_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
