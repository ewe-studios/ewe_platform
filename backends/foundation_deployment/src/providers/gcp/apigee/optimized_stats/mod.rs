//! Auto-generated API module for gcp/apigee optimizedStats.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_apigee_optimized_stats `
...
/// Arguments for [`apigee.organizations.environments.optimizedStats.get_builder`].
...
///
/// ```ignore
/// let task = apigee_organizations_environments_optimized_stats_get_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn apigee_organizations_environments_optimized_stats_get_request<R, F>(
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://apigee.googleapis.com/v1/organizations/{{organizationsId}}/environments/{{environmentsId}}/optimizedStats/{{optimizedStatsId}}",
    );
