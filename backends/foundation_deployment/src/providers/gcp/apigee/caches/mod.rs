//! Auto-generated API module for gcp/apigee caches.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_apigee_caches `
...
/// Arguments for [`apigee.organizations.environments.caches.delete_builder`].
...
// -----------------------------------------------------------------------------
// DELETE v1/organizations/{organizationsId}/environments/{environmentsId}/caches/{cachesId}
// -----------------------------------------------------------------------------
...
///
/// ```ignore
/// let task = apigee_organizations_environments_caches_delete_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn apigee_organizations_environments_caches_delete_request<R, F>(
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://apigee.googleapis.com/v1/organizations/{{organizationsId}}/environments/{{environmentsId}}/caches/{{cachesId}}",
    );
