//! Auto-generated API module for gcp/apigee projects.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_apigee_projects `
...
/// Arguments for [`apigee.projects.provisionOrganization_builder`].
...
// -----------------------------------------------------------------------------
// POST v1/projects/{projectsId}:provisionOrganization
// -----------------------------------------------------------------------------
...
///
/// ```ignore
/// let task = apigee_projects_provision_organization_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn apigee_projects_provision_organization_request<R, F>(
...
{
    let endpoint_url =
        format!("https://apigee.googleapis.com/v1/projects/{{projectsId}}:provisionOrganization",);
