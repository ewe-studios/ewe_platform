//! Auto-generated API module for gcp/apigee securityStats:queryTimeSeriesStats.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_apigee_security_stats_query_time_series_stats `
...
/// `GoogleCloudApigeeV1QueryTimeSeriesStatsResponseSequence` type.
...
/// `GoogleCloudApigeeV1QueryTimeSeriesStatsResponse` type.
#[derive(Debug, Clone, Serialize, Deserialize, JsonHash)]
...
/// Arguments for [`apigee.organizations.environments.securityStats.queryTimeSeriesStats_builder`].
...
// -----------------------------------------------------------------------------
// POST v1/organizations/{organizationsId}/environments/{environmentsId}/securityStats:queryTimeSeriesStats
// -----------------------------------------------------------------------------
...
///
/// ```ignore
/// let task = apigee_organizations_environments_security_stats_query_time_series_stats_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn apigee_organizations_environments_security_stats_query_time_series_stats_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<
                ApiResponse<GoogleCloudApigeeV1QueryTimeSeriesStatsResponse>,
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://apigee.googleapis.com/v1/organizations/{{organizationsId}}/environments/{{environmentsId}}/securityStats:queryTimeSeriesStats",
    );
    ...
    Ok(builder
        ...
        .map_ready(|intro| match intro {
            super::shared::RequestIntro::Success {
                ...
                let parsed: GoogleCloudApigeeV1QueryTimeSeriesStatsResponse =
