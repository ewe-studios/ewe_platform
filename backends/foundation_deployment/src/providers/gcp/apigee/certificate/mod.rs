//! Auto-generated API module for gcp/apigee certificate.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_apigee_certificate `
...
/// Arguments for [`apigee.organizations.environments.keystores.aliases.getCertificate_builder`].
...
///
/// ```ignore
/// let task = apigee_organizations_environments_keystores_aliases_get_certificate_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn apigee_organizations_environments_keystores_aliases_get_certificate_request<R, F>(
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://apigee.googleapis.com/v1/organizations/{{organizationsId}}/environments/{{environmentsId}}/keystores/{{keystoresId}}/aliases/{{aliasesId}}/certificate",
    );
