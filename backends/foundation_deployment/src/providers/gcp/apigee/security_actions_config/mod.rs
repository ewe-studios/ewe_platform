//! Auto-generated API module for gcp/apigee securityActionsConfig.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_apigee_security_actions_config `
...
/// `GoogleCloudApigeeV1SecurityActionsConfig` type.
...
/// Arguments for [`apigee.organizations.environments.getSecurityActionsConfig_builder`].
...
/// Arguments for [`apigee.organizations.environments.updateSecurityActionsConfig_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
///
/// ```ignore
/// let task = apigee_organizations_environments_get_security_actions_config_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn apigee_organizations_environments_get_security_actions_config_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<
                ApiResponse<GoogleCloudApigeeV1SecurityActionsConfig>,
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://apigee.googleapis.com/v1/organizations/{{organizationsId}}/environments/{{environmentsId}}/securityActionsConfig",
    );
    ...
    Ok(builder
        ...
        .map_ready(|intro| match intro {
            super::shared::RequestIntro::Success {
                ...
                let parsed: GoogleCloudApigeeV1SecurityActionsConfig = serde_json::from_str(&body)
...
///
/// ```ignore
/// let task = apigee_organizations_environments_update_security_actions_config_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn apigee_organizations_environments_update_security_actions_config_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
