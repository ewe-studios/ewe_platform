//! Auto-generated API module for gcp/apigee apiSecurityRuntimeConfig.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_apigee_security_runtime_config `
...
/// `GoogleCloudApigeeV1ApiSecurityRuntimeConfig` type.
...
/// Arguments for [`apigee.organizations.environments.getApiSecurityRuntimeConfig_builder`].
...
///
/// ```ignore
/// let task = apigee_organizations_environments_get_api_security_runtime_config_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn apigee_organizations_environments_get_api_security_runtime_config_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<
                ApiResponse<GoogleCloudApigeeV1ApiSecurityRuntimeConfig>,
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://apigee.googleapis.com/v1/organizations/{{organizationsId}}/environments/{{environmentsId}}/apiSecurityRuntimeConfig",
    );
    ...
    Ok(builder
        ...
        .map_ready(|intro| match intro {
            super::shared::RequestIntro::Success {
                ...
                let parsed: GoogleCloudApigeeV1ApiSecurityRuntimeConfig =
