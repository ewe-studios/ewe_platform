//! Auto-generated API module for gcp/servicenetworking roles:add.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_servicenetworking_roles_add `
...
{
    let endpoint_url =
        format!("https://servicenetworking.googleapis.com/v1/services/{{servicesId}}/roles:add",);
