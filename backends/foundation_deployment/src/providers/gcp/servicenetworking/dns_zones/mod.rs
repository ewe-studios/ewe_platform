//! Auto-generated API module for gcp/servicenetworking dnsZones.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_servicenetworking_dns_zones `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://servicenetworking.googleapis.com/v1/services/{{servicesId}}/projects/{{projectsId}}/global/networks/{{networksId}}/dnsZones/{{dnsZonesId}}",
    );
