//! Auto-generated API module for gcp/servicenetworking operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_servicenetworking_operations `
...
{
    let endpoint_url =
        format!("https://servicenetworking.googleapis.com/v1/operations/{{operationsId}}:cancel",);
...
{
    let endpoint_url =
        format!("https://servicenetworking.googleapis.com/v1/operations/{{operationsId}}",);
