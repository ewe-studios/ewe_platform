//! Auto-generated API module for gcp/apim locations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_apim_locations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://apim.googleapis.com/v1alpha/projects/{{projectsId}}/locations/{{locationsId}}",
    );
...
{
    let endpoint_url =
        format!("https://apim.googleapis.com/v1alpha/projects/{{projectsId}}/locations",);
...
{
    let endpoint_url = format!(
        "https://apim.googleapis.com/v1alpha/projects/{{projectsId}}/locations/{{locationsId}}:listApiObservationTags",
    );
