//! Auto-generated API module for gcp/parallelstore operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_parallelstore_operations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://parallelstore.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/operations/{{operationsId}}:cancel",
    );
...
{
    let endpoint_url = format!(
        "https://parallelstore.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/operations/{{operationsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://parallelstore.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/operations",
    );
