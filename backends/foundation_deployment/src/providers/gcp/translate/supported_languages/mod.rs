//! Auto-generated API module for gcp/translate supportedLanguages.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_translate_supported_languages `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://translation.googleapis.com/v3/projects/{{projectsId}}/supportedLanguages",
    );
...
{
    let endpoint_url = format!(
        "https://translation.googleapis.com/v3/projects/{{projectsId}}/locations/{{locationsId}}/supportedLanguages",
    );
