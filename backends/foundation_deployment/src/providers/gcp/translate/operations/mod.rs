//! Auto-generated API module for gcp/translate operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_translate_operations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://translation.googleapis.com/v3/projects/{{projectsId}}/locations/{{locationsId}}/operations/{{operationsId}}:cancel",
    );
...
{
    let endpoint_url = format!(
        "https://translation.googleapis.com/v3/projects/{{projectsId}}/locations/{{locationsId}}/operations/{{operationsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://translation.googleapis.com/v3/projects/{{projectsId}}/locations/{{locationsId}}/operations",
    );
...
{
    let endpoint_url = format!(
        "https://translation.googleapis.com/v3/projects/{{projectsId}}/locations/{{locationsId}}/operations/{{operationsId}}:wait",
    );
