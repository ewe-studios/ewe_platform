//! Auto-generated API module for gcp/vault operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_vault_operations `
...
{
    let endpoint_url =
        format!("https://vault.googleapis.com/v1/operations/{{operationsId}}:cancel",);
...
where
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!("https://vault.googleapis.com/v1/operations/{{operationsId}}",);
