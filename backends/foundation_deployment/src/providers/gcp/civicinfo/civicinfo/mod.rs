//! Auto-generated API module for gcp/civicinfo civicinfo.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_civicinfo_civicinfo `
...
/// `CivicinfoApiprotosV2DivisionSearchResult` type.
#[derive(Debug, Clone, Default, Serialize, Deserialize, JsonHash)]
...
/// `CivicinfoApiprotosV2DivisionSearchResponse` type.
#[derive(Debug, Clone, Default, Serialize, Deserialize, JsonHash)]
...
/// Arguments for [`civicinfo.divisions.search_builder`].
#[derive(Debug, Clone, Default, Serialize, JsonHash)]
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    ...
    let endpoint_url = {
        ...
        let mut first = true;
        if let Some(ref v) = args.address {
            if first {
                url.push('?');
                first = false;
            } else {
...
///
/// ```ignore
/// let task = civicinfo_divisions_search_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn civicinfo_divisions_search_request<R, F>(
    client: &SimpleHttpClient<R>,
    ...
    impl TaskIterator<
            Ready = Result<
                ApiResponse<CivicinfoApiprotosV2DivisionSearchResponse>,
                super::shared::ApiError,
            >,
            Pending = super::shared::ApiPending,
            Spawner = super::shared::BoxedSendExecutionAction,
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    ...
    let endpoint_url = {
        let mut url = endpoint_url;
        let mut first = true;
        if let Some(ref v) = args.production_data_only {
            if first {
                url.push('?');
                first = false;
            } else {
            ...
            url.push_str("productionDataOnly=");
            url.push_str(&urlencoding::encode(v));
        }
        url
    };
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    ...
    let endpoint_url = {
        ...
        if let Some(ref v) = args.election_id {
            if first {
                url.push('?');
                first = false;
            } else {
            ...
            url.push_str("electionId=");
            url.push_str(&urlencoding::encode(v));
        }
        if let Some(ref v) = args.official_only {
            if first {
                url.push('?');
                first = false;
            } else {
        ...
        if let Some(ref v) = args.return_all_available_data {
            if first {
                url.push('?');
                first = false;
            } else {
            ...
            url.push_str("returnAllAvailableData=");
            url.push_str(&urlencoding::encode(v));
        }
        url
    };
