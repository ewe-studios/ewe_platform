//! Auto-generated API module for gcp/readerrevenuesubscriptionlinking entitlements.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_readerrevenuesubscriptionlinking_entitlements `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://readerrevenuesubscriptionlinking.googleapis.com/v1/publications/{{publicationsId}}/readers/{{readersId}}/entitlements",
    );
