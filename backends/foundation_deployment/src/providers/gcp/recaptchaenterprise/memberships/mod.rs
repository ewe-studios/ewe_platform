//! Auto-generated API module for gcp/recaptchaenterprise memberships.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_recaptchaenterprise_memberships `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://recaptchaenterprise.googleapis.com/v1/projects/{{projectsId}}/relatedaccountgroups/{{relatedaccountgroupsId}}/memberships",
    );
