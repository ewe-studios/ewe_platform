//! Auto-generated API module for gcp/libraryagent libraryagent.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_libraryagent_libraryagent `
...
{
    let endpoint_url = format!("https://libraryagent.googleapis.com/v1/{}", args.name,);
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://libraryagent.googleapis.com/v1/{}:borrow",
        args.name,
    );
...
{
    let endpoint_url = format!(
        "https://libraryagent.googleapis.com/v1/{}/books",
        args.parent,
    );
...
{
    let endpoint_url = format!(
        "https://libraryagent.googleapis.com/v1/{}:return",
        args.name,
    );
