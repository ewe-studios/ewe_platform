//! Auto-generated API module for gcp/networkservices authzExtensions.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_networkservices_authz_extensions `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://networkservices.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/authzExtensions",
    );
...
{
    let endpoint_url = format!(
        "https://networkservices.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/authzExtensions/{{authzExtensionsId}}",
    );
