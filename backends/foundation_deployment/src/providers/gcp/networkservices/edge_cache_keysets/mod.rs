//! Auto-generated API module for gcp/networkservices edgeCacheKeysets.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_networkservices_edge_cache_keysets `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://networkservices.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/edgeCacheKeysets/{{edgeCacheKeysetsId}}:getIamPolicy",
    );
...
{
    let endpoint_url = format!(
        "https://networkservices.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/edgeCacheKeysets/{{edgeCacheKeysetsId}}:setIamPolicy",
    );
...
{
    let endpoint_url = format!(
        "https://networkservices.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/edgeCacheKeysets/{{edgeCacheKeysetsId}}:testIamPermissions",
    );
