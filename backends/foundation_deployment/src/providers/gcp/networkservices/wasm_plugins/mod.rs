//! Auto-generated API module for gcp/networkservices wasmPlugins.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_networkservices_wasm_plugins `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://networkservices.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/wasmPlugins",
    );
...
{
    let endpoint_url = format!(
        "https://networkservices.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/wasmPlugins/{{wasmPluginsId}}",
    );
