//! Auto-generated API module for gcp/networkservices edgeCacheServices.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_networkservices_edge_cache_services `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://networkservices.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/edgeCacheServices/{{edgeCacheServicesId}}:getIamPolicy",
    );
...
{
    let endpoint_url = format!(
        "https://networkservices.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/edgeCacheServices/{{edgeCacheServicesId}}:setIamPolicy",
    );
...
{
    let endpoint_url = format!(
        "https://networkservices.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/edgeCacheServices/{{edgeCacheServicesId}}:testIamPermissions",
    );
