//! Auto-generated API module for gcp/contentwarehouse referenceId.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_contentwarehouse_reference_id `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://contentwarehouse.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/documents/referenceId/{{referenceIdId}}:delete",
    );
...
{
    let endpoint_url = format!(
        "https://contentwarehouse.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/documents/referenceId/{{referenceIdId}}:get",
    );
...
{
    let endpoint_url = format!(
        "https://contentwarehouse.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/documents/referenceId/{{referenceIdId}}",
    );
