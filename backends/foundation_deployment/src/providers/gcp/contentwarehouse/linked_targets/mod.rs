//! Auto-generated API module for gcp/contentwarehouse linkedTargets.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_contentwarehouse_linked_targets `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://contentwarehouse.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/documents/{{documentsId}}/linkedTargets",
    );
