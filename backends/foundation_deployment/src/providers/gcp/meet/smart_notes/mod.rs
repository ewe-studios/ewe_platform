//! Auto-generated API module for gcp/meet smartNotes.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_meet_smart_notes `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://meet.googleapis.com/v2/conferenceRecords/{{conferenceRecordsId}}/smartNotes/{{smartNotesId}}",
    );
...
{
    let endpoint_url = format!(
        "https://meet.googleapis.com/v2/conferenceRecords/{{conferenceRecordsId}}/smartNotes",
    );
