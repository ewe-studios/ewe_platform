//! Auto-generated API module for gcp/meet conferenceRecords.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_meet_conference_records `
...
{
    let endpoint_url =
        format!("https://meet.googleapis.com/v2/conferenceRecords/{{conferenceRecordsId}}",);
