//! Auto-generated API module for gcp/firebase defaultLocation:finalize.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_firebase_default_location_finalize `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://firebase.googleapis.com/v1beta1/projects/{{projectsId}}/defaultLocation:finalize",
    );
