//! Auto-generated API module for gcp/firebase operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_firebase_operations `
...
{
    let endpoint_url =
        format!("https://firebase.googleapis.com/v1beta1/operations/{{operationsId}}",);
