//! Auto-generated API module for gcp/iap brands.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_iap_brands `
...
{
    let endpoint_url = format!("https://iap.googleapis.com/v1/projects/{{projectsId}}/brands",);
...
{
    let endpoint_url =
        format!("https://iap.googleapis.com/v1/projects/{{projectsId}}/brands/{{brandsId}}",);
