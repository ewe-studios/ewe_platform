//! Auto-generated API module for gcp/firebaseappdistribution operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_firebaseappdistribution_operations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://firebaseappdistribution.googleapis.com/v1/projects/{{projectsId}}/apps/{{appsId}}/releases/{{releasesId}}/operations/{{operationsId}}:cancel",
    );
...
{
    let endpoint_url = format!(
        "https://firebaseappdistribution.googleapis.com/v1/projects/{{projectsId}}/apps/{{appsId}}/releases/{{releasesId}}/operations/{{operationsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://firebaseappdistribution.googleapis.com/v1/projects/{{projectsId}}/apps/{{appsId}}/releases/{{releasesId}}/operations",
    );
...
{
    let endpoint_url = format!(
        "https://firebaseappdistribution.googleapis.com/v1/projects/{{projectsId}}/apps/{{appsId}}/releases/{{releasesId}}/operations/{{operationsId}}:wait",
    );
