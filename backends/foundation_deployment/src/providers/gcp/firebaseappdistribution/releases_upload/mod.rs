//! Auto-generated API module for gcp/firebaseappdistribution releases:upload.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_firebaseappdistribution_releases_upload `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://firebaseappdistribution.googleapis.com/v1/projects/{{projectsId}}/apps/{{appsId}}/releases:upload",
    );
