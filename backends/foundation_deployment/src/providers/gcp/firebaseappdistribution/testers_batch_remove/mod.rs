//! Auto-generated API module for gcp/firebaseappdistribution testers:batchRemove.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_firebaseappdistribution_testers_batch_remove `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://firebaseappdistribution.googleapis.com/v1/projects/{{projectsId}}/testers:batchRemove",
    );
