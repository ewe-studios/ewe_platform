//! Auto-generated API module for gcp/metastore databases.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_metastore_databases `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://metastore.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/services/{{servicesId}}/databases/{{databasesId}}:getIamPolicy",
    );
...
{
    let endpoint_url = format!(
        "https://metastore.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/services/{{servicesId}}/databases/{{databasesId}}:setIamPolicy",
    );
