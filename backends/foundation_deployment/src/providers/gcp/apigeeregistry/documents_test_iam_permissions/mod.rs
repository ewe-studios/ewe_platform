//! Auto-generated API module for gcp/apigeeregistry documents:testIamPermissions.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_apigeeregistry_documents_test_iam_permissions `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://apigeeregistry.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/documents:testIamPermissions",
    );
