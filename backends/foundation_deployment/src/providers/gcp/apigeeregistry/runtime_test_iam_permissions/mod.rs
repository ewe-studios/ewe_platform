//! Auto-generated API module for gcp/apigeeregistry runtime:testIamPermissions.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_apigeeregistry_runtime_test_iam_permissions `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://apigeeregistry.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/runtime:testIamPermissions",
    );
