//! Auto-generated API module for gcp/firebaseappcheck resourcePolicies:batchUpdate.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_firebaseappcheck_resource_policies_batch_update `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://firebaseappcheck.googleapis.com/v1/projects/{{projectsId}}/services/{{servicesId}}/resourcePolicies:batchUpdate",
    );
