//! Auto-generated API module for gcp/firebaseappcheck recaptchaEnterpriseConfig:batchGet.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_firebaseappcheck_recaptcha_enterprise_config_batch_get `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://firebaseappcheck.googleapis.com/v1/projects/{{projectsId}}/apps/-/recaptchaEnterpriseConfig:batchGet",
    );
