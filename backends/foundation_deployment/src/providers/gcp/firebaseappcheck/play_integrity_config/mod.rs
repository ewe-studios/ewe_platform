//! Auto-generated API module for gcp/firebaseappcheck playIntegrityConfig.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_firebaseappcheck_play_integrity_config `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://firebaseappcheck.googleapis.com/v1/projects/{{projectsId}}/apps/{{appsId}}/playIntegrityConfig",
    );
