//! Auto-generated API module for gcp/prod_tt_sasportal devices:createSigned.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_prod_tt_sasportal_devices_create_signed `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://prod-tt-sasportal.googleapis.com/v1alpha1/customers/{{customersId}}/deployments/{{deploymentsId}}/devices:createSigned",
    );
...
{
    let endpoint_url = format!(
        "https://prod-tt-sasportal.googleapis.com/v1alpha1/customers/{{customersId}}/devices:createSigned",
    );
...
{
    let endpoint_url = format!(
        "https://prod-tt-sasportal.googleapis.com/v1alpha1/customers/{{customersId}}/nodes/{{nodesId}}/devices:createSigned",
    );
...
{
    let endpoint_url = format!(
        "https://prod-tt-sasportal.googleapis.com/v1alpha1/nodes/{{nodesId}}/deployments/{{deploymentsId}}/devices:createSigned",
    );
...
{
    let endpoint_url = format!(
        "https://prod-tt-sasportal.googleapis.com/v1alpha1/nodes/{{nodesId}}/devices:createSigned",
    );
...
{
    let endpoint_url = format!(
        "https://prod-tt-sasportal.googleapis.com/v1alpha1/nodes/{{nodesId}}/nodes/{{nodesId1}}/devices:createSigned",
    );
