//! Auto-generated API module for gcp/prod_tt_sasportal customers:listLegacyOrganizations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_prod_tt_sasportal_customers_list_legacy_organizations `
