//! Auto-generated API module for gcp/prod_tt_sasportal customers.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_prod_tt_sasportal_customers `
...
{
    let endpoint_url =
        format!("https://prod-tt-sasportal.googleapis.com/v1alpha1/customers/{{customersId}}",);
