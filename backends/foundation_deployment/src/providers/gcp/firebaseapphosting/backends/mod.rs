//! Auto-generated API module for gcp/firebaseapphosting backends.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_firebaseapphosting_backends `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://firebaseapphosting.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/backends",
    );
...
{
    let endpoint_url = format!(
        "https://firebaseapphosting.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/backends/{{backendsId}}",
    );
