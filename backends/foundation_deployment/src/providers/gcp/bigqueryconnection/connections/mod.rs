//! Auto-generated API module for gcp/bigqueryconnection connections.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_bigqueryconnection_connections `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://bigqueryconnection.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/connections",
    );
...
{
    let endpoint_url = format!(
        "https://bigqueryconnection.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/connections/{{connectionsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://bigqueryconnection.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/connections/{{connectionsId}}:getIamPolicy",
    );
...
{
    let endpoint_url = format!(
        "https://bigqueryconnection.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/connections/{{connectionsId}}:setIamPolicy",
    );
...
{
    let endpoint_url = format!(
        "https://bigqueryconnection.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/connections/{{connectionsId}}:testIamPermissions",
    );
