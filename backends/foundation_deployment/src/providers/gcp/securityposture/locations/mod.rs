//! Auto-generated API module for gcp/securityposture locations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_securityposture_locations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://securityposture.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}",
    );
...
{
    let endpoint_url =
        format!("https://securityposture.googleapis.com/v1/projects/{{projectsId}}/locations",);
