//! Auto-generated API module for gcp/securityposture operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_securityposture_operations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://securityposture.googleapis.com/v1/organizations/{{organizationsId}}/locations/{{locationsId}}/operations/{{operationsId}}:cancel",
    );
...
{
    let endpoint_url = format!(
        "https://securityposture.googleapis.com/v1/organizations/{{organizationsId}}/locations/{{locationsId}}/operations/{{operationsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://securityposture.googleapis.com/v1/organizations/{{organizationsId}}/locations/{{locationsId}}/operations",
    );
