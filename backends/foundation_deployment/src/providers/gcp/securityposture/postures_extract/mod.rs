//! Auto-generated API module for gcp/securityposture postures:extract.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_securityposture_postures_extract `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://securityposture.googleapis.com/v1/organizations/{{organizationsId}}/locations/{{locationsId}}/postures:extract",
    );
