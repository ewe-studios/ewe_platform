//! Auto-generated API module for gcp/dlp connections:search.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_dlp_connections_search `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://dlp.googleapis.com/v2/organizations/{{organizationsId}}/locations/{{locationsId}}/connections:search",
    );
...
{
    let endpoint_url = format!(
        "https://dlp.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/connections:search",
    );
