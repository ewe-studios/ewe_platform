//! Auto-generated API module for gcp/dlp content:reidentify.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_dlp_content_reidentify `
...
// -----------------------------------------------------------------------------
// POST v2/projects/{projectsId}/content:reidentify
// -----------------------------------------------------------------------------
...
{
    let endpoint_url =
        format!("https://dlp.googleapis.com/v2/projects/{{projectsId}}/content:reidentify",);
...
// -----------------------------------------------------------------------------
// POST v2/projects/{projectsId}/locations/{locationsId}/content:reidentify
// -----------------------------------------------------------------------------
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://dlp.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/content:reidentify",
    );
