//! Auto-generated API module for gcp/dlp jobTriggers.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_dlp_job_triggers `
...
// -----------------------------------------------------------------------------
// POST v2/organizations/{organizationsId}/locations/{locationsId}/jobTriggers
// -----------------------------------------------------------------------------
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://dlp.googleapis.com/v2/organizations/{{organizationsId}}/locations/{{locationsId}}/jobTriggers",
    );
...
// -----------------------------------------------------------------------------
// DELETE v2/organizations/{organizationsId}/locations/{locationsId}/jobTriggers/{jobTriggersId}
// -----------------------------------------------------------------------------
...
{
    let endpoint_url = format!(
        "https://dlp.googleapis.com/v2/organizations/{{organizationsId}}/locations/{{locationsId}}/jobTriggers/{{jobTriggersId}}",
    );
...
// -----------------------------------------------------------------------------
// PATCH v2/organizations/{organizationsId}/locations/{locationsId}/jobTriggers/{jobTriggersId}
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// POST v2/projects/{projectsId}/jobTriggers/{jobTriggersId}:activate
// -----------------------------------------------------------------------------
...
{
    let endpoint_url = format!(
        "https://dlp.googleapis.com/v2/projects/{{projectsId}}/jobTriggers/{{jobTriggersId}}:activate",
    );
...
// -----------------------------------------------------------------------------
// POST v2/projects/{projectsId}/jobTriggers
// -----------------------------------------------------------------------------
...
{
    let endpoint_url =
        format!("https://dlp.googleapis.com/v2/projects/{{projectsId}}/jobTriggers",);
...
// -----------------------------------------------------------------------------
// DELETE v2/projects/{projectsId}/jobTriggers/{jobTriggersId}
// -----------------------------------------------------------------------------
...
{
    let endpoint_url = format!(
        "https://dlp.googleapis.com/v2/projects/{{projectsId}}/jobTriggers/{{jobTriggersId}}",
    );
...
// -----------------------------------------------------------------------------
// PATCH v2/projects/{projectsId}/jobTriggers/{jobTriggersId}
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// POST v2/projects/{projectsId}/locations/{locationsId}/jobTriggers/{jobTriggersId}:activate
// -----------------------------------------------------------------------------
...
{
    let endpoint_url = format!(
        "https://dlp.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/jobTriggers/{{jobTriggersId}}:activate",
    );
...
// -----------------------------------------------------------------------------
// POST v2/projects/{projectsId}/locations/{locationsId}/jobTriggers
// -----------------------------------------------------------------------------
...
{
    let endpoint_url = format!(
        "https://dlp.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/jobTriggers",
    );
...
// -----------------------------------------------------------------------------
// DELETE v2/projects/{projectsId}/locations/{locationsId}/jobTriggers/{jobTriggersId}
// -----------------------------------------------------------------------------
...
{
    let endpoint_url = format!(
        "https://dlp.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/jobTriggers/{{jobTriggersId}}",
    );
...
// -----------------------------------------------------------------------------
// POST v2/projects/{projectsId}/locations/{locationsId}/jobTriggers/{jobTriggersId}:hybridInspect
// -----------------------------------------------------------------------------
...
{
    let endpoint_url = format!(
        "https://dlp.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/jobTriggers/{{jobTriggersId}}:hybridInspect",
    );
...
// -----------------------------------------------------------------------------
// PATCH v2/projects/{projectsId}/locations/{locationsId}/jobTriggers/{jobTriggersId}
// -----------------------------------------------------------------------------
