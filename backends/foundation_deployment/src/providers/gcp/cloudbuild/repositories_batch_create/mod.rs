//! Auto-generated API module for gcp/cloudbuild repositories:batchCreate.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_cloudbuild_repositories_batch_create `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://cloudbuild.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/connections/{{connectionsId}}/repositories:batchCreate",
    );
