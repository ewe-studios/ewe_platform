//! Auto-generated API module for gcp/cloudbuild connections:processWebhook.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_cloudbuild_connections_process_webhook `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://cloudbuild.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/connections:processWebhook",
    );
