//! Auto-generated API module for gcp/cloudbuild locations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_cloudbuild_locations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://cloudbuild.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}",
    );
...
{
    let endpoint_url =
        format!("https://cloudbuild.googleapis.com/v2/projects/{{projectsId}}/locations",);
