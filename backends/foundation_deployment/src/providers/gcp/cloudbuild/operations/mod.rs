//! Auto-generated API module for gcp/cloudbuild operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_cloudbuild_operations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://cloudbuild.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/operations/{{operationsId}}:cancel",
    );
...
{
    let endpoint_url = format!(
        "https://cloudbuild.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/operations/{{operationsId}}",
    );
