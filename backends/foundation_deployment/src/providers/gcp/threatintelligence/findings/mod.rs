//! Auto-generated API module for gcp/threatintelligence findings.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_threatintelligence_findings `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://threatintelligence.googleapis.com/v1beta/projects/{{projectsId}}/findings/{{findingsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://threatintelligence.googleapis.com/v1beta/projects/{{projectsId}}/findings",
    );
