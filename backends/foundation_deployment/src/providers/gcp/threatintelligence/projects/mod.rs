//! Auto-generated API module for gcp/threatintelligence projects.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_threatintelligence_projects `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://threatintelligence.googleapis.com/v1beta/projects/{{projectsId}}:generateOrgProfile",
    );
