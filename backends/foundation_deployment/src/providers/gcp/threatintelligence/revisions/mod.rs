//! Auto-generated API module for gcp/threatintelligence revisions.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_threatintelligence_revisions `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://threatintelligence.googleapis.com/v1beta/projects/{{projectsId}}/configurations/{{configurationsId}}/revisions",
    );
