//! Auto-generated API module for gcp/dataplex policyIntents.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_dataplex_policy_intents `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://dataplex.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/policyIntents/{{policyIntentsId}}:getIamPolicy",
    );
...
// -----------------------------------------------------------------------------
// POST v1/projects/{projectsId}/locations/{locationsId}/policyIntents/{policyIntentsId}:setIamPolicy
// -----------------------------------------------------------------------------
...
{
    let endpoint_url = format!(
        "https://dataplex.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/policyIntents/{{policyIntentsId}}:setIamPolicy",
    );
...
// -----------------------------------------------------------------------------
// POST v1/projects/{projectsId}/locations/{locationsId}/policyIntents/{policyIntentsId}:testIamPermissions
// -----------------------------------------------------------------------------
...
{
    let endpoint_url = format!(
        "https://dataplex.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/policyIntents/{{policyIntentsId}}:testIamPermissions",
    );
