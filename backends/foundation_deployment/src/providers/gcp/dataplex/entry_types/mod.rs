//! Auto-generated API module for gcp/dataplex entryTypes.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_dataplex_entry_types `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://dataplex.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/entryTypes",
    );
...
{
    let endpoint_url = format!(
        "https://dataplex.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/entryTypes/{{entryTypesId}}",
    );
...
{
    let endpoint_url = format!(
        "https://dataplex.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/entryTypes/{{entryTypesId}}:getIamPolicy",
    );
...
// -----------------------------------------------------------------------------
// POST v1/projects/{projectsId}/locations/{locationsId}/entryTypes/{entryTypesId}:setIamPolicy
// -----------------------------------------------------------------------------
...
{
    let endpoint_url = format!(
        "https://dataplex.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/entryTypes/{{entryTypesId}}:setIamPolicy",
    );
...
// -----------------------------------------------------------------------------
// POST v1/projects/{projectsId}/locations/{locationsId}/entryTypes/{entryTypesId}:testIamPermissions
// -----------------------------------------------------------------------------
...
{
    let endpoint_url = format!(
        "https://dataplex.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/entryTypes/{{entryTypesId}}:testIamPermissions",
    );
