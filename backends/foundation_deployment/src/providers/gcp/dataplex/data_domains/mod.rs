//! Auto-generated API module for gcp/dataplex dataDomains.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_dataplex_data_domains `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://dataplex.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/dataDomains/{{dataDomainsId}}:getIamPolicy",
    );
...
// -----------------------------------------------------------------------------
// POST v1/projects/{projectsId}/locations/{locationsId}/dataDomains/{dataDomainsId}:setIamPolicy
// -----------------------------------------------------------------------------
...
{
    let endpoint_url = format!(
        "https://dataplex.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/dataDomains/{{dataDomainsId}}:setIamPolicy",
    );
...
// -----------------------------------------------------------------------------
// POST v1/projects/{projectsId}/locations/{locationsId}/dataDomains/{dataDomainsId}:testIamPermissions
// -----------------------------------------------------------------------------
...
{
    let endpoint_url = format!(
        "https://dataplex.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/dataDomains/{{dataDomainsId}}:testIamPermissions",
    );
