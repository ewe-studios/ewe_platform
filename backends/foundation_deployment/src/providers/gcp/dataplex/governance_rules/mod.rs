//! Auto-generated API module for gcp/dataplex governanceRules.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_dataplex_governance_rules `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://dataplex.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/governanceRules/{{governanceRulesId}}:getIamPolicy",
    );
...
// -----------------------------------------------------------------------------
// POST v1/projects/{projectsId}/locations/{locationsId}/governanceRules/{governanceRulesId}:setIamPolicy
// -----------------------------------------------------------------------------
...
{
    let endpoint_url = format!(
        "https://dataplex.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/governanceRules/{{governanceRulesId}}:setIamPolicy",
    );
...
// -----------------------------------------------------------------------------
// POST v1/projects/{projectsId}/locations/{locationsId}/governanceRules/{governanceRulesId}:testIamPermissions
// -----------------------------------------------------------------------------
...
{
    let endpoint_url = format!(
        "https://dataplex.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/governanceRules/{{governanceRulesId}}:testIamPermissions",
    );
