//! Auto-generated API module for gcp/dataproc workflowTemplates:instantiateInline.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_dataproc_workflow_templates_instantiate_inline `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://dataproc.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/workflowTemplates:instantiateInline",
    );
...
{
    let endpoint_url = format!(
        "https://dataproc.googleapis.com/v1/projects/{{projectsId}}/regions/{{regionsId}}/workflowTemplates:instantiateInline",
    );
