//! Auto-generated API module for gcp/dfareporting generateCode.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_dfareporting_generate_code `
...
/// `DynamicProfileGenerateCodeResponse` type.
...
/// Arguments for [`dfareporting.dynamicProfiles.generateCode_builder`].
...
///
/// ```ignore
/// let task = dfareporting_dynamic_profiles_generate_code_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn dfareporting_dynamic_profiles_generate_code_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<
                ApiResponse<DynamicProfileGenerateCodeResponse>,
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://dfareporting.googleapis.com/dfareporting/v5/studio/dynamicProfiles/{{dynamicProfilesId}}/generateCode",
    );
