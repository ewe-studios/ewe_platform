//! Auto-generated API module for gcp/dfareporting userRolePermissionGroups.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_dfareporting_user_role_permission_groups `
...
/// `UserRolePermissionGroupsListResponse` type.
#[derive(Debug, Clone, Serialize, Deserialize, JsonHash)]
pub struct UserRolePermissionGroupsListResponse {
    /// kind property.
    pub kind: Option<String>,
    /// userRolePermissionGroups property.
...
/// Arguments for [`dfareporting.userRolePermissionGroups.get_builder`].
...
/// Arguments for [`dfareporting.userRolePermissionGroups.list_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
///
/// ```ignore
/// let task = dfareporting_user_role_permission_groups_get_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn dfareporting_user_role_permission_groups_get_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<ApiResponse<UserRolePermissionGroup>, super::shared::ApiError>,
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://dfareporting.googleapis.com/dfareporting/v5/userprofiles/{{userprofilesId}}/userRolePermissionGroups/{{userRolePermissionGroupsId}}",
    );
    ...
    Ok(builder
        ...
        .map_ready(|intro| match intro {
            super::shared::RequestIntro::Success {
                ...
                let parsed: UserRolePermissionGroup =
...
///
/// ```ignore
/// let task = dfareporting_user_role_permission_groups_list_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn dfareporting_user_role_permission_groups_list_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
...
{
    let endpoint_url = format!(
        "https://dfareporting.googleapis.com/dfareporting/v5/userprofiles/{{userprofilesId}}/userRolePermissionGroups",
    );
