//! Auto-generated API module for gcp/dfareporting remarketingListShares.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_dfareporting_remarketing_list_shares `
...
/// Arguments for [`dfareporting.remarketingListShares.get_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
pub struct DfareportingRemarketingListSharesGetArgs {
    /// Path parameter: `profileId`.
    pub profile_id: String,
    /// Path parameter: `remarketingListId`.
    pub remarketing_list_id: String,
}

/// Arguments for [`dfareporting.remarketingListShares.patch_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
/// Arguments for [`dfareporting.remarketingListShares.update_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
///
/// ```ignore
/// let task = dfareporting_remarketing_list_shares_get_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn dfareporting_remarketing_list_shares_get_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<ApiResponse<RemarketingListShare>, super::shared::ApiError>,
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://dfareporting.googleapis.com/dfareporting/v5/userprofiles/{{userprofilesId}}/remarketingListShares/{{remarketingListSharesId}}",
    );
    ...
    Ok(builder
        ...
        .map_ready(|intro| match intro {
            super::shared::RequestIntro::Success {
                ...
                let parsed: RemarketingListShare =
...
///
/// ```ignore
/// let task = dfareporting_remarketing_list_shares_patch_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn dfareporting_remarketing_list_shares_patch_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
...
{
    let endpoint_url = format!(
        "https://dfareporting.googleapis.com/dfareporting/v5/userprofiles/{{userprofilesId}}/remarketingListShares",
    );
...
// -----------------------------------------------------------------------------
// PUT userprofiles/{userprofilesId}/remarketingListShares
// -----------------------------------------------------------------------------
...
///
/// ```ignore
/// let task = dfareporting_remarketing_list_shares_update_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn dfareporting_remarketing_list_shares_update_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
