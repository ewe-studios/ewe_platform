//! Auto-generated API module for gcp/dfareporting tvCampaignDetails.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_dfareporting_tv_campaign_details `
...
/// Arguments for [`dfareporting.tvCampaignDetails.get_builder`].
...
///
/// ```ignore
/// let task = dfareporting_tv_campaign_details_get_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn dfareporting_tv_campaign_details_get_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<ApiResponse<TvCampaignDetail>, super::shared::ApiError>,
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://dfareporting.googleapis.com/dfareporting/v5/userprofiles/{{userprofilesId}}/tvCampaignDetails/{{tvCampaignDetailsId}}",
    );
