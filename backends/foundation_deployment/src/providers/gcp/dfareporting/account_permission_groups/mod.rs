//! Auto-generated API module for gcp/dfareporting accountPermissionGroups.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_dfareporting_account_permission_groups `
...
/// `AccountPermissionGroupsListResponse` type.
#[derive(Debug, Clone, Serialize, Deserialize, JsonHash)]
pub struct AccountPermissionGroupsListResponse {
    /// accountPermissionGroups property.
...
/// Arguments for [`dfareporting.accountPermissionGroups.get_builder`].
...
/// Arguments for [`dfareporting.accountPermissionGroups.list_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
///
/// ```ignore
/// let task = dfareporting_account_permission_groups_get_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn dfareporting_account_permission_groups_get_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<ApiResponse<AccountPermissionGroup>, super::shared::ApiError>,
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://dfareporting.googleapis.com/dfareporting/v5/userprofiles/{{userprofilesId}}/accountPermissionGroups/{{accountPermissionGroupsId}}",
    );
    ...
    Ok(builder
        ...
        .map_ready(|intro| match intro {
            super::shared::RequestIntro::Success {
                ...
                let parsed: AccountPermissionGroup =
...
///
/// ```ignore
/// let task = dfareporting_account_permission_groups_list_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn dfareporting_account_permission_groups_list_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
...
{
    let endpoint_url = format!(
        "https://dfareporting.googleapis.com/dfareporting/v5/userprofiles/{{userprofilesId}}/accountPermissionGroups",
    );
