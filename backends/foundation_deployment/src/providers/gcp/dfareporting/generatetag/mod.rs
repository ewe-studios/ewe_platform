//! Auto-generated API module for gcp/dfareporting generatetag.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_dfareporting_generatetag `
...
/// `FloodlightActivitiesGenerateTagResponse` type.
#[derive(Debug, Clone, Serialize, Deserialize, JsonHash)]
pub struct FloodlightActivitiesGenerateTagResponse {
    /// floodlightActivityTag property.
    pub floodlight_activity_tag: Option<String>,
    /// globalSiteTagGlobalSnippet property.
...
/// Arguments for [`dfareporting.floodlightActivities.generatetag_builder`].
...
///
/// ```ignore
/// let task = dfareporting_floodlight_activities_generatetag_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn dfareporting_floodlight_activities_generatetag_request<R, F>(
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://dfareporting.googleapis.com/dfareporting/v5/userprofiles/{{userprofilesId}}/floodlightActivities/generatetag",
    );
    ...
    Ok(builder
        ...
        .map_ready(|intro| match intro {
            super::shared::RequestIntro::Success {
                ...
                let parsed: FloodlightActivitiesGenerateTagResponse = serde_json::from_str(&body)
                    .map_err(
