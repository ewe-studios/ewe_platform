//! Auto-generated API module for gcp/dfareporting campaignCreativeAssociations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_dfareporting_campaign_creative_associations `
...
/// `CampaignCreativeAssociationsListResponse` type.
#[derive(Debug, Clone, Serialize, Deserialize, JsonHash)]
pub struct CampaignCreativeAssociationsListResponse {
    /// campaignCreativeAssociations property.
...
/// `CampaignCreativeAssociation` type.
#[derive(Debug, Clone, Serialize, Deserialize, JsonHash)]
...
/// Arguments for [`dfareporting.campaignCreativeAssociations.insert_builder`].
...
/// Arguments for [`dfareporting.campaignCreativeAssociations.list_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
// -----------------------------------------------------------------------------
// POST userprofiles/{userprofilesId}/campaigns/{campaignsId}/campaignCreativeAssociations
// -----------------------------------------------------------------------------
...
///
/// ```ignore
/// let task = dfareporting_campaign_creative_associations_insert_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn dfareporting_campaign_creative_associations_insert_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<ApiResponse<CampaignCreativeAssociation>, super::shared::ApiError>,
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://dfareporting.googleapis.com/dfareporting/v5/userprofiles/{{userprofilesId}}/campaigns/{{campaignsId}}/campaignCreativeAssociations",
    );
    ...
    Ok(builder
        ...
        .map_ready(|intro| match intro {
            super::shared::RequestIntro::Success {
                ...
                let parsed: CampaignCreativeAssociation =
...
///
/// ```ignore
/// let task = dfareporting_campaign_creative_associations_list_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn dfareporting_campaign_creative_associations_list_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
