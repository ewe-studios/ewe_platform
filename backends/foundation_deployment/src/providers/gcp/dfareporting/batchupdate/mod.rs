//! Auto-generated API module for gcp/dfareporting batchupdate.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_dfareporting_batchupdate `
...
/// Arguments for [`dfareporting.conversions.batchupdate_builder`].
...
///
/// ```ignore
/// let task = dfareporting_conversions_batchupdate_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn dfareporting_conversions_batchupdate_request<R, F>(
    client: &SimpleHttpClient<R>,
    args: &DfareportingConversionsBatchupdateArgs,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<ApiResponse<ConversionsBatchUpdateResponse>, super::shared::ApiError>,
    ...
    Ok(builder
        ...
        .map_ready(|intro| match intro {
            super::shared::RequestIntro::Success {
                ...
                let parsed: ConversionsBatchUpdateResponse =
