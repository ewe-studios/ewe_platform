//! Auto-generated API module for gcp/texttospeech operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_texttospeech_operations `
...
{
    let endpoint_url =
        format!("https://texttospeech.googleapis.com/v1/operations/{{operationsId}}:cancel",);
...
{
    let endpoint_url =
        format!("https://texttospeech.googleapis.com/v1/operations/{{operationsId}}",);
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://texttospeech.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/operations/{{operationsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://texttospeech.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/operations",
    );
