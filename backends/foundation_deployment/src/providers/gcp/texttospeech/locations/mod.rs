//! Auto-generated API module for gcp/texttospeech locations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_texttospeech_locations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://texttospeech.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}:synthesizeLongAudio",
    );
