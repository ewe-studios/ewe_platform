//! Auto-generated API module for gcp/places media.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_places_media `
...
{
    let endpoint_url =
        format!("https://places.googleapis.com/v1/places/{{placesId}}/photos/{{photosId}}/media",);
