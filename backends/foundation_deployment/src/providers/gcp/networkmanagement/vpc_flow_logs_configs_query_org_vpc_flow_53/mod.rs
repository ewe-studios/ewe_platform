//! Auto-generated API module for gcp/networkmanagement vpcFlowLogsConfigs:queryOrgVpcFlowLogsConfigs.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_networkmanagement_vpc_flow_logs_configs_query_org_vpc_flow_53 `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://networkmanagement.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/vpcFlowLogsConfigs:queryOrgVpcFlowLogsConfigs",
    );
