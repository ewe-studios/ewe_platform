//! Auto-generated API module for gcp/networkmanagement locations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_networkmanagement_locations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://networkmanagement.googleapis.com/v1/organizations/{{organizationsId}}/locations/{{locationsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://networkmanagement.googleapis.com/v1/organizations/{{organizationsId}}/locations",
    );
...
{
    let endpoint_url = format!(
        "https://networkmanagement.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}",
    );
...
{
    let endpoint_url =
        format!("https://networkmanagement.googleapis.com/v1/projects/{{projectsId}}/locations",);
