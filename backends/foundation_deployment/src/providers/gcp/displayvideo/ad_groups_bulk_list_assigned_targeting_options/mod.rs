//! Auto-generated API module for gcp/displayvideo adGroups:bulkListAssignedTargetingOptions.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_displayvideo_ad_groups_bulk_list_assigned_targeting_options `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://displayvideo.googleapis.com/v4/advertisers/{{advertisersId}}/adGroups:bulkListAssignedTargetingOptions",
    );
