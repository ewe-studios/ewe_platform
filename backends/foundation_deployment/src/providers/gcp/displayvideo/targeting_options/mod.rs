//! Auto-generated API module for gcp/displayvideo targetingOptions.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_displayvideo_targeting_options `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://displayvideo.googleapis.com/v4/targetingTypes/{{targetingTypesId}}/targetingOptions/{{targetingOptionsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://displayvideo.googleapis.com/v4/targetingTypes/{{targetingTypesId}}/targetingOptions",
    );
