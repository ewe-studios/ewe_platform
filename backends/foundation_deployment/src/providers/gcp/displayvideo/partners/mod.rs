//! Auto-generated API module for gcp/displayvideo partners.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_displayvideo_partners `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://displayvideo.googleapis.com/v4/partners/{{partnersId}}:editAssignedTargetingOptions",
    );
...
where
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!("https://displayvideo.googleapis.com/v4/partners/{{partnersId}}",);
