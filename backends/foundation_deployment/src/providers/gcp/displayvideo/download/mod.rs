//! Auto-generated API module for gcp/displayvideo download.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_displayvideo_download `
...
use super::shared::GoogleBytestreamMedia;
...
{
    let endpoint_url = format!("https://displayvideo.googleapis.com/download/{{downloadId}}",);
