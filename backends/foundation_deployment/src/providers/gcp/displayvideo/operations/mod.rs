//! Auto-generated API module for gcp/displayvideo operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_displayvideo_operations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://displayvideo.googleapis.com/v4/sdfdownloadtasks/operations/{{operationsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://displayvideo.googleapis.com/v4/sdfuploadtasks/operations/{{operationsId}}",
    );
