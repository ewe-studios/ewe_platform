//! Auto-generated API module for gcp/displayvideo sites:replace.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_displayvideo_sites_replace `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://displayvideo.googleapis.com/v4/advertisers/{}/channels/{{channelsId}}/sites:replace",
        args.advertiser_id,
    );
...
{
    let endpoint_url = format!(
        "https://displayvideo.googleapis.com/v4/partners/{}/channels/{{channelsId}}/sites:replace",
        args.partner_id,
    );
