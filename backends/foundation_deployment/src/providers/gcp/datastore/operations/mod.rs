//! Auto-generated API module for gcp/datastore operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_datastore_operations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://datastore.googleapis.com/v1/projects/{{projectsId}}/operations/{{operationsId}}:cancel",
    );
...
{
    let endpoint_url = format!(
        "https://datastore.googleapis.com/v1/projects/{{projectsId}}/operations/{{operationsId}}",
    );
...
{
    let endpoint_url =
        format!("https://datastore.googleapis.com/v1/projects/{{projectsId}}/operations",);
