//! Auto-generated API module for gcp/baremetalsolution osImages.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_baremetalsolution_os_images `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://baremetalsolution.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/osImages/{{osImagesId}}",
    );
...
{
    let endpoint_url = format!(
        "https://baremetalsolution.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/osImages",
    );
