//! Auto-generated API module for gcp/baremetalsolution provisioningConfigs.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_baremetalsolution_provisioning_configs `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://baremetalsolution.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/provisioningConfigs",
    );
...
{
    let endpoint_url = format!(
        "https://baremetalsolution.googleapis.com/v2/projects/{{projectsId}}/locations/{{locationsId}}/provisioningConfigs/{{provisioningConfigsId}}",
    );
