//! Auto-generated API module for gcp/firebasehosting firebasehosting.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_firebasehosting_firebasehosting `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://firebasehosting.googleapis.com/v1/{}:cancel",
        args.name,
    );
