//! Auto-generated API module for gcp/firestore databases:clone.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_firestore_databases_clone `
...
{
    let endpoint_url =
        format!("https://firestore.googleapis.com/v1/projects/{{projectsId}}/databases:clone",);
