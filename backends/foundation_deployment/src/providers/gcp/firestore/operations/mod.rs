//! Auto-generated API module for gcp/firestore operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_firestore_operations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://firestore.googleapis.com/v1/projects/{{projectsId}}/databases/{{databasesId}}/operations/{{operationsId}}:cancel",
    );
...
{
    let endpoint_url = format!(
        "https://firestore.googleapis.com/v1/projects/{{projectsId}}/databases/{{databasesId}}/operations/{{operationsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://firestore.googleapis.com/v1/projects/{{projectsId}}/databases/{{databasesId}}/operations",
    );
