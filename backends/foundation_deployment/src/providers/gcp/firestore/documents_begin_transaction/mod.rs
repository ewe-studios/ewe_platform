//! Auto-generated API module for gcp/firestore documents:beginTransaction.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_firestore_documents_begin_transaction `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://firestore.googleapis.com/v1/projects/{{projectsId}}/databases/{{databasesId}}/documents:beginTransaction",
    );
