//! Auto-generated API module for gcp/fcm messages:send.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_fcm_messages_send `
...
{
    let endpoint_url =
        format!("https://fcm.googleapis.com/v1/projects/{{projectsId}}/messages:send",);
