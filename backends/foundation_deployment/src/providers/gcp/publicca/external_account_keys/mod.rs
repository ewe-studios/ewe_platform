//! Auto-generated API module for gcp/publicca externalAccountKeys.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_publicca_external_account_keys `
...
/// Arguments for [`publicca.projects.locations.externalAccountKeys.create_builder`].
...
///
/// ```ignore
/// let task = publicca_projects_locations_external_account_keys_create_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn publicca_projects_locations_external_account_keys_create_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<ApiResponse<ExternalAccountKey>, super::shared::ApiError>,
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://publicca.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/externalAccountKeys",
    );
