//! Auto-generated API module for gcp/bigquerydatatransfer projects.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_bigquerydatatransfer_projects `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://bigquerydatatransfer.googleapis.com/v1/projects/{{projectsId}}:enrollDataSources",
    );
