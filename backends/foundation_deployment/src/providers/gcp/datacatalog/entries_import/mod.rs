//! Auto-generated API module for gcp/datacatalog entries:import.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_datacatalog_entries_import `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://datacatalog.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/entryGroups/{{entryGroupsId}}/entries:import",
    );
