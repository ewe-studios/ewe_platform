//! Auto-generated API module for gcp/datacatalog tags:reconcile.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_datacatalog_tags_reconcile `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://datacatalog.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/entryGroups/{{entryGroupsId}}/entries/{{entriesId}}/tags:reconcile",
    );
