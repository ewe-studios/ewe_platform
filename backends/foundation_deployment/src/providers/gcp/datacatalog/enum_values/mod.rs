//! Auto-generated API module for gcp/datacatalog enumValues.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_datacatalog_enum_values `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://datacatalog.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/tagTemplates/{{tagTemplatesId}}/fields/{{fieldsId}}/enumValues/{{enumValuesId}}:rename",
    );
