//! Auto-generated API module for gcp/datacatalog entries.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_datacatalog_entries `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://datacatalog.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/entryGroups/{{entryGroupsId}}/entries",
    );
...
{
    let endpoint_url = format!(
        "https://datacatalog.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/entryGroups/{{entryGroupsId}}/entries/{{entriesId}}",
    );
...
{
    let endpoint_url = format!(
        "https://datacatalog.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/entryGroups/{{entryGroupsId}}/entries/{{entriesId}}:getIamPolicy",
    );
...
{
    let endpoint_url = format!(
        "https://datacatalog.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/entryGroups/{{entryGroupsId}}/entries/{{entriesId}}:modifyEntryContacts",
    );
...
{
    let endpoint_url = format!(
        "https://datacatalog.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/entryGroups/{{entryGroupsId}}/entries/{{entriesId}}:modifyEntryOverview",
    );
...
{
    let endpoint_url = format!(
        "https://datacatalog.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/entryGroups/{{entryGroupsId}}/entries/{{entriesId}}:star",
    );
...
{
    let endpoint_url = format!(
        "https://datacatalog.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/entryGroups/{{entryGroupsId}}/entries/{{entriesId}}:testIamPermissions",
    );
...
{
    let endpoint_url = format!(
        "https://datacatalog.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/entryGroups/{{entryGroupsId}}/entries/{{entriesId}}:unstar",
    );
