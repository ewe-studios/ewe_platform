//! Auto-generated API module for gcp/sqladmin projects.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_sqladmin_projects `
...
{
    let endpoint_url =
        format!("https://sqladmin.googleapis.com/v1/projects/{{projectsId}}:pointInTimeRestore",);
