//! Auto-generated API module for gcp/cloudkms ekmConfig:setIamPolicy.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_cloudkms_ekm_config_set_iam_policy `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://cloudkms.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/ekmConfig:setIamPolicy",
    );
