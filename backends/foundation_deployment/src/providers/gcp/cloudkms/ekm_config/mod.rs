//! Auto-generated API module for gcp/cloudkms ekmConfig.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_cloudkms_ekm_config `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://cloudkms.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/ekmConfig",
    );
