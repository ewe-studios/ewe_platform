//! Auto-generated API module for gcp/datamanager userListDirectLicenses.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_datamanager_user_list_direct_licenses `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://datamanager.googleapis.com/v1/accountTypes/{{accountTypesId}}/accounts/{{accountsId}}/userListDirectLicenses",
    );
...
{
    let endpoint_url = format!(
        "https://datamanager.googleapis.com/v1/accountTypes/{{accountTypesId}}/accounts/{{accountsId}}/userListDirectLicenses/{{userListDirectLicensesId}}",
    );
