//! Auto-generated API module for gcp/datamanager insights:retrieve.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_datamanager_insights_retrieve `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://datamanager.googleapis.com/v1/accountTypes/{{accountTypesId}}/accounts/{{accountsId}}/insights:retrieve",
    );
