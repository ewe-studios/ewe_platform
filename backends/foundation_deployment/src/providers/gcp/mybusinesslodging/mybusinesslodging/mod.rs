//! Auto-generated API module for gcp/mybusinesslodging mybusinesslodging.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_mybusinesslodging_mybusinesslodging `
...
/// `GetGoogleUpdatedLodgingResponse` type.
#[derive(Debug, Clone, Default, Serialize, Deserialize, JsonHash)]
...
/// Arguments for [`mybusinesslodging.locations.lodging.getGoogleUpdated_builder`].
#[derive(Debug, Clone, Default, Serialize, JsonHash)]
...
{
    let endpoint_url = format!("https://mybusinesslodging.googleapis.com/v1/{}", args.name,);
...
///
/// ```ignore
/// let task = mybusinesslodging_locations_lodging_get_google_updated_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn mybusinesslodging_locations_lodging_get_google_updated_request<R, F>(
    client: &SimpleHttpClient<R>,
    args: &MybusinesslodgingLocationsLodgingGetGoogleUpdatedArgs,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<ApiResponse<GetGoogleUpdatedLodgingResponse>, super::shared::ApiError>,
            Pending = super::shared::ApiPending,
            Spawner = super::shared::BoxedSendExecutionAction,
        > + Send
        + 'static,
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://mybusinesslodging.googleapis.com/v1/{}:getGoogleUpdated",
        args.name,
    );
    ...
    Ok(builder
        ...
        .map_ready(|intro| match intro {
            super::shared::RequestIntro::Success {
                ...
                let body =
                    foundation_core::wire::simple_http::client::body_reader::collect_string(stream);
                let parsed: GetGoogleUpdatedLodgingResponse =
                    serde_json::from_str(&body).map_err(|e: serde_json::Error| {
                        super::shared::ApiError::ParseFailed(e.to_string())
                    })?;
                Ok(ApiResponse {
