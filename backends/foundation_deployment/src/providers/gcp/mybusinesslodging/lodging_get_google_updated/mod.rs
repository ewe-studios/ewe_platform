//! Auto-generated API module for gcp/mybusinesslodging lodging:getGoogleUpdated.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_mybusinesslodging_lodging_get_google_updated `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://mybusinesslodging.googleapis.com/v1/locations/{{locationsId}}/lodging:getGoogleUpdated",
    );
