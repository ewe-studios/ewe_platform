//! Auto-generated API module for gcp/analyticsadmin dataSharingSettings.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_analyticsadmin_data_sharing_settings `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://analyticsadmin.googleapis.com/v1beta/accounts/{{accountsId}}/dataSharingSettings",
    );
