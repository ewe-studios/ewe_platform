//! Auto-generated API module for gcp/analyticsadmin customDimensions.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_analyticsadmin_custom_dimensions `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://analyticsadmin.googleapis.com/v1beta/properties/{{propertiesId}}/customDimensions/{{customDimensionsId}}:archive",
    );
...
{
    let endpoint_url = format!(
        "https://analyticsadmin.googleapis.com/v1beta/properties/{{propertiesId}}/customDimensions",
    );
...
{
    let endpoint_url = format!(
        "https://analyticsadmin.googleapis.com/v1beta/properties/{{propertiesId}}/customDimensions/{{customDimensionsId}}",
    );
