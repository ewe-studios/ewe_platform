//! Auto-generated API module for gcp/analyticsadmin dataRetentionSettings.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_analyticsadmin_data_retention_settings `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://analyticsadmin.googleapis.com/v1beta/properties/{{propertiesId}}/dataRetentionSettings",
    );
