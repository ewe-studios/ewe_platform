//! Auto-generated API module for gcp/cloudidentity idpCredentials:add.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_cloudidentity_idp_credentials_add `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://cloudidentity.googleapis.com/v1/inboundSamlSsoProfiles/{{inboundSamlSsoProfilesId}}/idpCredentials:add",
    );
