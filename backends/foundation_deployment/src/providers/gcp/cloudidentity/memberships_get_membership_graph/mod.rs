//! Auto-generated API module for gcp/cloudidentity memberships:getMembershipGraph.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_cloudidentity_memberships_get_membership_graph `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://cloudidentity.googleapis.com/v1/groups/{{groupsId}}/memberships:getMembershipGraph",
    );
