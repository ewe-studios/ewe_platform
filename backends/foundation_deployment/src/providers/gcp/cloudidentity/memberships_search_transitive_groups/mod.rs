//! Auto-generated API module for gcp/cloudidentity memberships:searchTransitiveGroups.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_cloudidentity_memberships_search_transitive_groups `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://cloudidentity.googleapis.com/v1/groups/{{groupsId}}/memberships:searchTransitiveGroups",
    );
