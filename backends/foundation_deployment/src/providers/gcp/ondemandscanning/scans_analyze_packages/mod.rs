//! Auto-generated API module for gcp/ondemandscanning scans:analyzePackages.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_ondemandscanning_scans_analyze_packages `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://ondemandscanning.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/scans:analyzePackages",
    );
