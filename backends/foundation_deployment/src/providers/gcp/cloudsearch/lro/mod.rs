//! Auto-generated API module for gcp/cloudsearch lro.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_cloudsearch_lro `
...
{
    let endpoint_url =
        format!("https://cloudsearch.googleapis.com/v1/operations/{{operationsId}}/lro",);
