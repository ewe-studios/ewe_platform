//! Auto-generated API module for gcp/cloudsearch items:poll.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_cloudsearch_items_poll `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://cloudsearch.googleapis.com/v1/indexing/datasources/{{datasourcesId}}/items:poll",
    );
