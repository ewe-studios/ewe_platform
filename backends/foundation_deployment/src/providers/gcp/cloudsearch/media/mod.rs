//! Auto-generated API module for gcp/cloudsearch media.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_cloudsearch_media `
...
{
    let endpoint_url = format!("https://cloudsearch.googleapis.com/v1/media/{{mediaId}}",);
