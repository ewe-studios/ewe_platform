//! Auto-generated API module for gcp/tagmanager destinations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_tagmanager_destinations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://tagmanager.googleapis.com/tagmanager/v2/accounts/{{accountsId}}/containers/{{containersId}}/destinations/{{destinationsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://tagmanager.googleapis.com/tagmanager/v2/accounts/{{accountsId}}/containers/{{containersId}}/destinations",
    );
