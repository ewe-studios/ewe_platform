//! Auto-generated API module for gcp/tagmanager status.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_tagmanager_status `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://tagmanager.googleapis.com/tagmanager/v2/accounts/{{accountsId}}/containers/{{containersId}}/workspaces/{{workspacesId}}/status",
    );
