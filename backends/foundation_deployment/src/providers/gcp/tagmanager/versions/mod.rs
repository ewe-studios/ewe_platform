//! Auto-generated API module for gcp/tagmanager versions.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_tagmanager_versions `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://tagmanager.googleapis.com/tagmanager/v2/accounts/{{accountsId}}/containers/{{containersId}}/versions/{{versionsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://tagmanager.googleapis.com/tagmanager/v2/accounts/{{accountsId}}/containers/{{containersId}}/versions/{{versionsId}}:publish",
    );
...
{
    let endpoint_url = format!(
        "https://tagmanager.googleapis.com/tagmanager/v2/accounts/{{accountsId}}/containers/{{containersId}}/versions/{{versionsId}}:set_latest",
    );
...
{
    let endpoint_url = format!(
        "https://tagmanager.googleapis.com/tagmanager/v2/accounts/{{accountsId}}/containers/{{containersId}}/versions/{{versionsId}}:undelete",
    );
