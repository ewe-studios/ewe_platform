//! Auto-generated API module for gcp/drivelabels capabilities.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_drivelabels_capabilities `
...
{
    let endpoint_url =
        format!("https://drivelabels.googleapis.com/v2/users/{{usersId}}/capabilities",);
