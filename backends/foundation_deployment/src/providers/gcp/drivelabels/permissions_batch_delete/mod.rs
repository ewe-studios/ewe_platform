//! Auto-generated API module for gcp/drivelabels permissions:batchDelete.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_drivelabels_permissions_batch_delete `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://drivelabels.googleapis.com/v2/labels/{{labelsId}}/permissions:batchDelete",
    );
...
{
    let endpoint_url = format!(
        "https://drivelabels.googleapis.com/v2/labels/{{labelsId}}/revisions/{{revisionsId}}/permissions:batchDelete",
    );
