//! Auto-generated API module for gcp/workloadmanager evaluations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_workloadmanager_evaluations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://workloadmanager.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/evaluations",
    );
...
{
    let endpoint_url = format!(
        "https://workloadmanager.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/evaluations/{{evaluationsId}}",
    );
