//! Auto-generated API module for gcp/contactcenterinsights encryptionSpec:initialize.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_contactcenterinsights_encryption_spec_initialize `
...
// -----------------------------------------------------------------------------
// POST v1/projects/{projectsId}/locations/{locationsId}/encryptionSpec:initialize
// -----------------------------------------------------------------------------
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://contactcenterinsights.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/encryptionSpec:initialize",
    );
