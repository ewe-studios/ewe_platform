//! Auto-generated API module for gcp/contactcenterinsights authorizedViews:search.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_contactcenterinsights_authorized_views_search `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://contactcenterinsights.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/authorizedViewSets/{{authorizedViewSetsId}}/authorizedViews:search",
    );
