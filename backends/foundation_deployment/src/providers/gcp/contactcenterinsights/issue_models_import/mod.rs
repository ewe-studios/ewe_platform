//! Auto-generated API module for gcp/contactcenterinsights issueModels:import.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_contactcenterinsights_issue_models_import `
...
// -----------------------------------------------------------------------------
// POST v1/projects/{projectsId}/locations/{locationsId}/issueModels:import
// -----------------------------------------------------------------------------
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://contactcenterinsights.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/issueModels:import",
    );
