//! Auto-generated API module for gcp/contactcenterinsights autoLabelingRules:test.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_contactcenterinsights_auto_labeling_rules_test `
...
// -----------------------------------------------------------------------------
// POST v1/projects/{projectsId}/locations/{locationsId}/autoLabelingRules:test
// -----------------------------------------------------------------------------
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://contactcenterinsights.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/autoLabelingRules:test",
    );
