//! Auto-generated API module for gcp/cloudresourcemanager operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_cloudresourcemanager_operations `
...
{
    let endpoint_url =
        format!("https://cloudresourcemanager.googleapis.com/v3/operations/{{operationsId}}",);
