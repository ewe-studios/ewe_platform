//! Auto-generated API module for gcp/cloudresourcemanager effectiveTagBindingCollections.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_cloudresourcemanager_effective_tag_binding_collections `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://cloudresourcemanager.googleapis.com/v3/locations/{{locationsId}}/effectiveTagBindingCollections/{{effectiveTagBindingCollectionsId}}",
    );
