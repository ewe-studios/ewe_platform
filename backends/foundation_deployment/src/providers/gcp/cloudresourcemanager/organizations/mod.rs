//! Auto-generated API module for gcp/cloudresourcemanager organizations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_cloudresourcemanager_organizations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://cloudresourcemanager.googleapis.com/v3/organizations/{{organizationsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://cloudresourcemanager.googleapis.com/v3/organizations/{{organizationsId}}:getIamPolicy",
    );
...
{
    let endpoint_url = format!(
        "https://cloudresourcemanager.googleapis.com/v3/organizations/{{organizationsId}}:setIamPolicy",
    );
...
{
    let endpoint_url = format!(
        "https://cloudresourcemanager.googleapis.com/v3/organizations/{{organizationsId}}:testIamPermissions",
    );
