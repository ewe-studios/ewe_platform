//! Auto-generated API module for gcp/cloudresourcemanager tagBindings.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_cloudresourcemanager_tag_bindings `
...
{
    let endpoint_url =
        format!("https://cloudresourcemanager.googleapis.com/v3/tagBindings/{{tagBindingsId}}",);
