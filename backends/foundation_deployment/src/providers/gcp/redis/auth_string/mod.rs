//! Auto-generated API module for gcp/redis authString.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_redis_auth_string `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://redis.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/instances/{{instancesId}}/authString",
    );
