//! Auto-generated API module for gcp/dataportability portabilityArchiveState.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_dataportability_portability_archive_state `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://dataportability.googleapis.com/v1/archiveJobs/{{archiveJobsId}}/portabilityArchiveState",
    );
