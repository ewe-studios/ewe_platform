//! Auto-generated API module for gcp/healthcare $everything.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_healthcare_everything `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://healthcare.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/datasets/{{datasetsId}}/fhirStores/{{fhirStoresId}}/fhir/Patient/{{PatientId}}/$everything",
    );
