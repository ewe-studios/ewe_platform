//! Auto-generated API module for gcp/healthcare bulkdata.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_healthcare_bulkdata `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://healthcare.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/datasets/{{datasetsId}}/dicomStores/{{dicomStoresId}}/dicomWeb/studies/{{studiesId}}/series/{{seriesId}}/instances/{{instancesId}}/bulkdata/{{bulkdataId}}/{{bulkdataId1}}",
    );
