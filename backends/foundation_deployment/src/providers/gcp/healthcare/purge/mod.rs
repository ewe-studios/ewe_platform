//! Auto-generated API module for gcp/healthcare $purge.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_healthcare_purge `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://healthcare.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/datasets/{{datasetsId}}/fhirStores/{{fhirStoresId}}/fhir/{{fhirId}}/{{fhirId1}}/$purge",
    );
