//! Auto-generated API module for gcp/notebooks notebooks.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_notebooks_notebooks `
...
/// `CheckAuthorizationRequest` type.
...
/// `DiagnosticConfig` type.
#[derive(Debug, Clone, Default, Serialize, Deserialize, JsonHash)]
pub struct DiagnosticConfig {
    /// enableCopyHomeFilesFlag property.
    pub enable_copy_home_files_flag: Option<bool>,
    /// enablePacketCaptureFlag property.
    pub enable_packet_capture_flag: Option<bool>,
    /// enableRepairFlag property.
...
/// `UpgradeInstanceSystemRequest` type.
#[derive(Debug, Clone, Default, Serialize, Deserialize, JsonHash)]
...
/// `RollbackInstanceRequest` type.
#[derive(Debug, Clone, Default, Serialize, Deserialize, JsonHash)]
pub struct RollbackInstanceRequest {
    /// revisionId property.
    pub revision_id: Option<String>,
    /// targetSnapshot property.
...
/// `ReportInstanceInfoSystemRequest` type.
#[derive(Debug, Clone, Default, Serialize, Deserialize, JsonHash)]
...
/// Arguments for [`notebooks.projects.locations.get_builder`].
...
/// Arguments for [`notebooks.projects.locations.list_builder`].
#[derive(Debug, Clone, Default, Serialize, JsonHash)]
...
/// Arguments for [`notebooks.projects.locations.operations.cancel_builder`].
#[derive(Debug, Clone, Default, Serialize, JsonHash)]
...
/// Arguments for [`notebooks.projects.locations.operations.delete_builder`].
#[derive(Debug, Clone, Default, Serialize, JsonHash)]
...
/// Arguments for [`notebooks.projects.locations.operations.get_builder`].
#[derive(Debug, Clone, Default, Serialize, JsonHash)]
...
/// Arguments for [`notebooks.projects.locations.operations.list_builder`].
#[derive(Debug, Clone, Default, Serialize, JsonHash)]
...
///
/// ```ignore
/// let task = notebooks_projects_locations_get_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn notebooks_projects_locations_get_request<R, F>(
...
{
    let endpoint_url = format!("https://notebooks.googleapis.com/v2/{}", args.name,);
...
///
/// ```ignore
/// let task = notebooks_projects_locations_list_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn notebooks_projects_locations_list_request<R, F>(
    client: &SimpleHttpClient<R>,
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://notebooks.googleapis.com/v2/{}/locations",
        args.name,
    );
...
{
    let endpoint_url = format!(
        "https://notebooks.googleapis.com/v2/{}:checkAuthorization",
        args.name,
    );
...
{
    let endpoint_url = format!(
        "https://notebooks.googleapis.com/v2/{}:checkUpgradability",
        args.notebook_instance,
    );
...
{
    let endpoint_url = format!(
        "https://notebooks.googleapis.com/v2/{}/instances",
        args.parent,
    );
...
where
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!("https://notebooks.googleapis.com/v2/{}:diagnose", args.name,);
...
{
    let endpoint_url = format!(
        "https://notebooks.googleapis.com/v2/{}:generateAccessToken",
        args.name,
    );
...
{
    let endpoint_url = format!(
        "https://notebooks.googleapis.com/v2/{}/instances:getConfig",
        args.name,
    );
...
{
    let endpoint_url = format!(
        "https://notebooks.googleapis.com/v2/{}:getIamPolicy",
        args.resource,
    );
...
{
    let endpoint_url = format!(
        "https://notebooks.googleapis.com/v2/{}:reportInfoSystem",
        args.name,
    );
...
where
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!("https://notebooks.googleapis.com/v2/{}:reset", args.name,);
...
{
    let endpoint_url = format!(
        "https://notebooks.googleapis.com/v2/{}:resizeDisk",
        args.notebook_instance,
    );
...
where
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!("https://notebooks.googleapis.com/v2/{}:restore", args.name,);
...
where
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!("https://notebooks.googleapis.com/v2/{}:rollback", args.name,);
...
{
    let endpoint_url = format!(
        "https://notebooks.googleapis.com/v2/{}:setIamPolicy",
        args.resource,
    );
...
where
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!("https://notebooks.googleapis.com/v2/{}:start", args.name,);
...
where
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!("https://notebooks.googleapis.com/v2/{}:stop", args.name,);
...
{
    let endpoint_url = format!(
        "https://notebooks.googleapis.com/v2/{}:testIamPermissions",
        args.resource,
    );
...
where
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!("https://notebooks.googleapis.com/v2/{}:upgrade", args.name,);
...
{
    let endpoint_url = format!(
        "https://notebooks.googleapis.com/v2/{}:upgradeSystem",
        args.name,
    );
...
///
/// ```ignore
/// let task = notebooks_projects_locations_operations_cancel_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn notebooks_projects_locations_operations_cancel_request<R, F>(
    client: &SimpleHttpClient<R>,
...
where
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!("https://notebooks.googleapis.com/v2/{}:cancel", args.name,);
...
///
/// ```ignore
/// let task = notebooks_projects_locations_operations_delete_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn notebooks_projects_locations_operations_delete_request<R, F>(
    client: &SimpleHttpClient<R>,
...
///
/// ```ignore
/// let task = notebooks_projects_locations_operations_get_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn notebooks_projects_locations_operations_get_request<R, F>(
    client: &SimpleHttpClient<R>,
...
///
/// ```ignore
/// let task = notebooks_projects_locations_operations_list_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn notebooks_projects_locations_operations_list_request<R, F>(
    client: &SimpleHttpClient<R>,
...
{
    let endpoint_url = format!(
        "https://notebooks.googleapis.com/v2/{}/operations",
        args.name,
    );
