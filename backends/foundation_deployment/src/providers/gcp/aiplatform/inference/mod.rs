//! Auto-generated API module for gcp/aiplatform inference.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_aiplatform_inference `
...
/// Arguments for [`aiplatform.projects.locations.endpoints.google.science.inference_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
pub struct AiplatformProjectsLocationsEndpointsGoogleScienceInferenceArgs {
...
///
/// ```ignore
/// let task = aiplatform_projects_locations_endpoints_google_science_inference_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn aiplatform_projects_locations_endpoints_google_science_inference_request<R, F>(
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://aiplatform.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/endpoints/google/science/inference",
    );
