//! Auto-generated API module for gcp/aiplatform memories:generate.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_aiplatform_memories_generate `
...
/// Arguments for [`aiplatform.projects.locations.reasoningEngines.memories.generate_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
pub struct AiplatformProjectsLocationsReasoningEnginesMemoriesGenerateArgs {
...
// -----------------------------------------------------------------------------
// POST v1/projects/{projectsId}/locations/{locationsId}/reasoningEngines/{reasoningEnginesId}/memories:generate
// -----------------------------------------------------------------------------
...
///
/// ```ignore
/// let task = aiplatform_projects_locations_reasoning_engines_memories_generate_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn aiplatform_projects_locations_reasoning_engines_memories_generate_request<R, F>(
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://aiplatform.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/reasoningEngines/{{reasoningEnginesId}}/memories:generate",
    );
