//! Auto-generated API module for gcp/aiplatform studies:lookup.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_aiplatform_studies_lookup `
...
/// Arguments for [`aiplatform.projects.locations.studies.lookup_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
pub struct AiplatformProjectsLocationsStudiesLookupArgs {
...
// -----------------------------------------------------------------------------
// POST v1/projects/{projectsId}/locations/{locationsId}/studies:lookup
// -----------------------------------------------------------------------------
...
///
/// ```ignore
/// let task = aiplatform_projects_locations_studies_lookup_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn aiplatform_projects_locations_studies_lookup_request<R, F>(
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://aiplatform.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/studies:lookup",
    );
