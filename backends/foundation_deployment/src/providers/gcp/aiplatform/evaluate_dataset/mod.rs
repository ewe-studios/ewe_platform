//! Auto-generated API module for gcp/aiplatform v1:evaluateDataset.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_aiplatform_evaluate_dataset `
...
///
/// ```ignore
/// let task = aiplatform_evaluate_dataset_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn aiplatform_evaluate_dataset_request<R, F>(
