//! Auto-generated API module for gcp/aiplatform dataItems.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_aiplatform_data_items `
...
/// `GoogleCloudAiplatformV1ListDataItemsResponse` type.
#[derive(Debug, Clone, Serialize, Deserialize, JsonHash)]
pub struct GoogleCloudAiplatformV1ListDataItemsResponse {
    /// dataItems property.
    pub data_items: Option<Vec<GoogleCloudAiplatformV1DataItem>>,
...
/// Arguments for [`aiplatform.projects.locations.datasets.dataItems.list_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
pub struct AiplatformProjectsLocationsDatasetsDataItemsListArgs {
...
///
/// ```ignore
/// let task = aiplatform_projects_locations_datasets_data_items_list_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn aiplatform_projects_locations_datasets_data_items_list_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<
                ApiResponse<GoogleCloudAiplatformV1ListDataItemsResponse>,
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://aiplatform.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/datasets/{{datasetsId}}/dataItems",
    );
    ...
    Ok(builder
        ...
        .map_ready(|intro| match intro {
            super::shared::RequestIntro::Success {
                ...
                let parsed: GoogleCloudAiplatformV1ListDataItemsResponse =
