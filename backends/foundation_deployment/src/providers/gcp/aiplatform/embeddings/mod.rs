//! Auto-generated API module for gcp/aiplatform embeddings.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_aiplatform_embeddings `
...
/// Arguments for [`aiplatform.projects.locations.endpoints.openapi.embeddings_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
pub struct AiplatformProjectsLocationsEndpointsOpenapiEmbeddingsArgs {
...
///
/// ```ignore
/// let task = aiplatform_projects_locations_endpoints_openapi_embeddings_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn aiplatform_projects_locations_endpoints_openapi_embeddings_request<R, F>(
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://aiplatform.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/endpoints/openapi/embeddings",
    );
