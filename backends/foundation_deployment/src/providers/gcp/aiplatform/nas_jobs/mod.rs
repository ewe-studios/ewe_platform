//! Auto-generated API module for gcp/aiplatform nasJobs.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_aiplatform_nas_jobs `
...
#[derive(Debug, Clone, Serialize, Deserialize, JsonHash)]
pub struct GoogleCloudAiplatformV1NasJob {
    /// createTime property.
    pub create_time: Option<String>,
    /// displayName property.
    pub display_name: Option<String>,
    /// enableRestrictedImageTraining property.
    pub enable_restricted_image_training: Option<bool>,
    ...
    /// name property.
    pub name: Option<String>,
    /// nasJobOutput property.
    pub nas_job_output: Option<GoogleCloudAiplatformV1NasJobOutput>,
    /// nasJobSpec property.
    pub nas_job_spec: Option<GoogleCloudAiplatformV1NasJobSpec>,
...
#[derive(Debug, Clone, Serialize, Deserialize, JsonHash)]
pub struct GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecSearchTrialSpec {
    ...
    /// searchTrialJobSpec property.
    pub search_trial_job_spec: Option<GoogleCloudAiplatformV1CustomJobSpec>,
}
...
/// Arguments for [`aiplatform.projects.locations.nasJobs.cancel_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
pub struct AiplatformProjectsLocationsNasJobsCancelArgs {
    /// Path parameter: `name`.
    pub name: String,
}

/// Arguments for [`aiplatform.projects.locations.nasJobs.create_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
pub struct AiplatformProjectsLocationsNasJobsCreateArgs {
    /// Path parameter: `parent`.
    pub parent: String,
}

/// Arguments for [`aiplatform.projects.locations.nasJobs.delete_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
pub struct AiplatformProjectsLocationsNasJobsDeleteArgs {
    /// Path parameter: `name`.
    pub name: String,
}

/// Arguments for [`aiplatform.projects.locations.nasJobs.get_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
pub struct AiplatformProjectsLocationsNasJobsGetArgs {
    /// Path parameter: `name`.
    pub name: String,
}

/// Arguments for [`aiplatform.projects.locations.nasJobs.list_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
pub struct AiplatformProjectsLocationsNasJobsListArgs {
    /// Path parameter: `parent`.
    pub parent: String,
...
// -----------------------------------------------------------------------------
// POST v1/projects/{projectsId}/locations/{locationsId}/nasJobs/{nasJobsId}:cancel
// -----------------------------------------------------------------------------
...
///
/// ```ignore
/// let task = aiplatform_projects_locations_nas_jobs_cancel_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn aiplatform_projects_locations_nas_jobs_cancel_request<R, F>(
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://aiplatform.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/nasJobs/{{nasJobsId}}:cancel",
    );
...
// -----------------------------------------------------------------------------
// POST v1/projects/{projectsId}/locations/{locationsId}/nasJobs
// -----------------------------------------------------------------------------
...
///
/// ```ignore
/// let task = aiplatform_projects_locations_nas_jobs_create_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn aiplatform_projects_locations_nas_jobs_create_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<ApiResponse<GoogleCloudAiplatformV1NasJob>, super::shared::ApiError>,
            Pending = super::shared::ApiPending,
            Spawner = super::shared::BoxedSendExecutionAction,
        > + Send
        + 'static,
...
{
    let endpoint_url = format!(
        "https://aiplatform.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/nasJobs",
    );
    ...
    Ok(builder
        ...
        .map_ready(|intro| match intro {
            super::shared::RequestIntro::Success {
                ...
                let body =
                    foundation_core::wire::simple_http::client::body_reader::collect_string(stream);
                let parsed: GoogleCloudAiplatformV1NasJob =
                    serde_json::from_str(&body).map_err(|e: serde_json::Error| {
                        super::shared::ApiError::ParseFailed(e.to_string())
                    })?;
                Ok(ApiResponse {
...
// -----------------------------------------------------------------------------
// DELETE v1/projects/{projectsId}/locations/{locationsId}/nasJobs/{nasJobsId}
// -----------------------------------------------------------------------------
...
///
/// ```ignore
/// let task = aiplatform_projects_locations_nas_jobs_delete_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn aiplatform_projects_locations_nas_jobs_delete_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
...
{
    let endpoint_url = format!(
        "https://aiplatform.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/nasJobs/{{nasJobsId}}",
    );
...
// -----------------------------------------------------------------------------
// GET v1/projects/{projectsId}/locations/{locationsId}/nasJobs/{nasJobsId}
// -----------------------------------------------------------------------------
...
///
/// ```ignore
/// let task = aiplatform_projects_locations_nas_jobs_get_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn aiplatform_projects_locations_nas_jobs_get_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
...
///
/// ```ignore
/// let task = aiplatform_projects_locations_nas_jobs_list_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn aiplatform_projects_locations_nas_jobs_list_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<
                ApiResponse<GoogleCloudAiplatformV1ListNasJobsResponse>,
                super::shared::ApiError,
            >,
            Pending = super::shared::ApiPending,
            Spawner = super::shared::BoxedSendExecutionAction,
    ...
    Ok(builder
        ...
        .map_ready(|intro| match intro {
            super::shared::RequestIntro::Success {
                ...
                let body =
                    foundation_core::wire::simple_http::client::body_reader::collect_string(stream);
                let parsed: GoogleCloudAiplatformV1ListNasJobsResponse =
                    serde_json::from_str(&body).map_err(|e: serde_json::Error| {
                        super::shared::ApiError::ParseFailed(e.to_string())
                    })?;
                Ok(ApiResponse {
