//! Auto-generated API module for gcp/aiplatform cacheConfig.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_aiplatform_cache_config `
...
/// `GoogleCloudAiplatformV1CacheConfig` type.
#[derive(Debug, Clone, Serialize, Deserialize, JsonHash)]
pub struct GoogleCloudAiplatformV1CacheConfig {
...
/// Arguments for [`aiplatform.projects.getCacheConfig_builder`].
...
/// Arguments for [`aiplatform.projects.updateCacheConfig_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
pub struct AiplatformProjectsUpdateCacheConfigArgs {
    /// Path parameter: `name`.
    pub name: String,
}
...
///
/// ```ignore
/// let task = aiplatform_projects_get_cache_config_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn aiplatform_projects_get_cache_config_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<
                ApiResponse<GoogleCloudAiplatformV1CacheConfig>,
...
{
    let endpoint_url =
        format!("https://aiplatform.googleapis.com/v1/projects/{{projectsId}}/cacheConfig",);
...
// -----------------------------------------------------------------------------
// PATCH v1/projects/{projectsId}/cacheConfig
// -----------------------------------------------------------------------------
...
///
/// ```ignore
/// let task = aiplatform_projects_update_cache_config_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn aiplatform_projects_update_cache_config_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
