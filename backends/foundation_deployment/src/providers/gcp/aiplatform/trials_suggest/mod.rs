//! Auto-generated API module for gcp/aiplatform trials:suggest.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_aiplatform_trials_suggest `
...
/// Arguments for [`aiplatform.projects.locations.studies.trials.suggest_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
pub struct AiplatformProjectsLocationsStudiesTrialsSuggestArgs {
...
///
/// ```ignore
/// let task = aiplatform_projects_locations_studies_trials_suggest_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn aiplatform_projects_locations_studies_trials_suggest_request<R, F>(
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://aiplatform.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/studies/{{studiesId}}/trials:suggest",
    );
