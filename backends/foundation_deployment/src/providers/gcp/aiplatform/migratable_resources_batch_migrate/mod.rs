//! Auto-generated API module for gcp/aiplatform migratableResources:batchMigrate.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_aiplatform_migratable_resources_batch_migrate `
...
/// Arguments for [`aiplatform.projects.locations.migratableResources.batchMigrate_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
pub struct AiplatformProjectsLocationsMigratableResourcesBatchMigrateArgs {
...
// -----------------------------------------------------------------------------
// POST v1/projects/{projectsId}/locations/{locationsId}/migratableResources:batchMigrate
// -----------------------------------------------------------------------------
...
///
/// ```ignore
/// let task = aiplatform_projects_locations_migratable_resources_batch_migrate_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn aiplatform_projects_locations_migratable_resources_batch_migrate_request<R, F>(
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://aiplatform.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/migratableResources:batchMigrate",
    );
