//! Auto-generated API module for gcp/aiplatform responses.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_aiplatform_responses `
...
/// Arguments for [`aiplatform.projects.locations.endpoints.openapi.responses_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
pub struct AiplatformProjectsLocationsEndpointsOpenapiResponsesArgs {
...
///
/// ```ignore
/// let task = aiplatform_projects_locations_endpoints_openapi_responses_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn aiplatform_projects_locations_endpoints_openapi_responses_request<R, F>(
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://aiplatform.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/endpoints/openapi/responses",
    );
