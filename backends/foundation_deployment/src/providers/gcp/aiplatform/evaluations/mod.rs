//! Auto-generated API module for gcp/aiplatform evaluations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_aiplatform_evaluations `
...
/// `GoogleCloudAiplatformV1ListModelEvaluationsResponse` type.
#[derive(Debug, Clone, Serialize, Deserialize, JsonHash)]
pub struct GoogleCloudAiplatformV1ListModelEvaluationsResponse {
    /// modelEvaluations property.
    pub model_evaluations: Option<Vec<GoogleCloudAiplatformV1ModelEvaluation>>,
...
/// Arguments for [`aiplatform.projects.locations.models.evaluations.get_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
pub struct AiplatformProjectsLocationsModelsEvaluationsGetArgs {
    /// Path parameter: `name`.
    pub name: String,
}

/// Arguments for [`aiplatform.projects.locations.models.evaluations.list_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
pub struct AiplatformProjectsLocationsModelsEvaluationsListArgs {
...
// -----------------------------------------------------------------------------
// GET v1/projects/{projectsId}/locations/{locationsId}/models/{modelsId}/evaluations/{evaluationsId}
// -----------------------------------------------------------------------------
...
///
/// ```ignore
/// let task = aiplatform_projects_locations_models_evaluations_get_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn aiplatform_projects_locations_models_evaluations_get_request<R, F>(
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://aiplatform.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/models/{{modelsId}}/evaluations/{{evaluationsId}}",
    );
...
///
/// ```ignore
/// let task = aiplatform_projects_locations_models_evaluations_list_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn aiplatform_projects_locations_models_evaluations_list_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
            Ready = Result<
                ApiResponse<GoogleCloudAiplatformV1ListModelEvaluationsResponse>,
                super::shared::ApiError,
            >,
            Pending = super::shared::ApiPending,
            Spawner = super::shared::BoxedSendExecutionAction,
...
{
    let endpoint_url = format!(
        "https://aiplatform.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/models/{{modelsId}}/evaluations",
    );
    ...
    Ok(builder
        ...
        .map_ready(|intro| match intro {
            super::shared::RequestIntro::Success {
                ...
                let body =
                    foundation_core::wire::simple_http::client::body_reader::collect_string(stream);
                let parsed: GoogleCloudAiplatformV1ListModelEvaluationsResponse =
