//! Auto-generated API module for gcp/aiplatform tuningJobs:rebaseTunedModel.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_aiplatform_tuning_jobs_rebase_tuned_model `
...
/// Arguments for [`aiplatform.projects.locations.tuningJobs.rebaseTunedModel_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
pub struct AiplatformProjectsLocationsTuningJobsRebaseTunedModelArgs {
...
// -----------------------------------------------------------------------------
// POST v1/projects/{projectsId}/locations/{locationsId}/tuningJobs:rebaseTunedModel
// -----------------------------------------------------------------------------
...
///
/// ```ignore
/// let task = aiplatform_projects_locations_tuning_jobs_rebase_tuned_model_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn aiplatform_projects_locations_tuning_jobs_rebase_tuned_model_request<R, F>(
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://aiplatform.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/tuningJobs:rebaseTunedModel",
    );
