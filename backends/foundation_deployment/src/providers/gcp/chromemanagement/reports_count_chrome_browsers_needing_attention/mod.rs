//! Auto-generated API module for gcp/chromemanagement reports:countChromeBrowsersNeedingAttention.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_chromemanagement_reports_count_chrome_browsers_needing_attention `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://chromemanagement.googleapis.com/v1/customers/{{customersId}}/reports:countChromeBrowsersNeedingAttention",
    );
