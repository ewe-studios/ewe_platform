//! Auto-generated API module for gcp/chromemanagement reports:countChromeDevicesReachingAutoExpirationDate.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_chromemanagement_reports_count_chrome_devices_reaching_au_58 `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://chromemanagement.googleapis.com/v1/customers/{{customersId}}/reports:countChromeDevicesReachingAutoExpirationDate",
    );
