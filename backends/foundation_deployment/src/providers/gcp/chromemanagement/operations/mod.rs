//! Auto-generated API module for gcp/chromemanagement operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_chromemanagement_operations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://chromemanagement.googleapis.com/v1/customers/{{customersId}}/certificateProvisioningProcesses/{{certificateProvisioningProcessesId}}/operations/{{operationsId}}",
    );
...
{
    let endpoint_url =
        format!("https://chromemanagement.googleapis.com/v1/operations/{{operationsId}}:cancel",);
...
{
    let endpoint_url =
        format!("https://chromemanagement.googleapis.com/v1/operations/{{operationsId}}",);
