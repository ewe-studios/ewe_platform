//! Auto-generated API module for gcp/chromemanagement apps:fetchDevicesRequestingExtension.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_chromemanagement_apps_fetch_devices_requesting_extension `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://chromemanagement.googleapis.com/v1/customers/{{customersId}}/apps:fetchDevicesRequestingExtension",
    );
