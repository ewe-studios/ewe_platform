//! Auto-generated API module for gcp/chromemanagement thirdPartyProfileUsers.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_chromemanagement_third_party_profile_users `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://chromemanagement.googleapis.com/v1/customers/{{customersId}}/thirdPartyProfileUsers/{{thirdPartyProfileUsersId}}:move",
    );
