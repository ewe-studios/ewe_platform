...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/cloudchannel/openapi.json`.
...
pub struct GoogleCloudChannelV1BillingAccountPurchaseInfo {
    ...
    pub billing_account:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1BillingAccount>>,
}
...
pub struct GoogleCloudChannelV1ChangeOfferRequest {
    ...
    #[serde(default)]
    pub parameters:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudChannelV1Parameter>>>,
...
pub struct GoogleCloudChannelV1ChangeRenewalSettingsRequest {
    ...
    pub renewal_settings:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1RenewalSettings>>,
    /// Optional. You can specify an optional unique request ID, and if you need to retry your request, the server will know to ignore the request if it''s complete. For example, you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if it received the original operation with the same request ID. If it did, it will ignore the second request. The request ID must be a valid [UUID](https://tools.ietf.org/html/rfc4122) with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
    #[serde(default, rename = "requestId")]
    pub request_id: ::core::option::Option<String>,
}
...
pub struct GoogleCloudChannelV1ChannelPartnerLink {
    ...
    pub channel_partner_cloud_identity_info:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1CloudIdentityInfo>>,
...
pub struct GoogleCloudChannelV1ChannelPartnerRepricingConfig {
    ...
    pub repricing_config:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1RepricingConfig>>,
...
pub struct GoogleCloudChannelV1CheckCloudIdentityAccountsExistResponse {
    ...
    pub cloud_identity_accounts: ::core::option::Option<
...
pub struct GoogleCloudChannelV1CloudIdentityInfo {
    ...
    pub edu_data: ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1EduData>>,
...
pub struct GoogleCloudChannelV1ConditionalOverride {
    ...
    #[serde(default)]
    pub adjustment:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1RepricingAdjustment>>,
    ...
    pub repricing_condition:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1RepricingCondition>>,
}
...
pub struct GoogleCloudChannelV1Constraints {
    ...
    pub customer_constraints:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1CustomerConstraints>>,
}
...
pub struct GoogleCloudChannelV1CreateEntitlementRequest {
    ...
    #[serde(default)]
    pub entitlement: ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1Entitlement>>,
    /// Optional. You can specify an optional unique request ID, and if you need to retry your request, the server will know to ignore the request if it''s complete. For example, you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if it received the original operation with the same request ID. If it did, it will ignore the second request. The request ID must be a valid [UUID](https://tools.ietf.org/html/rfc4122) with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
    #[serde(default, rename = "requestId")]
    pub request_id: ::core::option::Option<String>,
}
...
pub struct GoogleCloudChannelV1Customer {
    ...
    pub org_postal_address: ::core::option::Option<::std::boxed::Box<GoogleTypePostalAddress>>,
    /// Primary contact info.
    #[serde(default, rename = "primaryContactInfo")]
    pub primary_contact_info:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1ContactInfo>>,
...
pub struct GoogleCloudChannelV1DateRange {
    ...
    pub invoice_end_date: ::core::option::Option<::std::boxed::Box<GoogleTypeDate>>,
    ...
    pub invoice_start_date: ::core::option::Option<::std::boxed::Box<GoogleTypeDate>>,
    ...
    pub usage_end_date_time: ::core::option::Option<::std::boxed::Box<GoogleTypeDateTime>>,
    ...
    pub usage_start_date_time: ::core::option::Option<::std::boxed::Box<GoogleTypeDateTime>>,
}
...
pub struct GoogleCloudChannelV1DiscountComponent {
    ...
    pub discount_absolute: ::core::option::Option<::std::boxed::Box<GoogleTypeMoney>>,
...
pub struct GoogleCloudChannelV1Entitlement {
    ...
    pub association_info:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1AssociationInfo>>,
    ...
    pub commitment_settings:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1CommitmentSettings>>,
    ...
    pub provisioned_service:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1ProvisionedService>>,
    ...
    pub trial_settings:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1TrialSettings>>,
...
pub struct GoogleCloudChannelV1FetchReportResultsResponse {
    ...
    pub report_metadata:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1ReportResultsMetadata>>,
    /// The report''s lists of values. Each row follows the settings and ordering of the columns from report_metadata.
    #[serde(default)]
    pub rows: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudChannelV1Row>>>,
}
...
pub struct GoogleCloudChannelV1ListChannelPartnerLinksResponse {
    ...
    pub channel_partner_links: ::core::option::Option<
...
pub struct GoogleCloudChannelV1ListChannelPartnerRepricingConfigsResponse {
    ...
    pub channel_partner_repricing_configs: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudChannelV1ChannelPartnerRepricingConfig>>,
    >,
...
pub struct GoogleCloudChannelV1ListCustomerRepricingConfigsResponse {
    ...
    pub customer_repricing_configs: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudChannelV1CustomerRepricingConfig>>,
    >,
...
pub struct GoogleCloudChannelV1ListCustomersResponse {
    ...
    #[serde(default)]
    pub customers:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudChannelV1Customer>>>,
...
pub struct GoogleCloudChannelV1ListEntitlementChangesResponse {
    ...
    pub entitlement_changes: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudChannelV1EntitlementChange>>,
    >,
...
pub struct GoogleCloudChannelV1ListEntitlementsResponse {
    ...
    #[serde(default)]
    pub entitlements:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudChannelV1Entitlement>>>,
...
pub struct GoogleCloudChannelV1ListOffersResponse {
    ...
    #[serde(default)]
    pub offers:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudChannelV1Offer>>>,
}
...
pub struct GoogleCloudChannelV1ListProductsResponse {
    ...
    #[serde(default)]
    pub products:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudChannelV1Product>>>,
}
...
pub struct GoogleCloudChannelV1ListPurchasableOffersResponse {
    ...
    pub purchasable_offers: ::core::option::Option<
...
pub struct GoogleCloudChannelV1ListPurchasableSkusResponse {
    ...
    pub purchasable_skus: ::core::option::Option<
...
pub struct GoogleCloudChannelV1ListReportsResponse {
    ...
    #[serde(default)]
    pub reports:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudChannelV1Report>>>,
}
...
pub struct GoogleCloudChannelV1ListSkuGroupBillableSkusResponse {
    ...
    pub billable_skus:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudChannelV1BillableSku>>>,
...
pub struct GoogleCloudChannelV1ListSkuGroupsResponse {
    ...
    pub sku_groups:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudChannelV1SkuGroup>>>,
}
...
pub struct GoogleCloudChannelV1ListSkusResponse {
    ...
    /// The list of SKUs requested.
    #[serde(default)]
    pub skus: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudChannelV1Sku>>>,
}
...
pub struct GoogleCloudChannelV1ListTransferableOffersResponse {
    ...
    pub transferable_offers: ::core::option::Option<
...
pub struct GoogleCloudChannelV1ListTransferableSkusResponse {
    ...
    pub transferable_skus: ::core::option::Option<
...
pub struct GoogleCloudChannelV1MarketingInfo {
    ...
    pub default_logo: ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1Media>>,
...
pub struct GoogleCloudChannelV1Offer {
    ...
    #[serde(default)]
    pub constraints: ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1Constraints>>,
    ...
    pub marketing_info:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1MarketingInfo>>,
    /// Resource Name of the Offer. Format: accounts/{account_id}/offers/{offer_id}
    #[serde(default)]
    pub name: ::core::option::Option<String>,
    /// Parameters required to use current Offer to purchase.
    #[serde(default, rename = "parameterDefinitions")]
    pub parameter_definitions: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudChannelV1ParameterDefinition>>,
    >,
    /// Describes the payment plan for the Offer.
    #[serde(default)]
    pub plan: ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1Plan>>,
    /// Price for each monetizable resource type.
    #[serde(default, rename = "priceByResources")]
    pub price_by_resources: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudChannelV1PriceByResource>>,
    >,
    /// SKU the offer is associated with.
    #[serde(default)]
    pub sku: ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1Sku>>,
...
pub struct GoogleCloudChannelV1Parameter {
    ...
    #[serde(default)]
    pub value: ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1Value>>,
}
...
pub struct GoogleCloudChannelV1ParameterDefinition {
    ...
    pub allowed_values:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudChannelV1Value>>>,
    ...
    pub max_value: ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1Value>>,
    ...
    pub min_value: ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1Value>>,
    /// Name of the parameter.
    #[serde(default)]
    pub name: ::core::option::Option<String>,
...
pub struct GoogleCloudChannelV1PercentageAdjustment {
    ...
    #[serde(default)]
    pub percentage: ::core::option::Option<::std::boxed::Box<GoogleTypeDecimal>>,
}
...
pub struct GoogleCloudChannelV1Plan {
    ...
    pub payment_cycle: ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1Period>>,
    ...
    pub trial_period: ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1Period>>,
}
...
pub struct GoogleCloudChannelV1Price {
    ...
    pub base_price: ::core::option::Option<::std::boxed::Box<GoogleTypeMoney>>,
    ...
    pub discount_components: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudChannelV1DiscountComponent>>,
    >,
    /// Effective Price after applying the discounts.
    #[serde(default, rename = "effectivePrice")]
    pub effective_price: ::core::option::Option<::std::boxed::Box<GoogleTypeMoney>>,
    ...
    pub price_period: ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1Period>>,
}
...
pub struct GoogleCloudChannelV1PriceByResource {
    ...
    #[serde(default)]
    pub price: ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1Price>>,
    /// Specifies the price by time range.
    #[serde(default, rename = "pricePhases")]
    pub price_phases:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudChannelV1PricePhase>>>,
...
pub struct GoogleCloudChannelV1PricePhase {
    ...
    pub price_tiers:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudChannelV1PriceTier>>>,
}
...
pub struct GoogleCloudChannelV1ProvisionCloudIdentityRequest {
    ...
    #[serde(default)]
    pub user: ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1AdminUser>>,
...
pub struct GoogleCloudChannelV1PurchasableOffer {
    /// Offer.
    #[serde(default)]
    pub offer: ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1Offer>>,
    /// Optional. Price reference ID for the offer. Only for offers that require additional price information. Used to guarantee that the pricing is consistent between quoting the offer and placing the order.
    #[serde(default, rename = "priceReferenceId")]
    pub price_reference_id: ::core::option::Option<String>,
}
...
pub struct GoogleCloudChannelV1QueryEligibleBillingAccountsResponse {
    ...
    pub sku_purchase_groups: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudChannelV1SkuPurchaseGroup>>,
    >,
}
...
pub struct GoogleCloudChannelV1Report {
    ...
    #[serde(default)]
    pub columns:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudChannelV1Column>>>,
...
pub struct GoogleCloudChannelV1ReportJob {
    ...
    pub report_status: ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1ReportStatus>>,
}
...
pub struct GoogleCloudChannelV1ReportResultsMetadata {
    ...
    pub date_range: ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1DateRange>>,
    ...
    pub preceding_date_range:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1DateRange>>,
    /// Details of the completed report.
    #[serde(default)]
    pub report: ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1Report>>,
...
pub struct GoogleCloudChannelV1ReportValue {
    ...
    pub date_time_value: ::core::option::Option<::std::boxed::Box<GoogleTypeDateTime>>,
    ...
    pub decimal_value: ::core::option::Option<::std::boxed::Box<GoogleTypeDecimal>>,
    /// A value of type int.
...
pub struct GoogleCloudChannelV1RepricingAdjustment {
    ...
    pub percentage_adjustment:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1PercentageAdjustment>>,
}
...
pub struct GoogleCloudChannelV1RepricingCondition {
    ...
    pub sku_group_condition:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1SkuGroupCondition>>,
}
...
pub struct GoogleCloudChannelV1RepricingConfig {
    ...
    pub conditional_overrides: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudChannelV1ConditionalOverride>>,
    >,
    ...
    pub effective_invoice_month: ::core::option::Option<::std::boxed::Box<GoogleTypeDate>>,
    ...
    pub entitlement_granularity: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudChannelV1RepricingConfigEntitlementGranularity>,
    >,
...
pub struct GoogleCloudChannelV1Row {
    ...
    #[serde(default)]
    pub values:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudChannelV1ReportValue>>>,
}
...
pub struct GoogleCloudChannelV1RunReportJobResponse {
    ...
    pub report_job: ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1ReportJob>>,
...
pub struct GoogleCloudChannelV1Sku {
    ...
    #[serde(default)]
    pub product: ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1Product>>,
}
...
pub struct GoogleCloudChannelV1SkuPurchaseGroup {
    ...
    pub billing_account_purchase_infos: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudChannelV1BillingAccountPurchaseInfo>>,
    >,
...
pub struct GoogleCloudChannelV1SubscriberEvent {
    ...
    pub customer_event:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1CustomerEvent>>,
    /// Entitlement event sent as part of Pub/Sub event to partners.
    #[serde(default, rename = "entitlementEvent")]
    pub entitlement_event:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1EntitlementEvent>>,
}
...
pub struct GoogleCloudChannelV1TransferableSku {
    ...
    pub legacy_sku: ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1Sku>>,
    ...
    pub transfer_eligibility:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1TransferEligibility>>,
}
...
pub struct GoogleCloudChannelV1UpdateChannelPartnerLinkRequest {
    ...
    pub channel_partner_link:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1ChannelPartnerLink>>,
...
pub struct GoogleCloudChannelV1alpha1CommitmentSettings {
    ...
    #[serde(default, rename = "renewalSettings")]
    pub renewal_settings:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1alpha1RenewalSettings>>,
    /// Output only. Commitment start timestamp.
    #[serde(default, rename = "startTime")]
    pub start_time: ::core::option::Option<String>,
}
...
pub struct GoogleCloudChannelV1alpha1Entitlement {
    ...
    #[serde(default, rename = "associationInfo")]
    pub association_info:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1alpha1AssociationInfo>>,
    /// Optional. The billing account resource name that is used to pay for this entitlement.
    #[serde(default, rename = "billingAccount")]
    pub billing_account: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "commitmentSettings")]
    pub commitment_settings:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1alpha1CommitmentSettings>>,
    /// Output only. The time at which the entitlement is created.
    #[serde(default, rename = "createTime")]
    pub create_time: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "provisionedService")]
    pub provisioned_service:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1alpha1ProvisionedService>>,
    ...
    #[serde(default, rename = "trialSettings")]
    pub trial_settings:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1alpha1TrialSettings>>,
    /// Output only. The time at which the entitlement is updated.
    #[serde(default, rename = "updateTime")]
    pub update_time: ::core::option::Option<String>,
}
...
pub struct GoogleCloudChannelV1alpha1Parameter {
    ...
    /// Value of the parameter.
    #[serde(default)]
    pub value: ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1alpha1Value>>,
}
...
pub struct GoogleCloudChannelV1alpha1RenewalSettings {
    ...
    /// Describes how frequently the reseller will be billed, such as once per month.
    #[serde(default, rename = "paymentCycle")]
    pub payment_cycle: ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1alpha1Period>>,
...
pub struct GoogleCloudChannelV1alpha1Report {
    ...
    pub columns: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudChannelV1alpha1Column>>,
    >,
    /// A description of other aspects of the report, such as the products it supports.
    #[serde(default)]
    pub description: ::core::option::Option<String>,
...
pub struct GoogleCloudChannelV1alpha1ReportJob {
    ...
    #[serde(default, rename = "reportStatus")]
    pub report_status:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1alpha1ReportStatus>>,
}
...
pub struct GoogleCloudChannelV1alpha1ReportResultsMetadata {
    /// The date range of reported usage.
    #[serde(default, rename = "dateRange")]
    pub date_range: ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1alpha1DateRange>>,
    /// The usage dates immediately preceding date_range with the same duration. Use this to calculate trending usage and costs. This is only populated if you request trending data. For example, if date_range is July 1-15, preceding_date_range will be June 16-30.
    #[serde(default, rename = "precedingDateRange")]
    pub preceding_date_range:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1alpha1DateRange>>,
    /// Details of the completed report.
    #[serde(default)]
    pub report: ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1alpha1Report>>,
    /// The total number of rows of data in the final report.
    #[serde(default, rename = "rowCount")]
    pub row_count: ::core::option::Option<String>,
}
...
pub struct GoogleCloudChannelV1alpha1RunReportJobResponse {
    /// Pass report_job.name to FetchReportResultsRequest.report_job to retrieve the report''s results.
    #[serde(default, rename = "reportJob")]
    pub report_job: ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1alpha1ReportJob>>,
    /// The metadata for the report''s results (display name, columns, row count, and date range). If you view this before the operation finishes, you may see incomplete data.
    #[serde(default, rename = "reportMetadata")]
    pub report_metadata:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1alpha1ReportResultsMetadata>>,
}
...
pub struct GoogleCloudChannelV1alpha1SubscriberEvent {
    ...
    pub channel_partner_event:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1alpha1ChannelPartnerEvent>>,
    /// Customer event sent as part of Pub/Sub event to partners.
    #[serde(default, rename = "customerEvent")]
    pub customer_event:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1alpha1CustomerEvent>>,
    /// Entitlement event sent as part of Pub/Sub event to partners.
    #[serde(default, rename = "entitlementEvent")]
    pub entitlement_event:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1alpha1EntitlementEvent>>,
    /// Opportunity event sent as part of Pub/Sub event to partners/integrators.
    #[serde(default, rename = "opportunityEvent")]
    pub opportunity_event:
        ::core::option::Option<::std::boxed::Box<GoogleCloudChannelV1alpha1OpportunityEvent>>,
}
