...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/vmwareengine/openapi.json`.
...
pub struct AutoscalingPolicy {
    ...
    pub consumed_memory_thresholds: ::core::option::Option<::std::boxed::Box<Thresholds>>,
    /// Optional. Utilization thresholds pertaining to CPU utilization.
    #[serde(default, rename = "cpuThresholds")]
    pub cpu_thresholds: ::core::option::Option<::std::boxed::Box<Thresholds>>,
    /// Optional. Utilization thresholds pertaining to amount of granted memory.
    #[serde(default, rename = "grantedMemoryThresholds")]
    pub granted_memory_thresholds: ::core::option::Option<::std::boxed::Box<Thresholds>>,
    ...
    pub storage_thresholds: ::core::option::Option<::std::boxed::Box<Thresholds>>,
}
...
pub struct Cluster {
    ...
    pub datastore_mount_config:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DatastoreMountConfig>>>,
    ...
    pub stretched_cluster_config: ::core::option::Option<::std::boxed::Box<StretchedClusterConfig>>,
...
pub struct Constraints {
    ...
    pub disallowed_intervals:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<WeeklyTimeInterval>>>,
    ...
    pub reschedule_date_range: ::core::option::Option<::std::boxed::Box<Interval>>,
}
...
pub struct Datastore {
    ...
    pub nfs_datastore: ::core::option::Option<::std::boxed::Box<NfsDatastore>>,
...
pub struct DatastoreMountConfig {
    ...
    pub datastore_network: ::core::option::Option<::std::boxed::Box<DatastoreNetwork>>,
...
pub struct DnsBindPermission {
    ...
    #[serde(default)]
    pub principals: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Principal>>>,
}
...
pub struct ExternalAccessRule {
    ...
    pub destination_ip_ranges: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<IpRange>>>,
    ...
    pub source_ip_ranges: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<IpRange>>>,
...
pub struct FetchNetworkPolicyExternalAddressesResponse {
    ...
    pub external_addresses:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ExternalAddress>>>,
...
pub struct ListDatastoresResponse {
    ...
    #[serde(default)]
    pub datastores: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Datastore>>>,
    /// A token, which can be sent as page_token to retrieve the next page. If this field is omitted, there are no subsequent pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
...
pub struct ListExternalAccessRulesResponse {
    ...
    pub external_access_rules:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ExternalAccessRule>>>,
    /// A token, which can be sent as page_token to retrieve the next page. If this field is omitted, there are no subsequent pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// Locations that could not be reached when making an aggregated query using wildcards.
...
pub struct ListHcxActivationKeysResponse {
    ...
    pub hcx_activation_keys:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<HcxActivationKey>>>,
    /// A token, which can be sent as page_token to retrieve the next page. If this field is omitted, there are no subsequent pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// Locations that could not be reached when making an aggregated query using wildcards.
...
pub struct ListLoggingServersResponse {
    ...
    pub logging_servers: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<LoggingServer>>>,
...
pub struct ListManagementDnsZoneBindingsResponse {
    ...
    pub management_dns_zone_bindings:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ManagementDnsZoneBinding>>>,
    /// A token, which can be sent as page_token to retrieve the next page. If this field is omitted, there are no subsequent pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// Locations that could not be reached when making an aggregated query using wildcards.
...
pub struct ListNetworkPeeringsResponse {
    ...
    pub network_peerings:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<NetworkPeering>>>,
    /// A token, which can be sent as page_token to retrieve the next page. If this field is omitted, there are no subsequent pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// Unreachable resources.
...
pub struct ListNetworkPoliciesResponse {
    ...
    pub network_policies: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<NetworkPolicy>>>,
    /// A token, which can be send as page_token to retrieve the next page. If this field is omitted, there are no subsequent pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// Locations that could not be reached when making an aggregated query using wildcards.
...
pub struct ListPeeringRoutesResponse {
    ...
    pub peering_routes: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PeeringRoute>>>,
}
...
pub struct ListPrivateCloudsResponse {
    ...
    pub private_clouds: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PrivateCloud>>>,
    /// Locations that could not be reached when making an aggregated query using wildcards.
    #[serde(default)]
    pub unreachable: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct ListSubnetsResponse {
    ...
    /// A list of subnets.
    #[serde(default)]
    pub subnets: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Subnet>>>,
    /// Locations that could not be reached when making an aggregated query using wildcards.
    #[serde(default)]
    pub unreachable: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct ListUpgradesResponse {
    ...
    /// A list of Upgrades.
    #[serde(default)]
    pub upgrades: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Upgrade>>>,
}
...
pub struct ListVmwareEngineNetworksResponse {
    ...
    pub vmware_engine_networks:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<VmwareEngineNetwork>>>,
}
...
pub struct MountDatastoreRequest {
    ...
    #[serde(default, rename = "datastoreMountConfig")]
    pub datastore_mount_config: ::core::option::Option<::std::boxed::Box<DatastoreMountConfig>>,
...
pub struct NetworkPolicy {
    ...
    #[serde(default, rename = "externalIp")]
    pub external_ip: ::core::option::Option<::std::boxed::Box<NetworkService>>,
    /// Network service that allows VMware workloads to access the internet.
    #[serde(default, rename = "internetAccess")]
    pub internet_access: ::core::option::Option<::std::boxed::Box<NetworkService>>,
...
pub struct NfsDatastore {
    ...
    pub google_file_service: ::core::option::Option<::std::boxed::Box<GoogleFileService>>,
    ...
    pub third_party_file_service: ::core::option::Option<::std::boxed::Box<ThirdPartyFileService>>,
}
...
pub struct PrivateCloud {
    ...
    #[serde(default)]
    pub hcx: ::core::option::Option<::std::boxed::Box<Hcx>>,
    ...
    pub management_cluster: ::core::option::Option<::std::boxed::Box<ManagementCluster>>,
    ...
    #[serde(default)]
    pub nsx: ::core::option::Option<::std::boxed::Box<Nsx>>,
    ...
    #[serde(default)]
    pub vcenter: ::core::option::Option<::std::boxed::Box<Vcenter>>,
}
...
pub struct Schedule {
    ...
    #[serde(default)]
    pub constraints: ::core::option::Option<::std::boxed::Box<Constraints>>,
    ...
    pub edit_window: ::core::option::Option<::std::boxed::Box<Interval>>,
    ...
    pub weekly_windows: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TimeWindow>>>,
}
...
pub struct Upgrade {
    ...
    pub component_upgrades:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<VmwareUpgradeComponent>>>,
...
pub struct VmwareEngineNetwork {
    ...
    pub vpc_networks: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<VpcNetwork>>>,
}
