...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/servicecontrol/openapi.json`.
...
pub struct AttributeContext {
    ...
    #[serde(default)]
    pub api: ::core::option::Option<::std::boxed::Box<Api>>,
    /// The destination of a network activity, such as accepting a TCP connection. In a multi hop network activity, the destination represents the receiver of the last hop.
    #[serde(default)]
    pub destination: ::core::option::Option<::std::boxed::Box<Peer>>,
    ...
    #[serde(default)]
    pub origin: ::core::option::Option<::std::boxed::Box<Peer>>,
    /// Represents a network request, such as an HTTP request.
    #[serde(default)]
    pub request: ::core::option::Option<::std::boxed::Box<Request>>,
    /// Represents a target resource that is involved with a network activity. If multiple resources are involved with an activity, this must be the primary one.
    #[serde(default)]
    pub resource: ::core::option::Option<::std::boxed::Box<Resource>>,
    /// Represents a network response, such as an HTTP response.
    #[serde(default)]
    pub response: ::core::option::Option<::std::boxed::Box<Response>>,
    /// The source of a network activity, such as starting a TCP connection. In a multi hop network activity, the source represents the sender of the last hop.
    #[serde(default)]
    pub source: ::core::option::Option<::std::boxed::Box<Peer>>,
}
...
pub struct AuditLog {
    ...
    pub authentication_info: ::core::option::Option<::std::boxed::Box<AuthenticationInfo>>,
    /// Authorization information. If there are multiple resources or permissions involved, then there is one AuthorizationInfo element for each {resource, permission} tuple.
    #[serde(default, rename = "authorizationInfo")]
    pub authorization_info:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AuthorizationInfo>>>,
    ...
    pub policy_violation_info: ::core::option::Option<::std::boxed::Box<PolicyViolationInfo>>,
    ...
    pub resource_location: ::core::option::Option<::std::boxed::Box<ResourceLocation>>,
...
pub struct Auth {
    ...
    #[serde(default)]
    pub oauth: ::core::option::Option<::std::boxed::Box<Oauth>>,
...
pub struct AuthenticationInfo {
    ...
    pub oauth_info: ::core::option::Option<::std::boxed::Box<OAuthInfo>>,
    ...
    pub service_delegation_history:
        ::core::option::Option<::std::boxed::Box<ServiceDelegationHistory>>,
...
pub struct AuthorizationInfo {
    ...
    pub resource_attributes: ::core::option::Option<::std::boxed::Box<Resource>>,
}
...
pub struct CheckRequest {
    ...
    #[serde(default)]
    pub attributes: ::core::option::Option<::std::boxed::Box<AttributeContext>>,
    /// Optional. Contains a comma-separated list of flags.
    #[serde(default)]
    pub flags: ::core::option::Option<String>,
    /// Describes the resources and the policies applied to each resource.
    #[serde(default)]
    pub resources: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ResourceInfo>>>,
...
pub struct OrgPolicyViolationInfo {
    ...
    pub violation_info: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ViolationInfo>>>,
}
...
pub struct PolicyViolationInfo {
    ...
    pub org_policy_violation_info:
        ::core::option::Option<::std::boxed::Box<OrgPolicyViolationInfo>>,
}
...
pub struct ReportRequest {
    ...
    #[serde(default)]
    pub operations: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AttributeContext>>>,
    /// Specifies the version of the service configuration that should be used to process the request. Must not be empty. Set this field to ''latest'' to specify using the latest configuration.
    #[serde(default, rename = "serviceConfigId")]
    pub service_config_id: ::core::option::Option<String>,
}
...
pub struct Request {
    ...
    #[serde(default)]
    pub auth: ::core::option::Option<::std::boxed::Box<Auth>>,
...
pub struct RequestMetadata {
    ...
    pub destination_attributes: ::core::option::Option<::std::boxed::Box<Peer>>,
    ...
    pub request_attributes: ::core::option::Option<::std::boxed::Box<Request>>,
}
...
pub struct ServiceAccountDelegationInfo {
    ...
    pub first_party_principal: ::core::option::Option<::std::boxed::Box<FirstPartyPrincipal>>,
    ...
    #[serde(default, rename = "thirdPartyPrincipal")]
    pub third_party_principal: ::core::option::Option<::std::boxed::Box<ThirdPartyPrincipal>>,
}
...
pub struct ServiceDelegationHistory {
    ...
    pub service_metadata:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ServiceMetadata>>>,
}
...
pub struct V2LogEntry {
    ...
    pub http_request: ::core::option::Option<::std::boxed::Box<V2HttpRequest>>,
    ...
    #[serde(default)]
    pub operation: ::core::option::Option<::std::boxed::Box<V2LogEntryOperation>>,
    ...
    pub source_location: ::core::option::Option<::std::boxed::Box<V2LogEntrySourceLocation>>,
...
pub struct V2ResourceEvent {
    ...
    #[serde(default)]
    pub parent: ::core::option::Option<::std::boxed::Box<Resource>>,
