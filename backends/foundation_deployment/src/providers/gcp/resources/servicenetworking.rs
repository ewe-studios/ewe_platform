...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/servicenetworking/openapi.json`.
...
pub struct AddDnsRecordSetRequest {
    ...
    pub dns_record_set: ::core::option::Option<::std::boxed::Box<DnsRecordSet>>,
...
pub struct AddDnsZoneResponse {
    ...
    pub consumer_peering_zone: ::core::option::Option<::std::boxed::Box<DnsZone>>,
    /// The private DNS zone created in the shared producer host project.
    #[serde(default, rename = "producerPrivateZone")]
    pub producer_private_zone: ::core::option::Option<::std::boxed::Box<DnsZone>>,
}
...
pub struct AddRolesRequest {
    ...
    pub policy_binding: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PolicyBinding>>>,
}
...
pub struct AddSubnetworkRequest {
    ...
    pub secondary_ip_range_specs:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SecondaryIpRangeSpec>>>,
...
pub struct ConsumerConfig {
    ...
    pub cloudsql_configs:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<CloudSQLConfig>>>,
...
pub struct ListDnsRecordSetsResponse {
    ...
    pub dns_record_sets: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DnsRecordSet>>>,
}
...
pub struct ListDnsZonesResponse {
    ...
    pub dns_zone_pairs: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DnsZonePair>>>,
}
...
pub struct ListPeeredDnsDomainsResponse {
    ...
    pub peered_dns_domains:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PeeredDnsDomain>>>,
}
...
pub struct RangeReservation {
    ...
    pub subnetwork_candidates:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Subnetwork>>>,
}
...
pub struct Subnetwork {
    ...
    pub secondary_ip_ranges:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SecondaryIpRange>>>,
}
...
pub struct UpdateConsumerConfigRequest {
    ...
    pub consumer_config: ::core::option::Option<::std::boxed::Box<ConsumerConfig>>,
}
...
pub struct UpdateDnsRecordSetRequest {
    ...
    pub existing_dns_record_set: ::core::option::Option<::std::boxed::Box<DnsRecordSet>>,
    /// Required. The new values that the DNS record set should be updated to hold.
    #[serde(default, rename = "newDnsRecordSet")]
    pub new_dns_record_set: ::core::option::Option<::std::boxed::Box<DnsRecordSet>>,
    /// Required. The name of the private DNS zone in the shared producer host project from which the record set will be removed.
    #[serde(default)]
    pub zone: ::core::option::Option<String>,
}
...
pub struct ValidateConsumerConfigRequest {
    ...
    pub consumer_project: ::core::option::Option<::std::boxed::Box<ConsumerProject>>,
    ...
    pub range_reservation: ::core::option::Option<::std::boxed::Box<RangeReservation>>,
