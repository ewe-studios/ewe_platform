...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/cloudresourcemanager/openapi.json`.
...
pub struct ListEffectiveTagsResponse {
    ...
    #[serde(default, rename = "effectiveTags")]
    pub effective_tags: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<EffectiveTag>>>,
...
pub struct ListLiensResponse {
    /// A list of Liens.
    #[serde(default)]
    pub liens: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Lien>>>,
...
pub struct ListProjectsResponse {
    ...
    #[serde(default)]
    pub projects: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Project>>>,
}
...
pub struct ListTagBindingsResponse {
    ...
    pub tag_bindings: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TagBinding>>>,
}
...
pub struct ListTagHoldsResponse {
    ...
    pub tag_holds: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TagHold>>>,
}
...
pub struct ListTagKeysResponse {
    ...
    pub tag_keys: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TagKey>>>,
}
...
pub struct ListTagValuesResponse {
    ...
    pub tag_values: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TagValue>>>,
}
