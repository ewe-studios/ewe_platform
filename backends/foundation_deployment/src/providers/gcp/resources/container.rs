...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/container/openapi.json`.
...
pub struct AcceleratorConfig {
    ...
    pub gpu_driver_installation_config:
        ::core::option::Option<::std::boxed::Box<GPUDriverInstallationConfig>>,
    ...
    pub gpu_sharing_config: ::core::option::Option<::std::boxed::Box<GPUSharingConfig>>,
}
...
pub struct AdditionalPodNetworkConfig {
    ...
    pub max_pods_per_node: ::core::option::Option<::std::boxed::Box<MaxPodsConstraint>>,
...
pub struct AdditionalPodRangesConfig {
    ...
    pub pod_range_info: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<RangeInfo>>>,
...
pub struct AddonsConfig {
    ...
    pub cloud_run_config: ::core::option::Option<::std::boxed::Box<CloudRunConfig>>,
    ...
    pub config_connector_config: ::core::option::Option<::std::boxed::Box<ConfigConnectorConfig>>,
    /// Configuration for NodeLocalDNS, a dns cache running on cluster nodes
    #[serde(default, rename = "dnsCacheConfig")]
    pub dns_cache_config: ::core::option::Option<::std::boxed::Box<DnsCacheConfig>>,
    /// Configuration for the Compute Engine Persistent Disk CSI driver.
    #[serde(default, rename = "gcePersistentDiskCsiDriverConfig")]
    pub gce_persistent_disk_csi_driver_config:
        ::core::option::Option<::std::boxed::Box<GcePersistentDiskCsiDriverConfig>>,
    ...
    pub gcp_filestore_csi_driver_config:
        ::core::option::Option<::std::boxed::Box<GcpFilestoreCsiDriverConfig>>,
    /// Configuration for the Cloud Storage Fuse CSI driver.
    #[serde(default, rename = "gcsFuseCsiDriverConfig")]
    pub gcs_fuse_csi_driver_config:
        ::core::option::Option<::std::boxed::Box<GcsFuseCsiDriverConfig>>,
    /// Configuration for the Backup for GKE agent addon.
    #[serde(default, rename = "gkeBackupAgentConfig")]
    pub gke_backup_agent_config: ::core::option::Option<::std::boxed::Box<GkeBackupAgentConfig>>,
    ...
    pub high_scale_checkpointing_config:
        ::core::option::Option<::std::boxed::Box<HighScaleCheckpointingConfig>>,
    /// Configuration for the horizontal pod autoscaling feature, which increases or decreases the number of replica pods a replication controller has based on the resource usage of the existing pods.
    #[serde(default, rename = "horizontalPodAutoscaling")]
    pub horizontal_pod_autoscaling:
        ::core::option::Option<::std::boxed::Box<HorizontalPodAutoscaling>>,
    /// Configuration for the HTTP (L7) load balancing controller addon, which makes it easy to set up HTTP load balancers for services in a cluster.
    #[serde(default, rename = "httpLoadBalancing")]
    pub http_load_balancing: ::core::option::Option<::std::boxed::Box<HttpLoadBalancing>>,
    /// Configuration for the Kubernetes Dashboard. This addon is deprecated, and will be disabled in 1.15. It is recommended to use the Cloud Console to manage and monitor your Kubernetes clusters, workloads and applications. For more information, see: https://cloud.google.com/kubernetes-engine/docs/concepts/dashboards
    #[serde(default, rename = "kubernetesDashboard")]
    pub kubernetes_dashboard: ::core::option::Option<::std::boxed::Box<KubernetesDashboard>>,
    /// Configuration for the Lustre CSI driver.
    #[serde(default, rename = "lustreCsiDriverConfig")]
    pub lustre_csi_driver_config: ::core::option::Option<::std::boxed::Box<LustreCsiDriverConfig>>,
    /// Configuration for NetworkPolicy. This only tracks whether the addon is enabled or not on the Master, it does not track whether network policy is enabled for the nodes.
    #[serde(default, rename = "networkPolicyConfig")]
    pub network_policy_config: ::core::option::Option<::std::boxed::Box<NetworkPolicyConfig>>,
    /// Configuration for the Cloud Storage Parallelstore CSI driver.
    #[serde(default, rename = "parallelstoreCsiDriverConfig")]
    pub parallelstore_csi_driver_config:
        ::core::option::Option<::std::boxed::Box<ParallelstoreCsiDriverConfig>>,
    /// Optional. Configuration for Ray Operator addon.
    #[serde(default, rename = "rayOperatorConfig")]
    pub ray_operator_config: ::core::option::Option<::std::boxed::Box<RayOperatorConfig>>,
    /// Optional. Configuration for the slice controller add-on.
    #[serde(default, rename = "sliceControllerConfig")]
    pub slice_controller_config: ::core::option::Option<::std::boxed::Box<SliceControllerConfig>>,
    /// Optional. Configuration for the StatefulHA add-on.
    #[serde(default, rename = "statefulHaConfig")]
    pub stateful_ha_config: ::core::option::Option<::std::boxed::Box<StatefulHAConfig>>,
}
...
pub struct Autopilot {
    ...
    pub cluster_policy_config: ::core::option::Option<::std::boxed::Box<ClusterPolicyConfig>>,
    /// Enable Autopilot
    #[serde(default)]
    pub enabled: ::core::option::Option<bool>,
    ...
    pub privileged_admission_config:
        ::core::option::Option<::std::boxed::Box<PrivilegedAdmissionConfig>>,
    /// WorkloadPolicyConfig is the configuration related to GCW workload policy
    #[serde(default, rename = "workloadPolicyConfig")]
    pub workload_policy_config: ::core::option::Option<::std::boxed::Box<WorkloadPolicyConfig>>,
}
...
pub struct AutoprovisioningNodePoolDefaults {
    ...
    #[serde(default)]
    pub management: ::core::option::Option<::std::boxed::Box<NodeManagement>>,
    ...
    pub upgrade_settings: ::core::option::Option<::std::boxed::Box<UpgradeSettings>>,
}
...
pub struct BlueGreenSettings {
    ...
    pub autoscaled_rollout_policy:
        ::core::option::Option<::std::boxed::Box<AutoscaledRolloutPolicy>>,
    ...
    pub standard_rollout_policy: ::core::option::Option<::std::boxed::Box<StandardRolloutPolicy>>,
}
...
pub struct CertificateAuthorityDomainConfig {
    ...
    pub gcp_secret_manager_certificate_config:
        ::core::option::Option<::std::boxed::Box<GCPSecretManagerCertificateConfig>>,
}
...
pub struct CertificateConfigPair {
    ...
    #[serde(default)]
    pub cert: ::core::option::Option<::std::boxed::Box<CertificateConfig>>,
    /// Key configures the client private key. Optional.
    #[serde(default)]
    pub key: ::core::option::Option<::std::boxed::Box<CertificateConfig>>,
}
...
pub struct CheckAutopilotCompatibilityResponse {
    ...
    #[serde(default)]
    pub issues:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AutopilotCompatibilityIssue>>>,
...
pub struct Cluster {
    ...
    pub addons_config: ::core::option::Option<::std::boxed::Box<AddonsConfig>>,
    ...
    pub anonymous_authentication_config:
        ::core::option::Option<::std::boxed::Box<AnonymousAuthenticationConfig>>,
    /// Configuration controlling RBAC group membership information.
    #[serde(default, rename = "authenticatorGroupsConfig")]
    pub authenticator_groups_config:
        ::core::option::Option<::std::boxed::Box<AuthenticatorGroupsConfig>>,
    /// Autopilot configuration for the cluster.
    #[serde(default)]
    pub autopilot: ::core::option::Option<::std::boxed::Box<Autopilot>>,
    /// Cluster-level autoscaling configuration.
    #[serde(default)]
    pub autoscaling: ::core::option::Option<::std::boxed::Box<ClusterAutoscaling>>,
    /// Configuration for Binary Authorization.
    #[serde(default, rename = "binaryAuthorization")]
    pub binary_authorization: ::core::option::Option<::std::boxed::Box<BinaryAuthorization>>,
    ...
    pub compliance_posture_config:
        ::core::option::Option<::std::boxed::Box<CompliancePostureConfig>>,
    /// Which conditions caused the current cluster state.
    #[serde(default)]
    pub conditions: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<StatusCondition>>>,
    /// Configuration of Confidential Nodes. All the nodes in the cluster will be Confidential VM once enabled.
    #[serde(default, rename = "confidentialNodes")]
    pub confidential_nodes: ::core::option::Option<::std::boxed::Box<ConfidentialNodes>>,
    /// Configuration for control plane egress control.
    #[serde(default, rename = "controlPlaneEgress")]
    pub control_plane_egress: ::core::option::Option<::std::boxed::Box<ControlPlaneEgress>>,
    /// Configuration for all cluster''s control plane endpoints.
    #[serde(default, rename = "controlPlaneEndpointsConfig")]
    pub control_plane_endpoints_config:
        ::core::option::Option<::std::boxed::Box<ControlPlaneEndpointsConfig>>,
    /// Configuration for the fine-grained cost management feature.
    #[serde(default, rename = "costManagementConfig")]
    pub cost_management_config: ::core::option::Option<::std::boxed::Box<CostManagementConfig>>,
    ...
    pub database_encryption: ::core::option::Option<::std::boxed::Box<DatabaseEncryption>>,
    /// The default constraint on the maximum number of pods that can be run simultaneously on a node in the node pool of this cluster. Only honored if cluster created with IP Alias support.
    #[serde(default, rename = "defaultMaxPodsConstraint")]
    pub default_max_pods_constraint: ::core::option::Option<::std::boxed::Box<MaxPodsConstraint>>,
    /// An optional description of this cluster.
    #[serde(default)]
    pub description: ::core::option::Option<String>,
    /// Beta APIs Config
    #[serde(default, rename = "enableK8sBetaApis")]
    pub enable_k8s_beta_apis: ::core::option::Option<::std::boxed::Box<K8sBetaAPIConfig>>,
    ...
    pub enterprise_config: ::core::option::Option<::std::boxed::Box<EnterpriseConfig>>,
    ...
    #[serde(default)]
    pub fleet: ::core::option::Option<::std::boxed::Box<Fleet>>,
    /// Configuration for GKE auto upgrades.
    #[serde(default, rename = "gkeAutoUpgradeConfig")]
    pub gke_auto_upgrade_config: ::core::option::Option<::std::boxed::Box<GkeAutoUpgradeConfig>>,
    /// Output only. Unique id for the cluster.
    #[serde(default)]
    pub id: ::core::option::Option<String>,
    /// Configuration for Identity Service component.
    #[serde(default, rename = "identityServiceConfig")]
    pub identity_service_config: ::core::option::Option<::std::boxed::Box<IdentityServiceConfig>>,
    ...
    pub ip_allocation_policy: ::core::option::Option<::std::boxed::Box<IPAllocationPolicy>>,
    ...
    pub legacy_abac: ::core::option::Option<::std::boxed::Box<LegacyAbac>>,
    ...
    pub managed_machine_learning_diagnostics_config:
        ::core::option::Option<::std::boxed::Box<ManagedMachineLearningDiagnosticsConfig>>,
    /// Configuration for Managed OpenTelemetry pipeline.
    #[serde(default, rename = "managedOpentelemetryConfig")]
    pub managed_opentelemetry_config:
        ::core::option::Option<::std::boxed::Box<ManagedOpenTelemetryConfig>>,
    /// The authentication information for accessing the master endpoint. If unspecified, the defaults are used: For clusters before v1.12, if master_auth is unspecified, username will be set to "admin", a random password will be generated, and a client certificate will be issued.
    #[serde(default, rename = "masterAuth")]
    pub master_auth: ::core::option::Option<::std::boxed::Box<MasterAuth>>,
    ...
    pub master_authorized_networks_config:
        ::core::option::Option<::std::boxed::Box<MasterAuthorizedNetworksConfig>>,
    /// Configuration for issuance of mTLS keys and certificates to Kubernetes pods.
    #[serde(default, rename = "meshCertificates")]
    pub mesh_certificates: ::core::option::Option<::std::boxed::Box<MeshCertificates>>,
    /// Monitoring configuration for the cluster.
    #[serde(default, rename = "monitoringConfig")]
    pub monitoring_config: ::core::option::Option<::std::boxed::Box<MonitoringConfig>>,
    ...
    pub network_policy: ::core::option::Option<::std::boxed::Box<NetworkPolicy>>,
    ...
    pub node_config: ::core::option::Option<::std::boxed::Box<NodeConfig>>,
    ...
    pub node_pool_auto_config: ::core::option::Option<::std::boxed::Box<NodePoolAutoConfig>>,
    /// Default NodePool settings for the entire cluster. These settings are overridden if specified on the specific NodePool object.
    #[serde(default, rename = "nodePoolDefaults")]
    pub node_pool_defaults: ::core::option::Option<::std::boxed::Box<NodePoolDefaults>>,
    ...
    pub parent_product_config: ::core::option::Option<::std::boxed::Box<ParentProductConfig>>,
    /// The config for pod autoscaling.
    #[serde(default, rename = "podAutoscaling")]
    pub pod_autoscaling: ::core::option::Option<::std::boxed::Box<PodAutoscaling>>,
    /// Configuration for private cluster.
    #[serde(default, rename = "privateClusterConfig")]
    pub private_cluster_config: ::core::option::Option<::std::boxed::Box<PrivateClusterConfig>>,
    /// RBACBindingConfig allows user to restrict ClusterRoleBindings an RoleBindings that can be created.
    #[serde(default, rename = "rbacBindingConfig")]
    pub rbac_binding_config: ::core::option::Option<::std::boxed::Box<RBACBindingConfig>>,
    /// Release channel configuration. If left unspecified on cluster creation and a version is specified, the cluster is enrolled in the most mature release channel where the version is available (first checking STABLE, then REGULAR, and finally RAPID). Otherwise, if no release channel configuration and no version is specified, the cluster is enrolled in the REGULAR channel with its default version.
    #[serde(default, rename = "releaseChannel")]
    pub release_channel: ::core::option::Option<::std::boxed::Box<ReleaseChannel>>,
    ...
    pub resource_usage_export_config:
        ::core::option::Option<::std::boxed::Box<ResourceUsageExportConfig>>,
    ...
    pub schedule_upgrade_config: ::core::option::Option<::std::boxed::Box<ScheduleUpgradeConfig>>,
    /// Secret CSI driver configuration.
    #[serde(default, rename = "secretManagerConfig")]
    pub secret_manager_config: ::core::option::Option<::std::boxed::Box<SecretManagerConfig>>,
    /// Configuration for sync Secret Manager secrets as k8s secrets.
    #[serde(default, rename = "secretSyncConfig")]
    pub secret_sync_config: ::core::option::Option<::std::boxed::Box<SecretSyncConfig>>,
    /// Optional. Enable/Disable Security Posture API features for the cluster.
    #[serde(default, rename = "securityPostureConfig")]
    pub security_posture_config: ::core::option::Option<::std::boxed::Box<SecurityPostureConfig>>,
    ...
    pub shielded_nodes: ::core::option::Option<::std::boxed::Box<ShieldedNodes>>,
    ...
    pub user_managed_keys_config: ::core::option::Option<::std::boxed::Box<UserManagedKeysConfig>>,
    /// Cluster-level Vertical Pod Autoscaling configuration.
    #[serde(default, rename = "verticalPodAutoscaling")]
    pub vertical_pod_autoscaling: ::core::option::Option<::std::boxed::Box<VerticalPodAutoscaling>>,
...
pub struct ClusterAutoscaling {
    ...
    pub autoprovisioning_node_pool_defaults:
        ::core::option::Option<::std::boxed::Box<AutoprovisioningNodePoolDefaults>>,
    ...
    pub default_compute_class_config:
        ::core::option::Option<::std::boxed::Box<DefaultComputeClassConfig>>,
    ...
    pub resource_limits: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ResourceLimit>>>,
}
...
pub struct ClusterUpdate {
    ...
    pub additional_pod_ranges_config:
        ::core::option::Option<::std::boxed::Box<AdditionalPodRangesConfig>>,
    ...
    pub desired_additional_ip_ranges_config:
        ::core::option::Option<::std::boxed::Box<DesiredAdditionalIPRangesConfig>>,
    /// Configurations for the various addons available to run in the cluster.
    #[serde(default, rename = "desiredAddonsConfig")]
    pub desired_addons_config: ::core::option::Option<::std::boxed::Box<AddonsConfig>>,
    /// Configuration for limiting anonymous access to all endpoints except the health checks.
    ...
    pub desired_auto_ipam_config: ::core::option::Option<::std::boxed::Box<AutoIpamConfig>>,
    ...
    pub desired_autopilot_cluster_policy_config:
        ::core::option::Option<::std::boxed::Box<ClusterPolicyConfig>>,
    /// WorkloadPolicyConfig is the configuration related to GCW workload policy
    #[serde(default, rename = "desiredAutopilotWorkloadPolicyConfig")]
    pub desired_autopilot_workload_policy_config:
        ::core::option::Option<::std::boxed::Box<WorkloadPolicyConfig>>,
    /// The desired configuration options for the Binary Authorization feature.
    #[serde(default, rename = "desiredBinaryAuthorization")]
    pub desired_binary_authorization:
        ::core::option::Option<::std::boxed::Box<BinaryAuthorization>>,
    /// Cluster-level autoscaling configuration.
    #[serde(default, rename = "desiredClusterAutoscaling")]
    pub desired_cluster_autoscaling: ::core::option::Option<::std::boxed::Box<ClusterAutoscaling>>,
    ...
    pub desired_containerd_config: ::core::option::Option<::std::boxed::Box<ContainerdConfig>>,
    /// The desired control plane egress control config for the cluster.
    #[serde(default, rename = "desiredControlPlaneEgress")]
    pub desired_control_plane_egress: ::core::option::Option<::std::boxed::Box<ControlPlaneEgress>>,
    ...
    pub desired_cost_management_config:
        ::core::option::Option<::std::boxed::Box<CostManagementConfig>>,
    /// Configuration of etcd encryption.
    #[serde(default, rename = "desiredDatabaseEncryption")]
    pub desired_database_encryption: ::core::option::Option<::std::boxed::Box<DatabaseEncryption>>,
    ...
    pub desired_default_snat_status: ::core::option::Option<::std::boxed::Box<DefaultSnatStatus>>,
    ...
    pub desired_dns_config: ::core::option::Option<::std::boxed::Box<DNSConfig>>,
    ...
    pub desired_enterprise_config:
        ::core::option::Option<::std::boxed::Box<DesiredEnterpriseConfig>>,
    /// The desired fleet configuration for the cluster.
    #[serde(default, rename = "desiredFleet")]
    pub desired_fleet: ::core::option::Option<::std::boxed::Box<Fleet>>,
    /// The desired config of Gateway API on this cluster.
    #[serde(default, rename = "desiredGatewayApiConfig")]
    pub desired_gateway_api_config: ::core::option::Option<::std::boxed::Box<GatewayAPIConfig>>,
    /// The desired GCFS config for the cluster
    #[serde(default, rename = "desiredGcfsConfig")]
    pub desired_gcfs_config: ::core::option::Option<::std::boxed::Box<GcfsConfig>>,
    /// The desired Identity Service component configuration.
    #[serde(default, rename = "desiredIdentityServiceConfig")]
    pub desired_identity_service_config:
        ::core::option::Option<::std::boxed::Box<IdentityServiceConfig>>,
    ...
    pub desired_intra_node_visibility_config:
        ::core::option::Option<::std::boxed::Box<IntraNodeVisibilityConfig>>,
    /// Desired Beta APIs to be enabled for cluster.
    #[serde(default, rename = "desiredK8sBetaApis")]
    pub desired_k8s_beta_apis: ::core::option::Option<::std::boxed::Box<K8sBetaAPIConfig>>,
    /// The desired L4 Internal Load Balancer Subsetting configuration.
    #[serde(default, rename = "desiredL4ilbSubsettingConfig")]
    pub desired_l4ilb_subsetting_config:
        ::core::option::Option<::std::boxed::Box<ILBSubsettingConfig>>,
    ...
    pub desired_logging_config: ::core::option::Option<::std::boxed::Box<LoggingConfig>>,
    /// The logging service the cluster should use to write logs. Currently available options: * logging.googleapis.com/kubernetes - The Cloud Logging service with a Kubernetes-native resource model * logging.googleapis.com - The legacy Cloud Logging service (no longer available as of GKE 1.15). * none - no logs will be exported from the cluster. If left as an empty string,logging.googleapis.com/kubernetes will be used for GKE 1.14+ or logging.googleapis.com for earlier versions.
    ...
    pub desired_mesh_certificates: ::core::option::Option<::std::boxed::Box<MeshCertificates>>,
    /// The desired monitoring configuration.
    #[serde(default, rename = "desiredMonitoringConfig")]
    pub desired_monitoring_config: ::core::option::Option<::std::boxed::Box<MonitoringConfig>>,
    /// The monitoring service the cluster should use to write metrics. Currently available options: * monitoring.googleapis.com/kubernetes - The Cloud Monitoring service with a Kubernetes-native resource model * monitoring.googleapis.com - The legacy Cloud Monitoring service (no longer available as of GKE 1.15). * none - No metrics will be exported from the cluster. If left as an empty string,monitoring.googleapis.com/kubernetes will be used for GKE 1.14+ or monitoring.googleapis.com for earlier versions.
    ...
    pub desired_network_performance_config:
        ::core::option::Option<::std::boxed::Box<ClusterNetworkPerformanceConfig>>,
    /// The desired network tier configuration for the cluster.
    #[serde(default, rename = "desiredNetworkTierConfig")]
    pub desired_network_tier_config: ::core::option::Option<::std::boxed::Box<NetworkTierConfig>>,
    /// The desired node kubelet config for the cluster.
    #[serde(default, rename = "desiredNodeKubeletConfig")]
    pub desired_node_kubelet_config: ::core::option::Option<::std::boxed::Box<NodeKubeletConfig>>,
    ...
    pub desired_node_pool_auto_config_kubelet_config:
        ::core::option::Option<::std::boxed::Box<NodeKubeletConfig>>,
    ...
    pub desired_node_pool_auto_config_linux_node_config:
        ::core::option::Option<::std::boxed::Box<LinuxNodeConfig>>,
    ...
    pub desired_node_pool_auto_config_network_tags:
        ::core::option::Option<::std::boxed::Box<NetworkTags>>,
    ...
    pub desired_node_pool_auto_config_resource_manager_tags:
        ::core::option::Option<::std::boxed::Box<ResourceManagerTags>>,
    ...
    pub desired_node_pool_autoscaling:
        ::core::option::Option<::std::boxed::Box<NodePoolAutoscaling>>,
    ...
    pub desired_node_pool_logging_config:
        ::core::option::Option<::std::boxed::Box<NodePoolLoggingConfig>>,
    ...
    pub desired_notification_config: ::core::option::Option<::std::boxed::Box<NotificationConfig>>,
    /// The desired parent product config for the cluster.
    #[serde(default, rename = "desiredParentProductConfig")]
    pub desired_parent_product_config:
        ::core::option::Option<::std::boxed::Box<ParentProductConfig>>,
    /// The desired config for pod autoscaling.
    #[serde(default, rename = "desiredPodAutoscaling")]
    pub desired_pod_autoscaling: ::core::option::Option<::std::boxed::Box<PodAutoscaling>>,
    ...
    pub desired_private_cluster_config:
        ::core::option::Option<::std::boxed::Box<PrivateClusterConfig>>,
    ...
    pub desired_rbac_binding_config: ::core::option::Option<::std::boxed::Box<RBACBindingConfig>>,
    /// The desired release channel configuration.
    #[serde(default, rename = "desiredReleaseChannel")]
    pub desired_release_channel: ::core::option::Option<::std::boxed::Box<ReleaseChannel>>,
    ...
    pub desired_secret_manager_config:
        ::core::option::Option<::std::boxed::Box<SecretManagerConfig>>,
    /// Configuration for sync Secret Manager secrets as k8s secrets.
    #[serde(default, rename = "desiredSecretSyncConfig")]
    pub desired_secret_sync_config: ::core::option::Option<::std::boxed::Box<SecretSyncConfig>>,
    /// Enable/Disable Security Posture API features for the cluster.
    #[serde(default, rename = "desiredSecurityPostureConfig")]
    pub desired_security_posture_config:
        ::core::option::Option<::std::boxed::Box<SecurityPostureConfig>>,
    /// ServiceExternalIPsConfig specifies the config for the use of Services with ExternalIPs field.
    #[serde(default, rename = "desiredServiceExternalIpsConfig")]
    pub desired_service_external_ips_config:
        ::core::option::Option<::std::boxed::Box<ServiceExternalIPsConfig>>,
    /// Configuration for Shielded Nodes.
    #[serde(default, rename = "desiredShieldedNodes")]
    pub desired_shielded_nodes: ::core::option::Option<::std::boxed::Box<ShieldedNodes>>,
    ...
    pub desired_user_managed_keys_config:
        ::core::option::Option<::std::boxed::Box<UserManagedKeysConfig>>,
    /// Cluster-level Vertical Pod Autoscaling configuration.
    #[serde(default, rename = "desiredVerticalPodAutoscaling")]
    pub desired_vertical_pod_autoscaling:
        ::core::option::Option<::std::boxed::Box<VerticalPodAutoscaling>>,
    /// Configuration for Workload Identity.
    #[serde(default, rename = "desiredWorkloadIdentityConfig")]
    pub desired_workload_identity_config:
        ::core::option::Option<::std::boxed::Box<WorkloadIdentityConfig>>,
...
pub struct ClusterUpgradeInfo {
    ...
    pub upgrade_details: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<UpgradeDetails>>>,
}
...
pub struct ContainerdConfig {
    ...
    pub private_registry_access_config:
        ::core::option::Option<::std::boxed::Box<PrivateRegistryAccessConfig>>,
    ...
    pub registry_hosts:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<RegistryHostConfig>>>,
    /// Optional. WritableCgroups defines writable cgroups configuration for the node pool.
    #[serde(default, rename = "writableCgroups")]
    pub writable_cgroups: ::core::option::Option<::std::boxed::Box<WritableCgroups>>,
}
...
pub struct ControlPlaneEndpointsConfig {
    ...
    pub dns_endpoint_config: ::core::option::Option<::std::boxed::Box<DNSEndpointConfig>>,
    /// IP endpoints configuration.
    #[serde(default, rename = "ipEndpointsConfig")]
    pub ip_endpoints_config: ::core::option::Option<::std::boxed::Box<IPEndpointsConfig>>,
}
...
pub struct CreateClusterRequest {
    ...
    #[serde(default)]
    pub cluster: ::core::option::Option<::std::boxed::Box<Cluster>>,
...
pub struct CreateNodePoolRequest {
    ...
    pub node_pool: ::core::option::Option<::std::boxed::Box<NodePool>>,
...
pub struct DatabaseEncryption {
    ...
    pub last_operation_errors:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<OperationError>>>,
...
pub struct DesiredAdditionalIPRangesConfig {
    ...
    pub additional_ip_ranges_configs:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AdditionalIPRangesConfig>>>,
}
...
pub struct DisruptionEvent {
    ...
    pub pdb_blocked_pod: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PdbBlockedPod>>>,
...
pub struct GetJSONWebKeysResponse {
    ...
    pub cache_header: ::core::option::Option<::std::boxed::Box<HttpCacheControlResponseHeader>>,
    /// The public component of the keys used by the cluster to sign token requests.
    #[serde(default)]
    pub keys: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Jwk>>>,
}
...
pub struct HostConfig {
    ...
    #[serde(default)]
    pub ca: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<CertificateConfig>>>,
    ...
    #[serde(default)]
    pub client: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<CertificateConfigPair>>>,
    ...
    #[serde(default)]
    pub header: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<RegistryHeader>>>,
...
pub struct IPAllocationPolicy {
    ...
    pub auto_ipam_config: ::core::option::Option<::std::boxed::Box<AutoIpamConfig>>,
    ...
    pub network_tier_config: ::core::option::Option<::std::boxed::Box<NetworkTierConfig>>,
    ...
    pub pod_cidr_overprovision_config:
        ::core::option::Option<::std::boxed::Box<PodCIDROverprovisionConfig>>,
...
pub struct LinuxNodeConfig {
    ...
    pub accurate_time_config: ::core::option::Option<::std::boxed::Box<AccurateTimeConfig>>,
    ...
    #[serde(default)]
    pub hugepages: ::core::option::Option<::std::boxed::Box<HugepagesConfig>>,
    ...
    pub node_kernel_module_loading:
        ::core::option::Option<::std::boxed::Box<NodeKernelModuleLoading>>,
    /// Optional. Enables and configures swap space on nodes. If omitted, swap is disabled.
    #[serde(default, rename = "swapConfig")]
    pub swap_config: ::core::option::Option<::std::boxed::Box<SwapConfig>>,
...
pub struct ListUsableSubnetworksResponse {
    ...
    #[serde(default)]
    pub subnetworks: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<UsableSubnetwork>>>,
}
...
pub struct LoggingConfig {
    ...
    pub component_config: ::core::option::Option<::std::boxed::Box<LoggingComponentConfig>>,
}
...
pub struct MaintenancePolicy {
    ...
    pub disruption_budget: ::core::option::Option<::std::boxed::Box<DisruptionBudget>>,
...
pub struct MaintenanceWindow {
    ...
    pub daily_maintenance_window: ::core::option::Option<::std::boxed::Box<DailyMaintenanceWindow>>,
    ...
    pub recurring_window: ::core::option::Option<::std::boxed::Box<RecurringTimeWindow>>,
}
...
pub struct ManagedPrometheusConfig {
    ...
    pub auto_monitoring_config: ::core::option::Option<::std::boxed::Box<AutoMonitoringConfig>>,
...
pub struct MasterAuth {
    ...
    pub client_certificate_config:
        ::core::option::Option<::std::boxed::Box<ClientCertificateConfig>>,
...
pub struct MasterAuthorizedNetworksConfig {
    ...
    pub cidr_blocks: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<CidrBlock>>>,
...
pub struct MonitoringConfig {
    ...
    pub advanced_datapath_observability_config:
        ::core::option::Option<::std::boxed::Box<AdvancedDatapathObservabilityConfig>>,
    /// Monitoring components configuration
    #[serde(default, rename = "componentConfig")]
    pub component_config: ::core::option::Option<::std::boxed::Box<MonitoringComponentConfig>>,
    /// Enable Google Cloud Managed Service for Prometheus in the cluster.
    #[serde(default, rename = "managedPrometheusConfig")]
    pub managed_prometheus_config:
        ::core::option::Option<::std::boxed::Box<ManagedPrometheusConfig>>,
}
...
pub struct NetworkConfig {
    ...
    pub default_snat_status: ::core::option::Option<::std::boxed::Box<DefaultSnatStatus>>,
    ...
    pub dns_config: ::core::option::Option<::std::boxed::Box<DNSConfig>>,
    ...
    pub gateway_api_config: ::core::option::Option<::std::boxed::Box<GatewayAPIConfig>>,
...
pub struct NodeConfig {
    ...
    pub containerd_config: ::core::option::Option<::std::boxed::Box<ContainerdConfig>>,
    /// Size of the disk attached to each node, specified in GB. The smallest allowed disk size is 10GB. If unspecified, the default disk size is 100GB.
    #[serde(default, rename = "diskSizeGb")]
    pub disk_size_gb: ::core::option::Option<i32>,
    /// Type of the disk attached to each node (e.g. ''pd-standard'', ''pd-ssd'' or ''pd-balanced'') If unspecified, the default disk type is ''pd-standard''
    ...
    pub ephemeral_storage_local_ssd_config:
        ::core::option::Option<::std::boxed::Box<EphemeralStorageLocalSsdConfig>>,
    /// Enable or disable NCCL fast socket for the node pool.
    #[serde(default, rename = "fastSocket")]
    pub fast_socket: ::core::option::Option<::std::boxed::Box<FastSocket>>,
    /// Flex Start flag for enabling Flex Start VM.
    #[serde(default, rename = "flexStart")]
    pub flex_start: ::core::option::Option<bool>,
    /// Google Container File System (image streaming) configs.
    #[serde(default, rename = "gcfsConfig")]
    pub gcfs_config: ::core::option::Option<::std::boxed::Box<GcfsConfig>>,
    /// The configuration for GPU Direct
    #[serde(default, rename = "gpuDirectConfig")]
    pub gpu_direct_config: ::core::option::Option<::std::boxed::Box<GPUDirectConfig>>,
    /// Enable or disable gvnic in the node pool.
    #[serde(default)]
    pub gvnic: ::core::option::Option<::std::boxed::Box<VirtualNIC>>,
    /// The image type to use for this node. Note that for a given image type, the latest version of it will be used. Please see https://cloud.google.com/kubernetes-engine/docs/concepts/node-images for available image types.
    #[serde(default, rename = "imageType")]
    pub image_type: ::core::option::Option<String>,
    /// Node kubelet configs.
    #[serde(default, rename = "kubeletConfig")]
    pub kubelet_config: ::core::option::Option<::std::boxed::Box<NodeKubeletConfig>>,
    ...
    pub linux_node_config: ::core::option::Option<::std::boxed::Box<LinuxNodeConfig>>,
    /// Parameters for using raw-block Local NVMe SSDs.
    #[serde(default, rename = "localNvmeSsdBlockConfig")]
    pub local_nvme_ssd_block_config:
        ::core::option::Option<::std::boxed::Box<LocalNvmeSsdBlockConfig>>,
    ...
    #[serde(default, rename = "loggingConfig")]
    pub logging_config: ::core::option::Option<::std::boxed::Box<NodePoolLoggingConfig>>,
    ...
    pub resource_manager_tags: ::core::option::Option<::std::boxed::Box<ResourceManagerTags>>,
    /// Sandbox configuration for this node.
    #[serde(default, rename = "sandboxConfig")]
    pub sandbox_config: ::core::option::Option<::std::boxed::Box<SandboxConfig>>,
    ...
    pub secondary_boot_disks:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SecondaryBootDisk>>>,
    ...
    pub sole_tenant_config: ::core::option::Option<::std::boxed::Box<SoleTenantConfig>>,
    ...
    pub taint_config: ::core::option::Option<::std::boxed::Box<TaintConfig>>,
    /// List of kubernetes taints to be applied to each node. For more information, including usage and the valid values, see: https://kubernetes.io/docs/concepts/configuration/taint-and-toleration/
    #[serde(default)]
    pub taints: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<NodeTaint>>>,
    /// Parameters that can be configured on Windows nodes.
    #[serde(default, rename = "windowsNodeConfig")]
    pub windows_node_config: ::core::option::Option<::std::boxed::Box<WindowsNodeConfig>>,
    /// The workload metadata configuration for this node.
    #[serde(default, rename = "workloadMetadataConfig")]
    pub workload_metadata_config: ::core::option::Option<::std::boxed::Box<WorkloadMetadataConfig>>,
}
...
pub struct NodeConfigDefaults {
    ...
    pub node_kubelet_config: ::core::option::Option<::std::boxed::Box<NodeKubeletConfig>>,
}
...
pub struct NodeKubeletConfig {
    ...
    pub crash_loop_back_off: ::core::option::Option<::std::boxed::Box<CrashLoopBackOffConfig>>,
    ...
    pub eviction_minimum_reclaim: ::core::option::Option<::std::boxed::Box<EvictionMinimumReclaim>>,
    ...
    pub eviction_soft: ::core::option::Option<::std::boxed::Box<EvictionSignals>>,
    ...
    pub eviction_soft_grace_period: ::core::option::Option<::std::boxed::Box<EvictionGracePeriod>>,
    ...
    pub memory_manager: ::core::option::Option<::std::boxed::Box<MemoryManager>>,
    ...
    pub topology_manager: ::core::option::Option<::std::boxed::Box<TopologyManager>>,
}
...
pub struct NodeManagement {
    ...
    pub upgrade_options: ::core::option::Option<::std::boxed::Box<AutoUpgradeOptions>>,
}
...
pub struct NodeNetworkConfig {
    ...
    pub additional_node_network_configs:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AdditionalNodeNetworkConfig>>>,
    /// We specify the additional pod networks for this node pool using this list. Each pod network corresponds to an additional alias IP range for the node
    #[serde(default, rename = "additionalPodNetworkConfigs")]
    pub additional_pod_network_configs:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AdditionalPodNetworkConfig>>>,
...
pub struct NodePool {
    ...
    pub autopilot_config: ::core::option::Option<::std::boxed::Box<AutopilotConfig>>,
    /// Autoscaler configuration for this NodePool. Autoscaler is enabled only if a valid configuration is present.
    #[serde(default)]
    pub autoscaling: ::core::option::Option<::std::boxed::Box<NodePoolAutoscaling>>,
    /// Enable best effort provisioning for nodes
    #[serde(default, rename = "bestEffortProvisioning")]
    pub best_effort_provisioning: ::core::option::Option<::std::boxed::Box<BestEffortProvisioning>>,
    /// Which conditions caused the current node pool state.
    #[serde(default)]
    pub conditions: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<StatusCondition>>>,
    /// The node configuration of the pool.
    #[serde(default)]
    pub config: ::core::option::Option<::std::boxed::Box<NodeConfig>>,
    ...
    pub max_pods_constraint: ::core::option::Option<::std::boxed::Box<MaxPodsConstraint>>,
    /// The name of the node pool.
    #[serde(default)]
    pub name: ::core::option::Option<String>,
    /// Networking configuration for this NodePool. If specified, it overrides the cluster-level defaults.
    #[serde(default, rename = "networkConfig")]
    pub network_config: ::core::option::Option<::std::boxed::Box<NodeNetworkConfig>>,
    /// Specifies the node drain configuration for this node pool.
    #[serde(default, rename = "nodeDrainConfig")]
    pub node_drain_config: ::core::option::Option<::std::boxed::Box<NodeDrainConfig>>,
    /// Specifies the node placement policy.
    #[serde(default, rename = "placementPolicy")]
    pub placement_policy: ::core::option::Option<::std::boxed::Box<PlacementPolicy>>,
    ...
    pub queued_provisioning: ::core::option::Option<::std::boxed::Box<QueuedProvisioning>>,
    /// Output only. Server-defined URL for the resource.
    #[serde(default, rename = "selfLink")]
    pub self_link: ::core::option::Option<String>,
...
pub struct NodePoolAutoConfig {
    ...
    pub network_tags: ::core::option::Option<::std::boxed::Box<NetworkTags>>,
...
pub struct NodePoolDefaults {
    ...
    pub node_config_defaults: ::core::option::Option<::std::boxed::Box<NodeConfigDefaults>>,
}
...
pub struct NodePoolLoggingConfig {
    ...
    pub variant_config: ::core::option::Option<::std::boxed::Box<LoggingVariantConfig>>,
}
...
pub struct NotificationConfig {
    ...
    #[serde(default)]
    pub pubsub: ::core::option::Option<::std::boxed::Box<PubSub>>,
}
...
pub struct Operation {
    ...
    pub cluster_conditions:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<StatusCondition>>>,
...
pub struct OperationProgress {
    ...
    #[serde(default)]
    pub stages: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<OperationProgress>>>,
...
pub struct PrivateClusterConfig {
    ...
    pub master_global_access_config:
        ::core::option::Option<::std::boxed::Box<PrivateClusterMasterGlobalAccessConfig>>,
...
pub struct PrivateRegistryAccessConfig {
    ...
    pub certificate_authority_domain_config: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<CertificateAuthorityDomainConfig>>,
    >,
...
pub struct RayOperatorConfig {
    ...
    pub ray_cluster_logging_config:
        ::core::option::Option<::std::boxed::Box<RayClusterLoggingConfig>>,
    ...
    pub ray_cluster_monitoring_config:
        ::core::option::Option<::std::boxed::Box<RayClusterMonitoringConfig>>,
}
...
pub struct RecurringTimeWindow {
    ...
    #[serde(default)]
    pub window: ::core::option::Option<::std::boxed::Box<TimeWindow>>,
}
...
pub struct RegistryHostConfig {
    ...
    #[serde(default)]
    pub hosts: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<HostConfig>>>,
...
pub struct ResourceUsageExportConfig {
    ...
    pub bigquery_destination: ::core::option::Option<::std::boxed::Box<BigQueryDestination>>,
    /// Configuration to enable resource consumption metering.
    #[serde(default, rename = "consumptionMeteringConfig")]
    pub consumption_metering_config:
        ::core::option::Option<::std::boxed::Box<ConsumptionMeteringConfig>>,
...
pub struct SecretManagerConfig {
    ...
    pub rotation_config: ::core::option::Option<::std::boxed::Box<RotationConfig>>,
}
...
pub struct SecretSyncConfig {
    ...
    /// Rotation config for secret manager.
    #[serde(default, rename = "rotationConfig")]
    pub rotation_config: ::core::option::Option<::std::boxed::Box<SyncRotationConfig>>,
}
...
pub struct ServerConfig {
    ...
    #[serde(default)]
    pub channels: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ReleaseChannelConfig>>>,
...
pub struct SetMasterAuthRequest {
    ...
    #[serde(default)]
    pub update: ::core::option::Option<::std::boxed::Box<MasterAuth>>,
    /// Deprecated. The name of the Google Compute Engine [zone](https://cloud.google.com/compute/docs/zones#available) in which the cluster resides. This field has been deprecated and replaced by the name field.
    #[serde(default)]
    pub zone: ::core::option::Option<String>,
}
...
pub struct SoleTenantConfig {
    ...
    pub node_affinities: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<NodeAffinity>>>,
}
...
pub struct SwapConfig {
    ...
    pub boot_disk_profile: ::core::option::Option<::std::boxed::Box<BootDiskProfile>>,
    /// Provisions a new, separate local NVMe SSD exclusively for swap.
    #[serde(default, rename = "dedicatedLocalSsdProfile")]
    pub dedicated_local_ssd_profile:
        ::core::option::Option<::std::boxed::Box<DedicatedLocalSsdProfile>>,
    ...
    pub ephemeral_local_ssd_profile:
        ::core::option::Option<::std::boxed::Box<EphemeralLocalSsdProfile>>,
}
...
pub struct TimeWindow {
    ...
    pub maintenance_exclusion_options:
        ::core::option::Option<::std::boxed::Box<MaintenanceExclusionOptions>>,
...
pub struct UpdateClusterRequest {
    ...
    /// Required. A description of the update.
    #[serde(default)]
    pub update: ::core::option::Option<::std::boxed::Box<ClusterUpdate>>,
    /// Deprecated. The name of the Google Compute Engine [zone](https://cloud.google.com/compute/docs/zones#available) in which the cluster resides. This field has been deprecated and replaced by the name field.
    #[serde(default)]
    pub zone: ::core::option::Option<String>,
}
...
pub struct UpdateInfo {
    ...
    pub blue_green_info: ::core::option::Option<::std::boxed::Box<BlueGreenInfo>>,
}
...
pub struct UpdateNodePoolRequest {
    ...
    #[serde(default)]
    pub labels: ::core::option::Option<::std::boxed::Box<NodeLabels>>,
    /// Parameters that can be configured on Linux nodes.
    #[serde(default, rename = "linuxNodeConfig")]
    pub linux_node_config: ::core::option::Option<::std::boxed::Box<LinuxNodeConfig>>,
    ...
    pub node_network_config: ::core::option::Option<::std::boxed::Box<NodeNetworkConfig>>,
    /// Deprecated. The name of the node pool to upgrade. This field has been deprecated and replaced by the name field.
    #[serde(default, rename = "nodePoolId")]
    pub node_pool_id: ::core::option::Option<String>,
    /// Required. The Kubernetes version to change the nodes to (typically an upgrade). Users may specify either explicit versions offered by Kubernetes Engine or version aliases, which have the following behavior: - "latest": picks the highest valid Kubernetes version - "1.X": picks the highest valid patch+gke.N patch in the 1.X version - "1.X.Y": picks the highest valid gke.N patch in the 1.X.Y version - "1.X.Y-gke.N": picks an explicit Kubernetes version - "-": picks the Kubernetes master version
    ...
    /// The resource labels for the node pool to use to annotate any related Google Compute Engine resources.
    #[serde(default, rename = "resourceLabels")]
    pub resource_labels: ::core::option::Option<::std::boxed::Box<ResourceLabels>>,
    ...
    #[serde(default)]
    pub tags: ::core::option::Option<::std::boxed::Box<NetworkTags>>,
    ...
    #[serde(default)]
    pub taints: ::core::option::Option<::std::boxed::Box<NodeTaints>>,
    /// Upgrade settings control disruption and speed of the upgrade.
    #[serde(default, rename = "upgradeSettings")]
    pub upgrade_settings: ::core::option::Option<::std::boxed::Box<UpgradeSettings>>,
    /// Parameters that can be configured on Windows nodes.
...
pub struct UpgradeInfoEvent {
    ...
    pub disruption_event: ::core::option::Option<::std::boxed::Box<DisruptionEvent>>,
...
pub struct UpgradeSettings {
    ...
    pub blue_green_settings: ::core::option::Option<::std::boxed::Box<BlueGreenSettings>>,
