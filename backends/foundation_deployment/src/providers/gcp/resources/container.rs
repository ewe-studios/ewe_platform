...
pub struct BootDiskProfile {
    ...
    pub swap_size_percent: Option<i32>,
}
...
pub struct DisruptionEvent {
    ...
    pub pdb_blocked_node: Option<String>,
    ...
    pub pdb_blocked_pod: Option<Vec<PdbBlockedPod>>,
    ...
    pub pdb_violation_timeout: Option<String>,
}
...
pub struct NodeConfig {
    ...
    pub secondary_boot_disk_update_strategy: Option<serde_json::Value>,
...
pub struct NodeKubeletConfig {
    ...
    pub shutdown_grace_period_critical_pods_seconds: Option<i32>,
    ...
    pub shutdown_grace_period_seconds: Option<i32>,
...
pub struct SecurityBulletinEvent {
    ...
    pub affected_supported_minors: Option<Vec<String>>,
    ...
    pub bulletin_uri: Option<String>,
    ...
    pub resource_type_affected: Option<String>,
    ...
    pub suggested_upgrade_target: Option<String>,
}
...
pub struct UpgradeInfoEvent {
    ...
    pub disruption_event: Option<DisruptionEvent>,
    ...
    pub extended_support_end_time: Option<String>,
    /// The operation associated with this upgrade.
    #[serde(default)]
    pub operation: Option<String>,
    /// Optional relative path to the resource. For example in node pool upgrades, the relative path of the node pool.
    ...
    pub standard_support_end_time: Option<String>,
    /// The time when the operation was started.
    #[serde(default, rename = "startTime")]
    pub start_time: Option<String>,
