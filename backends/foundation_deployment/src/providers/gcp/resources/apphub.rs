...
pub struct Attributes {
    ...
    pub business_owners: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ContactInfo>>>,
    /// Optional. User-defined criticality information.
    #[serde(default)]
    pub criticality: ::core::option::Option<::std::boxed::Box<Criticality>>,
    /// Optional. Developer team that owns development and coding.
    #[serde(default, rename = "developerOwners")]
    pub developer_owners: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ContactInfo>>>,
    /// Optional. User-defined environment information.
    #[serde(default)]
    pub environment: ::core::option::Option<::std::boxed::Box<Environment>>,
    /// Optional. Operator team that ensures runtime and operations.
    #[serde(default, rename = "operatorOwners")]
    pub operator_owners: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ContactInfo>>>,
}
...
pub struct Boundary {
    ...
    pub crm_node: ::core::option::Option<String>,
...
pub struct DiscoveredService {
    ...
    pub service_properties: ::core::option::Option<::std::boxed::Box<ServiceProperties>>,
    ...
    pub service_reference: ::core::option::Option<::std::boxed::Box<ServiceReference>>,
}
...
pub struct DiscoveredWorkload {
    ...
    pub workload_properties: ::core::option::Option<::std::boxed::Box<WorkloadProperties>>,
    ...
    pub workload_reference: ::core::option::Option<::std::boxed::Box<WorkloadReference>>,
}
...
pub struct ListApplicationsResponse {
    ...
    #[serde(default)]
    pub applications: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Application>>>,
...
pub struct ListDiscoveredServicesResponse {
    ...
    pub discovered_services:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DiscoveredService>>>,
    /// A token identifying a page of results the server should return.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// Locations that could not be reached.
...
pub struct ListDiscoveredWorkloadsResponse {
    ...
    pub discovered_workloads:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DiscoveredWorkload>>>,
    /// A token identifying a page of results the server should return.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// Locations that could not be reached.
...
pub struct ListExtendedMetadataSchemasResponse {
    ...
    pub extended_metadata_schemas:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ExtendedMetadataSchema>>>,
    /// A token identifying a page of results the server should return.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct ListServiceProjectAttachmentsResponse {
    ...
    pub service_project_attachments:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ServiceProjectAttachment>>>,
    /// Locations that could not be reached.
    #[serde(default)]
    pub unreachable: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct LookupDiscoveredServiceResponse {
    ...
    pub discovered_service: ::core::option::Option<::std::boxed::Box<DiscoveredService>>,
}
...
pub struct LookupServiceProjectAttachmentResponse {
    ...
    pub service_project_attachment:
        ::core::option::Option<::std::boxed::Box<ServiceProjectAttachment>>,
}
...
pub struct Service {
    ...
    #[serde(default, rename = "discoveredService")]
    pub discovered_service: ::core::option::Option<String>,
...
pub struct ServiceProjectAttachment {
    ...
    pub service_project: ::core::option::Option<String>,
...
pub struct ServiceProperties {
    ...
    pub extended_metadata: ::core::option::Option<serde_json::Value>,
    /// Output only. The type of the service.
    #[serde(default, rename = "functionalType")]
    pub functional_type: ::core::option::Option<::std::boxed::Box<FunctionalType>>,
    ...
    pub registration_type: ::core::option::Option<::std::boxed::Box<RegistrationType>>,
...
pub struct Workload {
    ...
    #[serde(default, rename = "discoveredWorkload")]
    pub discovered_workload: ::core::option::Option<String>,
