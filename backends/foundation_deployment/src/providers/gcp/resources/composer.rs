...
pub struct CheckUpgradeResponse {
    ...
    pub build_log_uri: ::core::option::Option<String>,
    ...
    pub config_conflicts:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ConfigConflict>>>,
    ...
    pub contains_pypi_modules_conflict: ::core::option::Option<String>,
    ...
    pub pypi_conflict_build_log_extract: ::core::option::Option<String>,
...
pub struct ComposerWorkload {
    ...
    #[serde(default)]
    pub status: ::core::option::Option<::std::boxed::Box<ComposerWorkloadStatus>>,
...
pub struct DataRetentionConfig {
    ...
    pub airflow_metadata_retention_config:
        ::core::option::Option<::std::boxed::Box<AirflowMetadataRetentionPolicyConfig>>,
    /// Optional. The configuration settings for task logs retention
    #[serde(default, rename = "taskLogsRetentionConfig")]
    pub task_logs_retention_config:
        ::core::option::Option<::std::boxed::Box<TaskLogsRetentionConfig>>,
}
...
pub struct Environment {
    ...
    #[serde(default)]
    pub config: ::core::option::Option<::std::boxed::Box<EnvironmentConfig>>,
    ...
    pub storage_config: ::core::option::Option<::std::boxed::Box<StorageConfig>>,
...
pub struct EnvironmentConfig {
    ...
    pub data_retention_config: ::core::option::Option<::std::boxed::Box<DataRetentionConfig>>,
    /// Optional. The configuration settings for Cloud SQL instance used internally by Apache Airflow software.
    #[serde(default, rename = "databaseConfig")]
    pub database_config: ::core::option::Option<::std::boxed::Box<DatabaseConfig>>,
    ...
    pub private_environment_config:
        ::core::option::Option<::std::boxed::Box<PrivateEnvironmentConfig>>,
    /// Optional. The Recovery settings configuration of an environment. This field is supported for Cloud Composer environments in versions composer-2.*.*-airflow-*.*.* and newer.
    #[serde(default, rename = "recoveryConfig")]
    pub recovery_config: ::core::option::Option<::std::boxed::Box<RecoveryConfig>>,
...
pub struct ExecuteAirflowCommandRequest {
    ...
    /// Airflow subcommand.
    #[serde(default)]
    pub subcommand: ::core::option::Option<String>,
}
...
pub struct FetchDatabasePropertiesResponse {
    ...
    pub is_failover_replica_available: ::core::option::Option<bool>,
    /// The Compute Engine zone that the instance is currently serving from.
    #[serde(default, rename = "primaryGceZone")]
    pub primary_gce_zone: ::core::option::Option<String>,
...
pub struct ListImageVersionsResponse {
    ...
    pub image_versions: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ImageVersion>>>,
    /// The page token used to query for the next page if one exists.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct ListUserWorkloadsConfigMapsResponse {
    ...
    pub user_workloads_config_maps:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<UserWorkloadsConfigMap>>>,
}
...
pub struct ListUserWorkloadsSecretsResponse {
    ...
    pub user_workloads_secrets:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<UserWorkloadsSecret>>>,
}
...
pub struct ListWorkloadsResponse {
    ...
    #[serde(default)]
    pub workloads: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ComposerWorkload>>>,
}
...
pub struct LoadSnapshotRequest {
    ...
    pub skip_airflow_overrides_setting: ::core::option::Option<bool>,
    ...
    pub skip_environment_variables_setting: ::core::option::Option<bool>,
    ...
    pub skip_gcs_data_copying: ::core::option::Option<bool>,
    ...
    pub skip_pypi_packages_installation: ::core::option::Option<bool>,
...
pub struct PollAirflowCommandRequest {
    ...
    pub next_line_number: ::core::option::Option<i32>,
    /// The name of the pod where the command is executed.
    #[serde(default)]
    pub pod: ::core::option::Option<String>,
    /// The namespace of the pod where the command is executed.
...
pub struct PollAirflowCommandResponse {
    ...
    pub exit_info: ::core::option::Option<::std::boxed::Box<ExitInfo>>,
    /// Output from the command execution. It may not contain the full output and the caller may need to poll for more lines.
    #[serde(default)]
    pub output: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Line>>>,
...
pub struct PrivateEnvironmentConfig {
    ...
    pub cloud_composer_connection_subnetwork: ::core::option::Option<String>,
    /// Optional. The CIDR block from which IP range for Cloud Composer Network in tenant project will be reserved. Needs to be disjoint from private_cluster_config.master_ipv4_cidr_block and cloud_sql_ipv4_cidr_block. This field is supported for Cloud Composer environments in versions composer-2.*.*-airflow-*.*.* and newer.
    #[serde(default, rename = "cloudComposerNetworkIpv4CidrBlock")]
    pub cloud_composer_network_ipv4_cidr_block: ::core::option::Option<String>,
    ...
    pub cloud_composer_network_ipv4_reserved_range: ::core::option::Option<String>,
    /// Optional. The CIDR block from which IP range in tenant project will be reserved for Cloud SQL. Needs to be disjoint from web_server_ipv4_cidr_block.
    #[serde(default, rename = "cloudSqlIpv4CidrBlock")]
    pub cloud_sql_ipv4_cidr_block: ::core::option::Option<String>,
    ...
    pub enable_private_builds_only: ::core::option::Option<bool>,
    ...
    pub enable_private_environment: ::core::option::Option<bool>,
    /// Optional. When enabled, IPs from public (non-RFC1918) ranges can be used for IPAllocationPolicy.cluster_ipv4_cidr_block and IPAllocationPolicy.service_ipv4_cidr_block.
    #[serde(default, rename = "enablePrivatelyUsedPublicIps")]
    pub enable_privately_used_public_ips: ::core::option::Option<bool>,
    /// Optional. Configuration for the network connections configuration in the environment.
    #[serde(default, rename = "networkingConfig")]
    pub networking_config: ::core::option::Option<::std::boxed::Box<NetworkingConfig>>,
    ...
    pub networking_type: ::core::option::Option<String>,
    ...
    pub web_server_ipv4_cidr_block: ::core::option::Option<String>,
    ...
    pub web_server_ipv4_reserved_range: ::core::option::Option<String>,
}
...
pub struct RecoveryConfig {
    ...
    pub scheduled_snapshots_config:
        ::core::option::Option<::std::boxed::Box<ScheduledSnapshotsConfig>>,
}
...
pub struct SoftwareConfig {
    ...
    pub airflow_config_overrides: ::core::option::Option<serde_json::Value>,
    /// Optional. The configuration for Cloud Data Lineage integration.
    #[serde(default, rename = "cloudDataLineageIntegration")]
    pub cloud_data_lineage_integration:
        ::core::option::Option<::std::boxed::Box<CloudDataLineageIntegration>>,
    ...
    pub pypi_packages: ::core::option::Option<serde_json::Value>,
    ...
    pub scheduler_count: ::core::option::Option<i32>,
...
pub struct WebServerNetworkAccessControl {
    ...
    pub allowed_ip_ranges:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AllowedIpRange>>>,
}
...
pub struct WorkloadsConfig {
    ...
    pub dag_processor: ::core::option::Option<::std::boxed::Box<DagProcessorResource>>,
    /// Optional. Resources used by Airflow schedulers.
    #[serde(default)]
    pub scheduler: ::core::option::Option<::std::boxed::Box<SchedulerResource>>,
    /// Optional. Resources used by Airflow triggerers.
    #[serde(default)]
    pub triggerer: ::core::option::Option<::std::boxed::Box<TriggererResource>>,
    /// Optional. Resources used by Airflow web server.
    #[serde(default, rename = "webServer")]
    pub web_server: ::core::option::Option<::std::boxed::Box<WebServerResource>>,
    /// Optional. Resources used by Airflow workers.
    #[serde(default)]
    pub worker: ::core::option::Option<::std::boxed::Box<WorkerResource>>,
}
