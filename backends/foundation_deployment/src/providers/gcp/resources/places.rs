...
pub struct GoogleGeoTypeViewport {
    ...
    #[serde(default)]
    pub high: ::core::option::Option<::std::boxed::Box<GoogleTypeLatLng>>,
    /// Required. The low point of the viewport.
    #[serde(default)]
    pub low: ::core::option::Option<::std::boxed::Box<GoogleTypeLatLng>>,
}
...
pub struct GoogleMapsPlacesV1AddressDescriptor {
    ...
    #[serde(default)]
    pub areas: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleMapsPlacesV1AddressDescriptorArea>>,
    >,
    ...
    pub landmarks: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleMapsPlacesV1AddressDescriptorLandmark>>,
    >,
}
...
pub struct GoogleMapsPlacesV1AddressDescriptorArea {
    ...
    pub display_name: ::core::option::Option<::std::boxed::Box<GoogleTypeLocalizedText>>,
...
pub struct GoogleMapsPlacesV1AutocompletePlacesRequest {
    ...
    pub include_query_predictions: ::core::option::Option<bool>,
    ...
    pub included_region_codes: ::core::option::Option<::std::vec::Vec<String>>,
    ...
    pub input_offset: ::core::option::Option<i32>,
    ...
    pub location_bias: ::core::option::Option<
        ::std::boxed::Box<GoogleMapsPlacesV1AutocompletePlacesRequestLocationBias>,
    >,
    ...
    pub location_restriction: ::core::option::Option<
        ::std::boxed::Box<GoogleMapsPlacesV1AutocompletePlacesRequestLocationRestriction>,
    >,
    ...
    #[serde(default)]
    pub origin: ::core::option::Option<::std::boxed::Box<GoogleTypeLatLng>>,
...
pub struct GoogleMapsPlacesV1AutocompletePlacesRequestLocationBias {
    ...
    #[serde(default)]
    pub circle: ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1Circle>>,
    /// A viewport defined by a northeast and a southwest corner.
    #[serde(default)]
    pub rectangle: ::core::option::Option<::std::boxed::Box<GoogleGeoTypeViewport>>,
}
...
pub struct GoogleMapsPlacesV1AutocompletePlacesResponse {
    ...
    pub suggestions: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleMapsPlacesV1AutocompletePlacesResponseSuggestion>>,
    >,
}
...
pub struct GoogleMapsPlacesV1AutocompletePlacesResponseSuggestion {
    ...
    pub place_prediction: ::core::option::Option<
        ::std::boxed::Box<GoogleMapsPlacesV1AutocompletePlacesResponseSuggestionPlacePrediction>,
    >,
    /// A prediction for a query.
    #[serde(default, rename = "queryPrediction")]
    pub query_prediction: ::core::option::Option<
        ::std::boxed::Box<GoogleMapsPlacesV1AutocompletePlacesResponseSuggestionQueryPrediction>,
    >,
}
...
pub struct GoogleMapsPlacesV1AutocompletePlacesResponseSuggestionFormattableText {
    ...
    pub matches: ::core::option::Option<
        ::std::vec::Vec<
            ::std::boxed::Box<GoogleMapsPlacesV1AutocompletePlacesResponseSuggestionStringRange>,
        >,
    >,
...
pub struct GoogleMapsPlacesV1AutocompletePlacesResponseSuggestionPlacePrediction {
    ...
    pub structured_format: ::core::option::Option<
        ::std::boxed::Box<GoogleMapsPlacesV1AutocompletePlacesResponseSuggestionStructuredFormat>,
    >,
    ...
    pub text: ::core::option::Option<
        ::std::boxed::Box<GoogleMapsPlacesV1AutocompletePlacesResponseSuggestionFormattableText>,
    >,
...
pub struct GoogleMapsPlacesV1Circle {
    ...
    #[serde(default)]
    pub center: ::core::option::Option<::std::boxed::Box<GoogleTypeLatLng>>,
...
pub struct GoogleMapsPlacesV1ContentBlock {
    ...
    #[serde(default)]
    pub content: ::core::option::Option<::std::boxed::Box<GoogleTypeLocalizedText>>,
...
pub struct GoogleMapsPlacesV1ContextualContent {
    ...
    #[serde(default)]
    pub justifications: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleMapsPlacesV1ContextualContentJustification>>,
    >,
    /// Information (including references) about photos of this place, contextual to the place query.
    #[serde(default)]
    pub photos: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleMapsPlacesV1Photo>>>,
    /// List of reviews about this place, contextual to the place query.
    #[serde(default)]
    pub reviews:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleMapsPlacesV1Review>>>,
}
...
pub struct GoogleMapsPlacesV1ContextualContentJustification {
    ...
    pub business_availability_attributes_justification: ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1ContextualContentJustificationBusinessAvailabilityAttributesJustification>>,
    /// Experimental: See https://developers.google.com/maps/documentation/places/web-service/experimental/places-generative for more details.
    #[serde(default, rename = "reviewJustification")]
    pub review_justification: ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1ContextualContentJustificationReviewJustification>>,
}
...
pub struct GoogleMapsPlacesV1ContextualContentJustificationReviewJustification {
    ...
    #[serde(default)]
    pub review: ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1Review>>,
}
...
pub struct GoogleMapsPlacesV1ContextualContentJustificationReviewJustificationHighlightedText {
    ...
    pub highlighted_text_ranges: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleMapsPlacesV1ContextualContentJustificationReviewJustificationHighlightedTextHighlightedTextRange>>>,
    #[serde(default)]
    pub text: ::core::option::Option<String>,
}
...
pub struct GoogleMapsPlacesV1eVChargeOptions {
    ...
    pub connector_aggregation: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleMapsPlacesV1eVChargeOptionsConnectorAggregation>>,
    >,
...
pub struct GoogleMapsPlacesV1FuelOptions {
    ...
    pub fuel_prices: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleMapsPlacesV1FuelOptionsFuelPrice>>,
    >,
}
...
pub struct GoogleMapsPlacesV1FuelOptionsFuelPrice {
    ...
    #[serde(default)]
    pub price: ::core::option::Option<::std::boxed::Box<GoogleTypeMoney>>,
...
pub struct GoogleMapsPlacesV1Photo {
    ...
    pub author_attributions: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleMapsPlacesV1AuthorAttribution>>,
    >,
...
pub struct GoogleMapsPlacesV1Place {
    ...
    pub accessibility_options:
        ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1PlaceAccessibilityOptions>>,
    ...
    pub address_components: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleMapsPlacesV1PlaceAddressComponent>>,
    >,
    ...
    pub address_descriptor:
        ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1AddressDescriptor>>,
    /// The place''s address in adr microformat: http://microformats.org/wiki/adr.
    #[serde(default, rename = "adrFormatAddress")]
    pub adr_format_address: ::core::option::Option<String>,
    /// Place allows dogs.
    #[serde(default, rename = "allowsDogs")]
    pub allows_dogs: ::core::option::Option<bool>,
    /// A set of data provider that must be shown with this result.
    #[serde(default)]
    pub attributions: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleMapsPlacesV1PlaceAttribution>>,
    >,
    ...
    pub business_status: ::core::option::Option<String>,
    ...
    pub consumer_alert:
        ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1PlaceConsumerAlert>>,
    /// List of places in which the current place is located.
    #[serde(default, rename = "containingPlaces")]
    pub containing_places: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleMapsPlacesV1PlaceContainingPlace>>,
    >,
    ...
    pub current_opening_hours:
        ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1PlaceOpeningHours>>,
    ...
    pub current_secondary_opening_hours: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleMapsPlacesV1PlaceOpeningHours>>,
    >,
    ...
    pub editorial_summary: ::core::option::Option<::std::boxed::Box<GoogleTypeLocalizedText>>,
    /// The summary of amenities near the EV charging station.
    #[serde(default, rename = "evChargeAmenitySummary")]
    pub ev_charge_amenity_summary:
        ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1PlaceEvChargeAmenitySummary>>,
    /// Information of ev charging options.
    #[serde(default, rename = "evChargeOptions")]
    pub ev_charge_options:
        ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1eVChargeOptions>>,
    /// A full, human-readable address for this place.
    #[serde(default, rename = "formattedAddress")]
    pub formatted_address: ::core::option::Option<String>,
    /// The most recent information about fuel options in a gas station. This information is updated regularly.
    #[serde(default, rename = "fuelOptions")]
    pub fuel_options: ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1FuelOptions>>,
    /// AI-generated summary of the place.
    #[serde(default, rename = "generativeSummary")]
    pub generative_summary:
        ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1PlaceGenerativeSummary>>,
    ...
    pub google_maps_links:
        ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1PlaceGoogleMapsLinks>>,
    ...
    pub google_maps_type_label: ::core::option::Option<::std::boxed::Box<GoogleTypeLocalizedText>>,
    /// A URL providing more information about this place.
    #[serde(default, rename = "googleMapsUri")]
    pub google_maps_uri: ::core::option::Option<String>,
    /// Background color for icon_mask in hex format, e.g. #909CE1.
    #[serde(default, rename = "iconBackgroundColor")]
    pub icon_background_color: ::core::option::Option<String>,
    ...
    pub icon_mask_base_uri: ::core::option::Option<String>,
    /// The unique identifier of a place.
    #[serde(default)]
    pub id: ::core::option::Option<String>,
    /// A human-readable phone number for the place, in international format.
    #[serde(default, rename = "internationalPhoneNumber")]
    pub international_phone_number: ::core::option::Option<String>,
    /// Place provides live music.
    #[serde(default, rename = "liveMusic")]
    pub live_music: ::core::option::Option<bool>,
    /// The position of this place.
    #[serde(default)]
    pub location: ::core::option::Option<::std::boxed::Box<GoogleTypeLatLng>>,
    ...
    pub moved_place: ::core::option::Option<String>,
    ...
    pub moved_place_id: ::core::option::Option<String>,
    /// This Place''s resource name, in places/{place_id} format. Can be used to look up the Place.
    #[serde(default)]
    pub name: ::core::option::Option<String>,
    /// A human-readable phone number for the place, in national format.
    #[serde(default, rename = "nationalPhoneNumber")]
    pub national_phone_number: ::core::option::Option<String>,
    /// A summary of points of interest near the place.
    #[serde(default, rename = "neighborhoodSummary")]
    pub neighborhood_summary:
        ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1PlaceNeighborhoodSummary>>,
    ...
    pub opening_date: ::core::option::Option<::std::boxed::Box<GoogleTypeDate>>,
    ...
    pub parking_options:
        ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1PlaceParkingOptions>>,
    ...
    pub payment_options:
        ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1PlacePaymentOptions>>,
    ...
    pub plus_code: ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1PlacePlusCode>>,
    /// The address in postal address format.
    #[serde(default, rename = "postalAddress")]
    pub postal_address: ::core::option::Option<::std::boxed::Box<GoogleTypePostalAddress>>,
    ...
    pub price_level: ::core::option::Option<String>,
    /// The price range associated with a Place.
    #[serde(default, rename = "priceRange")]
    pub price_range: ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1PriceRange>>,
    ...
    pub primary_type: ::core::option::Option<String>,
    ...
    pub primary_type_display_name:
        ::core::option::Option<::std::boxed::Box<GoogleTypeLocalizedText>>,
    ...
    pub regular_secondary_opening_hours: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleMapsPlacesV1PlaceOpeningHours>>,
    >,
    ...
    pub review_summary:
        ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1PlaceReviewSummary>>,
    ...
    pub short_formatted_address: ::core::option::Option<String>,
    /// A list of sub-destinations related to the place.
    #[serde(default, rename = "subDestinations")]
    pub sub_destinations: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleMapsPlacesV1PlaceSubDestination>>,
    >,
    ...
    #[serde(default)]
    pub viewport: ::core::option::Option<::std::boxed::Box<GoogleGeoTypeViewport>>,
...
pub struct GoogleMapsPlacesV1PlaceAddressComponent {
    ...
    pub long_text: ::core::option::Option<String>,
    ...
    pub short_text: ::core::option::Option<String>,
...
pub struct GoogleMapsPlacesV1PlaceAttribution {
    ...
    pub provider_uri: ::core::option::Option<String>,
}
...
pub struct GoogleMapsPlacesV1PlaceConsumerAlert {
    ...
    #[serde(default)]
    pub details:
        ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1PlaceConsumerAlertDetails>>,
...
pub struct GoogleMapsPlacesV1PlaceConsumerAlertDetails {
    ...
    pub about_link:
        ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1PlaceConsumerAlertDetailsLink>>,
...
pub struct GoogleMapsPlacesV1PlaceEvChargeAmenitySummary {
    ...
    #[serde(default)]
    pub coffee: ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1ContentBlock>>,
    ...
    pub disclosure_text: ::core::option::Option<::std::boxed::Box<GoogleTypeLocalizedText>>,
    /// A link where users can flag a problem with the summary.
    #[serde(default, rename = "flagContentUri")]
    pub flag_content_uri: ::core::option::Option<String>,
    /// An overview of the available amenities. This is guaranteed to be provided.
    #[serde(default)]
    pub overview: ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1ContentBlock>>,
    /// A summary of the nearby restaurants.
    #[serde(default)]
    pub restaurant: ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1ContentBlock>>,
    /// A summary of the nearby stores.
    #[serde(default)]
    pub store: ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1ContentBlock>>,
}
...
pub struct GoogleMapsPlacesV1PlaceGenerativeSummary {
    ...
    #[serde(default)]
    pub overview: ::core::option::Option<::std::boxed::Box<GoogleTypeLocalizedText>>,
    /// A link where users can flag a problem with the overview summary.
    #[serde(default, rename = "overviewFlagContentUri")]
    pub overview_flag_content_uri: ::core::option::Option<String>,
}
...
pub struct GoogleMapsPlacesV1PlaceGoogleMapsLinks {
    ...
    pub photos_uri: ::core::option::Option<String>,
    /// A link to show this place.
    #[serde(default, rename = "placeUri")]
    pub place_uri: ::core::option::Option<String>,
    ...
    pub write_a_review_uri: ::core::option::Option<String>,
}
...
pub struct GoogleMapsPlacesV1PlaceNeighborhoodSummary {
    ...
    #[serde(default)]
    pub description: ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1ContentBlock>>,
    /// The AI disclosure message "Summarized with Gemini" (and its localized variants). This will be in the language specified in the request if available.
    #[serde(default, rename = "disclosureText")]
    pub disclosure_text: ::core::option::Option<::std::boxed::Box<GoogleTypeLocalizedText>>,
    /// A link where users can flag a problem with the summary.
...
pub struct GoogleMapsPlacesV1PlaceOpeningHours {
    ...
    #[serde(default)]
    pub periods: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleMapsPlacesV1PlaceOpeningHoursPeriod>>,
    >,
    ...
    pub special_days: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleMapsPlacesV1PlaceOpeningHoursSpecialDay>>,
    >,
...
pub struct GoogleMapsPlacesV1PlaceOpeningHoursPeriod {
    ...
    #[serde(default)]
    pub close:
        ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1PlaceOpeningHoursPeriodPoint>>,
...
pub struct GoogleMapsPlacesV1PlaceReviewSummary {
    ...
    #[serde(default)]
    pub text: ::core::option::Option<::std::boxed::Box<GoogleTypeLocalizedText>>,
}
...
pub struct GoogleMapsPlacesV1PriceRange {
    ...
    pub end_price: ::core::option::Option<::std::boxed::Box<GoogleTypeMoney>>,
    /// The low end of the price range (inclusive). Price should be at or above this amount.
    #[serde(default, rename = "startPrice")]
    pub start_price: ::core::option::Option<::std::boxed::Box<GoogleTypeMoney>>,
}
...
pub struct GoogleMapsPlacesV1Review {
    ...
    pub author_attribution:
        ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1AuthorAttribution>>,
    ...
    pub original_text: ::core::option::Option<::std::boxed::Box<GoogleTypeLocalizedText>>,
    ...
    pub visit_date: ::core::option::Option<::std::boxed::Box<GoogleTypeDate>>,
}
...
pub struct GoogleMapsPlacesV1RoutingParameters {
    ...
    pub route_modifiers:
        ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1RouteModifiers>>,
...
pub struct GoogleMapsPlacesV1RoutingSummary {
    ...
    #[serde(default)]
    pub legs: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleMapsPlacesV1RoutingSummaryLeg>>,
    >,
}
...
pub struct GoogleMapsPlacesV1SearchNearbyRequest {
    ...
    #[serde(default, rename = "locationRestriction")]
    pub location_restriction: ::core::option::Option<
        ::std::boxed::Box<GoogleMapsPlacesV1SearchNearbyRequestLocationRestriction>,
    >,
    ...
    pub routing_parameters:
        ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1RoutingParameters>>,
}
...
pub struct GoogleMapsPlacesV1SearchNearbyResponse {
    ...
    #[serde(default)]
    pub places: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleMapsPlacesV1Place>>>,
    ...
    pub routing_summaries: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleMapsPlacesV1RoutingSummary>>,
    >,
}
...
pub struct GoogleMapsPlacesV1SearchTextRequest {
    ...
    pub ev_options:
        ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1SearchTextRequestEVOptions>>,
    /// Optional. If true, include businesses that are not yet open but will open in the future.
    #[serde(default, rename = "includeFutureOpeningBusinesses")]
    pub include_future_opening_businesses: ::core::option::Option<bool>,
    /// Optional. Include pure service area businesses if the field is set to true. Pure service area business is a business that visits or delivers to customers directly but does not serve customers at their business address. For example, businesses like cleaning services or plumbers. Those businesses do not have a physical address or location on Google Maps. Places will not return fields including location, plus_code, and other location related fields for these businesses.
    ...
    #[serde(default, rename = "locationBias")]
    pub location_bias:
        ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1SearchTextRequestLocationBias>>,
    ...
    #[serde(default, rename = "locationRestriction")]
    pub location_restriction: ::core::option::Option<
        ::std::boxed::Box<GoogleMapsPlacesV1SearchTextRequestLocationRestriction>,
    >,
    ...
    pub search_along_route_parameters: ::core::option::Option<
        ::std::boxed::Box<GoogleMapsPlacesV1SearchTextRequestSearchAlongRouteParameters>,
    >,
...
pub struct GoogleMapsPlacesV1SearchTextRequestSearchAlongRouteParameters {
    ...
    #[serde(default)]
    pub polyline: ::core::option::Option<::std::boxed::Box<GoogleMapsPlacesV1Polyline>>,
}
...
pub struct GoogleMapsPlacesV1SearchTextResponse {
    ...
    pub contextual_contents: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleMapsPlacesV1ContextualContent>>,
    >,
