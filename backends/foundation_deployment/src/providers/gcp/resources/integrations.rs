...
pub struct EnterpriseCrmEventbusProtoConnectorsGenericConnectorTaskConfig {
    ...
    #[serde(default)]
    pub connection: ::core::option::Option<EnterpriseCrmEventbusProtoConnectorsConnection>,
...
pub struct EnterpriseCrmEventbusProtoParameterMap {
    #[serde(default)]
    pub entries:
        ::core::option::Option<::std::vec::Vec<EnterpriseCrmEventbusProtoParameterMapEntry>>,
...
pub struct EnterpriseCrmEventbusProtoSuspensionResolutionInfo {
    ...
    pub cloud_kms_config: ::core::option::Option<EnterpriseCrmEventbusProtoCloudKmsConfig>,
    /// Auto-generated.
    ...
    pub external_traffic: ::core::option::Option<EnterpriseCrmEventbusProtoExternalTraffic>,
    /// Auto-generated.
...
pub struct EnterpriseCrmFrontendsEventbusProtoParameterMap {
    ...
    pub entries: ::core::option::Option<
        ::std::vec::Vec<EnterpriseCrmFrontendsEventbusProtoParameterMapEntry>,
    >,
    /// Option to specify key value type for all entries of the map. If provided then field types for all entries must conform to this. // TODO: enum values: ["DATA_TYPE_UNSPECIFIED", "STRING_VALUE", "INT_VALUE", "DOUBLE_VALUE", "BOOLEAN_VALUE", "PROTO_VALUE", "SERIALIZED_OBJECT_VALUE", "STRING_ARRAY", "INT_ARRAY", "DOUBLE_ARRAY", "PROTO_ARRAY", "PROTO_ENUM", "BOOLEAN_ARRAY", "PROTO_ENUM_ARRAY", "BYTES", "BYTES_ARRAY", "NON_SERIALIZABLE_OBJECT", "JSON_VALUE"]
    #[serde(default, rename = "keyType")]
    pub key_type: ::core::option::Option<String>,
...
pub struct GoogleCloudIntegrationsV1alphaDownloadIntegrationVersionResponse {
    ...
    #[serde(default)]
    pub files:
        ::core::option::Option<::std::vec::Vec<GoogleCloudIntegrationsV1alphaSerializedFile>>,
}
...
pub struct GoogleCloudIntegrationsV1alphaDownloadJsonPackageResponse {
    ...
    #[serde(default)]
    pub files: ::core::option::Option<::std::vec::Vec<GoogleCloudIntegrationsV1alphaFile>>,
}
...
pub struct GoogleCloudIntegrationsV1alphaGenerateOpenApiSpecRequest {
    ...
    pub api_trigger_resources:
        ::core::option::Option<::std::vec::Vec<GoogleCloudIntegrationsV1alphaApiTriggerResource>>,
...
pub struct GoogleCloudIntegrationsV1alphaGetClientMetadataResponse {
    ...
    #[serde(default)]
    pub properties: ::core::option::Option<GoogleCloudIntegrationsV1alphaProjectProperties>,
}
...
pub struct GoogleCloudIntegrationsV1alphaGetClientResponse {
    /// Required. Required: The client configuration that was requested
    #[serde(default)]
    pub client: ::core::option::Option<GoogleCloudIntegrationsV1alphaClientConfig>,
}
...
pub struct GoogleCloudIntegrationsV1alphaListAuthConfigsResponse {
    ...
    pub auth_configs:
        ::core::option::Option<::std::vec::Vec<GoogleCloudIntegrationsV1alphaAuthConfig>>,
...
pub struct GoogleCloudIntegrationsV1alphaListCertificatesResponse {
    ...
    #[serde(default)]
    pub certificates:
        ::core::option::Option<::std::vec::Vec<GoogleCloudIntegrationsV1alphaCertificate>>,
    /// The token used to retrieve the next page of results.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct GoogleCloudIntegrationsV1alphaListConnectionsResponse {
    /// Connections.
    #[serde(default)]
    pub connections: ::core::option::Option<::std::vec::Vec<GoogleCloudConnectorsV1Connection>>,
    /// Next page token.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct GoogleCloudIntegrationsV1alphaListExecutionsResponse {
    ...
    pub execution_infos: ::core::option::Option<
        ::std::vec::Vec<EnterpriseCrmFrontendsEventbusProtoEventExecutionInfo>,
    >,
...
pub struct GoogleCloudIntegrationsV1alphaListIntegrationsResponse {
    ...
    #[serde(default)]
    pub integrations:
        ::core::option::Option<::std::vec::Vec<GoogleCloudIntegrationsV1alphaIntegration>>,
...
pub struct GoogleCloudIntegrationsV1alphaListRuntimeActionSchemasResponse {
    ...
    pub runtime_action_schemas:
        ::core::option::Option<::std::vec::Vec<GoogleCloudIntegrationsV1alphaRuntimeActionSchema>>,
}
...
pub struct GoogleCloudIntegrationsV1alphaListRuntimeEntitySchemasResponse {
    ...
    pub runtime_entity_schemas:
        ::core::option::Option<::std::vec::Vec<GoogleCloudIntegrationsV1alphaRuntimeEntitySchema>>,
}
...
pub struct GoogleCloudIntegrationsV1alphaListSfdcChannelsResponse {
    ...
    pub sfdc_channels:
        ::core::option::Option<::std::vec::Vec<GoogleCloudIntegrationsV1alphaSfdcChannel>>,
}
...
pub struct GoogleCloudIntegrationsV1alphaListSfdcInstancesResponse {
    ...
    pub sfdc_instances:
        ::core::option::Option<::std::vec::Vec<GoogleCloudIntegrationsV1alphaSfdcInstance>>,
}
...
pub struct GoogleCloudIntegrationsV1alphaListSuspensionsResponse {
    ...
    #[serde(default)]
    pub suspensions:
        ::core::option::Option<::std::vec::Vec<GoogleCloudIntegrationsV1alphaSuspension>>,
}
...
pub struct GoogleCloudIntegrationsV1alphaOAuth2AuthorizationCode {
    ...
    pub access_token: ::core::option::Option<GoogleCloudIntegrationsV1alphaAccessToken>,
    ...
    pub auth_params: ::core::option::Option<GoogleCloudIntegrationsV1alphaParameterMap>,
    /// The client''s id.
    #[serde(default, rename = "clientId")]
    pub client_id: ::core::option::Option<String>,
    /// The client''s secret.
    ...
    pub token_params: ::core::option::Option<GoogleCloudIntegrationsV1alphaParameterMap>,
}
...
pub struct GoogleCloudIntegrationsV1alphaTaskConfig {
    ...
    pub conditional_failure_policies:
        ::core::option::Option<GoogleCloudIntegrationsV1alphaConditionalFailurePolicies>,
    ...
    pub failure_policy: ::core::option::Option<GoogleCloudIntegrationsV1alphaFailurePolicy>,
    ...
    pub next_tasks: ::core::option::Option<::std::vec::Vec<GoogleCloudIntegrationsV1alphaNextTask>>,
    ...
    pub success_policy: ::core::option::Option<GoogleCloudIntegrationsV1alphaSuccessPolicy>,
    ...
    pub synchronous_call_failure_policy:
        ::core::option::Option<GoogleCloudIntegrationsV1alphaFailurePolicy>,
...
pub struct GoogleCloudIntegrationsV1alphaTriggerConfig {
    ...
    pub alert_config: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudIntegrationsV1alphaIntegrationAlertConfig>,
    >,
    /// Optional. Cloud Scheduler Trigger related metadata
    #[serde(default, rename = "cloudSchedulerConfig")]
    pub cloud_scheduler_config:
        ::core::option::Option<GoogleCloudIntegrationsV1alphaCloudSchedulerConfig>,
    /// Optional. User-provided description intended to give additional business context about the task.
    #[serde(default)]
    pub description: ::core::option::Option<String>,
    /// Optional. Optional Error catcher id of the error catch flow which will be executed when execution error happens in the task
    ...
    pub input_variables:
        ::core::option::Option<GoogleCloudIntegrationsV1alphaTriggerConfigVariables>,
...
pub struct GoogleCloudIntegrationsV1alphaValueType {
    ...
    pub boolean_array: ::core::option::Option<GoogleCloudIntegrationsV1alphaBooleanParameterArray>,
    /// Boolean.
    #[serde(default, rename = "booleanValue")]
    pub boolean_value: ::core::option::Option<bool>,
    /// Double Number Array.
    #[serde(default, rename = "doubleArray")]
    pub double_array: ::core::option::Option<GoogleCloudIntegrationsV1alphaDoubleParameterArray>,
    /// Double Number.
    #[serde(default, rename = "doubleValue")]
    pub double_value: ::core::option::Option<f64>,
    /// Integer Array.
    #[serde(default, rename = "intArray")]
    pub int_array: ::core::option::Option<GoogleCloudIntegrationsV1alphaIntParameterArray>,
    /// Integer.
    #[serde(default, rename = "intValue")]
    pub int_value: ::core::option::Option<String>,
    /// Json.
    ...
    pub string_array: ::core::option::Option<GoogleCloudIntegrationsV1alphaStringParameterArray>,
    /// String.
    #[serde(default, rename = "stringValue")]
    pub string_value: ::core::option::Option<String>,
}
