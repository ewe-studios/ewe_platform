...
pub struct EnterpriseCrmEventbusAuthconfigAuthConfigTaskParam {
    ...
    pub allowed_service_account_in_context: Option<bool>,
    ...
    pub use_service_account_in_context: Option<bool>,
}
...
pub struct EnterpriseCrmEventbusProtoBaseValue {
    ...
    pub base_function: Option<EnterpriseCrmEventbusProtoFunction>,
    /// Start with a literal value.
    #[serde(default, rename = "literalValue")]
    pub literal_value: Option<EnterpriseCrmEventbusProtoParameterValueType>,
...
pub struct EnterpriseCrmEventbusProtoCloudKmsConfig {
    ...
    pub key_ring_name: Option<String>,
    ...
    pub key_version_name: Option<String>,
...
pub struct EnterpriseCrmEventbusProtoConnectorsGenericConnectorTaskConfig {
    ...
    #[serde(default)]
    pub connection: Option<EnterpriseCrmEventbusProtoConnectorsConnection>,
...
pub struct EnterpriseCrmEventbusProtoEventExecutionDetails {
    ...
    pub event_retries_from_beginning_count: Option<i32>,
    ...
    pub rye_lock_unheld_count: Option<i32>,
}
...
pub struct EnterpriseCrmEventbusProtoEventExecutionSnapshotEventExecutionSnapshotMetadata {
    ...
    pub event_attempt_num: Option<i32>,
    ...
    pub task_attempt_num: Option<i32>,
...
pub struct EnterpriseCrmEventbusProtoExternalTraffic {
    ...
    pub enable_internal_ip: Option<bool>,
    ...
    pub retry_request_for_quota: Option<bool>,
...
pub struct EnterpriseCrmEventbusProtoFailurePolicy {
    ...
    pub max_num_retries: Option<i32>,
...
pub struct EnterpriseCrmEventbusProtoField {
    ...
    #[serde(default, rename = "defaultValue")]
    pub default_value: Option<EnterpriseCrmEventbusProtoParameterValueType>,
    ...
    pub transform_expression: Option<EnterpriseCrmEventbusProtoTransformExpression>,
}
...
pub struct EnterpriseCrmEventbusProtoFieldMappingConfig {
    ...
    pub mapped_fields: Option<Vec<EnterpriseCrmEventbusProtoMappedField>>,
}
...
pub struct EnterpriseCrmEventbusProtoFunction {
    ...
    pub function_type: Option<EnterpriseCrmEventbusProtoFunctionType>,
    /// List of parameters required for the transformation.
    #[serde(default)]
    pub parameters: Option<Vec<EnterpriseCrmEventbusProtoTransformExpression>>,
}
...
pub struct EnterpriseCrmEventbusProtoFunctionType {
    /// LINT.IfChange
    #[serde(default, rename = "baseFunction")]
    pub base_function: Option<EnterpriseCrmEventbusProtoBaseFunction>,
    #[serde(default, rename = "booleanArrayFunction")]
    pub boolean_array_function: Option<EnterpriseCrmEventbusProtoBooleanArrayFunction>,
    #[serde(default, rename = "booleanFunction")]
    pub boolean_function: Option<EnterpriseCrmEventbusProtoBooleanFunction>,
    #[serde(default, rename = "doubleArrayFunction")]
    pub double_array_function: Option<EnterpriseCrmEventbusProtoDoubleArrayFunction>,
    #[serde(default, rename = "doubleFunction")]
    pub double_function: Option<EnterpriseCrmEventbusProtoDoubleFunction>,
    #[serde(default, rename = "intArrayFunction")]
    pub int_array_function: Option<EnterpriseCrmEventbusProtoIntArrayFunction>,
    #[serde(default, rename = "intFunction")]
    pub int_function: Option<EnterpriseCrmEventbusProtoIntFunction>,
    #[serde(default, rename = "jsonFunction")]
    pub json_function: Option<EnterpriseCrmEventbusProtoJsonFunction>,
    #[serde(default, rename = "protoArrayFunction")]
    pub proto_array_function: Option<EnterpriseCrmEventbusProtoProtoArrayFunction>,
    #[serde(default, rename = "protoFunction")]
    pub proto_function: Option<EnterpriseCrmEventbusProtoProtoFunction>,
    #[serde(default, rename = "stringArrayFunction")]
    pub string_array_function: Option<EnterpriseCrmEventbusProtoStringArrayFunction>,
    #[serde(default, rename = "stringFunction")]
    pub string_function: Option<EnterpriseCrmEventbusProtoStringFunction>,
}
...
pub struct EnterpriseCrmEventbusProtoLoopMetadata {
    ...
    pub current_iteration_count: Option<String>,
    ...
    pub current_iteration_detail: Option<String>,
...
pub struct EnterpriseCrmEventbusProtoMappedField {
    ...
    pub input_field: Option<EnterpriseCrmEventbusProtoField>,
    /// The output field being mapped to.
    #[serde(default, rename = "outputField")]
    pub output_field: Option<EnterpriseCrmEventbusProtoField>,
}
...
pub struct EnterpriseCrmEventbusProtoParameterMap {
    #[serde(default)]
    pub entries: Option<Vec<EnterpriseCrmEventbusProtoParameterMapEntry>>,
...
pub struct EnterpriseCrmEventbusProtoParameterMapEntry {
    #[serde(default)]
    pub key: Option<EnterpriseCrmEventbusProtoParameterMapField>,
    #[serde(default)]
    pub value: Option<EnterpriseCrmEventbusProtoParameterMapField>,
}
...
pub struct EnterpriseCrmEventbusProtoScatterResponse {
    ...
    pub response_params: Option<Vec<EnterpriseCrmEventbusProtoParameterEntry>>,
    /// The element that was scattered for this execution.
    #[serde(default, rename = "scatterElement")]
    pub scatter_element: Option<EnterpriseCrmEventbusProtoParameterValueType>,
}
...
pub struct EnterpriseCrmEventbusProtoSuspensionExpiration {
    ...
    pub expire_after_ms: Option<i32>,
    ...
    pub remind_after_ms: Option<i32>,
}
...
pub struct EnterpriseCrmEventbusProtoSuspensionResolutionInfo {
    #[serde(default)]
    pub audit: Option<EnterpriseCrmEventbusProtoSuspensionResolutionInfoAudit>,
    /// The event data user sends as request.
    #[serde(default, rename = "clientId")]
    pub client_id: Option<String>,
    /// KMS info, used by cmek/gmek integration
    #[serde(default, rename = "cloudKmsConfig")]
    pub cloud_kms_config: Option<EnterpriseCrmEventbusProtoCloudKmsConfig>,
    /// Auto-generated.
    ...
    pub encrypted_suspension_resolution_info: Option<String>,
    ...
    pub external_traffic: Option<EnterpriseCrmEventbusProtoExternalTraffic>,
    /// Auto-generated.
    ...
    pub suspension_config: Option<EnterpriseCrmEventbusProtoSuspensionConfig>,
...
pub struct EnterpriseCrmEventbusProtoSuspensionResolutionInfoAudit {
    ...
    pub resolved_by_cpi: Option<String>,
    #[serde(default)]
...
pub struct EnterpriseCrmEventbusProtoTaskAlertConfig {
    ...
    pub num_aggregation_periods: Option<i32>,
...
pub struct EnterpriseCrmEventbusProtoTaskMetadata {
    ...
    pub external_category_sequence: Option<i32>,
...
pub struct EnterpriseCrmEventbusProtoTransformExpression {
    ...
    pub initial_value: Option<EnterpriseCrmEventbusProtoBaseValue>,
    /// Transformations to be applied sequentially.
    #[serde(default, rename = "transformationFunctions")]
    pub transformation_functions: Option<Vec<EnterpriseCrmEventbusProtoFunction>>,
}
...
pub struct EnterpriseCrmFrontendsEventbusProtoParameterMap {
    #[serde(default)]
    pub entries: Option<Vec<EnterpriseCrmFrontendsEventbusProtoParameterMapEntry>>,
    /// Option to specify key value type for all entries of the map. If provided then field types for all entries must conform to this. // TODO: enum values: ["DATA_TYPE_UNSPECIFIED", "STRING_VALUE", "INT_VALUE", "DOUBLE_VALUE", "BOOLEAN_VALUE", "PROTO_VALUE", "SERIALIZED_OBJECT_VALUE", "STRING_ARRAY", "INT_ARRAY", "DOUBLE_ARRAY", "PROTO_ARRAY", "PROTO_ENUM", "BOOLEAN_ARRAY", "PROTO_ENUM_ARRAY", "BYTES", "BYTES_ARRAY", "NON_SERIALIZABLE_OBJECT", "JSON_VALUE"]
    #[serde(default, rename = "keyType")]
    pub key_type: Option<String>,
    /// TODO: enum values: ["DATA_TYPE_UNSPECIFIED", "STRING_VALUE", "INT_VALUE", "DOUBLE_VALUE", "BOOLEAN_VALUE", "PROTO_VALUE", "SERIALIZED_OBJECT_VALUE", "STRING_ARRAY", "INT_ARRAY", "DOUBLE_ARRAY", "PROTO_ARRAY", "PROTO_ENUM", "BOOLEAN_ARRAY", "PROTO_ENUM_ARRAY", "BYTES", "BYTES_ARRAY", "NON_SERIALIZABLE_OBJECT", "JSON_VALUE"]
...
pub struct EnterpriseCrmFrontendsEventbusProtoParameterMapEntry {
    #[serde(default)]
    pub key: Option<EnterpriseCrmFrontendsEventbusProtoParameterMapField>,
    #[serde(default)]
    pub value: Option<EnterpriseCrmFrontendsEventbusProtoParameterMapField>,
}
...
pub struct EnterpriseCrmFrontendsEventbusProtoParameterMapField {
    /// Passing a literal value.
    #[serde(default, rename = "literalValue")]
    pub literal_value: Option<EnterpriseCrmFrontendsEventbusProtoParameterValueType>,
    /// Referencing one of the WF variables.
    #[serde(default, rename = "referenceKey")]
    pub reference_key: Option<String>,
}
...
pub struct EnterpriseCrmFrontendsEventbusProtoTaskConfig {
    ...
    pub incoming_edge_count: Option<i32>,
...
pub struct GoogleCloudIntegrationsV1alphaApiTriggerResource {
    ...
    pub integration_resource: Option<String>,
    /// Required. Trigger Id of the API trigger(s) in the integration
    #[serde(default, rename = "triggerId")]
    pub trigger_id: Option<Vec<String>>,
}
...
pub struct GoogleCloudIntegrationsV1alphaAssertion {
    ...
    pub assertion_strategy: Option<String>,
    ...
    #[serde(default)]
    pub parameter: Option<GoogleCloudIntegrationsV1alphaEventParameter>,
...
pub struct GoogleCloudIntegrationsV1alphaAssertionResult {
    ...
    #[serde(default)]
    pub assertion: Option<GoogleCloudIntegrationsV1alphaAssertion>,
...
pub struct GoogleCloudIntegrationsV1alphaConditionalFailurePolicies {
    /// The default failure policy to be applied if no conditional failure policy matches.
    #[serde(default, rename = "defaultFailurePolicy")]
    pub default_failure_policy: Option<GoogleCloudIntegrationsV1alphaFailurePolicy>,
    /// The list of failure policies that will be applied to the task in order.
    #[serde(default, rename = "failurePolicies")]
    pub failure_policies: Option<Vec<GoogleCloudIntegrationsV1alphaFailurePolicy>>,
}
...
pub struct GoogleCloudIntegrationsV1alphaCredential {
    ...
    pub auth_token: Option<GoogleCloudIntegrationsV1alphaAuthToken>,
    ...
    /// JWT credential
    #[serde(default)]
    pub jwt: Option<GoogleCloudIntegrationsV1alphaJwt>,
    ...
    pub oauth2_authorization_code: Option<GoogleCloudIntegrationsV1alphaOAuth2AuthorizationCode>,
    /// OAuth2Implicit oauth2_implicit = 5; OAuth2 client credentials
    #[serde(default, rename = "oauth2ClientCredentials")]
    pub oauth2_client_credentials: Option<GoogleCloudIntegrationsV1alphaOAuth2ClientCredentials>,
    ...
    pub oauth2_resource_owner_credentials:
        Option<GoogleCloudIntegrationsV1alphaOAuth2ResourceOwnerCredentials>,
    /// Google OIDC ID Token
    #[serde(default, rename = "oidcToken")]
    pub oidc_token: Option<GoogleCloudIntegrationsV1alphaOidcToken>,
    /// Service account credential
    #[serde(default, rename = "serviceAccountCredentials")]
    pub service_account_credentials:
        Option<GoogleCloudIntegrationsV1alphaServiceAccountCredentials>,
    /// Username and password credential
    #[serde(default, rename = "usernameAndPassword")]
    pub username_and_password: Option<GoogleCloudIntegrationsV1alphaUsernameAndPassword>,
}
...
pub struct GoogleCloudIntegrationsV1alphaEventParameter {
    ...
    /// Values for the defined keys. Each value can either be string, int, double or any proto message.
    #[serde(default)]
    pub value: Option<GoogleCloudIntegrationsV1alphaValueType>,
}
...
pub struct GoogleCloudIntegrationsV1alphaExecutionDetails {
    ...
    pub attempt_stats: Option<Vec<GoogleCloudIntegrationsV1alphaAttemptStats>>,
    /// Total size of all event_execution_snapshots for an execution
    #[serde(default, rename = "eventExecutionSnapshotsSize")]
    pub event_execution_snapshots_size: Option<String>,
    /// List of snapshots taken during the execution.
    #[serde(default, rename = "executionSnapshots")]
    pub execution_snapshots: Option<Vec<GoogleCloudIntegrationsV1alphaExecutionSnapshot>>,
...
pub struct GoogleCloudIntegrationsV1alphaExecutionSnapshot {
    ...
    pub execution_snapshot_metadata:
        Option<GoogleCloudIntegrationsV1alphaExecutionSnapshotExecutionSnapshotMetadata>,
    /// Parameters used during the execution.
    #[serde(default)]
    pub params: Option<serde_json::Value>,
    /// All of the task execution details at the given point of time.
    #[serde(default, rename = "taskExecutionDetails")]
    pub task_execution_details: Option<Vec<GoogleCloudIntegrationsV1alphaTaskExecutionDetails>>,
}
...
pub struct GoogleCloudIntegrationsV1alphaExecutionSnapshotExecutionSnapshotMetadata {
    ...
    pub execution_attempt: Option<i32>,
    /// The direct integration which the event execution snapshots belongs to
    #[serde(default, rename = "integrationName")]
    pub integration_name: Option<String>,
...
pub struct GoogleCloudIntegrationsV1alphaIntegrationAlertConfig {
    ...
    pub duration_threshold: Option<String>,
    ...
    /// The metric value, above or below which the alert should be triggered.
    #[serde(default, rename = "thresholdValue")]
    pub threshold_value: Option<GoogleCloudIntegrationsV1alphaIntegrationAlertConfigThresholdValue>,
}
...
pub struct GoogleCloudIntegrationsV1alphaIntegrationConfigParameter {
    ...
    #[serde(default)]
    pub parameter: Option<GoogleCloudIntegrationsV1alphaIntegrationParameter>,
...
pub struct GoogleCloudIntegrationsV1alphaIntegrationParameter {
    ...
    /// Default values for the defined keys. Each value can either be string, int, double or any proto message or a serialized object.
    #[serde(default, rename = "defaultValue")]
    pub default_value: Option<GoogleCloudIntegrationsV1alphaValueType>,
    ...
    pub input_output_type: Option<String>,
    /// Whether this parameter is a transient parameter.
    #[serde(default, rename = "isTransient")]
    pub is_transient: Option<bool>,
    /// This schema will be used to validate runtime JSON-typed values of this parameter.
...
pub struct GoogleCloudIntegrationsV1alphaMockConfig {
    ...
    pub failed_executions: Option<String>,
    ...
    #[serde(default)]
    pub parameters: Option<Vec<GoogleCloudIntegrationsV1alphaEventParameter>>,
}
...
pub struct GoogleCloudIntegrationsV1alphaOAuth2AuthorizationCode {
    ...
    #[serde(default, rename = "accessToken")]
    pub access_token: Option<GoogleCloudIntegrationsV1alphaAccessToken>,
    ...
    pub apply_reauth_policy: Option<bool>,
    ...
    pub auth_params: Option<GoogleCloudIntegrationsV1alphaParameterMap>,
    /// The client''s id.
    #[serde(default, rename = "clientId")]
    pub client_id: Option<String>,
    /// The client''s secret.
    ...
    pub token_params: Option<GoogleCloudIntegrationsV1alphaParameterMap>,
}
...
pub struct GoogleCloudIntegrationsV1alphaParameterMap {
    ...
    #[serde(default)]
    pub entries: Option<Vec<GoogleCloudIntegrationsV1alphaParameterMapEntry>>,
...
pub struct GoogleCloudIntegrationsV1alphaParameterMapEntry {
    ...
    #[serde(default)]
    pub key: Option<GoogleCloudIntegrationsV1alphaParameterMapField>,
    /// Value of the map entry.
    #[serde(default)]
    pub value: Option<GoogleCloudIntegrationsV1alphaParameterMapField>,
}
...
pub struct GoogleCloudIntegrationsV1alphaParameterMapField {
    /// Passing a literal value.
    #[serde(default, rename = "literalValue")]
    pub literal_value: Option<GoogleCloudIntegrationsV1alphaValueType>,
...
pub struct GoogleCloudIntegrationsV1alphaRuntimeEntitySchema {
    ...
    pub array_field_schema: Option<String>,
    /// Name of the entity.
    #[serde(default)]
...
pub struct GoogleCloudIntegrationsV1alphaSuspension {
    ...
    pub approval_config: Option<GoogleCloudIntegrationsV1alphaSuspensionApprovalConfig>,
    /// Metadata pertaining to the resolution of this suspension.
    #[serde(default)]
    pub audit: Option<GoogleCloudIntegrationsV1alphaSuspensionAudit>,
    /// Output only. Auto-generated.
    #[serde(default, rename = "createTime")]
    pub create_time: Option<String>,
    /// Required. ID of the associated execution.
...
pub struct GoogleCloudIntegrationsV1alphaSuspensionApprovalConfig {
    ...
    /// Indicates the next steps when no external actions happen on the suspension.
    #[serde(default)]
    pub expiration: Option<GoogleCloudIntegrationsV1alphaSuspensionApprovalExpiration>,
}
...
pub struct GoogleCloudIntegrationsV1alphaTaskConfig {
    ...
    pub conditional_failure_policies:
        Option<GoogleCloudIntegrationsV1alphaConditionalFailurePolicies>,
    ...
    /// Optional. Determines the number of times the task will be retried on failure and with what retry strategy. This is applicable for asynchronous calls to Eventbus alone (Post To Queue, Schedule etc.).
    #[serde(default, rename = "failurePolicy")]
    pub failure_policy: Option<GoogleCloudIntegrationsV1alphaFailurePolicy>,
    ...
    #[serde(default, rename = "nextTasks")]
    pub next_tasks: Option<Vec<GoogleCloudIntegrationsV1alphaNextTask>>,
    ...
    #[serde(default, rename = "successPolicy")]
    pub success_policy: Option<GoogleCloudIntegrationsV1alphaSuccessPolicy>,
    /// Optional. Determines the number of times the task will be retried on failure and with what retry strategy. This is applicable for synchronous calls to Eventbus alone (Post).
    #[serde(default, rename = "synchronousCallFailurePolicy")]
    pub synchronous_call_failure_policy: Option<GoogleCloudIntegrationsV1alphaFailurePolicy>,
...
pub struct GoogleCloudIntegrationsV1alphaTaskExecutionDetails {
    ...
    #[serde(default, rename = "taskAttemptStats")]
    pub task_attempt_stats: Option<Vec<GoogleCloudIntegrationsV1alphaAttemptStats>>,
...
pub struct GoogleCloudIntegrationsV1alphaTemplateBundle {
    ...
    pub integration_version_template:
        Option<GoogleCloudIntegrationsV1alphaIntegrationVersionTemplate>,
    ...
    pub sub_integration_version_templates:
        Option<Vec<GoogleCloudIntegrationsV1alphaIntegrationVersionTemplate>>,
}
...
pub struct GoogleCloudIntegrationsV1alphaTestTaskConfig {
    ...
    #[serde(default)]
    pub assertions: Option<Vec<GoogleCloudIntegrationsV1alphaAssertion>>,
    /// Optional. Defines how to mock the given task during test execution
    #[serde(default, rename = "mockConfig")]
    pub mock_config: Option<GoogleCloudIntegrationsV1alphaMockConfig>,
    ...
    pub task_config: Option<GoogleCloudIntegrationsV1alphaTaskConfig>,
...
pub struct GoogleCloudIntegrationsV1alphaTriggerConfig {
    ...
    #[serde(default, rename = "alertConfig")]
    pub alert_config: Option<Vec<GoogleCloudIntegrationsV1alphaIntegrationAlertConfig>>,
    /// Optional. Cloud Scheduler Trigger related metadata
    #[serde(default, rename = "cloudSchedulerConfig")]
    pub cloud_scheduler_config: Option<GoogleCloudIntegrationsV1alphaCloudSchedulerConfig>,
    /// Optional. User-provided description intended to give additional business context about the task.
    #[serde(default)]
    pub description: Option<String>,
    /// Optional. Optional Error catcher id of the error catch flow which will be executed when execution error happens in the task
    ...
    /// Optional. List of input variables for the api trigger.
    #[serde(default, rename = "inputVariables")]
    pub input_variables: Option<GoogleCloudIntegrationsV1alphaTriggerConfigVariables>,
    ...
    /// Optional. List of output variables for the api trigger.
    #[serde(default, rename = "outputVariables")]
    pub output_variables: Option<GoogleCloudIntegrationsV1alphaTriggerConfigVariables>,
    /// Optional. Informs the front-end application where to draw this error catcher config on the UI.
    #[serde(default)]
    pub position: Option<GoogleCloudIntegrationsV1alphaCoordinate>,
    ...
    #[serde(default, rename = "startTasks")]
    pub start_tasks: Option<Vec<GoogleCloudIntegrationsV1alphaNextTask>>,
...
pub struct GoogleCloudIntegrationsV1alphaUseTemplateRequestIntegrationDetails {
    ...
    pub integration_description: Option<String>,
}
...
pub struct GoogleCloudIntegrationsV1alphaValueType {
    /// Boolean Array.
    #[serde(default, rename = "booleanArray")]
    pub boolean_array: Option<GoogleCloudIntegrationsV1alphaBooleanParameterArray>,
    /// Boolean.
    #[serde(default, rename = "booleanValue")]
    pub boolean_value: Option<bool>,
    /// Double Number Array.
    #[serde(default, rename = "doubleArray")]
    pub double_array: Option<GoogleCloudIntegrationsV1alphaDoubleParameterArray>,
    /// Double Number.
    #[serde(default, rename = "doubleValue")]
    pub double_value: Option<f64>,
    /// Integer Array.
    #[serde(default, rename = "intArray")]
    pub int_array: Option<GoogleCloudIntegrationsV1alphaIntParameterArray>,
    /// Integer.
    #[serde(default, rename = "intValue")]
    pub int_value: Option<String>,
    /// Json.
    ...
    /// String Array.
    #[serde(default, rename = "stringArray")]
    pub string_array: Option<GoogleCloudIntegrationsV1alphaStringParameterArray>,
    /// String.
    #[serde(default, rename = "stringValue")]
    pub string_value: Option<String>,
}
...
pub struct GoogleInternalCloudCrmEventbusV3PostToQueueWithTriggerIdRequest {
    ...
    pub quota_retry_count: Option<i32>,
