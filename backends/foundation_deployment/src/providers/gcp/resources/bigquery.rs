//! Auto-generated resource types for Google Cloud Platform - bigquery.
//!
//! This file is generated by `cargo run --bin ewe_platform gen_resource_types`.
//! DO NOT EDIT MANUALLY.
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/bigquery/openapi.json`.
...
pub struct ArimaForecastingMetrics {
    ...
    pub arima_fitting_metrics:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ArimaFittingMetrics>>>,
    /// Repeated as there can be many metric sets (one for each model) in auto-arima and the large-scale case.
    #[serde(default, rename = "arimaSingleModelForecastingMetrics")]
    pub arima_single_model_forecasting_metrics: ::core::option::Option<
    ...
    pub non_seasonal_order: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ArimaOrder>>>,
...
pub struct ArimaModelInfo {
    ...
    pub arima_coefficients: ::core::option::Option<::std::boxed::Box<ArimaCoefficients>>,
    /// Arima fitting metrics.
    #[serde(default, rename = "arimaFittingMetrics")]
    pub arima_fitting_metrics: ::core::option::Option<::std::boxed::Box<ArimaFittingMetrics>>,
    /// Whether Arima model fitted with drift or not. It is always false when d is not 1.
    #[serde(default, rename = "hasDrift")]
    ...
    /// Non-seasonal order.
    #[serde(default, rename = "nonSeasonalOrder")]
    pub non_seasonal_order: ::core::option::Option<::std::boxed::Box<ArimaOrder>>,
    /// Seasonal periods. Repeated because multiple periods are supported for one time series.
    #[serde(default, rename = "seasonalPeriods")]
    pub seasonal_periods: ::core::option::Option<::std::vec::Vec<String>>,
...
pub struct ArimaResult {
    ...
    pub arima_model_info:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ArimaModelInfo>>>,
    /// Seasonal periods. Repeated because multiple periods are supported for one time series.
    #[serde(default, rename = "seasonalPeriods")]
    pub seasonal_periods: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct BiEngineStatistics {
    ...
    pub bi_engine_reasons:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<BiEngineReason>>>,
}
...
pub struct BigtableColumn {
    ...
    pub proto_config: ::core::option::Option<::std::boxed::Box<BigtableProtoConfig>>,
...
pub struct BigtableColumnFamily {
    ...
    #[serde(default)]
    pub columns: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<BigtableColumn>>>,
...
pub struct BigtableOptions {
    ...
    pub column_families:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<BigtableColumnFamily>>>,
...
pub struct BinaryClassificationMetrics {
    ...
    pub aggregate_classification_metrics:
        ::core::option::Option<::std::boxed::Box<AggregateClassificationMetrics>>,
    /// Binary confusion matrix at multiple thresholds.
    #[serde(default, rename = "binaryConfusionMatrixList")]
    pub binary_confusion_matrix_list:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<BinaryConfusionMatrix>>>,
...
pub struct BqmlTrainingRun {
    ...
    pub iteration_results:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<BqmlIterationResult>>>,
    /// Deprecated.
...
pub struct CategoricalValue {
    ...
    pub category_counts: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<CategoryCount>>>,
}
...
pub struct CloneDefinition {
    ...
    pub base_table_reference: ::core::option::Option<::std::boxed::Box<TableReference>>,
...
pub struct Cluster {
    ...
    pub feature_values: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<FeatureValue>>>,
}
...
pub struct DataSplitResult {
    ...
    pub evaluation_table: ::core::option::Option<::std::boxed::Box<TableReference>>,
    /// Table reference of the test data after split.
    #[serde(default, rename = "testTable")]
    pub test_table: ::core::option::Option<::std::boxed::Box<TableReference>>,
    /// Table reference of the training data after split.
    #[serde(default, rename = "trainingTable")]
    pub training_table: ::core::option::Option<::std::boxed::Box<TableReference>>,
}
...
pub struct Dataset {
    ...
    #[serde(default)]
    pub access: ::core::option::Option<::std::vec::Vec<serde_json::Value>>,
    ...
    #[serde(default, rename = "catalogSource")]
    pub catalog_source: ::core::option::Option<String>,
    ...
    pub dataset_reference: ::core::option::Option<::std::boxed::Box<DatasetReference>>,
    ...
    #[serde(default, rename = "defaultEncryptionConfiguration")]
    pub default_encryption_configuration:
        ::core::option::Option<::std::boxed::Box<EncryptionConfiguration>>,
    ...
    pub default_partition_expiration_ms: ::core::option::Option<String>,
    /// Optional. Defines the default rounding mode specification of new tables created within this dataset. During table creation, if this field is specified, the table within this dataset will inherit the default rounding mode of the dataset. Setting the default rounding mode on a table overrides this option. Existing tables in the dataset are unaffected. If columns are defined during that table creation, they will immediately inherit the table''s default rounding mode, unless otherwise specified. // TODO: enum values: ["ROUNDING_MODE_UNSPECIFIED", "ROUND_HALF_AWAY_FROM_ZERO", "ROUND_HALF_EVEN"]
    ...
    pub default_table_expiration_ms: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "externalCatalogDatasetOptions")]
    pub external_catalog_dataset_options:
        ::core::option::Option<::std::boxed::Box<ExternalCatalogDatasetOptions>>,
    ...
    #[serde(default, rename = "externalDatasetReference")]
    pub external_dataset_reference:
        ::core::option::Option<::std::boxed::Box<ExternalDatasetReference>>,
    ...
    #[serde(default, rename = "isCaseInsensitive")]
    ...
    #[serde(default, rename = "linkedDatasetMetadata")]
    pub linked_dataset_metadata: ::core::option::Option<::std::boxed::Box<LinkedDatasetMetadata>>,
    ...
    #[serde(default, rename = "linkedDatasetSource")]
    pub linked_dataset_source: ::core::option::Option<::std::boxed::Box<LinkedDatasetSource>>,
    ...
    pub max_time_travel_hours: ::core::option::Option<String>,
    ...
    #[serde(default)]
    pub restrictions: ::core::option::Option<::std::boxed::Box<RestrictionConfig>>,
    ...
    /// Optional. Updates storage_billing_model for the dataset. // TODO: enum values: ["STORAGE_BILLING_MODEL_UNSPECIFIED", "LOGICAL", "PHYSICAL"]
    #[serde(default, rename = "storageBillingModel")]
    pub storage_billing_model: ::core::option::Option<String>,
    /// Output only. Tags for the dataset. To provide tags as inputs, use the resourceTags field.
    #[serde(default)]
    pub tags: ::core::option::Option<::std::vec::Vec<serde_json::Value>>,
...
pub struct DatasetAccessEntry {
    ...
    #[serde(default)]
    pub dataset: ::core::option::Option<::std::boxed::Box<DatasetReference>>,
    ...
    pub target_types: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct DatasetList {
    ...
    #[serde(default)]
    pub datasets: ::core::option::Option<::std::vec::Vec<serde_json::Value>>,
...
pub struct DoubleHparamSearchSpace {
    ...
    #[serde(default)]
    pub candidates: ::core::option::Option<::std::boxed::Box<DoubleCandidates>>,
...
pub struct EvaluationMetrics {
    ...
    pub arima_forecasting_metrics:
        ::core::option::Option<::std::boxed::Box<ArimaForecastingMetrics>>,
    /// Populated for binary classification/classifier models.
    #[serde(default, rename = "binaryClassificationMetrics")]
    pub binary_classification_metrics:
        ::core::option::Option<::std::boxed::Box<BinaryClassificationMetrics>>,
    /// Populated for clustering models.
    #[serde(default, rename = "clusteringMetrics")]
    pub clustering_metrics: ::core::option::Option<::std::boxed::Box<ClusteringMetrics>>,
    ...
    pub dimensionality_reduction_metrics:
        ::core::option::Option<::std::boxed::Box<DimensionalityReductionMetrics>>,
    /// Populated for multi-class classification/classifier models.
    #[serde(default, rename = "multiClassClassificationMetrics")]
    pub multi_class_classification_metrics:
        ::core::option::Option<::std::boxed::Box<MultiClassClassificationMetrics>>,
    /// Populated for implicit feedback type matrix factorization models.
    #[serde(default, rename = "rankingMetrics")]
    pub ranking_metrics: ::core::option::Option<::std::boxed::Box<RankingMetrics>>,
    /// Populated for regression models and explicit feedback type matrix factorization models.
    #[serde(default, rename = "regressionMetrics")]
    pub regression_metrics: ::core::option::Option<::std::boxed::Box<RegressionMetrics>>,
}
...
pub struct ExplainQueryStage {
    ...
    #[serde(default)]
    pub steps: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ExplainQueryStep>>>,
...
pub struct ExternalCatalogDatasetOptions {
    ...
    pub default_storage_location_uri: ::core::option::Option<String>,
...
pub struct ExternalCatalogTableOptions {
    ...
    pub storage_descriptor: ::core::option::Option<::std::boxed::Box<StorageDescriptor>>,
}
...
pub struct ExternalDataConfiguration {
    ...
    #[serde(default, rename = "avroOptions")]
    pub avro_options: ::core::option::Option<::std::boxed::Box<AvroOptions>>,
    /// Optional. Additional options if sourceFormat is set to BIGTABLE.
    #[serde(default, rename = "bigtableOptions")]
    pub bigtable_options: ::core::option::Option<::std::boxed::Box<BigtableOptions>>,
    ...
    pub csv_options: ::core::option::Option<::std::boxed::Box<CsvOptions>>,
    ...
    #[serde(default, rename = "datetimeFormat")]
    pub datetime_format: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "decimalTargetTypes")]
    pub decimal_target_types: ::core::option::Option<::std::vec::Vec<String>>,
    /// Optional. Specifies how source URIs are interpreted for constructing the file set to load. By default source URIs are expanded against the underlying storage. Other options include specifying manifest files. Only applicable to object storage systems. // TODO: enum values: ["FILE_SET_SPEC_TYPE_FILE_SYSTEM_MATCH", "FILE_SET_SPEC_TYPE_NEW_LINE_DELIMITED_MANIFEST"]
    #[serde(default, rename = "fileSetSpecType")]
    pub file_set_spec_type: ::core::option::Option<String>,
    /// Optional. Additional options if sourceFormat is set to GOOGLE_SHEETS.
    #[serde(default, rename = "googleSheetsOptions")]
    pub google_sheets_options: ::core::option::Option<::std::boxed::Box<GoogleSheetsOptions>>,
    ...
    #[serde(default, rename = "hivePartitioningOptions")]
    pub hive_partitioning_options:
        ::core::option::Option<::std::boxed::Box<HivePartitioningOptions>>,
    ...
    /// Optional. Load option to be used together with source_format newline-delimited JSON to indicate that a variant of JSON is being loaded. To load newline-delimited GeoJSON, specify GEOJSON (and source_format must be set to NEWLINE_DELIMITED_JSON). // TODO: enum values: ["JSON_EXTENSION_UNSPECIFIED", "GEOJSON"]
    #[serde(default, rename = "jsonExtension")]
    pub json_extension: ::core::option::Option<String>,
    /// Optional. Additional properties to set if sourceFormat is set to JSON.
    #[serde(default, rename = "jsonOptions")]
    pub json_options: ::core::option::Option<::std::boxed::Box<JsonOptions>>,
    /// Optional. The maximum number of bad records that BigQuery can ignore when reading data. If the number of bad records exceeds this value, an invalid error is returned in the job result. The default value is 0, which requires that all records are valid. This setting is ignored for Google Cloud Bigtable, Google Cloud Datastore backups, Avro, ORC and Parquet formats.
    #[serde(default, rename = "maxBadRecords")]
    pub max_bad_records: ::core::option::Option<i32>,
    /// Optional. Metadata Cache Mode for the table. Set this to enable caching of metadata from external data source. // TODO: enum values: ["METADATA_CACHE_MODE_UNSPECIFIED", "AUTOMATIC", "MANUAL"]
    #[serde(default, rename = "metadataCacheMode")]
    pub metadata_cache_mode: ::core::option::Option<String>,
    /// Optional. ObjectMetadata is used to create Object Tables. Object Tables contain a listing of objects (with their metadata) found at the source_uris. If ObjectMetadata is set, source_format should be omitted. Currently SIMPLE is the only supported Object Metadata type. // TODO: enum values: ["OBJECT_METADATA_UNSPECIFIED", "DIRECTORY", "SIMPLE"]
    #[serde(default, rename = "objectMetadata")]
    pub object_metadata: ::core::option::Option<String>,
    /// Optional. Additional properties to set if sourceFormat is set to PARQUET.
    #[serde(default, rename = "parquetOptions")]
    pub parquet_options: ::core::option::Option<::std::boxed::Box<ParquetOptions>>,
    ...
    #[serde(default, rename = "referenceFileSchemaUri")]
    pub reference_file_schema_uri: ::core::option::Option<String>,
    ...
    #[serde(default)]
    pub schema: ::core::option::Option<::std::boxed::Box<TableSchema>>,
    ...
    #[serde(default, rename = "sourceUris")]
    pub source_uris: ::core::option::Option<::std::vec::Vec<String>>,
    ...
    #[serde(default, rename = "timestampFormat")]
    pub timestamp_format: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "timestampTargetPrecision")]
...
pub struct FeatureValue {
    ...
    pub categorical_value: ::core::option::Option<::std::boxed::Box<CategoricalValue>>,
...
pub struct GenAiFunctionStats {
    ...
    pub cost_optimization_stats:
        ::core::option::Option<::std::boxed::Box<GenAiFunctionCostOptimizationStats>>,
    /// Error stats for the function.
    #[serde(default, rename = "errorStats")]
    pub error_stats: ::core::option::Option<::std::boxed::Box<GenAiFunctionErrorStats>>,
...
pub struct GenAiStats {
    ...
    #[serde(default, rename = "errorStats")]
    pub error_stats: ::core::option::Option<::std::boxed::Box<GenAiErrorStats>>,
    ...
    pub function_stats:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GenAiFunctionStats>>>,
}
...
pub struct GeneratedColumn {
    ...
    pub generated_expression_info:
        ::core::option::Option<::std::boxed::Box<GeneratedExpressionInfo>>,
...
pub struct GetQueryResultsResponse {
    ...
    #[serde(default)]
    pub errors: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ErrorProto>>>,
    ...
    pub job_reference: ::core::option::Option<::std::boxed::Box<JobReference>>,
    ...
    #[serde(default)]
    pub rows: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TableRow>>>,
...
pub struct GlobalExplanation {
    ...
    #[serde(default)]
    pub explanations: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Explanation>>>,
}
...
pub struct HparamSearchSpaces {
    ...
    pub activation_fn: ::core::option::Option<::std::boxed::Box<StringHparamSearchSpace>>,
    /// Mini batch sample size.
    #[serde(default, rename = "batchSize")]
    pub batch_size: ::core::option::Option<::std::boxed::Box<IntHparamSearchSpace>>,
    /// Booster type for boosted tree models.
    #[serde(default, rename = "boosterType")]
    pub booster_type: ::core::option::Option<::std::boxed::Box<StringHparamSearchSpace>>,
    /// Subsample ratio of columns for each level for boosted tree models.
    #[serde(default, rename = "colsampleBylevel")]
    pub colsample_bylevel: ::core::option::Option<::std::boxed::Box<DoubleHparamSearchSpace>>,
    /// Subsample ratio of columns for each node(split) for boosted tree models.
    #[serde(default, rename = "colsampleBynode")]
    pub colsample_bynode: ::core::option::Option<::std::boxed::Box<DoubleHparamSearchSpace>>,
    /// Subsample ratio of columns when constructing each tree for boosted tree models.
    #[serde(default, rename = "colsampleBytree")]
    pub colsample_bytree: ::core::option::Option<::std::boxed::Box<DoubleHparamSearchSpace>>,
    /// Dart normalization type for boosted tree models.
    #[serde(default, rename = "dartNormalizeType")]
    pub dart_normalize_type: ::core::option::Option<::std::boxed::Box<StringHparamSearchSpace>>,
    /// Dropout probability for dnn model training and boosted tree models using dart booster.
    #[serde(default)]
    pub dropout: ::core::option::Option<::std::boxed::Box<DoubleHparamSearchSpace>>,
    /// Hidden units for neural network models.
    #[serde(default, rename = "hiddenUnits")]
    pub hidden_units: ::core::option::Option<::std::boxed::Box<IntArrayHparamSearchSpace>>,
    /// L1 regularization coefficient.
    #[serde(default, rename = "l1Reg")]
    pub l1_reg: ::core::option::Option<::std::boxed::Box<DoubleHparamSearchSpace>>,
    /// L2 regularization coefficient.
    #[serde(default, rename = "l2Reg")]
    pub l2_reg: ::core::option::Option<::std::boxed::Box<DoubleHparamSearchSpace>>,
    /// Learning rate of training jobs.
    #[serde(default, rename = "learnRate")]
    pub learn_rate: ::core::option::Option<::std::boxed::Box<DoubleHparamSearchSpace>>,
    /// Maximum depth of a tree for boosted tree models.
    #[serde(default, rename = "maxTreeDepth")]
    pub max_tree_depth: ::core::option::Option<::std::boxed::Box<IntHparamSearchSpace>>,
    /// Minimum split loss for boosted tree models.
    #[serde(default, rename = "minSplitLoss")]
    pub min_split_loss: ::core::option::Option<::std::boxed::Box<DoubleHparamSearchSpace>>,
    /// Minimum sum of instance weight needed in a child for boosted tree models.
    #[serde(default, rename = "minTreeChildWeight")]
    pub min_tree_child_weight: ::core::option::Option<::std::boxed::Box<IntHparamSearchSpace>>,
    /// Number of clusters for k-means.
    #[serde(default, rename = "numClusters")]
    pub num_clusters: ::core::option::Option<::std::boxed::Box<IntHparamSearchSpace>>,
    /// Number of latent factors to train on.
    #[serde(default, rename = "numFactors")]
    pub num_factors: ::core::option::Option<::std::boxed::Box<IntHparamSearchSpace>>,
    /// Number of parallel trees for boosted tree models.
    #[serde(default, rename = "numParallelTree")]
    pub num_parallel_tree: ::core::option::Option<::std::boxed::Box<IntHparamSearchSpace>>,
    /// Optimizer of TF models.
    #[serde(default)]
    pub optimizer: ::core::option::Option<::std::boxed::Box<StringHparamSearchSpace>>,
    /// Subsample the training data to grow tree to prevent overfitting for boosted tree models.
    #[serde(default)]
    pub subsample: ::core::option::Option<::std::boxed::Box<DoubleHparamSearchSpace>>,
    /// Tree construction algorithm for boosted tree models.
    #[serde(default, rename = "treeMethod")]
    pub tree_method: ::core::option::Option<::std::boxed::Box<StringHparamSearchSpace>>,
    /// Hyperparameter for matrix factoration when implicit feedback type is specified.
    #[serde(default, rename = "walsAlpha")]
    pub wals_alpha: ::core::option::Option<::std::boxed::Box<DoubleHparamSearchSpace>>,
}
...
pub struct HparamTuningTrial {
    ...
    pub evaluation_metrics: ::core::option::Option<::std::boxed::Box<EvaluationMetrics>>,
    ...
    pub hparam_tuning_evaluation_metrics:
        ::core::option::Option<::std::boxed::Box<EvaluationMetrics>>,
    /// The hyperprameters selected for this trial.
    #[serde(default)]
    pub hparams: ::core::option::Option<::std::boxed::Box<TrainingOptions>>,
...
pub struct IndexPruningStats {
    ...
    pub base_table: ::core::option::Option<::std::boxed::Box<TableReference>>,
    /// The index id.
...
pub struct IntArrayHparamSearchSpace {
    ...
    #[serde(default)]
    pub candidates: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<IntArray>>>,
}
...
pub struct IntHparamSearchSpace {
    ...
    #[serde(default)]
    pub candidates: ::core::option::Option<::std::boxed::Box<IntCandidates>>,
    /// Range of the int hyperparameter.
    #[serde(default)]
    pub range: ::core::option::Option<::std::boxed::Box<IntRange>>,
}
...
pub struct IterationResult {
    ...
    pub arima_result: ::core::option::Option<::std::boxed::Box<ArimaResult>>,
    /// Information about top clusters for clustering models.
    #[serde(default, rename = "clusterInfos")]
    pub cluster_infos: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ClusterInfo>>>,
    ...
    pub principal_component_infos:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PrincipalComponentInfo>>>,
...
pub struct Job {
    ...
    #[serde(default)]
    pub configuration: ::core::option::Option<::std::boxed::Box<JobConfiguration>>,
    ...
    pub job_creation_reason: ::core::option::Option<::std::boxed::Box<JobCreationReason>>,
    ...
    #[serde(default)]
    pub statistics: ::core::option::Option<::std::boxed::Box<JobStatistics>>,
...
pub struct JobConfiguration {
    ...
    #[serde(default)]
    pub copy: ::core::option::Option<::std::boxed::Box<JobConfigurationTableCopy>>,
    /// Optional. If set, don''t actually run this job. A valid query will return a mostly empty response with some processing statistics, while an invalid query will return the same error it would if it wasn''t a dry run. Behavior of non-query jobs is undefined.
    #[serde(default, rename = "dryRun")]
    pub dry_run: ::core::option::Option<bool>,
    /// [Pick one] Configures an extract job.
    #[serde(default)]
    pub extract: ::core::option::Option<::std::boxed::Box<JobConfigurationExtract>>,
    ...
    #[serde(default)]
    pub load: ::core::option::Option<::std::boxed::Box<JobConfigurationLoad>>,
    ...
    #[serde(default)]
    pub query: ::core::option::Option<::std::boxed::Box<JobConfigurationQuery>>,
...
pub struct JobConfigurationExtract {
    ...
    #[serde(default, rename = "destinationFormat")]
    pub destination_format: ::core::option::Option<String>,
    /// [Pick one] DEPRECATED: Use destinationUris instead, passing only one URI as necessary. The fully-qualified Google Cloud Storage URI where the extracted table should be written.
    #[serde(default, rename = "destinationUri")]
    pub destination_uri: ::core::option::Option<String>,
    /// [Pick one] A list of fully-qualified Google Cloud Storage URIs where the extracted table should be written.
    #[serde(default, rename = "destinationUris")]
    pub destination_uris: ::core::option::Option<::std::vec::Vec<String>>,
    ...
    #[serde(default, rename = "modelExtractOptions")]
    pub model_extract_options: ::core::option::Option<::std::boxed::Box<ModelExtractOptions>>,
    /// Optional. Whether to print out a header row in the results. Default is true. Not applicable when extracting models.
    #[serde(default, rename = "printHeader")]
    pub print_header: ::core::option::Option<bool>,
    /// A reference to the model being exported.
    #[serde(default, rename = "sourceModel")]
    pub source_model: ::core::option::Option<::std::boxed::Box<ModelReference>>,
    /// A reference to the table being exported.
    #[serde(default, rename = "sourceTable")]
    pub source_table: ::core::option::Option<::std::boxed::Box<TableReference>>,
...
pub struct JobConfigurationLoad {
    ...
    #[serde(default)]
    pub clustering: ::core::option::Option<::std::boxed::Box<Clustering>>,
    /// Optional. Character map supported for column names in CSV/Parquet loads. Defaults to STRICT and can be overridden by Project Config Service. Using this option with unsupporting load formats will result in an error. // TODO: enum values: ["COLUMN_NAME_CHARACTER_MAP_UNSPECIFIED", "STRICT", "V1", "V2"]
    #[serde(default, rename = "columnNameCharacterMap")]
    pub column_name_character_map: ::core::option::Option<String>,
    ...
    pub connection_properties:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ConnectionProperty>>>,
    ...
    #[serde(default, rename = "copyFilesOnly")]
    ...
    pub destination_table: ::core::option::Option<::std::boxed::Box<TableReference>>,
    /// Optional. [Experimental] Properties with which to create the destination table if it is new.
    #[serde(default, rename = "destinationTableProperties")]
    pub destination_table_properties:
        ::core::option::Option<::std::boxed::Box<DestinationTableProperties>>,
    ...
    #[serde(default, rename = "fieldDelimiter")]
    pub field_delimiter: ::core::option::Option<String>,
    /// Optional. Specifies how source URIs are interpreted for constructing the file set to load. By default, source URIs are expanded against the underlying storage. You can also specify manifest files to control how the file set is constructed. This option is only applicable to object storage systems. // TODO: enum values: ["FILE_SET_SPEC_TYPE_FILE_SYSTEM_MATCH", "FILE_SET_SPEC_TYPE_NEW_LINE_DELIMITED_MANIFEST"]
    #[serde(default, rename = "fileSetSpecType")]
    pub file_set_spec_type: ::core::option::Option<String>,
    /// Optional. When set, configures hive partitioning support. Not all storage formats support hive partitioning -- requesting hive partitioning on an unsupported format will lead to an error, as will providing an invalid specification.
    #[serde(default, rename = "hivePartitioningOptions")]
    ...
    #[serde(default, rename = "projectionFields")]
    pub projection_fields: ::core::option::Option<::std::vec::Vec<String>>,
    /// Optional. The value that is used to quote data sections in a CSV file. BigQuery converts the string to ISO-8859-1 encoding, and then uses the first byte of the encoded string to split the data in its raw, binary state. The default value is a double-quote (''"''). If your data does not contain quoted sections, set the property value to an empty string. If your data contains quoted newline characters, you must also set the allowQuotedNewlines property to true. To include the specific quote character within a quoted value, precede it with an additional matching quote character. For example, if you want to escape the default character '' " '', use '' "" ''. @default "
    #[serde(default)]
    pub quote: ::core::option::Option<String>,
    ...
    pub range_partitioning: ::core::option::Option<::std::boxed::Box<RangePartitioning>>,
    ...
    #[serde(default, rename = "schemaInline")]
    pub schema_inline: ::core::option::Option<String>,
    /// [Deprecated] The format of the schemaInline property.
    #[serde(default, rename = "schemaInlineFormat")]
    pub schema_inline_format: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "schemaUpdateOptions")]
    pub schema_update_options: ::core::option::Option<::std::vec::Vec<String>>,
    ...
    /// Optional. Controls the strategy used to match loaded columns to the schema. If not set, a sensible default is chosen based on how the schema is provided. If autodetect is used, then columns are matched by name. Otherwise, columns are matched by position. This is done to keep the behavior backward-compatible. // TODO: enum values: ["SOURCE_COLUMN_MATCH_UNSPECIFIED", "POSITION", "NAME"]
    #[serde(default, rename = "sourceColumnMatch")]
    pub source_column_match: ::core::option::Option<String>,
    ...
    pub time_partitioning: ::core::option::Option<::std::boxed::Box<TimePartitioning>>,
...
pub struct JobConfigurationQuery {
    ...
    pub default_dataset: ::core::option::Option<::std::boxed::Box<DatasetReference>>,
    /// Custom encryption configuration (e.g., Cloud KMS keys)
    #[serde(default, rename = "destinationEncryptionConfiguration")]
    pub destination_encryption_configuration:
        ::core::option::Option<::std::boxed::Box<EncryptionConfiguration>>,
    ...
    #[serde(default, rename = "flattenResults")]
    ...
    #[serde(default, rename = "maximumBillingTier")]
    pub maximum_billing_tier: ::core::option::Option<i32>,
    ...
    #[serde(default, rename = "scriptOptions")]
    pub script_options: ::core::option::Option<::std::boxed::Box<ScriptOptions>>,
    ...
    #[serde(default, rename = "systemVariables")]
    pub system_variables: ::core::option::Option<::std::boxed::Box<SystemVariables>>,
    ...
    #[serde(default, rename = "tableDefinitions")]
    pub table_definitions: ::core::option::Option<serde_json::Value>,
    /// Time-based partitioning specification for the destination table. Only one of timePartitioning and rangePartitioning should be specified.
    #[serde(default, rename = "timePartitioning")]
    pub time_partitioning: ::core::option::Option<::std::boxed::Box<TimePartitioning>>,
    ...
    pub user_defined_function_resources:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<UserDefinedFunctionResource>>>,
...
pub struct JobConfigurationTableCopy {
    ...
    pub source_tables: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TableReference>>>,
...
pub struct JobStatistics {
    ...
    #[serde(default)]
    pub copy: ::core::option::Option<::std::boxed::Box<JobStatistics5>>,
    ...
    pub data_masking_statistics: ::core::option::Option<::std::boxed::Box<DataMaskingStatistics>>,
    ...
    #[serde(default)]
    pub extract: ::core::option::Option<::std::boxed::Box<JobStatistics4>>,
    ...
    #[serde(default)]
    pub load: ::core::option::Option<::std::boxed::Box<JobStatistics3>>,
    ...
    #[serde(default)]
    pub query: ::core::option::Option<::std::boxed::Box<JobStatistics2>>,
    ...
    pub row_level_security_statistics:
        ::core::option::Option<::std::boxed::Box<RowLevelSecurityStatistics>>,
    ...
    pub script_statistics: ::core::option::Option<::std::boxed::Box<ScriptStatistics>>,
    /// Output only. Information of the session if this job is part of one.
    #[serde(default, rename = "sessionInfo")]
    pub session_info: ::core::option::Option<::std::boxed::Box<SessionInfo>>,
    ...
    pub transaction_info: ::core::option::Option<::std::boxed::Box<TransactionInfo>>,
}
...
pub struct JobStatistics2 {
    ...
    pub bi_engine_statistics: ::core::option::Option<::std::boxed::Box<BiEngineStatistics>>,
    ...
    #[serde(default, rename = "billingTier")]
    pub billing_tier: ::core::option::Option<i32>,
    /// Output only. Whether the query result was fetched from the query cache.
    #[serde(default, rename = "cacheHit")]
    pub cache_hit: ::core::option::Option<bool>,
    /// Output only. Referenced dataset for DCL statement.
    #[serde(default, rename = "dclTargetDataset")]
    pub dcl_target_dataset: ::core::option::Option<::std::boxed::Box<DatasetReference>>,
    /// Output only. Referenced table for DCL statement.
    #[serde(default, rename = "dclTargetTable")]
    pub dcl_target_table: ::core::option::Option<::std::boxed::Box<TableReference>>,
    /// Output only. Referenced view for DCL statement.
    #[serde(default, rename = "dclTargetView")]
    pub dcl_target_view: ::core::option::Option<::std::boxed::Box<TableReference>>,
    ...
    #[serde(default, rename = "ddlAffectedRowAccessPolicyCount")]
    pub ddl_affected_row_access_policy_count: ::core::option::Option<String>,
    /// Output only. The table after rename. Present only for ALTER TABLE RENAME TO query.
    #[serde(default, rename = "ddlDestinationTable")]
    pub ddl_destination_table: ::core::option::Option<::std::boxed::Box<TableReference>>,
    /// Output only. The DDL operation performed, possibly dependent on the pre-existence of the DDL target.
    #[serde(default, rename = "ddlOperationPerformed")]
    pub ddl_operation_performed: ::core::option::Option<String>,
    /// Output only. The DDL target dataset. Present only for CREATE/ALTER/DROP SCHEMA(dataset) queries.
    #[serde(default, rename = "ddlTargetDataset")]
    pub ddl_target_dataset: ::core::option::Option<::std::boxed::Box<DatasetReference>>,
    /// Output only. [Beta] The DDL target routine. Present only for CREATE/DROP FUNCTION/PROCEDURE queries.
    #[serde(default, rename = "ddlTargetRoutine")]
    pub ddl_target_routine: ::core::option::Option<::std::boxed::Box<RoutineReference>>,
    /// Output only. The DDL target row access policy. Present only for CREATE/DROP ROW ACCESS POLICY queries.
    #[serde(default, rename = "ddlTargetRowAccessPolicy")]
    pub ddl_target_row_access_policy:
        ::core::option::Option<::std::boxed::Box<RowAccessPolicyReference>>,
    /// Output only. The DDL target table. Present only for CREATE/DROP TABLE/VIEW and DROP ALL ROW ACCESS POLICIES queries.
    #[serde(default, rename = "ddlTargetTable")]
    pub ddl_target_table: ::core::option::Option<::std::boxed::Box<TableReference>>,
    /// Output only. Detailed statistics for DML statements INSERT, UPDATE, DELETE, MERGE or TRUNCATE.
    #[serde(default, rename = "dmlStats")]
    pub dml_stats: ::core::option::Option<::std::boxed::Box<DmlStatistics>>,
    /// Output only. The original estimate of bytes processed for the job.
    #[serde(default, rename = "estimatedBytesProcessed")]
    pub estimated_bytes_processed: ::core::option::Option<String>,
    /// Output only. Stats for EXPORT DATA statement.
    #[serde(default, rename = "exportDataStatistics")]
    pub export_data_statistics: ::core::option::Option<::std::boxed::Box<ExportDataStatistics>>,
    /// Output only. Job cost breakdown as bigquery internal cost and external service costs.
    #[serde(default, rename = "externalServiceCosts")]
    pub external_service_costs:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ExternalServiceCost>>>,
    /// Output only. Statistics related to GenAI usage in the query.
    #[serde(default, rename = "genAiStats")]
    pub gen_ai_stats: ::core::option::Option<::std::boxed::Box<GenAiStats>>,
    /// Output only. Statistics related to incremental query results, if enabled for the query. This feature is not yet available.
    #[serde(default, rename = "incrementalResultStats")]
    pub incremental_result_stats: ::core::option::Option<::std::boxed::Box<IncrementalResultStats>>,
    /// Output only. Statistics for a LOAD query.
    #[serde(default, rename = "loadQueryStatistics")]
    pub load_query_statistics: ::core::option::Option<::std::boxed::Box<LoadQueryStatistics>>,
    /// Output only. Statistics of materialized views of a query job.
    #[serde(default, rename = "materializedViewStatistics")]
    pub materialized_view_statistics:
        ::core::option::Option<::std::boxed::Box<MaterializedViewStatistics>>,
    /// Output only. Statistics of metadata cache usage in a query for BigLake tables.
    #[serde(default, rename = "metadataCacheStatistics")]
    pub metadata_cache_statistics:
        ::core::option::Option<::std::boxed::Box<MetadataCacheStatistics>>,
    /// Output only. Statistics of a BigQuery ML training job.
    #[serde(default, rename = "mlStatistics")]
    pub ml_statistics: ::core::option::Option<::std::boxed::Box<MlStatistics>>,
    /// Deprecated.
    #[serde(default, rename = "modelTraining")]
    pub model_training: ::core::option::Option<::std::boxed::Box<BigQueryModelTraining>>,
    /// Deprecated.
    #[serde(default, rename = "modelTrainingCurrentIteration")]
    pub model_training_current_iteration: ::core::option::Option<i32>,
    /// Deprecated.
    #[serde(default, rename = "modelTrainingExpectedTotalIteration")]
    pub model_training_expected_total_iteration: ::core::option::Option<String>,
    /// Output only. The number of rows affected by a DML statement. Present only for DML statements INSERT, UPDATE or DELETE.
    #[serde(default, rename = "numDmlAffectedRows")]
    pub num_dml_affected_rows: ::core::option::Option<String>,
    /// Output only. Performance insights.
    #[serde(default, rename = "performanceInsights")]
    pub performance_insights: ::core::option::Option<::std::boxed::Box<PerformanceInsights>>,
    /// Output only. Query optimization information for a QUERY job.
    #[serde(default, rename = "queryInfo")]
    pub query_info: ::core::option::Option<::std::boxed::Box<QueryInfo>>,
    /// Output only. Describes execution plan for the query.
    #[serde(default, rename = "queryPlan")]
    pub query_plan: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ExplainQueryStage>>>,
    ...
    #[serde(default, rename = "referencedPropertyGraphs")]
    pub referenced_property_graphs:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PropertyGraphReference>>>,
    /// Output only. Referenced routines for the job.
    #[serde(default, rename = "referencedRoutines")]
    pub referenced_routines:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<RoutineReference>>>,
    /// Output only. Referenced tables for the job.
    #[serde(default, rename = "referencedTables")]
    ...
    #[serde(default, rename = "searchStatistics")]
    pub search_statistics: ::core::option::Option<::std::boxed::Box<SearchStatistics>>,
    /// Output only. Statistics of a Spark procedure job.
    #[serde(default, rename = "sparkStatistics")]
    pub spark_statistics: ::core::option::Option<::std::boxed::Box<SparkStatistics>>,
    ...
    #[serde(default, rename = "statementType")]
    pub statement_type: ::core::option::Option<String>,
    /// Output only. Describes a timeline of job execution.
    #[serde(default)]
    pub timeline: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<QueryTimelineSample>>>,
    ...
    #[serde(default, rename = "totalBytesProcessedAccuracy")]
    pub total_bytes_processed_accuracy: ::core::option::Option<String>,
    /// Output only. Total number of partitions processed from all partitioned tables referenced in the job.
    #[serde(default, rename = "totalPartitionsProcessed")]
    pub total_partitions_processed: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "totalServicesSkuSlotMs")]
    pub total_services_sku_slot_ms: ::core::option::Option<String>,
    /// Output only. Slot-milliseconds for the job.
    #[serde(default, rename = "totalSlotMs")]
    pub total_slot_ms: ::core::option::Option<String>,
    /// Output only. Total bytes transferred for cross-cloud queries such as Cross Cloud Transfer and CREATE TABLE AS SELECT (CTAS).
    #[serde(default, rename = "transferredBytes")]
    pub transferred_bytes: ::core::option::Option<String>,
    /// Output only. GoogleSQL only: list of undeclared query parameters detected during a dry run validation.
    #[serde(default, rename = "undeclaredQueryParameters")]
    pub undeclared_query_parameters:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<QueryParameter>>>,
    /// Output only. Vector Search query specific statistics.
    #[serde(default, rename = "vectorSearchStatistics")]
    pub vector_search_statistics: ::core::option::Option<::std::boxed::Box<VectorSearchStatistics>>,
}
...
pub struct JobStatus {
    ...
    pub error_result: ::core::option::Option<::std::boxed::Box<ErrorProto>>,
...
pub struct JoinRestrictionPolicy {
    ...
    pub join_allowed_columns: ::core::option::Option<::std::vec::Vec<String>>,
    /// Optional. Specifies if a join is required or not on queries for the view. Default is JOIN_CONDITION_UNSPECIFIED. // TODO: enum values: ["JOIN_CONDITION_UNSPECIFIED", "JOIN_ANY", "JOIN_ALL", "JOIN_NOT_REQUIRED", "JOIN_BLOCKED"]
    #[serde(default, rename = "joinCondition")]
...
pub struct LinkedDatasetSource {
    ...
    pub source_dataset: ::core::option::Option<::std::boxed::Box<DatasetReference>>,
}
...
pub struct ListModelsResponse {
    ...
    #[serde(default)]
    pub models: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Model>>>,
    /// A token to request the next page of results.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct ListRoutinesResponse {
    ...
    #[serde(default)]
    pub routines: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Routine>>>,
}
...
pub struct ListRowAccessPoliciesResponse {
    ...
    pub row_access_policies:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<RowAccessPolicy>>>,
}
...
pub struct LoadQueryStatistics {
    ...
    pub bytes_transferred: ::core::option::Option<String>,
...
pub struct MaterializedView {
    ...
    pub table_reference: ::core::option::Option<::std::boxed::Box<TableReference>>,
}
...
pub struct MaterializedViewStatistics {
    ...
    pub materialized_view:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<MaterializedView>>>,
}
...
pub struct MaterializedViewStatus {
    ...
    pub last_refresh_status: ::core::option::Option<::std::boxed::Box<ErrorProto>>,
...
pub struct MetadataCacheStatistics {
    ...
    pub table_metadata_cache_usage:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TableMetadataCacheUsage>>>,
}
...
pub struct MlStatistics {
    ...
    pub hparam_trials:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<HparamTuningTrial>>>,
    ...
    #[serde(default, rename = "iterationResults")]
    pub iteration_results:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<IterationResult>>>,
...
pub struct Model {
    ...
    pub feature_columns:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<StandardSqlField>>>,
    /// Optional. A descriptive name for this model.
    #[serde(default, rename = "friendlyName")]
    pub friendly_name: ::core::option::Option<String>,
    /// Output only. All hyperparameter search spaces in this model.
    #[serde(default, rename = "hparamSearchSpaces")]
    pub hparam_search_spaces: ::core::option::Option<::std::boxed::Box<HparamSearchSpaces>>,
    ...
    pub label_columns: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<StandardSqlField>>>,
    ...
    pub model_reference: ::core::option::Option<::std::boxed::Box<ModelReference>>,
    ...
    pub remote_model_info: ::core::option::Option<::std::boxed::Box<RemoteModelInfo>>,
    /// Information for all training runs in increasing order of start_time.
    #[serde(default, rename = "trainingRuns")]
    pub training_runs: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TrainingRun>>>,
    ...
    pub transform_columns:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TransformColumn>>>,
}
...
pub struct ModelDefinition {
    ...
    /// Deprecated.
    #[serde(default, rename = "trainingRuns")]
    pub training_runs: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<BqmlTrainingRun>>>,
}
...
pub struct MultiClassClassificationMetrics {
    ...
    pub confusion_matrix_list:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ConfusionMatrix>>>,
}
...
pub struct PartitionSkew {
    ...
    pub skew_sources: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SkewSource>>>,
}
...
pub struct PartitioningDefinition {
    ...
    pub partitioned_column:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PartitionedColumn>>>,
}
...
pub struct PerformanceInsights {
    ...
    pub avg_previous_execution_ms: ::core::option::Option<String>,
    /// Output only. Query stage performance insights compared to previous runs, for diagnosing performance regression.
    #[serde(default, rename = "stagePerformanceChangeInsights")]
    pub stage_performance_change_insights:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<StagePerformanceChangeInsight>>>,
    ...
    pub stage_performance_standalone_insights: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<StagePerformanceStandaloneInsight>>,
    >,
}
...
pub struct PrivacyPolicy {
    ...
    pub aggregation_threshold_policy:
        ::core::option::Option<::std::boxed::Box<AggregationThresholdPolicy>>,
    /// Optional. Policy used for differential privacy.
    #[serde(default, rename = "differentialPrivacyPolicy")]
    pub differential_privacy_policy:
        ::core::option::Option<::std::boxed::Box<DifferentialPrivacyPolicy>>,
    ...
    pub join_restriction_policy: ::core::option::Option<::std::boxed::Box<JoinRestrictionPolicy>>,
}
...
pub struct PropertyGraphReference {
    ...
    #[serde(default, rename = "propertyGraphId")]
...
pub struct QueryParameterValue {
    ...
    pub array_values:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<QueryParameterValue>>>,
...
pub struct QueryRequest {
    ...
    pub format_options: ::core::option::Option<::std::boxed::Box<DataFormatOptions>>,
...
pub struct QueryTimelineSample {
    ...
    pub active_units: ::core::option::Option<String>,
    /// Total parallel units of work completed by this query.
    #[serde(default, rename = "completedUnits")]
    pub completed_units: ::core::option::Option<String>,
    /// Milliseconds elapsed since the start of query execution.
    #[serde(default, rename = "elapsedMs")]
    pub elapsed_ms: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "estimatedRunnableUnits")]
    pub estimated_runnable_units: ::core::option::Option<String>,
    /// Total units of work remaining for the query. This number can be revised (increased or decreased) while the query is running.
    #[serde(default, rename = "pendingUnits")]
    pub pending_units: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "shuffleRamUsageRatio")]
...
pub struct Routine {
    /// Optional.
    #[serde(default)]
    pub arguments: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Argument>>>,
    ...
    pub build_status: ::core::option::Option<::std::boxed::Box<RoutineBuildStatus>>,
    ...
    pub external_runtime_options: ::core::option::Option<::std::boxed::Box<ExternalRuntimeOptions>>,
    ...
    pub python_options: ::core::option::Option<::std::boxed::Box<PythonOptions>>,
    /// Optional. Remote function specific options.
    #[serde(default, rename = "remoteFunctionOptions")]
    pub remote_function_options: ::core::option::Option<::std::boxed::Box<RemoteFunctionOptions>>,
    /// Optional. Can be set only if routine_type = "TABLE_VALUED_FUNCTION". If absent, the return table type is inferred from definition_body at query time in each query that references this routine. If present, then the columns in the evaluated table result will be cast to match the column types specified in return table type, at query time.
    #[serde(default, rename = "returnTableType")]
    pub return_table_type: ::core::option::Option<::std::boxed::Box<StandardSqlTableType>>,
    ...
    pub routine_reference: ::core::option::Option<::std::boxed::Box<RoutineReference>>,
    ...
    pub spark_options: ::core::option::Option<::std::boxed::Box<SparkOptions>>,
...
pub struct Row {
    ...
    #[serde(default)]
    pub entries: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Entry>>>,
}
...
pub struct ScriptStackFrame {
    ...
    pub end_column: ::core::option::Option<i32>,
    /// Output only. One-based end line.
    #[serde(default, rename = "endLine")]
    pub end_line: ::core::option::Option<i32>,
    /// Output only. Name of the active procedure, empty if in a top-level script.
    #[serde(default, rename = "procedureId")]
    pub procedure_id: ::core::option::Option<String>,
...
pub struct ScriptStatistics {
    ...
    pub stack_frames: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ScriptStackFrame>>>,
}
...
pub struct SearchStatistics {
    ...
    pub index_pruning_stats:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<IndexPruningStats>>>,
    ...
    pub index_unused_reasons:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<IndexUnusedReason>>>,
...
pub struct SparkStatistics {
    ...
    pub logging_info: ::core::option::Option<::std::boxed::Box<SparkLoggingInfo>>,
...
pub struct StagePerformanceChangeInsight {
    ...
    pub input_data_change: ::core::option::Option<::std::boxed::Box<InputDataChange>>,
...
pub struct StagePerformanceStandaloneInsight {
    ...
    #[serde(default, rename = "highCardinalityJoins")]
    pub high_cardinality_joins:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<HighCardinalityJoin>>>,
    /// Output only. True if the stage has insufficient shuffle quota.
    #[serde(default, rename = "insufficientShuffleQuota")]
    pub insufficient_shuffle_quota: ::core::option::Option<bool>,
    /// Output only. Partition skew in the stage.
    #[serde(default, rename = "partitionSkew")]
    pub partition_skew: ::core::option::Option<::std::boxed::Box<PartitionSkew>>,
    /// Output only. True if the stage has a slot contention issue.
    #[serde(default, rename = "slotContention")]
...
pub struct StandardSqlStructType {
    ...
    #[serde(default)]
    pub fields: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<StandardSqlField>>>,
}
...
pub struct StandardSqlTableType {
    ...
    #[serde(default)]
    pub columns: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<StandardSqlField>>>,
}
...
pub struct StorageDescriptor {
    ...
    pub serde_info: ::core::option::Option<::std::boxed::Box<SerDeInfo>>,
}
...
pub struct StoredColumnsUsage {
    ...
    pub stored_columns_unused_reasons:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<StoredColumnsUnusedReason>>>,
}
...
pub struct Table {
    ...
    pub biglake_configuration: ::core::option::Option<::std::boxed::Box<BigLakeConfiguration>>,
    ...
    pub clone_definition: ::core::option::Option<::std::boxed::Box<CloneDefinition>>,
    ...
    pub external_catalog_table_options:
        ::core::option::Option<::std::boxed::Box<ExternalCatalogTableOptions>>,
    /// Optional. Describes the data format, location, and other properties of a table stored outside of BigQuery. By defining these properties, the data source can then be queried as if it were a standard BigQuery table.
    #[serde(default, rename = "externalDataConfiguration")]
    pub external_data_configuration:
        ::core::option::Option<::std::boxed::Box<ExternalDataConfiguration>>,
    ...
    #[serde(default, rename = "materializedView")]
    pub materialized_view: ::core::option::Option<::std::boxed::Box<MaterializedViewDefinition>>,
    /// Output only. The materialized view status.
    #[serde(default, rename = "materializedViewStatus")]
    pub materialized_view_status: ::core::option::Option<::std::boxed::Box<MaterializedViewStatus>>,
    ...
    /// Deprecated.
    #[serde(default)]
    pub model: ::core::option::Option<::std::boxed::Box<ModelDefinition>>,
    ...
    pub partition_definition: ::core::option::Option<::std::boxed::Box<PartitioningDefinition>>,
    /// If specified, configures range partitioning for this table.
    #[serde(default, rename = "rangePartitioning")]
    pub range_partitioning: ::core::option::Option<::std::boxed::Box<RangePartitioning>>,
    /// Optional. Output only. Table references of all replicas currently active on the table.
    #[serde(default)]
    pub replicas: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TableReference>>>,
    ...
    pub snapshot_definition: ::core::option::Option<::std::boxed::Box<SnapshotDefinition>>,
    /// Output only. Contains information regarding this table''s streaming buffer, if one is present. This field will be absent if the table is not being streamed to or if there is no data in the streaming buffer.
    #[serde(default, rename = "streamingBuffer")]
    pub streaming_buffer: ::core::option::Option<::std::boxed::Box<Streamingbuffer>>,
    /// Optional. Tables Primary Key and Foreign Key information
    #[serde(default, rename = "tableConstraints")]
    pub table_constraints: ::core::option::Option<::std::boxed::Box<TableConstraints>>,
    ...
    pub table_replication_info: ::core::option::Option<::std::boxed::Box<TableReplicationInfo>>,
    ...
    #[serde(default)]
    pub view: ::core::option::Option<::std::boxed::Box<ViewDefinition>>,
}
...
pub struct TableFieldSchema {
    /// Deprecated.
    #[serde(default)]
    pub categories: ::core::option::Option<serde_json::Value>,
    ...
    pub data_policies: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DataPolicyOption>>>,
    /// Optional. A SQL expression to specify the [default value] (https://cloud.google.com/bigquery/docs/default-values) for this field.
    #[serde(default, rename = "defaultValueExpression")]
    pub default_value_expression: ::core::option::Option<String>,
    /// Optional. The field description. The maximum length is 1,024 characters.
    #[serde(default)]
    pub description: ::core::option::Option<String>,
    /// Optional. Describes the nested schema fields if the type property is set to RECORD.
    #[serde(default)]
    pub fields: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TableFieldSchema>>>,
    ...
    /// Optional. Definition of how values are generated for the field. Only valid for top-level schema fields (not nested fields).
    #[serde(default, rename = "generatedColumn")]
    pub generated_column: ::core::option::Option<::std::boxed::Box<GeneratedColumn>>,
    /// Optional. Maximum length of values of this field for STRINGS or BYTES. If max_length is not specified, no maximum length constraint is imposed on this field. If type = "STRING", then max_length represents the maximum UTF-8 length of strings in this field. If type = "BYTES", then max_length represents the maximum number of bytes in this field. It is invalid to set this field if type ≠ "STRING" and ≠ "BYTES".
    #[serde(default, rename = "maxLength")]
    pub max_length: ::core::option::Option<String>,
    ...
    pub policy_tags: ::core::option::Option<serde_json::Value>,
    ...
    #[serde(default)]
    pub precision: ::core::option::Option<String>,
    /// Represents the type of a field element.
    #[serde(default, rename = "rangeElementType")]
    pub range_element_type: ::core::option::Option<serde_json::Value>,
    /// Optional. Specifies the rounding mode to be used when storing values of NUMERIC and BIGNUMERIC type. // TODO: enum values: ["ROUNDING_MODE_UNSPECIFIED", "ROUND_HALF_AWAY_FROM_ZERO", "ROUND_HALF_EVEN"]
    #[serde(default, rename = "roundingMode")]
    pub rounding_mode: ::core::option::Option<String>,
    /// Optional. See documentation for precision.
    #[serde(default)]
    pub scale: ::core::option::Option<String>,
    /// Optional. Precision (maximum number of total digits in base 10) for seconds of TIMESTAMP type. Possible values include: * 6 (Default, for TIMESTAMP type with microsecond precision) * 12 (For TIMESTAMP type with picosecond precision)
    #[serde(default, rename = "timestampPrecision")]
    pub timestamp_precision: ::core::option::Option<String>,
...
pub struct TableMetadataCacheUsage {
    ...
    pub pruning_stats: ::core::option::Option<::std::boxed::Box<PruningStats>>,
...
pub struct TableReplicationInfo {
    ...
    pub replication_error: ::core::option::Option<::std::boxed::Box<ErrorProto>>,
...
pub struct TableRow {
    ...
    #[serde(default)]
    pub f: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TableCell>>>,
}
...
pub struct TableSchema {
    ...
    pub foreign_type_info: ::core::option::Option<::std::boxed::Box<ForeignTypeInfo>>,
}
...
pub struct TrainingOptions {
    ...
    #[serde(default, rename = "activationFn")]
    pub activation_fn: ::core::option::Option<String>,
    /// If true, detect step changes and make data adjustment in the input time series.
    #[serde(default, rename = "adjustStepChanges")]
    ...
    #[serde(default, rename = "approxGlobalFeatureContrib")]
    pub approx_global_feature_contrib: ::core::option::Option<bool>,
    /// Whether to enable auto ARIMA or not.
    #[serde(default, rename = "autoArima")]
    pub auto_arima: ::core::option::Option<bool>,
    /// The max value of the sum of non-seasonal p and q.
    #[serde(default, rename = "autoArimaMaxOrder")]
    pub auto_arima_max_order: ::core::option::Option<String>,
    /// The min value of the sum of non-seasonal p and q.
    #[serde(default, rename = "autoArimaMinOrder")]
    pub auto_arima_min_order: ::core::option::Option<String>,
    /// Whether to calculate class weights automatically based on the popularity of each label.
    #[serde(default, rename = "autoClassWeights")]
    pub auto_class_weights: ::core::option::Option<bool>,
    /// Batch size for dnn models.
    #[serde(default, rename = "batchSize")]
    pub batch_size: ::core::option::Option<String>,
    /// Booster type for boosted tree models. // TODO: enum values: ["BOOSTER_TYPE_UNSPECIFIED", "GBTREE", "DART"]
    #[serde(default, rename = "boosterType")]
    pub booster_type: ::core::option::Option<String>,
    /// Budget in hours for AutoML training.
    #[serde(default, rename = "budgetHours")]
    pub budget_hours: ::core::option::Option<f64>,
    /// Whether or not p-value test should be computed for this model. Only available for linear and logistic regression models.
    #[serde(default, rename = "calculatePValues")]
    pub calculate_p_values: ::core::option::Option<bool>,
    /// Categorical feature encoding method. // TODO: enum values: ["ENCODING_METHOD_UNSPECIFIED", "ONE_HOT_ENCODING", "LABEL_ENCODING", "DUMMY_ENCODING"]
    #[serde(default, rename = "categoryEncodingMethod")]
    pub category_encoding_method: ::core::option::Option<String>,
    /// If true, clean spikes and dips in the input time series.
    #[serde(default, rename = "cleanSpikesAndDips")]
    pub clean_spikes_and_dips: ::core::option::Option<bool>,
    /// Enums for color space, used for processing images in Object Table. See more details at https://www.tensorflow.org/io/tutorials/colorspace. // TODO: enum values: ["COLOR_SPACE_UNSPECIFIED", "RGB", "HSV", "YIQ", "YUV", "GRAYSCALE"]
    #[serde(default, rename = "colorSpace")]
    pub color_space: ::core::option::Option<String>,
    /// Subsample ratio of columns for each level for boosted tree models.
    #[serde(default, rename = "colsampleBylevel")]
    ...
    #[serde(default, rename = "contributionMetric")]
    pub contribution_metric: ::core::option::Option<String>,
    /// Type of normalization algorithm for boosted tree models using dart booster. // TODO: enum values: ["DART_NORMALIZE_TYPE_UNSPECIFIED", "TREE", "FOREST"]
    #[serde(default, rename = "dartNormalizeType")]
    pub dart_normalize_type: ::core::option::Option<String>,
    /// The data frequency of a time series. // TODO: enum values: ["DATA_FREQUENCY_UNSPECIFIED", "AUTO_FREQUENCY", "YEARLY", "QUARTERLY", "MONTHLY", "WEEKLY", "DAILY", "HOURLY", "PER_MINUTE"]
    #[serde(default, rename = "dataFrequency")]
    pub data_frequency: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "dataSplitColumn")]
    pub data_split_column: ::core::option::Option<String>,
    /// The fraction of evaluation data over the whole input data. The rest of data will be used as training data. The format should be double. Accurate to two decimal places. Default value is 0.2.
    #[serde(default, rename = "dataSplitEvalFraction")]
    pub data_split_eval_fraction: ::core::option::Option<f64>,
    /// The data split type for training and evaluation, e.g. RANDOM. // TODO: enum values: ["DATA_SPLIT_METHOD_UNSPECIFIED", "RANDOM", "CUSTOM", "SEQUENTIAL", "NO_SPLIT", "AUTO_SPLIT"]
    #[serde(default, rename = "dataSplitMethod")]
    pub data_split_method: ::core::option::Option<String>,
    /// If true, perform decompose time series and save the results.
    #[serde(default, rename = "decomposeTimeSeries")]
    ...
    #[serde(default, rename = "dimensionIdColumns")]
    pub dimension_id_columns: ::core::option::Option<::std::vec::Vec<String>>,
    /// Distance type for clustering models. // TODO: enum values: ["DISTANCE_TYPE_UNSPECIFIED", "EUCLIDEAN", "COSINE"]
    #[serde(default, rename = "distanceType")]
    pub distance_type: ::core::option::Option<String>,
    /// Dropout probability for dnn models.
    #[serde(default)]
    pub dropout: ::core::option::Option<f64>,
    /// Whether to stop early when the loss doesn''t improve significantly any more (compared to min_relative_progress). Used only for iterative training algorithms.
    #[serde(default, rename = "earlyStop")]
    pub early_stop: ::core::option::Option<bool>,
    /// If true, enable global explanation during training.
    #[serde(default, rename = "enableGlobalExplain")]
    ...
    #[serde(default, rename = "endpointIdleTtl")]
    pub endpoint_idle_ttl: ::core::option::Option<String>,
    /// Feedback type that specifies which algorithm to run for matrix factorization. // TODO: enum values: ["FEEDBACK_TYPE_UNSPECIFIED", "IMPLICIT", "EXPLICIT"]
    #[serde(default, rename = "feedbackType")]
    pub feedback_type: ::core::option::Option<String>,
    /// Whether the model should include intercept during model training.
    #[serde(default, rename = "fitIntercept")]
    ...
    #[serde(default, rename = "forecastLimitLowerBound")]
    pub forecast_limit_lower_bound: ::core::option::Option<f64>,
    /// The forecast limit upper bound that was used during ARIMA model training with limits.
    #[serde(default, rename = "forecastLimitUpperBound")]
    pub forecast_limit_upper_bound: ::core::option::Option<f64>,
    /// Hidden units for dnn models.
    #[serde(default, rename = "hiddenUnits")]
    pub hidden_units: ::core::option::Option<::std::vec::Vec<String>>,
    /// The geographical region based on which the holidays are considered in time series modeling. If a valid value is specified, then holiday effects modeling is enabled. // TODO: enum values: ["HOLIDAY_REGION_UNSPECIFIED", "GLOBAL", "NA", "JAPAC", "EMEA", "LAC", "AE", "AR", "AT", "AU", "BE", "BR", "CA", "CH", "CL", "CN", "CO", "CS", "CZ", "DE", "DK", "DZ", "EC", "EE", "EG", "ES", "FI", "FR", "GB", "GR", "HK", "HU", "ID", "IE", "IL", "IN", "IR", "IT", "JP", "KR", "LV", "MA", "MX", "MY", "NG", "NL", "NO", "NZ", "PE", "PH", "PK", "PL", "PT", "RO", "RS", "RU", "SA", "SE", "SG", "SI", "SK", "TH", "TR", "TW", "UA", "US", "VE", "VN", "ZA"]
    #[serde(default, rename = "holidayRegion")]
    pub holiday_region: ::core::option::Option<String>,
    /// A list of geographical regions that are used for time series modeling.
    #[serde(default, rename = "holidayRegions")]
    pub holiday_regions: ::core::option::Option<::std::vec::Vec<String>>,
    /// The number of periods ahead that need to be forecasted.
    #[serde(default)]
    pub horizon: ::core::option::Option<String>,
    /// The target evaluation metrics to optimize the hyperparameters for.
    #[serde(default, rename = "hparamTuningObjectives")]
    pub hparam_tuning_objectives: ::core::option::Option<::std::vec::Vec<String>>,
    /// The id of a Hugging Face model. For example, google/gemma-2-2b-it.
    #[serde(default, rename = "huggingFaceModelId")]
    pub hugging_face_model_id: ::core::option::Option<String>,
    /// Include drift when fitting an ARIMA model.
    #[serde(default, rename = "includeDrift")]
    pub include_drift: ::core::option::Option<bool>,
    /// Specifies the initial learning rate for the line search learn rate strategy.
    #[serde(default, rename = "initialLearnRate")]
    pub initial_learn_rate: ::core::option::Option<f64>,
    /// Name of input label columns in training data.
    #[serde(default, rename = "inputLabelColumns")]
    pub input_label_columns: ::core::option::Option<::std::vec::Vec<String>>,
    /// Name of the instance weight column for training data. This column isn''t be used as a feature.
    #[serde(default, rename = "instanceWeightColumn")]
    pub instance_weight_column: ::core::option::Option<String>,
    /// Number of integral steps for the integrated gradients explain method.
    #[serde(default, rename = "integratedGradientsNumSteps")]
    pub integrated_gradients_num_steps: ::core::option::Option<String>,
    /// Name of the column used to determine the rows corresponding to control and test. Applies to contribution analysis models.
    #[serde(default, rename = "isTestColumn")]
    pub is_test_column: ::core::option::Option<String>,
    /// Item column specified for matrix factorization models.
    #[serde(default, rename = "itemColumn")]
    pub item_column: ::core::option::Option<String>,
    /// The column used to provide the initial centroids for kmeans algorithm when kmeans_initialization_method is CUSTOM.
    #[serde(default, rename = "kmeansInitializationColumn")]
    pub kmeans_initialization_column: ::core::option::Option<String>,
    /// The method used to initialize the centroids for kmeans algorithm. // TODO: enum values: ["KMEANS_INITIALIZATION_METHOD_UNSPECIFIED", "RANDOM", "CUSTOM", "KMEANS_PLUS_PLUS"]
    #[serde(default, rename = "kmeansInitializationMethod")]
    pub kmeans_initialization_method: ::core::option::Option<String>,
    /// L1 regularization coefficient to activations.
    #[serde(default, rename = "l1RegActivation")]
    pub l1_reg_activation: ::core::option::Option<f64>,
    /// L1 regularization coefficient.
    #[serde(default, rename = "l1Regularization")]
    pub l1_regularization: ::core::option::Option<f64>,
    /// L2 regularization coefficient.
    #[serde(default, rename = "l2Regularization")]
    pub l2_regularization: ::core::option::Option<f64>,
    /// Weights associated with each label class, for rebalancing the training data. Only applicable for classification models.
    #[serde(default, rename = "labelClassWeights")]
    pub label_class_weights: ::core::option::Option<serde_json::Value>,
    /// Learning rate in training. Used only for iterative training algorithms.
    #[serde(default, rename = "learnRate")]
    pub learn_rate: ::core::option::Option<f64>,
    /// The strategy to determine learn rate for the current iteration. // TODO: enum values: ["LEARN_RATE_STRATEGY_UNSPECIFIED", "LINE_SEARCH", "CONSTANT"]
    #[serde(default, rename = "learnRateStrategy")]
    pub learn_rate_strategy: ::core::option::Option<String>,
    /// Type of loss function used during training run. // TODO: enum values: ["LOSS_TYPE_UNSPECIFIED", "MEAN_SQUARED_LOSS", "MEAN_LOG_LOSS"]
    #[serde(default, rename = "lossType")]
    pub loss_type: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "maxParallelTrials")]
    pub max_parallel_trials: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "maxReplicaCount")]
    pub max_replica_count: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "maxTimeSeriesLength")]
    pub max_time_series_length: ::core::option::Option<String>,
    /// Maximum depth of a tree for boosted tree models.
    #[serde(default, rename = "maxTreeDepth")]
    pub max_tree_depth: ::core::option::Option<String>,
    /// The apriori support minimum. Applies to contribution analysis models.
    #[serde(default, rename = "minAprioriSupport")]
    pub min_apriori_support: ::core::option::Option<f64>,
    /// When early_stop is true, stops training when accuracy improvement is less than ''min_relative_progress''. Used only for iterative training algorithms.
    #[serde(default, rename = "minRelativeProgress")]
    ...
    #[serde(default, rename = "minReplicaCount")]
    pub min_replica_count: ::core::option::Option<String>,
    /// Minimum split loss for boosted tree models.
    #[serde(default, rename = "minSplitLoss")]
    ...
    #[serde(default, rename = "minTimeSeriesLength")]
    pub min_time_series_length: ::core::option::Option<String>,
    /// Minimum sum of instance weight needed in a child for boosted tree models.
    #[serde(default, rename = "minTreeChildWeight")]
    pub min_tree_child_weight: ::core::option::Option<String>,
    /// The name of a Vertex model garden publisher model. Format is publishers/{publisher}/models/{model}@{optional_version_id}.
    #[serde(default, rename = "modelGardenModelName")]
    pub model_garden_model_name: ::core::option::Option<String>,
    /// The model registry. // TODO: enum values: ["MODEL_REGISTRY_UNSPECIFIED", "VERTEX_AI"]
    #[serde(default, rename = "modelRegistry")]
    pub model_registry: ::core::option::Option<String>,
    /// Google Cloud Storage URI from which the model was imported. Only applicable for imported models.
    #[serde(default, rename = "modelUri")]
    pub model_uri: ::core::option::Option<String>,
    /// A specification of the non-seasonal part of the ARIMA model: the three components (p, d, q) are the AR order, the degree of differencing, and the MA order.
    #[serde(default, rename = "nonSeasonalOrder")]
    pub non_seasonal_order: ::core::option::Option<::std::boxed::Box<ArimaOrder>>,
    /// Number of clusters for clustering models.
    #[serde(default, rename = "numClusters")]
    pub num_clusters: ::core::option::Option<String>,
    /// Num factors specified for matrix factorization models.
    #[serde(default, rename = "numFactors")]
    pub num_factors: ::core::option::Option<String>,
    /// Number of parallel trees constructed during each iteration for boosted tree models.
    #[serde(default, rename = "numParallelTree")]
    pub num_parallel_tree: ::core::option::Option<String>,
    /// Number of principal components to keep in the PCA model. Must be &lt;= the number of features.
    #[serde(default, rename = "numPrincipalComponents")]
    pub num_principal_components: ::core::option::Option<String>,
    /// Number of trials to run this hyperparameter tuning job.
    #[serde(default, rename = "numTrials")]
    pub num_trials: ::core::option::Option<String>,
    /// Optimization strategy for training linear regression models. // TODO: enum values: ["OPTIMIZATION_STRATEGY_UNSPECIFIED", "BATCH_GRADIENT_DESCENT", "NORMAL_EQUATION"]
    #[serde(default, rename = "optimizationStrategy")]
    pub optimization_strategy: ::core::option::Option<String>,
    /// Optimizer used for training the neural nets.
    #[serde(default)]
    pub optimizer: ::core::option::Option<String>,
    /// The minimum ratio of cumulative explained variance that needs to be given by the PCA model.
    #[serde(default, rename = "pcaExplainedVarianceRatio")]
    pub pca_explained_variance_ratio: ::core::option::Option<f64>,
    /// The solver for PCA. // TODO: enum values: ["UNSPECIFIED", "FULL", "RANDOMIZED", "AUTO"]
    #[serde(default, rename = "pcaSolver")]
    pub pca_solver: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "reservationAffinityKey")]
    pub reservation_affinity_key: ::core::option::Option<String>,
    /// Specifies the reservation affinity type used to configure a Vertex AI resource. The default value is NO_RESERVATION. // TODO: enum values: ["RESERVATION_AFFINITY_TYPE_UNSPECIFIED", "NO_RESERVATION", "ANY_RESERVATION", "SPECIFIC_RESERVATION"]
    #[serde(default, rename = "reservationAffinityType")]
    pub reservation_affinity_type: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "reservationAffinityValues")]
    pub reservation_affinity_values: ::core::option::Option<::std::vec::Vec<String>>,
    /// Number of paths for the sampled Shapley explain method.
    #[serde(default, rename = "sampledShapleyNumPaths")]
    pub sampled_shapley_num_paths: ::core::option::Option<String>,
    /// If true, scale the feature values by dividing the feature standard deviation. Currently only apply to PCA.
    #[serde(default, rename = "scaleFeatures")]
    pub scale_features: ::core::option::Option<bool>,
    /// Whether to standardize numerical features. Default to true.
    #[serde(default, rename = "standardizeFeatures")]
    pub standardize_features: ::core::option::Option<bool>,
    /// Subsample fraction of the training data to grow tree to prevent overfitting for boosted tree models.
    #[serde(default)]
    pub subsample: ::core::option::Option<f64>,
    ...
    #[serde(default, rename = "timeSeriesDataColumn")]
    pub time_series_data_column: ::core::option::Option<String>,
    /// The time series id column that was used during ARIMA model training.
    #[serde(default, rename = "timeSeriesIdColumn")]
    pub time_series_id_column: ::core::option::Option<String>,
    /// The time series id columns that were used during ARIMA model training.
    #[serde(default, rename = "timeSeriesIdColumns")]
    pub time_series_id_columns: ::core::option::Option<::std::vec::Vec<String>>,
    /// The fraction of the interpolated length of the time series that''s used to model the time series trend component. All of the time points of the time series are used to model the non-trend component. This training option accelerates modeling training without sacrificing much forecasting accuracy. You can use this option with minTimeSeriesLength but not with maxTimeSeriesLength.
    #[serde(default, rename = "timeSeriesLengthFraction")]
    pub time_series_length_fraction: ::core::option::Option<f64>,
    /// Column to be designated as time series timestamp for ARIMA model.
    #[serde(default, rename = "timeSeriesTimestampColumn")]
    pub time_series_timestamp_column: ::core::option::Option<String>,
    /// Tree construction algorithm for boosted tree models. // TODO: enum values: ["TREE_METHOD_UNSPECIFIED", "AUTO", "EXACT", "APPROX", "HIST"]
    #[serde(default, rename = "treeMethod")]
    pub tree_method: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "trendSmoothingWindowSize")]
    pub trend_smoothing_window_size: ::core::option::Option<String>,
    /// User column specified for matrix factorization models.
    #[serde(default, rename = "userColumn")]
    pub user_column: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "vertexAiModelVersionAliases")]
    pub vertex_ai_model_version_aliases: ::core::option::Option<::std::vec::Vec<String>>,
    /// Hyperparameter for matrix factoration when implicit feedback type is specified.
    #[serde(default, rename = "walsAlpha")]
    pub wals_alpha: ::core::option::Option<f64>,
    /// Whether to train a model from the last checkpoint.
    #[serde(default, rename = "warmStart")]
    pub warm_start: ::core::option::Option<bool>,
    /// User-selected XGBoost versions for training of XGBoost models.
    #[serde(default, rename = "xgboostVersion")]
...
pub struct TrainingRun {
    ...
    pub class_level_global_explanations:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GlobalExplanation>>>,
    ...
    pub data_split_result: ::core::option::Option<::std::boxed::Box<DataSplitResult>>,
    ...
    pub model_level_global_explanation:
        ::core::option::Option<::std::boxed::Box<GlobalExplanation>>,
    /// Output only. Output of each iteration run, results.size() &lt;= max_iterations.
    #[serde(default)]
    pub results: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<IterationResult>>>,
    ...
    #[serde(default, rename = "trainingOptions")]
    pub training_options: ::core::option::Option<::std::boxed::Box<TrainingOptions>>,
...
pub struct VectorSearchStatistics {
    ...
    pub stored_columns_usages:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<StoredColumnsUsage>>>,
}
...
pub struct ViewDefinition {
    ...
    pub foreign_definitions:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ForeignViewDefinition>>>,
    /// Optional. Specifies the privacy policy for the view.
    #[serde(default, rename = "privacyPolicy")]
    pub privacy_policy: ::core::option::Option<::std::boxed::Box<PrivacyPolicy>>,
