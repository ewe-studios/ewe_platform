...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/contactcenteraiplatform/openapi.json`.
...
pub struct ContactCenter {
    ...
    pub admin_user: ::core::option::Option<::std::boxed::Box<AdminUser>>,
    ...
    #[serde(default)]
    pub critical: ::core::option::Option<::std::boxed::Box<Critical>>,
    ...
    pub feature_config: ::core::option::Option<::std::boxed::Box<FeatureConfig>>,
    ...
    pub private_access: ::core::option::Option<::std::boxed::Box<PrivateAccess>>,
    ...
    pub saml_params: ::core::option::Option<::std::boxed::Box<SAMLParams>>,
    ...
    #[serde(default)]
    pub uris: ::core::option::Option<::std::boxed::Box<URIs>>,
...
pub struct Critical {
    ...
    pub peak_hours: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<WeeklySchedule>>>,
}
...
pub struct EmployeeInfo {
    ...
    pub unwanted_event_intervals:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<UnwantedEventInterval>>>,
}
...
pub struct GenerateShiftsRequest {
    ...
    pub employee_info: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<EmployeeInfo>>>,
    /// Required. The solver will generate the maximum number of shifts per shift template.
    #[serde(default, rename = "planningHorizon")]
    pub planning_horizon: ::core::option::Option<::std::boxed::Box<PlanningHorizon>>,
    ...
    pub shift_templates: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ShiftTemplate>>>,
    /// Required. Parameters for the solver.
    #[serde(default, rename = "solverConfig")]
    pub solver_config: ::core::option::Option<::std::boxed::Box<SolverConfig>>,
    ...
    pub workforce_demands: ::core::option::Option<::std::boxed::Box<WorkforceDemandList>>,
}
...
pub struct ListContactCentersResponse {
    ...
    pub contact_centers: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ContactCenter>>>,
...
pub struct OperationMetadata {
    ...
    pub contact_center: ::core::option::Option<::std::boxed::Box<ContactCenter>>,
    /// Output only. The time the operation was created.
    #[serde(default, rename = "createTime")]
    pub create_time: ::core::option::Option<String>,
    /// Output only. The time the operation finished running.
...
pub struct PlanningHorizon {
    ...
    #[serde(default, rename = "endTime")]
    pub end_time: ::core::option::Option<::std::boxed::Box<DateTime>>,
    ...
    pub start_time: ::core::option::Option<::std::boxed::Box<DateTime>>,
}
...
pub struct PrivateAccess {
    ...
    pub egress_settings: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Component>>>,
    ...
    pub ingress_settings: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Component>>>,
    /// Private service connect settings.
    #[serde(default, rename = "pscSetting")]
    pub psc_setting: ::core::option::Option<::std::boxed::Box<PscSetting>>,
}
...
pub struct ShiftTemplate {
    ...
    pub days_off_dates: ::core::option::Option<::std::boxed::Box<DateList>>,
    ...
    pub earliest_start_time: ::core::option::Option<::std::boxed::Box<TimeOfDay>>,
    ...
    pub event_templates: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<EventTemplate>>>,
    /// Required. Unique ID of this template.
    #[serde(default)]
    pub id: ::core::option::Option<String>,
    ...
    pub latest_start_time: ::core::option::Option<::std::boxed::Box<TimeOfDay>>,
...
pub struct WorkforceDemandList {
    /// Optional. Values in the list.
    #[serde(default)]
    pub values: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<WorkforceDemand>>>,
}
