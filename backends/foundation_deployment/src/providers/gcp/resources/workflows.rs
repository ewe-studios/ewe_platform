...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/workflows/openapi.json`.
...
pub struct ListWorkflowRevisionsResponse {
    ...
    #[serde(default)]
    pub workflows: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Workflow>>>,
}
