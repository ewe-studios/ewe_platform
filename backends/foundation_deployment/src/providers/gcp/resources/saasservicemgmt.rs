...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/saasservicemgmt/openapi.json`.
...
pub struct ListRolloutKindsResponse {
    ...
    pub rollout_kinds: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<RolloutKind>>>,
    /// Locations that could not be reached.
    #[serde(default)]
    pub unreachable: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct ListSaasResponse {
    ...
    /// The resulting saas.
    #[serde(default)]
    pub saas: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Saas>>>,
    /// Locations that could not be reached.
    #[serde(default)]
    pub unreachable: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct ListUnitKindsResponse {
    ...
    pub unit_kinds: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<UnitKind>>>,
    /// Locations that could not be reached.
    #[serde(default)]
    pub unreachable: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct ListUnitOperationsResponse {
    ...
    pub unit_operations: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<UnitOperation>>>,
    /// Locations that could not be reached.
    #[serde(default)]
    pub unreachable: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct ListUnitsResponse {
    ...
    /// The resulting units.
    #[serde(default)]
    pub units: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Unit>>>,
    /// Locations that could not be reached.
    #[serde(default)]
    pub unreachable: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct Provision {
    ...
    pub input_variables: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<UnitVariable>>>,
...
pub struct Release {
    ...
    #[serde(default)]
    pub blueprint: ::core::option::Option<::std::boxed::Box<Blueprint>>,
    ...
    pub input_variable_defaults:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<UnitVariable>>>,
    ...
    pub output_variables: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<UnitVariable>>>,
    /// Optional. Set of requirements to be fulfilled on the Unit when using this Release.
    #[serde(default, rename = "releaseRequirements")]
    pub release_requirements: ::core::option::Option<::std::boxed::Box<ReleaseRequirements>>,
...
pub struct Rollout {
    ...
    #[serde(default)]
    pub control: ::core::option::Option<::std::boxed::Box<RolloutControl>>,
    /// Output only. The timestamp when the resource was created.
    #[serde(default, rename = "createTime")]
    pub create_time: ::core::option::Option<String>,
    ...
    #[serde(default)]
    pub stats: ::core::option::Option<::std::boxed::Box<RolloutStats>>,
    /// Output only. The unique identifier of the resource. UID is unique in the time and space for this resource within the scope of the service. It is typically generated by the server on successful creation of a resource and must not be changed. UID is used to uniquely identify resources with resource name reuses. This should be a UUID4.
    #[serde(default)]
    pub uid: ::core::option::Option<String>,
...
pub struct RolloutControl {
    ...
    pub run_params: ::core::option::Option<::std::boxed::Box<RunRolloutActionParams>>,
}
...
pub struct RolloutKind {
    ...
    pub error_budget: ::core::option::Option<::std::boxed::Box<ErrorBudget>>,
    /// Output only. An opaque value that uniquely identifies a version or generation of a resource. It can be used to confirm that the client and server agree on the ordering of a resource being written.
    #[serde(default)]
    pub etag: ::core::option::Option<String>,
    /// Optional. The labels on the resource, which can be used for categorization. similar to Kubernetes resource labels.
...
pub struct RolloutStats {
    ...
    pub operations_by_state: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Aggregate>>>,
}
...
pub struct Saas {
    ...
    #[serde(default)]
    pub conditions: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SaasCondition>>>,
    /// Output only. The timestamp when the resource was created.
    #[serde(default, rename = "createTime")]
    pub create_time: ::core::option::Option<String>,
...
pub struct Unit {
    ...
    #[serde(default)]
    pub conditions: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<UnitCondition>>>,
    /// Output only. The timestamp when the resource was created.
    #[serde(default, rename = "createTime")]
    pub create_time: ::core::option::Option<String>,
    /// Optional. Output only. Set of dependencies for this unit. Maximum 10.
    #[serde(default)]
    pub dependencies: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<UnitDependency>>>,
    ...
    #[serde(default)]
    pub dependents: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<UnitDependency>>>,
    /// Output only. An opaque value that uniquely identifies a version or generation of a resource. It can be used to confirm that the client and server agree on the ordering of a resource being written.
    #[serde(default)]
    pub etag: ::core::option::Option<String>,
    ...
    #[serde(default)]
    pub maintenance: ::core::option::Option<::std::boxed::Box<MaintenanceSettings>>,
...
pub struct UnitKind {
    ...
    #[serde(default)]
    pub dependencies: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Dependency>>>,
    /// Output only. An opaque value that uniquely identifies a version or generation of a resource. It can be used to confirm that the client and server agree on the ordering of a resource being written.
    #[serde(default)]
    pub etag: ::core::option::Option<String>,
    ...
    pub input_variable_mappings:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<VariableMapping>>>,
    /// Optional. The labels on the resource, which can be used for categorization. similar to Kubernetes resource labels.
    #[serde(default)]
    pub labels: ::core::option::Option<serde_json::Value>,
...
pub struct UnitOperation {
    ...
    #[serde(default)]
    pub conditions:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<UnitOperationCondition>>>,
    /// Output only. The timestamp when the resource was created.
    #[serde(default, rename = "createTime")]
    pub create_time: ::core::option::Option<String>,
    /// Output only. The timestamp when the resource was marked for deletion (deletion is an asynchronous operation).
    ...
    #[serde(default)]
    pub provision: ::core::option::Option<::std::boxed::Box<Provision>>,
    ...
    pub update_time: ::core::option::Option<String>,
    #[serde(default)]
    pub upgrade: ::core::option::Option<::std::boxed::Box<Upgrade>>,
}
...
pub struct VariableMapping {
    ...
    #[serde(default)]
    pub from: ::core::option::Option<::std::boxed::Box<FromMapping>>,
    /// Optional. Input variables whose values will be passed on to dependencies.
    #[serde(default)]
    pub to: ::core::option::Option<::std::boxed::Box<ToMapping>>,
