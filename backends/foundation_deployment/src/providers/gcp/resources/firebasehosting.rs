...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/firebasehosting/openapi.json`.
...
pub struct CertVerification {
    ...
    #[serde(default)]
    pub dns: ::core::option::Option<::std::boxed::Box<DnsUpdates>>,
    ...
    #[serde(default)]
    pub http: ::core::option::Option<::std::boxed::Box<HttpUpdate>>,
}
...
pub struct CustomDomainMetadata {
    ...
    pub quick_setup_updates: ::core::option::Option<::std::boxed::Box<DnsUpdates>>,
}
...
pub struct LiveMigrationStep {
    ...
    pub cert_verification: ::core::option::Option<::std::boxed::Box<CertVerification>>,
    /// Output only. DNS updates to facilitate your domain''s zero-downtime migration to Hosting.
    #[serde(default, rename = "dnsUpdates")]
    pub dns_updates: ::core::option::Option<::std::boxed::Box<DnsUpdates>>,
