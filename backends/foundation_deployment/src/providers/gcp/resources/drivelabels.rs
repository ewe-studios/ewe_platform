...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/drivelabels/openapi.json`.
...
pub struct GoogleAppsDriveLabelsV2BadgeColors {
    ...
    pub foreground_color: ::core::option::Option<::std::boxed::Box<GoogleTypeColor>>,
    /// Output only. Color that can be used for text without a background.
    #[serde(default, rename = "soloColor")]
    pub solo_color: ::core::option::Option<::std::boxed::Box<GoogleTypeColor>>,
}
...
pub struct GoogleAppsDriveLabelsV2BatchDeleteLabelPermissionsRequest {
    ...
    pub requests: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleAppsDriveLabelsV2DeleteLabelPermissionRequest>>,
    >,
...
pub struct GoogleAppsDriveLabelsV2BatchUpdateLabelPermissionsRequest {
    ...
    #[serde(default)]
    pub requests: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleAppsDriveLabelsV2UpdateLabelPermissionRequest>>,
    >,
...
pub struct GoogleAppsDriveLabelsV2BatchUpdateLabelPermissionsResponse {
    ...
    pub permissions: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleAppsDriveLabelsV2LabelPermission>>,
    >,
}
...
pub struct GoogleAppsDriveLabelsV2DateLimits {
    ...
    pub max_value: ::core::option::Option<::std::boxed::Box<GoogleTypeDate>>,
    /// Minimum value for the date field type.
    #[serde(default, rename = "minValue")]
    pub min_value: ::core::option::Option<::std::boxed::Box<GoogleTypeDate>>,
}
...
pub struct GoogleAppsDriveLabelsV2DeltaUpdateLabelRequest {
    ...
    #[serde(default)]
    pub requests: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleAppsDriveLabelsV2DeltaUpdateLabelRequestRequest>>,
    >,
    /// Set to true in order to use the user''s admin credentials. The server will verify the user is an admin for the label before allowing access.
    #[serde(default, rename = "useAdminAccess")]
    pub use_admin_access: ::core::option::Option<bool>,
    ...
    pub write_control:
        ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2WriteControl>>,
}
...
pub struct GoogleAppsDriveLabelsV2DeltaUpdateLabelRequestCreateFieldRequest {
    ...
    #[serde(default)]
    pub field: ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2Field>>,
}
...
pub struct GoogleAppsDriveLabelsV2DeltaUpdateLabelRequestCreateSelectionChoiceRequest {
    ...
    #[serde(default)]
    pub choice: ::core::option::Option<
        ::std::boxed::Box<GoogleAppsDriveLabelsV2FieldSelectionOptionsChoice>,
    >,
...
pub struct GoogleAppsDriveLabelsV2DeltaUpdateLabelRequestDisableFieldRequest {
    ...
    pub disabled_policy:
        ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2LifecycleDisabledPolicy>>,
...
pub struct GoogleAppsDriveLabelsV2DeltaUpdateLabelRequestRequest {
    ...
    pub create_field: ::core::option::Option<
        ::std::boxed::Box<GoogleAppsDriveLabelsV2DeltaUpdateLabelRequestCreateFieldRequest>,
    >,
    ...
    pub delete_field: ::core::option::Option<
        ::std::boxed::Box<GoogleAppsDriveLabelsV2DeltaUpdateLabelRequestDeleteFieldRequest>,
    >,
    ...
    pub disable_field: ::core::option::Option<
        ::std::boxed::Box<GoogleAppsDriveLabelsV2DeltaUpdateLabelRequestDisableFieldRequest>,
    >,
    ...
    pub enable_field: ::core::option::Option<
        ::std::boxed::Box<GoogleAppsDriveLabelsV2DeltaUpdateLabelRequestEnableFieldRequest>,
    >,
    ...
    pub update_field_type: ::core::option::Option<
        ::std::boxed::Box<GoogleAppsDriveLabelsV2DeltaUpdateLabelRequestUpdateFieldTypeRequest>,
    >,
...
pub struct GoogleAppsDriveLabelsV2DeltaUpdateLabelRequestUpdateFieldPropertiesRequest {
    ...
    #[serde(default)]
    pub properties:
        ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2FieldProperties>>,
...
pub struct GoogleAppsDriveLabelsV2DeltaUpdateLabelRequestUpdateFieldTypeRequest {
    ...
    pub date_options:
        ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2FieldDateOptions>>,
    /// Required. The field to update.
    #[serde(default)]
    pub id: ::core::option::Option<String>,
    ...
    pub integer_options:
        ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2FieldIntegerOptions>>,
    /// Update field to Selection.
    #[serde(default, rename = "selectionOptions")]
    pub selection_options:
        ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2FieldSelectionOptions>>,
    /// Update field to Text.
    #[serde(default, rename = "textOptions")]
    pub text_options:
        ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2FieldTextOptions>>,
    ...
    pub user_options:
        ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2FieldUserOptions>>,
}
...
pub struct GoogleAppsDriveLabelsV2DeltaUpdateLabelRequestUpdateLabelPropertiesRequest {
    ...
    #[serde(default)]
    pub properties:
        ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2LabelProperties>>,
...
pub struct GoogleAppsDriveLabelsV2DeltaUpdateLabelRequestUpdateSelectionChoicePropertiesRequest {
    ...
    pub properties: ::core::option::Option<
        ::std::boxed::Box<GoogleAppsDriveLabelsV2FieldSelectionOptionsChoiceProperties>,
    >,
    /// The fields that should be updated. At least one field must be specified. The root properties is implied and should not be specified. A single * can be used as a short-hand for updating every field.
    #[serde(default, rename = "updateMask")]
    pub update_mask: ::core::option::Option<String>,
...
pub struct GoogleAppsDriveLabelsV2DeltaUpdateLabelResponse {
    ...
    pub responses: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleAppsDriveLabelsV2DeltaUpdateLabelResponseResponse>>,
    >,
    ...
    pub updated_label: ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2Label>>,
}
...
pub struct GoogleAppsDriveLabelsV2DeltaUpdateLabelResponseResponse {
    ...
    #[serde(default, rename = "createField")]
    pub create_field: ::core::option::Option<
        ::std::boxed::Box<GoogleAppsDriveLabelsV2DeltaUpdateLabelResponseCreateFieldResponse>,
    >,
...
pub struct GoogleAppsDriveLabelsV2Field {
    ...
    pub applied_capabilities:
        ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2FieldAppliedCapabilities>>,
    /// Output only. The time this field was created.
    #[serde(default, rename = "createTime")]
    pub create_time: ::core::option::Option<String>,
    /// Output only. The user who created this field.
    #[serde(default)]
    pub creator: ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2UserInfo>>,
    /// Date field options.
    #[serde(default, rename = "dateOptions")]
    pub date_options:
        ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2FieldDateOptions>>,
    ...
    #[serde(default)]
    pub disabler: ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2UserInfo>>,
    /// Output only. UI display hints for rendering a field.
    #[serde(default, rename = "displayHints")]
    pub display_hints:
        ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2FieldDisplayHints>>,
    ...
    #[serde(default)]
    pub lifecycle: ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2Lifecycle>>,
    /// Output only. The LockStatus of this field.
    #[serde(default, rename = "lockStatus")]
    pub lock_status: ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2LockStatus>>,
    ...
    #[serde(default)]
    pub publisher: ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2UserInfo>>,
    ...
    pub schema_capabilities:
        ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2FieldSchemaCapabilities>>,
    ...
    #[serde(default)]
    pub updater: ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2UserInfo>>,
    /// User field options.
    #[serde(default, rename = "userOptions")]
    pub user_options:
        ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2FieldUserOptions>>,
...
pub struct GoogleAppsDriveLabelsV2FieldLimits {
    ...
    pub date_limits: ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2DateLimits>>,
    /// Integer field limits.
    #[serde(default, rename = "integerLimits")]
    pub integer_limits:
        ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2IntegerLimits>>,
    /// Long text field limits.
    #[serde(default, rename = "longTextLimits")]
    pub long_text_limits:
        ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2LongTextLimits>>,
    ...
    pub selection_limits:
        ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2SelectionLimits>>,
    /// The relevant limits for the specified Field.Type. Text field limits.
    #[serde(default, rename = "textLimits")]
    pub text_limits: ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2TextLimits>>,
    /// User field limits.
    #[serde(default, rename = "userLimits")]
    pub user_limits: ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2UserLimits>>,
}
...
pub struct GoogleAppsDriveLabelsV2FieldSelectionOptions {
    ...
    #[serde(default)]
    pub choices: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleAppsDriveLabelsV2FieldSelectionOptionsChoice>>,
    >,
    ...
    pub list_options:
        ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2FieldListOptions>>,
}
...
pub struct GoogleAppsDriveLabelsV2FieldSelectionOptionsChoice {
    ...
    pub applied_capabilities: ::core::option::Option<
        ::std::boxed::Box<GoogleAppsDriveLabelsV2FieldSelectionOptionsChoiceAppliedCapabilities>,
    >,
    ...
    #[serde(default, rename = "displayHints")]
    pub display_hints: ::core::option::Option<
        ::std::boxed::Box<GoogleAppsDriveLabelsV2FieldSelectionOptionsChoiceDisplayHints>,
    >,
    ...
    pub schema_capabilities: ::core::option::Option<
        ::std::boxed::Box<GoogleAppsDriveLabelsV2FieldSelectionOptionsChoiceSchemaCapabilities>,
    >,
...
pub struct GoogleAppsDriveLabelsV2FieldSelectionOptionsChoiceDisplayHints {
    ...
    pub badge_colors: ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2BadgeColors>>,
    ...
    pub dark_badge_colors:
        ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2BadgeColors>>,
...
pub struct GoogleAppsDriveLabelsV2FieldSelectionOptionsChoiceProperties {
    ...
    pub badge_config: ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2BadgeConfig>>,
...
pub struct GoogleAppsDriveLabelsV2Label {
    ...
    #[serde(default, rename = "appliedCapabilities")]
    pub applied_capabilities:
        ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2LabelAppliedCapabilities>>,
    ...
    pub applied_label_policy:
        ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2LabelAppliedLabelPolicy>>,
    ...
    #[serde(default, rename = "displayHints")]
    pub display_hints:
        ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2LabelDisplayHints>>,
    /// Optional. The EnabledAppSettings for this Label.
    #[serde(default, rename = "enabledAppSettings")]
    pub enabled_app_settings:
        ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2LabelEnabledAppSettings>>,
    /// List of fields in descending priority order.
    #[serde(default)]
    pub fields:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleAppsDriveLabelsV2Field>>>,
    ...
    pub revision_creator:
        ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2UserInfo>>,
    ...
    #[serde(default, rename = "schemaCapabilities")]
    pub schema_capabilities:
        ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2LabelSchemaCapabilities>>,
}
...
pub struct GoogleAppsDriveLabelsV2LabelEnabledAppSettings {
    ...
    pub enabled_apps: ::core::option::Option<
        ::std::vec::Vec<
            ::std::boxed::Box<GoogleAppsDriveLabelsV2LabelEnabledAppSettingsEnabledApp>,
        >,
    >,
}
...
pub struct GoogleAppsDriveLabelsV2LabelLimits {
    ...
    pub field_limits: ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2FieldLimits>>,
...
pub struct GoogleAppsDriveLabelsV2LabelLock {
    ...
    #[serde(default)]
    pub capabilities:
        ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2LabelLockCapabilities>>,
...
pub struct GoogleAppsDriveLabelsV2ListLabelLocksResponse {
    ...
    pub label_locks: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleAppsDriveLabelsV2LabelLock>>,
    >,
...
pub struct GoogleAppsDriveLabelsV2ListLabelPermissionsResponse {
    ...
    pub label_permissions: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleAppsDriveLabelsV2LabelPermission>>,
    >,
    /// The token of the next page in the response.
    #[serde(default, rename = "nextPageToken")]
...
pub struct GoogleAppsDriveLabelsV2ListLabelsResponse {
    ...
    #[serde(default)]
    pub labels:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleAppsDriveLabelsV2Label>>>,
    /// The token of the next page in the response.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct GoogleAppsDriveLabelsV2SelectionLimits {
    ...
    pub list_limits: ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2ListLimits>>,
...
pub struct GoogleAppsDriveLabelsV2UpdateLabelPermissionRequest {
    ...
    pub label_permission:
        ::core::option::Option<::std::boxed::Box<GoogleAppsDriveLabelsV2LabelPermission>>,
