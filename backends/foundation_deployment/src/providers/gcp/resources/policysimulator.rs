...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/policysimulator/openapi.json`.
...
pub struct GoogleCloudOrgpolicyV2AlternatePolicySpec {
    ...
    #[serde(default)]
    pub spec: ::core::option::Option<::std::boxed::Box<GoogleCloudOrgpolicyV2PolicySpec>>,
}
...
pub struct GoogleCloudOrgpolicyV2Policy {
    ...
    #[serde(default)]
    pub alternate:
        ::core::option::Option<::std::boxed::Box<GoogleCloudOrgpolicyV2AlternatePolicySpec>>,
    /// Dry-run policy. Audit-only policy, can be used to monitor how the policy would have impacted the existing and future resources if it''s enforced.
    #[serde(default, rename = "dryRunSpec")]
    pub dry_run_spec: ::core::option::Option<::std::boxed::Box<GoogleCloudOrgpolicyV2PolicySpec>>,
...
pub struct GoogleCloudOrgpolicyV2PolicySpec {
    ...
    pub rules: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudOrgpolicyV2PolicySpecPolicyRule>>,
    >,
...
pub struct GoogleCloudOrgpolicyV2PolicySpecPolicyRule {
    ...
    pub values: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudOrgpolicyV2PolicySpecPolicyRuleStringValues>,
    >,
}
...
pub struct GoogleCloudPolicysimulatorV1AccessStateDiff {
    ...
    #[serde(default)]
    pub baseline:
        ::core::option::Option<::std::boxed::Box<GoogleCloudPolicysimulatorV1ExplainedAccess>>,
...
pub struct GoogleCloudPolicysimulatorV1ExplainedAccess {
    ...
    pub policies: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudPolicysimulatorV1ExplainedPolicy>>,
    >,
}
...
pub struct GoogleCloudPolicysimulatorV1ExplainedPolicy {
    ...
    pub binding_explanations: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudPolicysimulatorV1BindingExplanation>>,
    >,
...
pub struct GoogleCloudPolicysimulatorV1ListOrgPolicyViolationsPreviewsResponse {
    ...
    pub org_policy_violations_previews: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudPolicysimulatorV1OrgPolicyViolationsPreview>>,
    >,
}
...
pub struct GoogleCloudPolicysimulatorV1ListOrgPolicyViolationsResponse {
    ...
    pub org_policy_violations: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudPolicysimulatorV1OrgPolicyViolation>>,
    >,
}
...
pub struct GoogleCloudPolicysimulatorV1ListReplayResultsResponse {
    ...
    pub replay_results: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudPolicysimulatorV1ReplayResult>>,
    >,
}
...
pub struct GoogleCloudPolicysimulatorV1OrgPolicyOverlay {
    ...
    pub custom_constraints: ::core::option::Option<
        ::std::vec::Vec<
            ::std::boxed::Box<GoogleCloudPolicysimulatorV1OrgPolicyOverlayCustomConstraintOverlay>,
        >,
    >,
    ...
    pub policies: ::core::option::Option<
        ::std::vec::Vec<
            ::std::boxed::Box<GoogleCloudPolicysimulatorV1OrgPolicyOverlayPolicyOverlay>,
        >,
    >,
}
...
pub struct GoogleCloudPolicysimulatorV1OrgPolicyOverlayCustomConstraintOverlay {
    ...
    pub custom_constraint:
        ::core::option::Option<::std::boxed::Box<GoogleCloudOrgpolicyV2CustomConstraint>>,
...
pub struct GoogleCloudPolicysimulatorV1OrgPolicyOverlayPolicyOverlay {
    ...
    #[serde(default)]
    pub policy: ::core::option::Option<::std::boxed::Box<GoogleCloudOrgpolicyV2Policy>>,
...
pub struct GoogleCloudPolicysimulatorV1OrgPolicyViolation {
    ...
    #[serde(default)]
    pub resource:
        ::core::option::Option<::std::boxed::Box<GoogleCloudPolicysimulatorV1ResourceContext>>,
}
...
pub struct GoogleCloudPolicysimulatorV1OrgPolicyViolationsPreview {
    ...
    #[serde(default)]
    pub overlay:
        ::core::option::Option<::std::boxed::Box<GoogleCloudPolicysimulatorV1OrgPolicyOverlay>>,
    ...
    pub resource_counts: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudPolicysimulatorV1OrgPolicyViolationsPreviewResourceCounts>,
    >,
...
pub struct GoogleCloudPolicysimulatorV1Replay {
    ...
    #[serde(default)]
    pub config: ::core::option::Option<::std::boxed::Box<GoogleCloudPolicysimulatorV1ReplayConfig>>,
    ...
    pub results_summary:
        ::core::option::Option<::std::boxed::Box<GoogleCloudPolicysimulatorV1ReplayResultsSummary>>,
...
pub struct GoogleCloudPolicysimulatorV1ReplayDiff {
    ...
    pub access_diff:
        ::core::option::Option<::std::boxed::Box<GoogleCloudPolicysimulatorV1AccessStateDiff>>,
}
...
pub struct GoogleCloudPolicysimulatorV1ReplayResult {
    ...
    pub access_tuple:
        ::core::option::Option<::std::boxed::Box<GoogleCloudPolicysimulatorV1AccessTuple>>,
    ...
    #[serde(default)]
    pub diff: ::core::option::Option<::std::boxed::Box<GoogleCloudPolicysimulatorV1ReplayDiff>>,
    ...
    pub last_seen_date: ::core::option::Option<::std::boxed::Box<GoogleTypeDate>>,
...
pub struct GoogleCloudPolicysimulatorV1ReplayResultsSummary {
    ...
    pub newest_date: ::core::option::Option<::std::boxed::Box<GoogleTypeDate>>,
    /// The date of the oldest log entry replayed.
    #[serde(default, rename = "oldestDate")]
    pub oldest_date: ::core::option::Option<::std::boxed::Box<GoogleTypeDate>>,
...
pub struct GoogleCloudPolicysimulatorV1betaOrgPolicyOverlay {
    ...
    pub policies: ::core::option::Option<
        ::std::vec::Vec<
            ::std::boxed::Box<GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlay>,
        >,
    >,
}
...
pub struct GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview {
    ...
    #[serde(default)]
    pub overlay:
        ::core::option::Option<::std::boxed::Box<GoogleCloudPolicysimulatorV1betaOrgPolicyOverlay>>,
    /// Output only. A summary of the state of all resources scanned for compliance with the changed OrgPolicy.
    #[serde(default, rename = "resourceCounts")]
    pub resource_counts: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCounts>,
    >,
    /// Output only. The state of the OrgPolicyViolationsPreview. // TODO: enum values: ["PREVIEW_STATE_UNSPECIFIED", "PREVIEW_PENDING", "PREVIEW_RUNNING", "PREVIEW_SUCCEEDED", "PREVIEW_FAILED"]
    #[serde(default)]
    pub state: ::core::option::Option<String>,
