...
pub struct ListChannelConnectionsResponse {
    ...
    pub channel_connections: ::core::option::Option<::std::vec::Vec<ChannelConnection>>,
...
pub struct ListEnrollmentsResponse {
    ...
    #[serde(default)]
    pub enrollments: ::core::option::Option<::std::vec::Vec<Enrollment>>,
...
pub struct ListGoogleApiSourcesResponse {
    ...
    pub google_api_sources: ::core::option::Option<::std::vec::Vec<GoogleApiSource>>,
...
pub struct ListMessageBusesResponse {
    ...
    pub message_buses: ::core::option::Option<::std::vec::Vec<MessageBus>>,
...
pub struct ListProvidersResponse {
    ...
    #[serde(default)]
    pub providers: ::core::option::Option<::std::vec::Vec<Provider>>,
    /// Unreachable resources, if any.
    #[serde(default)]
    pub unreachable: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct ListTriggersResponse {
    ...
    #[serde(default)]
    pub triggers: ::core::option::Option<::std::vec::Vec<Trigger>>,
    /// Unreachable resources, if any.
    #[serde(default)]
    pub unreachable: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct GoogleApiSource {
    ...
    pub organization_subscription: ::core::option::Option<OrganizationSubscription>,
    ...
    pub project_subscriptions: ::core::option::Option<ProjectSubscriptions>,
    /// Output only. Server assigned unique identifier for the channel. The value is a UUID4 string and guaranteed to remain unchanged until the resource is deleted.
    #[serde(default)]
    pub uid: ::core::option::Option<String>,
    /// Output only. The last-modified time.
...
pub struct Pipeline {
    ...
    #[serde(default)]
    pub destinations:
        ::core::option::Option<::std::vec::Vec<GoogleCloudEventarcV1PipelineDestination>>,
    ...
    pub input_payload_format:
        ::core::option::Option<GoogleCloudEventarcV1PipelineMessagePayloadFormat>,
    ...
    #[serde(default)]
    pub mediations: ::core::option::Option<::std::vec::Vec<GoogleCloudEventarcV1PipelineMediation>>,
    ...
    pub retry_policy: ::core::option::Option<GoogleCloudEventarcV1PipelineRetryPolicy>,
...
pub struct Provider {
    ...
    pub event_types: ::core::option::Option<::std::vec::Vec<EventType>>,
...
pub struct GoogleCloudEventarcV1PipelineDestination {
    ...
    pub authentication_config:
        ::core::option::Option<GoogleCloudEventarcV1PipelineDestinationAuthenticationConfig>,
    ...
    pub http_endpoint: ::core::option::Option<GoogleCloudEventarcV1PipelineDestinationHttpEndpoint>,
    ...
    pub network_config:
        ::core::option::Option<GoogleCloudEventarcV1PipelineDestinationNetworkConfig>,
...
pub struct GoogleCloudEventarcV1PipelineMediation {
    ...
    #[serde(default)]
    pub transformation:
        ::core::option::Option<GoogleCloudEventarcV1PipelineMediationTransformation>,
}
...
pub struct EventType {
    ...
    pub filtering_attributes: ::core::option::Option<::std::vec::Vec<FilteringAttribute>>,
...
pub struct Destination {
    ...
    #[serde(default)]
    pub gke: ::core::option::Option<GKE>,
    /// An HTTP endpoint destination described by an URI.
    #[serde(default, rename = "httpEndpoint")]
    pub http_endpoint: ::core::option::Option<HttpEndpoint>,
...
pub struct GoogleCloudEventarcV1PipelineMessagePayloadFormat {
    ...
    #[serde(default)]
    pub protobuf:
        ::core::option::Option<GoogleCloudEventarcV1PipelineMessagePayloadFormatProtobufFormat>,
}
