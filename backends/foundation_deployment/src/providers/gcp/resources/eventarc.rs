//! Auto-generated resource types for Google Cloud Platform - eventarc.
//!
//! This file is generated by `cargo run --bin ewe_platform gen_resource_types`.
//! DO NOT EDIT MANUALLY.
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/eventarc/openapi.json`.
...
pub struct Channel {
    ...
    pub activation_token: ::core::option::Option<String>,
    ...
    /// Output only. The state of a Channel. // TODO: enum values: ["STATE_UNSPECIFIED", "PENDING", "ACTIVE", "INACTIVE"]
    #[serde(default)]
...
pub struct Destination {
    ...
    #[serde(default)]
    pub gke: ::core::option::Option<::std::boxed::Box<GKE>>,
    /// An HTTP endpoint destination described by an URI.
    #[serde(default, rename = "httpEndpoint")]
    pub http_endpoint: ::core::option::Option<::std::boxed::Box<HttpEndpoint>>,
...
pub struct Enrollment {
    ...
    #[serde(default, rename = "celMatch")]
    pub cel_match: ::core::option::Option<String>,
    /// Output only. The creation time.
    #[serde(default, rename = "createTime")]
    pub create_time: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "messageBus")]
    pub message_bus: ::core::option::Option<String>,
...
pub struct EventType {
    ...
    #[serde(default, rename = "eventSchemaUri")]
    pub event_schema_uri: ::core::option::Option<String>,
    /// Output only. Filtering attributes for the event type.
    #[serde(default, rename = "filteringAttributes")]
    pub filtering_attributes:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<FilteringAttribute>>>,
...
pub struct FilteringAttribute {
    ...
    #[serde(default, rename = "pathPatternSupported")]
    pub path_pattern_supported: ::core::option::Option<bool>,
...
pub struct GoogleApiSource {
    ...
    #[serde(default, rename = "organizationSubscription")]
    pub organization_subscription:
        ::core::option::Option<::std::boxed::Box<OrganizationSubscription>>,
    ...
    #[serde(default, rename = "projectSubscriptions")]
    pub project_subscriptions: ::core::option::Option<::std::boxed::Box<ProjectSubscriptions>>,
    /// Output only. Server assigned unique identifier for the channel. The value is a UUID4 string and guaranteed to remain unchanged until the resource is deleted.
    #[serde(default)]
    pub uid: ::core::option::Option<String>,
    /// Output only. The last-modified time.
...
pub struct GoogleCloudEventarcV1PipelineDestination {
    ...
    pub authentication_config: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudEventarcV1PipelineDestinationAuthenticationConfig>,
    >,
    ...
    #[serde(default, rename = "httpEndpoint")]
    pub http_endpoint: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudEventarcV1PipelineDestinationHttpEndpoint>,
    >,
    ...
    pub network_config: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudEventarcV1PipelineDestinationNetworkConfig>,
    >,
    ...
    #[serde(default, rename = "outputPayloadFormat")]
    pub output_payload_format: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudEventarcV1PipelineMessagePayloadFormat>,
    >,
...
pub struct GoogleCloudEventarcV1PipelineDestinationAuthenticationConfig {
    ...
    pub google_oidc: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudEventarcV1PipelineDestinationAuthenticationConfigOidcToken>,
    >,
    ...
    pub oauth_token: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudEventarcV1PipelineDestinationAuthenticationConfigOAuthToken>,
    >,
}
...
pub struct GoogleCloudEventarcV1PipelineDestinationHttpEndpoint {
    ...
    pub message_binding_template: ::core::option::Option<String>,
...
pub struct GoogleCloudEventarcV1PipelineMediation {
    ...
    pub transformation: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudEventarcV1PipelineMediationTransformation>,
    >,
}
...
pub struct GoogleCloudEventarcV1PipelineMediationTransformation {
    ...
    pub transformation_template: ::core::option::Option<String>,
}
...
pub struct GoogleCloudEventarcV1PipelineMessagePayloadFormat {
    ...
    #[serde(default)]
    pub avro: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudEventarcV1PipelineMessagePayloadFormatAvroFormat>,
    >,
    ...
    pub protobuf: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudEventarcV1PipelineMessagePayloadFormatProtobufFormat>,
    >,
}
...
pub struct GoogleCloudEventarcV1PipelineRetryPolicy {
    ...
    #[serde(default, rename = "maxRetryDelay")]
    pub max_retry_delay: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "minRetryDelay")]
    pub min_retry_delay: ::core::option::Option<String>,
}
...
pub struct ListChannelConnectionsResponse {
    ...
    pub channel_connections:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ChannelConnection>>>,
...
pub struct ListEnrollmentsResponse {
    ...
    #[serde(default)]
    pub enrollments: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Enrollment>>>,
...
pub struct ListGoogleApiSourcesResponse {
    ...
    pub google_api_sources:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleApiSource>>>,
...
pub struct ListMessageBusEnrollmentsResponse {
    /// The requested enrollments, up to the number specified in page_size.
    #[serde(default)]
    pub enrollments: ::core::option::Option<::std::vec::Vec<String>>,
    /// A page token that can be sent to ListMessageBusEnrollments to request the next page. If this is empty, then there are no more pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// Unreachable resources, if any.
...
pub struct ListMessageBusesResponse {
    ...
    pub message_buses: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<MessageBus>>>,
...
pub struct ListProvidersResponse {
    ...
    #[serde(default)]
    pub providers: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Provider>>>,
    /// Unreachable resources, if any.
    #[serde(default)]
    pub unreachable: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct ListTriggersResponse {
    ...
    #[serde(default)]
    pub triggers: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Trigger>>>,
    /// Unreachable resources, if any.
    #[serde(default)]
    pub unreachable: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct Pipeline {
    ...
    pub destinations: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudEventarcV1PipelineDestination>>,
    >,
    ...
    #[serde(default, rename = "inputPayloadFormat")]
    pub input_payload_format: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudEventarcV1PipelineMessagePayloadFormat>,
    >,
    ...
    #[serde(default)]
    pub mediations: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudEventarcV1PipelineMediation>>,
    >,
    ...
    pub retry_policy:
        ::core::option::Option<::std::boxed::Box<GoogleCloudEventarcV1PipelineRetryPolicy>>,
...
pub struct Provider {
    ...
    pub event_types: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<EventType>>>,
...
pub struct Trigger {
    ...
    #[serde(default, rename = "eventDataContentType")]
    pub event_data_content_type: ::core::option::Option<String>,
    ...
    #[serde(default)]
    pub transport: ::core::option::Option<::std::boxed::Box<Transport>>,
