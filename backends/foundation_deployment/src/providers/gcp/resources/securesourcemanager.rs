...
pub struct BatchCreatePullRequestCommentsRequest {
    ...
    #[serde(default)]
    pub requests: ::core::option::Option<::std::vec::Vec<CreatePullRequestCommentRequest>>,
}
...
pub struct BatchCreatePullRequestCommentsResponse {
    ...
    pub pull_request_comments: ::core::option::Option<::std::vec::Vec<PullRequestComment>>,
}
...
pub struct FetchTreeResponse {
    ...
    pub tree_entries: ::core::option::Option<::std::vec::Vec<TreeEntry>>,
}
...
pub struct ListBranchRulesResponse {
    ...
    pub branch_rules: ::core::option::Option<::std::vec::Vec<BranchRule>>,
    /// A token identifying a page of results the server should return.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct ListHooksResponse {
    /// The list of hooks.
    #[serde(default)]
    pub hooks: ::core::option::Option<::std::vec::Vec<Hook>>,
    /// A token identifying a page of results the server should return.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct ListIssueCommentsResponse {
    ...
    pub issue_comments: ::core::option::Option<::std::vec::Vec<IssueComment>>,
    /// A token identifying a page of results the server should return.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct ListPullRequestFileDiffsResponse {
    ...
    pub file_diffs: ::core::option::Option<::std::vec::Vec<FileDiff>>,
    /// A token identifying a page of results the server should return.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct ListPullRequestsResponse {
    ...
    pub pull_requests: ::core::option::Option<::std::vec::Vec<PullRequest>>,
}
...
pub struct BranchRule {
    ...
    pub required_status_checks: ::core::option::Option<::std::vec::Vec<Check>>,
...
pub struct Hook {
    ...
    pub push_option: ::core::option::Option<PushOption>,
...
pub struct Instance {
    ...
    pub host_config: ::core::option::Option<HostConfig>,
    ...
    pub private_config: ::core::option::Option<PrivateConfig>,
    ...
    pub workforce_identity_federation_config:
        ::core::option::Option<WorkforceIdentityFederationConfig>,
}
...
pub struct PullRequest {
    ...
    #[serde(default)]
    pub base: ::core::option::Option<Branch>,
    ...
    #[serde(default)]
    pub head: ::core::option::Option<Branch>,
...
pub struct Repository {
    ...
    pub initial_config: ::core::option::Option<InitialConfig>,
...
pub struct PrivateConfig {
    ...
    pub custom_host_config: ::core::option::Option<CustomHostConfig>,
