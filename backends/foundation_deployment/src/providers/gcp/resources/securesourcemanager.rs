//! Auto-generated resource types for Google Cloud Platform - securesourcemanager.
//!
//! This file is generated by `cargo run --bin ewe_platform gen_resource_types`.
//! DO NOT EDIT MANUALLY.
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/securesourcemanager/openapi.json`.
...
pub struct BatchCreatePullRequestCommentsRequest {
    ...
    #[serde(default)]
    pub requests:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<CreatePullRequestCommentRequest>>>,
}
...
pub struct BatchCreatePullRequestCommentsResponse {
    ...
    pub pull_request_comments:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PullRequestComment>>>,
}
...
pub struct Branch {
    ...
    #[serde(default)]
    pub sha: ::core::option::Option<String>,
}
...
pub struct BranchRule {
    ...
    pub allow_stale_reviews: ::core::option::Option<bool>,
    ...
    #[serde(default, rename = "includePattern")]
    pub include_pattern: ::core::option::Option<String>,
    /// Optional. The minimum number of approvals required for the branch rule to be matched.
    #[serde(default, rename = "minimumApprovalsCount")]
    pub minimum_approvals_count: ::core::option::Option<i32>,
    /// Optional. The minimum number of reviews required for the branch rule to be matched.
    #[serde(default, rename = "minimumReviewsCount")]
    pub minimum_reviews_count: ::core::option::Option<i32>,
    ...
    #[serde(default, rename = "requireCodeOwnerApproval")]
    pub require_code_owner_approval: ::core::option::Option<bool>,
    /// Optional. Determines if require comments resolved before merging to the branch.
    #[serde(default, rename = "requireCommentsResolved")]
    pub require_comments_resolved: ::core::option::Option<bool>,
    /// Optional. Determines if require linear history before merging to the branch.
    #[serde(default, rename = "requireLinearHistory")]
    pub require_linear_history: ::core::option::Option<bool>,
    /// Optional. Determines if the branch rule requires a pull request or not.
    #[serde(default, rename = "requirePullRequest")]
    pub require_pull_request: ::core::option::Option<bool>,
    /// Optional. List of required status checks before merging to the branch.
    #[serde(default, rename = "requiredStatusChecks")]
    pub required_status_checks: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Check>>>,
...
pub struct Code {
    ...
    #[serde(default, rename = "effectiveCommitSha")]
    pub effective_commit_sha: ::core::option::Option<String>,
    /// Output only. The root comment of the conversation, derived from the reply field.
    #[serde(default, rename = "effectiveRootComment")]
    pub effective_root_comment: ::core::option::Option<String>,
...
pub struct CreatePullRequestCommentRequest {
    ...
    #[serde(default, rename = "pullRequestComment")]
    pub pull_request_comment: ::core::option::Option<::std::boxed::Box<PullRequestComment>>,
}
...
pub struct FetchTreeResponse {
    ...
    #[serde(default, rename = "treeEntries")]
    pub tree_entries: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TreeEntry>>>,
}
...
pub struct Hook {
    ...
    #[serde(default, rename = "pushOption")]
    pub push_option: ::core::option::Option<::std::boxed::Box<PushOption>>,
    /// Optional. The sensitive query string to be appended to the target URI.
    #[serde(default, rename = "sensitiveQueryString")]
    pub sensitive_query_string: ::core::option::Option<String>,
...
pub struct InitialConfig {
    ...
    #[serde(default)]
    pub gitignores: ::core::option::Option<::std::vec::Vec<String>>,
    ...
    #[serde(default)]
    pub readme: ::core::option::Option<String>,
}
...
pub struct Instance {
    ...
    pub host_config: ::core::option::Option<::std::boxed::Box<HostConfig>>,
    ...
    #[serde(default, rename = "privateConfig")]
    pub private_config: ::core::option::Option<::std::boxed::Box<PrivateConfig>>,
    /// Output only. Current state of the instance. // TODO: enum values: ["STATE_UNSPECIFIED", "CREATING", "ACTIVE", "DELETING", "PAUSED", "UNKNOWN"]
    #[serde(default)]
    pub state: ::core::option::Option<String>,
    /// Output only. An optional field providing information about the current instance state. // TODO: enum values: ["STATE_NOTE_UNSPECIFIED", "PAUSED_CMEK_UNAVAILABLE", "INSTANCE_RESUMING"]
    #[serde(default, rename = "stateNote")]
    pub state_note: ::core::option::Option<String>,
    /// Output only. Update timestamp.
    #[serde(default, rename = "updateTime")]
    pub update_time: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "workforceIdentityFederationConfig")]
    pub workforce_identity_federation_config:
        ::core::option::Option<::std::boxed::Box<WorkforceIdentityFederationConfig>>,
}
...
pub struct Issue {
    ...
    #[serde(default)]
    pub name: ::core::option::Option<String>,
    /// Output only. State of the issue. // TODO: enum values: ["STATE_UNSPECIFIED", "OPEN", "CLOSED"]
    #[serde(default)]
    pub state: ::core::option::Option<String>,
...
pub struct ListBranchRulesResponse {
    ...
    pub branch_rules: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<BranchRule>>>,
    /// A token identifying a page of results the server should return.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct ListHooksResponse {
    /// The list of hooks.
    #[serde(default)]
    pub hooks: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Hook>>>,
    /// A token identifying a page of results the server should return.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct ListIssueCommentsResponse {
    ...
    pub issue_comments: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<IssueComment>>>,
    /// A token identifying a page of results the server should return.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct ListPullRequestFileDiffsResponse {
    ...
    pub file_diffs: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<FileDiff>>>,
    /// A token identifying a page of results the server should return.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct ListPullRequestsResponse {
    ...
    pub pull_requests: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PullRequest>>>,
}
...
pub struct PrivateConfig {
    ...
    #[serde(default, rename = "customHostConfig")]
    pub custom_host_config: ::core::option::Option<::std::boxed::Box<CustomHostConfig>>,
    ...
    #[serde(default, rename = "httpServiceAttachment")]
    pub http_service_attachment: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "pscAllowedProjects")]
    pub psc_allowed_projects: ::core::option::Option<::std::vec::Vec<String>>,
    ...
    #[serde(default, rename = "sshServiceAttachment")]
    pub ssh_service_attachment: ::core::option::Option<String>,
}
...
pub struct PullRequest {
    ...
    #[serde(default)]
    pub base: ::core::option::Option<::std::boxed::Box<Branch>>,
    ...
    #[serde(default)]
    pub head: ::core::option::Option<::std::boxed::Box<Branch>>,
    ...
    #[serde(default)]
    pub name: ::core::option::Option<String>,
    /// Output only. State of the pull request (open, closed or merged). // TODO: enum values: ["STATE_UNSPECIFIED", "OPEN", "CLOSED", "MERGED"]
    #[serde(default)]
    pub state: ::core::option::Option<String>,
...
pub struct PullRequestComment {
    ...
    #[serde(default)]
    pub code: ::core::option::Option<::std::boxed::Box<Code>>,
...
pub struct PushOption {
    ...
    pub branch_filter: ::core::option::Option<String>,
}
...
pub struct Repository {
    ...
    #[serde(default, rename = "initialConfig")]
    pub initial_config: ::core::option::Option<::std::boxed::Box<InitialConfig>>,
...
pub struct ResolvePullRequestCommentsRequest {
    ...
    pub auto_fill: ::core::option::Option<bool>,
...
pub struct TreeEntry {
    ...
    /// Output only. The type of the object (TREE, BLOB, COMMIT). Output-only. // TODO: enum values: ["OBJECT_TYPE_UNSPECIFIED", "TREE", "BLOB", "COMMIT"]
...
pub struct URIs {
    ...
    #[serde(default, rename = "gitHttps")]
    pub git_https: ::core::option::Option<String>,
