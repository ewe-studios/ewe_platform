...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/config/openapi.json`.
...
pub struct Deployment {
    ...
    pub delete_results: ::core::option::Option<::std::boxed::Box<ApplyResults>>,
    ...
    pub provider_config: ::core::option::Option<::std::boxed::Box<ProviderConfig>>,
    ...
    pub terraform_blueprint: ::core::option::Option<::std::boxed::Box<TerraformBlueprint>>,
    ...
    pub tf_errors: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TerraformError>>>,
...
pub struct DeploymentGroup {
    ...
    pub deployment_units:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DeploymentUnit>>>,
    ...
    pub provisioning_error: ::core::option::Option<::std::boxed::Box<Status>>,
...
pub struct DeploymentGroupRevision {
    ...
    #[serde(default)]
    pub snapshot: ::core::option::Option<::std::boxed::Box<DeploymentGroup>>,
}
...
pub struct DeploymentOperationMetadata {
    ...
    pub apply_results: ::core::option::Option<::std::boxed::Box<ApplyResults>>,
...
pub struct DeploymentUnitProgress {
    ...
    pub deployment_operation_summary:
        ::core::option::Option<::std::boxed::Box<DeploymentOperationSummary>>,
...
pub struct ExportPreviewResultResponse {
    ...
    #[serde(default)]
    pub result: ::core::option::Option<::std::boxed::Box<PreviewResult>>,
}
...
pub struct ExternalValueSource {
    ...
    pub deployment_source: ::core::option::Option<::std::boxed::Box<DeploymentSource>>,
}
...
pub struct ListDeploymentGroupRevisionsResponse {
    ...
    pub deployment_group_revisions:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DeploymentGroupRevision>>>,
...
pub struct ListDeploymentGroupsResponse {
    ...
    pub deployment_groups:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DeploymentGroup>>>,
...
pub struct ListPreviewsResponse {
    ...
    /// List of Previews.
    #[serde(default)]
    pub previews: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Preview>>>,
    /// Locations that could not be reached.
    #[serde(default)]
    pub unreachable: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct ListResourceChangesResponse {
    ...
    pub resource_changes:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ResourceChange>>>,
...
pub struct ListResourceDriftsResponse {
    ...
    pub resource_drifts: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ResourceDrift>>>,
    /// Unreachable resources, if any.
    #[serde(default)]
    pub unreachable: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct ListTerraformVersionsResponse {
    ...
    pub terraform_versions:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TerraformVersion>>>,
    /// Unreachable resources, if any.
    #[serde(default)]
    pub unreachable: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct OperationMetadata {
    ...
    pub deployment_metadata: ::core::option::Option<::std::boxed::Box<DeploymentOperationMetadata>>,
    /// Output only. Time when the operation finished running.
    #[serde(default, rename = "endTime")]
    pub end_time: ::core::option::Option<String>,
    /// Output only. Metadata about the preview operation state.
    #[serde(default, rename = "previewMetadata")]
    pub preview_metadata: ::core::option::Option<::std::boxed::Box<PreviewOperationMetadata>>,
    ...
    pub provision_deployment_group_metadata:
        ::core::option::Option<::std::boxed::Box<ProvisionDeploymentGroupOperationMetadata>>,
...
pub struct Preview {
    ...
    pub preview_artifacts: ::core::option::Option<::std::boxed::Box<PreviewArtifacts>>,
...
pub struct ProvisionDeploymentGroupOperationMetadata {
    ...
    pub deployment_unit_progresses:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DeploymentUnitProgress>>>,
...
pub struct Resource {
    ...
    pub terraform_info: ::core::option::Option<::std::boxed::Box<ResourceTerraformInfo>>,
}
...
pub struct ResourceChange {
    ...
    pub property_changes:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PropertyChange>>>,
    /// Output only. Terraform info of the resource change.
    #[serde(default, rename = "terraformInfo")]
    pub terraform_info: ::core::option::Option<::std::boxed::Box<ResourceChangeTerraformInfo>>,
}
...
pub struct ResourceDrift {
    ...
    pub property_drifts: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PropertyDrift>>>,
    /// Output only. Terraform info of the resource drift.
    #[serde(default, rename = "terraformInfo")]
    pub terraform_info: ::core::option::Option<::std::boxed::Box<ResourceDriftTerraformInfo>>,
}
...
pub struct TerraformBlueprint {
    ...
    pub git_source: ::core::option::Option<::std::boxed::Box<GitSource>>,
