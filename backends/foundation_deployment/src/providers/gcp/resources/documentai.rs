...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/documentai/openapi.json`.
...
pub struct CloudAiDocumentaiLabHifiaToolsValidationValidatorInput {
    ...
    pub validation_rules: ::core::option::Option<
        ::std::vec::Vec<
            ::std::boxed::Box<CloudAiDocumentaiLabHifiaToolsValidationValidatorInputValidationRule>,
        >,
    >,
}
...
pub struct CloudAiDocumentaiLabHifiaToolsValidationValidatorInputValidationRuleFormValidationOperation {
    ...
    #[serde(default)]
    pub constants: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<CloudAiDocumentaiLabHifiaToolsValidationValidatorInputValidationRuleConstant>>>,
    /// A list of fields to be used as operands.
    #[serde(default)]
    pub fields: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<CloudAiDocumentaiLabHifiaToolsValidationValidatorInputValidationRuleField>>>,
    ...
    #[serde(default)]
    pub operations: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<CloudAiDocumentaiLabHifiaToolsValidationValidatorInputValidationRuleFormValidationOperation>>>,
}
...
pub struct GoogleCloudDocumentaiUiv1beta3AutoLabelDocumentsMetadata {
    ...
    pub common_metadata: ::core::option::Option<
...
pub struct GoogleCloudDocumentaiUiv1beta3AutoLabelDocumentsMetadataIndividualAutoLabelStatus {
    ...
    pub document_id:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3DocumentId>>,
...
pub struct GoogleCloudDocumentaiUiv1beta3BatchDeleteDocumentsMetadata {
    /// The basic metadata of the long-running operation.
    #[serde(default, rename = "commonMetadata")]
    pub common_metadata: ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3CommonOperationMetadata>>,
    ...
    pub individual_batch_delete_statuses: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3BatchDeleteDocumentsMetadataIndividualBatchDeleteStatus>>>,
...
pub struct GoogleCloudDocumentaiUiv1beta3BatchUpdateDocumentsMetadata {
    ...
    pub individual_batch_update_statuses: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3BatchUpdateDocumentsMetadataIndividualBatchUpdateStatus>>>,
}
...
pub struct GoogleCloudDocumentaiUiv1beta3DocumentId {
    ...
    pub gcs_managed_doc_id: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3DocumentIdGCSManagedDocumentId>,
    >,
    /// Points to a specific revision of the document if set.
    #[serde(default, rename = "revisionRef")]
    pub revision_ref:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3RevisionRef>>,
    /// A document id within unmanaged dataset.
    #[serde(default, rename = "unmanagedDocId")]
    pub unmanaged_doc_id: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3DocumentIdUnmanagedDocumentId>,
    >,
}
...
pub struct GoogleCloudDocumentaiUiv1beta3DocumentSchema {
    ...
    pub entity_types: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3DocumentSchemaEntityType>>,
    >,
    /// Metadata of the schema.
    #[serde(default)]
    pub metadata: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3DocumentSchemaMetadata>,
    >,
}
...
pub struct GoogleCloudDocumentaiUiv1beta3DocumentSchemaEntityType {
    ...
    pub entity_type_metadata:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3EntityTypeMetadata>>,
    /// If specified, lists all the possible values for this entity. This should not be more than a handful of values. If the number of values is &gt;10 or could change frequently, use the EntityType.value_ontology field and specify a list of all possible values in a value ontology file.
    #[serde(default, rename = "enumValues")]
    pub enum_values: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3DocumentSchemaEntityTypeEnumValues>,
    >,
    ...
    pub properties: ::core::option::Option<
        ::std::vec::Vec<
            ::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3DocumentSchemaEntityTypeProperty>,
        >,
    >,
}
...
pub struct GoogleCloudDocumentaiUiv1beta3DocumentSchemaEntityTypeProperty {
    ...
    pub property_metadata:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3PropertyMetadata>>,
...
pub struct GoogleCloudDocumentaiUiv1beta3EntityTypeMetadata {
    ...
    pub field_tier_metadata:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3FieldTierMetadata>>,
    /// Human review labeling config on the entity.
    #[serde(default, rename = "humanReviewLabelingMetadata")]
    pub human_review_labeling_metadata: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3HumanReviewLabelingMetadata>,
    >,
    /// Human review config on the entity.
    #[serde(default, rename = "humanReviewMetadata")]
    pub human_review_metadata: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3HumanReviewValidationMetadata>,
    >,
    ...
    pub schema_editability_metadata: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3SchemaEditabilityMetadata>,
    >,
    /// Schema inference metadata on the entity.
    #[serde(default, rename = "schemaInferenceMetadata")]
    pub schema_inference_metadata: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3SchemaInferenceMetadata>,
    >,
}
...
pub struct GoogleCloudDocumentaiUiv1beta3EvaluationReference {
    ...
    pub aggregate_metrics:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3EvaluationMetrics>>,
...
pub struct GoogleCloudDocumentaiUiv1beta3ExportDocumentsMetadata {
    ...
    pub split_export_stats: ::core::option::Option<
        ::std::vec::Vec<
            ::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3ExportDocumentsMetadataSplitExportStat>,
        >,
    >,
}
...
pub struct GoogleCloudDocumentaiUiv1beta3FieldExtractionMetadata {
    ...
    pub entity_query: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3FieldExtractionMetadataEntityQuery>,
    >,
    /// Summary options config.
    #[serde(default, rename = "summaryOptions")]
    pub summary_options:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3SummaryOptions>>,
}
...
pub struct GoogleCloudDocumentaiUiv1beta3Processor {
    ...
    pub processor_version_aliases: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3ProcessorVersionAlias>>,
    >,
...
pub struct GoogleCloudDocumentaiUiv1beta3ProcessorVersion {
    ...
    pub deprecation_info: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3ProcessorVersionDeprecationInfo>,
    >,
    ...
    pub document_schema:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3DocumentSchema>>,
    /// Output only. Information about Generative AI model-based processor versions.
    #[serde(default, rename = "genAiModelInfo")]
    pub gen_ai_model_info: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3ProcessorVersionGenAiModelInfo>,
    >,
    ...
    pub latest_evaluation: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3EvaluationReference>,
    >,
    ...
    #[serde(default)]
    pub schema: ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3Schema>>,
...
pub struct GoogleCloudDocumentaiUiv1beta3PropertyMetadata {
    ...
    pub field_extraction_metadata: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiUiv1beta3FieldExtractionMetadata>,
    >,
    /// Field tier metadata on the property
    #[serde(default, rename = "fieldTierMetadata")]
    pub field_tier_metadata:
...
pub struct GoogleCloudDocumentaiUiv1beta3SampleDocumentsResponse {
    ...
    pub sample_test_status: ::core::option::Option<::std::boxed::Box<GoogleRpcStatus>>,
    /// The status of sampling documents in training split.
    #[serde(default, rename = "sampleTrainingStatus")]
    pub sample_training_status: ::core::option::Option<::std::boxed::Box<GoogleRpcStatus>>,
...
pub struct GoogleCloudDocumentaiUiv1beta3TrainProcessorVersionMetadataDatasetValidation {
    ...
    pub dataset_errors: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleRpcStatus>>>,
...
pub struct GoogleCloudDocumentaiV1BatchDocumentsInputConfig {
    ...
    pub gcs_documents:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1GcsDocuments>>,
    /// The set of documents that match the specified Cloud Storage gcs_prefix.
    #[serde(default, rename = "gcsPrefix")]
    pub gcs_prefix: ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1GcsPrefix>>,
}
...
pub struct GoogleCloudDocumentaiV1BatchProcessMetadata {
    ...
    pub individual_process_statuses: ::core::option::Option<
        ::std::vec::Vec<
            ::std::boxed::Box<GoogleCloudDocumentaiV1BatchProcessMetadataIndividualProcessStatus>,
        >,
    >,
...
pub struct GoogleCloudDocumentaiV1BatchProcessMetadataIndividualProcessStatus {
    ...
    pub human_review_status:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1HumanReviewStatus>>,
...
pub struct GoogleCloudDocumentaiV1BatchProcessRequest {
    ...
    pub document_output_config:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1DocumentOutputConfig>>,
    /// The input documents for the BatchProcessDocuments method.
    #[serde(default, rename = "inputDocuments")]
    pub input_documents:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1BatchDocumentsInputConfig>>,
    ...
    pub process_options:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1ProcessOptions>>,
...
pub struct GoogleCloudDocumentaiV1DeleteProcessorMetadata {
    ...
    #[serde(default, rename = "commonMetadata")]
    pub common_metadata:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1CommonOperationMetadata>>,
}
...
pub struct GoogleCloudDocumentaiV1Document {
    ...
    pub entities_revisions: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1DocumentEntitiesRevision>>,
    >,
    ...
    pub entity_validation_output: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiV1DocumentEntityValidationOutput>,
    >,
...
pub struct GoogleCloudDocumentaiV1DocumentOutputConfig {
    ...
    pub gcs_output_config: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiV1DocumentOutputConfigGcsOutputConfig>,
    >,
}
...
pub struct GoogleCloudDocumentaiV1DocumentOutputConfigGcsOutputConfig {
    ...
    pub sharding_config: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiV1DocumentOutputConfigGcsOutputConfigShardingConfig>,
    >,
}
...
pub struct GoogleCloudDocumentaiV1DocumentSchema {
    ...
    #[serde(default, rename = "entityTypes")]
    pub entity_types: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1DocumentSchemaEntityType>>,
    >,
    /// Metadata of the schema.
    #[serde(default)]
    pub metadata:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1DocumentSchemaMetadata>>,
}
...
pub struct GoogleCloudDocumentaiV1DocumentSchemaEntityType {
    ...
    #[serde(default, rename = "enumValues")]
    pub enum_values: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiV1DocumentSchemaEntityTypeEnumValues>,
    >,
    /// Name of the type. It must be unique within the schema file and cannot be a "Common Type". The following naming conventions are used: - Use snake_casing. - Name matching is case-sensitive. - Maximum 64 characters. - Must start with a letter. - Allowed characters: ASCII letters [a-z0-9_-]. (For backward compatibility, internal infrastructure and tooling can handle any ASCII character.) - The / is sometimes used to denote a property of a type. For example line_item/amount. This convention is deprecated, but will still be honored for backward compatibility.
    #[serde(default)]
    pub name: ::core::option::Option<String>,
    ...
    #[serde(default)]
    pub properties: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1DocumentSchemaEntityTypeProperty>>,
    >,
}
...
pub struct GoogleCloudDocumentaiV1Documents {
    ...
    #[serde(default)]
    pub documents:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1Document>>>,
}
...
pub struct GoogleCloudDocumentaiV1Evaluation {
    ...
    pub all_entities_metrics: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics>,
    >,
    ...
    pub document_counters:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1EvaluationCounters>>,
    ...
    #[serde(default)]
    pub revisions: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1EvaluationEvaluationRevision>>,
    >,
}
...
pub struct GoogleCloudDocumentaiV1EvaluationConfidenceLevelMetrics {
    ...
    #[serde(default)]
    pub metrics:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1EvaluationMetrics>>,
}
...
pub struct GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics {
    ...
    pub confidence_level_metrics: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1EvaluationConfidenceLevelMetrics>>,
    >,
...
pub struct GoogleCloudDocumentaiV1FetchProcessorTypesResponse {
    ...
    pub processor_types: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1ProcessorType>>,
    >,
}
...
pub struct GoogleCloudDocumentaiV1GcsDocuments {
    ...
    pub documents: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1GcsDocument>>,
    >,
}
...
pub struct GoogleCloudDocumentaiV1GenerateSchemaVersionRequest {
    ...
    pub inline_documents:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1Documents>>,
    /// The set of raw documents.
    #[serde(default, rename = "rawDocuments")]
    pub raw_documents:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1RawDocuments>>,
}
...
pub struct GoogleCloudDocumentaiV1GenerateSchemaVersionRequestGenerateSchemaVersionParams {
    ...
    #[serde(default)]
    pub history:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1SchemaGenerationHistory>>,
...
pub struct GoogleCloudDocumentaiV1GenerateSchemaVersionResponse {
    ...
    pub schema_version:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1SchemaVersion>>,
}
...
pub struct GoogleCloudDocumentaiV1ListEvaluationsResponse {
    ...
    pub evaluations: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1Evaluation>>,
    >,
...
pub struct GoogleCloudDocumentaiV1ListProcessorVersionsResponse {
    ...
    #[serde(default, rename = "processorVersions")]
    pub processor_versions: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1ProcessorVersion>>,
    >,
}
...
pub struct GoogleCloudDocumentaiV1ListProcessorsResponse {
    ...
    /// The list of processors.
    #[serde(default)]
    pub processors: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1Processor>>,
    >,
}
...
pub struct GoogleCloudDocumentaiV1ListSchemaVersionsResponse {
    ...
    pub schema_versions: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1SchemaVersion>>,
    >,
}
...
pub struct GoogleCloudDocumentaiV1ListSchemasResponse {
    ...
    /// The list of Schemas.
    #[serde(default)]
    pub schemas: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1NextSchema>>,
    >,
}
...
pub struct GoogleCloudDocumentaiV1OcrConfig {
    ...
    #[serde(default)]
    pub hints: ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1OcrConfigHints>>,
    /// Configurations for premium OCR features.
    #[serde(default, rename = "premiumFeatures")]
    pub premium_features:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1OcrConfigPremiumFeatures>>,
}
...
pub struct GoogleCloudDocumentaiV1ProcessOptions {
    ...
    pub individual_page_selector: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiV1ProcessOptionsIndividualPageSelector>,
    >,
    ...
    pub layout_config: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiV1ProcessOptionsLayoutConfig>,
    >,
    ...
    pub ocr_config: ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1OcrConfig>>,
    ...
    pub schema_override:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1DocumentSchema>>,
}
...
pub struct GoogleCloudDocumentaiV1ProcessOptionsLayoutConfig {
    ...
    pub chunking_config: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiV1ProcessOptionsLayoutConfigChunkingConfig>,
    >,
...
pub struct GoogleCloudDocumentaiV1ProcessRequest {
    ...
    pub gcs_document: ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1GcsDocument>>,
    ...
    pub inline_document: ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1Document>>,
    /// Optional. The labels with user-defined metadata for the request. Label keys and values can be no longer than 63 characters (Unicode codepoints) and can only contain lowercase letters, numeric characters, underscores, and dashes. International characters are allowed. Label values are optional. Label keys must start with a letter.
    #[serde(default)]
    pub labels: ::core::option::Option<serde_json::Value>,
    /// Inference-time options for the process API
    ...
    pub raw_document: ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1RawDocument>>,
    /// Whether human review should be skipped for this request. Default to false.
    #[serde(default, rename = "skipHumanReview")]
    pub skip_human_review: ::core::option::Option<bool>,
}
...
pub struct GoogleCloudDocumentaiV1ProcessResponse {
    ...
    #[serde(default)]
    pub document: ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1Document>>,
    /// The status of human review on the processed document.
    #[serde(default, rename = "humanReviewStatus")]
    pub human_review_status:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1HumanReviewStatus>>,
...
pub struct GoogleCloudDocumentaiV1Processor {
    ...
    #[serde(default, rename = "processorVersionAliases")]
    pub processor_version_aliases: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1ProcessorVersionAlias>>,
    >,
    /// Output only. Reserved for future use.
    #[serde(default, rename = "satisfiesPzi")]
    pub satisfies_pzi: ::core::option::Option<bool>,
...
pub struct GoogleCloudDocumentaiV1ProcessorType {
    ...
    pub available_locations: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1ProcessorTypeLocationInfo>>,
    >,
...
pub struct GoogleCloudDocumentaiV1ProcessorVersion {
    ...
    #[serde(default, rename = "deprecationInfo")]
    pub deprecation_info: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiV1ProcessorVersionDeprecationInfo>,
    >,
    /// The display name of the processor version.
    #[serde(default, rename = "displayName")]
    pub display_name: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "genAiModelInfo")]
    pub gen_ai_model_info: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiV1ProcessorVersionGenAiModelInfo>,
    >,
    /// Output only. Denotes that this ProcessorVersion is managed by Google.
    #[serde(default, rename = "googleManaged")]
    pub google_managed: ::core::option::Option<bool>,
    ...
    pub latest_evaluation:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1EvaluationReference>>,
    /// Output only. The model type of this processor version. // TODO: enum values: ["MODEL_TYPE_UNSPECIFIED", "MODEL_TYPE_GENERATIVE", "MODEL_TYPE_CUSTOM"]
    #[serde(default, rename = "modelType")]
    pub model_type: ::core::option::Option<String>,
    /// Identifier. The resource name of the processor version. Format: projects/{project}/locations/{location}/processors/{processor}/processorVersions/{processor_version}
...
pub struct GoogleCloudDocumentaiV1RawDocuments {
    ...
    #[serde(default)]
    pub documents: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1RawDocument>>,
    >,
}
...
pub struct GoogleCloudDocumentaiV1SchemaGenerationHistory {
    ...
    #[serde(default)]
    pub iterations: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1SchemaGenerationIteration>>,
    >,
}
...
pub struct GoogleCloudDocumentaiV1SchemaVersion {
    ...
    #[serde(default)]
    pub schema: ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1DocumentSchema>>,
}
...
pub struct GoogleCloudDocumentaiV1TrainProcessorVersionMetadata {
    ...
    #[serde(default, rename = "testDatasetValidation")]
    pub test_dataset_validation: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiV1TrainProcessorVersionMetadataDatasetValidation>,
    >,
    /// The training dataset validation information.
    #[serde(default, rename = "trainingDatasetValidation")]
    pub training_dataset_validation: ::core::option::Option<
...
pub struct GoogleCloudDocumentaiV1TrainProcessorVersionRequest {
    ...
    pub input_data: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiV1TrainProcessorVersionRequestInputData>,
    >,
    /// Required. The processor version to be created.
    #[serde(default, rename = "processorVersion")]
    pub processor_version:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1ProcessorVersion>>,
}
...
pub struct GoogleCloudDocumentaiV1beta3BatchDeleteDocumentsMetadataIndividualBatchDeleteStatus {
    ...
    #[serde(default, rename = "documentId")]
    pub document_id:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta3DocumentId>>,
    /// The status of deleting the document in storage.
    #[serde(default)]
    pub status: ::core::option::Option<::std::boxed::Box<GoogleRpcStatus>>,
}
...
pub struct GoogleCloudDocumentaiV1beta3BatchProcessMetadataIndividualProcessStatus {
    ...
    #[serde(default, rename = "humanReviewStatus")]
    pub human_review_status:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta3HumanReviewStatus>>,
    /// The source of the document, same as the input_gcs_source field in the request when the batch process started.
    #[serde(default, rename = "inputGcsSource")]
    pub input_gcs_source: ::core::option::Option<String>,
    /// The Cloud Storage output destination (in the request as DocumentOutputConfig.GcsOutputConfig.gcs_uri) of the processed document if it was successful, otherwise empty.
...
pub struct GoogleCloudDocumentaiV1beta3Dataset {
    ...
    pub document_warehouse_config: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiV1beta3DatasetDocumentWarehouseConfig>,
    >,
    ...
    pub gcs_managed_config: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiV1beta3DatasetGCSManagedConfig>,
    >,
...
pub struct GoogleCloudDocumentaiV1beta3DatasetGCSManagedConfig {
    ...
    #[serde(default, rename = "gcsPrefix")]
    pub gcs_prefix:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta3GcsPrefix>>,
}
...
pub struct GoogleCloudDocumentaiV1beta3DocumentId {
    ...
    #[serde(default, rename = "gcsManagedDocId")]
    pub gcs_managed_doc_id: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiV1beta3DocumentIdGCSManagedDocumentId>,
    >,
    /// Points to a specific revision of the document if set.
    #[serde(default, rename = "revisionRef")]
    pub revision_ref:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta3RevisionRef>>,
    /// A document id within unmanaged dataset.
    #[serde(default, rename = "unmanagedDocId")]
    pub unmanaged_doc_id: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiV1beta3DocumentIdUnmanagedDocumentId>,
    >,
}
...
pub struct GoogleCloudDocumentaiV1beta3DocumentSchema {
    ...
    #[serde(default, rename = "entityTypes")]
    pub entity_types: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1beta3DocumentSchemaEntityType>>,
    >,
    /// Metadata of the schema.
    #[serde(default)]
    pub metadata: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiV1beta3DocumentSchemaMetadata>,
    >,
}
...
pub struct GoogleCloudDocumentaiV1beta3DocumentSchemaEntityType {
    ...
    #[serde(default, rename = "entityTypeMetadata")]
    pub entity_type_metadata:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta3EntityTypeMetadata>>,
    /// If specified, lists all the possible values for this entity. This should not be more than a handful of values. If the number of values is &gt;10 or could change frequently, use the EntityType.value_ontology field and specify a list of all possible values in a value ontology file.
    #[serde(default, rename = "enumValues")]
    pub enum_values: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiV1beta3DocumentSchemaEntityTypeEnumValues>,
    >,
    /// Name of the type. It must be unique within the schema file and cannot be a "Common Type". The following naming conventions are used: - Use snake_casing. - Name matching is case-sensitive. - Maximum 64 characters. - Must start with a letter. - Allowed characters: ASCII letters [a-z0-9_-]. (For backward compatibility, internal infrastructure and tooling can handle any ASCII character.) - The / is sometimes used to denote a property of a type. For example line_item/amount. This convention is deprecated, but will still be honored for backward compatibility.
    #[serde(default)]
    pub name: ::core::option::Option<String>,
    ...
    pub properties: ::core::option::Option<
        ::std::vec::Vec<
            ::std::boxed::Box<GoogleCloudDocumentaiV1beta3DocumentSchemaEntityTypeProperty>,
        >,
    >,
}
...
pub struct GoogleCloudDocumentaiV1beta3DocumentSchemaEntityTypeProperty {
    ...
    #[serde(default, rename = "propertyMetadata")]
    pub property_metadata:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta3PropertyMetadata>>,
    /// A reference to the value type of the property. This type is subject to the same conventions as the Entity.base_types field.
    #[serde(default, rename = "valueType")]
    pub value_type: ::core::option::Option<String>,
}
...
pub struct GoogleCloudDocumentaiV1beta3EvaluationReference {
    ...
    #[serde(default, rename = "aggregateMetrics")]
    pub aggregate_metrics:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta3EvaluationMetrics>>,
    /// An aggregate of the statistics for the evaluation with fuzzy matching off.
    #[serde(default, rename = "aggregateMetricsExact")]
    pub aggregate_metrics_exact:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta3EvaluationMetrics>>,
...
pub struct GoogleCloudDocumentaiV1beta3FieldExtractionMetadata {
    ...
    #[serde(default, rename = "summaryOptions")]
    pub summary_options:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta3SummaryOptions>>,
}
...
pub struct GoogleCloudDocumentaiV1beta3Processor {
    ...
    #[serde(default, rename = "processorVersionAliases")]
    pub processor_version_aliases: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudDocumentaiV1beta3ProcessorVersionAlias>>,
    >,
    /// Output only. Reserved for future use.
    #[serde(default, rename = "satisfiesPzi")]
    pub satisfies_pzi: ::core::option::Option<bool>,
...
pub struct GoogleCloudDocumentaiV1beta3ProcessorVersion {
    ...
    #[serde(default, rename = "deprecationInfo")]
    pub deprecation_info: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiV1beta3ProcessorVersionDeprecationInfo>,
    >,
    /// The display name of the processor version.
    #[serde(default, rename = "displayName")]
    pub display_name: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "documentSchema")]
    pub document_schema:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta3DocumentSchema>>,
    /// Output only. Information about Generative AI model-based processor versions.
    #[serde(default, rename = "genAiModelInfo")]
    pub gen_ai_model_info: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiV1beta3ProcessorVersionGenAiModelInfo>,
    >,
    /// Output only. Denotes that this ProcessorVersion is managed by Google.
    #[serde(default, rename = "googleManaged")]
    pub google_managed: ::core::option::Option<bool>,
    ...
    #[serde(default, rename = "latestEvaluation")]
    pub latest_evaluation:
        ::core::option::Option<::std::boxed::Box<GoogleCloudDocumentaiV1beta3EvaluationReference>>,
    /// Output only. The model type of this processor version. // TODO: enum values: ["MODEL_TYPE_UNSPECIFIED", "MODEL_TYPE_GENERATIVE", "MODEL_TYPE_CUSTOM"]
    #[serde(default, rename = "modelType")]
    pub model_type: ::core::option::Option<String>,
    /// Identifier. The resource name of the processor version. Format: projects/{project}/locations/{location}/processors/{processor}/processorVersions/{processor_version}
...
pub struct GoogleCloudDocumentaiV1beta3PropertyMetadata {
    ...
    #[serde(default, rename = "fieldExtractionMetadata")]
    pub field_extraction_metadata: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudDocumentaiV1beta3FieldExtractionMetadata>,
    >,
    /// Whether the property should be considered as "inactive".
    #[serde(default)]
    pub inactive: ::core::option::Option<bool>,
