...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/beyondcorp/openapi.json`.
...
pub struct AppGateway {
    ...
    pub allocated_connections:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AllocatedConnection>>>,
...
pub struct CloudSecurityZerotrustApplinkAppConnectorProtoConnectionConfig {
    ...
    pub gateway: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<CloudSecurityZerotrustApplinkAppConnectorProtoGateway>>,
    >,
...
pub struct GoogleCloudBeyondcorpAppconnectionsV1AppConnection {
    ...
    pub application_endpoint: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudBeyondcorpAppconnectionsV1AppConnectionApplicationEndpoint>,
    >,
    ...
    #[serde(default)]
    pub gateway: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudBeyondcorpAppconnectionsV1AppConnectionGateway>,
    >,
    /// Optional. Resource labels to represent user provided metadata.
    #[serde(default)]
    pub labels: ::core::option::Option<serde_json::Value>,
...
pub struct GoogleCloudBeyondcorpAppconnectionsV1ListAppConnectionsResponse {
    ...
    pub app_connections: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudBeyondcorpAppconnectionsV1AppConnection>>,
    >,
...
pub struct GoogleCloudBeyondcorpAppconnectionsV1ResolveAppConnectionsResponse {
    ...
    pub app_connection_details: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudBeyondcorpAppconnectionsV1ResolveAppConnectionsResponseAppConnectionDetails>>>,
    /// A token to retrieve the next page of results, or empty if there are no more results in the list.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// A list of locations that could not be reached.
...
pub struct GoogleCloudBeyondcorpAppconnectionsV1ResolveAppConnectionsResponseAppConnectionDetails {
    ...
    pub app_connection: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudBeyondcorpAppconnectionsV1AppConnection>,
    >,
...
pub struct GoogleCloudBeyondcorpAppconnectorsV1AppConnector {
    ...
    pub principal_info: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfo>,
    >,
...
pub struct GoogleCloudBeyondcorpAppconnectorsV1AppConnectorInstanceConfig {
    ...
    pub image_config:
        ::core::option::Option<::std::boxed::Box<GoogleCloudBeyondcorpAppconnectorsV1ImageConfig>>,
    ...
    pub notification_config: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudBeyondcorpAppconnectorsV1NotificationConfig>,
    >,
...
pub struct GoogleCloudBeyondcorpAppconnectorsV1ListAppConnectorsResponse {
    ...
    pub app_connectors: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudBeyondcorpAppconnectorsV1AppConnector>>,
    >,
    /// A token to retrieve the next page of results, or empty if there are no more results in the list.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
...
pub struct GoogleCloudBeyondcorpAppconnectorsV1ResolveInstanceConfigResponse {
    ...
    pub instance_config: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudBeyondcorpAppconnectorsV1AppConnectorInstanceConfig>,
    >,
}
...
pub struct GoogleCloudBeyondcorpAppconnectorsV1ResourceInfo {
    ...
    pub sub: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudBeyondcorpAppconnectorsV1ResourceInfo>>,
    >,
...
pub struct GoogleCloudBeyondcorpSecuritygatewaysV1Application {
    ...
    pub endpoint_matchers: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudBeyondcorpSecuritygatewaysV1EndpointMatcher>>,
    >,
    ...
    pub upstreams: ::core::option::Option<
        ::std::vec::Vec<
            ::std::boxed::Box<GoogleCloudBeyondcorpSecuritygatewaysV1ApplicationUpstream>,
        >,
    >,
}
...
pub struct GoogleCloudBeyondcorpSecuritygatewaysV1ApplicationUpstream {
    ...
    pub egress_policy: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudBeyondcorpSecuritygatewaysV1EgressPolicy>,
    >,
    /// List of the external endpoints to forward traffic to.
    #[serde(default)]
    pub external: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudBeyondcorpSecuritygatewaysV1ApplicationUpstreamExternal>,
    >,
    /// Network to forward traffic to.
    #[serde(default)]
    pub network: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudBeyondcorpSecuritygatewaysV1ApplicationUpstreamNetwork>,
    >,
    /// Optional. Enables proxy protocol configuration for the upstream.
    #[serde(default, rename = "proxyProtocol")]
    pub proxy_protocol: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudBeyondcorpSecuritygatewaysV1ProxyProtocolConfig>,
    >,
}
...
pub struct GoogleCloudBeyondcorpSecuritygatewaysV1ApplicationUpstreamExternal {
    ...
    pub endpoints: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudBeyondcorpSecuritygatewaysV1Endpoint>>,
    >,
}
...
pub struct GoogleCloudBeyondcorpSecuritygatewaysV1Hub {
    ...
    pub internet_gateway: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudBeyondcorpSecuritygatewaysV1InternetGateway>,
    >,
}
...
pub struct GoogleCloudBeyondcorpSecuritygatewaysV1ListApplicationsResponse {
    ...
    #[serde(default)]
    pub applications: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudBeyondcorpSecuritygatewaysV1Application>>,
    >,
    /// A token to retrieve the next page of results, or empty if there are no more results in the list.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
...
pub struct GoogleCloudBeyondcorpSecuritygatewaysV1ListSecurityGatewaysResponse {
    ...
    pub security_gateways: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudBeyondcorpSecuritygatewaysV1SecurityGateway>>,
    >,
    /// A list of locations that could not be reached.
    #[serde(default)]
    pub unreachable: ::core::option::Option<::std::vec::Vec<String>>,
...
pub struct GoogleCloudBeyondcorpSecuritygatewaysV1ProxyProtocolConfig {
    ...
    pub contextual_headers: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudBeyondcorpSecuritygatewaysV1ContextualHeaders>,
    >,
...
pub struct GoogleCloudBeyondcorpSecuritygatewaysV1SecurityGateway {
    ...
    pub service_discovery: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudBeyondcorpSecuritygatewaysV1ServiceDiscovery>,
    >,
...
pub struct GoogleCloudBeyondcorpSecuritygatewaysV1ServiceDiscovery {
    ...
    pub api_gateway: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudBeyondcorpSecuritygatewaysV1ServiceDiscoveryApiGateway>,
    >,
}
...
pub struct ListAppGatewaysResponse {
    ...
    pub app_gateways: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AppGateway>>>,
    /// A token to retrieve the next page of results, or empty if there are no more results in the list.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// A list of locations that could not be reached.
...
pub struct Tunnelv1ProtoTunnelerInfo {
    ...
    pub latest_err: ::core::option::Option<::std::boxed::Box<Tunnelv1ProtoTunnelerError>>,
