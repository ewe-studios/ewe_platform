...
pub struct CloudSecurityZerotrustApplinkAppConnectorProtoConnectionConfig {
    ...
    #[serde(default)]
    pub gateway: Option<Vec<CloudSecurityZerotrustApplinkAppConnectorProtoGateway>>,
...
pub struct GoogleCloudBeyondcorpAppconnectorsV1ContainerHealthDetails {
    ...
    pub expected_config_version: Option<String>,
...
pub struct GoogleCloudBeyondcorpSecuritygatewaysV1Hub {
    ...
    pub internet_gateway: Option<GoogleCloudBeyondcorpSecuritygatewaysV1InternetGateway>,
}
...
pub struct GoogleCloudBeyondcorpSecuritygatewaysV1InternetGateway {
    ...
    pub assigned_ips: Option<Vec<String>>,
}
...
pub struct Tunnelv1ProtoTunnelerInfo {
    ...
    pub backoff_retry_count: Option<i64>,
    ...
    pub total_retry_count: Option<i64>,
}
