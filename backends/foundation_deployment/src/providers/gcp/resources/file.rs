...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/file/openapi.json`.
...
pub struct DirectoryServicesConfig {
    ...
    #[serde(default)]
    pub ldap: ::core::option::Option<::std::boxed::Box<LdapConfig>>,
}
...
pub struct FileShareConfig {
    ...
    pub nfs_export_options:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<NfsExportOptions>>>,
...
pub struct Instance {
    ...
    pub directory_services: ::core::option::Option<::std::boxed::Box<DirectoryServicesConfig>>,
    ...
    pub performance_limits: ::core::option::Option<::std::boxed::Box<PerformanceLimits>>,
    ...
    #[serde(default)]
    pub replication: ::core::option::Option<::std::boxed::Box<Replication>>,
    /// Output only. Reserved for future use.
    #[serde(default, rename = "satisfiesPzi")]
    pub satisfies_pzi: ::core::option::Option<bool>,
    /// Output only. Reserved for future use.
...
pub struct PerformanceConfig {
    ...
    pub fixed_iops: ::core::option::Option<::std::boxed::Box<FixedIOPS>>,
    ...
    pub iops_per_tb: ::core::option::Option<::std::boxed::Box<IOPSPerTB>>,
}
...
pub struct Replication {
    ...
    #[serde(default)]
    pub replicas: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ReplicaConfig>>>,
