...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/datastore/openapi.json`.
...
pub struct AggregationQuery {
    ...
    pub nested_query: ::core::option::Option<::std::boxed::Box<Query>>,
}
...
pub struct AggregationResultBatch {
    ...
    pub aggregation_results:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AggregationResult>>>,
...
pub struct BeginTransactionRequest {
    ...
    pub transaction_options: ::core::option::Option<::std::boxed::Box<TransactionOptions>>,
}
...
pub struct CommitResponse {
    ...
    pub mutation_results:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<MutationResult>>>,
}
...
pub struct GoogleDatastoreAdminV1ExportEntitiesMetadata {
    /// Metadata common to all Datastore Admin operations.
    #[serde(default)]
    pub common: ::core::option::Option<::std::boxed::Box<GoogleDatastoreAdminV1CommonMetadata>>,
    /// Description of which entities are being exported.
    #[serde(default, rename = "entityFilter")]
    pub entity_filter:
        ::core::option::Option<::std::boxed::Box<GoogleDatastoreAdminV1EntityFilter>>,
    ...
    pub progress_bytes: ::core::option::Option<::std::boxed::Box<GoogleDatastoreAdminV1Progress>>,
    /// An estimate of the number of entities processed.
    #[serde(default, rename = "progressEntities")]
    pub progress_entities:
        ::core::option::Option<::std::boxed::Box<GoogleDatastoreAdminV1Progress>>,
}
...
pub struct GoogleDatastoreAdminV1ListIndexesResponse {
    ...
    #[serde(default)]
    pub indexes:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleDatastoreAdminV1Index>>>,
...
pub struct GoogleDatastoreAdminV1MigrationProgressEvent {
    ...
    pub prepare_step_details:
        ::core::option::Option<::std::boxed::Box<GoogleDatastoreAdminV1PrepareStepDetails>>,
    /// Details for the REDIRECT_WRITES step.
    #[serde(default, rename = "redirectWritesStepDetails")]
    pub redirect_writes_step_details:
        ::core::option::Option<::std::boxed::Box<GoogleDatastoreAdminV1RedirectWritesStepDetails>>,
...
pub struct GoogleDatastoreAdminV1beta1ExportEntitiesMetadata {
    ...
    #[serde(default)]
    pub common:
        ::core::option::Option<::std::boxed::Box<GoogleDatastoreAdminV1beta1CommonMetadata>>,
    /// Description of which entities are being exported.
    #[serde(default, rename = "entityFilter")]
    pub entity_filter:
        ::core::option::Option<::std::boxed::Box<GoogleDatastoreAdminV1beta1EntityFilter>>,
    ...
    #[serde(default, rename = "progressBytes")]
    pub progress_bytes:
        ::core::option::Option<::std::boxed::Box<GoogleDatastoreAdminV1beta1Progress>>,
    /// An estimate of the number of entities processed.
    #[serde(default, rename = "progressEntities")]
    pub progress_entities:
        ::core::option::Option<::std::boxed::Box<GoogleDatastoreAdminV1beta1Progress>>,
...
pub struct GqlQuery {
    ...
    pub positional_bindings:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GqlQueryParameter>>>,
...
pub struct Key {
    ...
    #[serde(default)]
    pub path: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PathElement>>>,
}
...
pub struct LookupRequest {
    ...
    pub property_mask: ::core::option::Option<::std::boxed::Box<PropertyMask>>,
    /// The options for this lookup request.
    #[serde(default, rename = "readOptions")]
    pub read_options: ::core::option::Option<::std::boxed::Box<ReadOptions>>,
}
...
pub struct LookupResponse {
    ...
    #[serde(default)]
    pub deferred: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Key>>>,
    /// Entities found as ResultType.FULL entities. The order of results in this field is undefined and has no relation to the order of the keys in the input.
    #[serde(default)]
    pub found: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<EntityResult>>>,
    /// Entities not found as ResultType.KEY_ONLY entities. The order of results in this field is undefined and has no relation to the order of the keys in the input.
    #[serde(default)]
    pub missing: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<EntityResult>>>,
...
pub struct Mutation {
    ...
    pub property_transforms:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PropertyTransform>>>,
...
pub struct Query {
    ...
    pub distinct_on: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PropertyReference>>>,
    ...
    #[serde(default)]
    pub kind: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<KindExpression>>>,
    ...
    #[serde(default)]
    pub order: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PropertyOrder>>>,
    /// The projection to return. Defaults to returning all properties.
    #[serde(default)]
    pub projection: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Projection>>>,
...
pub struct QueryResultBatch {
    ...
    pub entity_results: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<EntityResult>>>,
...
pub struct RunAggregationQueryRequest {
    ...
    pub aggregation_query: ::core::option::Option<::std::boxed::Box<AggregationQuery>>,
    /// The ID of the database against which to make the request. ''(default)'' is not allowed; please use empty string '''' to refer the default database.
    #[serde(default, rename = "databaseId")]
    pub database_id: ::core::option::Option<String>,
    ...
    pub gql_query: ::core::option::Option<::std::boxed::Box<GqlQuery>>,
...
pub struct RunAggregationQueryResponse {
    ...
    #[serde(default)]
    pub batch: ::core::option::Option<::std::boxed::Box<AggregationResultBatch>>,
    ...
    #[serde(default)]
    pub query: ::core::option::Option<::std::boxed::Box<AggregationQuery>>,
...
pub struct RunQueryResponse {
    ...
    #[serde(default)]
    pub batch: ::core::option::Option<::std::boxed::Box<QueryResultBatch>>,
