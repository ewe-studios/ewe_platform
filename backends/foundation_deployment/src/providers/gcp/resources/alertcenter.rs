...
pub struct AbuseDetected {
    ...
    pub additional_details: ::core::option::Option<::std::boxed::Box<EntityList>>,
...
pub struct AccessApproval {
    ...
    #[serde(default)]
    pub tickets: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SupportTicket>>>,
}
...
pub struct AccountSuspensionWarning {
    ...
    pub suspension_details:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AccountSuspensionDetails>>>,
}
...
pub struct AccountWarning {
    ...
    pub login_details: ::core::option::Option<::std::boxed::Box<LoginDetails>>,
}
...
pub struct Alert {
    ...
    #[serde(default)]
    pub metadata: ::core::option::Option<::std::boxed::Box<AlertMetadata>>,
...
pub struct AppMakerSqlSetupNotification {
    ...
    pub request_info: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<RequestInfo>>>,
}
...
pub struct AppsOutage {
    ...
    pub merge_info: ::core::option::Option<::std::boxed::Box<MergeInfo>>,
...
pub struct Attachment {
    ...
    #[serde(default)]
    pub csv: ::core::option::Option<::std::boxed::Box<Csv>>,
}
...
pub struct BadWhitelist {
    ...
    pub domain_id: ::core::option::Option<::std::boxed::Box<DomainId>>,
    /// The entity whose actions triggered a Gmail phishing alert.
    #[serde(default, rename = "maliciousEntity")]
    pub malicious_entity: ::core::option::Option<::std::boxed::Box<MaliciousEntity>>,
    /// The list of messages contained by this alert.
    #[serde(default)]
    pub messages: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GmailMessageInfo>>>,
...
pub struct ClientSideEncryptionServiceUnavailable {
    ...
    pub idp_error:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<IdentityProviderError>>>,
    /// External key services impacted by an outage or misconfiguration.
    #[serde(default, rename = "keyServiceError")]
    pub key_service_error:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<KeyServiceError>>>,
}
...
pub struct Csv {
    ...
    pub data_rows: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<CsvRow>>>,
...
pub struct DeviceCompromised {
    ...
    #[serde(default)]
    pub events:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DeviceCompromisedSecurityDetail>>>,
}
...
pub struct DlpRuleViolation {
    ...
    pub rule_violation_info: ::core::option::Option<::std::boxed::Box<RuleViolationInfo>>,
}
...
pub struct GoogleOperations {
    ...
    pub attachment_data: ::core::option::Option<::std::boxed::Box<Attachment>>,
...
pub struct ListAlertFeedbackResponse {
    ...
    #[serde(default)]
    pub feedback: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AlertFeedback>>>,
}
...
pub struct MaliciousEntity {
    ...
    #[serde(default)]
    pub entity: ::core::option::Option<::std::boxed::Box<User>>,
...
pub struct MatchInfo {
    ...
    pub predefined_detector: ::core::option::Option<::std::boxed::Box<PredefinedDetectorInfo>>,
    /// For matched detector defined by administrators.
    #[serde(default, rename = "userDefinedDetector")]
    pub user_defined_detector: ::core::option::Option<::std::boxed::Box<UserDefinedDetectorInfo>>,
}
...
pub struct RuleViolationInfo {
    ...
    pub match_info: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<MatchInfo>>>,
    ...
    pub resource_info: ::core::option::Option<::std::boxed::Box<ResourceInfo>>,
    /// Details of the violated rule.
    #[serde(default, rename = "ruleInfo")]
    pub rule_info: ::core::option::Option<::std::boxed::Box<RuleInfo>>,
    ...
    pub triggered_action_info:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ActionInfo>>>,
...
pub struct SensitiveAdminAction {
    ...
    pub primary_admin_changed_event:
        ::core::option::Option<::std::boxed::Box<PrimaryAdminChangedEvent>>,
    ...
    pub sso_profile_created_event:
        ::core::option::Option<::std::boxed::Box<SSOProfileCreatedEvent>>,
    ...
    pub sso_profile_deleted_event:
        ::core::option::Option<::std::boxed::Box<SSOProfileDeletedEvent>>,
    ...
    pub sso_profile_updated_event:
        ::core::option::Option<::std::boxed::Box<SSOProfileUpdatedEvent>>,
    ...
    pub super_admin_password_reset_event:
        ::core::option::Option<::std::boxed::Box<SuperAdminPasswordResetEvent>>,
}
...
pub struct Settings {
    ...
    #[serde(default)]
    pub notifications: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Notification>>>,
}
...
pub struct TransferMisconfiguration {
    ...
    #[serde(default)]
    pub errors: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TransferError>>>,
}
...
pub struct VoiceMisconfiguration {
    ...
    pub members_misconfiguration:
        ::core::option::Option<::std::boxed::Box<TransferMisconfiguration>>,
    ...
    pub voicemail_misconfiguration:
        ::core::option::Option<::std::boxed::Box<VoicemailMisconfiguration>>,
}
...
pub struct VoicemailMisconfiguration {
    ...
    #[serde(default)]
    pub errors: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<VoicemailRecipientError>>>,
}
