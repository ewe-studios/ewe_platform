...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/airquality/openapi.json`.
...
pub struct HourInfo {
    ...
    pub health_recommendations: ::core::option::Option<::std::boxed::Box<HealthRecommendations>>,
    ...
    #[serde(default)]
    pub indexes: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AirQualityIndex>>>,
    ...
    #[serde(default)]
    pub pollutants: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Pollutant>>>,
}
...
pub struct LookupCurrentConditionsRequest {
    ...
    pub custom_local_aqis:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<CustomLocalAqi>>>,
    ...
    #[serde(default)]
    pub location: ::core::option::Option<::std::boxed::Box<LatLng>>,
...
pub struct LookupForecastRequest {
    ...
    #[serde(default)]
    pub period: ::core::option::Option<::std::boxed::Box<Interval>>,
    /// Optional. Determines the color palette used for data provided by the ''Universal Air Quality Index'' (UAQI). This color palette is relevant just for UAQI, other AQIs have a predetermined color palette that can''t be controlled. // TODO: enum values: ["COLOR_PALETTE_UNSPECIFIED", "RED_GREEN", "INDIGO_PERSIAN_DARK", "INDIGO_PERSIAN_LIGHT"]
    #[serde(default, rename = "uaqiColorPalette")]
    pub uaqi_color_palette: ::core::option::Option<String>,
...
pub struct LookupForecastResponse {
    ...
    pub hourly_forecasts:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<HourlyForecast>>>,
...
pub struct LookupHistoryResponse {
    ...
    pub hours_info: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<HourInfo>>>,
    /// Optional. The token to retrieve the next page.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// Optional. The ISO_3166-1 alpha-2 code of the country/region corresponding to the location provided in the request. This field might be omitted from the response if the location provided in the request resides in a disputed territory.
...
pub struct Pollutant {
    ...
    pub additional_info: ::core::option::Option<::std::boxed::Box<AdditionalInfo>>,
    ...
    #[serde(default)]
    pub concentration: ::core::option::Option<::std::boxed::Box<Concentration>>,
