...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/adsense/openapi.json`.
...
pub struct AdUnit {
    ...
    pub content_ads_settings: ::core::option::Option<::std::boxed::Box<ContentAdsSettings>>,
...
pub struct ListAdClientsResponse {
    ...
    pub ad_clients: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AdClient>>>,
...
pub struct ListCustomChannelsResponse {
    ...
    pub custom_channels: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<CustomChannel>>>,
...
pub struct ListPaymentsResponse {
    ...
    #[serde(default)]
    pub payments: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Payment>>>,
}
...
pub struct ListPolicyIssuesResponse {
    ...
    pub policy_issues: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PolicyIssue>>>,
}
...
pub struct ListSavedReportsResponse {
    ...
    pub saved_reports: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SavedReport>>>,
}
...
pub struct ListUrlChannelsResponse {
    ...
    pub url_channels: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<UrlChannel>>>,
}
...
pub struct PolicyIssue {
    ...
    pub first_detected_date: ::core::option::Option<::std::boxed::Box<Date>>,
    ...
    pub last_detected_date: ::core::option::Option<::std::boxed::Box<Date>>,
    ...
    pub policy_topics: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PolicyTopic>>>,
    ...
    pub warning_escalation_date: ::core::option::Option<::std::boxed::Box<Date>>,
}
...
pub struct ReportResult {
    ...
    #[serde(default)]
    pub averages: ::core::option::Option<::std::boxed::Box<Row>>,
    ...
    #[serde(default)]
    pub totals: ::core::option::Option<::std::boxed::Box<Row>>,
...
pub struct Row {
    /// Cells in the row.
    #[serde(default)]
    pub cells: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Cell>>>,
}
