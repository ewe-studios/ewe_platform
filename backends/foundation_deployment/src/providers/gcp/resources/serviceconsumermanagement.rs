...
pub struct V1Beta1BatchCreateProducerOverridesResponse {
    ...
    #[serde(default)]
    pub overrides: Option<Vec<V1Beta1QuotaOverride>>,
}
...
pub struct V1Beta1GenerateServiceIdentityResponse {
    ...
    #[serde(default)]
    pub identity: Option<V1Beta1ServiceIdentity>,
}
...
pub struct V1Beta1ImportProducerQuotaPoliciesResponse {
    ...
    #[serde(default)]
    pub policies: Option<Vec<V1Beta1ProducerQuotaPolicy>>,
}
...
pub struct V1GenerateDefaultIdentityResponse {
    ...
    #[serde(default)]
    pub identity: Option<V1DefaultIdentity>,
...
pub struct V1GenerateServiceAccountResponse {
    ...
    #[serde(default)]
    pub account: Option<V1ServiceAccount>,
}
...
pub struct V1ServiceAccount {
    ...
    pub iam_account_name: Option<String>,
