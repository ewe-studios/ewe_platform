...
pub struct GoogleCloudRecommenderV1InsightTypeConfig {
    ...
    pub insight_type_generation_config:
        ::core::option::Option<GoogleCloudRecommenderV1InsightTypeGenerationConfig>,
...
pub struct GoogleCloudRecommenderV1ListInsightsResponse {
    ...
    #[serde(default)]
    pub insights: ::core::option::Option<::std::vec::Vec<GoogleCloudRecommenderV1Insight>>,
...
pub struct GoogleCloudRecommenderV1ListRecommendationsResponse {
    ...
    #[serde(default)]
    pub recommendations:
        ::core::option::Option<::std::vec::Vec<GoogleCloudRecommenderV1Recommendation>>,
}
...
pub struct GoogleCloudRecommenderV1Recommendation {
    ...
    pub additional_impact: ::core::option::Option<::std::vec::Vec<GoogleCloudRecommenderV1Impact>>,
    /// Insights that led to this recommendation.
    #[serde(default, rename = "associatedInsights")]
    pub associated_insights: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudRecommenderV1RecommendationInsightReference>,
    >,
    /// Content of the recommendation describing recommended changes to resources.
    #[serde(default)]
    pub content: ::core::option::Option<GoogleCloudRecommenderV1RecommendationContent>,
    /// Free-form human readable summary in English. The maximum length is 500 characters.
    #[serde(default)]
    pub description: ::core::option::Option<String>,
    ...
    pub primary_impact: ::core::option::Option<GoogleCloudRecommenderV1Impact>,
    ...
    #[serde(default, rename = "stateInfo")]
    pub state_info: ::core::option::Option<GoogleCloudRecommenderV1RecommendationStateInfo>,
...
pub struct GoogleCloudRecommenderV1RecommendationContent {
    ...
    pub operation_groups:
        ::core::option::Option<::std::vec::Vec<GoogleCloudRecommenderV1OperationGroup>>,
