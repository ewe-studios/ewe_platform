...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/alloydb/openapi.json`.
...
pub struct AutomatedBackupPolicy {
    ...
    pub quantity_based_retention: ::core::option::Option<::std::boxed::Box<QuantityBasedRetention>>,
    /// Time-based Backup retention policy.
    #[serde(default, rename = "timeBasedRetention")]
    pub time_based_retention: ::core::option::Option<::std::boxed::Box<TimeBasedRetention>>,
...
pub struct Backup {
    ...
    pub expiry_quantity: ::core::option::Option<::std::boxed::Box<QuantityBasedExpiry>>,
...
pub struct BackupDrInfo {
    ...
    pub current_window: ::core::option::Option<::std::boxed::Box<BackupDrEnabledWindow>>,
    ...
    pub previous_windows:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<BackupDrEnabledWindow>>>,
}
...
pub struct ClientConnectionConfig {
    ...
    pub ssl_config: ::core::option::Option<::std::boxed::Box<SslConfig>>,
}
...
pub struct Cluster {
    ...
    pub automated_backup_policy: ::core::option::Option<::std::boxed::Box<AutomatedBackupPolicy>>,
    /// Output only. Cluster created from backup.
    #[serde(default, rename = "backupSource")]
    pub backup_source: ::core::option::Option<::std::boxed::Box<BackupSource>>,
    /// Output only. Cluster created from a BackupDR backup.
    #[serde(default, rename = "backupdrBackupSource")]
    pub backupdr_backup_source: ::core::option::Option<::std::boxed::Box<BackupDrBackupSource>>,
    /// Output only. Output only information about BackupDR protection for this cluster.
    #[serde(default, rename = "backupdrInfo")]
    pub backupdr_info: ::core::option::Option<::std::boxed::Box<BackupDrInfo>>,
    /// Output only. Cluster created from CloudSQL snapshot.
    #[serde(default, rename = "cloudsqlBackupRunSource")]
    pub cloudsql_backup_run_source:
        ::core::option::Option<::std::boxed::Box<CloudSQLBackupRunSource>>,
    ...
    pub continuous_backup_config: ::core::option::Option<::std::boxed::Box<ContinuousBackupConfig>>,
    /// Output only. Continuous backup properties for this cluster.
    #[serde(default, rename = "continuousBackupInfo")]
    pub continuous_backup_info: ::core::option::Option<::std::boxed::Box<ContinuousBackupInfo>>,
    /// Output only. Create time stamp
    #[serde(default, rename = "createTime")]
    pub create_time: ::core::option::Option<String>,
    ...
    pub dataplex_config: ::core::option::Option<::std::boxed::Box<DataplexConfig>>,
    /// Output only. Delete time stamp
    #[serde(default, rename = "deleteTime")]
    pub delete_time: ::core::option::Option<String>,
    ...
    pub maintenance_update_policy:
        ::core::option::Option<::std::boxed::Box<MaintenanceUpdatePolicy>>,
    ...
    pub migration_source: ::core::option::Option<::std::boxed::Box<MigrationSource>>,
    ...
    pub primary_config: ::core::option::Option<::std::boxed::Box<PrimaryConfig>>,
    ...
    pub secondary_config: ::core::option::Option<::std::boxed::Box<SecondaryConfig>>,
    ...
    pub trial_metadata: ::core::option::Option<::std::boxed::Box<TrialMetadata>>,
    /// Output only. The system-generated UID of the resource. The UID is assigned when the resource is created, and it is retained until it is deleted.
    #[serde(default)]
    pub uid: ::core::option::Option<String>,
...
pub struct ClusterUpgradeDetails {
    ...
    pub instance_upgrade_details:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<InstanceUpgradeDetails>>>,
    /// Normalized name of the cluster
    #[serde(default)]
    pub name: ::core::option::Option<String>,
    /// Array containing stage info associated with this cluster.
    #[serde(default, rename = "stageInfo")]
    pub stage_info: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<StageInfo>>>,
...
pub struct DenyMaintenancePeriod {
    ...
    pub end_date: ::core::option::Option<::std::boxed::Box<GoogleTypeDate>>,
    ...
    pub start_date: ::core::option::Option<::std::boxed::Box<GoogleTypeDate>>,
...
pub struct ExportClusterRequest {
    ...
    pub csv_export_options: ::core::option::Option<::std::boxed::Box<CsvExportOptions>>,
    ...
    pub sql_export_options: ::core::option::Option<::std::boxed::Box<SqlExportOptions>>,
}
...
pub struct ImportClusterRequest {
    ...
    pub csv_import_options: ::core::option::Option<::std::boxed::Box<CsvImportOptions>>,
...
pub struct Instance {
    ...
    pub client_connection_config: ::core::option::Option<::std::boxed::Box<ClientConnectionConfig>>,
    ...
    #[serde(default, rename = "networkConfig")]
    pub network_config: ::core::option::Option<::std::boxed::Box<InstanceNetworkConfig>>,
    ...
    pub observability_config:
        ::core::option::Option<::std::boxed::Box<ObservabilityInstanceConfig>>,
    ...
    pub psc_instance_config: ::core::option::Option<::std::boxed::Box<PscInstanceConfig>>,
    /// Output only. The public IP addresses for the Instance. This is available ONLY when enable_public_ip is set. This is the connection endpoint for an end-user application.
    #[serde(default, rename = "publicIpAddress")]
    pub public_ip_address: ::core::option::Option<String>,
    ...
    pub query_insights_config:
        ::core::option::Option<::std::boxed::Box<QueryInsightsInstanceConfig>>,
    /// Read pool instance configuration. This is required if the value of instanceType is READ_POOL.
    #[serde(default, rename = "readPoolConfig")]
    pub read_pool_config: ::core::option::Option<::std::boxed::Box<ReadPoolConfig>>,
    ...
    pub writable_node: ::core::option::Option<::std::boxed::Box<Node>>,
}
...
pub struct ListSupportedDatabaseFlagsResponse {
    ...
    pub supported_database_flags:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SupportedDatabaseFlag>>>,
}
...
pub struct MaintenanceUpdatePolicy {
    ...
    pub maintenance_windows:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<MaintenanceWindow>>>,
}
...
pub struct OperationMetadata {
    ...
    pub upgrade_cluster_status: ::core::option::Option<::std::boxed::Box<UpgradeClusterStatus>>,
...
pub struct PscInstanceConfig {
    ...
    pub psc_interface_configs:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PscInterfaceConfig>>>,
...
pub struct ReadPoolInstancesUpgradeStageStatus {
    ...
    pub upgrade_stats: ::core::option::Option<::std::boxed::Box<Stats>>,
}
...
pub struct RestoreClusterRequest {
    ...
    pub backupdr_pitr_source: ::core::option::Option<::std::boxed::Box<BackupDrPitrSource>>,
    ...
    pub continuous_backup_source: ::core::option::Option<::std::boxed::Box<ContinuousBackupSource>>,
    /// Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server ignores the request if it has already been completed. The server guarantees that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if the original operation with the same request ID was received, and if so, ignores the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
    #[serde(default, rename = "requestId")]
    pub request_id: ::core::option::Option<String>,
    /// Optional. If set, performs request validation, for example, permission checks and any other type of validation, but does not actually execute the create request.
...
pub struct StageStatus {
    ...
    pub read_pool_instances_upgrade:
        ::core::option::Option<::std::boxed::Box<ReadPoolInstancesUpgradeStageStatus>>,
...
pub struct StorageDatabasecenterPartnerapiV1mainBackupConfiguration {
    ...
    pub backup_retention_settings: ::core::option::Option<
        ::std::boxed::Box<StorageDatabasecenterPartnerapiV1mainRetentionSettings>,
    >,
...
pub struct StorageDatabasecenterPartnerapiV1mainBackupDRMetadata {
    ...
    pub backup_configuration: ::core::option::Option<
        ::std::boxed::Box<StorageDatabasecenterPartnerapiV1mainBackupConfiguration>,
    >,
    /// Latest backup run information for this instance.
    #[serde(default, rename = "backupRun")]
    pub backup_run:
        ::core::option::Option<::std::boxed::Box<StorageDatabasecenterPartnerapiV1mainBackupRun>>,
    /// BackupDR configuration for this instance.
    #[serde(default, rename = "backupdrConfiguration")]
    pub backupdr_configuration: ::core::option::Option<
        ::std::boxed::Box<StorageDatabasecenterPartnerapiV1mainBackupDRConfiguration>,
    >,
    ...
    pub resource_id: ::core::option::Option<
        ::std::boxed::Box<StorageDatabasecenterPartnerapiV1mainDatabaseResourceId>,
    >,
}
...
pub struct StorageDatabasecenterPartnerapiV1mainBackupRun {
    ...
    pub error: ::core::option::Option<
        ::std::boxed::Box<StorageDatabasecenterPartnerapiV1mainOperationError>,
    >,
...
pub struct StorageDatabasecenterPartnerapiV1mainCustomMetadataData {
    ...
    pub internal_resource_metadata: ::core::option::Option<
        ::std::vec::Vec<
            ::std::boxed::Box<StorageDatabasecenterPartnerapiV1mainInternalResourceMetadata>,
        >,
    >,
}
...
pub struct StorageDatabasecenterPartnerapiV1mainDatabaseResourceFeed {
    ...
    pub backupdr_metadata: ::core::option::Option<
        ::std::boxed::Box<StorageDatabasecenterPartnerapiV1mainBackupDRMetadata>,
    >,
    ...
    pub config_based_signal_data: ::core::option::Option<
        ::std::boxed::Box<StorageDatabasecenterPartnerapiV1mainConfigBasedSignalData>,
    >,
    ...
    pub database_resource_signal_data: ::core::option::Option<
        ::std::boxed::Box<StorageDatabasecenterPartnerapiV1mainDatabaseResourceSignalData>,
    >,
    ...
    pub observability_metric_data: ::core::option::Option<
        ::std::boxed::Box<StorageDatabasecenterPartnerapiV1mainObservabilityMetricData>,
    >,
    ...
    pub resource_health_signal_data: ::core::option::Option<
        ::std::boxed::Box<StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData>,
    >,
    ...
    pub resource_metadata: ::core::option::Option<
        ::std::boxed::Box<StorageDatabasecenterPartnerapiV1mainDatabaseResourceMetadata>,
    >,
...
pub struct StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData {
    ...
    #[serde(default)]
    pub compliance: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<StorageDatabasecenterPartnerapiV1mainCompliance>>,
    >,
...
pub struct StorageDatabasecenterPartnerapiV1mainDatabaseResourceMetadata {
    ...
    pub availability_configuration: ::core::option::Option<
        ::std::boxed::Box<StorageDatabasecenterPartnerapiV1mainAvailabilityConfiguration>,
    >,
    /// Backup configuration for this instance
    #[serde(default, rename = "backupConfiguration")]
    pub backup_configuration: ::core::option::Option<
    ...
    pub custom_metadata: ::core::option::Option<
        ::std::boxed::Box<StorageDatabasecenterPartnerapiV1mainCustomMetadataData>,
    >,
    ...
    #[serde(default)]
    pub entitlements: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<StorageDatabasecenterPartnerapiV1mainEntitlement>>,
    >,
    ...
    pub gcbdr_configuration: ::core::option::Option<
        ::std::boxed::Box<StorageDatabasecenterPartnerapiV1mainGCBDRConfiguration>,
    >,
    ...
    pub machine_configuration: ::core::option::Option<
        ::std::boxed::Box<StorageDatabasecenterPartnerapiV1mainMachineConfiguration>,
    >,
    /// Optional. Maintenance info for the resource.
    #[serde(default, rename = "maintenanceInfo")]
    pub maintenance_info: ::core::option::Option<
        ::std::boxed::Box<StorageDatabasecenterPartnerapiV1mainResourceMaintenanceInfo>,
    >,
    ...
    pub primary_resource_id: ::core::option::Option<
        ::std::boxed::Box<StorageDatabasecenterPartnerapiV1mainDatabaseResourceId>,
    >,
    ...
    #[serde(default)]
    pub product: ::core::option::Option<::std::boxed::Box<StorageDatabasecenterProtoCommonProduct>>,
    ...
    pub resource_flags: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<StorageDatabasecenterPartnerapiV1mainResourceFlags>>,
    >,
    ...
    pub tags_set:
        ::core::option::Option<::std::boxed::Box<StorageDatabasecenterPartnerapiV1mainTags>>,
    ...
    pub user_label_set:
        ::core::option::Option<::std::boxed::Box<StorageDatabasecenterPartnerapiV1mainUserLabels>>,
...
pub struct StorageDatabasecenterPartnerapiV1mainDatabaseResourceSignalData {
    ...
    pub signal_metadata_list: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<StorageDatabasecenterPartnerapiV1mainSignalMetadata>>,
    >,
...
pub struct StorageDatabasecenterPartnerapiV1mainObservabilityMetricData {
    ...
    #[serde(default)]
    pub value:
        ::core::option::Option<::std::boxed::Box<StorageDatabasecenterProtoCommonTypedValue>>,
}
...
pub struct StorageDatabasecenterPartnerapiV1mainResourceMaintenanceInfo {
    ...
    pub current_version_release_date: ::core::option::Option<::std::boxed::Box<GoogleTypeDate>>,
    /// Optional. List of Deny maintenance period for the database resource.
    #[serde(default, rename = "denyMaintenanceSchedules")]
    pub deny_maintenance_schedules: ::core::option::Option<
        ::std::vec::Vec<
            ::std::boxed::Box<StorageDatabasecenterPartnerapiV1mainResourceMaintenanceDenySchedule>,
        >,
    >,
    ...
    #[serde(default, rename = "maintenanceSchedule")]
    pub maintenance_schedule: ::core::option::Option<
        ::std::boxed::Box<StorageDatabasecenterPartnerapiV1mainResourceMaintenanceSchedule>,
    >,
    ...
    pub upcoming_maintenance: ::core::option::Option<
        ::std::boxed::Box<StorageDatabasecenterPartnerapiV1mainUpcomingMaintenance>,
    >,
}
...
pub struct SupportedDatabaseFlag {
    ...
    pub integer_restrictions: ::core::option::Option<::std::boxed::Box<IntegerRestrictions>>,
    ...
    pub string_restrictions: ::core::option::Option<::std::boxed::Box<StringRestrictions>>,
...
pub struct UpgradeClusterResponse {
    ...
    pub cluster_upgrade_details:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ClusterUpgradeDetails>>>,
...
pub struct UpgradeClusterStatus {
    ...
    #[serde(default)]
    pub stages: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<StageStatus>>>,
...
pub struct WeeklySchedule {
    ...
    pub start_times:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleTypeTimeOfDay>>>,
}
