...
pub struct CreateCustomClassRequest {
    ...
    pub custom_class: ::core::option::Option<::std::boxed::Box<CustomClass>>,
...
pub struct CreatePhraseSetRequest {
    ...
    pub phrase_set: ::core::option::Option<::std::boxed::Box<PhraseSet>>,
...
pub struct CustomClass {
    ...
    #[serde(default)]
    pub items: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ClassItem>>>,
...
pub struct ListCustomClassesResponse {
    ...
    pub custom_classes: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<CustomClass>>>,
...
pub struct ListPhraseSetResponse {
    ...
    pub phrase_sets: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PhraseSet>>>,
}
...
pub struct LongRunningRecognizeRequest {
    ...
    #[serde(default)]
    pub audio: ::core::option::Option<::std::boxed::Box<RecognitionAudio>>,
    /// Required. Provides information to the recognizer that specifies how to process the request.
    #[serde(default)]
    pub config: ::core::option::Option<::std::boxed::Box<RecognitionConfig>>,
    /// Optional. Specifies an optional destination for the recognition results.
    #[serde(default, rename = "outputConfig")]
    pub output_config: ::core::option::Option<::std::boxed::Box<TranscriptOutputConfig>>,
}
...
pub struct LongRunningRecognizeResponse {
    ...
    pub output_error: ::core::option::Option<::std::boxed::Box<Status>>,
    ...
    #[serde(default)]
    pub results:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SpeechRecognitionResult>>>,
    /// Provides information on speech adaptation behavior in response
    #[serde(default, rename = "speechAdaptationInfo")]
    pub speech_adaptation_info: ::core::option::Option<::std::boxed::Box<SpeechAdaptationInfo>>,
...
pub struct PhraseSet {
    ...
    #[serde(default)]
    pub phrases: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Phrase>>>,
...
pub struct RecognitionConfig {
    ...
    #[serde(default)]
    pub adaptation: ::core::option::Option<::std::boxed::Box<SpeechAdaptation>>,
    ...
    pub alternative_language_codes: ::core::option::Option<::std::vec::Vec<String>>,
    ...
    pub audio_channel_count: ::core::option::Option<i32>,
    ...
    pub diarization_config: ::core::option::Option<::std::boxed::Box<SpeakerDiarizationConfig>>,
    ...
    pub enable_separate_recognition_per_channel: ::core::option::Option<bool>,
    ...
    #[serde(default)]
    pub metadata: ::core::option::Option<::std::boxed::Box<RecognitionMetadata>>,
    ...
    pub profanity_filter: ::core::option::Option<bool>,
    ...
    pub speech_contexts: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SpeechContext>>>,
    ...
    pub transcript_normalization:
        ::core::option::Option<::std::boxed::Box<TranscriptNormalization>>,
...
pub struct RecognitionMetadata {
    ...
    pub audio_topic: ::core::option::Option<String>,
    /// The industry vertical to which this speech recognition request most closely applies. This is most indicative of the topics contained in the audio. Use the 6-digit NAICS code to identify the industry vertical - see https://www.naics.com/search/.
    #[serde(default, rename = "industryNaicsCodeOfAudio")]
    pub industry_naics_code_of_audio: ::core::option::Option<i64>,
    ...
    pub microphone_distance: ::core::option::Option<String>,
    ...
    pub original_media_type: ::core::option::Option<String>,
    ...
    pub original_mime_type: ::core::option::Option<String>,
    /// The device used to make the recording. Examples ''Nexus 5X'' or ''Polycom SoundStation IP 6000'' or ''POTS'' or ''VoIP'' or ''Cardioid Microphone''.
    #[serde(default, rename = "recordingDeviceName")]
    pub recording_device_name: ::core::option::Option<String>,
...
pub struct SpeechAdaptation {
    ...
    pub abnf_grammar: ::core::option::Option<::std::boxed::Box<ABNFGrammar>>,
...
pub struct SpeechRecognitionAlternative {
    ...
    #[serde(default)]
    pub words: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<WordInfo>>>,
}
...
pub struct SpeechRecognitionResult {
    ...
    #[serde(default)]
    pub alternatives:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SpeechRecognitionAlternative>>>,
