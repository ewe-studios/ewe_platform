...
pub struct ListActiveDirectoriesResponse {
    ...
    pub active_directories: ::core::option::Option<::std::vec::Vec<ActiveDirectory>>,
...
pub struct ListBackupPoliciesResponse {
    ...
    pub backup_policies: ::core::option::Option<::std::vec::Vec<BackupPolicy>>,
    /// A token identifying a page of results the server should return.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// Locations that could not be reached.
...
pub struct ListHostGroupsResponse {
    ...
    pub host_groups: ::core::option::Option<::std::vec::Vec<HostGroup>>,
    /// A token identifying a page of results the server should return.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// Locations that could not be reached.
...
pub struct ListKmsConfigsResponse {
    ...
    pub kms_configs: ::core::option::Option<::std::vec::Vec<KmsConfig>>,
    /// A token identifying a page of results the server should return.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// Locations that could not be reached.
...
pub struct ListQuotaRulesResponse {
    ...
    pub quota_rules: ::core::option::Option<::std::vec::Vec<QuotaRule>>,
    /// Locations that could not be reached.
    #[serde(default)]
    pub unreachable: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct ListReplicationsResponse {
    ...
    #[serde(default)]
    pub replications: ::core::option::Option<::std::vec::Vec<Replication>>,
    /// Locations that could not be reached.
    #[serde(default)]
    pub unreachable: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct BackupVault {
    ...
    pub backup_retention_policy: ::core::option::Option<BackupRetentionPolicy>,
...
pub struct Volume {
    ...
    pub block_devices: ::core::option::Option<::std::vec::Vec<BlockDevice>>,
    ...
    pub clone_details: ::core::option::Option<CloneDetails>,
    ...
    pub hybrid_replication_parameters: ::core::option::Option<HybridReplicationParameters>,
    ...
    pub mount_options: ::core::option::Option<::std::vec::Vec<MountOption>>,
...
pub struct ExportPolicy {
    ...
    #[serde(default)]
    pub rules: ::core::option::Option<::std::vec::Vec<SimpleExportPolicyRule>>,
}
