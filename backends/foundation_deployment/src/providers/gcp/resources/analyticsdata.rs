...
pub struct BatchRunPivotReportsRequest {
    ...
    #[serde(default)]
    pub requests: ::core::option::Option<::std::vec::Vec<RunPivotReportRequest>>,
}
...
pub struct BatchRunPivotReportsResponse {
    ...
    pub pivot_reports: ::core::option::Option<::std::vec::Vec<RunPivotReportResponse>>,
}
...
pub struct BatchRunReportsRequest {
    ...
    #[serde(default)]
    pub requests: ::core::option::Option<::std::vec::Vec<RunReportRequest>>,
}
...
pub struct BatchRunReportsResponse {
    ...
    #[serde(default)]
    pub reports: ::core::option::Option<::std::vec::Vec<RunReportResponse>>,
}
...
pub struct CheckCompatibilityResponse {
    ...
    pub dimension_compatibilities: ::core::option::Option<::std::vec::Vec<DimensionCompatibility>>,
...
pub struct ListAudienceExportsResponse {
    ...
    pub audience_exports: ::core::option::Option<::std::vec::Vec<AudienceExport>>,
...
pub struct Metadata {
    ...
    #[serde(default)]
    pub comparisons: ::core::option::Option<::std::vec::Vec<ComparisonMetadata>>,
    /// The dimension descriptions.
    #[serde(default)]
    pub dimensions: ::core::option::Option<::std::vec::Vec<DimensionMetadata>>,
    /// The metric descriptions.
    #[serde(default)]
    pub metrics: ::core::option::Option<::std::vec::Vec<MetricMetadata>>,
...
pub struct QueryAudienceExportResponse {
    ...
    pub audience_rows: ::core::option::Option<::std::vec::Vec<V1betaAudienceRow>>,
...
pub struct RunRealtimeReportRequest {
    ...
    pub minute_ranges: ::core::option::Option<::std::vec::Vec<MinuteRange>>,
    /// Specifies how rows are ordered in the response.
    #[serde(default, rename = "orderBys")]
    pub order_bys: ::core::option::Option<::std::vec::Vec<OrderBy>>,
...
pub struct RunRealtimeReportResponse {
    ...
    pub dimension_headers: ::core::option::Option<::std::vec::Vec<DimensionHeader>>,
    ...
    #[serde(default)]
    pub maximums: ::core::option::Option<::std::vec::Vec<Row>>,
    /// Describes metric columns. The number of MetricHeaders and ordering of MetricHeaders matches the metrics present in rows.
    #[serde(default, rename = "metricHeaders")]
    pub metric_headers: ::core::option::Option<::std::vec::Vec<MetricHeader>>,
    /// If requested, the minimum values of metrics.
    #[serde(default)]
    pub minimums: ::core::option::Option<::std::vec::Vec<Row>>,
    ...
    #[serde(default)]
    pub totals: ::core::option::Option<::std::vec::Vec<Row>>,
}
...
pub struct RunPivotReportRequest {
    ...
    #[serde(default)]
    pub comparisons: ::core::option::Option<::std::vec::Vec<Comparison>>,
    ...
    #[serde(default)]
    pub pivots: ::core::option::Option<::std::vec::Vec<Pivot>>,
...
pub struct RunPivotReportResponse {
    ...
    #[serde(default)]
    pub aggregates: ::core::option::Option<::std::vec::Vec<Row>>,
    /// Describes dimension columns. The number of DimensionHeaders and ordering of DimensionHeaders matches the dimensions present in rows.
    #[serde(default, rename = "dimensionHeaders")]
    pub dimension_headers: ::core::option::Option<::std::vec::Vec<DimensionHeader>>,
    ...
    pub pivot_headers: ::core::option::Option<::std::vec::Vec<PivotHeader>>,
...
pub struct AudienceExport {
    ...
    #[serde(default)]
    pub dimensions: ::core::option::Option<::std::vec::Vec<V1betaAudienceDimension>>,
...
pub struct V1betaAudienceRow {
    ...
    pub dimension_values: ::core::option::Option<::std::vec::Vec<V1betaAudienceDimensionValue>>,
}
...
pub struct PivotHeader {
    ...
    pub pivot_dimension_headers: ::core::option::Option<::std::vec::Vec<PivotDimensionHeader>>,
...
pub struct CohortSpec {
    ...
    #[serde(default)]
    pub cohorts: ::core::option::Option<::std::vec::Vec<Cohort>>,
...
pub struct Row {
    ...
    #[serde(default, rename = "dimensionValues")]
    pub dimension_values: ::core::option::Option<::std::vec::Vec<DimensionValue>>,
...
pub struct ResponseMetaData {
    ...
    pub sampling_metadatas: ::core::option::Option<::std::vec::Vec<SamplingMetadata>>,
    ...
    pub schema_restriction_response: ::core::option::Option<SchemaRestrictionResponse>,
...
pub struct OrderBy {
    ...
    #[serde(default)]
    pub dimension: ::core::option::Option<DimensionOrderBy>,
    /// Sorts results by a metric''s values.
    #[serde(default)]
    pub metric: ::core::option::Option<MetricOrderBy>,
    /// Sorts results by a metric''s values within a pivot column group.
    #[serde(default)]
    pub pivot: ::core::option::Option<PivotOrderBy>,
}
...
pub struct DimensionExpression {
    ...
    #[serde(default)]
    pub concatenate: ::core::option::Option<ConcatenateExpression>,
    /// Used to convert a dimension value to lower case.
    #[serde(default, rename = "lowerCase")]
    pub lower_case: ::core::option::Option<CaseExpression>,
    /// Used to convert a dimension value to upper case.
    #[serde(default, rename = "upperCase")]
    pub upper_case: ::core::option::Option<CaseExpression>,
}
...
pub struct SchemaRestrictionResponse {
    ...
    pub active_metric_restrictions:
        ::core::option::Option<::std::vec::Vec<ActiveMetricRestriction>>,
}
...
pub struct PivotOrderBy {
    ...
    pub pivot_selections: ::core::option::Option<::std::vec::Vec<PivotSelection>>,
}
