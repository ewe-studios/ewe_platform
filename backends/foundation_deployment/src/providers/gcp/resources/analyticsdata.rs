...
pub struct ActiveMetricRestriction {
    ...
    pub restricted_metric_types: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct AudienceExport {
    ...
    pub audience_display_name: ::core::option::Option<String>,
    ...
    pub begin_creating_time: ::core::option::Option<String>,
    ...
    pub creation_quota_tokens_charged: ::core::option::Option<i32>,
    /// Required. The dimensions requested and displayed in the query response.
    #[serde(default)]
    pub dimensions:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<V1betaAudienceDimension>>>,
...
pub struct BatchRunPivotReportsRequest {
    ...
    #[serde(default)]
    pub requests: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<RunPivotReportRequest>>>,
}
...
pub struct BatchRunPivotReportsResponse {
    ...
    pub pivot_reports:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<RunPivotReportResponse>>>,
}
...
pub struct BatchRunReportsRequest {
    ...
    #[serde(default)]
    pub requests: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<RunReportRequest>>>,
}
...
pub struct BatchRunReportsResponse {
    ...
    #[serde(default)]
    pub reports: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<RunReportResponse>>>,
}
...
pub struct CheckCompatibilityResponse {
    ...
    pub dimension_compatibilities:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DimensionCompatibility>>>,
    /// The compatibility of each metric.
    #[serde(default, rename = "metricCompatibilities")]
    pub metric_compatibilities:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<MetricCompatibility>>>,
}
...
pub struct CohortReportSettings {
    ...
    #[serde(default)]
    pub accumulate: ::core::option::Option<bool>,
}
...
pub struct CohortSpec {
    ...
    pub cohort_report_settings: ::core::option::Option<::std::boxed::Box<CohortReportSettings>>,
    ...
    #[serde(default)]
    pub cohorts: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Cohort>>>,
    ...
    pub cohorts_range: ::core::option::Option<::std::boxed::Box<CohortsRange>>,
}
...
pub struct ComparisonMetadata {
    ...
    pub api_name: ::core::option::Option<String>,
    ...
    pub ui_name: ::core::option::Option<String>,
}
...
pub struct ConcatenateExpression {
    ...
    pub dimension_names: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct Dimension {
    ...
    pub dimension_expression: ::core::option::Option<::std::boxed::Box<DimensionExpression>>,
...
pub struct DimensionCompatibility {
    ...
    pub dimension_metadata: ::core::option::Option<::std::boxed::Box<DimensionMetadata>>,
}
...
pub struct DimensionExpression {
    ...
    #[serde(default)]
    pub concatenate: ::core::option::Option<::std::boxed::Box<ConcatenateExpression>>,
    /// Used to convert a dimension value to lower case.
    #[serde(default, rename = "lowerCase")]
    pub lower_case: ::core::option::Option<::std::boxed::Box<CaseExpression>>,
    /// Used to convert a dimension value to upper case.
    #[serde(default, rename = "upperCase")]
    pub upper_case: ::core::option::Option<::std::boxed::Box<CaseExpression>>,
}
...
pub struct DimensionMetadata {
    ...
    pub custom_definition: ::core::option::Option<bool>,
    ...
    pub deprecated_api_names: ::core::option::Option<::std::vec::Vec<String>>,
...
pub struct Filter {
    ...
    pub string_filter: ::core::option::Option<::std::boxed::Box<StringFilter>>,
}
...
pub struct FilterExpressionList {
    /// A list of filter expressions.
    #[serde(default)]
    pub expressions: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<FilterExpression>>>,
}
...
pub struct ListAudienceExportsResponse {
    ...
    pub audience_exports:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AudienceExport>>>,
...
pub struct Metadata {
    ...
    #[serde(default)]
    pub comparisons: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ComparisonMetadata>>>,
    /// The dimension descriptions.
    #[serde(default)]
    pub dimensions: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DimensionMetadata>>>,
    /// The metric descriptions.
    #[serde(default)]
    pub metrics: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<MetricMetadata>>>,
...
pub struct Metric {
    ...
    #[serde(default)]
    pub invisible: ::core::option::Option<bool>,
...
pub struct MetricCompatibility {
    ...
    pub metric_metadata: ::core::option::Option<::std::boxed::Box<MetricMetadata>>,
}
...
pub struct MetricMetadata {
    ...
    pub blocked_reasons: ::core::option::Option<::std::vec::Vec<String>>,
...
pub struct OrderBy {
    ...
    #[serde(default)]
    pub dimension: ::core::option::Option<::std::boxed::Box<DimensionOrderBy>>,
    /// Sorts results by a metric''s values.
    #[serde(default)]
    pub metric: ::core::option::Option<::std::boxed::Box<MetricOrderBy>>,
    /// Sorts results by a metric''s values within a pivot column group.
    #[serde(default)]
    pub pivot: ::core::option::Option<::std::boxed::Box<PivotOrderBy>>,
}
...
pub struct Pivot {
    ...
    pub order_bys: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<OrderBy>>>,
}
...
pub struct PivotHeader {
    ...
    pub pivot_dimension_headers:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PivotDimensionHeader>>>,
...
pub struct PivotOrderBy {
    ...
    pub pivot_selections:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PivotSelection>>>,
}
...
pub struct PivotSelection {
    ...
    pub dimension_value: ::core::option::Option<String>,
}
...
pub struct PropertyQuota {
    ...
    pub concurrent_requests: ::core::option::Option<::std::boxed::Box<QuotaStatus>>,
    ...
    pub potentially_thresholded_requests_per_hour:
        ::core::option::Option<::std::boxed::Box<QuotaStatus>>,
    ...
    pub server_errors_per_project_per_hour: ::core::option::Option<::std::boxed::Box<QuotaStatus>>,
    ...
    pub tokens_per_day: ::core::option::Option<::std::boxed::Box<QuotaStatus>>,
    ...
    pub tokens_per_hour: ::core::option::Option<::std::boxed::Box<QuotaStatus>>,
    ...
    pub tokens_per_project_per_hour: ::core::option::Option<::std::boxed::Box<QuotaStatus>>,
}
...
pub struct QueryAudienceExportResponse {
    ...
    pub audience_export: ::core::option::Option<::std::boxed::Box<AudienceExport>>,
    ...
    pub audience_rows:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<V1betaAudienceRow>>>,
...
pub struct ResponseMetaData {
    ...
    pub data_loss_from_other_row: ::core::option::Option<bool>,
    /// If empty reason is specified, the report is empty for this reason.
    #[serde(default, rename = "emptyReason")]
    pub empty_reason: ::core::option::Option<String>,
    ...
    pub sampling_metadatas:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SamplingMetadata>>>,
    ...
    pub schema_restriction_response:
        ::core::option::Option<::std::boxed::Box<SchemaRestrictionResponse>>,
...
pub struct RunPivotReportRequest {
    ...
    pub cohort_spec: ::core::option::Option<::std::boxed::Box<CohortSpec>>,
    ...
    #[serde(default)]
    pub comparisons: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Comparison>>>,
    ...
    #[serde(default)]
    pub pivots: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Pivot>>>,
    ...
    pub return_property_quota: ::core::option::Option<bool>,
}
...
pub struct RunPivotReportResponse {
    ...
    #[serde(default)]
    pub aggregates: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Row>>>,
    /// Describes dimension columns. The number of DimensionHeaders and ordering of DimensionHeaders matches the dimensions present in rows.
    #[serde(default, rename = "dimensionHeaders")]
    pub dimension_headers:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DimensionHeader>>>,
    ...
    pub metric_headers: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<MetricHeader>>>,
    ...
    pub pivot_headers: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PivotHeader>>>,
    /// This Google Analytics property''s quota state including this request.
    #[serde(default, rename = "propertyQuota")]
    pub property_quota: ::core::option::Option<::std::boxed::Box<PropertyQuota>>,
...
pub struct RunRealtimeReportRequest {
    ...
    pub minute_ranges: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<MinuteRange>>>,
...
pub struct RunRealtimeReportResponse {
    ...
    #[serde(default)]
    pub maximums: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Row>>>,
    /// Describes metric columns. The number of MetricHeaders and ordering of MetricHeaders matches the metrics present in rows.
    #[serde(default, rename = "metricHeaders")]
    pub metric_headers: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<MetricHeader>>>,
    /// If requested, the minimum values of metrics.
    #[serde(default)]
    pub minimums: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Row>>>,
    ...
    #[serde(default)]
    pub totals: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Row>>>,
}
...
pub struct SamplingMetadata {
    ...
    pub samples_read_count: ::core::option::Option<String>,
    ...
    pub sampling_space_size: ::core::option::Option<String>,
}
...
pub struct SchemaRestrictionResponse {
    ...
    pub active_metric_restrictions:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ActiveMetricRestriction>>>,
}
...
pub struct V1betaAudienceRow {
    ...
    #[serde(default, rename = "dimensionValues")]
    pub dimension_values:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<V1betaAudienceDimensionValue>>>,
}
