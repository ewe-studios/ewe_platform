...
pub struct GoogleCloudDataplexV1Aspect {
    ...
    pub aspect_source: ::core::option::Option<GoogleCloudDataplexV1AspectSource>,
...
pub struct GoogleCloudDataplexV1DataScanEvent {
    ...
    pub data_profile: ::core::option::Option<GoogleCloudDataplexV1DataScanEventDataProfileResult>,
    /// Applied configs for data profile type data scan.
    #[serde(default, rename = "dataProfileConfigs")]
    pub data_profile_configs:
        ::core::option::Option<GoogleCloudDataplexV1DataScanEventDataProfileAppliedConfigs>,
    /// Data quality result for data quality type data scan.
    #[serde(default, rename = "dataQuality")]
    pub data_quality: ::core::option::Option<GoogleCloudDataplexV1DataScanEventDataQualityResult>,
    /// Applied configs for data quality type data scan.
    #[serde(default, rename = "dataQualityConfigs")]
    pub data_quality_configs:
        ::core::option::Option<GoogleCloudDataplexV1DataScanEventDataQualityAppliedConfigs>,
    ...
    pub post_scan_actions_result:
        ::core::option::Option<GoogleCloudDataplexV1DataScanEventPostScanActionsResult>,
...
pub struct GoogleCloudDataplexV1DiscoveryEvent {
    ...
    #[serde(default)]
    pub action: ::core::option::Option<GoogleCloudDataplexV1DiscoveryEventActionDetails>,
    /// The id of the associated asset.
    #[serde(default, rename = "assetId")]
    pub asset_id: ::core::option::Option<String>,
    /// Details about discovery configuration in effect.
    #[serde(default)]
    pub config: ::core::option::Option<GoogleCloudDataplexV1DiscoveryEventConfigDetails>,
    ...
    #[serde(default)]
    pub entity: ::core::option::Option<GoogleCloudDataplexV1DiscoveryEventEntityDetails>,
    ...
    #[serde(default)]
    pub partition: ::core::option::Option<GoogleCloudDataplexV1DiscoveryEventPartitionDetails>,
    /// Details about the BigQuery table publishing associated with the event.
    #[serde(default)]
    pub table: ::core::option::Option<GoogleCloudDataplexV1DiscoveryEventTableDetails>,
...
pub struct GoogleCloudDataplexV1GovernanceEvent {
    ...
    #[serde(default)]
    pub entity: ::core::option::Option<GoogleCloudDataplexV1GovernanceEventEntity>,
...
pub struct GoogleCloudDataplexV1ImportItem {
    ...
    pub entry_link: ::core::option::Option<GoogleCloudDataplexV1EntryLink>,
...
pub struct GoogleCloudDataplexV1ListActionsResponse {
    ...
    #[serde(default)]
    pub actions: ::core::option::Option<::std::vec::Vec<GoogleCloudDataplexV1Action>>,
...
pub struct GoogleCloudDataplexV1ListAspectTypesResponse {
    ...
    pub aspect_types: ::core::option::Option<::std::vec::Vec<GoogleCloudDataplexV1AspectType>>,
    /// Token to retrieve the next page of results, or empty if there are no more results in the list.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
...
pub struct GoogleCloudDataplexV1ListAssetsResponse {
    ...
    #[serde(default)]
    pub assets: ::core::option::Option<::std::vec::Vec<GoogleCloudDataplexV1Asset>>,
    /// Token to retrieve the next page of results, or empty if there are no more results in the list.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct GoogleCloudDataplexV1ListDataAssetsResponse {
    ...
    pub data_assets: ::core::option::Option<::std::vec::Vec<GoogleCloudDataplexV1DataAsset>>,
...
pub struct GoogleCloudDataplexV1ListDataAttributeBindingsResponse {
    ...
    pub data_attribute_bindings:
        ::core::option::Option<::std::vec::Vec<GoogleCloudDataplexV1DataAttributeBinding>>,
    /// Token to retrieve the next page of results, or empty if there are no more results in the list.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
...
pub struct GoogleCloudDataplexV1ListDataAttributesResponse {
    ...
    pub data_attributes:
        ::core::option::Option<::std::vec::Vec<GoogleCloudDataplexV1DataAttribute>>,
    /// Token to retrieve the next page of results, or empty if there are no more results in the list.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// Locations that could not be reached.
...
pub struct GoogleCloudDataplexV1ListDataProductsResponse {
    ...
    pub data_products: ::core::option::Option<::std::vec::Vec<GoogleCloudDataplexV1DataProduct>>,
    /// A token, which can be sent as page_token to retrieve the next page. If this field is empty, then there are no subsequent pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
...
pub struct GoogleCloudDataplexV1ListDataScanJobsResponse {
    ...
    pub data_scan_jobs: ::core::option::Option<::std::vec::Vec<GoogleCloudDataplexV1DataScanJob>>,
    /// Token to retrieve the next page of results, or empty if there are no more results in the list.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct GoogleCloudDataplexV1ListDataScansResponse {
    ...
    pub data_scans: ::core::option::Option<::std::vec::Vec<GoogleCloudDataplexV1DataScan>>,
    /// Token to retrieve the next page of results, or empty if there are no more results in the list.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// Locations that could not be reached.
...
pub struct GoogleCloudDataplexV1ListDataTaxonomiesResponse {
    ...
    pub data_taxonomies: ::core::option::Option<::std::vec::Vec<GoogleCloudDataplexV1DataTaxonomy>>,
    /// Token to retrieve the next page of results, or empty if there are no more results in the list.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// Locations that could not be reached.
...
pub struct GoogleCloudDataplexV1ListEncryptionConfigsResponse {
    ...
    pub encryption_configs:
        ::core::option::Option<::std::vec::Vec<GoogleCloudDataplexV1EncryptionConfig>>,
    /// Token to retrieve the next page of results, or empty if there are no more results in the list.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// Locations that could not be reached.
...
pub struct GoogleCloudDataplexV1ListEntitiesResponse {
    ...
    #[serde(default)]
    pub entities: ::core::option::Option<::std::vec::Vec<GoogleCloudDataplexV1Entity>>,
...
pub struct GoogleCloudDataplexV1ListEntriesResponse {
    ...
    #[serde(default)]
    pub entries: ::core::option::Option<::std::vec::Vec<GoogleCloudDataplexV1Entry>>,
    /// Token to retrieve the next page of results, or empty if there are no more results in the list.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct GoogleCloudDataplexV1ListEntryGroupsResponse {
    ...
    pub entry_groups: ::core::option::Option<::std::vec::Vec<GoogleCloudDataplexV1EntryGroup>>,
    /// Token to retrieve the next page of results, or empty if there are no more results in the list.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// Locations that the service couldn''t reach.
...
pub struct GoogleCloudDataplexV1ListEntryTypesResponse {
    ...
    pub entry_types: ::core::option::Option<::std::vec::Vec<GoogleCloudDataplexV1EntryType>>,
    /// Token to retrieve the next page of results, or empty if there are no more results in the list.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// Locations that the service couldn''t reach.
...
pub struct GoogleCloudDataplexV1ListGlossariesResponse {
    ...
    #[serde(default)]
    pub glossaries: ::core::option::Option<::std::vec::Vec<GoogleCloudDataplexV1Glossary>>,
...
pub struct GoogleCloudDataplexV1ListGlossaryCategoriesResponse {
    ...
    #[serde(default)]
    pub categories: ::core::option::Option<::std::vec::Vec<GoogleCloudDataplexV1GlossaryCategory>>,
    /// A token, which can be sent as page_token to retrieve the next page. If this field is omitted, there are no subsequent pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// Locations that the service couldn''t reach.
...
pub struct GoogleCloudDataplexV1ListGlossaryTermsResponse {
    ...
    #[serde(default)]
    pub terms: ::core::option::Option<::std::vec::Vec<GoogleCloudDataplexV1GlossaryTerm>>,
    /// Locations that the service couldn''t reach.
    #[serde(default, rename = "unreachableLocations")]
    pub unreachable_locations: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct GoogleCloudDataplexV1ListJobsResponse {
    ...
    #[serde(default)]
    pub jobs: ::core::option::Option<::std::vec::Vec<GoogleCloudDataplexV1Job>>,
    /// Token to retrieve the next page of results, or empty if there are no more results in the list.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct GoogleCloudDataplexV1ListLakesResponse {
    ...
    #[serde(default)]
    pub lakes: ::core::option::Option<::std::vec::Vec<GoogleCloudDataplexV1Lake>>,
    /// Token to retrieve the next page of results, or empty if there are no more results in the list.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// Locations that could not be reached.
...
pub struct GoogleCloudDataplexV1ListMetadataFeedsResponse {
    ...
    pub metadata_feeds: ::core::option::Option<::std::vec::Vec<GoogleCloudDataplexV1MetadataFeed>>,
...
pub struct GoogleCloudDataplexV1ListMetadataJobsResponse {
    ...
    pub metadata_jobs: ::core::option::Option<::std::vec::Vec<GoogleCloudDataplexV1MetadataJob>>,
    /// A token to retrieve the next page of results. If there are no more results in the list, the value is empty.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// Locations that the service couldn''t reach.
...
pub struct GoogleCloudDataplexV1ListPartitionsResponse {
    ...
    #[serde(default)]
    pub partitions: ::core::option::Option<::std::vec::Vec<GoogleCloudDataplexV1Partition>>,
}
...
pub struct GoogleCloudDataplexV1ListTasksResponse {
    ...
    #[serde(default)]
    pub tasks: ::core::option::Option<::std::vec::Vec<GoogleCloudDataplexV1Task>>,
    /// Locations that could not be reached.
    #[serde(default, rename = "unreachableLocations")]
    pub unreachable_locations: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct GoogleCloudDataplexV1ListZonesResponse {
    ...
    #[serde(default)]
    pub zones: ::core::option::Option<::std::vec::Vec<GoogleCloudDataplexV1Zone>>,
}
...
pub struct GoogleCloudDataplexV1LookupEntryLinksResponse {
    ...
    pub entry_links: ::core::option::Option<::std::vec::Vec<GoogleCloudDataplexV1EntryLink>>,
    /// Token to retrieve the next page of results, or empty if there are no more results in the list.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct GoogleCloudDataplexV1Action {
    ...
    pub invalid_data_organization:
        ::core::option::Option<GoogleCloudDataplexV1ActionInvalidDataOrganization>,
    ...
    pub missing_data: ::core::option::Option<GoogleCloudDataplexV1ActionMissingData>,
    /// Details for issues related to absence of a managed resource.
    #[serde(default, rename = "missingResource")]
    pub missing_resource: ::core::option::Option<GoogleCloudDataplexV1ActionMissingResource>,
    ...
    pub unauthorized_resource:
        ::core::option::Option<GoogleCloudDataplexV1ActionUnauthorizedResource>,
...
pub struct GoogleCloudDataplexV1MetadataFeed {
    ...
    #[serde(default)]
    pub filters: ::core::option::Option<GoogleCloudDataplexV1MetadataFeedFilters>,
    ...
    #[serde(default)]
    pub scope: ::core::option::Option<GoogleCloudDataplexV1MetadataFeedScope>,
...
pub struct GoogleCloudDataplexV1MetadataJob {
    ...
    pub export_result: ::core::option::Option<GoogleCloudDataplexV1MetadataJobExportJobResult>,
    /// Export job specification.
    #[serde(default, rename = "exportSpec")]
    pub export_spec: ::core::option::Option<GoogleCloudDataplexV1MetadataJobExportJobSpec>,
    /// Output only. Import job result.
    #[serde(default, rename = "importResult")]
    pub import_result: ::core::option::Option<GoogleCloudDataplexV1MetadataJobImportJobResult>,
    /// Import job specification.
    #[serde(default, rename = "importSpec")]
    pub import_spec: ::core::option::Option<GoogleCloudDataplexV1MetadataJobImportJobSpec>,
    /// Optional. User-defined labels.
    #[serde(default)]
    pub labels: ::core::option::Option<serde_json::Value>,
    ...
    #[serde(default)]
    pub status: ::core::option::Option<GoogleCloudDataplexV1MetadataJobStatus>,
...
pub struct GoogleCloudDataplexV1MetadataJobImportJobSpec {
    ...
    #[serde(default)]
    pub scope: ::core::option::Option<GoogleCloudDataplexV1MetadataJobImportJobSpecImportJobScope>,
...
pub struct GoogleCloudDataplexV1TaskExecutionStatus {
    ...
    pub latest_job: ::core::option::Option<GoogleCloudDataplexV1Job>,
...
pub struct GoogleCloudDataplexV1TaskNotebookTaskConfig {
    ...
    pub infrastructure_spec: ::core::option::Option<GoogleCloudDataplexV1TaskInfrastructureSpec>,
...
pub struct GoogleCloudDataplexV1ZoneDiscoverySpec {
    /// Optional. Configuration for CSV data.
    #[serde(default, rename = "csvOptions")]
    pub csv_options: ::core::option::Option<GoogleCloudDataplexV1ZoneDiscoverySpecCsvOptions>,
    ...
    /// Optional. Configuration for Json data.
    #[serde(default, rename = "jsonOptions")]
    pub json_options: ::core::option::Option<GoogleCloudDataplexV1ZoneDiscoverySpecJsonOptions>,
    /// Optional. Cron schedule (https://en.wikipedia.org/wiki/Cron) for running discovery periodically. Successive discovery runs must be scheduled at least 60 minutes apart. The default value is to run discovery every 60 minutes.To explicitly set a timezone to the cron tab, apply a prefix in the cron tab: "CRON_TZ=${IANA_TIME_ZONE}" or TZ=${IANA_TIME_ZONE}". The ${IANA_TIME_ZONE} may only be a valid string from IANA time zone database. For example, CRON_TZ=America/New_York 1 * * * *, or TZ=America/New_York 1 * * * *.
    #[serde(default)]
    pub schedule: ::core::option::Option<String>,
}
...
pub struct GoogleCloudDataplexV1Trigger {
    ...
    pub on_demand: ::core::option::Option<GoogleCloudDataplexV1TriggerOnDemand>,
...
pub struct GoogleCloudDataplexV1DataQualityRule {
    ...
    pub non_null_expectation:
        ::core::option::Option<GoogleCloudDataplexV1DataQualityRuleNonNullExpectation>,
    ...
    pub uniqueness_expectation:
        ::core::option::Option<GoogleCloudDataplexV1DataQualityRuleUniquenessExpectation>,
}
...
pub struct GoogleCloudDataplexV1DataQualitySpecPostScanActionsNotificationReport {
    ...
    pub job_end_trigger:
        ::core::option::Option<GoogleCloudDataplexV1DataQualitySpecPostScanActionsJobEndTrigger>,
    /// Optional. If set, report will be sent when a scan job fails.
    #[serde(default, rename = "jobFailureTrigger")]
    pub job_failure_trigger: ::core::option::Option<
