...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/analyticshub/openapi.json`.
...
pub struct AIInference {
    ...
    pub unstructured_inference: ::core::option::Option<::std::boxed::Box<UnstructuredInference>>,
}
...
pub struct BigQueryDatasetSource {
    ...
    pub effective_replicas: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Replica>>>,
    ...
    pub restricted_export_policy: ::core::option::Option<::std::boxed::Box<RestrictedExportPolicy>>,
    ...
    pub selected_resources:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SelectedResource>>>,
}
...
pub struct CloudStorageConfig {
    ...
    pub avro_config: ::core::option::Option<::std::boxed::Box<AvroConfig>>,
...
pub struct DataExchange {
    ...
    pub sharing_environment_config:
        ::core::option::Option<::std::boxed::Box<SharingEnvironmentConfig>>,
}
...
pub struct DestinationDataset {
    ...
    pub dataset_reference: ::core::option::Option<::std::boxed::Box<DestinationDatasetReference>>,
...
pub struct DestinationPubSubSubscription {
    ...
    pub pubsub_subscription: ::core::option::Option<::std::boxed::Box<GooglePubsubV1Subscription>>,
}
...
pub struct GooglePubsubV1Subscription {
    ...
    pub bigquery_config: ::core::option::Option<::std::boxed::Box<BigQueryConfig>>,
    ...
    pub bigtable_config: ::core::option::Option<::std::boxed::Box<BigtableConfig>>,
    ...
    pub cloud_storage_config: ::core::option::Option<::std::boxed::Box<CloudStorageConfig>>,
    ...
    pub dead_letter_policy: ::core::option::Option<::std::boxed::Box<DeadLetterPolicy>>,
    ...
    pub expiration_policy: ::core::option::Option<::std::boxed::Box<ExpirationPolicy>>,
    ...
    pub message_transforms:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<MessageTransform>>>,
    ...
    pub push_config: ::core::option::Option<::std::boxed::Box<PushConfig>>,
    ...
    pub retry_policy: ::core::option::Option<::std::boxed::Box<RetryPolicy>>,
...
pub struct ListDataExchangesResponse {
    ...
    pub data_exchanges: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DataExchange>>>,
...
pub struct ListQueryTemplatesResponse {
    ...
    pub query_templates: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<QueryTemplate>>>,
}
...
pub struct ListSharedResourceSubscriptionsResponse {
    ...
    pub shared_resource_subscriptions:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Subscription>>>,
}
...
pub struct Listing {
    ...
    pub bigquery_dataset: ::core::option::Option<::std::boxed::Box<BigQueryDatasetSource>>,
    ...
    pub commercial_info: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudBigqueryAnalyticshubV1ListingCommercialInfo>,
    >,
    /// Optional. Details of the data provider who owns the source data.
    #[serde(default, rename = "dataProvider")]
    pub data_provider: ::core::option::Option<::std::boxed::Box<DataProvider>>,
    ...
    pub pubsub_topic: ::core::option::Option<::std::boxed::Box<PubSubTopicSource>>,
    ...
    pub restricted_export_config: ::core::option::Option<::std::boxed::Box<RestrictedExportConfig>>,
    ...
    pub stored_procedure_config: ::core::option::Option<::std::boxed::Box<StoredProcedureConfig>>,
}
...
pub struct MessageTransform {
    ...
    pub ai_inference: ::core::option::Option<::std::boxed::Box<AIInference>>,
    ...
    pub javascript_udf: ::core::option::Option<::std::boxed::Box<JavaScriptUDF>>,
}
...
pub struct PushConfig {
    ...
    pub no_wrapper: ::core::option::Option<::std::boxed::Box<NoWrapper>>,
...
pub struct QueryTemplate {
    ...
    #[serde(default)]
    pub routine: ::core::option::Option<::std::boxed::Box<Routine>>,
...
pub struct SharingEnvironmentConfig {
    ...
    pub dcr_exchange_config: ::core::option::Option<::std::boxed::Box<DcrExchangeConfig>>,
...
pub struct SubscribeDataExchangeRequest {
    ...
    pub destination_dataset: ::core::option::Option<::std::boxed::Box<DestinationDataset>>,
...
pub struct SubscribeListingRequest {
    ...
    pub destination_pubsub_subscription:
        ::core::option::Option<::std::boxed::Box<DestinationPubSubSubscription>>,
}
...
pub struct Subscription {
    ...
    #[serde(default, rename = "commercialInfo")]
    pub commercial_info: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudBigqueryAnalyticshubV1SubscriptionCommercialInfo>,
    >,
    ...
    pub linked_resources:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<LinkedResource>>>,
