...
pub struct AnalyticsDetails {
    ...
    pub analytics_property: ::core::option::Option<AnalyticsProperty>,
...
pub struct ListAndroidAppsResponse {
    ...
    #[serde(default)]
    pub apps: ::core::option::Option<::std::vec::Vec<AndroidApp>>,
...
pub struct ListAvailableProjectsResponse {
    ...
    pub project_info: ::core::option::Option<::std::vec::Vec<ProjectInfo>>,
}
...
pub struct ListFirebaseProjectsResponse {
    ...
    #[serde(default)]
    pub results: ::core::option::Option<::std::vec::Vec<FirebaseProject>>,
}
...
pub struct ListIosAppsResponse {
    ...
    #[serde(default)]
    pub apps: ::core::option::Option<::std::vec::Vec<IosApp>>,
...
pub struct ListShaCertificatesResponse {
    ...
    #[serde(default)]
    pub certificates: ::core::option::Option<::std::vec::Vec<ShaCertificate>>,
}
...
pub struct ListWebAppsResponse {
    ...
    #[serde(default)]
    pub apps: ::core::option::Option<::std::vec::Vec<WebApp>>,
...
pub struct SearchFirebaseAppsResponse {
    ...
    #[serde(default)]
    pub apps: ::core::option::Option<::std::vec::Vec<FirebaseAppInfo>>,
