...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/apigateway/openapi.json`.
...
pub struct ApigatewayApiConfig {
    ...
    pub grpc_services: ::core::option::Option<
    ...
    pub managed_service_configs:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ApigatewayApiConfigFile>>>,
    ...
    pub openapi_documents: ::core::option::Option<
...
pub struct ApigatewayApiConfigGrpcServiceDefinition {
    ...
    pub file_descriptor_set: ::core::option::Option<::std::boxed::Box<ApigatewayApiConfigFile>>,
    ...
    #[serde(default)]
    pub source: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ApigatewayApiConfigFile>>>,
}
...
pub struct ApigatewayApiConfigOpenApiDocument {
    ...
    #[serde(default)]
    pub document: ::core::option::Option<::std::boxed::Box<ApigatewayApiConfigFile>>,
}
...
pub struct ApigatewayAuditConfig {
    ...
    pub audit_log_configs:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ApigatewayAuditLogConfig>>>,
...
pub struct ApigatewayBinding {
    ...
    #[serde(default)]
    pub condition: ::core::option::Option<::std::boxed::Box<ApigatewayExpr>>,
...
pub struct ApigatewayListApiConfigsResponse {
    ...
    pub api_configs:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ApigatewayApiConfig>>>,
    /// Next page token.
...
pub struct ApigatewayListApisResponse {
    /// APIs.
    #[serde(default)]
    pub apis: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ApigatewayApi>>>,
    /// Next page token.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// Locations that could not be reached.
...
pub struct ApigatewayListGatewaysResponse {
    /// Gateways.
    #[serde(default)]
    pub gateways: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ApigatewayGateway>>>,
    /// Next page token.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// Locations that could not be reached.
...
pub struct ApigatewayListLocationsResponse {
    ...
    #[serde(default)]
    pub locations: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ApigatewayLocation>>>,
...
pub struct ApigatewayListOperationsResponse {
    ...
    #[serde(default)]
    pub operations: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ApigatewayOperation>>>,
...
pub struct ApigatewayOperation {
    ...
    #[serde(default)]
    pub error: ::core::option::Option<::std::boxed::Box<ApigatewayStatus>>,
...
pub struct ApigatewayOperationMetadata {
    ...
    #[serde(default)]
    pub diagnostics: ::core::option::Option<
...
pub struct ApigatewayPolicy {
    ...
    pub audit_configs:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ApigatewayAuditConfig>>>,
    /// Associates a list of members, or principals, with a role. Optionally, may specify a condition that determines how and when the bindings are applied. Each of the bindings must contain at least one principal. The bindings in a Policy can refer to up to 1,500 principals; up to 250 of these principals can be Google groups. Each occurrence of a principal counts towards these limits. For example, if the bindings grant 50 different roles to user:alice@example.com, and not to any other principal, then you can add another 1,450 principals to the bindings in the Policy.
    #[serde(default)]
    pub bindings: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ApigatewayBinding>>>,
...
pub struct ApigatewaySetIamPolicyRequest {
    ...
    #[serde(default)]
    pub policy: ::core::option::Option<::std::boxed::Box<ApigatewayPolicy>>,
