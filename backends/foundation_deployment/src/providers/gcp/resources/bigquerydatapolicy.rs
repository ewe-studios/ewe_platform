...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/bigquerydatapolicy/openapi.json`.
...
pub struct CreateDataPolicyRequest {
    ...
    pub data_policy: ::core::option::Option<::std::boxed::Box<DataPolicy>>,
...
pub struct DataPolicy {
    ...
    pub data_governance_tag: ::core::option::Option<::std::boxed::Box<DataGovernanceTag>>,
    ...
    pub data_masking_policy: ::core::option::Option<::std::boxed::Box<DataMaskingPolicy>>,
...
pub struct ListDataPoliciesResponse {
    ...
    pub data_policies: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DataPolicy>>>,
