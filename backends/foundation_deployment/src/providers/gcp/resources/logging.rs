...
pub struct BucketMetadata {
    ...
    pub create_bucket_request: Option<CreateBucketRequest>,
    ...
    pub update_bucket_request: Option<UpdateBucketRequest>,
}
...
pub struct CopyLogEntriesResponse {
    ...
    pub log_entries_copied_count: Option<String>,
}
...
pub struct LinkMetadata {
    ...
    pub create_link_request: Option<CreateLinkRequest>,
    /// DeleteLink RPC request.
    #[serde(default, rename = "deleteLinkRequest")]
    pub delete_link_request: Option<DeleteLinkRequest>,
    /// The end time of an operation.
    #[serde(default, rename = "endTime")]
    pub end_time: Option<String>,
...
pub struct LocationMetadata {
    ...
    pub log_analytics_enabled: Option<bool>,
}
...
pub struct RequestLog {
    ...
    #[serde(default)]
    pub line: Option<Vec<LogLine>>,
    /// Number of CPU megacycles used to process request.
    #[serde(default, rename = "megaCycles")]
    pub mega_cycles: Option<String>,
    ...
    pub url_map_entry: Option<String>,
    ...
    pub was_loading_request: Option<bool>,
}
