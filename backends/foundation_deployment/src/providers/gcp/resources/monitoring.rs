...
pub struct CreateCollectdTimeSeriesRequest {
    ...
    pub collectd_payloads: ::core::option::Option<::std::vec::Vec<CollectdPayload>>,
...
pub struct CreateCollectdTimeSeriesResponse {
    ...
    pub payload_errors: ::core::option::Option<::std::vec::Vec<CollectdPayloadError>>,
    ...
    #[serde(default)]
    pub summary: ::core::option::Option<CreateTimeSeriesSummary>,
}
...
pub struct ListAlertPoliciesResponse {
    ...
    pub alert_policies: ::core::option::Option<::std::vec::Vec<AlertPolicy>>,
...
pub struct ListGroupMembersResponse {
    ...
    #[serde(default)]
    pub members: ::core::option::Option<::std::vec::Vec<MonitoredResource>>,
...
pub struct ListGroupsResponse {
    ...
    #[serde(default)]
    pub group: ::core::option::Option<::std::vec::Vec<Group>>,
    /// If there are more results than have been returned, then this field is set to a non-empty value. To see the additional results, use that value as page_token in the next call to this method.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct ListMetricDescriptorsResponse {
    ...
    pub metric_descriptors: ::core::option::Option<::std::vec::Vec<MetricDescriptor>>,
    /// If there are more results than have been returned, then this field is set to a non-empty value. To see the additional results, use that value as page_token in the next call to this method.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct ListNotificationChannelDescriptorsResponse {
    ...
    pub channel_descriptors: ::core::option::Option<::std::vec::Vec<NotificationChannelDescriptor>>,
...
pub struct ListNotificationChannelsResponse {
    ...
    pub notification_channels: ::core::option::Option<::std::vec::Vec<NotificationChannel>>,
...
pub struct ListServiceLevelObjectivesResponse {
    ...
    pub service_level_objectives: ::core::option::Option<::std::vec::Vec<ServiceLevelObjective>>,
}
...
pub struct ListSnoozesResponse {
    ...
    #[serde(default)]
    pub snoozes: ::core::option::Option<::std::vec::Vec<Snooze>>,
}
...
pub struct ListTimeSeriesResponse {
    ...
    pub execution_errors: ::core::option::Option<::std::vec::Vec<Status>>,
    /// If there are more results than have been returned, then this field is set to a non-empty value. To see the additional results, use that value as page_token in the next call to this method.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
...
pub struct ListUptimeCheckConfigsResponse {
    ...
    pub uptime_check_configs: ::core::option::Option<::std::vec::Vec<UptimeCheckConfig>>,
}
...
pub struct ListUptimeCheckIpsResponse {
    ...
    pub uptime_check_ips: ::core::option::Option<::std::vec::Vec<UptimeCheckIp>>,
}
...
pub struct QueryTimeSeriesResponse {
    ...
    pub partial_errors: ::core::option::Option<::std::vec::Vec<Status>>,
    /// The time series data.
    #[serde(default, rename = "timeSeriesData")]
    pub time_series_data: ::core::option::Option<::std::vec::Vec<TimeSeriesData>>,
...
pub struct CollectdPayload {
    ...
    #[serde(default)]
    pub values: ::core::option::Option<::std::vec::Vec<CollectdValue>>,
}
...
pub struct CollectdPayloadError {
    ...
    pub value_errors: ::core::option::Option<::std::vec::Vec<CollectdValueError>>,
}
...
pub struct AlertPolicy {
    ...
    pub alert_strategy: ::core::option::Option<AlertStrategy>,
    ...
    #[serde(default)]
    pub validity: ::core::option::Option<Status>,
}
...
pub struct Alert {
    ...
    #[serde(default)]
    pub log: ::core::option::Option<LogMetadata>,
    ...
    #[serde(default)]
    pub policy: ::core::option::Option<PolicySnapshot>,
...
pub struct NotificationChannel {
    ...
    pub mutation_records: ::core::option::Option<::std::vec::Vec<MutationRecord>>,
...
pub struct Service {
    ...
    pub app_engine: ::core::option::Option<AppEngine>,
    ...
    pub basic_service: ::core::option::Option<BasicService>,
    /// Type used for Cloud Endpoints services.
    #[serde(default, rename = "cloudEndpoints")]
    pub cloud_endpoints: ::core::option::Option<CloudEndpoints>,
    /// Type used for Cloud Run services.
    #[serde(default, rename = "cloudRun")]
    pub cloud_run: ::core::option::Option<CloudRun>,
    ...
    pub gke_namespace: ::core::option::Option<GkeNamespace>,
    /// Type used for GKE Services (the Kubernetes concept of a service).
    #[serde(default, rename = "gkeService")]
    pub gke_service: ::core::option::Option<GkeService>,
    ...
    pub istio_canonical_service: ::core::option::Option<IstioCanonicalService>,
    /// Type used for Istio services scoped to an Istio mesh.
    #[serde(default, rename = "meshIstio")]
    pub mesh_istio: ::core::option::Option<MeshIstio>,
...
pub struct TimeSeries {
    ...
    #[serde(default)]
    pub points: ::core::option::Option<::std::vec::Vec<Point>>,
...
pub struct UptimeCheckConfig {
    ...
    pub content_matchers: ::core::option::Option<::std::vec::Vec<ContentMatcher>>,
    ...
    pub http_check: ::core::option::Option<HttpCheck>,
    /// The internal checkers that this check will egress from. If is_internal is true and this list is empty, the check will egress from all the InternalCheckers configured for the project that owns this UptimeCheckConfig.
    #[serde(default, rename = "internalCheckers")]
    pub internal_checkers: ::core::option::Option<::std::vec::Vec<InternalChecker>>,
    ...
    pub monitored_resource: ::core::option::Option<MonitoredResource>,
    ...
    pub synthetic_monitor: ::core::option::Option<SyntheticMonitorTarget>,
    /// Contains information needed to make a TCP check.
    #[serde(default, rename = "tcpCheck")]
    pub tcp_check: ::core::option::Option<TcpCheck>,
...
pub struct TimeSeriesData {
    ...
    pub label_values: ::core::option::Option<::std::vec::Vec<LabelValue>>,
    /// The points in the time series.
    #[serde(default, rename = "pointData")]
    pub point_data: ::core::option::Option<::std::vec::Vec<PointData>>,
}
...
pub struct TimeSeriesDescriptor {
    ...
    pub label_descriptors: ::core::option::Option<::std::vec::Vec<LabelDescriptor>>,
    /// Descriptors for the point data value columns.
    #[serde(default, rename = "pointDescriptors")]
    pub point_descriptors: ::core::option::Option<::std::vec::Vec<ValueDescriptor>>,
}
...
pub struct AlertStrategy {
    ...
    pub notification_channel_strategy:
        ::core::option::Option<::std::vec::Vec<NotificationChannelStrategy>>,
    ...
    pub notification_rate_limit: ::core::option::Option<NotificationRateLimit>,
}
...
pub struct LogMetadata {
    ...
    pub extracted_labels: ::core::option::Option<serde_json::Value>,
}
...
pub struct ServiceLevelIndicator {
    ...
    pub basic_sli: ::core::option::Option<BasicSli>,
    /// Request-based SLIs
    #[serde(default, rename = "requestBased")]
    pub request_based: ::core::option::Option<RequestBasedSli>,
    /// Windows-based SLIs
    #[serde(default, rename = "windowsBased")]
    pub windows_based: ::core::option::Option<WindowsBasedSli>,
}
...
pub struct ContentMatcher {
    ...
    pub json_path_matcher: ::core::option::Option<JsonPathMatcher>,
...
pub struct HttpCheck {
    ...
    pub accepted_response_status_codes: ::core::option::Option<::std::vec::Vec<ResponseStatusCode>>,
    ...
    pub auth_info: ::core::option::Option<BasicAuthentication>,
    ...
    pub service_agent_authentication: ::core::option::Option<ServiceAgentAuthentication>,
...
pub struct SyntheticMonitorTarget {
    ...
    pub cloud_function_v2: ::core::option::Option<CloudFunctionV2Target>,
}
...
pub struct PointData {
    ...
    #[serde(default)]
    pub values: ::core::option::Option<::std::vec::Vec<TypedValue>>,
}
...
pub struct SqlCondition {
    ...
    pub boolean_test: ::core::option::Option<BooleanTest>,
    /// Schedule the query to execute every so many days.
    #[serde(default)]
    pub daily: ::core::option::Option<Daily>,
    /// Schedule the query to execute every so many hours.
    #[serde(default)]
    pub hourly: ::core::option::Option<Hourly>,
    /// Schedule the query to execute every so many minutes.
    #[serde(default)]
    pub minutes: ::core::option::Option<Minutes>,
    ...
    pub row_count_test: ::core::option::Option<RowCountTest>,
}
...
pub struct MetricThreshold {
    ...
    pub denominator_aggregations: ::core::option::Option<::std::vec::Vec<Aggregation>>,
    ...
    pub forecast_options: ::core::option::Option<ForecastOptions>,
...
pub struct WindowsBasedSli {
    ...
    pub good_total_ratio_threshold: ::core::option::Option<PerformanceThreshold>,
    /// A window is good if the metric''s value is in a good range, averaged across returned streams.
    #[serde(default, rename = "metricMeanInRange")]
    pub metric_mean_in_range: ::core::option::Option<MetricRange>,
    /// A window is good if the metric''s value is in a good range, summed across returned streams.
    #[serde(default, rename = "metricSumInRange")]
    pub metric_sum_in_range: ::core::option::Option<MetricRange>,
...
pub struct CloudFunctionV2Target {
    ...
    pub cloud_run_revision: ::core::option::Option<MonitoredResource>,
...
pub struct TypedValue {
    ...
    pub distribution_value: ::core::option::Option<Distribution>,
...
pub struct Daily {
    ...
    pub execution_time: ::core::option::Option<TimeOfDay>,
...
pub struct PerformanceThreshold {
    ...
    pub basic_sli_performance: ::core::option::Option<BasicSli>,
    /// RequestBasedSli to evaluate to judge window quality.
    #[serde(default)]
    pub performance: ::core::option::Option<RequestBasedSli>,
...
pub struct MetricRange {
    ...
    #[serde(default)]
    pub range: ::core::option::Option<GoogleMonitoringV3Range>,
...
pub struct Distribution {
    ...
    #[serde(default)]
    pub exemplars: ::core::option::Option<::std::vec::Vec<Exemplar>>,
...
pub struct RequestBasedSli {
    ...
    pub distribution_cut: ::core::option::Option<DistributionCut>,
    /// good_total_ratio is used when the ratio of good_service to total_service is computed from two TimeSeries.
    #[serde(default, rename = "goodTotalRatio")]
    pub good_total_ratio: ::core::option::Option<TimeSeriesRatio>,
}
...
impl ResourceIdentifier<MonitoringFoldersTimeSeriesListArgs> for ListTimeSeriesResponse {
    fn generate_resource_id(&self, input: &MonitoringFoldersTimeSeriesListArgs) -> String {
        format!("gcp::ListTimeSeriesResponse/{}", input.name)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::ListTimeSeriesResponse"
    }
...
impl ResourceIdentifier<MonitoringProjectsAlertPoliciesCreateArgs> for AlertPolicy {
    fn generate_resource_id(&self, input: &MonitoringProjectsAlertPoliciesCreateArgs) -> String {
        format!("gcp::AlertPolicy/{}", input.name)
    }
...
impl ResourceIdentifier<MonitoringProjectsAlertPoliciesListArgs> for ListAlertPoliciesResponse {
    fn generate_resource_id(&self, input: &MonitoringProjectsAlertPoliciesListArgs) -> String {
        format!("gcp::ListAlertPoliciesResponse/{}", input.name)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::ListAlertPoliciesResponse"
    }
    ...
    for CreateCollectdTimeSeriesResponse
{
    fn generate_resource_id(
        ...
        format!("gcp::CreateCollectdTimeSeriesResponse/{}", input.name)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::CreateCollectdTimeSeriesResponse"
    }
...
impl ResourceIdentifier<MonitoringProjectsGroupsListArgs> for ListGroupsResponse {
    fn generate_resource_id(&self, input: &MonitoringProjectsGroupsListArgs) -> String {
        format!("gcp::ListGroupsResponse/{}", input.name)
    }
...
impl ResourceIdentifier<MonitoringProjectsGroupsMembersListArgs> for ListGroupMembersResponse {
    fn generate_resource_id(&self, input: &MonitoringProjectsGroupsMembersListArgs) -> String {
        format!("gcp::ListGroupMembersResponse/{}", input.name)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::ListGroupMembersResponse"
    }
...
impl ResourceIdentifier<MonitoringProjectsMetricDescriptorsCreateArgs> for MetricDescriptor {
    fn generate_resource_id(
        ...
        format!("gcp::MetricDescriptor/{}", input.name)
    }
    ...
    for ListMetricDescriptorsResponse
{
    fn generate_resource_id(&self, input: &MonitoringProjectsMetricDescriptorsListArgs) -> String {
        format!("gcp::ListMetricDescriptorsResponse/{}", input.name)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::ListMetricDescriptorsResponse"
    }
    ...
    for MonitoredResourceDescriptor
{
    fn generate_resource_id(
        ...
        format!("gcp::MonitoredResourceDescriptor/{}", input.name)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::MonitoredResourceDescriptor"
    }
    ...
    for NotificationChannelDescriptor
{
    fn generate_resource_id(
        ...
        format!("gcp::NotificationChannelDescriptor/{}", input.name)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::NotificationChannelDescriptor"
    }
    ...
    for ListNotificationChannelDescriptorsResponse
{
    fn generate_resource_id(
        ...
        format!(
            "gcp::ListNotificationChannelDescriptorsResponse/{}",
            input.name
        )
    }
...
impl ResourceIdentifier<MonitoringProjectsNotificationChannelsCreateArgs> for NotificationChannel {
    fn generate_resource_id(
        ...
        format!("gcp::NotificationChannel/{}", input.name)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::NotificationChannel"
    }
    ...
    for GetNotificationChannelVerificationCodeResponse
{
    fn generate_resource_id(
        ...
        format!(
            "gcp::GetNotificationChannelVerificationCodeResponse/{}",
            input.name
        )
    }
    ...
    for ListNotificationChannelsResponse
{
    fn generate_resource_id(
        ...
        format!("gcp::ListNotificationChannelsResponse/{}", input.name)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::ListNotificationChannelsResponse"
    }
...
impl ResourceIdentifier<MonitoringProjectsSnoozesCreateArgs> for Snooze {
    fn generate_resource_id(&self, input: &MonitoringProjectsSnoozesCreateArgs) -> String {
        format!("gcp::Snooze/{}", input.parent)
    }
...
impl ResourceIdentifier<MonitoringProjectsSnoozesListArgs> for ListSnoozesResponse {
    fn generate_resource_id(&self, input: &MonitoringProjectsSnoozesListArgs) -> String {
        format!("gcp::ListSnoozesResponse/{}", input.parent)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::ListSnoozesResponse"
    }
...
impl ResourceIdentifier<MonitoringProjectsTimeSeriesQueryArgs> for QueryTimeSeriesResponse {
    fn generate_resource_id(&self, input: &MonitoringProjectsTimeSeriesQueryArgs) -> String {
        format!("gcp::QueryTimeSeriesResponse/{}", input.name)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::QueryTimeSeriesResponse"
    }
...
impl ResourceIdentifier<MonitoringProjectsUptimeCheckConfigsCreateArgs> for UptimeCheckConfig {
    fn generate_resource_id(
        ...
        format!("gcp::UptimeCheckConfig/{}", input.parent)
    }
    ...
    for ListUptimeCheckConfigsResponse
{
    fn generate_resource_id(&self, input: &MonitoringProjectsUptimeCheckConfigsListArgs) -> String {
        format!("gcp::ListUptimeCheckConfigsResponse/{}", input.parent)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::ListUptimeCheckConfigsResponse"
    }
...
impl ResourceIdentifier<MonitoringServicesCreateArgs> for Service {
    fn generate_resource_id(&self, input: &MonitoringServicesCreateArgs) -> String {
        format!("gcp::Service/{}", input.parent)
    }
    ...
    for ServiceLevelObjective
{
    fn generate_resource_id(
        ...
        format!("gcp::ServiceLevelObjective/{}", input.parent)
    }
    ...
    for ListServiceLevelObjectivesResponse
{
    fn generate_resource_id(
        ...
        format!("gcp::ListServiceLevelObjectivesResponse/{}", input.parent)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::ListServiceLevelObjectivesResponse"
    }
...
impl ResourceIdentifier<MonitoringUptimeCheckIpsListArgs> for ListUptimeCheckIpsResponse {
    fn generate_resource_id(&self, input: &MonitoringUptimeCheckIpsListArgs) -> String {
        "gcp::ListUptimeCheckIpsResponse".to_string()
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::ListUptimeCheckIpsResponse"
    }
