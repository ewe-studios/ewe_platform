//! Auto-generated resource types for Google Cloud Platform - cloudasset.
//!
...
pub struct AnalyzeIamPolicyLongrunningRequest {
    ...
    #[serde(default, rename = "savedAnalysisQuery")]
...
pub struct AnalyzeIamPolicyResponse {
    ...
    pub fully_explored: ::core::option::Option<bool>,
    /// The main analysis that matches the original request.
    #[serde(default, rename = "mainAnalysis")]
    pub main_analysis: ::core::option::Option<IamPolicyAnalysis>,
    ...
    #[serde(default, rename = "serviceAccountImpersonationAnalysis")]
    pub service_account_impersonation_analysis:
        ::core::option::Option<::std::vec::Vec<IamPolicyAnalysis>>,
}
...
pub struct AnalyzeMoveResponse {
    ...
    pub move_analysis: ::core::option::Option<::std::vec::Vec<MoveAnalysis>>,
}
...
pub struct AnalyzeOrgPoliciesResponse {
    ...
    #[serde(default, rename = "orgPolicyResults")]
    pub org_policy_results: ::core::option::Option<::std::vec::Vec<OrgPolicyResult>>,
}
...
pub struct AnalyzeOrgPolicyGovernedAssetsResponse {
    ...
    #[serde(default, rename = "governedAssets")]
    pub governed_assets: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudAssetV1AnalyzeOrgPolicyGovernedAssetsResponseGovernedAsset>,
    >,
...
pub struct AnalyzeOrgPolicyGovernedContainersResponse {
    ...
    #[serde(default, rename = "governedContainers")]
    pub governed_containers:
        ::core::option::Option<::std::vec::Vec<GoogleCloudAssetV1GovernedContainer>>,
...
pub struct BatchGetAssetsHistoryResponse {
    ...
    #[serde(default)]
    pub assets: ::core::option::Option<::std::vec::Vec<TemporalAsset>>,
}
...
pub struct BatchGetEffectiveIamPoliciesResponse {
    ...
    pub policy_results: ::core::option::Option<::std::vec::Vec<EffectiveIamPolicy>>,
}
...
pub struct ExportAssetsRequest {
    ...
    pub asset_types: ::core::option::Option<::std::vec::Vec<String>>,
    /// Asset content type. If not specified, no content but the asset name will be returned. // TODO: enum values: ["CONTENT_TYPE_UNSPECIFIED", "RESOURCE", "IAM_POLICY", "ORG_POLICY", "ACCESS_POLICY", "OS_INVENTORY", "RELATIONSHIP"]
...
pub struct GoogleCloudAssetV1p7beta1Asset {
    ...
    pub access_level: ::core::option::Option<GoogleIdentityAccesscontextmanagerV1AccessLevel>,
    ...
    pub access_policy: ::core::option::Option<GoogleIdentityAccesscontextmanagerV1AccessPolicy>,
    ...
    pub iam_policy: ::core::option::Option<Policy>,
    ...
    #[serde(default, rename = "orgPolicy")]
    pub org_policy: ::core::option::Option<::std::vec::Vec<GoogleCloudOrgpolicyV1Policy>>,
    /// The related assets of the asset of one relationship type. One asset only represents one type of relationship.
    #[serde(default, rename = "relatedAssets")]
    pub related_assets: ::core::option::Option<GoogleCloudAssetV1p7beta1RelatedAssets>,
    /// A representation of the resource.
    #[serde(default)]
    pub resource: ::core::option::Option<GoogleCloudAssetV1p7beta1Resource>,
    /// Please also refer to the [service perimeter user guide](https://cloud.google.com/vpc-service-controls/docs/overview).
    #[serde(default, rename = "servicePerimeter")]
    pub service_perimeter:
        ::core::option::Option<GoogleIdentityAccesscontextmanagerV1ServicePerimeter>,
...
pub struct Item {
    ...
    pub available_package: ::core::option::Option<SoftwarePackage>,
    ...
    #[serde(default, rename = "installedPackage")]
    pub installed_package: ::core::option::Option<SoftwarePackage>,
    /// The origin of this inventory item. // TODO: enum values: ["ORIGIN_TYPE_UNSPECIFIED", "INVENTORY_REPORT"]
    #[serde(default, rename = "originType")]
    pub origin_type: ::core::option::Option<String>,
    /// The specific type of inventory, correlating to its specific details. // TODO: enum values: ["TYPE_UNSPECIFIED", "INSTALLED_PACKAGE", "AVAILABLE_PACKAGE"]
...
pub struct ListFeedsResponse {
    /// A list of feeds.
    #[serde(default)]
    pub feeds: ::core::option::Option<::std::vec::Vec<Feed>>,
}
...
pub struct QueryAssetsRequest {
    ...
    pub job_reference: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "readTimeWindow")]
...
pub struct RelatedResources {
    ...
    pub related_resources: ::core::option::Option<::std::vec::Vec<RelatedResource>>,
}
...
pub struct SearchAllIamPoliciesResponse {
    ...
    #[serde(default)]
    pub results: ::core::option::Option<::std::vec::Vec<IamPolicySearchResult>>,
}
...
pub struct SearchAllResourcesResponse {
    ...
    #[serde(default)]
    pub results: ::core::option::Option<::std::vec::Vec<ResourceSearchResult>>,
}
...
pub struct IamPolicyAnalysisOutputConfig {
    ...
    pub bigquery_destination: ::core::option::Option<GoogleCloudAssetV1BigQueryDestination>,
    /// Destination on Cloud Storage.
    #[serde(default, rename = "gcsDestination")]
    pub gcs_destination: ::core::option::Option<GoogleCloudAssetV1GcsDestination>,
}
...
pub struct IamPolicyAnalysis {
    ...
    #[serde(default, rename = "analysisResults")]
    pub analysis_results: ::core::option::Option<::std::vec::Vec<IamPolicyAnalysisResult>>,
    /// Represents whether all entries in the analysis_results have been fully explored to answer the query.
    #[serde(default, rename = "fullyExplored")]
    pub fully_explored: ::core::option::Option<bool>,
    /// A list of non-critical errors happened during the query handling.
    #[serde(default, rename = "nonCriticalErrors")]
    pub non_critical_errors: ::core::option::Option<::std::vec::Vec<IamPolicyAnalysisState>>,
}
...
pub struct MoveAnalysis {
    ...
    #[serde(default)]
    pub analysis: ::core::option::Option<MoveAnalysisResult>,
...
pub struct OrgPolicyResult {
    ...
    pub consolidated_policy: ::core::option::Option<AnalyzerOrgPolicy>,
    ...
    #[serde(default, rename = "policyBundle")]
    pub policy_bundle: ::core::option::Option<::std::vec::Vec<AnalyzerOrgPolicy>>,
...
pub struct GoogleCloudAssetV1AnalyzeOrgPolicyGovernedAssetsResponseGovernedAsset {
    ...
    #[serde(default, rename = "governedIamPolicy")]
    pub governed_iam_policy: ::core::option::Option<
    ...
    #[serde(default, rename = "governedResource")]
    pub governed_resource: ::core::option::Option<
...
pub struct AnalyzerOrgPolicyConstraint {
    ...
    pub custom_constraint: ::core::option::Option<GoogleCloudAssetV1CustomConstraint>,
    /// The definition of the canned constraint defined by Google.
    #[serde(default, rename = "googleDefinedConstraint")]
    pub google_defined_constraint: ::core::option::Option<GoogleCloudAssetV1Constraint>,
}
...
pub struct GoogleCloudAssetV1GovernedContainer {
    ...
    pub effective_tags: ::core::option::Option<::std::vec::Vec<EffectiveTagDetails>>,
...
pub struct TemporalAsset {
    ...
    #[serde(default, rename = "priorAsset")]
    pub prior_asset: ::core::option::Option<Asset>,
    /// State of prior_asset. // TODO: enum values: ["PRIOR_ASSET_STATE_UNSPECIFIED", "PRESENT", "INVALID", "DOES_NOT_EXIST", "DELETED"]
    #[serde(default, rename = "priorAssetState")]
    pub prior_asset_state: ::core::option::Option<String>,
...
pub struct EffectiveIamPolicy {
    ...
    #[serde(default)]
    pub policies: ::core::option::Option<::std::vec::Vec<PolicyInfo>>,
}
...
pub struct GoogleCloudAssetV1p7beta1RelatedAssets {
    ...
    #[serde(default)]
    pub assets: ::core::option::Option<::std::vec::Vec<GoogleCloudAssetV1p7beta1RelatedAsset>>,
    /// The detailed relation attributes.
    #[serde(default, rename = "relationshipAttributes")]
    pub relationship_attributes:
        ::core::option::Option<GoogleCloudAssetV1p7beta1RelationshipAttributes>,
}
...
pub struct GoogleCloudAssetV1p7beta1Resource {
    ...
    #[serde(default, rename = "discoveryDocumentUri")]
    pub discovery_document_uri: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "discoveryName")]
    pub discovery_name: ::core::option::Option<String>,
...
pub struct SoftwarePackage {
    ...
    pub apt_package: ::core::option::Option<VersionedPackage>,
    /// Details of a COS package.
    #[serde(default, rename = "cosPackage")]
    pub cos_package: ::core::option::Option<VersionedPackage>,
    /// Details of a Googet package. For details about the googet package manager, see https://github.com/google/googet.
    #[serde(default, rename = "googetPackage")]
    pub googet_package: ::core::option::Option<VersionedPackage>,
    /// Details of a Windows Quick Fix engineering package. See https://docs.microsoft.com/en-us/windows/win32/cimwin32prov/win32-quickfixengineering for info in Windows Quick Fix Engineering.
    #[serde(default, rename = "qfePackage")]
    pub qfe_package: ::core::option::Option<WindowsQuickFixEngineeringPackage>,
    /// Details of Windows Application.
    #[serde(default, rename = "windowsApplication")]
    pub windows_application: ::core::option::Option<WindowsApplication>,
    /// Details of a Windows Update package. See https://docs.microsoft.com/en-us/windows/win32/api/_wua/ for information about Windows Update.
    #[serde(default, rename = "wuaPackage")]
    pub wua_package: ::core::option::Option<WindowsUpdatePackage>,
    /// Yum package info. For details about the yum package manager, see https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/6/html/deployment_guide/ch-yum.
    #[serde(default, rename = "yumPackage")]
    pub yum_package: ::core::option::Option<VersionedPackage>,
    /// Details of a Zypper package. For details about the Zypper package manager, see https://en.opensuse.org/SDB:Zypper_manual.
    #[serde(default, rename = "zypperPackage")]
    pub zypper_package: ::core::option::Option<VersionedPackage>,
    /// Details of a Zypper patch. For details about the Zypper package manager, see https://en.opensuse.org/SDB:Zypper_manual.
    #[serde(default, rename = "zypperPatch")]
    pub zypper_patch: ::core::option::Option<ZypperPatch>,
}
...
pub struct SavedQuery {
    /// The query content.
    #[serde(default)]
    pub content: ::core::option::Option<QueryContent>,
    ...
    #[serde(default, rename = "lastUpdater")]
    pub last_updater: ::core::option::Option<String>,
...
pub struct QueryAssetsOutputConfig {
    ...
    pub bigquery_destination:
        ::core::option::Option<GoogleCloudAssetV1QueryAssetsOutputConfigBigQueryDestination>,
}
...
pub struct ResourceSearchResult {
    ...
    pub additional_attributes: ::core::option::Option<serde_json::Value>,
    ...
    #[serde(default, rename = "attachedResources")]
    pub attached_resources: ::core::option::Option<::std::vec::Vec<AttachedResource>>,
    ...
    #[serde(default)]
    pub enrichments: ::core::option::Option<::std::vec::Vec<AssetEnrichment>>,
    ...
    #[serde(default, rename = "kmsKeys")]
    pub kms_keys: ::core::option::Option<::std::vec::Vec<String>>,
    ...
    #[serde(default, rename = "parentAssetType")]
    pub parent_asset_type: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "parentFullResourceName")]
    pub parent_full_resource_name: ::core::option::Option<String>,
    ...
    #[serde(default)]
    pub relationships: ::core::option::Option<serde_json::Value>,
    ...
    #[serde(default, rename = "sccSecurityMarks")]
    pub scc_security_marks: ::core::option::Option<serde_json::Value>,
    ...
    pub tag_keys: ::core::option::Option<::std::vec::Vec<String>>,
    ...
    #[serde(default, rename = "tagValueIds")]
    pub tag_value_ids: ::core::option::Option<::std::vec::Vec<String>>,
    ...
    #[serde(default, rename = "versionedResources")]
    pub versioned_resources: ::core::option::Option<::std::vec::Vec<VersionedResource>>,
}
...
pub struct Feed {
    ...
    pub asset_names: ::core::option::Option<::std::vec::Vec<String>>,
    ...
    /// Asset content type. If not specified, no content but the asset name and type will be returned. // TODO: enum values: ["CONTENT_TYPE_UNSPECIFIED", "RESOURCE", "IAM_POLICY", "ORG_POLICY", "ACCESS_POLICY", "OS_INVENTORY", "RELATIONSHIP"]
    #[serde(default, rename = "contentType")]
    pub content_type: ::core::option::Option<String>,
    /// Required. Feed output configuration defining where the asset updates are published to.
    #[serde(default, rename = "feedOutputConfig")]
...
pub struct GoogleCloudAssetV1BigQueryDestination {
    ...
    /// The partition key for BigQuery partitioned table. // TODO: enum values: ["PARTITION_KEY_UNSPECIFIED", "REQUEST_TIME"]
...
pub struct IamPolicyAnalysisResult {
    ...
    pub access_control_lists:
        ::core::option::Option<::std::vec::Vec<GoogleCloudAssetV1AccessControlList>>,
    ...
    #[serde(default, rename = "attachedResourceFullName")]
    pub attached_resource_full_name: ::core::option::Option<String>,
    /// Represents whether all analyses on the iam_binding have successfully finished.
    #[serde(default, rename = "fullyExplored")]
    pub fully_explored: ::core::option::Option<bool>,
    /// The IAM policy binding under analysis.
    #[serde(default, rename = "iamBinding")]
    pub iam_binding: ::core::option::Option<Binding>,
    ...
    #[serde(default, rename = "identityList")]
    pub identity_list: ::core::option::Option<GoogleCloudAssetV1IdentityList>,
}
...
pub struct MoveAnalysisResult {
    ...
    #[serde(default)]
    pub blockers: ::core::option::Option<::std::vec::Vec<MoveImpact>>,
    ...
    #[serde(default)]
    pub warnings: ::core::option::Option<::std::vec::Vec<MoveImpact>>,
}
...
pub struct GoogleCloudAssetV1AnalyzeOrgPolicyGovernedAssetsResponseGovernedIamPolicy {
    ...
    pub attached_resource: ::core::option::Option<String>,
...
pub struct GoogleCloudAssetV1Constraint {
    ...
    pub list_constraint: ::core::option::Option<GoogleCloudAssetV1ListConstraint>,
...
pub struct AnalyzerOrgPolicy {
    ...
    pub applied_resource: ::core::option::Option<String>,
    ...
    #[serde(default)]
    pub rules: ::core::option::Option<::std::vec::Vec<GoogleCloudAssetV1Rule>>,
}
...
pub struct Asset {
    ...
    pub asset_exceptions: ::core::option::Option<::std::vec::Vec<AssetException>>,
    /// The type of the asset. Example: compute.googleapis.com/Disk See [Supported asset types](https://cloud.google.com/asset-inventory/docs/supported-asset-types) for more information.
    #[serde(default, rename = "assetType")]
    pub asset_type: ::core::option::Option<String>,
    /// A representation of the IAM policy set on a Google Cloud resource. There can be a maximum of one IAM policy set on any given resource. In addition, IAM policies inherit their granted access scope from any policies set on parent resources in the resource hierarchy. Therefore, the effectively policy is the union of both the policy set on this resource and each policy set on all of the resource''s ancestry resource levels in the hierarchy. See [this topic](https://cloud.google.com/iam/help/allow-policies/inheritance) for more information.
    ...
    #[serde(default, rename = "osInventory")]
    pub os_inventory: ::core::option::Option<Inventory>,
    /// One related asset of the current asset.
    #[serde(default, rename = "relatedAsset")]
...
pub struct BigQueryDestination {
    ...
    #[serde(default, rename = "partitionSpec")]
    ...
    #[serde(default, rename = "separateTablesPerAssetType")]
    pub separate_tables_per_asset_type: ::core::option::Option<bool>,
...
pub struct GoogleCloudAssetV1p7beta1RelationshipAttributes {
    ...
    #[serde(default, rename = "sourceResourceType")]
    pub source_resource_type: ::core::option::Option<String>,
...
pub struct WindowsQuickFixEngineeringPackage {
    ...
    #[serde(default, rename = "hotFixId")]
    pub hot_fix_id: ::core::option::Option<String>,
...
pub struct WindowsApplication {
    ...
    pub install_date: ::core::option::Option<Date>,
...
pub struct WindowsUpdatePackage {
    ...
    #[serde(default)]
    pub categories: ::core::option::Option<::std::vec::Vec<WindowsUpdateCategory>>,
    ...
    #[serde(default, rename = "lastDeploymentChangeTime")]
    pub last_deployment_change_time: ::core::option::Option<String>,
    /// A collection of URLs that provide more information about the update package.
    #[serde(default, rename = "moreInfoUrls")]
    pub more_info_urls: ::core::option::Option<::std::vec::Vec<String>>,
    /// The revision number of this update package.
    #[serde(default, rename = "revisionNumber")]
    pub revision_number: ::core::option::Option<i32>,
...
pub struct ZypperPatch {
    ...
    #[serde(default, rename = "patchName")]
    pub patch_name: ::core::option::Option<String>,
...
pub struct QueryContent {
    ...
    pub iam_policy_analysis_query: ::core::option::Option<IamPolicyAnalysisQuery>,
}
...
pub struct AssetEnrichment {
    ...
    pub resource_owners: ::core::option::Option<ResourceOwners>,
}
...
pub struct GoogleCloudAssetV1AccessControlList {
    ...
    #[serde(default)]
    pub accesses: ::core::option::Option<::std::vec::Vec<GoogleCloudAssetV1Access>>,
    /// Condition evaluation for this AccessControlList, if there is a condition defined in the above IAM policy binding.
    #[serde(default, rename = "conditionEvaluation")]
    pub condition_evaluation: ::core::option::Option<ConditionEvaluation>,
    ...
    #[serde(default, rename = "resourceEdges")]
    pub resource_edges: ::core::option::Option<::std::vec::Vec<GoogleCloudAssetV1Edge>>,
    ...
    #[serde(default)]
    pub resources: ::core::option::Option<::std::vec::Vec<GoogleCloudAssetV1Resource>>,
}
...
pub struct GoogleCloudAssetV1IdentityList {
    ...
    pub group_edges: ::core::option::Option<::std::vec::Vec<GoogleCloudAssetV1Edge>>,
    ...
    #[serde(default)]
    pub identities: ::core::option::Option<::std::vec::Vec<GoogleCloudAssetV1Identity>>,
}
...
pub struct GoogleCloudAssetV1Rule {
    ...
    #[serde(default)]
    pub values: ::core::option::Option<GoogleCloudAssetV1StringValues>,
}
...
pub struct GoogleIdentityAccesscontextmanagerV1AccessLevel {
    ...
    #[serde(default)]
    pub basic: ::core::option::Option<GoogleIdentityAccesscontextmanagerV1BasicLevel>,
    /// A CustomLevel written in the Common Expression Language.
    #[serde(default)]
    pub custom: ::core::option::Option<GoogleIdentityAccesscontextmanagerV1CustomLevel>,
...
pub struct GoogleCloudOrgpolicyV1Policy {
    ...
    pub boolean_policy: ::core::option::Option<GoogleCloudOrgpolicyV1BooleanPolicy>,
    ...
    #[serde(default, rename = "listPolicy")]
...
pub struct RelatedAssets {
    /// The peer resources of the relationship.
    #[serde(default)]
    pub assets: ::core::option::Option<::std::vec::Vec<RelatedAsset>>,
...
pub struct GoogleIdentityAccesscontextmanagerV1ServicePerimeter {
    ...
    #[serde(default)]
    pub spec: ::core::option::Option<GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig>,
    /// Current ServicePerimeter configuration. Specifies sets of resources, restricted services and access levels that determine perimeter content and boundaries.
    #[serde(default)]
    pub status: ::core::option::Option<GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig>,
    /// Human readable title. Must be unique within the Policy.
    #[serde(default)]
    pub title: ::core::option::Option<String>,
...
pub struct IamPolicyAnalysisQuery {
    ...
    pub access_selector: ::core::option::Option<AccessSelector>,
    /// Optional. The hypothetical context for IAM conditions evaluation.
    #[serde(default, rename = "conditionContext")]
    pub condition_context: ::core::option::Option<ConditionContext>,
    /// Optional. Specifies an identity for analysis.
    #[serde(default, rename = "identitySelector")]
    pub identity_selector: ::core::option::Option<IdentitySelector>,
...
pub struct GoogleCloudAssetV1Access {
    ...
    pub analysis_state: ::core::option::Option<IamPolicyAnalysisState>,
    /// The permission.
    #[serde(default)]
...
pub struct Tag {
    ...
    #[serde(default, rename = "tagKeyId")]
    pub tag_key_id: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "tagValueId")]
    pub tag_value_id: ::core::option::Option<String>,
}
...
pub struct ConditionEvaluation {
    ...
    pub evaluation_value: ::core::option::Option<String>,
}
...
pub struct GoogleIdentityAccesscontextmanagerV1BasicLevel {
    ...
    #[serde(default)]
    pub conditions:
        ::core::option::Option<::std::vec::Vec<GoogleIdentityAccesscontextmanagerV1Condition>>,
}
...
pub struct GoogleCloudOrgpolicyV1ListPolicy {
    ...
    pub all_values: ::core::option::Option<String>,
...
pub struct OsInfo {
    ...
    #[serde(default, rename = "kernelRelease")]
    pub kernel_release: ::core::option::Option<String>,
    ...
    pub long_name: ::core::option::Option<String>,
    /// The current version of the OS Config agent running on the VM.
    #[serde(default, rename = "osconfigAgentVersion")]
    pub osconfig_agent_version: ::core::option::Option<String>,
...
pub struct RelatedAsset {
    ...
    pub relationship_type: ::core::option::Option<String>,
}
...
pub struct GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig {
    ...
    pub egress_policies:
        ::core::option::Option<::std::vec::Vec<GoogleIdentityAccesscontextmanagerV1EgressPolicy>>,
    /// List of IngressPolicies to apply to the perimeter. A perimeter may have multiple IngressPolicies, each of which is evaluated separately. Access is granted if any Ingress Policy grants it. Must be empty for a perimeter bridge.
    #[serde(default, rename = "ingressPolicies")]
    pub ingress_policies:
        ::core::option::Option<::std::vec::Vec<GoogleIdentityAccesscontextmanagerV1IngressPolicy>>,
    ...
    pub vpc_accessible_services:
        ::core::option::Option<GoogleIdentityAccesscontextmanagerV1VpcAccessibleServices>,
}
...
pub struct ConditionContext {
    ...
    pub access_time: ::core::option::Option<String>,
}
...
pub struct Options {
    ...
    pub analyze_service_account_impersonation: ::core::option::Option<bool>,
    ...
    #[serde(default, rename = "expandResources")]
    pub expand_resources: ::core::option::Option<bool>,
    ...
    #[serde(default, rename = "expandRoles")]
    pub expand_roles: ::core::option::Option<bool>,
    /// Optional. If true, the result will output the relevant membership relationships between groups and other groups, and between groups and principals. Default is false.
    #[serde(default, rename = "outputGroupEdges")]
    pub output_group_edges: ::core::option::Option<bool>,
    /// Optional. If true, the result will output the relevant parent/child relationships between resources. Default is false.
    #[serde(default, rename = "outputResourceEdges")]
    pub output_resource_edges: ::core::option::Option<bool>,
}
...
pub struct AssetException {
    ...
    /// The type of exception. // TODO: enum values: ["EXCEPTION_TYPE_UNSPECIFIED", "TRUNCATION"]
...
pub struct GoogleIdentityAccesscontextmanagerV1Condition {
    ...
    pub device_policy: ::core::option::Option<GoogleIdentityAccesscontextmanagerV1DevicePolicy>,
    ...
    pub vpc_network_sources: ::core::option::Option<
        ::std::vec::Vec<GoogleIdentityAccesscontextmanagerV1VpcNetworkSource>,
    >,
}
...
pub struct GoogleIdentityAccesscontextmanagerV1EgressPolicy {
    ...
    pub egress_from: ::core::option::Option<GoogleIdentityAccesscontextmanagerV1EgressFrom>,
    /// Defines the conditions on the ApiOperation and destination resources that cause this EgressPolicy to apply.
    #[serde(default, rename = "egressTo")]
    pub egress_to: ::core::option::Option<GoogleIdentityAccesscontextmanagerV1EgressTo>,
...
pub struct GoogleIdentityAccesscontextmanagerV1IngressPolicy {
    ...
    pub ingress_from: ::core::option::Option<GoogleIdentityAccesscontextmanagerV1IngressFrom>,
    /// Defines the conditions on the ApiOperation and request destination that cause this IngressPolicy to apply.
    #[serde(default, rename = "ingressTo")]
    pub ingress_to: ::core::option::Option<GoogleIdentityAccesscontextmanagerV1IngressTo>,
...
pub struct GoogleIdentityAccesscontextmanagerV1DevicePolicy {
    ...
    pub os_constraints:
        ::core::option::Option<::std::vec::Vec<GoogleIdentityAccesscontextmanagerV1OsConstraint>>,
...
pub struct GoogleIdentityAccesscontextmanagerV1VpcNetworkSource {
    ...
    pub vpc_subnetwork: ::core::option::Option<GoogleIdentityAccesscontextmanagerV1VpcSubNetwork>,
}
...
pub struct GoogleIdentityAccesscontextmanagerV1EgressFrom {
    ...
    #[serde(default)]
    pub sources:
        ::core::option::Option<::std::vec::Vec<GoogleIdentityAccesscontextmanagerV1EgressSource>>,
}
...
pub struct GoogleIdentityAccesscontextmanagerV1EgressTo {
    ...
    #[serde(default)]
    pub operations:
        ::core::option::Option<::std::vec::Vec<GoogleIdentityAccesscontextmanagerV1ApiOperation>>,
...
pub struct GoogleIdentityAccesscontextmanagerV1IngressFrom {
    ...
    #[serde(default)]
    pub sources:
        ::core::option::Option<::std::vec::Vec<GoogleIdentityAccesscontextmanagerV1IngressSource>>,
}
...
pub struct GoogleIdentityAccesscontextmanagerV1ApiOperation {
    ...
    pub method_selectors:
        ::core::option::Option<::std::vec::Vec<GoogleIdentityAccesscontextmanagerV1MethodSelector>>,
    ...
    for BatchGetEffectiveIamPoliciesResponse
{
    fn generate_resource_id(&self, input: &CloudassetEffectiveIamPoliciesBatchGetArgs) -> String {
        format!("gcp::BatchGetEffectiveIamPoliciesResponse/{}", input.scope)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::BatchGetEffectiveIamPoliciesResponse"
    }
...
impl ResourceIdentifier<CloudassetFeedsListArgs> for ListFeedsResponse {
    fn generate_resource_id(&self, input: &CloudassetFeedsListArgs) -> String {
        format!("gcp::ListFeedsResponse/{}", input.parent)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::ListFeedsResponse"
    }
...
impl ResourceIdentifier<CloudassetAnalyzeIamPolicyArgs> for AnalyzeIamPolicyResponse {
    fn generate_resource_id(&self, input: &CloudassetAnalyzeIamPolicyArgs) -> String {
        format!("gcp::AnalyzeIamPolicyResponse/{}", input.scope)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::AnalyzeIamPolicyResponse"
    }
...
impl ResourceIdentifier<CloudassetAnalyzeMoveArgs> for AnalyzeMoveResponse {
    fn generate_resource_id(&self, input: &CloudassetAnalyzeMoveArgs) -> String {
        format!("gcp::AnalyzeMoveResponse/{}", input.resource)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::AnalyzeMoveResponse"
    }
...
impl ResourceIdentifier<CloudassetAnalyzeOrgPoliciesArgs> for AnalyzeOrgPoliciesResponse {
    fn generate_resource_id(&self, input: &CloudassetAnalyzeOrgPoliciesArgs) -> String {
        format!("gcp::AnalyzeOrgPoliciesResponse/{}", input.scope)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::AnalyzeOrgPoliciesResponse"
    }
    ...
    for AnalyzeOrgPolicyGovernedAssetsResponse
{
    fn generate_resource_id(&self, input: &CloudassetAnalyzeOrgPolicyGovernedAssetsArgs) -> String {
        format!(
            "gcp::AnalyzeOrgPolicyGovernedAssetsResponse/{}",
            input.scope
        )
    }
    ...
    for AnalyzeOrgPolicyGovernedContainersResponse
{
    fn generate_resource_id(
        ...
        format!(
            "gcp::AnalyzeOrgPolicyGovernedContainersResponse/{}",
            input.scope
        )
    }
...
impl ResourceIdentifier<CloudassetBatchGetAssetsHistoryArgs> for BatchGetAssetsHistoryResponse {
    fn generate_resource_id(&self, input: &CloudassetBatchGetAssetsHistoryArgs) -> String {
        format!("gcp::BatchGetAssetsHistoryResponse/{}", input.parent)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::BatchGetAssetsHistoryResponse"
    }
...
impl ResourceIdentifier<CloudassetQueryAssetsArgs> for QueryAssetsResponse {
    fn generate_resource_id(&self, input: &CloudassetQueryAssetsArgs) -> String {
        format!("gcp::QueryAssetsResponse/{}", input.parent)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::QueryAssetsResponse"
    }
...
impl ResourceIdentifier<CloudassetSearchAllIamPoliciesArgs> for SearchAllIamPoliciesResponse {
    fn generate_resource_id(&self, input: &CloudassetSearchAllIamPoliciesArgs) -> String {
        format!("gcp::SearchAllIamPoliciesResponse/{}", input.scope)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::SearchAllIamPoliciesResponse"
    }
...
impl ResourceIdentifier<CloudassetSearchAllResourcesArgs> for SearchAllResourcesResponse {
    fn generate_resource_id(&self, input: &CloudassetSearchAllResourcesArgs) -> String {
        format!("gcp::SearchAllResourcesResponse/{}", input.scope)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::SearchAllResourcesResponse"
    }
