//! Auto-generated resource types for Google Cloud Platform - addressvalidation.
//!
//! This file is generated by `cargo run --bin ewe_platform gen_resource_types`.
//! DO NOT EDIT MANUALLY.
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/addressvalidation/openapi.json`.
...
pub struct GoogleMapsAddressvalidationV1Address {
    ...
    pub address_components: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleMapsAddressvalidationV1AddressComponent>>,
    >,
    ...
    #[serde(default, rename = "missingComponentTypes")]
    pub missing_component_types: ::core::option::Option<::std::vec::Vec<String>>,
    ...
    #[serde(default, rename = "unconfirmedComponentTypes")]
    pub unconfirmed_component_types: ::core::option::Option<::std::vec::Vec<String>>,
    ...
    #[serde(default, rename = "unresolvedTokens")]
...
pub struct GoogleMapsAddressvalidationV1AddressComponent {
    ...
    pub component_name:
        ::core::option::Option<::std::boxed::Box<GoogleMapsAddressvalidationV1ComponentName>>,
...
pub struct GoogleMapsAddressvalidationV1Geocode {
    ...
    #[serde(default)]
    pub bounds: ::core::option::Option<::std::boxed::Box<GoogleGeoTypeViewport>>,
    ...
    #[serde(default, rename = "featureSizeMeters")]
    pub feature_size_meters: ::core::option::Option<f32>,
    ...
    #[serde(default, rename = "placeTypes")]
    pub place_types: ::core::option::Option<::std::vec::Vec<String>>,
    /// The plus code corresponding to the location.
    #[serde(default, rename = "plusCode")]
    pub plus_code: ::core::option::Option<::std::boxed::Box<GoogleMapsAddressvalidationV1PlusCode>>,
}
...
pub struct GoogleMapsAddressvalidationV1UspsData {
    ...
    pub abbreviated_city: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "addressRecordType")]
    pub address_record_type: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "carrierRoute")]
    pub carrier_route: ::core::option::Option<String>,
    /// Carrier route rate sort indicator.
    #[serde(default, rename = "carrierRouteIndicator")]
    pub carrier_route_indicator: ::core::option::Option<String>,
    /// Indicator that the request has been CASS processed.
    #[serde(default, rename = "cassProcessed")]
    pub cass_processed: ::core::option::Option<bool>,
    /// County name.
    #[serde(default)]
    pub county: ::core::option::Option<String>,
    /// Indicator that a default address was found, but more specific addresses exists.
    #[serde(default, rename = "defaultAddress")]
    pub default_address: ::core::option::Option<bool>,
    ...
    #[serde(default, rename = "deliveryPointCheckDigit")]
    pub delivery_point_check_digit: ::core::option::Option<String>,
    /// 2 digit delivery point code
    #[serde(default, rename = "deliveryPointCode")]
    pub delivery_point_code: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "dpvCmra")]
    pub dpv_cmra: ::core::option::Option<String>,
    ...
    pub dpv_confirmation: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "dpvDoorNotAccessible")]
    pub dpv_door_not_accessible: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "dpvDrop")]
    pub dpv_drop: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "dpvEnhancedDeliveryCode")]
    pub dpv_enhanced_delivery_code: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "dpvFootnote")]
    pub dpv_footnote: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "dpvNoSecureLocation")]
    pub dpv_no_secure_location: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "dpvNoStat")]
    pub dpv_no_stat: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "dpvNoStatReasonCode")]
    pub dpv_no_stat_reason_code: ::core::option::Option<i32>,
    ...
    #[serde(default, rename = "dpvNonDeliveryDays")]
    pub dpv_non_delivery_days: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "dpvNonDeliveryDaysValues")]
    pub dpv_non_delivery_days_values: ::core::option::Option<i32>,
    ...
    #[serde(default, rename = "dpvPbsa")]
    pub dpv_pbsa: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "dpvThrowback")]
    pub dpv_throwback: ::core::option::Option<String>,
    /// Is this place vacant? Returns a single character. * Y: The address is vacant * N: The address is not vacant
    #[serde(default, rename = "dpvVacant")]
    pub dpv_vacant: ::core::option::Option<String>,
    /// eLOT Ascending/Descending Flag (A/D).
    #[serde(default, rename = "elotFlag")]
    pub elot_flag: ::core::option::Option<String>,
    /// Enhanced Line of Travel (eLOT) number.
    #[serde(default, rename = "elotNumber")]
    pub elot_number: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "ewsNoMatch")]
    pub ews_no_match: ::core::option::Option<bool>,
    /// FIPS county code.
    #[serde(default, rename = "fipsCountyCode")]
    pub fips_county_code: ::core::option::Option<String>,
    /// LACSLink indicator.
    #[serde(default, rename = "lacsLinkIndicator")]
    pub lacs_link_indicator: ::core::option::Option<String>,
    /// LACSLink return code.
    #[serde(default, rename = "lacsLinkReturnCode")]
    pub lacs_link_return_code: ::core::option::Option<String>,
    /// PMB (Private Mail Box) unit designator.
    #[serde(default, rename = "pmbDesignator")]
    pub pmb_designator: ::core::option::Option<String>,
    /// PMB (Private Mail Box) number;
    #[serde(default, rename = "pmbNumber")]
    pub pmb_number: ::core::option::Option<String>,
    /// PO Box only postal code.
    #[serde(default, rename = "poBoxOnlyPostalCode")]
    pub po_box_only_postal_code: ::core::option::Option<bool>,
    /// Main post office city.
    #[serde(default, rename = "postOfficeCity")]
    pub post_office_city: ::core::option::Option<String>,
    /// Main post office state.
    #[serde(default, rename = "postOfficeState")]
    pub post_office_state: ::core::option::Option<String>,
    /// USPS standardized address.
    #[serde(default, rename = "standardizedAddress")]
    pub standardized_address:
        ::core::option::Option<::std::boxed::Box<GoogleMapsAddressvalidationV1UspsAddress>>,
    ...
    #[serde(default, rename = "suitelinkFootnote")]
...
pub struct GoogleMapsAddressvalidationV1ValidateAddressRequest {
    ...
    #[serde(default)]
    pub address: ::core::option::Option<::std::boxed::Box<GoogleTypePostalAddress>>,
    ...
    pub language_options:
        ::core::option::Option<::std::boxed::Box<GoogleMapsAddressvalidationV1LanguageOptions>>,
...
pub struct GoogleMapsAddressvalidationV1ValidateAddressResponse {
    ...
    #[serde(default)]
    pub result:
        ::core::option::Option<::std::boxed::Box<GoogleMapsAddressvalidationV1ValidationResult>>,
}
...
pub struct GoogleMapsAddressvalidationV1ValidationResult {
    ...
    #[serde(default)]
    pub address: ::core::option::Option<::std::boxed::Box<GoogleMapsAddressvalidationV1Address>>,
    ...
    pub english_latin_address:
        ::core::option::Option<::std::boxed::Box<GoogleMapsAddressvalidationV1Address>>,
    /// Information about the location and place that the address geocoded to.
    #[serde(default)]
    pub geocode: ::core::option::Option<::std::boxed::Box<GoogleMapsAddressvalidationV1Geocode>>,
    ...
    #[serde(default)]
    pub metadata:
        ::core::option::Option<::std::boxed::Box<GoogleMapsAddressvalidationV1AddressMetadata>>,
    /// Extra deliverability flags provided by USPS. Only provided in region US and PR.
    #[serde(default, rename = "uspsData")]
    pub usps_data: ::core::option::Option<::std::boxed::Box<GoogleMapsAddressvalidationV1UspsData>>,
    /// Overall verdict flags
    #[serde(default)]
    pub verdict: ::core::option::Option<::std::boxed::Box<GoogleMapsAddressvalidationV1Verdict>>,
}
...
pub struct GoogleMapsAddressvalidationV1Verdict {
    ...
    #[serde(default, rename = "hasInferredComponents")]
    pub has_inferred_components: ::core::option::Option<bool>,
    /// At least one address component was replaced, see [google.maps.addressvalidation.v1.Address.address_components] for details.
    #[serde(default, rename = "hasReplacedComponents")]
    pub has_replaced_components: ::core::option::Option<bool>,
    ...
    #[serde(default, rename = "hasSpellCorrectedComponents")]
    pub has_spell_corrected_components: ::core::option::Option<bool>,
