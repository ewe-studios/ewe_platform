...
pub struct Actuation {
    ...
    pub actuation_output: ::core::option::Option<ActuationOutput>,
    /// Output only. [Output only] Deployment output
    #[serde(default, rename = "deploymentOutput")]
    pub deployment_output: ::core::option::Option<::std::vec::Vec<DeploymentOutput>>,
...
pub struct AgentStates {
    ...
    pub hana_monitoring: ::core::option::Option<ServiceStates>,
    ...
    pub process_metrics: ::core::option::Option<ServiceStates>,
    /// Optional. The System discovery metrics of the agent.
    #[serde(default, rename = "systemDiscovery")]
    pub system_discovery: ::core::option::Option<ServiceStates>,
}
...
pub struct AgentStatus {
    ...
    #[serde(default)]
    pub services: ::core::option::Option<::std::vec::Vec<AgentStatusServiceStatus>>,
...
pub struct AgentStatusServiceStatus {
    ...
    pub config_values: ::core::option::Option<::std::vec::Vec<AgentStatusConfigValue>>,
    ...
    pub iam_permissions: ::core::option::Option<::std::vec::Vec<AgentStatusIAMPermission>>,
...
pub struct Command {
    ...
    pub agent_command: ::core::option::Option<AgentCommand>,
...
pub struct ComponentHealth {
    ...
    pub component_health_checks: ::core::option::Option<::std::vec::Vec<HealthCheck>>,
...
pub struct DatabaseProperties {
    ...
    pub backup_properties: ::core::option::Option<BackupProperties>,
...
pub struct Deployment {
    ...
    pub sap_system_s4_config: ::core::option::Option<SapSystemS4Config>,
    ...
    pub sql_server_workload: ::core::option::Option<SqlServerWorkload>,
...
pub struct Execution {
    ...
    pub external_data_sources: ::core::option::Option<::std::vec::Vec<ExternalDataSources>>,
    ...
    #[serde(default)]
    pub notices: ::core::option::Option<::std::vec::Vec<Notice>>,
    /// Output only. [Output only] Result summary for the execution.
    #[serde(default, rename = "resultSummary")]
    pub result_summary: ::core::option::Option<Summary>,
    /// Output only. Execution result summary per rule.
    #[serde(default, rename = "ruleResults")]
    pub rule_results: ::core::option::Option<::std::vec::Vec<RuleExecutionResult>>,
...
pub struct HealthCheck {
    ...
    #[serde(default)]
    pub resource: ::core::option::Option<CloudResource>,
...
pub struct Insight {
    ...
    pub agent_status: ::core::option::Option<AgentStatus>,
    ...
    pub open_shift_validation: ::core::option::Option<OpenShiftValidation>,
    ...
    pub sap_discovery: ::core::option::Option<SapDiscovery>,
    /// The insights data for the SAP workload validation.
    #[serde(default, rename = "sapValidation")]
    pub sap_validation: ::core::option::Option<SapValidation>,
    /// Output only. [Output only] Create time stamp
    ...
    pub sqlserver_validation: ::core::option::Option<SqlserverValidation>,
    /// The insights data for workload validation of torso workloads.
    #[serde(default, rename = "torsoValidation")]
    pub torso_validation: ::core::option::Option<TorsoValidation>,
}
...
pub struct InstanceProperties {
    ...
    pub sap_instance_properties: ::core::option::Option<SapInstanceProperties>,
    /// Optional. Instance status.
    #[serde(default)]
    pub status: ::core::option::Option<String>,
    /// Optional. the next maintenance event on VM
    #[serde(default, rename = "upcomingMaintenanceEvent")]
    pub upcoming_maintenance_event: ::core::option::Option<UpcomingMaintenanceEvent>,
}
...
pub struct ListActuationsResponse {
    ...
    #[serde(default)]
    pub actuations: ::core::option::Option<::std::vec::Vec<Actuation>>,
...
pub struct ListDiscoveredProfilesResponse {
    ...
    pub workload_profiles: ::core::option::Option<::std::vec::Vec<WorkloadProfile>>,
}
...
pub struct ListEvaluationsResponse {
    ...
    #[serde(default)]
    pub evaluations: ::core::option::Option<::std::vec::Vec<Evaluation>>,
    /// A token identifying a page of results the server should return.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// Locations that could not be reached.
...
pub struct ListExecutionResultsResponse {
    ...
    pub execution_results: ::core::option::Option<::std::vec::Vec<ExecutionResult>>,
    /// A token, which can be sent as page_token to retrieve the next page. If this field is omitted, there are no subsequent pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct ListScannedResourcesResponse {
    ...
    pub scanned_resources: ::core::option::Option<::std::vec::Vec<ScannedResource>>,
}
...
pub struct SapComponent {
    ...
    pub database_properties: ::core::option::Option<DatabaseProperties>,
    ...
    #[serde(default)]
    pub resources: ::core::option::Option<::std::vec::Vec<CloudResource>>,
...
pub struct SapDiscovery {
    ...
    pub workload_properties: ::core::option::Option<SapDiscoveryWorkloadProperties>,
}
...
pub struct SapDiscoveryWorkloadProperties {
    ...
    pub product_versions:
        ::core::option::Option<::std::vec::Vec<SapDiscoveryWorkloadPropertiesProductVersion>>,
    ...
    pub software_component_versions: ::core::option::Option<
        ::std::vec::Vec<SapDiscoveryWorkloadPropertiesSoftwareComponentProperties>,
    >,
}
...
pub struct SapInstanceProperties {
    ...
    pub agent_states: ::core::option::Option<AgentStates>,
...
pub struct SapSystemS4Config {
    ...
    /// instance details
    #[serde(default)]
    pub app: ::core::option::Option<AppDetails>,
    /// database details
    #[serde(default)]
    pub database: ::core::option::Option<DatabaseDetails>,
    ...
    /// database details
    #[serde(default)]
    pub location: ::core::option::Option<LocationDetails>,
...
pub struct SapValidation {
    ...
    #[serde(default, rename = "validationDetails")]
    pub validation_details: ::core::option::Option<::std::vec::Vec<SapValidationValidationDetail>>,
...
pub struct SapWorkload {
    ...
    #[serde(default)]
    pub application: ::core::option::Option<SapComponent>,
    ...
    #[serde(default)]
    pub database: ::core::option::Option<SapComponent>,
...
pub struct ServiceStates {
    ...
    #[serde(default, rename = "iamPermissions")]
    pub iam_permissions: ::core::option::Option<::std::vec::Vec<IAMPermission>>,
...
pub struct SqlServerWorkload {
    ...
    #[serde(default)]
    pub location: ::core::option::Option<SqlLocationDetails>,
    ...
    #[serde(default)]
    pub pacemaker: ::core::option::Option<Pacemaker>,
...
pub struct SqlserverValidation {
    ...
    pub validation_details:
        ::core::option::Option<::std::vec::Vec<SqlserverValidationValidationDetail>>,
}
...
pub struct SqlserverValidationValidationDetail {
    ...
    #[serde(default)]
    pub details: ::core::option::Option<::std::vec::Vec<SqlserverValidationDetails>>,
...
pub struct ViolationDetails {
    ...
    pub rule_output: ::core::option::Option<::std::vec::Vec<RuleOutput>>,
    /// The service account associated with the resource.
    #[serde(default, rename = "serviceAccount")]
    pub service_account: ::core::option::Option<String>,
}
...
pub struct WorkloadProfile {
    ...
    pub sap_workload: ::core::option::Option<SapWorkload>,
...
pub struct WriteInsightRequest {
    ...
    #[serde(default)]
    pub insight: ::core::option::Option<Insight>,
    /// Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
    #[serde(default, rename = "requestId")]
    pub request_id: ::core::option::Option<String>,
}
