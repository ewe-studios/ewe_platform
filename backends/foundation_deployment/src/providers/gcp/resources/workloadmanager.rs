...
pub struct SapDiscovery {
    ...
    pub application_layer: Option<SapDiscoveryComponent>,
    /// Required. An SAP System must have a database.
    #[serde(default, rename = "databaseLayer")]
    pub database_layer: Option<SapDiscoveryComponent>,
...
pub struct SapDiscoveryComponent {
    ...
    pub replication_sites: Option<Vec<SapDiscoveryComponentReplicationSite>>,
...
pub struct SapDiscoveryComponentReplicationSite {
    ...
    #[serde(default)]
    pub component: Option<SapDiscoveryComponent>,
