...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/verifiedaccess/openapi.json`.
...
pub struct DeviceSignals {
    ...
    #[serde(default)]
    pub antivirus: ::core::option::Option<::std::boxed::Box<Antivirus>>,
    ...
    pub crowd_strike_agent: ::core::option::Option<::std::boxed::Box<CrowdStrikeAgent>>,
...
pub struct VerifyChallengeResponseResult {
    ...
    pub device_signals: ::core::option::Option<::std::boxed::Box<DeviceSignals>>,
