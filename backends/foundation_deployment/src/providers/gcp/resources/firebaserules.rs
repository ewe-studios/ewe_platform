...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/firebaserules/openapi.json`.
...
pub struct ExpressionReport {
    /// Subexpressions
    #[serde(default)]
    pub children: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ExpressionReport>>>,
    /// Position of expression in original rules source.
    #[serde(default, rename = "sourcePosition")]
    pub source_position: ::core::option::Option<::std::boxed::Box<SourcePosition>>,
    /// Values that this expression evaluated to when encountered.
    #[serde(default)]
    pub values: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ValueCount>>>,
}
...
pub struct FunctionMock {
    ...
    #[serde(default)]
    pub args: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Arg>>>,
    /// The name of the function. The function name must match one provided by a service declaration.
    #[serde(default)]
    pub function: ::core::option::Option<String>,
    /// The mock result of the function call.
    #[serde(default)]
    pub result: ::core::option::Option<::std::boxed::Box<ApiResult>>,
}
...
pub struct ListRulesetsResponse {
    ...
    #[serde(default)]
    pub rulesets: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Ruleset>>>,
}
...
pub struct TestCase {
    ...
    pub function_mocks: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<FunctionMock>>>,
...
pub struct TestResult {
    ...
    pub error_position: ::core::option::Option<::std::boxed::Box<SourcePosition>>,
    ...
    pub expression_reports:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ExpressionReport>>>,
    ...
    pub function_calls: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<FunctionCall>>>,
    ...
    pub visited_expressions:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<VisitedExpression>>>,
}
...
pub struct TestRulesetRequest {
    ...
    pub test_suite: ::core::option::Option<::std::boxed::Box<TestSuite>>,
}
...
pub struct TestRulesetResponse {
    ...
    pub test_results: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TestResult>>>,
}
...
pub struct UpdateReleaseRequest {
    ...
    #[serde(default)]
    pub release: ::core::option::Option<::std::boxed::Box<Release>>,
