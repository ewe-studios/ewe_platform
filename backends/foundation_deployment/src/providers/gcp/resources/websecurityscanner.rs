...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/websecurityscanner/openapi.json`.
...
pub struct Authentication {
    ...
    pub custom_account: ::core::option::Option<::std::boxed::Box<CustomAccount>>,
    /// Authentication using a Google account.
    #[serde(default, rename = "googleAccount")]
    pub google_account: ::core::option::Option<::std::boxed::Box<GoogleAccount>>,
    /// Authentication using Identity-Aware-Proxy (IAP).
    #[serde(default, rename = "iapCredential")]
    pub iap_credential: ::core::option::Option<::std::boxed::Box<IapCredential>>,
}
...
pub struct Finding {
    ...
    pub outdated_library: ::core::option::Option<::std::boxed::Box<OutdatedLibrary>>,
    ...
    pub violating_resource: ::core::option::Option<::std::boxed::Box<ViolatingResource>>,
    /// Output only. An addon containing information about vulnerable or missing HTTP headers.
    #[serde(default, rename = "vulnerableHeaders")]
    pub vulnerable_headers: ::core::option::Option<::std::boxed::Box<VulnerableHeaders>>,
    ...
    pub vulnerable_parameters: ::core::option::Option<::std::boxed::Box<VulnerableParameters>>,
    /// Output only. An addon containing information reported for an XSS, if any.
    #[serde(default)]
    pub xss: ::core::option::Option<::std::boxed::Box<Xss>>,
    /// Output only. An addon containing information reported for an XXE, if any.
    #[serde(default)]
    pub xxe: ::core::option::Option<::std::boxed::Box<Xxe>>,
}
...
pub struct IapCredential {
    ...
    pub iap_test_service_account_info:
        ::core::option::Option<::std::boxed::Box<IapTestServiceAccountInfo>>,
}
...
pub struct ListCrawledUrlsResponse {
    ...
    pub crawled_urls: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<CrawledUrl>>>,
...
pub struct ListFindingTypeStatsResponse {
    ...
    pub finding_type_stats:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<FindingTypeStats>>>,
}
...
pub struct ListScanConfigsResponse {
    ...
    pub scan_configs: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ScanConfig>>>,
}
...
pub struct ListScanRunsResponse {
    ...
    pub scan_runs: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ScanRun>>>,
}
...
pub struct ScanConfig {
    ...
    pub latest_run: ::core::option::Option<::std::boxed::Box<ScanRun>>,
...
pub struct ScanRun {
    ...
    pub error_trace: ::core::option::Option<::std::boxed::Box<ScanRunErrorTrace>>,
    ...
    pub warning_traces:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ScanRunWarningTrace>>>,
}
...
pub struct ScanRunErrorTrace {
    ...
    pub scan_config_error: ::core::option::Option<::std::boxed::Box<ScanConfigError>>,
}
...
pub struct VulnerableHeaders {
    ...
    #[serde(default)]
    pub headers: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Header>>>,
    /// List of missing headers.
    #[serde(default, rename = "missingHeaders")]
    pub missing_headers: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Header>>>,
}
