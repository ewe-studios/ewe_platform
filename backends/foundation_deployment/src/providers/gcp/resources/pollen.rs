...
pub struct DayInfo {
    ...
    pub plant_info: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PlantInfo>>>,
    ...
    pub pollen_type_info:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PollenTypeInfo>>>,
}
...
pub struct LookupForecastResponse {
    ...
    pub daily_info: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DayInfo>>>,
...
pub struct PlantInfo {
    ...
    pub in_season: ::core::option::Option<bool>,
    /// This object contains data representing specific pollen index value, category and description.
    #[serde(default, rename = "indexInfo")]
    pub index_info: ::core::option::Option<::std::boxed::Box<IndexInfo>>,
    /// Contains general information about plants, including details on their seasonality, special shapes and colors, information about allergic cross-reactions, and plant photos.
    #[serde(default, rename = "plantDescription")]
    pub plant_description: ::core::option::Option<::std::boxed::Box<PlantDescription>>,
}
...
pub struct PollenTypeInfo {
    ...
    pub health_recommendations: ::core::option::Option<::std::vec::Vec<String>>,
