...
pub struct AdaptiveMtTranslateRequest {
    ...
    #[serde(default)]
    pub content: ::core::option::Option<::std::vec::Vec<String>>,
    ...
    pub glossary_config: ::core::option::Option<::std::boxed::Box<GlossaryConfig>>,
    /// Configuration for caller provided reference sentences.
    #[serde(default, rename = "referenceSentenceConfig")]
    pub reference_sentence_config:
        ::core::option::Option<::std::boxed::Box<ReferenceSentenceConfig>>,
}
...
pub struct AdaptiveMtTranslateResponse {
    ...
    pub glossary_translations:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AdaptiveMtTranslation>>>,
...
pub struct BatchTranslateDocumentRequest {
    ...
    pub format_conversions: ::core::option::Option<serde_json::Value>,
    /// Optional. Glossaries to be applied. It''s keyed by target language code.
    #[serde(default)]
    pub glossaries: ::core::option::Option<serde_json::Value>,
    /// Required. Input configurations. The total number of files matched should be &lt;= 100. The total content size to translate should be &lt;= 100M Unicode codepoints. The files must use UTF-8 encoding.
    #[serde(default, rename = "inputConfigs")]
    pub input_configs:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<BatchDocumentInputConfig>>>,
    ...
    pub output_config: ::core::option::Option<::std::boxed::Box<BatchDocumentOutputConfig>>,
    /// Optional. If true, only native pdf pages will be translated.
    #[serde(default, rename = "pdfNativeOnly")]
    pub pdf_native_only: ::core::option::Option<bool>,
...
pub struct BatchTranslateTextRequest {
    ...
    #[serde(default, rename = "inputConfigs")]
    pub input_configs: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<InputConfig>>>,
...
pub struct DatasetInputConfig {
    ...
    pub input_files: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<InputFile>>>,
}
...
pub struct DatasetOutputConfig {
    ...
    #[serde(default, rename = "gcsDestination")]
    pub gcs_destination: ::core::option::Option<::std::boxed::Box<GcsOutputDestination>>,
}
...
pub struct DetectLanguageRequest {
    ...
    pub document_input_config: ::core::option::Option<::std::boxed::Box<DocumentInputConfig>>,
    /// Optional. The labels with user-defined metadata for the request. Label keys and values can be no longer than 63 characters (Unicode codepoints), can only contain lowercase letters, numeric characters, underscores and dashes. International characters are allowed. Label values are optional. Label keys must start with a letter. See https://cloud.google.com/translate/docs/advanced/labels for more information.
    #[serde(default)]
    pub labels: ::core::option::Option<serde_json::Value>,
...
pub struct DetectLanguageResponse {
    ...
    #[serde(default)]
    pub languages: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DetectedLanguage>>>,
}
...
pub struct ExportDataRequest {
    ...
    #[serde(default, rename = "outputConfig")]
    pub output_config: ::core::option::Option<::std::boxed::Box<DatasetOutputConfig>>,
}
...
pub struct Glossary {
    ...
    pub input_config: ::core::option::Option<::std::boxed::Box<GlossaryInputConfig>>,
    /// Used with equivalent term set glossaries.
    #[serde(default, rename = "languageCodesSet")]
    pub language_codes_set: ::core::option::Option<::std::boxed::Box<LanguageCodesSet>>,
    /// Used with unidirectional glossaries.
    #[serde(default, rename = "languagePair")]
    pub language_pair: ::core::option::Option<::std::boxed::Box<LanguageCodePair>>,
...
pub struct GlossaryEntry {
    ...
    pub terms_pair: ::core::option::Option<::std::boxed::Box<GlossaryTermsPair>>,
    /// Used for an equivalent term sets glossary.
    #[serde(default, rename = "termsSet")]
    pub terms_set: ::core::option::Option<::std::boxed::Box<GlossaryTermsSet>>,
}
...
pub struct GlossaryTermsPair {
    ...
    pub source_term: ::core::option::Option<::std::boxed::Box<GlossaryTerm>>,
    /// The term that will replace the match source term.
    #[serde(default, rename = "targetTerm")]
    pub target_term: ::core::option::Option<::std::boxed::Box<GlossaryTerm>>,
}
...
pub struct GlossaryTermsSet {
    ...
    #[serde(default)]
    pub terms: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GlossaryTerm>>>,
}
...
pub struct ImportAdaptiveMtFileRequest {
    ...
    pub file_input_source: ::core::option::Option<::std::boxed::Box<FileInputSource>>,
    /// Google Cloud Storage file source.
    #[serde(default, rename = "gcsInputSource")]
    pub gcs_input_source: ::core::option::Option<::std::boxed::Box<GcsInputSource>>,
}
...
pub struct ImportAdaptiveMtFileResponse {
    ...
    pub adaptive_mt_file: ::core::option::Option<::std::boxed::Box<AdaptiveMtFile>>,
}
...
pub struct ImportDataRequest {
    ...
    #[serde(default, rename = "inputConfig")]
    pub input_config: ::core::option::Option<::std::boxed::Box<DatasetInputConfig>>,
}
...
pub struct InputFile {
    /// Google Cloud Storage file source.
    #[serde(default, rename = "gcsSource")]
    pub gcs_source: ::core::option::Option<::std::boxed::Box<GcsInputSource>>,
...
pub struct ListAdaptiveMtDatasetsResponse {
    ...
    pub adaptive_mt_datasets:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AdaptiveMtDataset>>>,
...
pub struct ListAdaptiveMtFilesResponse {
    ...
    pub adaptive_mt_files:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AdaptiveMtFile>>>,
...
pub struct ListAdaptiveMtSentencesResponse {
    ...
    pub adaptive_mt_sentences:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AdaptiveMtSentence>>>,
    /// Optional.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct ListGlossariesResponse {
    ...
    #[serde(default)]
    pub glossaries: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Glossary>>>,
...
pub struct ListGlossaryEntriesResponse {
    ...
    pub glossary_entries: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GlossaryEntry>>>,
...
pub struct ReferenceSentenceConfig {
    ...
    pub reference_sentence_pair_lists:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ReferenceSentencePairList>>>,
...
pub struct ReferenceSentencePairList {
    ...
    pub reference_sentence_pairs:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ReferenceSentencePair>>>,
}
...
pub struct RefineTextRequest {
    ...
    pub refinement_entries:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<RefinementEntry>>>,
...
pub struct RefinementEntry {
    ...
    pub original_translation: ::core::option::Option<String>,
...
pub struct RomanizeTextResponse {
    ...
    #[serde(default)]
    pub romanizations: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Romanization>>>,
}
...
pub struct SupportedLanguage {
    ...
    pub support_source: ::core::option::Option<bool>,
...
pub struct SupportedLanguages {
    ...
    #[serde(default)]
    pub languages: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SupportedLanguage>>>,
}
...
pub struct TranslateDocumentRequest {
    ...
    pub document_output_config: ::core::option::Option<::std::boxed::Box<DocumentOutputConfig>>,
    /// Optional. If true, enable auto rotation correction in DVS.
    #[serde(default, rename = "enableRotationCorrection")]
    pub enable_rotation_correction: ::core::option::Option<bool>,
    /// Optional. If true, use the text removal server to remove the shadow text on background image for native pdf translation. Shadow removal feature can only be enabled when is_translate_native_pdf_only: false && pdf_native_only: false
    ...
    /// Optional. Glossary to be applied. The glossary must be within the same region (have the same location-id) as the model, otherwise an INVALID_ARGUMENT (400) error is returned.
    #[serde(default, rename = "glossaryConfig")]
    pub glossary_config: ::core::option::Option<::std::boxed::Box<TranslateTextGlossaryConfig>>,
...
pub struct TranslateDocumentResponse {
    ...
    pub document_translation: ::core::option::Option<::std::boxed::Box<DocumentTranslation>>,
    ...
    pub glossary_document_translation:
        ::core::option::Option<::std::boxed::Box<DocumentTranslation>>,
...
pub struct TranslateTextRequest {
    ...
    pub transliteration_config: ::core::option::Option<::std::boxed::Box<TransliterationConfig>>,
}
...
pub struct TranslateTextResponse {
    ...
    #[serde(default, rename = "glossaryTranslations")]
    pub glossary_translations:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Translation>>>,
    /// Text translation responses with no glossary applied. This field has the same length as contents.
    #[serde(default)]
    pub translations: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Translation>>>,
}
