...
pub struct CustomRegionMetadata {
    ...
    pub optional_read_only_regions: Option<Vec<String>>,
    /// The read-write regions for this custom region.
    #[serde(default, rename = "requiredReadWriteRegions")]
    pub required_read_write_regions: Option<Vec<String>>,
...
pub struct LocationMetadata {
    ...
    pub custom_region_metadata: Option<Vec<CustomRegionMetadata>>,
    ...
    pub multi_region_metadata: Option<MultiRegionMetadata>,
    /// The versions of Hive Metastore that can be used when creating a new metastore service in this location. The server guarantees that exactly one HiveMetastoreVersion in the list will set is_default.
    #[serde(default, rename = "supportedHiveMetastoreVersions")]
    pub supported_hive_metastore_versions: Option<Vec<HiveMetastoreVersion>>,
}
...
pub struct MultiRegionMetadata {
    ...
    pub constituent_regions: Option<Vec<String>>,
...
pub struct QueryMetadataResponse {
    ...
    pub result_manifest_uri: Option<String>,
}
