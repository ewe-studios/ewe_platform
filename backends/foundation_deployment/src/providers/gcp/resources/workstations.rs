...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/workstations/openapi.json`.
...
pub struct EphemeralDirectory {
    ...
    pub gce_pd: ::core::option::Option<::std::boxed::Box<GcePersistentDisk>>,
...
pub struct GceInstance {
    ...
    pub boost_configs: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<BoostConfig>>>,
    /// Optional. The size of the boot disk for the VM in gigabytes (GB). The minimum boot disk size is 30 GB. Defaults to 50 GB.
    #[serde(default, rename = "bootDiskSizeGb")]
    pub boot_disk_size_gb: ::core::option::Option<i32>,
    ...
    pub confidential_instance_config:
        ::core::option::Option<::std::boxed::Box<GceConfidentialInstanceConfig>>,
    ...
    pub shielded_instance_config:
        ::core::option::Option<::std::boxed::Box<GceShieldedInstanceConfig>>,
...
pub struct Host {
    ...
    pub gce_instance: ::core::option::Option<::std::boxed::Box<GceInstance>>,
}
...
pub struct ListUsableWorkstationConfigsResponse {
    ...
    pub workstation_configs:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<WorkstationConfig>>>,
}
...
pub struct ListUsableWorkstationsResponse {
    ...
    #[serde(default)]
    pub workstations: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Workstation>>>,
}
...
pub struct ListWorkstationClustersResponse {
    ...
    pub workstation_clusters:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<WorkstationCluster>>>,
}
...
pub struct PersistentDirectory {
    ...
    pub gce_hd: ::core::option::Option<::std::boxed::Box<GceHyperdiskBalancedHighAvailability>>,
    /// A PersistentDirectory backed by a Compute Engine persistent disk.
    #[serde(default, rename = "gcePd")]
    pub gce_pd: ::core::option::Option<::std::boxed::Box<GceRegionalPersistentDisk>>,
...
pub struct RuntimeHost {
    ...
    pub gce_instance_host: ::core::option::Option<::std::boxed::Box<GceInstanceHost>>,
}
...
pub struct Workstation {
    ...
    pub runtime_host: ::core::option::Option<::std::boxed::Box<RuntimeHost>>,
...
pub struct WorkstationCluster {
    ...
    #[serde(default)]
    pub conditions: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Status>>>,
    ...
    pub domain_config: ::core::option::Option<::std::boxed::Box<DomainConfig>>,
    /// Optional. Checksum computed by the server. May be sent on update and delete requests to make sure that the client has an up-to-date value before proceeding.
    #[serde(default)]
    pub etag: ::core::option::Option<String>,
    /// Optional. Configuration options for Cluster HTTP Gateway.
    #[serde(default, rename = "gatewayConfig")]
    pub gateway_config: ::core::option::Option<::std::boxed::Box<GatewayConfig>>,
...
pub struct WorkstationConfig {
    ...
    pub allowed_ports: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PortRange>>>,
    /// Optional. Client-specified annotations.
    #[serde(default)]
    pub annotations: ::core::option::Option<serde_json::Value>,
    ...
    pub encryption_key: ::core::option::Option<::std::boxed::Box<CustomerEncryptionKey>>,
    /// Optional. Ephemeral directories which won''t persist across workstation sessions.
    #[serde(default, rename = "ephemeralDirectories")]
    pub ephemeral_directories:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<EphemeralDirectory>>>,
    /// Optional. Checksum computed by the server. May be sent on update and delete requests to make sure that the client has an up-to-date value before proceeding.
    #[serde(default)]
    pub etag: ::core::option::Option<String>,
    ...
    #[serde(default)]
    pub host: ::core::option::Option<::std::boxed::Box<Host>>,
    ...
    pub persistent_directories:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PersistentDirectory>>>,
    /// Optional. Readiness checks to perform when starting a workstation using this workstation configuration. Mark a workstation as running only after all specified readiness checks return 200 status codes.
    #[serde(default, rename = "readinessChecks")]
    pub readiness_checks:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ReadinessCheck>>>,
