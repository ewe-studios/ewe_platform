...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/mybusinessverifications/openapi.json`.
...
pub struct CompleteVerificationResponse {
    ...
    #[serde(default)]
    pub verification: ::core::option::Option<::std::boxed::Box<Verification>>,
}
...
pub struct FetchVerificationOptionsRequest {
    ...
    #[serde(default)]
    pub context: ::core::option::Option<::std::boxed::Box<ServiceBusinessContext>>,
...
pub struct FetchVerificationOptionsResponse {
    ...
    #[serde(default)]
    pub options: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<VerificationOption>>>,
}
...
pub struct GenerateInstantVerificationTokenRequest {
    ...
    pub location_data: ::core::option::Option<::std::boxed::Box<LocationData>>,
...
pub struct ListVerificationsResponse {
    ...
    #[serde(default)]
    pub verifications: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Verification>>>,
}
...
pub struct VerificationOption {
    ...
    pub address_data: ::core::option::Option<::std::boxed::Box<AddressVerificationData>>,
    /// Set only if the method is VETTED_PARTNER.
    #[serde(default)]
    pub announcement: ::core::option::Option<String>,
    /// Set only if the method is EMAIL.
    #[serde(default, rename = "emailData")]
    pub email_data: ::core::option::Option<::std::boxed::Box<EmailVerificationData>>,
...
pub struct VerifyLocationRequest {
    ...
    #[serde(default)]
    pub token: ::core::option::Option<::std::boxed::Box<VerificationToken>>,
...
pub struct VoiceOfMerchantState {
    ...
    pub comply_with_guidelines: ::core::option::Option<::std::boxed::Box<ComplyWithGuidelines>>,
    ...
    #[serde(default)]
    pub verify: ::core::option::Option<::std::boxed::Box<Verify>>,
