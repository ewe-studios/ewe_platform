...
pub struct GoogleCloudDatacatalogV1DumpItem {
    ...
    pub tagged_entry: ::core::option::Option<GoogleCloudDatacatalogV1TaggedEntry>,
}
...
pub struct GoogleCloudDatacatalogV1ExportTaxonomiesResponse {
    ...
    #[serde(default)]
    pub taxonomies:
        ::core::option::Option<::std::vec::Vec<GoogleCloudDatacatalogV1SerializedTaxonomy>>,
}
...
pub struct GoogleCloudDatacatalogV1ImportTaxonomiesRequest {
    ...
    pub cross_regional_source: ::core::option::Option<GoogleCloudDatacatalogV1CrossRegionalSource>,
    /// Inline source taxonomy to import.
    #[serde(default, rename = "inlineSource")]
    pub inline_source: ::core::option::Option<GoogleCloudDatacatalogV1InlineSource>,
}
...
pub struct GoogleCloudDatacatalogV1ImportTaxonomiesResponse {
    /// Imported taxonomies.
    #[serde(default)]
    pub taxonomies: ::core::option::Option<::std::vec::Vec<GoogleCloudDatacatalogV1Taxonomy>>,
}
...
pub struct GoogleCloudDatacatalogV1ListEntriesResponse {
    /// Entry details.
    #[serde(default)]
    pub entries: ::core::option::Option<::std::vec::Vec<GoogleCloudDatacatalogV1Entry>>,
...
pub struct GoogleCloudDatacatalogV1ListEntryGroupsResponse {
    ...
    pub entry_groups: ::core::option::Option<::std::vec::Vec<GoogleCloudDatacatalogV1EntryGroup>>,
...
pub struct GoogleCloudDatacatalogV1ListPolicyTagsResponse {
    ...
    pub policy_tags: ::core::option::Option<::std::vec::Vec<GoogleCloudDatacatalogV1PolicyTag>>,
}
...
pub struct GoogleCloudDatacatalogV1ListTagsResponse {
    ...
    /// Tag details.
    #[serde(default)]
    pub tags: ::core::option::Option<::std::vec::Vec<GoogleCloudDatacatalogV1Tag>>,
}
...
pub struct GoogleCloudDatacatalogV1ModifyEntryContactsRequest {
    ...
    #[serde(default)]
    pub contacts: ::core::option::Option<GoogleCloudDatacatalogV1Contacts>,
}
...
pub struct GoogleCloudDatacatalogV1ReplaceTaxonomyRequest {
    ...
    pub serialized_taxonomy: ::core::option::Option<GoogleCloudDatacatalogV1SerializedTaxonomy>,
}
...
pub struct GoogleCloudDatacatalogV1SearchCatalogRequest {
    ...
    #[serde(default)]
    pub scope: ::core::option::Option<GoogleCloudDatacatalogV1SearchCatalogRequestScope>,
}
...
pub struct GoogleCloudDatacatalogV1SearchCatalogResponse {
    ...
    #[serde(default)]
    pub results:
        ::core::option::Option<::std::vec::Vec<GoogleCloudDatacatalogV1SearchCatalogResult>>,
...
pub struct GoogleCloudDatacatalogV1TagField {
    ...
    pub enum_value: ::core::option::Option<GoogleCloudDatacatalogV1TagFieldEnumValue>,
...
pub struct GoogleCloudDatacatalogV1TaggedEntry {
    ...
    pub absent_tags: ::core::option::Option<::std::vec::Vec<GoogleCloudDatacatalogV1Tag>>,
    ...
    pub present_tags: ::core::option::Option<::std::vec::Vec<GoogleCloudDatacatalogV1Tag>>,
    /// Non-encrypted Data Catalog v1 Entry.
    #[serde(default, rename = "v1Entry")]
    pub v1_entry: ::core::option::Option<GoogleCloudDatacatalogV1Entry>,
}
...
pub struct GoogleCloudDatacatalogV1EntryGroup {
    ...
    pub data_catalog_timestamps: ::core::option::Option<GoogleCloudDatacatalogV1SystemTimestamps>,
...
pub struct GoogleCloudDatacatalogV1Taxonomy {
    ...
    #[serde(default)]
    pub service: ::core::option::Option<GoogleCloudDatacatalogV1TaxonomyService>,
    /// Output only. Creation and modification timestamps of this taxonomy.
    #[serde(default, rename = "taxonomyTimestamps")]
    pub taxonomy_timestamps: ::core::option::Option<GoogleCloudDatacatalogV1SystemTimestamps>,
}
...
pub struct GoogleCloudDatacatalogV1FieldType {
    ...
    pub enum_type: ::core::option::Option<GoogleCloudDatacatalogV1FieldTypeEnumType>,
...
pub struct GoogleCloudDatacatalogV1Entry {
    ...
    pub bigquery_date_sharded_spec:
        ::core::option::Option<GoogleCloudDatacatalogV1BigQueryDateShardedSpec>,
    ...
    pub bigquery_table_spec: ::core::option::Option<GoogleCloudDatacatalogV1BigQueryTableSpec>,
    /// Business Context of the entry. Not supported for BigQuery datasets
    #[serde(default, rename = "businessContext")]
    pub business_context: ::core::option::Option<GoogleCloudDatacatalogV1BusinessContext>,
    ...
    pub cloud_bigtable_system_spec:
        ::core::option::Option<GoogleCloudDatacatalogV1CloudBigtableSystemSpec>,
    /// Output only. Physical location of the entry.
    #[serde(default, rename = "dataSource")]
    pub data_source: ::core::option::Option<GoogleCloudDatacatalogV1DataSource>,
    /// Specification that applies to a data source connection. Valid only for entries with the DATA_SOURCE_CONNECTION type.
    #[serde(default, rename = "dataSourceConnectionSpec")]
    pub data_source_connection_spec:
        ::core::option::Option<GoogleCloudDatacatalogV1DataSourceConnectionSpec>,
    /// Specification that applies to a table resource. Valid only for entries with the TABLE or EXPLORE type.
    #[serde(default, rename = "databaseTableSpec")]
    pub database_table_spec: ::core::option::Option<GoogleCloudDatacatalogV1DatabaseTableSpec>,
    /// Specification that applies to a dataset.
    #[serde(default, rename = "datasetSpec")]
    pub dataset_spec: ::core::option::Option<GoogleCloudDatacatalogV1DatasetSpec>,
    ...
    pub feature_online_store_spec:
        ::core::option::Option<GoogleCloudDatacatalogV1FeatureOnlineStoreSpec>,
    /// Specification that applies to a fileset resource. Valid only for entries with the FILESET type.
    #[serde(default, rename = "filesetSpec")]
    pub fileset_spec: ::core::option::Option<GoogleCloudDatacatalogV1FilesetSpec>,
    ...
    pub gcs_fileset_spec: ::core::option::Option<GoogleCloudDatacatalogV1GcsFilesetSpec>,
    /// Spec for graph.
    #[serde(default, rename = "graphSpec")]
    pub graph_spec: ::core::option::Option<GoogleCloudDatacatalogV1GraphSpec>,
    ...
    pub looker_system_spec: ::core::option::Option<GoogleCloudDatacatalogV1LookerSystemSpec>,
    /// Model specification.
    #[serde(default, rename = "modelSpec")]
    pub model_spec: ::core::option::Option<GoogleCloudDatacatalogV1ModelSpec>,
    ...
    pub personal_details: ::core::option::Option<GoogleCloudDatacatalogV1PersonalDetails>,
    /// Specification that applies to a user-defined function or procedure. Valid only for entries with the ROUTINE type.
    #[serde(default, rename = "routineSpec")]
    pub routine_spec: ::core::option::Option<GoogleCloudDatacatalogV1RoutineSpec>,
    /// Schema of the entry. An entry might not have any schema attached to it.
    #[serde(default)]
    pub schema: ::core::option::Option<GoogleCloudDatacatalogV1Schema>,
    /// Specification that applies to a Service resource.
    #[serde(default, rename = "serviceSpec")]
    pub service_spec: ::core::option::Option<GoogleCloudDatacatalogV1ServiceSpec>,
    /// Timestamps from the underlying resource, not from the Data Catalog entry. Output only when the entry has a system listed in the IntegratedSystem enum. For entries with user_specified_system, this field is optional and defaults to an empty timestamp.
    #[serde(default, rename = "sourceSystemTimestamps")]
    pub source_system_timestamps: ::core::option::Option<GoogleCloudDatacatalogV1SystemTimestamps>,
    /// Specification of a Spanner table.
    #[serde(default, rename = "spannerTableSpec")]
    pub spanner_table_spec: ::core::option::Option<GoogleCloudDatacatalogV1SpannerTableSpec>,
    /// Specification that applies to a relational database system. Only settable when user_specified_system is equal to SQL_DATABASE
    #[serde(default, rename = "sqlDatabaseSystemSpec")]
    pub sql_database_system_spec:
        ::core::option::Option<GoogleCloudDatacatalogV1SqlDatabaseSystemSpec>,
    ...
    pub usage_signal: ::core::option::Option<GoogleCloudDatacatalogV1UsageSignal>,
...
pub struct GoogleCloudDatacatalogV1FieldTypeEnumType {
    ...
    pub allowed_values:
        ::core::option::Option<::std::vec::Vec<GoogleCloudDatacatalogV1FieldTypeEnumTypeEnumValue>>,
}
...
pub struct GoogleCloudDatacatalogV1BigQueryTableSpec {
    ...
    pub table_spec: ::core::option::Option<GoogleCloudDatacatalogV1TableSpec>,
    /// Table view specification. Populated only if the table_source_type is BIGQUERY_VIEW.
    #[serde(default, rename = "viewSpec")]
    pub view_spec: ::core::option::Option<GoogleCloudDatacatalogV1ViewSpec>,
}
...
pub struct GoogleCloudDatacatalogV1DataSource {
    ...
    pub storage_properties: ::core::option::Option<GoogleCloudDatacatalogV1StorageProperties>,
}
...
pub struct GoogleCloudDatacatalogV1DataSourceConnectionSpec {
    ...
    pub bigquery_connection_spec:
        ::core::option::Option<GoogleCloudDatacatalogV1BigQueryConnectionSpec>,
}
...
pub struct GoogleCloudDatacatalogV1DatabaseTableSpec {
    ...
    pub database_view_spec:
        ::core::option::Option<GoogleCloudDatacatalogV1DatabaseTableSpecDatabaseViewSpec>,
    ...
    pub dataplex_table: ::core::option::Option<GoogleCloudDatacatalogV1DataplexTableSpec>,
...
pub struct GoogleCloudDatacatalogV1DatasetSpec {
    ...
    pub vertex_dataset_spec: ::core::option::Option<GoogleCloudDatacatalogV1VertexDatasetSpec>,
}
...
pub struct GoogleCloudDatacatalogV1FilesetSpec {
    ...
    pub dataplex_fileset: ::core::option::Option<GoogleCloudDatacatalogV1DataplexFilesetSpec>,
}
...
pub struct GoogleCloudDatacatalogV1GcsFilesetSpec {
    ...
    pub sample_gcs_file_specs:
        ::core::option::Option<::std::vec::Vec<GoogleCloudDatacatalogV1GcsFileSpec>>,
}
...
pub struct GoogleCloudDatacatalogV1GraphSpec {
    ...
    pub edge_tables:
        ::core::option::Option<::std::vec::Vec<GoogleCloudDatacatalogV1GraphSpecGraphElementTable>>,
...
pub struct GoogleCloudDatacatalogV1ModelSpec {
    ...
    pub vertex_model_spec: ::core::option::Option<GoogleCloudDatacatalogV1VertexModelSpec>,
}
...
pub struct GoogleCloudDatacatalogV1RoutineSpec {
    ...
    pub bigquery_routine_spec: ::core::option::Option<GoogleCloudDatacatalogV1BigQueryRoutineSpec>,
    ...
    pub routine_arguments:
        ::core::option::Option<::std::vec::Vec<GoogleCloudDatacatalogV1RoutineSpecArgument>>,
...
pub struct GoogleCloudDatacatalogV1ServiceSpec {
    ...
    pub cloud_bigtable_instance_spec:
        ::core::option::Option<GoogleCloudDatacatalogV1CloudBigtableInstanceSpec>,
}
...
pub struct GoogleCloudDatacatalogV1SpannerTableSpec {
    ...
    pub foreign_keys: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudDatacatalogV1SpannerTableSpecSpannerForeignKey>,
    >,
    /// Output only. The primary key of the table.
    #[serde(default, rename = "primaryKey")]
    pub primary_key:
        ::core::option::Option<GoogleCloudDatacatalogV1SpannerTableSpecSpannerPrimaryKey>,
}
...
pub struct GoogleCloudDatacatalogV1Contacts {
    ...
    #[serde(default)]
    pub people: ::core::option::Option<::std::vec::Vec<GoogleCloudDatacatalogV1ContactsPerson>>,
}
...
pub struct GoogleCloudDatacatalogV1BigQueryConnectionSpec {
    ...
    pub cloud_sql: ::core::option::Option<GoogleCloudDatacatalogV1CloudSqlBigQueryConnectionSpec>,
...
pub struct GoogleCloudDatacatalogV1DataplexTableSpec {
    ...
    pub dataplex_spec: ::core::option::Option<GoogleCloudDatacatalogV1DataplexSpec>,
    ...
    pub external_tables:
        ::core::option::Option<::std::vec::Vec<GoogleCloudDatacatalogV1DataplexExternalTable>>,
...
pub struct GoogleCloudDatacatalogV1GcsFileSpec {
    ...
    pub gcs_timestamps: ::core::option::Option<GoogleCloudDatacatalogV1SystemTimestamps>,
...
pub struct GoogleCloudDatacatalogV1GraphSpecGraphElementTable {
    ...
    pub label_and_properties: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudDatacatalogV1GraphSpecGraphElementTableLabelAndProperties>,
    >,
...
pub struct GoogleCloudDatacatalogV1VertexModelSpec {
    ...
    pub vertex_model_source_info:
        ::core::option::Option<GoogleCloudDatacatalogV1VertexModelSourceInfo>,
}
...
pub struct GoogleCloudDatacatalogV1ColumnSchema {
    ...
    pub looker_column_spec:
        ::core::option::Option<GoogleCloudDatacatalogV1ColumnSchemaLookerColumnSpec>,
...
pub struct GoogleCloudDatacatalogV1CloudBigtableInstanceSpec {
    ...
    pub cloud_bigtable_cluster_specs: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudDatacatalogV1CloudBigtableInstanceSpecCloudBigtableClusterSpec>,
    >,
}
...
pub struct GoogleCloudDatacatalogV1DataplexSpec {
    ...
    pub data_format: ::core::option::Option<GoogleCloudDatacatalogV1PhysicalSchema>,
...
pub struct GoogleCloudDatacatalogV1GraphSpecGraphElementTableLabelAndProperties {
    ...
    pub properties: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudDatacatalogV1GraphSpecGraphElementTableProperty>,
    >,
}
...
pub struct GoogleCloudDatacatalogV1PhysicalSchema {
    ...
    #[serde(default)]
    pub thrift: ::core::option::Option<GoogleCloudDatacatalogV1PhysicalSchemaThriftSchema>,
}
