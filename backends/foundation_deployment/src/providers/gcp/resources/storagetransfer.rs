...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/storagetransfer/openapi.json`.
...
pub struct AgentPool {
    ...
    pub bandwidth_limit: ::core::option::Option<::std::boxed::Box<BandwidthLimit>>,
...
pub struct AwsS3CompatibleData {
    ...
    pub s3_metadata: ::core::option::Option<::std::boxed::Box<S3CompatibleMetadata>>,
}
...
pub struct AwsS3Data {
    ...
    pub aws_access_key: ::core::option::Option<::std::boxed::Box<AwsAccessKey>>,
...
pub struct AzureBlobStorageData {
    ...
    pub azure_credentials: ::core::option::Option<::std::boxed::Box<AzureCredentials>>,
    ...
    pub federated_identity_config:
        ::core::option::Option<::std::boxed::Box<FederatedIdentityConfig>>,
    /// Root path to transfer objects. Must be an empty string or full path name that ends with a ''/''. This field is treated as an object prefix. As such, it should generally not begin with a ''/''.
    #[serde(default)]
    pub path: ::core::option::Option<String>,
    /// Service Directory Service to be used as the endpoint for transfers from a custom VPC. Format: projects/{project_id}/locations/{location}/namespaces/{namespace}/services/{service}
...
pub struct ListAgentPoolsResponse {
    ...
    pub agent_pools: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AgentPool>>>,
...
pub struct ListTransferJobsResponse {
    ...
    pub transfer_jobs: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TransferJob>>>,
}
...
pub struct ReplicationSpec {
    ...
    pub gcs_data_sink: ::core::option::Option<::std::boxed::Box<GcsData>>,
    /// The Cloud Storage bucket from which to replicate objects.
    #[serde(default, rename = "gcsDataSource")]
    pub gcs_data_source: ::core::option::Option<::std::boxed::Box<GcsData>>,
    ...
    pub object_conditions: ::core::option::Option<::std::boxed::Box<ObjectConditions>>,
    ...
    pub transfer_options: ::core::option::Option<::std::boxed::Box<TransferOptions>>,
}
...
pub struct Schedule {
    ...
    pub end_time_of_day: ::core::option::Option<::std::boxed::Box<TimeOfDay>>,
    ...
    pub schedule_end_date: ::core::option::Option<::std::boxed::Box<Date>>,
    ...
    pub schedule_start_date: ::core::option::Option<::std::boxed::Box<Date>>,
    ...
    pub start_time_of_day: ::core::option::Option<::std::boxed::Box<TimeOfDay>>,
}
...
pub struct TransferJob {
    ...
    pub event_stream: ::core::option::Option<::std::boxed::Box<EventStream>>,
    ...
    pub replication_spec: ::core::option::Option<::std::boxed::Box<ReplicationSpec>>,
    /// Specifies schedule for the transfer job. This is an optional field. When the field is not set, the job never executes a transfer, unless you invoke RunTransferJob or update the job to have a non-empty schedule.
    #[serde(default)]
    pub schedule: ::core::option::Option<::std::boxed::Box<Schedule>>,
    ...
    pub transfer_spec: ::core::option::Option<::std::boxed::Box<TransferSpec>>,
}
...
pub struct TransferOperation {
    ...
    #[serde(default)]
    pub counters: ::core::option::Option<::std::boxed::Box<TransferCounters>>,
    /// End time of this transfer execution.
    #[serde(default, rename = "endTime")]
    pub end_time: ::core::option::Option<String>,
    /// Summarizes errors encountered with sample error log entries.
    #[serde(default, rename = "errorBreakdowns")]
    pub error_breakdowns: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ErrorSummary>>>,
...
pub struct TransferOptions {
    ...
    pub metadata_options: ::core::option::Option<::std::boxed::Box<MetadataOptions>>,
...
pub struct TransferSpec {
    ...
    pub aws_s3_compatible_data_source:
        ::core::option::Option<::std::boxed::Box<AwsS3CompatibleData>>,
    /// Optional. An AWS S3 data source.
    #[serde(default, rename = "awsS3DataSource")]
    pub aws_s3_data_source: ::core::option::Option<::std::boxed::Box<AwsS3Data>>,
    ...
    pub azure_blob_storage_data_source:
        ::core::option::Option<::std::boxed::Box<AzureBlobStorageData>>,
    ...
    pub gcs_intermediate_data_location: ::core::option::Option<::std::boxed::Box<GcsData>>,
    /// Optional. An HDFS cluster data source.
    #[serde(default, rename = "hdfsDataSource")]
    pub hdfs_data_source: ::core::option::Option<::std::boxed::Box<HdfsData>>,
    /// Optional. An HTTP URL data source.
    #[serde(default, rename = "httpDataSource")]
    pub http_data_source: ::core::option::Option<::std::boxed::Box<HttpData>>,
    /// Only objects that satisfy these object conditions are included in the set of data source and data sink objects. Object conditions based on objects'' "last modification time" do not exclude objects in a data sink.
    #[serde(default, rename = "objectConditions")]
    pub object_conditions: ::core::option::Option<::std::boxed::Box<ObjectConditions>>,
    /// Optional. A POSIX Filesystem data sink.
    #[serde(default, rename = "posixDataSink")]
    pub posix_data_sink: ::core::option::Option<::std::boxed::Box<PosixFilesystem>>,
    /// Optional. A POSIX Filesystem data source.
    #[serde(default, rename = "posixDataSource")]
    pub posix_data_source: ::core::option::Option<::std::boxed::Box<PosixFilesystem>>,
    ...
    pub transfer_manifest: ::core::option::Option<::std::boxed::Box<TransferManifest>>,
...
pub struct UpdateTransferJobRequest {
    ...
    pub transfer_job: ::core::option::Option<::std::boxed::Box<TransferJob>>,
