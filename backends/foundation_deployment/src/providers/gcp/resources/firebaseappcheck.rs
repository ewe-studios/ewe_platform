...
pub struct GoogleFirebaseAppcheckV1BatchGetAppAttestConfigsResponse {
    ...
    #[serde(default)]
    pub configs: ::core::option::Option<::std::vec::Vec<GoogleFirebaseAppcheckV1AppAttestConfig>>,
}
...
pub struct GoogleFirebaseAppcheckV1BatchGetDeviceCheckConfigsResponse {
    ...
    #[serde(default)]
    pub configs: ::core::option::Option<::std::vec::Vec<GoogleFirebaseAppcheckV1DeviceCheckConfig>>,
}
...
pub struct GoogleFirebaseAppcheckV1BatchGetPlayIntegrityConfigsResponse {
    ...
    #[serde(default)]
    pub configs:
        ::core::option::Option<::std::vec::Vec<GoogleFirebaseAppcheckV1PlayIntegrityConfig>>,
}
...
pub struct GoogleFirebaseAppcheckV1BatchGetRecaptchaEnterpriseConfigsResponse {
    ...
    #[serde(default)]
    pub configs:
        ::core::option::Option<::std::vec::Vec<GoogleFirebaseAppcheckV1RecaptchaEnterpriseConfig>>,
}
...
pub struct GoogleFirebaseAppcheckV1BatchGetRecaptchaV3ConfigsResponse {
    ...
    #[serde(default)]
    pub configs: ::core::option::Option<::std::vec::Vec<GoogleFirebaseAppcheckV1RecaptchaV3Config>>,
}
...
pub struct GoogleFirebaseAppcheckV1BatchGetSafetyNetConfigsResponse {
    ...
    #[serde(default)]
    pub configs: ::core::option::Option<::std::vec::Vec<GoogleFirebaseAppcheckV1SafetyNetConfig>>,
}
...
pub struct GoogleFirebaseAppcheckV1BatchUpdateResourcePoliciesRequest {
    ...
    pub requests: ::core::option::Option<
        ::std::vec::Vec<GoogleFirebaseAppcheckV1UpdateResourcePolicyRequest>,
    >,
...
pub struct GoogleFirebaseAppcheckV1BatchUpdateResourcePoliciesResponse {
    ...
    pub resource_policies:
        ::core::option::Option<::std::vec::Vec<GoogleFirebaseAppcheckV1ResourcePolicy>>,
}
...
pub struct GoogleFirebaseAppcheckV1BatchUpdateServicesRequest {
    ...
    #[serde(default)]
    pub requests:
        ::core::option::Option<::std::vec::Vec<GoogleFirebaseAppcheckV1UpdateServiceRequest>>,
...
pub struct GoogleFirebaseAppcheckV1ExchangeAppAttestAttestationResponse {
    ...
    pub app_check_token: ::core::option::Option<GoogleFirebaseAppcheckV1AppCheckToken>,
...
pub struct GoogleFirebaseAppcheckV1ListDebugTokensResponse {
    ...
    pub debug_tokens: ::core::option::Option<::std::vec::Vec<GoogleFirebaseAppcheckV1DebugToken>>,
...
pub struct GoogleFirebaseAppcheckV1PlayIntegrityConfig {
    ...
    pub account_details:
        ::core::option::Option<GoogleFirebaseAppcheckV1PlayIntegrityConfigAccountDetails>,
    ...
    pub app_integrity:
        ::core::option::Option<GoogleFirebaseAppcheckV1PlayIntegrityConfigAppIntegrity>,
    ...
    pub device_integrity:
        ::core::option::Option<GoogleFirebaseAppcheckV1PlayIntegrityConfigDeviceIntegrity>,
