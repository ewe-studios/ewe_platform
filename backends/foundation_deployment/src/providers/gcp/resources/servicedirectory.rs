...
pub struct ListNamespacesResponse {
    ...
    #[serde(default)]
    pub namespaces: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Namespace>>>,
    /// Token to retrieve the next page of results, or empty if there are no more results in the list.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct ResolveServiceRequest {
    ...
    pub max_endpoints: ::core::option::Option<i32>,
}
...
pub struct ResolveServiceResponse {
    #[serde(default)]
    pub service: ::core::option::Option<::std::boxed::Box<Service>>,
}
