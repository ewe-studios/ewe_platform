...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/kmsinventory/openapi.json`.
...
pub struct GoogleCloudKmsInventoryV1ListCryptoKeysResponse {
    ...
    pub crypto_keys:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudKmsV1CryptoKey>>>,
...
pub struct GoogleCloudKmsInventoryV1ProtectedResourcesSummary {
    ...
    pub warnings: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudKmsInventoryV1Warning>>,
    >,
}
...
pub struct GoogleCloudKmsInventoryV1SearchProtectedResourcesResponse {
    ...
    pub protected_resources: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudKmsInventoryV1ProtectedResource>>,
    >,
}
...
pub struct GoogleCloudKmsV1CryptoKey {
    ...
    pub key_access_justifications_policy:
        ::core::option::Option<::std::boxed::Box<GoogleCloudKmsV1KeyAccessJustificationsPolicy>>,
    ...
    #[serde(default)]
    pub primary: ::core::option::Option<::std::boxed::Box<GoogleCloudKmsV1CryptoKeyVersion>>,
    ...
    pub version_template:
        ::core::option::Option<::std::boxed::Box<GoogleCloudKmsV1CryptoKeyVersionTemplate>>,
}
...
pub struct GoogleCloudKmsV1CryptoKeyVersion {
    ...
    #[serde(default)]
    pub attestation:
        ::core::option::Option<::std::boxed::Box<GoogleCloudKmsV1KeyOperationAttestation>>,
    ...
    pub external_protection_level_options:
        ::core::option::Option<::std::boxed::Box<GoogleCloudKmsV1ExternalProtectionLevelOptions>>,
...
pub struct GoogleCloudKmsV1KeyOperationAttestation {
    ...
    pub cert_chains: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudKmsV1KeyOperationAttestationCertificateChains>,
    >,
