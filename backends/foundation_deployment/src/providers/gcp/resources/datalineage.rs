...
pub struct GoogleCloudDatacatalogLineageConfigmanagementV1Config {
    ...
    #[serde(default)]
    pub ingestion:
        ::core::option::Option<GoogleCloudDatacatalogLineageConfigmanagementV1ConfigIngestion>,
...
pub struct GoogleCloudDatacatalogLineageV1ListLineageEventsResponse {
    ...
    pub lineage_events:
        ::core::option::Option<::std::vec::Vec<GoogleCloudDatacatalogLineageV1LineageEvent>>,
...
pub struct GoogleCloudDatacatalogLineageV1ListProcessesResponse {
    ...
    #[serde(default)]
    pub processes: ::core::option::Option<::std::vec::Vec<GoogleCloudDatacatalogLineageV1Process>>,
}
...
pub struct GoogleCloudDatacatalogLineageV1ListRunsResponse {
    ...
    #[serde(default)]
    pub runs: ::core::option::Option<::std::vec::Vec<GoogleCloudDatacatalogLineageV1Run>>,
}
...
pub struct GoogleCloudDatacatalogLineageV1SearchLinksResponse {
    ...
    #[serde(default)]
    pub links: ::core::option::Option<::std::vec::Vec<GoogleCloudDatacatalogLineageV1Link>>,
    /// The token to specify as page_token in the subsequent call to get the next page. Omitted if there are no more pages in the response.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
