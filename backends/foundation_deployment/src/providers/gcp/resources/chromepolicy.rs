...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/chromepolicy/openapi.json`.
...
pub struct GoogleChromePolicyVersionsV1BatchDeleteGroupPoliciesRequest {
    ...
    pub requests: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleChromePolicyVersionsV1DeleteGroupPolicyRequest>>,
    >,
}
...
pub struct GoogleChromePolicyVersionsV1BatchInheritOrgUnitPoliciesRequest {
    ...
    #[serde(default)]
    pub requests: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleChromePolicyVersionsV1InheritOrgUnitPolicyRequest>>,
    >,
}
...
pub struct GoogleChromePolicyVersionsV1BatchModifyGroupPoliciesRequest {
    ...
    #[serde(default)]
    pub requests: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleChromePolicyVersionsV1ModifyGroupPolicyRequest>>,
    >,
}
...
pub struct GoogleChromePolicyVersionsV1BatchModifyOrgUnitPoliciesRequest {
    ...
    #[serde(default)]
    pub requests: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleChromePolicyVersionsV1ModifyOrgUnitPolicyRequest>>,
    >,
}
...
pub struct GoogleChromePolicyVersionsV1DefineCertificateRequest {
    ...
    pub settings: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleChromePolicyVersionsV1NetworkSetting>>,
    >,
...
pub struct GoogleChromePolicyVersionsV1DeleteGroupPolicyRequest {
    ...
    pub policy_target_key:
        ::core::option::Option<::std::boxed::Box<GoogleChromePolicyVersionsV1PolicyTargetKey>>,
}
...
pub struct GoogleChromePolicyVersionsV1FieldConstraints {
    ...
    pub numeric_range_constraint: ::core::option::Option<
        ::std::boxed::Box<GoogleChromePolicyVersionsV1NumericRangeConstraint>,
    >,
    ...
    pub uploaded_file_constraints: ::core::option::Option<
        ::std::boxed::Box<GoogleChromePolicyVersionsV1UploadedFileConstraints>,
    >,
}
...
pub struct GoogleChromePolicyVersionsV1ListPolicySchemasResponse {
    ...
    pub policy_schemas: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleChromePolicyVersionsV1PolicySchema>>,
    >,
}
...
pub struct GoogleChromePolicyVersionsV1ModifyGroupPolicyRequest {
    ...
    pub policy_value:
        ::core::option::Option<::std::boxed::Box<GoogleChromePolicyVersionsV1PolicyValue>>,
...
pub struct GoogleChromePolicyVersionsV1PolicyApiLifecycle {
    ...
    pub end_support: ::core::option::Option<::std::boxed::Box<GoogleTypeDate>>,
...
pub struct GoogleChromePolicyVersionsV1PolicyModificationError {
    ...
    pub field_errors: ::core::option::Option<
        ::std::vec::Vec<
            ::std::boxed::Box<GoogleChromePolicyVersionsV1PolicyModificationFieldError>,
        >,
    >,
...
pub struct GoogleChromePolicyVersionsV1PolicyModificationErrorDetails {
    ...
    pub modification_errors: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleChromePolicyVersionsV1PolicyModificationError>>,
    >,
}
...
pub struct GoogleChromePolicyVersionsV1PolicySchema {
    ...
    pub additional_target_key_names: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleChromePolicyVersionsV1AdditionalTargetKeyName>>,
    >,
    ...
    #[serde(default)]
    pub definition: ::core::option::Option<::std::boxed::Box<Proto2FileDescriptorProto>>,
    ...
    pub notices: ::core::option::Option<
        ::std::vec::Vec<
            ::std::boxed::Box<GoogleChromePolicyVersionsV1PolicySchemaNoticeDescription>,
        >,
    >,
    /// Output only. Current lifecycle information.
    #[serde(default, rename = "policyApiLifecycle")]
    pub policy_api_lifecycle:
        ::core::option::Option<::std::boxed::Box<GoogleChromePolicyVersionsV1PolicyApiLifecycle>>,
...
pub struct GoogleChromePolicyVersionsV1PolicySchemaFieldDescription {
    ...
    pub field_constraints:
        ::core::option::Option<::std::boxed::Box<GoogleChromePolicyVersionsV1FieldConstraints>>,
    ...
    pub field_dependencies: ::core::option::Option<
        ::std::vec::Vec<
            ::std::boxed::Box<GoogleChromePolicyVersionsV1PolicySchemaFieldDependencies>,
        >,
    >,
    ...
    pub known_value_descriptions: ::core::option::Option<
        ::std::vec::Vec<
            ::std::boxed::Box<GoogleChromePolicyVersionsV1PolicySchemaFieldKnownValueDescription>,
        >,
    >,
    ...
    pub required_items: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleChromePolicyVersionsV1PolicySchemaRequiredItems>>,
    >,
}
...
pub struct GoogleChromePolicyVersionsV1RemoveCertificateErrorDetails {
    ...
    pub certificate_references: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleChromePolicyVersionsV1CertificateReference>>,
    >,
}
...
pub struct GoogleChromePolicyVersionsV1ResolveResponse {
    ...
    pub resolved_policies: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleChromePolicyVersionsV1ResolvedPolicy>>,
    >,
}
...
pub struct GoogleChromePolicyVersionsV1ResolvedPolicy {
    ...
    #[serde(default)]
    pub value: ::core::option::Option<::std::boxed::Box<GoogleChromePolicyVersionsV1PolicyValue>>,
}
...
pub struct Proto2DescriptorProto {
    ...
    pub enum_type:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Proto2EnumDescriptorProto>>>,
    #[serde(default)]
    pub field:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Proto2FieldDescriptorProto>>>,
    #[serde(default)]
    pub name: ::core::option::Option<String>,
    #[serde(default, rename = "nestedType")]
    pub nested_type:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Proto2DescriptorProto>>>,
    #[serde(default, rename = "oneofDecl")]
    pub oneof_decl:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Proto2OneofDescriptorProto>>>,
...
pub struct Proto2EnumDescriptorProto {
    ...
    #[serde(default)]
    pub value:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Proto2EnumValueDescriptorProto>>>,
    /// Support for export and local keywords on enums. // TODO: enum values: ["VISIBILITY_UNSET", "VISIBILITY_LOCAL", "VISIBILITY_EXPORT"]
    #[serde(default)]
    pub visibility: ::core::option::Option<String>,
}
