...
pub struct GoogleChromePolicyVersionsV1PolicyModificationError {
    ...
    pub field_errors: Option<Vec<GoogleChromePolicyVersionsV1PolicyModificationFieldError>>,
...
pub struct GoogleChromePolicyVersionsV1PolicyModificationErrorDetails {
    ...
    pub modification_errors: Option<Vec<GoogleChromePolicyVersionsV1PolicyModificationError>>,
}
...
pub struct GoogleChromePolicyVersionsV1RemoveCertificateErrorDetails {
    ...
    pub certificate_references: Option<Vec<GoogleChromePolicyVersionsV1CertificateReference>>,
}
