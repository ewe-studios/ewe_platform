...
pub struct Application {
    ...
    pub dispatch_rules: ::core::option::Option<::std::vec::Vec<UrlDispatchRule>>,
    /// The feature specific settings to be used in the application.
    #[serde(default, rename = "featureSettings")]
    pub feature_settings: ::core::option::Option<FeatureSettings>,
    ...
    #[serde(default)]
    pub iap: ::core::option::Option<IdentityAwareProxy>,
...
pub struct BatchUpdateIngressRulesRequest {
    ...
    pub ingress_rules: ::core::option::Option<::std::vec::Vec<FirewallRule>>,
}
...
pub struct ListAuthorizedCertificatesResponse {
    ...
    #[serde(default)]
    pub certificates: ::core::option::Option<::std::vec::Vec<AuthorizedCertificate>>,
...
pub struct ListAuthorizedDomainsResponse {
    ...
    #[serde(default)]
    pub domains: ::core::option::Option<::std::vec::Vec<AuthorizedDomain>>,
    /// Continuation token for fetching the next page of results.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct ListDomainMappingsResponse {
    ...
    pub domain_mappings: ::core::option::Option<::std::vec::Vec<DomainMapping>>,
    /// Continuation token for fetching the next page of results.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct ProjectEvent {
    ...
    pub project_metadata: ::core::option::Option<ProjectsMetadata>,
...
pub struct DomainMapping {
    ...
    pub resource_records: ::core::option::Option<::std::vec::Vec<ResourceRecord>>,
...
pub struct Runtime {
    ...
    pub decommissioned_date: ::core::option::Option<Date>,
    ...
    pub end_of_support_date: ::core::option::Option<Date>,
...
pub struct Version {
    ...
    pub automatic_scaling: ::core::option::Option<AutomaticScaling>,
    /// A service with basic scaling will create an instance when the application receives a request. The instance will be turned down when the app becomes idle. Basic scaling is ideal for work that is intermittent or driven by user activity.
    #[serde(default, rename = "basicScaling")]
    pub basic_scaling: ::core::option::Option<BasicScaling>,
    ...
    pub error_handlers: ::core::option::Option<::std::vec::Vec<ErrorHandler>>,
    /// Settings for App Engine flexible runtimes.
    #[serde(default, rename = "flexibleRuntimeSettings")]
    pub flexible_runtime_settings: ::core::option::Option<FlexibleRuntimeSettings>,
    /// Additional Google Generated Customer Metadata, this field won''t be provided by default and can be requested by setting the IncludeExtraData field in GetVersionRequest
    #[serde(default, rename = "generatedCustomerMetadata")]
    pub generated_customer_metadata: ::core::option::Option<serde_json::Value>,
    /// An ordered list of URL-matching patterns that should be applied to incoming requests. The first matching URL handles the request and other request handlers are not attempted.Only returned in GET requests if view=FULL is set.
    #[serde(default)]
    pub handlers: ::core::option::Option<::std::vec::Vec<UrlMap>>,
    ...
    #[serde(default)]
    pub libraries: ::core::option::Option<::std::vec::Vec<Library>>,
...
pub struct ProjectsMetadata {
    ...
    pub gce_tag: ::core::option::Option<::std::vec::Vec<GceTag>>,
...
pub struct ContainerState {
    ...
    pub previous_reasons: ::core::option::Option<Reasons>,
...
pub struct UrlMap {
    ...
    pub api_endpoint: ::core::option::Option<ApiEndpointHandler>,
    /// Action to take when users access resources that require authentication. Defaults to redirect. // TODO: enum values: ["AUTH_FAIL_ACTION_UNSPECIFIED", "AUTH_FAIL_ACTION_REDIRECT", "AUTH_FAIL_ACTION_UNAUTHORIZED"]
    #[serde(default, rename = "authFailAction")]
    pub auth_fail_action: ::core::option::Option<String>,
    ...
    #[serde(default)]
    pub script: ::core::option::Option<ScriptHandler>,
    /// Security (HTTPS) enforcement for this URL. // TODO: enum values: ["SECURE_UNSPECIFIED", "SECURE_DEFAULT", "SECURE_NEVER", "SECURE_OPTIONAL", "SECURE_ALWAYS"]
    #[serde(default, rename = "securityLevel")]
    pub security_level: ::core::option::Option<String>,
    /// Returns the contents of a file, such as an image, as the response.
    #[serde(default, rename = "staticFiles")]
    pub static_files: ::core::option::Option<StaticFilesHandler>,
