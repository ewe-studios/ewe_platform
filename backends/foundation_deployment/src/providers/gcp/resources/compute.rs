...
pub struct AcceleratorTopologiesInfoAcceleratorTopologyInfo {
    ...
    pub info_per_topology_states: Option<Vec<AcceleratorTopologiesInfoAcceleratorTopologyInfoInfoPerTopologyState>>,
}
...
pub struct BackendServiceHAPolicy {
    ...
    pub fast_i_p_move: Option<String>,
...
pub struct BulkInsertInstanceResource {
    ...
    pub per_instance_properties: Option<serde_json::Value>,
...
pub struct BulkZoneSetLabelsRequest {
    #[serde(default)]
    pub requests: Option<Vec<BulkSetLabelsRequest>>,
}
...
pub struct CalendarModeAdviceResponse {
    ...
    #[serde(default)]
    pub recommendations: Option<Vec<CalendarModeRecommendation>>,
}
...
pub struct CompositeHealthChecksScopedList {
    ...
    pub composite_health_checks: Option<Vec<CompositeHealthCheck>>,
...
pub struct Firewall {
    ...
    #[serde(default)]
    pub denied: Option<Vec<serde_json::Value>>,
    /// An optional description of this resource. Provide this field when you
    #[serde(default)]
    pub description: Option<String>,
...
pub struct FirewallPoliciesScopedList {
    ...
    pub firewall_policies: Option<Vec<FirewallPolicy>>,
...
pub struct FlexibleTimeRange {
    ...
    pub start_time_not_earlier_than: Option<String>,
    #[serde(default, rename = "startTimeNotLaterThan")]
    pub start_time_not_later_than: Option<String>,
}
...
pub struct ForwardingRule {
    ...
    #[serde(default, rename = "IPProtocol")]
    pub i_p_protocol: Option<String>,
    ...
    #[serde(default, rename = "externalManagedBackendBucketMigrationTestingPercentage")]
    pub external_managed_backend_bucket_migration_testing_percentage: Option<f32>,
    /// Fingerprint of this resource. A hash of the contents stored in this object.
    #[serde(default)]
    pub fingerprint: Option<String>,
    /// [Output Only] The unique identifier for the resource. This identifier is
...
pub struct FutureReservationsScopedList {
    ...
    pub future_reservations: Option<Vec<FutureReservation>>,
...
pub struct FutureResourcesRecommendation {
    ...
    pub other_locations: Option<serde_json::Value>,
...
pub struct FutureResourcesSpecSpecificSKUResources {
    ...
    pub local_ssd_partitions: Option<Vec<FutureResourcesSpecLocalSsdPartition>>,
...
pub struct FutureResourcesSpecTargetResources {
    ...
    pub aggregate_resources: Option<FutureResourcesSpecAggregateResources>,
    #[serde(default, rename = "specificSkuResources")]
    pub specific_sku_resources: Option<FutureResourcesSpecSpecificSKUResources>,
}
...
pub struct HealthAggregationPoliciesScopedList {
    ...
    pub health_aggregation_policies: Option<Vec<HealthAggregationPolicy>>,
...
pub struct HealthCheckServicesScopedList {
    ...
    #[serde(default)]
    pub resources: Option<Vec<HealthCheckService>>,
    /// Informational warning which replaces the list of
    #[serde(default)]
    pub warning: Option<serde_json::Value>,
}
...
pub struct HealthSourcesScopedList {
    ...
    #[serde(default, rename = "healthSources")]
    pub health_sources: Option<Vec<HealthSource>>,
    /// Informational warning which replaces the list of
    #[serde(default)]
    pub warning: Option<serde_json::Value>,
}
...
pub struct Image {
    ...
    pub raw_disk: Option<serde_json::Value>,
    /// Output only. Reserved for future use.
    #[serde(default, rename = "satisfiesPzi")]
    pub satisfies_pzi: Option<bool>,
    /// Output only. [Output Only] Reserved for future use.
...
pub struct InstanceTemplatesScopedList {
    ...
    pub instance_templates: Option<Vec<InstanceTemplate>>,
...
pub struct InstancesReportHostAsFaultyRequest {
    ...
    pub disruption_schedule: Option<String>,
    #[serde(default, rename = "faultReasons")]
    pub fault_reasons: Option<Vec<InstancesReportHostAsFaultyRequestFaultReason>>,
}
...
pub struct InstantSnapshotsScopedList {
    ...
    pub instant_snapshots: Option<Vec<InstantSnapshot>>,
...
pub struct InterconnectApplicationAwareInterconnect {
    ...
    pub shape_average_percentages: Option<Vec<InterconnectApplicationAwareInterconnectBandwidthPercentage>>,
    #[serde(default, rename = "strictPriorityPolicy")]
    pub strict_priority_policy: Option<serde_json::Value>,
}
...
pub struct InterconnectApplicationAwareInterconnectBandwidthPercentagePolicy {
    ...
    pub bandwidth_percentages: Option<Vec<InterconnectApplicationAwareInterconnectBandwidthPercentage>>,
}
...
pub struct InterconnectAttachmentGroupConfiguredAvailabilitySLA {
    ...
    pub intended_sla_blockers: Option<Vec<InterconnectAttachmentGroupConfiguredAvailabilitySLAIntendedSlaBlockers>>,
}
...
pub struct InterconnectAttachmentGroupsOperationalStatus {
    ...
    pub attachment_statuses: Option<Vec<InterconnectAttachmentGroupsOperationalStatusAttachmentStatus>>,
    #[serde(default)]
    pub configured: Option<InterconnectAttachmentGroupConfigured>,
...
pub struct InterconnectAttachmentL2ForwardingApplianceMapping {
    ...
    pub appliance_ip_address: Option<String>,
    /// Optional. Used to match against the inner VLAN when the packet
    #[serde(default, rename = "innerVlanToApplianceMappings")]
    pub inner_vlan_to_appliance_mappings: Option<Vec<InterconnectAttachmentL2ForwardingApplianceMappingInnerVlanToApplianceMapping>>,
...
pub struct InterconnectGroupConfiguredTopologyCapability {
    ...
    pub intended_capability_blockers: Option<Vec<InterconnectGroupConfiguredTopologyCapabilityIntendedCapabilityBlockers>>,
...
pub struct InterconnectGroupsCreateMembers {
    ...
    pub intent_mismatch_behavior: Option<String>,
    #[serde(default)]
    pub interconnects: Option<Vec<InterconnectGroupsCreateMembersInterconnectInput>>,
...
pub struct InterconnectRemoteLocation {
    ...
    pub max_lag_size400_gbps: Option<i32>,
    /// Output only. [Output Only] Name of the resource.
    #[serde(default)]
    pub name: Option<String>,
    /// Output only. [Output Only] The peeringdb identifier for this facility (corresponding
...
pub struct LocationPolicy {
    ...
    #[serde(default)]
    pub zones: Option<Vec<LocationPolicyZoneConfiguration>>,
}
...
pub struct MachineType {
    ...
    #[serde(default)]
    pub accelerators: Option<Vec<serde_json::Value>>,
...
pub struct NetworkProfileNetworkFeatures {
    ...
    pub predefined_subnetwork_ranges: Option<Vec<NetworkProfileNetworkFeaturesPredefinedSubnetworkRange>>,
...
pub struct NotificationEndpointsScopedList {
    ...
    #[serde(default)]
    pub resources: Option<Vec<NotificationEndpoint>>,
    /// Informational warning which replaces the list of
    #[serde(default)]
    pub warning: Option<serde_json::Value>,
}
...
pub struct PacketMirroringFilter {
    ...
    pub i_p_protocols: Option<Vec<String>>,
...
pub struct PreservedStatePreservedNetworkIp {
    ...
    #[serde(default, rename = "ipAddress")]
    pub ip_address: Option<PreservedStatePreservedNetworkIpIpAddress>,
}
...
pub struct Region {
    ...
    pub quota_status_warning: Option<serde_json::Value>,
...
pub struct ReservationBlock {
    ...
    pub reservation_sub_block_count: Option<i32>,
    ...
    pub reservation_sub_block_in_use_count: Option<i32>,
    /// Output only. [Output Only] Server-defined fully-qualified URL for this resource.
    #[serde(default, rename = "selfLink")]
    pub self_link: Option<String>,
    /// Output only. [Output Only] Server-defined URL for this resource with the resource id.
...
pub struct ReservationSlotsGetVersionRequest {
    ...
    pub sbom_selections: Option<Vec<String>>,
}
...
pub struct ReservationSubBlocksReportFaultyRequest {
    ...
    pub failure_component: Option<String>,
    /// The reasons for the fault experienced with the subBlock.
    #[serde(default, rename = "faultReasons")]
    pub fault_reasons: Option<Vec<ReservationSubBlocksReportFaultyRequestFaultReason>>,
}
...
pub struct ReservationsBlocksPerformMaintenanceRequest {
    ...
    pub maintenance_scope: Option<String>,
}
...
pub struct SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfig {
    ...
    pub threshold_configs: Option<Vec<SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigThresholdConfig>>,
}
...
pub struct StoragePoolTypesScopedList {
    ...
    pub storage_pool_types: Option<Vec<StoragePoolType>>,
