...
pub struct ExportFindingsMetadata {
    ...
    pub export_start_time: Option<String>,
}
...
pub struct GcpMetadata {
    ...
    #[serde(default)]
    pub folders: Option<Vec<GoogleCloudSecuritycenterV2Folder>>,
...
pub struct GoogleCloudSecuritycenterV1NotificationMessage {
    ...
    pub notification_config_name: Option<String>,
    /// The Cloud resource tied to this notification''s Finding.
    #[serde(default)]
    pub resource: Option<GoogleCloudSecuritycenterV1Resource>,
}
...
pub struct GoogleCloudSecuritycenterV1p1beta1Finding {
    ...
    /// Output only. User specified security marks. These marks are entirely managed by the user and come from the SecurityMarks resource that belongs to the finding.
    #[serde(default, rename = "securityMarks")]
    pub security_marks: Option<GoogleCloudSecuritycenterV1p1beta1SecurityMarks>,
    /// The severity of the finding. This field is managed by the source that writes the finding. // TODO: enum values: ["SEVERITY_UNSPECIFIED", "CRITICAL", "HIGH", "MEDIUM", "LOW"]
    #[serde(default)]
    pub severity: Option<String>,
    /// Source specific properties. These properties are managed by the source that writes the finding. The key names in the source_properties map must be between 1 and 255 characters, and must start with a letter and contain alphanumeric characters or underscores only.
...
pub struct GoogleCloudSecuritycenterV1p1beta1NotificationMessage {
    /// If it''s a Finding based notification config, this field will be populated.
    #[serde(default)]
    pub finding: Option<GoogleCloudSecuritycenterV1p1beta1Finding>,
    /// Name of the notification config that generated current notification.
    #[serde(default, rename = "notificationConfigName")]
    pub notification_config_name: Option<String>,
    /// The Cloud resource tied to the notification.
    #[serde(default)]
    pub resource: Option<GoogleCloudSecuritycenterV1p1beta1Resource>,
}
...
pub struct GoogleCloudSecuritycenterV1p1beta1Resource {
    /// Output only. Contains a Folder message for each folder in the assets ancestry. The first folder is the deepest nested folder, and the last folder is the folder directly under the Organization.
    #[serde(default)]
    pub folders: Option<Vec<GoogleCloudSecuritycenterV1p1beta1Folder>>,
    /// The full resource name of the resource. See: https://cloud.google.com/apis/design/resource_names#full_resource_name
    #[serde(default)]
    pub name: Option<String>,
    /// The full resource name of resource''s parent.
...
pub struct GoogleCloudSecuritycenterV2Access {
    ...
    /// The caller IP''s geolocation, which identifies where the call came from.
    #[serde(default, rename = "callerIpGeo")]
    pub caller_ip_geo: Option<GoogleCloudSecuritycenterV2Geolocation>,
    /// The method that the service account called, e.g. "SetIamPolicy".
    #[serde(default, rename = "methodName")]
    pub method_name: Option<String>,
    /// Associated email, such as "foo@google.com". The email address of the authenticated user or a service account acting on behalf of a third party principal making the request. For third party identity callers, the principal_subject field is populated instead of this field. For privacy reasons, the principal email address is sometimes redacted. For more information, see [Caller identities in audit logs](https://cloud.google.com/logging/docs/audit#user-id).
    ...
    pub service_account_delegation_info:
        Option<Vec<GoogleCloudSecuritycenterV2ServiceAccountDelegationInfo>>,
    /// The name of the service account key that was used to create or exchange credentials when authenticating the service account that made the request. This is a scheme-less URI full resource name. For example: "//iam.googleapis.com/projects/{PROJECT_ID}/serviceAccounts/{ACCOUNT}/keys/{key}".
    #[serde(default, rename = "serviceAccountKeyName")]
    pub service_account_key_name: Option<String>,
    /// This is the API service that the service account made a call to, e.g. "iam.googleapis.com"
...
pub struct GoogleCloudSecuritycenterV2AdcApplication {
    /// Consumer provided attributes for the AppHub application.
    #[serde(default)]
    pub attributes: Option<GoogleCloudSecuritycenterV2ResourceApplicationAttributes>,
    /// The resource name of an ADC Application. Format: projects/{project}/locations/{location}/spaces/{space}/applications/{application}
    #[serde(default)]
    pub name: Option<String>,
}
...
pub struct GoogleCloudSecuritycenterV2Allowed {
    /// Optional. Optional list of allowed IP rules.
    #[serde(default, rename = "ipRules")]
    pub ip_rules: Option<Vec<GoogleCloudSecuritycenterV2IpRule>>,
}
...
pub struct GoogleCloudSecuritycenterV2ArtifactGuardPolicies {
    /// A list of failing policies.
    #[serde(default, rename = "failingPolicies")]
    pub failing_policies: Option<Vec<GoogleCloudSecuritycenterV2ArtifactGuardPolicy>>,
    /// The ID of the resource that has policies configured for it.
    #[serde(default, rename = "resourceId")]
    pub resource_id: Option<String>,
}
...
pub struct GoogleCloudSecuritycenterV2AwsMetadata {
    /// The AWS account associated with the resource.
    #[serde(default)]
    pub account: Option<GoogleCloudSecuritycenterV2AwsAccount>,
    /// The AWS organization associated with the resource.
    #[serde(default)]
    pub organization: Option<GoogleCloudSecuritycenterV2AwsOrganization>,
    /// A list of AWS organizational units associated with the resource, ordered from lowest level (closest to the account) to highest level.
    #[serde(default, rename = "organizationalUnits")]
    pub organizational_units: Option<Vec<GoogleCloudSecuritycenterV2AwsOrganizationalUnit>>,
}
...
pub struct GoogleCloudSecuritycenterV2AzureMetadata {
    /// A list of Azure management groups associated with the resource, ordered from lowest level (closest to the subscription) to highest level.
    #[serde(default, rename = "managementGroups")]
    pub management_groups: Option<Vec<GoogleCloudSecuritycenterV2AzureManagementGroup>>,
    /// The Azure resource group associated with the resource.
    #[serde(default, rename = "resourceGroup")]
    pub resource_group: Option<GoogleCloudSecuritycenterV2AzureResourceGroup>,
    /// The Azure subscription associated with the resource.
    #[serde(default)]
    pub subscription: Option<GoogleCloudSecuritycenterV2AzureSubscription>,
    /// The Azure Entra tenant associated with the resource.
    #[serde(default)]
    pub tenant: Option<GoogleCloudSecuritycenterV2AzureTenant>,
}
...
pub struct GoogleCloudSecuritycenterV2Binding {
    ...
    /// The Role or ClusterRole referenced by the binding.
    #[serde(default)]
    pub role: Option<GoogleCloudSecuritycenterV2Role>,
    /// Represents one or more subjects that are bound to the role. Not always available for PATCH requests.
    #[serde(default)]
    pub subjects: Option<Vec<GoogleCloudSecuritycenterV2Subject>>,
}
...
pub struct GoogleCloudSecuritycenterV2CloudArmor {
    /// Information about potential Layer 7 DDoS attacks identified by [Google Cloud Armor Adaptive Protection](https://cloud.google.com/armor/docs/adaptive-protection-overview).
    #[serde(default, rename = "adaptiveProtection")]
    pub adaptive_protection: Option<GoogleCloudSecuritycenterV2AdaptiveProtection>,
    /// Information about DDoS attack volume and classification.
    #[serde(default)]
    pub attack: Option<GoogleCloudSecuritycenterV2Attack>,
    /// Duration of attack from the start until the current moment (updated every 5 minutes).
    #[serde(default)]
    pub duration: Option<String>,
    /// Information about incoming requests evaluated by [Google Cloud Armor security policies](https://cloud.google.com/armor/docs/security-policy-overview).
    #[serde(default)]
    pub requests: Option<GoogleCloudSecuritycenterV2Requests>,
    /// Information about the [Google Cloud Armor security policy](https://cloud.google.com/armor/docs/security-policy-overview) relevant to the finding.
    #[serde(default, rename = "securityPolicy")]
    pub security_policy: Option<GoogleCloudSecuritycenterV2SecurityPolicy>,
    /// Distinguish between volumetric & protocol DDoS attack and application layer attacks. For example, "L3_4" for Layer 3 and Layer 4 DDoS attacks, or "L_7" for Layer 7 DDoS attacks.
    #[serde(default, rename = "threatVector")]
    pub threat_vector: Option<String>,
}
...
pub struct GoogleCloudSecuritycenterV2CloudDlpDataProfile {
    ...
    /// Type of information detected by SDP. Info type includes name, version and sensitivity of the detected information type.
    #[serde(default, rename = "infoTypes")]
    pub info_types: Option<Vec<GoogleCloudSecuritycenterV2InfoType>>,
    /// The resource hierarchy level at which the data profile was generated. // TODO: enum values: ["PARENT_TYPE_UNSPECIFIED", "ORGANIZATION", "PROJECT"]
    #[serde(default, rename = "parentType")]
    pub parent_type: Option<String>,
}
...
pub struct GoogleCloudSecuritycenterV2ComplianceDetails {
    /// CloudControl associated with the finding
    #[serde(default, rename = "cloudControl")]
    pub cloud_control: Option<GoogleCloudSecuritycenterV2CloudControl>,
    /// Cloud Control Deployments associated with the finding. For example, organizations/123/locations/global/cloudControlDeployments/deploymentIdentifier
    #[serde(default, rename = "cloudControlDeploymentNames")]
    pub cloud_control_deployment_names: Option<Vec<String>>,
    /// Details of Frameworks associated with the finding
    #[serde(default)]
    pub frameworks: Option<Vec<GoogleCloudSecuritycenterV2Framework>>,
}
...
pub struct GoogleCloudSecuritycenterV2ContactDetails {
    /// A list of contacts
    #[serde(default)]
    pub contacts: Option<Vec<GoogleCloudSecuritycenterV2Contact>>,
}
...
pub struct GoogleCloudSecuritycenterV2Container {
    ...
    /// Container labels, as provided by the container runtime.
    #[serde(default)]
    pub labels: Option<Vec<GoogleCloudSecuritycenterV2Label>>,
    /// Name of the container.
    #[serde(default)]
    pub name: Option<String>,
    /// Container image URI provided when configuring a pod or container. This string can identify a container image version using mutable tags.
...
pub struct GoogleCloudSecuritycenterV2Cve {
    /// Describe Common Vulnerability Scoring System specified at https://www.first.org/cvss/v3.1/specification-document
    #[serde(default)]
    pub cvssv3: Option<GoogleCloudSecuritycenterV2Cvssv3>,
    /// Date the first publicly available exploit or PoC was released.
    #[serde(default, rename = "exploitReleaseDate")]
    pub exploit_release_date: Option<String>,
    /// The exploitation activity of the vulnerability in the wild. // TODO: enum values: ["EXPLOITATION_ACTIVITY_UNSPECIFIED", "WIDE", "CONFIRMED", "AVAILABLE", "ANTICIPATED", "NO_KNOWN"]
    ...
    /// Additional information about the CVE. e.g. https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2021-34527
    #[serde(default)]
    pub references: Option<Vec<GoogleCloudSecuritycenterV2Reference>>,
    /// Whether upstream fix is available for the CVE.
    #[serde(default, rename = "upstreamFixAvailable")]
    pub upstream_fix_available: Option<bool>,
    /// Whether or not the vulnerability was zero day when the finding was published.
...
pub struct GoogleCloudSecuritycenterV2Exfiltration {
    /// If there are multiple sources, then the data is considered "joined" between them. For instance, BigQuery can join multiple tables, and each table would be considered a source.
    #[serde(default)]
    pub sources: Option<Vec<GoogleCloudSecuritycenterV2ExfilResource>>,
    /// If there are multiple targets, each target would get a complete copy of the "joined" source data.
    #[serde(default)]
    pub targets: Option<Vec<GoogleCloudSecuritycenterV2ExfilResource>>,
    /// Total exfiltrated bytes processed for the entire job.
    #[serde(default, rename = "totalExfiltratedBytes")]
    pub total_exfiltrated_bytes: Option<String>,
}
...
pub struct GoogleCloudSecuritycenterV2ExternalSystem {
    ...
    /// Information about the ticket, if any, that is being used to track the resolution of the issue that is identified by this finding.
    #[serde(default, rename = "ticketInfo")]
    pub ticket_info: Option<GoogleCloudSecuritycenterV2TicketInfo>,
}
...
pub struct GoogleCloudSecuritycenterV2File {
    ...
    /// Path of the file in terms of underlying disk/partition identifiers.
    #[serde(default, rename = "diskPath")]
    pub disk_path: Option<GoogleCloudSecuritycenterV2DiskPath>,
    /// The load state of the file. // TODO: enum values: ["FILE_LOAD_STATE_UNSPECIFIED", "LOADED_BY_PROCESS", "NOT_LOADED_BY_PROCESS"]
    #[serde(default, rename = "fileLoadState")]
    pub file_load_state: Option<String>,
    /// The length in bytes of the file prefix that was hashed. If hashed_size == size, any hashes reported represent the entire file.
    ...
    /// Operation(s) performed on a file.
    #[serde(default)]
    pub operations: Option<Vec<GoogleCloudSecuritycenterV2FileOperation>>,
    /// True when the hash covers only a prefix of the file.
    #[serde(default, rename = "partiallyHashed")]
    pub partially_hashed: Option<bool>,
    /// Absolute path of the file as a JSON encoded string.
...
pub struct GoogleCloudSecuritycenterV2Finding {
    /// Access details associated with the finding, such as more information on the caller, which method was accessed, and from where.
    #[serde(default)]
    pub access: Option<GoogleCloudSecuritycenterV2Access>,
    /// AffectedResources associated with the finding.
    #[serde(default, rename = "affectedResources")]
    pub affected_resources: Option<GoogleCloudSecuritycenterV2AffectedResources>,
    /// Agent data access events associated with the finding.
    #[serde(default, rename = "agentDataAccessEvents")]
    pub agent_data_access_events: Option<Vec<GoogleCloudSecuritycenterV2AgentDataAccessEvent>>,
    /// The AI model associated with the finding.
    #[serde(default, rename = "aiModel")]
    pub ai_model: Option<GoogleCloudSecuritycenterV2AiModel>,
    /// Represents an application associated with the finding.
    #[serde(default)]
    pub application: Option<GoogleCloudSecuritycenterV2Application>,
    /// ArtifactGuardPolicies associated with the finding.
    #[serde(default, rename = "artifactGuardPolicies")]
    pub artifact_guard_policies: Option<GoogleCloudSecuritycenterV2ArtifactGuardPolicies>,
    /// The results of an attack path simulation relevant to this finding.
    #[serde(default, rename = "attackExposure")]
    pub attack_exposure: Option<GoogleCloudSecuritycenterV2AttackExposure>,
    /// Fields related to Backup and DR findings.
    #[serde(default, rename = "backupDisasterRecovery")]
    pub backup_disaster_recovery: Option<GoogleCloudSecuritycenterV2BackupDisasterRecovery>,
    ...
    /// Contains details about a chokepoint, which is a resource or resource group where high-risk attack paths converge, based on [attack path simulations] (https://cloud.google.com/security-command-center/docs/attack-exposure-learn#attack_path_simulations). This field cannot be updated. Its value is ignored in all update requests.
    #[serde(default)]
    pub chokepoint: Option<GoogleCloudSecuritycenterV2Chokepoint>,
    /// Fields related to Cloud Armor findings.
    #[serde(default, rename = "cloudArmor")]
    pub cloud_armor: Option<GoogleCloudSecuritycenterV2CloudArmor>,
    /// Cloud DLP data profile that is associated with the finding.
    #[serde(default, rename = "cloudDlpDataProfile")]
    pub cloud_dlp_data_profile: Option<GoogleCloudSecuritycenterV2CloudDlpDataProfile>,
    /// Cloud Data Loss Prevention (Cloud DLP) inspection results that are associated with the finding.
    #[serde(default, rename = "cloudDlpInspection")]
    pub cloud_dlp_inspection: Option<GoogleCloudSecuritycenterV2CloudDlpInspection>,
    /// Details about the compliance implications of the finding.
    #[serde(default, rename = "complianceDetails")]
    pub compliance_details: Option<GoogleCloudSecuritycenterV2ComplianceDetails>,
    /// Contains compliance information for security standards associated to the finding.
    #[serde(default)]
    pub compliances: Option<Vec<GoogleCloudSecuritycenterV2Compliance>>,
    /// Contains information about the IP connection associated with the finding.
    #[serde(default)]
    pub connections: Option<Vec<GoogleCloudSecuritycenterV2Connection>>,
    /// Output only. Map containing the points of contact for the given finding. The key represents the type of contact, while the value contains a list of all the contacts that pertain. Please refer to: https://cloud.google.com/resource-manager/docs/managing-notification-contacts#notification-categories { "security": { "contacts": [ { "email": "person1@company.com" }, { "email": "person2@company.com" } ] } }
    #[serde(default)]
    pub contacts: Option<serde_json::Value>,
    /// Containers associated with the finding. This field provides information for both Kubernetes and non-Kubernetes containers.
    #[serde(default)]
    pub containers: Option<Vec<GoogleCloudSecuritycenterV2Container>>,
    ...
    /// Data access events associated with the finding.
    #[serde(default, rename = "dataAccessEvents")]
    pub data_access_events: Option<Vec<GoogleCloudSecuritycenterV2DataAccessEvent>>,
    /// Data flow events associated with the finding.
    #[serde(default, rename = "dataFlowEvents")]
    pub data_flow_events: Option<Vec<GoogleCloudSecuritycenterV2DataFlowEvent>>,
    /// Data retention deletion events associated with the finding.
    #[serde(default, rename = "dataRetentionDeletionEvents")]
    pub data_retention_deletion_events:
        Option<Vec<GoogleCloudSecuritycenterV2DataRetentionDeletionEvent>>,
    /// Database associated with the finding.
    #[serde(default)]
    pub database: Option<GoogleCloudSecuritycenterV2Database>,
    /// Contains more details about the finding.
    #[serde(default)]
    pub description: Option<String>,
    /// DiscoveredWorkload associated with the finding.
    #[serde(default, rename = "discoveredWorkload")]
    pub discovered_workload: Option<GoogleCloudSecuritycenterV2DiscoveredWorkload>,
    /// Disk associated with the finding.
    #[serde(default)]
    pub disk: Option<GoogleCloudSecuritycenterV2Disk>,
    /// The time the finding was first detected. If an existing finding is updated, then this is the time the update occurred. For example, if the finding represents an open firewall, this property captures the time the detector believes the firewall became open. The accuracy is determined by the detector. If the finding is later resolved, then this time reflects when the finding was resolved. This must not be set to a value greater than the current timestamp.
    #[serde(default, rename = "eventTime")]
    pub event_time: Option<String>,
    /// Represents exfiltrations associated with the finding.
    #[serde(default)]
    pub exfiltration: Option<GoogleCloudSecuritycenterV2Exfiltration>,
    /// External exposure associated with the finding.
    #[serde(default, rename = "externalExposure")]
    pub external_exposure: Option<GoogleCloudSecuritycenterV2ExternalExposure>,
    /// Output only. Third party SIEM/SOAR fields within SCC, contains external system information and external system finding fields.
    #[serde(default, rename = "externalSystems")]
    pub external_systems: Option<serde_json::Value>,
    /// The URI that, if available, points to a web page outside of Security Command Center where additional information about the finding can be found. This field is guaranteed to be either empty or a well formed URL.
    ...
    /// File associated with the finding.
    #[serde(default)]
    pub files: Option<Vec<GoogleCloudSecuritycenterV2File>>,
    /// The class of the finding. // TODO: enum values: ["FINDING_CLASS_UNSPECIFIED", "THREAT", "VULNERABILITY", "MISCONFIGURATION", "OBSERVATION", "SCC_ERROR", "POSTURE_VIOLATION", "TOXIC_COMBINATION", "SENSITIVE_DATA_RISK", "CHOKEPOINT", "EXTERNAL_EXPOSURE"]
    #[serde(default, rename = "findingClass")]
    pub finding_class: Option<String>,
    /// Contains details about groups of which this finding is a member. A group is a collection of findings that are related in some way. This field cannot be updated. Its value is ignored in all update requests.
    #[serde(default, rename = "groupMemberships")]
    pub group_memberships: Option<Vec<GoogleCloudSecuritycenterV2GroupMembership>>,
    /// Represents IAM bindings associated with the finding.
    #[serde(default, rename = "iamBindings")]
    pub iam_bindings: Option<Vec<GoogleCloudSecuritycenterV2IamBinding>>,
    /// Represents what''s commonly known as an *indicator of compromise* (IoC) in computer forensics. This is an artifact observed on a network or in an operating system that, with high confidence, indicates a computer intrusion. For more information, see [Indicator of compromise](https://en.wikipedia.org/wiki/Indicator_of_compromise).
    #[serde(default)]
    pub indicator: Option<GoogleCloudSecuritycenterV2Indicator>,
    /// IP rules associated with the finding.
    #[serde(default, rename = "ipRules")]
    pub ip_rules: Option<GoogleCloudSecuritycenterV2IpRules>,
    /// Job associated with the finding.
    #[serde(default)]
    pub job: Option<GoogleCloudSecuritycenterV2Job>,
    /// Signature of the kernel rootkit.
    #[serde(default, rename = "kernelRootkit")]
    pub kernel_rootkit: Option<GoogleCloudSecuritycenterV2KernelRootkit>,
    /// Kubernetes resources associated with the finding.
    #[serde(default)]
    pub kubernetes: Option<GoogleCloudSecuritycenterV2Kubernetes>,
    /// The load balancers associated with the finding.
    #[serde(default, rename = "loadBalancers")]
    pub load_balancers: Option<Vec<GoogleCloudSecuritycenterV2LoadBalancer>>,
    /// Log entries that are relevant to the finding.
    #[serde(default, rename = "logEntries")]
    pub log_entries: Option<Vec<GoogleCloudSecuritycenterV2LogEntry>>,
    /// MITRE ATT&CK tactics and techniques related to this finding. See: https://attack.mitre.org
    #[serde(default, rename = "mitreAttack")]
    pub mitre_attack: Option<GoogleCloudSecuritycenterV2MitreAttack>,
    /// Unique identifier of the module which generated the finding. Example: folders/598186756061/securityHealthAnalyticsSettings/customModules/56799441161885
    #[serde(default, rename = "moduleName")]
    pub module_name: Option<String>,
    /// Indicates the mute state of a finding (either muted, unmuted or undefined). Unlike other attributes of a finding, a finding provider shouldn''t set the value of mute. // TODO: enum values: ["MUTE_UNSPECIFIED", "MUTED", "UNMUTED", "UNDEFINED"]
    ...
    /// Output only. The mute information regarding this finding.
    #[serde(default, rename = "muteInfo")]
    pub mute_info: Option<GoogleCloudSecuritycenterV2MuteInfo>,
    ...
    /// Represents the VPC networks that the resource is attached to.
    #[serde(default)]
    pub networks: Option<Vec<GoogleCloudSecuritycenterV2Network>>,
    /// Steps to address the finding.
    #[serde(default, rename = "nextSteps")]
    pub next_steps: Option<String>,
    /// Notebook associated with the finding.
    #[serde(default)]
    pub notebook: Option<GoogleCloudSecuritycenterV2Notebook>,
    /// Contains information about the org policies associated with the finding.
    #[serde(default, rename = "orgPolicies")]
    pub org_policies: Option<Vec<GoogleCloudSecuritycenterV2OrgPolicy>>,
    ...
    /// PolicyViolationSummary associated with the finding.
    #[serde(default, rename = "policyViolationSummary")]
    pub policy_violation_summary: Option<GoogleCloudSecuritycenterV2PolicyViolationSummary>,
    /// Represents operating system processes associated with the Finding.
    #[serde(default)]
    pub processes: Option<Vec<GoogleCloudSecuritycenterV2Process>>,
    ...
    /// Secret associated with the finding.
    #[serde(default)]
    pub secret: Option<GoogleCloudSecuritycenterV2Secret>,
    /// Output only. User specified security marks. These marks are entirely managed by the user and come from the SecurityMarks resource that belongs to the finding.
    #[serde(default, rename = "securityMarks")]
    pub security_marks: Option<GoogleCloudSecuritycenterV2SecurityMarks>,
    /// The security posture associated with the finding.
    #[serde(default, rename = "securityPosture")]
    pub security_posture: Option<GoogleCloudSecuritycenterV2SecurityPosture>,
    /// The severity of the finding. This field is managed by the source that writes the finding. // TODO: enum values: ["SEVERITY_UNSPECIFIED", "CRITICAL", "HIGH", "MEDIUM", "LOW"]
    #[serde(default)]
    pub severity: Option<String>,
    /// Source specific properties. These properties are managed by the source that writes the finding. The key names in the source_properties map must be between 1 and 255 characters, and must start with a letter and contain alphanumeric characters or underscores only.
    ...
    /// Contains details about a group of security issues that, when the issues occur together, represent a greater risk than when the issues occur independently. A group of such issues is referred to as a toxic combination. This field cannot be updated. Its value is ignored in all update requests.
    #[serde(default, rename = "toxicCombination")]
    pub toxic_combination: Option<GoogleCloudSecuritycenterV2ToxicCombination>,
    /// VertexAi associated with the finding.
    #[serde(default, rename = "vertexAi")]
    pub vertex_ai: Option<GoogleCloudSecuritycenterV2VertexAi>,
    /// Represents vulnerability-specific fields like CVE and CVSS scores. CVE stands for Common Vulnerabilities and Exposures (https://cve.mitre.org/about/)
    #[serde(default)]
    pub vulnerability: Option<GoogleCloudSecuritycenterV2Vulnerability>,
}
...
pub struct GoogleCloudSecuritycenterV2Framework {
    ...
    /// The controls associated with the framework.
    #[serde(default)]
    pub controls: Option<Vec<GoogleCloudSecuritycenterV2Control>>,
    /// Display name of the framework. For a standard framework, this will look like e.g. PCI DSS 3.2.1, whereas for a custom framework it can be a user defined string like MyFramework
    #[serde(default, rename = "displayName")]
    pub display_name: Option<String>,
    /// Name of the framework associated with the finding
...
pub struct GoogleCloudSecuritycenterV2Indicator {
    ...
    #[serde(default)]
    pub signatures: Option<Vec<GoogleCloudSecuritycenterV2ProcessSignature>>,
...
pub struct GoogleCloudSecuritycenterV2InfoType {
    ...
    pub sensitivity_score: Option<GoogleCloudSecuritycenterV2SensitivityScore>,
...
pub struct GoogleCloudSecuritycenterV2IpRule {
    ...
    pub port_ranges: Option<Vec<GoogleCloudSecuritycenterV2PortRange>>,
...
pub struct GoogleCloudSecuritycenterV2IpRules {
    ...
    #[serde(default)]
    pub allowed: Option<GoogleCloudSecuritycenterV2Allowed>,
    /// Tuple with denied rules.
    #[serde(default)]
    pub denied: Option<GoogleCloudSecuritycenterV2Denied>,
...
pub struct GoogleCloudSecuritycenterV2Issue {
    ...
    #[serde(default)]
    pub domains: Option<Vec<GoogleCloudSecuritycenterV2IssueDomain>>,
    ...
    #[serde(default)]
    pub mute: Option<GoogleCloudSecuritycenterV2IssueMute>,
    ...
    pub primary_resource: Option<GoogleCloudSecuritycenterV2IssueResource>,
    /// The findings related to the issue.
    #[serde(default, rename = "relatedFindings")]
    pub related_findings: Option<Vec<GoogleCloudSecuritycenterV2IssueFinding>>,
    /// Approaches to remediate the issue in Markdown format.
    #[serde(default)]
    pub remediations: Option<Vec<String>>,
    /// Additional resources associated with the issue.
    #[serde(default, rename = "secondaryResources")]
    pub secondary_resources: Option<Vec<GoogleCloudSecuritycenterV2IssueResource>>,
    /// The security context of the issue.
    #[serde(default, rename = "securityContexts")]
    pub security_contexts: Option<Vec<GoogleCloudSecuritycenterV2IssueSecurityContext>>,
...
pub struct GoogleCloudSecuritycenterV2IssueFinding {
    ...
    #[serde(default)]
    pub cve: Option<GoogleCloudSecuritycenterV2IssueFindingCve>,
    /// The name of the finding.
    #[serde(default)]
    pub name: Option<String>,
    /// The security bulletin of the finding.
    #[serde(default, rename = "securityBulletin")]
    pub security_bulletin: Option<GoogleCloudSecuritycenterV2IssueFindingSecurityBulletin>,
}
...
pub struct GoogleCloudSecuritycenterV2IssueResource {
    /// The ADC application associated with the finding.
    #[serde(default, rename = "adcApplication")]
    pub adc_application: Option<GoogleCloudSecuritycenterV2IssueResourceAdcApplication>,
    /// The ADC template associated with the finding.
    #[serde(default, rename = "adcApplicationTemplate")]
    pub adc_application_template:
        Option<GoogleCloudSecuritycenterV2IssueResourceAdcApplicationTemplateRevision>,
    /// The ADC shared template associated with the finding.
    #[serde(default, rename = "adcSharedTemplate")]
    pub adc_shared_template:
        Option<GoogleCloudSecuritycenterV2IssueResourceAdcSharedTemplateRevision>,
    /// The AppHub application associated with the resource, if any. Only populated for the primary resource.
    #[serde(default)]
    pub application: Option<GoogleCloudSecuritycenterV2IssueResourceApplication>,
    /// The AWS metadata of the resource associated with the issue. Only populated for AWS resources.
    #[serde(default, rename = "awsMetadata")]
    pub aws_metadata: Option<GoogleCloudSecuritycenterV2IssueResourceAwsMetadata>,
    /// The Azure metadata of the resource associated with the issue. Only populated for Azure resources.
    #[serde(default, rename = "azureMetadata")]
    pub azure_metadata: Option<GoogleCloudSecuritycenterV2IssueResourceAzureMetadata>,
    ...
    pub google_cloud_metadata: Option<GoogleCloudSecuritycenterV2IssueResourceGoogleCloudMetadata>,
...
pub struct GoogleCloudSecuritycenterV2IssueResourceAdcApplication {
    /// Consumer provided attributes for the AppHub application.
    #[serde(default)]
    pub attributes: Option<GoogleCloudSecuritycenterV2IssueResourceApplicationAttributes>,
    /// The resource name of an ADC Application. Format: projects/{project}/locations/{location}/spaces/{space}/applications/{application}
    #[serde(default)]
    pub name: Option<String>,
}
...
pub struct GoogleCloudSecuritycenterV2IssueResourceApplicationAttributes {
    ...
    #[serde(default, rename = "businessOwners")]
    pub business_owners:
        Option<Vec<GoogleCloudSecuritycenterV2IssueResourceApplicationAttributesContactInfo>>,
    /// User-defined criticality information.
    #[serde(default)]
    pub criticality:
        Option<GoogleCloudSecuritycenterV2IssueResourceApplicationAttributesCriticality>,
    /// Developer team that owns development and coding.
    #[serde(default, rename = "developerOwners")]
    pub developer_owners:
        Option<Vec<GoogleCloudSecuritycenterV2IssueResourceApplicationAttributesContactInfo>>,
    ...
    #[serde(default)]
    pub environment:
        Option<GoogleCloudSecuritycenterV2IssueResourceApplicationAttributesEnvironment>,
    /// Operator team that ensures runtime and operations.
    #[serde(default, rename = "operatorOwners")]
    pub operator_owners:
        Option<Vec<GoogleCloudSecuritycenterV2IssueResourceApplicationAttributesContactInfo>>,
...
pub struct GoogleCloudSecuritycenterV2IssueResourceAwsMetadata {
    ...
    #[serde(default)]
    pub account: Option<GoogleCloudSecuritycenterV2IssueResourceAwsMetadataAwsAccount>,
}
...
pub struct GoogleCloudSecuritycenterV2IssueResourceAzureMetadata {
    ...
    #[serde(default)]
    pub subscription:
        Option<GoogleCloudSecuritycenterV2IssueResourceAzureMetadataAzureSubscription>,
}
...
pub struct GoogleCloudSecuritycenterV2IssueSecurityContext {
    ...
    pub aggregated_count: Option<GoogleCloudSecuritycenterV2IssueSecurityContextAggregatedCount>,
    /// The context of the security context.
    #[serde(default)]
    pub context: Option<GoogleCloudSecuritycenterV2IssueSecurityContextContext>,
}
...
pub struct GoogleCloudSecuritycenterV2Kubernetes {
    ...
    pub access_reviews: Option<Vec<GoogleCloudSecuritycenterV2AccessReview>>,
    ...
    #[serde(default)]
    pub bindings: Option<Vec<GoogleCloudSecuritycenterV2Binding>>,
    ...
    pub node_pools: Option<Vec<GoogleCloudSecuritycenterV2NodePool>>,
    /// Provides Kubernetes [node](https://cloud.google.com/kubernetes-engine/docs/concepts/cluster-architecture#nodes) information.
    #[serde(default)]
    pub nodes: Option<Vec<GoogleCloudSecuritycenterV2Node>>,
    /// Kubernetes objects related to the finding.
    #[serde(default)]
    pub objects: Option<Vec<GoogleCloudSecuritycenterV2Object>>,
    ...
    #[serde(default)]
    pub pods: Option<Vec<GoogleCloudSecuritycenterV2Pod>>,
    ...
    #[serde(default)]
    pub roles: Option<Vec<GoogleCloudSecuritycenterV2Role>>,
}
...
pub struct GoogleCloudSecuritycenterV2LogEntry {
    ...
    pub cloud_logging_entry: Option<GoogleCloudSecuritycenterV2CloudLoggingEntry>,
}
...
pub struct GoogleCloudSecuritycenterV2MemoryHashSignature {
    ...
    #[serde(default)]
    pub detections: Option<Vec<GoogleCloudSecuritycenterV2Detection>>,
}
...
pub struct GoogleCloudSecuritycenterV2MuteInfo {
    ...
    pub dynamic_mute_records: Option<Vec<GoogleCloudSecuritycenterV2DynamicMuteRecord>>,
    ...
    pub static_mute: Option<GoogleCloudSecuritycenterV2StaticMute>,
}
...
pub struct GoogleCloudSecuritycenterV2NotificationMessage {
    /// If it''s a Finding based notification config, this field will be populated.
    #[serde(default)]
    pub finding: Option<GoogleCloudSecuritycenterV2Finding>,
    /// Name of the notification config that generated current notification.
    #[serde(default, rename = "notificationConfigName")]
    pub notification_config_name: Option<String>,
    /// The Cloud resource tied to this notification''s Finding.
    #[serde(default)]
    pub resource: Option<GoogleCloudSecuritycenterV2Resource>,
}
...
pub struct GoogleCloudSecuritycenterV2Process {
    ...
    #[serde(default)]
    pub binary: Option<GoogleCloudSecuritycenterV2File>,
    /// Process environment variables.
    #[serde(default, rename = "envVariables")]
    pub env_variables: Option<Vec<GoogleCloudSecuritycenterV2EnvironmentVariable>>,
    /// True if env_variables is incomplete.
    #[serde(default, rename = "envVariablesTruncated")]
    pub env_variables_truncated: Option<bool>,
    /// File information for libraries loaded by the process.
    #[serde(default)]
    pub libraries: Option<Vec<GoogleCloudSecuritycenterV2File>>,
    ...
    #[serde(default)]
    pub script: Option<GoogleCloudSecuritycenterV2File>,
...
pub struct GoogleCloudSecuritycenterV2ProcessSignature {
    ...
    pub memory_hash_signature: Option<GoogleCloudSecuritycenterV2MemoryHashSignature>,
    ...
    pub yara_rule_signature: Option<GoogleCloudSecuritycenterV2YaraRuleSignature>,
}
...
pub struct GoogleCloudSecuritycenterV2Resource {
    /// The ADC application associated with the finding.
    #[serde(default, rename = "adcApplication")]
    pub adc_application: Option<GoogleCloudSecuritycenterV2AdcApplication>,
    /// The ADC template associated with the finding.
    #[serde(default, rename = "adcApplicationTemplate")]
    pub adc_application_template: Option<GoogleCloudSecuritycenterV2AdcApplicationTemplateRevision>,
    /// The ADC shared template associated with the finding.
    #[serde(default, rename = "adcSharedTemplate")]
    pub adc_shared_template: Option<GoogleCloudSecuritycenterV2AdcSharedTemplateRevision>,
    /// The App Hub application this resource belongs to.
    #[serde(default)]
    pub application: Option<GoogleCloudSecuritycenterV2ResourceApplication>,
    /// The AWS metadata associated with the finding.
    #[serde(default, rename = "awsMetadata")]
    pub aws_metadata: Option<GoogleCloudSecuritycenterV2AwsMetadata>,
    /// The Azure metadata associated with the finding.
    #[serde(default, rename = "azureMetadata")]
    pub azure_metadata: Option<GoogleCloudSecuritycenterV2AzureMetadata>,
    ...
    pub gcp_metadata: Option<GcpMetadata>,
    /// The region or location of the service (if applicable).
    #[serde(default)]
    pub location: Option<String>,
    /// The full resource name of the resource. See: https://cloud.google.com/apis/design/resource_names#full_resource_name
    ...
    /// Provides the path to the resource within the resource hierarchy.
    #[serde(default, rename = "resourcePath")]
    pub resource_path: Option<GoogleCloudSecuritycenterV2ResourcePath>,
    /// A string representation of the resource path. For Google Cloud, it has the format of organizations/{organization_id}/folders/{folder_id}/folders/{folder_id}/projects/{project_id} where there can be any number of folders. For AWS, it has the format of org/{organization_id}/ou/{organizational_unit_id}/ou/{organizational_unit_id}/account/{account_id} where there can be any number of organizational units. For Azure, it has the format of mg/{management_group_id}/mg/{management_group_id}/subscription/{subscription_id}/rg/{resource_group_name} where there can be any number of management groups.
    #[serde(default, rename = "resourcePathString")]
    pub resource_path_string: Option<String>,
...
pub struct GoogleCloudSecuritycenterV2ResourceApplicationAttributes {
    ...
    #[serde(default, rename = "businessOwners")]
    pub business_owners:
        Option<Vec<GoogleCloudSecuritycenterV2ResourceApplicationAttributesContactInfo>>,
    /// User-defined criticality information.
    #[serde(default)]
    pub criticality: Option<GoogleCloudSecuritycenterV2ResourceApplicationAttributesCriticality>,
    /// Developer team that owns development and coding.
    #[serde(default, rename = "developerOwners")]
    pub developer_owners:
        Option<Vec<GoogleCloudSecuritycenterV2ResourceApplicationAttributesContactInfo>>,
    /// User-defined environment information.
    #[serde(default)]
    pub environment: Option<GoogleCloudSecuritycenterV2ResourceApplicationAttributesEnvironment>,
    /// Operator team that ensures runtime and operations.
    #[serde(default, rename = "operatorOwners")]
    pub operator_owners:
        Option<Vec<GoogleCloudSecuritycenterV2ResourceApplicationAttributesContactInfo>>,
...
pub struct GoogleCloudSecuritycenterV2ResourcePath {
    ...
    #[serde(default)]
    pub nodes: Option<Vec<GoogleCloudSecuritycenterV2ResourcePathNode>>,
}
...
pub struct GoogleCloudSecuritycenterV2ResourceValueConfig {
    ...
    #[serde(default, rename = "sensitiveDataProtectionMapping")]
    pub sensitive_data_protection_mapping:
        Option<GoogleCloudSecuritycenterV2SensitiveDataProtectionMapping>,
...
pub struct GoogleCloudSecuritycenterV2Secret {
    ...
    pub environment_variable: Option<GoogleCloudSecuritycenterV2SecretEnvironmentVariable>,
    /// The file containing the secret.
    #[serde(default, rename = "filePath")]
    pub file_path: Option<GoogleCloudSecuritycenterV2SecretFilePath>,
    /// The status of the secret.
    #[serde(default)]
    pub status: Option<GoogleCloudSecuritycenterV2SecretStatus>,
...
pub struct GoogleCloudSecuritycenterV2SecurityPosture {
    ...
    pub policy_drift_details: Option<Vec<GoogleCloudSecuritycenterV2PolicyDriftDetails>>,
...
pub struct GoogleCloudSecuritycenterV2VertexAi {
    ...
    #[serde(default)]
    pub datasets: Option<Vec<GoogleCloudSecuritycenterV2Dataset>>,
    /// Pipelines associated with the finding.
    #[serde(default)]
    pub pipelines: Option<Vec<GoogleCloudSecuritycenterV2Pipeline>>,
}
...
pub struct GoogleCloudSecuritycenterV2Vulnerability {
    ...
    #[serde(default)]
    pub cve: Option<GoogleCloudSecuritycenterV2Cve>,
    /// Represents one or more Common Weakness Enumeration (CWE) information on this vulnerability.
    #[serde(default)]
    pub cwes: Option<Vec<GoogleCloudSecuritycenterV2Cwe>>,
    /// The fixed package is relevant to the finding.
    #[serde(default, rename = "fixedPackage")]
    pub fixed_package: Option<GoogleCloudSecuritycenterV2Package>,
    /// The offending package is relevant to the finding.
    #[serde(default, rename = "offendingPackage")]
    pub offending_package: Option<GoogleCloudSecuritycenterV2Package>,
    ...
    #[serde(default, rename = "securityBulletin")]
    pub security_bulletin: Option<GoogleCloudSecuritycenterV2SecurityBulletin>,
}
...
pub struct SimulatedResult {
    ...
    pub no_violation: Option<serde_json::Value>,
}
...
pub struct VulnerabilitySnapshot {
    ...
    pub finding_count: Option<VulnerabilityCountBySeverity>,
