...
pub struct BDRBackupPlanJobLog {
    ...
    pub previous_backup_rules: ::core::option::Option<::std::vec::Vec<BackupRuleDetail>>,
    ...
    pub revised_backup_rules: ::core::option::Option<::std::vec::Vec<BackupRuleDetail>>,
...
pub struct ListBackupChannelsResponse {
    ...
    pub backup_channels: ::core::option::Option<::std::vec::Vec<BackupChannel>>,
...
pub struct ListBackupPlanBindingsResponse {
    ...
    pub backup_plan_bindings: ::core::option::Option<::std::vec::Vec<BackupPlanBinding>>,
...
pub struct ListBackupPlansResponse {
    ...
    pub backup_plans: ::core::option::Option<::std::vec::Vec<BackupPlan>>,
...
pub struct ListRestoreChannelsResponse {
    ...
    pub restore_channels: ::core::option::Option<::std::vec::Vec<RestoreChannel>>,
    /// Locations that could not be reached.
    #[serde(default)]
    pub unreachable: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct ListRestorePlanBindingsResponse {
    ...
    pub restore_plan_bindings: ::core::option::Option<::std::vec::Vec<RestorePlanBinding>>,
...
pub struct ListRestorePlansResponse {
    ...
    pub restore_plans: ::core::option::Option<::std::vec::Vec<RestorePlan>>,
    /// Locations that could not be reached.
    #[serde(default)]
    pub unreachable: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct ListVolumeBackupsResponse {
    ...
    pub volume_backups: ::core::option::Option<::std::vec::Vec<VolumeBackup>>,
}
...
pub struct ListVolumeRestoresResponse {
    ...
    pub volume_restores: ::core::option::Option<::std::vec::Vec<VolumeRestore>>,
}
...
pub struct BackupPlanBinding {
    ...
    pub backup_plan_details: ::core::option::Option<BackupPlanDetails>,
...
pub struct BackupPlan {
    ...
    pub backup_schedule: ::core::option::Option<Schedule>,
...
pub struct Backup {
    ...
    pub selected_applications: ::core::option::Option<NamespacedNames>,
    ...
    pub selected_namespace_labels: ::core::option::Option<ResourceLabels>,
    /// Output only. If set, the list of namespaces that were included in the Backup.
    #[serde(default, rename = "selectedNamespaces")]
    pub selected_namespaces: ::core::option::Option<Namespaces>,
    ...
    pub troubleshooting_info: ::core::option::Option<TroubleshootingInfo>,
    /// Output only. Server generated global unique identifier of [UUID4](https://en.wikipedia.org/wiki/Universally_unique_identifier)
    #[serde(default)]
    pub uid: ::core::option::Option<String>,
...
pub struct Restore {
    ...
    pub volume_data_restore_policy_overrides:
        ::core::option::Option<::std::vec::Vec<VolumeDataRestorePolicyOverride>>,
...
pub struct BackupPlanDetails {
    ...
    pub backup_config_details: ::core::option::Option<BackupConfigDetails>,
    ...
    pub retention_policy_details: ::core::option::Option<RetentionPolicyDetails>,
    /// Output only. A number that represents the current risk level of this BackupPlan from RPO perspective with 1 being no risk and 5 being highest risk.
    #[serde(default, rename = "rpoRiskLevel")]
    pub rpo_risk_level: ::core::option::Option<i32>,
...
pub struct Schedule {
    ...
    pub rpo_config: ::core::option::Option<RpoConfig>,
}
...
pub struct Filter {
    ...
    pub exclusion_filters: ::core::option::Option<::std::vec::Vec<ResourceSelector>>,
    ...
    pub inclusion_filters: ::core::option::Option<::std::vec::Vec<ResourceSelector>>,
}
...
pub struct RestoreConfig {
    ...
    pub cluster_resource_restore_scope: ::core::option::Option<ClusterResourceRestoreScope>,
    ...
    pub excluded_namespaces: ::core::option::Option<Namespaces>,
    ...
    pub restore_order: ::core::option::Option<RestoreOrder>,
    ...
    pub substitution_rules: ::core::option::Option<::std::vec::Vec<SubstitutionRule>>,
    /// Optional. A list of transformation rules to be applied against Kubernetes resources as they are selected for restoration from a Backup. Rules are executed in order defined - this order matters, as changes made by a rule may impact the filtering logic of subsequent rules. An empty list means no transformation will occur.
    #[serde(default, rename = "transformationRules")]
    pub transformation_rules: ::core::option::Option<::std::vec::Vec<TransformationRule>>,
    ...
    pub volume_data_restore_policy_bindings:
        ::core::option::Option<::std::vec::Vec<VolumeDataRestorePolicyBinding>>,
}
...
pub struct VolumeDataRestorePolicyOverride {
    ...
    pub selected_pvcs: ::core::option::Option<NamespacedNames>,
}
...
pub struct ResourceLabels {
    ...
    pub resource_labels: ::core::option::Option<::std::vec::Vec<Label>>,
}
...
pub struct RpoConfig {
    ...
    pub exclusion_windows: ::core::option::Option<::std::vec::Vec<ExclusionWindow>>,
...
pub struct ResourceSelector {
    ...
    pub group_kind: ::core::option::Option<GroupKind>,
...
pub struct ClusterResourceRestoreScope {
    ...
    pub excluded_group_kinds: ::core::option::Option<::std::vec::Vec<GroupKind>>,
    ...
    pub selected_group_kinds: ::core::option::Option<::std::vec::Vec<GroupKind>>,
}
...
pub struct RestoreOrder {
    ...
    pub group_kind_dependencies: ::core::option::Option<::std::vec::Vec<GroupKindDependency>>,
}
...
pub struct SubstitutionRule {
    ...
    pub target_group_kinds: ::core::option::Option<::std::vec::Vec<GroupKind>>,
...
pub struct TransformationRule {
    ...
    pub field_actions: ::core::option::Option<::std::vec::Vec<TransformationRuleAction>>,
...
pub struct NamespacedNames {
    ...
    pub namespaced_names: ::core::option::Option<::std::vec::Vec<NamespacedName>>,
}
...
pub struct ExclusionWindow {
    ...
    pub days_of_week: ::core::option::Option<DayOfWeekList>,
    ...
    pub single_occurrence_date: ::core::option::Option<Date>,
...
pub struct ResourceFilter {
    ...
    pub group_kinds: ::core::option::Option<::std::vec::Vec<GroupKind>>,
...
impl ResourceIdentifier<GkebackupProjectsLocationsBackupChannelsGetArgs> for BackupChannel {
    fn generate_resource_id(
        ...
        format!("gcp::BackupChannel/{}", input.name)
    }
    ...
    for ListBackupChannelsResponse
{
    fn generate_resource_id(
        ...
        format!("gcp::ListBackupChannelsResponse/{}", input.parent)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::ListBackupChannelsResponse"
    }
    ...
    for BackupPlanBinding
{
    fn generate_resource_id(
        ...
        format!("gcp::BackupPlanBinding/{}", input.name)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::BackupPlanBinding"
    }
    ...
    for ListBackupPlanBindingsResponse
{
    fn generate_resource_id(
        ...
        format!("gcp::ListBackupPlanBindingsResponse/{}", input.parent)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::ListBackupPlanBindingsResponse"
    }
...
impl ResourceIdentifier<GkebackupProjectsLocationsBackupPlansGetArgs> for BackupPlan {
    fn generate_resource_id(&self, input: &GkebackupProjectsLocationsBackupPlansGetArgs) -> String {
        format!("gcp::BackupPlan/{}", input.name)
    }
...
impl ResourceIdentifier<GkebackupProjectsLocationsBackupPlansGetTagsArgs> for GetTagsResponse {
    fn generate_resource_id(
        ...
        format!("gcp::GetTagsResponse/{}", input.name)
    }
...
impl ResourceIdentifier<GkebackupProjectsLocationsBackupPlansListArgs> for ListBackupPlansResponse {
    fn generate_resource_id(
        ...
        format!("gcp::ListBackupPlansResponse/{}", input.parent)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::ListBackupPlansResponse"
    }
...
impl ResourceIdentifier<GkebackupProjectsLocationsBackupPlansSetTagsArgs> for SetTagsResponse {
    fn generate_resource_id(
        ...
        format!("gcp::SetTagsResponse/{}", input.name)
    }
    ...
    for GetBackupIndexDownloadUrlResponse
{
    fn generate_resource_id(
        ...
        format!("gcp::GetBackupIndexDownloadUrlResponse/{}", input.backup)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::GetBackupIndexDownloadUrlResponse"
    }
    ...
    for VolumeBackup
{
    fn generate_resource_id(
        ...
        format!("gcp::VolumeBackup/{}", input.name)
    }
    ...
    for ListVolumeBackupsResponse
{
    fn generate_resource_id(
        ...
        format!("gcp::ListVolumeBackupsResponse/{}", input.parent)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::ListVolumeBackupsResponse"
    }
...
impl ResourceIdentifier<GkebackupProjectsLocationsRestoreChannelsGetArgs> for RestoreChannel {
    fn generate_resource_id(
        ...
        format!("gcp::RestoreChannel/{}", input.name)
    }
    ...
    for ListRestoreChannelsResponse
{
    fn generate_resource_id(
        ...
        format!("gcp::ListRestoreChannelsResponse/{}", input.parent)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::ListRestoreChannelsResponse"
    }
    ...
    for RestorePlanBinding
{
    fn generate_resource_id(
        ...
        format!("gcp::RestorePlanBinding/{}", input.name)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::RestorePlanBinding"
    }
    ...
    for ListRestorePlanBindingsResponse
{
    fn generate_resource_id(
        ...
        format!("gcp::ListRestorePlanBindingsResponse/{}", input.parent)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::ListRestorePlanBindingsResponse"
    }
...
impl ResourceIdentifier<GkebackupProjectsLocationsRestorePlansGetArgs> for RestorePlan {
    fn generate_resource_id(
        ...
        format!("gcp::RestorePlan/{}", input.name)
    }
    ...
    for ListRestorePlansResponse
{
    fn generate_resource_id(
        ...
        format!("gcp::ListRestorePlansResponse/{}", input.parent)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::ListRestorePlansResponse"
    }
    ...
    for ListRestoresResponse
{
    fn generate_resource_id(
        ...
        format!("gcp::ListRestoresResponse/{}", input.parent)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::ListRestoresResponse"
    }
    ...
    for VolumeRestore
{
    fn generate_resource_id(
        ...
        format!("gcp::VolumeRestore/{}", input.name)
    }
    ...
    for ListVolumeRestoresResponse
{
    fn generate_resource_id(
        ...
        format!("gcp::ListVolumeRestoresResponse/{}", input.parent)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::ListVolumeRestoresResponse"
    }
