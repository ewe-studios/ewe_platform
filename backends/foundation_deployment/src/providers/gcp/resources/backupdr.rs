...
pub struct AlloyDBClusterDataSourceProperties {
    ...
    pub pitr_windows: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AlloyDbPitrWindow>>>,
}
...
pub struct AttachedDisk {
    ...
    pub initialize_params: ::core::option::Option<::std::boxed::Box<InitializeParams>>,
...
pub struct Backup {
    ...
    pub alloy_db_backup_properties:
        ::core::option::Option<::std::boxed::Box<AlloyDbClusterBackupProperties>>,
    /// Output only. Backup Appliance specific backup properties.
    #[serde(default, rename = "backupApplianceBackupProperties")]
    pub backup_appliance_backup_properties:
        ::core::option::Option<::std::boxed::Box<BackupApplianceBackupProperties>>,
    /// Optional. The list of BackupLocks taken by the accessor Backup Appliance.
    #[serde(default, rename = "backupApplianceLocks")]
    pub backup_appliance_locks:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<BackupLock>>>,
    ...
    pub cloud_sql_instance_backup_properties:
        ::core::option::Option<::std::boxed::Box<CloudSqlInstanceBackupProperties>>,
    /// Output only. Compute Engine specific backup properties.
    #[serde(default, rename = "computeInstanceBackupProperties")]
    pub compute_instance_backup_properties:
        ::core::option::Option<::std::boxed::Box<ComputeInstanceBackupProperties>>,
    ...
    pub disk_backup_properties: ::core::option::Option<::std::boxed::Box<DiskBackupProperties>>,
    ...
    pub filestore_instance_backup_properties:
        ::core::option::Option<::std::boxed::Box<FilestoreInstanceBackupProperties>>,
    /// Output only. Configuration for a Google Cloud resource.
    #[serde(default, rename = "gcpBackupPlanInfo")]
    pub gcp_backup_plan_info: ::core::option::Option<::std::boxed::Box<GCPBackupPlanInfo>>,
    /// Output only. Unique identifier of the GCP resource that is being backed up.
    #[serde(default, rename = "gcpResource")]
    pub gcp_resource: ::core::option::Option<::std::boxed::Box<BackupGcpResource>>,
    ...
    pub service_locks: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<BackupLock>>>,
...
pub struct BackupConfigDetails {
    ...
    pub backup_dr_plan_config: ::core::option::Option<::std::boxed::Box<BackupDrPlanConfig>>,
    /// Google Cloud Backup and DR''s Template specific data.
    #[serde(default, rename = "backupDrTemplateConfig")]
    pub backup_dr_template_config:
        ::core::option::Option<::std::boxed::Box<BackupDrTemplateConfig>>,
    /// The locations where the backups are to be stored.
    #[serde(default, rename = "backupLocations")]
    pub backup_locations:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<BackupLocation>>>,
    ...
    pub pitr_settings: ::core::option::Option<::std::boxed::Box<PitrSettings>>,
...
pub struct BackupConfigInfo {
    ...
    pub backup_appliance_backup_config:
        ::core::option::Option<::std::boxed::Box<BackupApplianceBackupConfig>>,
    /// Configuration for a Google Cloud resource.
    #[serde(default, rename = "gcpBackupConfig")]
    pub gcp_backup_config: ::core::option::Option<::std::boxed::Box<GcpBackupConfig>>,
    /// Output only. If the last backup failed, this field has the error message.
    #[serde(default, rename = "lastBackupError")]
    pub last_backup_error: ::core::option::Option<::std::boxed::Box<Status>>,
...
pub struct BackupDrPlanConfig {
    ...
    pub backup_dr_plan_rules:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<BackupDrPlanRule>>>,
}
...
pub struct BackupLock {
    ...
    pub backup_appliance_lock_info:
        ::core::option::Option<::std::boxed::Box<BackupApplianceLockInfo>>,
    ...
    pub service_lock_info: ::core::option::Option<::std::boxed::Box<ServiceLockInfo>>,
}
...
pub struct BackupPlan {
    ...
    pub backup_rules: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<BackupRule>>>,
    ...
    pub compute_instance_backup_plan_properties:
        ::core::option::Option<::std::boxed::Box<ComputeInstanceBackupPlanProperties>>,
    ...
    pub disk_backup_plan_properties:
        ::core::option::Option<::std::boxed::Box<DiskBackupPlanProperties>>,
...
pub struct BackupPlanAssociation {
    ...
    pub alloydb_cluster_backup_plan_association_properties:
        ::core::option::Option<::std::boxed::Box<AlloyDBClusterBackupPlanAssociationProperties>>,
    ...
    pub cloud_sql_instance_backup_plan_association_properties:
        ::core::option::Option<::std::boxed::Box<CloudSqlInstanceBackupPlanAssociationProperties>>,
    /// Output only. The time when the instance was created.
    #[serde(default, rename = "createTime")]
    pub create_time: ::core::option::Option<String>,
    ...
    pub filestore_instance_backup_plan_association_properties:
        ::core::option::Option<::std::boxed::Box<FilestoreInstanceBackupPlanAssociationProperties>>,
    ...
    pub rules_config_info:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<RuleConfigInfo>>>,
...
pub struct BackupPlanRevision {
    ...
    pub backup_plan_snapshot: ::core::option::Option<::std::boxed::Box<BackupPlan>>,
...
pub struct BackupRule {
    ...
    pub standard_schedule: ::core::option::Option<::std::boxed::Box<StandardSchedule>>,
}
...
pub struct ComputeInstanceBackupProperties {
    ...
    #[serde(default)]
    pub disk: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AttachedDisk>>>,
    /// A list of guest accelerator cards'' type and count to use for instances created from these properties.
    #[serde(default, rename = "guestAccelerator")]
    pub guest_accelerator:
    ...
    #[serde(default, rename = "serviceAccount")]
    pub service_account: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ServiceAccount>>>,
...
pub struct ComputeInstanceRestoreProperties {
    ...
    pub reservation_affinity: ::core::option::Option<::std::boxed::Box<AllocationAffinity>>,
...
pub struct DataSource {
    ...
    pub backup_config_info: ::core::option::Option<::std::boxed::Box<BackupConfigInfo>>,
    ...
    pub data_source_backup_appliance_application:
        ::core::option::Option<::std::boxed::Box<DataSourceBackupApplianceApplication>>,
    ...
    pub data_source_gcp_resource: ::core::option::Option<::std::boxed::Box<DataSourceGcpResource>>,
...
pub struct DataSourceGcpResource {
    ...
    pub alloy_db_cluster_datasource_properties:
        ::core::option::Option<::std::boxed::Box<AlloyDBClusterDataSourceProperties>>,
    ...
    pub cloud_sql_instance_datasource_properties:
        ::core::option::Option<::std::boxed::Box<CloudSqlInstanceDataSourceProperties>>,
    ...
    pub compute_instance_datasource_properties:
        ::core::option::Option<::std::boxed::Box<ComputeInstanceDataSourceProperties>>,
    ...
    pub disk_datasource_properties:
        ::core::option::Option<::std::boxed::Box<DiskDataSourceProperties>>,
    ...
    pub filestore_instance_datasource_properties:
        ::core::option::Option<::std::boxed::Box<FilestoreInstanceDataSourceProperties>>,
...
pub struct DataSourceGcpResourceInfo {
    ...
    pub alloy_db_cluster_properties:
        ::core::option::Option<::std::boxed::Box<AlloyDBClusterDataSourceReferenceProperties>>,
    ...
    pub cloud_sql_instance_properties:
        ::core::option::Option<::std::boxed::Box<CloudSqlInstanceDataSourceReferenceProperties>>,
    ...
    pub filestore_instance_properties:
        ::core::option::Option<::std::boxed::Box<FilestoreInstanceDataSourceReferenceProperties>>,
...
pub struct DataSourceReference {
    ...
    pub data_source_backup_config_info:
        ::core::option::Option<::std::boxed::Box<DataSourceBackupConfigInfo>>,
    ...
    pub data_source_gcp_resource_info:
        ::core::option::Option<::std::boxed::Box<DataSourceGcpResourceInfo>>,
...
pub struct FetchAccessTokenResponse {
    ...
    pub read_location: ::core::option::Option<String>,
    ...
    pub write_location: ::core::option::Option<String>,
}
...
pub struct FetchBackupPlanAssociationsForResourceTypeResponse {
    ...
    pub backup_plan_associations:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<BackupPlanAssociation>>>,
...
pub struct FetchDataSourceReferencesForResourceTypeResponse {
    ...
    pub data_source_references:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DataSourceReference>>>,
    /// A token, which can be sent as page_token to retrieve the next page. If this field is omitted, there are no subsequent pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct FetchMsComplianceMetadataResponse {
    ...
    pub is_assured_workload: ::core::option::Option<bool>,
}
...
pub struct GoogleCloudBackupdrV1OperationMetadata {
    ...
    pub additional_info: ::core::option::Option<serde_json::Value>,
...
pub struct InitializeServiceRequest {
    ...
    pub backup_plan_location: ::core::option::Option<String>,
    ...
    pub cloud_sql_instance_initialization_config:
        ::core::option::Option<::std::boxed::Box<CloudSqlInstanceInitializationConfig>>,
    /// Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
    #[serde(default, rename = "requestId")]
    pub request_id: ::core::option::Option<String>,
...
pub struct InitiateBackupResponse {
    ...
    pub base_backup_generation_id: ::core::option::Option<i32>,
    /// The generation id of the new backup.
    #[serde(default, rename = "newBackupGenerationId")]
    pub new_backup_generation_id: ::core::option::Option<i32>,
}
...
pub struct ListBackupPlanRevisionsResponse {
    ...
    pub backup_plan_revisions:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<BackupPlanRevision>>>,
...
pub struct ListManagementServersResponse {
    ...
    pub management_servers:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ManagementServer>>>,
    /// A token identifying a page of results the server should return.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// Locations that could not be reached.
...
pub struct ListResourceBackupConfigsResponse {
    ...
    pub resource_backup_configs:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ResourceBackupConfig>>>,
}
...
pub struct ManagementServer {
    ...
    pub ba_proxy_uri: ::core::option::Option<::std::vec::Vec<String>>,
    /// Output only. The time when the instance was created.
    #[serde(default, rename = "createTime")]
    pub create_time: ::core::option::Option<String>,
    ...
    pub management_uri: ::core::option::Option<::std::boxed::Box<ManagementURI>>,
    ...
    pub workforce_identity_based_management_uri:
        ::core::option::Option<::std::boxed::Box<WorkforceIdentityBasedManagementURI>>,
    /// Output only. The OAuth client IDs for both types of user i.e. 1p and 3p.
    #[serde(default, rename = "workforceIdentityBasedOauth2ClientId")]
    pub workforce_identity_based_oauth2_client_id:
        ::core::option::Option<::std::boxed::Box<WorkforceIdentityBasedOAuth2ClientID>>,
}
...
pub struct ManagementURI {
    ...
    #[serde(default)]
    pub api: ::core::option::Option<String>,
...
pub struct Metadata {
    ...
    #[serde(default)]
    pub items: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Entry>>>,
}
...
pub struct ResourceBackupConfig {
    ...
    pub backup_configs_details:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<BackupConfigDetails>>>,
...
pub struct RestoreBackupRequest {
    ...
    pub compute_instance_restore_properties:
        ::core::option::Option<::std::boxed::Box<ComputeInstanceRestoreProperties>>,
    /// Compute Engine target environment to be used during restore.
    #[serde(default, rename = "computeInstanceTargetEnvironment")]
    pub compute_instance_target_environment:
        ::core::option::Option<::std::boxed::Box<ComputeInstanceTargetEnvironment>>,
    /// Disk properties to be overridden during restore.
    #[serde(default, rename = "diskRestoreProperties")]
    pub disk_restore_properties: ::core::option::Option<::std::boxed::Box<DiskRestoreProperties>>,
    /// Disk target environment to be used during restore.
    #[serde(default, rename = "diskTargetEnvironment")]
    pub disk_target_environment: ::core::option::Option<::std::boxed::Box<DiskTargetEnvironment>>,
    /// Region disk target environment to be used during restore.
    #[serde(default, rename = "regionDiskTargetEnvironment")]
    pub region_disk_target_environment:
        ::core::option::Option<::std::boxed::Box<RegionDiskTargetEnvironment>>,
    /// Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes after the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
    #[serde(default, rename = "requestId")]
    pub request_id: ::core::option::Option<String>,
}
...
pub struct RestoreBackupResponse {
    ...
    #[serde(default, rename = "targetResource")]
    pub target_resource: ::core::option::Option<::std::boxed::Box<TargetResource>>,
}
...
pub struct Scheduling {
    ...
    pub local_ssd_recovery_timeout: ::core::option::Option<::std::boxed::Box<SchedulingDuration>>,
...
pub struct StandardSchedule {
    ...
    pub backup_window: ::core::option::Option<::std::boxed::Box<BackupWindow>>,
    ...
    pub hourly_frequency: ::core::option::Option<i32>,
    ...
    pub week_day_of_month: ::core::option::Option<::std::boxed::Box<WeekDayOfMonth>>,
}
...
pub struct TargetResource {
    ...
    #[serde(default, rename = "gcpResource")]
    pub gcp_resource: ::core::option::Option<::std::boxed::Box<GcpResource>>,
}
