...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/dataform/openapi.json`.
...
pub struct ActionLoadConfig {
    ...
    #[serde(default)]
    pub maximum: ::core::option::Option<::std::boxed::Box<ActionIncrementalLoadMode>>,
    ...
    #[serde(default)]
    pub unique: ::core::option::Option<::std::boxed::Box<ActionIncrementalLoadMode>>,
}
...
pub struct ActionSqlDefinition {
    ...
    pub error_table: ::core::option::Option<::std::boxed::Box<ActionErrorTable>>,
    /// Load configuration.
    #[serde(default, rename = "loadConfig")]
    pub load_config: ::core::option::Option<::std::boxed::Box<ActionLoadConfig>>,
...
pub struct Assertion {
    ...
    pub dependency_targets: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Target>>>,
    ...
    pub parent_action: ::core::option::Option<::std::boxed::Box<Target>>,
    /// Descriptor for the assertion''s automatically-generated view and its columns.
    #[serde(default, rename = "relationDescriptor")]
    pub relation_descriptor: ::core::option::Option<::std::boxed::Box<RelationDescriptor>>,
...
pub struct CodeCompilationConfig {
    ...
    pub default_notebook_runtime_options:
        ::core::option::Option<::std::boxed::Box<NotebookRuntimeOptions>>,
...
pub struct CommitLogEntry {
    ...
    #[serde(default)]
    pub author: ::core::option::Option<::std::boxed::Box<CommitAuthor>>,
...
pub struct CommitRepositoryChangesRequest {
    ...
    pub commit_metadata: ::core::option::Option<::std::boxed::Box<CommitMetadata>>,
...
pub struct CompilationError {
    ...
    pub action_target: ::core::option::Option<::std::boxed::Box<Target>>,
...
pub struct CompilationResult {
    ...
    pub code_compilation_config: ::core::option::Option<::std::boxed::Box<CodeCompilationConfig>>,
    /// Output only. Errors encountered during project compilation.
    #[serde(default, rename = "compilationErrors")]
    pub compilation_errors:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<CompilationError>>>,
    ...
    pub data_encryption_state: ::core::option::Option<::std::boxed::Box<DataEncryptionState>>,
    ...
    pub private_resource_metadata:
        ::core::option::Option<::std::boxed::Box<PrivateResourceMetadata>>,
...
pub struct CompilationResultAction {
    ...
    #[serde(default)]
    pub assertion: ::core::option::Option<::std::boxed::Box<Assertion>>,
    ...
    pub canonical_target: ::core::option::Option<::std::boxed::Box<Target>>,
    /// The data preparation executed by this action.
    #[serde(default, rename = "dataPreparation")]
    pub data_preparation: ::core::option::Option<::std::boxed::Box<DataPreparation>>,
    /// The declaration declared by this action.
    #[serde(default)]
    pub declaration: ::core::option::Option<::std::boxed::Box<Declaration>>,
    ...
    #[serde(default)]
    pub operations: ::core::option::Option<::std::boxed::Box<Operations>>,
    /// The database relation created/updated by this action.
    #[serde(default)]
    pub relation: ::core::option::Option<::std::boxed::Box<Relation>>,
...
pub struct DataPreparation {
    ...
    pub contents_sql: ::core::option::Option<::std::boxed::Box<SqlDefinition>>,
...
pub struct DataPreparationAction {
    /// SQL definition for a Data Preparation. Contains a SQL query and additional context information.
    #[serde(default, rename = "contentsSql")]
    pub contents_sql: ::core::option::Option<::std::boxed::Box<ActionSqlDefinition>>,
...
pub struct DirectoryEntry {
    ...
    /// Entry with metadata.
    #[serde(default)]
    pub metadata: ::core::option::Option<::std::boxed::Box<FilesystemEntryMetadata>>,
}
...
pub struct FetchFileGitStatusesResponse {
    ...
    pub uncommitted_file_changes:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<UncommittedFileChange>>>,
}
...
pub struct FetchRepositoryHistoryResponse {
    ...
    #[serde(default)]
    pub commits: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<CommitLogEntry>>>,
...
pub struct FileOperation {
    ...
    pub write_file: ::core::option::Option<::std::boxed::Box<WriteFile>>,
}
...
pub struct GitRemoteSettings {
    ...
    pub ssh_authentication_config:
        ::core::option::Option<::std::boxed::Box<SshAuthenticationConfig>>,
...
pub struct IamPolicyOverrideView {
    ...
    pub iam_policy_name: ::core::option::Option<::std::boxed::Box<PolicyName>>,
...
pub struct InvocationConfig {
    ...
    pub included_targets: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Target>>>,
...
pub struct ListCompilationResultsResponse {
    ...
    pub compilation_results:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<CompilationResult>>>,
    /// A token, which can be sent as page_token to retrieve the next page. If this field is omitted, there are no subsequent pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
...
pub struct ListReleaseConfigsResponse {
    ...
    pub release_configs: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ReleaseConfig>>>,
    /// Locations which could not be reached.
    #[serde(default)]
    pub unreachable: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct ListWorkflowConfigsResponse {
    ...
    pub workflow_configs:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<WorkflowConfig>>>,
}
...
pub struct ListWorkflowInvocationsResponse {
    ...
    pub workflow_invocations:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<WorkflowInvocation>>>,
}
...
pub struct ListWorkspacesResponse {
    ...
    /// List of workspaces.
    #[serde(default)]
    pub workspaces: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Workspace>>>,
}
...
pub struct LoadConfig {
    ...
    /// Insert records where the value exceeds the previous maximum value for a column in the destination table
    #[serde(default)]
    pub maximum: ::core::option::Option<::std::boxed::Box<IncrementalLoadMode>>,
    /// Replace destination table
    #[serde(default)]
    pub replace: ::core::option::Option<serde_json::Value>,
    /// Insert records where the value of a column is not already present in the destination table
    #[serde(default)]
    pub unique: ::core::option::Option<::std::boxed::Box<IncrementalLoadMode>>,
}
...
pub struct QueryCompilationResultActionsResponse {
    ...
    pub compilation_result_actions:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<CompilationResultAction>>>,
    /// A token, which can be sent as page_token to retrieve the next page. If this field is omitted, there are no subsequent pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct QueryDirectoryContentsResponse {
    ...
    pub directory_entries:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DirectoryEntry>>>,
    /// A token, which can be sent as page_token to retrieve the next page. If this field is omitted, there are no subsequent pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct QueryFolderContentsResponse {
    ...
    #[serde(default)]
    pub entries: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<FolderContentsEntry>>>,
    /// A token, which can be sent as page_token to retrieve the next page. If this field is omitted, there are no subsequent pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct QueryTeamFolderContentsResponse {
    ...
    #[serde(default)]
    pub entries:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TeamFolderContentsEntry>>>,
    /// A token, which can be sent as page_token to retrieve the next page. If this field is omitted, there are no subsequent pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct QueryUserRootContentsResponse {
    /// List of entries in the folder.
    #[serde(default)]
    pub entries: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<RootContentsEntry>>>,
    /// A token, which can be sent as page_token to retrieve the next page. If this field is omitted, there are no subsequent pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct QueryWorkflowInvocationActionsResponse {
    ...
    pub workflow_invocation_actions:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<WorkflowInvocationAction>>>,
}
...
pub struct Relation {
    ...
    pub incremental_table_config: ::core::option::Option<::std::boxed::Box<IncrementalTableConfig>>,
...
pub struct RelationDescriptor {
    ...
    #[serde(default)]
    pub columns: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ColumnDescriptor>>>,
...
pub struct ReleaseConfig {
    ...
    pub recent_scheduled_release_records:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ScheduledReleaseRecord>>>,
...
pub struct Repository {
    ...
    pub git_remote_settings: ::core::option::Option<::std::boxed::Box<GitRemoteSettings>>,
    /// Output only. All the metadata information that is used internally to serve the resource. For example: timestamps, flags, status fields, etc. The format of this field is a JSON string.
    #[serde(default, rename = "internalMetadata")]
    pub internal_metadata: ::core::option::Option<String>,
    ...
    pub workspace_compilation_overrides:
        ::core::option::Option<::std::boxed::Box<WorkspaceCompilationOverrides>>,
}
...
pub struct ScheduledExecutionRecord {
    ...
    pub error_status: ::core::option::Option<::std::boxed::Box<Status>>,
...
pub struct SearchFilesResponse {
    ...
    pub search_results: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SearchResult>>>,
}
...
pub struct SearchResult {
    ...
    #[serde(default)]
    pub directory: ::core::option::Option<::std::boxed::Box<DirectorySearchResult>>,
    /// Details when search result is a file.
    #[serde(default)]
    pub file: ::core::option::Option<::std::boxed::Box<FileSearchResult>>,
}
...
pub struct SearchTeamFoldersResponse {
    ...
    #[serde(default)]
    pub results: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TeamFolderSearchResult>>>,
}
...
pub struct SqlDefinition {
    /// Error table configuration,
    #[serde(default, rename = "errorTable")]
    pub error_table: ::core::option::Option<::std::boxed::Box<ErrorTable>>,
    /// Load configuration.
    #[serde(default)]
    pub load: ::core::option::Option<::std::boxed::Box<LoadConfig>>,
    /// The SQL query representing the data preparation steps. Formatted as a Pipe SQL query statement.
    #[serde(default)]
    pub query: ::core::option::Option<String>,
}
...
pub struct TeamFolderSearchResult {
    ...
    pub team_folder: ::core::option::Option<::std::boxed::Box<TeamFolder>>,
}
...
pub struct WorkflowConfig {
    ...
    pub invocation_config: ::core::option::Option<::std::boxed::Box<InvocationConfig>>,
    ...
    pub recent_scheduled_execution_records:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ScheduledExecutionRecord>>>,
...
pub struct WorkflowInvocation {
    ...
    pub invocation_timing: ::core::option::Option<::std::boxed::Box<Interval>>,
...
pub struct WorkflowInvocationAction {
    ...
    pub bigquery_action: ::core::option::Option<::std::boxed::Box<BigQueryAction>>,
    ...
    pub data_preparation_action: ::core::option::Option<::std::boxed::Box<DataPreparationAction>>,
    ...
    pub notebook_action: ::core::option::Option<::std::boxed::Box<NotebookAction>>,
