//! Auto-generated resource types for Google Cloud Platform - serviceusage.
//!
...
pub struct AddEnableRulesResponse {
    ...
    #[serde(default, rename = "addedValues")]
    pub added_values: ::core::option::Option<::std::vec::Vec<String>>,
...
#[derive(Debug, Clone, Serialize, Deserialize, JsonHash)]
pub struct AnalyzeConsumerPolicyResponse {
    ...
    #[serde(default)]
    pub analysis: ::core::option::Option<::std::vec::Vec<Analysis>>,
}
...
pub struct BatchEnableServicesRequest {
    ...
    pub service_ids: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct BatchEnableServicesResponse {
    ...
    #[serde(default)]
    pub failures: ::core::option::Option<::std::vec::Vec<EnableFailure>>,
...
pub struct ConsumerPolicy {
    ...
    pub enable_rules: ::core::option::Option<::std::vec::Vec<EnableRule>>,
...
pub struct ContentSecurityPolicy {
    ...
    #[serde(default, rename = "mcpContentSecurity")]
    pub mcp_content_security: ::core::option::Option<ContentSecurity>,
...
pub struct DisableServiceRequest {
    /// Defines the behavior for checking service usage when disabling a service. // TODO: enum values: ["CHECK_IF_SERVICE_HAS_USAGE_UNSPECIFIED", "SKIP", "CHECK"]
    #[serde(default, rename = "checkIfServiceHasUsage")]
    pub check_if_service_has_usage: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "disableDependentServices")]
    pub disable_dependent_services: ::core::option::Option<bool>,
}
...
pub struct GetServiceIdentityResponse {
    ...
    /// Service identity state. // TODO: enum values: ["IDENTITY_STATE_UNSPECIFIED", "ACTIVE"]
    #[serde(default)]
...
pub struct GoogleApiServiceusageV1beta1GetServiceIdentityResponse {
    /// Service identity that service producer can use to access consumer resources. If exists is true, it contains email and unique_id. If exists is false, it contains pre-constructed email and empty unique_id.
    #[serde(default)]
    pub identity: ::core::option::Option<GoogleApiServiceusageV1beta1ServiceIdentity>,
    /// Service identity state. // TODO: enum values: ["IDENTITY_STATE_UNSPECIFIED", "ACTIVE"]
    #[serde(default)]
    pub state: ::core::option::Option<String>,
}
...
/// Consumer Policy is a set of rules that define what services or service groups can be used for a cloud resource hierarchy.
#[derive(Debug, Clone, Serialize, Deserialize, JsonHash)]
pub struct GoogleApiServiceusageV2alphaConsumerPolicy {
    /// Optional. Annotations is an unstructured key-value map stored with a policy that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. [AIP-128](https://google.aip.dev/128#annotations)
    #[serde(default)]
    pub annotations: ::core::option::Option<serde_json::Value>,
    ...
    #[serde(default, rename = "enableRules")]
    pub enable_rules:
        ::core::option::Option<::std::vec::Vec<GoogleApiServiceusageV2alphaEnableRule>>,
...
pub struct GoogleApiServiceusageV2betaAnalyzeConsumerPolicyResponse {
    /// The list of analyses returned from performing the intended policy update analysis. The analysis is grouped by service name and different analysis types. The empty analysis list means that the consumer policy can be updated without any warnings or blockers.
    #[serde(default)]
    pub analysis: ::core::option::Option<::std::vec::Vec<GoogleApiServiceusageV2betaAnalysis>>,
}

/// Consumer Policy is a set of rules that define what services or service groups can be used for a cloud resource hierarchy.
#[derive(Debug, Clone, Serialize, Deserialize, JsonHash)]
pub struct GoogleApiServiceusageV2betaConsumerPolicy {
    /// Output only. The time the policy was created. For singleton policies, this is the first touch of the policy.
    #[serde(default, rename = "createTime")]
    pub create_time: ::core::option::Option<String>,
    /// Enable rules define usable services, groups, and categories. There can currently be at most one EnableRule. This restriction will be lifted in later releases.
    #[serde(default, rename = "enableRules")]
    pub enable_rules:
        ::core::option::Option<::std::vec::Vec<GoogleApiServiceusageV2betaEnableRule>>,
    /// An opaque tag indicating the current version of the policy, used for concurrency control.
    #[serde(default)]
    pub etag: ::core::option::Option<String>,
    /// Output only. The resource name of the policy. Only the default policy is supported: projects/12345/consumerPolicies/default, folders/12345/consumerPolicies/default, organizations/12345/consumerPolicies/default.
...
#[derive(Debug, Clone, Serialize, Deserialize, JsonHash)]
pub struct GoogleApiServiceusageV2betaMcpPolicy {
    ...
    #[serde(default, rename = "mcpEnableRules")]
    pub mcp_enable_rules:
        ::core::option::Option<::std::vec::Vec<GoogleApiServiceusageV2betaMcpEnableRule>>,
...
pub struct Analysis {
    ...
    #[serde(default)]
    pub analysis: ::core::option::Option<AnalysisResult>,
    /// Output only. The type of analysis. // TODO: enum values: ["ANALYSIS_TYPE_UNSPECIFIED", "ANALYSIS_TYPE_DEPENDENCY", "ANALYSIS_TYPE_RESOURCE_USAGE", "ANALYSIS_TYPE_RESOURCE_EXISTENCE"]
    #[serde(default, rename = "analysisType")]
    pub analysis_type: ::core::option::Option<String>,
...
pub struct EnableRule {
    /// Client and resource project enable type. // TODO: enum values: ["ENABLE_TYPE_UNSPECIFIED", "CLIENT", "RESOURCE", "V1_COMPATIBLE"]
    #[serde(default, rename = "enableType")]
    pub enable_type: ::core::option::Option<String>,
...
pub struct ContentSecurity {
    ...
    #[serde(default, rename = "contentSecurityProviders")]
    pub content_security_providers:
        ::core::option::Option<::std::vec::Vec<ContentSecurityProvider>>,
}
...
#[derive(Debug, Clone, Serialize, Deserialize, JsonHash)]
pub struct GoogleApiServiceusageV2alphaEnableRule {
...
/// A message to group the analysis information.
#[derive(Debug, Clone, Serialize, Deserialize, JsonHash)]
pub struct GoogleApiServiceusageV2betaAnalysis {
    /// Output only. Analysis result of updating a policy.
    #[serde(default, rename = "analysisResult")]
    pub analysis_result: ::core::option::Option<GoogleApiServiceusageV2betaAnalysisResult>,
    /// Output only. The type of analysis. // TODO: enum values: ["ANALYSIS_TYPE_UNSPECIFIED", "ANALYSIS_TYPE_DEPENDENCY", "ANALYSIS_TYPE_RESOURCE_USAGE"]
    #[serde(default, rename = "analysisType")]
    pub analysis_type: ::core::option::Option<String>,
    /// Output only. The user friendly display name of the analysis type. E.g. service dependency analysis, service resource usage analysis, etc.
    #[serde(default, rename = "displayName")]
...
/// The consumer policy rule that defines enabled services, groups, and categories.
#[derive(Debug, Clone, Serialize, Deserialize, JsonHash)]
pub struct GoogleApiServiceusageV2betaEnableRule {
    /// The names of the services that are enabled. Example: services/storage.googleapis.com.
    #[serde(default)]
    pub services: ::core::option::Option<::std::vec::Vec<String>>,
}
...
#[derive(Debug, Clone, Serialize, Deserialize, JsonHash)]
pub struct GoogleApiServiceusageV2betaMcpEnableRule {
    /// List of enabled MCP services.
    #[serde(default, rename = "mcpServices")]
    pub mcp_services:
        ::core::option::Option<::std::vec::Vec<GoogleApiServiceusageV2betaMcpService>>,
}
...
pub struct GoogleApiServiceusageV1Service {
    ...
    #[serde(default)]
    pub config: ::core::option::Option<GoogleApiServiceusageV1ServiceConfig>,
    ...
    #[serde(default)]
    pub parent: ::core::option::Option<String>,
    /// Whether or not the service has been enabled for use by the consumer. // TODO: enum values: ["STATE_UNSPECIFIED", "DISABLED", "ENABLED"]
    #[serde(default)]
    pub state: ::core::option::Option<String>,
}
...
/// An analysis result including blockers and warnings.
#[derive(Debug, Clone, Serialize, Deserialize, JsonHash)]
pub struct GoogleApiServiceusageV2betaAnalysisResult {
    /// Blocking information that would prevent the policy changes at runtime.
    #[serde(default)]
    pub blockers: ::core::option::Option<::std::vec::Vec<GoogleApiServiceusageV2betaImpact>>,
    /// Warning information indicating that the policy changes might be unsafe, but will not block the changes at runtime.
    #[serde(default)]
    pub warnings: ::core::option::Option<::std::vec::Vec<GoogleApiServiceusageV2betaImpact>>,
}

/// McpService contains the service names that are enabled for MCP.
#[derive(Debug, Clone, Serialize, Deserialize, JsonHash)]
pub struct GoogleApiServiceusageV2betaMcpService {
...
pub struct Impact {
    ...
    /// Output only. The type of impact. // TODO: enum values: ["IMPACT_TYPE_UNSPECIFIED", "DEPENDENCY_MISSING_DEPENDENCIES", "RESOURCE_EXISTENCE_PROJECT"]
    #[serde(default, rename = "impactType")]
    pub impact_type: ::core::option::Option<String>,
...
/// A message to group impacts of updating a policy.
#[derive(Debug, Clone, Serialize, Deserialize, JsonHash)]
pub struct GoogleApiServiceusageV2betaImpact {
    /// Output only. User friendly impact detail in a free form message.
    #[serde(default)]
    pub detail: ::core::option::Option<String>,
    /// Output only. The type of impact. // TODO: enum values: ["IMPACT_TYPE_UNSPECIFIED", "DEPENDENCY_MISSING_DEPENDENCIES"]
    #[serde(default, rename = "impactType")]
    pub impact_type: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "missingDependency")]
    pub missing_dependency: ::core::option::Option<String>,
}
