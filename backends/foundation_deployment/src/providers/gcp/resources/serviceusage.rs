...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/serviceusage/openapi.json`.
...
pub struct Analysis {
    ...
    #[serde(default)]
    pub analysis: ::core::option::Option<::std::boxed::Box<AnalysisResult>>,
...
pub struct AnalysisResult {
    ...
    #[serde(default)]
    pub blockers: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Impact>>>,
    /// Warning information indicating that the policy changes might be unsafe, but will not block the changes at runtime.
    #[serde(default)]
    pub warnings: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Impact>>>,
}
...
pub struct AnalyzeConsumerPolicyResponse {
    ...
    #[serde(default)]
    pub analysis: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Analysis>>>,
}
...
pub struct BatchCreateAdminOverridesResponse {
    ...
    #[serde(default)]
    pub overrides: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<QuotaOverride>>>,
}
...
pub struct BatchEnableServicesResponse {
    ...
    #[serde(default)]
    pub failures: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<EnableFailure>>>,
    /// The new state of the services after enabling.
    #[serde(default)]
    pub services:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleApiServiceusageV1Service>>>,
}
...
pub struct ConsumerPolicy {
    ...
    pub enable_rules: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<EnableRule>>>,
...
pub struct ContentSecurity {
    ...
    pub content_security_providers:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ContentSecurityProvider>>>,
}
...
pub struct ContentSecurityPolicy {
    ...
    pub mcp_content_security: ::core::option::Option<::std::boxed::Box<ContentSecurity>>,
...
pub struct DisableServiceResponse {
    ...
    #[serde(default)]
    pub service: ::core::option::Option<::std::boxed::Box<GoogleApiServiceusageV1Service>>,
}
...
pub struct GoogleApiServiceusageV1Service {
    ...
    #[serde(default)]
    pub config: ::core::option::Option<::std::boxed::Box<GoogleApiServiceusageV1ServiceConfig>>,
...
pub struct GoogleApiServiceusageV1beta1GetServiceIdentityResponse {
    ...
    #[serde(default)]
    pub identity:
        ::core::option::Option<::std::boxed::Box<GoogleApiServiceusageV1beta1ServiceIdentity>>,
    /// Service identity state. // TODO: enum values: ["IDENTITY_STATE_UNSPECIFIED", "ACTIVE"]
    #[serde(default)]
    pub state: ::core::option::Option<String>,
}
...
pub struct GoogleApiServiceusageV2alphaConsumerPolicy {
    ...
    #[serde(default, rename = "enableRules")]
    pub enable_rules: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleApiServiceusageV2alphaEnableRule>>,
    >,
...
pub struct GoogleApiServiceusageV2betaAnalysis {
    ...
    pub analysis_result:
        ::core::option::Option<::std::boxed::Box<GoogleApiServiceusageV2betaAnalysisResult>>,
...
pub struct GoogleApiServiceusageV2betaAnalysisResult {
    ...
    pub blockers: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleApiServiceusageV2betaImpact>>,
    >,
    /// Warning information indicating that the policy changes might be unsafe, but will not block the changes at runtime.
    #[serde(default)]
...
pub struct GoogleApiServiceusageV2betaAnalyzeConsumerPolicyResponse {
    /// The list of analyses returned from performing the intended policy update analysis. The analysis is grouped by service name and different analysis types. The empty analysis list means that the consumer policy can be updated without any warnings or blockers.
    #[serde(default)]
    pub analysis: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleApiServiceusageV2betaAnalysis>>,
    >,
}
...
pub struct GoogleApiServiceusageV2betaConsumerPolicy {
    ...
    #[serde(default, rename = "enableRules")]
    pub enable_rules: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleApiServiceusageV2betaEnableRule>>,
    >,
    /// An opaque tag indicating the current version of the policy, used for concurrency control.
    #[serde(default)]
    pub etag: ::core::option::Option<String>,
...
pub struct GoogleApiServiceusageV2betaMcpEnableRule {
    ...
    pub mcp_services: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleApiServiceusageV2betaMcpService>>,
    >,
}
...
pub struct GoogleApiServiceusageV2betaMcpPolicy {
    ...
    pub mcp_enable_rules: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleApiServiceusageV2betaMcpEnableRule>>,
    >,
...
pub struct ImportAdminQuotaPoliciesResponse {
    ...
    #[serde(default)]
    pub policies: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AdminQuotaPolicy>>>,
}
