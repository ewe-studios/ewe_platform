...
pub struct AddEnableRulesResponse {
    ...
    pub added_values: Option<Vec<String>>,
...
pub struct BatchCreateAdminOverridesResponse {
    ...
    #[serde(default)]
    pub overrides: Option<Vec<QuotaOverride>>,
}
...
pub struct BatchEnableServicesResponse {
    ...
    #[serde(default)]
    pub failures: Option<Vec<EnableFailure>>,
...
pub struct ConsumerPolicy {
    ...
    pub enable_rules: Option<Vec<EnableRule>>,
...
pub struct ContentSecurity {
    ...
    pub content_security_providers: Option<Vec<ContentSecurityProvider>>,
}
...
pub struct ContentSecurityPolicy {
    ...
    pub mcp_content_security: Option<ContentSecurity>,
...
pub struct DisableServiceResponse {
    ...
    #[serde(default)]
    pub service: Option<GoogleApiServiceusageV1Service>,
}
...
pub struct GoogleApiServiceusageV1beta1GetServiceIdentityResponse {
    /// Service identity that service producer can use to access consumer resources. If exists is true, it contains email and unique_id. If exists is false, it contains pre-constructed email and empty unique_id.
    #[serde(default)]
    pub identity: Option<GoogleApiServiceusageV1beta1ServiceIdentity>,
    /// Service identity state. // TODO: enum values: ["IDENTITY_STATE_UNSPECIFIED", "ACTIVE"]
    #[serde(default)]
    pub state: Option<String>,
}
...
pub struct GoogleApiServiceusageV2alphaConsumerPolicy {
    ...
    #[serde(default, rename = "enableRules")]
    pub enable_rules: Option<Vec<GoogleApiServiceusageV2alphaEnableRule>>,
...
pub struct GoogleApiServiceusageV2betaAnalysis {
    ...
    pub analysis_result: Option<GoogleApiServiceusageV2betaAnalysisResult>,
...
pub struct GoogleApiServiceusageV2betaAnalysisResult {
    /// Blocking information that would prevent the policy changes at runtime.
    #[serde(default)]
    pub blockers: Option<Vec<GoogleApiServiceusageV2betaImpact>>,
    /// Warning information indicating that the policy changes might be unsafe, but will not block the changes at runtime.
    #[serde(default)]
    pub warnings: Option<Vec<GoogleApiServiceusageV2betaImpact>>,
}
...
pub struct GoogleApiServiceusageV2betaAnalyzeConsumerPolicyResponse {
    /// The list of analyses returned from performing the intended policy update analysis. The analysis is grouped by service name and different analysis types. The empty analysis list means that the consumer policy can be updated without any warnings or blockers.
    #[serde(default)]
    pub analysis: Option<Vec<GoogleApiServiceusageV2betaAnalysis>>,
}
...
pub struct GoogleApiServiceusageV2betaConsumerPolicy {
    ...
    /// Enable rules define usable services, groups, and categories. There can currently be at most one EnableRule. This restriction will be lifted in later releases.
    #[serde(default, rename = "enableRules")]
    pub enable_rules: Option<Vec<GoogleApiServiceusageV2betaEnableRule>>,
    /// An opaque tag indicating the current version of the policy, used for concurrency control.
    #[serde(default)]
    pub etag: Option<String>,
    /// Output only. The resource name of the policy. Only the default policy is supported: projects/12345/consumerPolicies/default, folders/12345/consumerPolicies/default, organizations/12345/consumerPolicies/default.
...
pub struct GoogleApiServiceusageV2betaMcpEnableRule {
    ...
    pub mcp_services: Option<Vec<GoogleApiServiceusageV2betaMcpService>>,
}
...
pub struct GoogleApiServiceusageV2betaMcpPolicy {
    ...
    pub mcp_enable_rules: Option<Vec<GoogleApiServiceusageV2betaMcpEnableRule>>,
...
pub struct ImportAdminQuotaPoliciesResponse {
    ...
    #[serde(default)]
    pub policies: Option<Vec<AdminQuotaPolicy>>,
}
...
pub struct QuotaOverride {
    ...
    pub admin_override_ancestor: Option<String>,
...
pub struct RemoveEnableRulesResponse {
    ...
    pub removed_values: Option<Vec<String>>,
}
