//! Auto-generated resource types for Google Cloud Platform - safebrowsing.
//!
//! This file is generated by `cargo run --bin ewe_platform gen_resource_types`.
//! DO NOT EDIT MANUALLY.
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/safebrowsing/openapi.json`.
...
pub struct GoogleSecuritySafebrowsingV5BatchGetHashListsResponse {
    ...
    pub hash_lists: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleSecuritySafebrowsingV5HashList>>,
    >,
}
...
pub struct GoogleSecuritySafebrowsingV5FullHash {
    ...
    pub full_hash: ::core::option::Option<String>,
    /// Unordered list. A repeated field identifying the details relevant to this full hash.
    #[serde(default, rename = "fullHashDetails")]
    pub full_hash_details: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleSecuritySafebrowsingV5FullHashFullHashDetail>>,
    >,
}
...
pub struct GoogleSecuritySafebrowsingV5FullHashFullHashDetail {
    ...
    /// The type of threat. This field will never be empty. // TODO: enum values: ["THREAT_TYPE_UNSPECIFIED", "MALWARE", "SOCIAL_ENGINEERING", "UNWANTED_SOFTWARE", "POTENTIALLY_HARMFUL_APPLICATION"]
    #[serde(default, rename = "threatType")]
    pub threat_type: ::core::option::Option<String>,
}
...
pub struct GoogleSecuritySafebrowsingV5HashList {
    ...
    pub additions_eight_bytes: ::core::option::Option<
        ::std::boxed::Box<GoogleSecuritySafebrowsingV5RiceDeltaEncoded64Bit>,
    >,
    /// The 4-byte additions.
    #[serde(default, rename = "additionsFourBytes")]
    pub additions_four_bytes: ::core::option::Option<
        ::std::boxed::Box<GoogleSecuritySafebrowsingV5RiceDeltaEncoded32Bit>,
    >,
    /// The 16-byte additions.
    #[serde(default, rename = "additionsSixteenBytes")]
    pub additions_sixteen_bytes: ::core::option::Option<
        ::std::boxed::Box<GoogleSecuritySafebrowsingV5RiceDeltaEncoded128Bit>,
    >,
    /// The 32-byte additions.
    #[serde(default, rename = "additionsThirtyTwoBytes")]
    pub additions_thirty_two_bytes: ::core::option::Option<
        ::std::boxed::Box<GoogleSecuritySafebrowsingV5RiceDeltaEncoded256Bit>,
    >,
    ...
    #[serde(default, rename = "compressedRemovals")]
    pub compressed_removals: ::core::option::Option<
        ::std::boxed::Box<GoogleSecuritySafebrowsingV5RiceDeltaEncoded32Bit>,
    >,
    ...
    #[serde(default)]
    pub metadata:
        ::core::option::Option<::std::boxed::Box<GoogleSecuritySafebrowsingV5HashListMetadata>>,
    ...
    pub minimum_wait_duration: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "partialUpdate")]
...
pub struct GoogleSecuritySafebrowsingV5HashListMetadata {
    ...
    /// The supported hash length for this hash list. Each hash list will support exactly one length. If a different hash length is introduced for the same set of threat types or safe types, it will be introduced as a separate list with a distinct name and respective hash length set. // TODO: enum values: ["HASH_LENGTH_UNSPECIFIED", "FOUR_BYTES", "EIGHT_BYTES", "SIXTEEN_BYTES", "THIRTY_TWO_BYTES"]
    #[serde(default, rename = "hashLength")]
    pub hash_length: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "likelySafeTypes")]
    pub likely_safe_types: ::core::option::Option<::std::vec::Vec<String>>,
...
pub struct GoogleSecuritySafebrowsingV5RiceDeltaEncoded256Bit {
    ...
    #[serde(default, rename = "firstValueFirstPart")]
    pub first_value_first_part: ::core::option::Option<String>,
    /// The last 64 bits of the first entry in the encoded data (hashes). If the field is empty, the last 64 bits are all zero.
    #[serde(default, rename = "firstValueFourthPart")]
    pub first_value_fourth_part: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "firstValueSecondPart")]
    pub first_value_second_part: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "firstValueThirdPart")]
    pub first_value_third_part: ::core::option::Option<String>,
...
pub struct GoogleSecuritySafebrowsingV5RiceDeltaEncoded32Bit {
    ...
    pub first_value: ::core::option::Option<i64>,
...
pub struct GoogleSecuritySafebrowsingV5SearchHashesResponse {
    ...
    pub cache_duration: ::core::option::Option<String>,
    /// Unordered list. The unordered list of full hashes found.
    #[serde(default, rename = "fullHashes")]
    pub full_hashes: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleSecuritySafebrowsingV5FullHash>>,
    >,
}
...
pub struct GoogleSecuritySafebrowsingV5SearchUrlsResponse {
    ...
    pub threats: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleSecuritySafebrowsingV5ThreatUrl>>,
    >,
}
