...
pub struct AbiTargeting {
    ...
    #[serde(default)]
    pub alternatives: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Abi>>>,
    /// Value of an abi.
    #[serde(default)]
    pub value: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Abi>>>,
}
...
pub struct AcquisitionTargetingRule {
    ...
    #[serde(default)]
    pub scope: ::core::option::Option<::std::boxed::Box<TargetingRuleScope>>,
}
...
pub struct AddTargetingRequest {
    ...
    pub targeting_update: ::core::option::Option<::std::boxed::Box<TargetingUpdate>>,
}
...
pub struct Apk {
    ...
    #[serde(default)]
    pub binary: ::core::option::Option<::std::boxed::Box<ApkBinary>>,
...
pub struct ApkDescription {
    ...
    pub asset_slice_metadata: ::core::option::Option<::std::boxed::Box<SplitApkMetadata>>,
    /// Set only for Instant split APKs.
    #[serde(default, rename = "instantApkMetadata")]
    pub instant_apk_metadata: ::core::option::Option<::std::boxed::Box<SplitApkMetadata>>,
    ...
    pub split_apk_metadata: ::core::option::Option<::std::boxed::Box<SplitApkMetadata>>,
    /// Set only for standalone APKs.
    #[serde(default, rename = "standaloneApkMetadata")]
    pub standalone_apk_metadata: ::core::option::Option<::std::boxed::Box<StandaloneApkMetadata>>,
    /// Apk-level targeting.
    #[serde(default)]
    pub targeting: ::core::option::Option<::std::boxed::Box<ApkTargeting>>,
}
...
pub struct ApkSet {
    ...
    pub apk_description: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ApkDescription>>>,
    /// Metadata about the module represented by this ApkSet
    #[serde(default, rename = "moduleMetadata")]
    pub module_metadata: ::core::option::Option<::std::boxed::Box<ModuleMetadata>>,
}
...
pub struct ApkTargeting {
    ...
    pub abi_targeting: ::core::option::Option<::std::boxed::Box<AbiTargeting>>,
    ...
    pub multi_abi_targeting: ::core::option::Option<::std::boxed::Box<MultiAbiTargeting>>,
    /// The screen density that this apk supports.
    #[serde(default, rename = "screenDensityTargeting")]
    pub screen_density_targeting: ::core::option::Option<::std::boxed::Box<ScreenDensityTargeting>>,
    /// The sdk version that the apk targets
    #[serde(default, rename = "sdkVersionTargeting")]
    pub sdk_version_targeting: ::core::option::Option<::std::boxed::Box<SdkVersionTargeting>>,
    ...
    pub texture_compression_format_targeting:
        ::core::option::Option<::std::boxed::Box<TextureCompressionFormatTargeting>>,
}
...
pub struct ApksAddExternallyHostedRequest {
    ...
    pub externally_hosted_apk: ::core::option::Option<::std::boxed::Box<ExternallyHostedApk>>,
}
...
pub struct ApksListResponse {
    /// All APKs.
    #[serde(default)]
    pub apks: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Apk>>>,
...
pub struct AppRecoveryAction {
    ...
    pub remote_in_app_update_data: ::core::option::Option<::std::boxed::Box<RemoteInAppUpdateData>>,
    ...
    #[serde(default)]
    pub targeting: ::core::option::Option<::std::boxed::Box<Targeting>>,
}
...
pub struct AssetSliceSet {
    ...
    pub asset_module_metadata: ::core::option::Option<::std::boxed::Box<AssetModuleMetadata>>,
}
...
pub struct AutoRenewingPlan {
    ...
    pub installment_details: ::core::option::Option<::std::boxed::Box<InstallmentPlan>>,
    ...
    pub price_change_details:
        ::core::option::Option<::std::boxed::Box<SubscriptionItemPriceChangeDetails>>,
    /// The information of the latest price step-up consent.
    #[serde(default, rename = "priceStepUpConsentDetails")]
    pub price_step_up_consent_details:
        ::core::option::Option<::std::boxed::Box<PriceStepUpConsentDetails>>,
    ...
    pub recurring_price: ::core::option::Option<::std::boxed::Box<Money>>,
}
...
pub struct BasePlan {
    ...
    pub auto_renewing_base_plan_type:
        ::core::option::Option<::std::boxed::Box<AutoRenewingBasePlanType>>,
    ...
    pub installments_base_plan_type:
        ::core::option::Option<::std::boxed::Box<InstallmentsBasePlanType>>,
    ...
    pub offer_tags: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<OfferTag>>>,
    ...
    pub other_regions_config: ::core::option::Option<::std::boxed::Box<OtherRegionsBasePlanConfig>>,
    ...
    pub prepaid_base_plan_type: ::core::option::Option<::std::boxed::Box<PrepaidBasePlanType>>,
    /// Region-specific information for this base plan.
    #[serde(default, rename = "regionalConfigs")]
    pub regional_configs:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<RegionalBasePlanConfig>>>,
...
pub struct BatchDeleteOneTimeProductOffersRequest {
    ...
    pub requests: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<DeleteOneTimeProductOfferRequest>>,
    >,
}
...
pub struct BatchDeleteOneTimeProductsRequest {
    ...
    #[serde(default)]
    pub requests:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DeleteOneTimeProductRequest>>>,
}
...
pub struct BatchDeletePurchaseOptionsRequest {
    ...
    #[serde(default)]
    pub requests:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DeletePurchaseOptionRequest>>>,
}
...
pub struct BatchGetOneTimeProductOffersRequest {
    ...
    #[serde(default)]
    pub requests:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GetOneTimeProductOfferRequest>>>,
}
...
pub struct BatchGetOneTimeProductOffersResponse {
    ...
    pub one_time_product_offers:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<OneTimeProductOffer>>>,
}
...
pub struct BatchGetOneTimeProductsResponse {
    ...
    pub one_time_products:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<OneTimeProduct>>>,
}
...
pub struct BatchGetOrdersResponse {
    ...
    #[serde(default)]
    pub orders: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Order>>>,
}
...
pub struct BatchGetSubscriptionOffersRequest {
    ...
    #[serde(default)]
    pub requests:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GetSubscriptionOfferRequest>>>,
}
...
pub struct BatchGetSubscriptionOffersResponse {
    ...
    pub subscription_offers:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SubscriptionOffer>>>,
}
...
pub struct BatchMigrateBasePlanPricesRequest {
    ...
    #[serde(default)]
    pub requests:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<MigrateBasePlanPricesRequest>>>,
}
...
pub struct BatchUpdateBasePlanStatesRequest {
    ...
    #[serde(default)]
    pub requests:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<UpdateBasePlanStateRequest>>>,
}
...
pub struct BatchUpdateOneTimeProductOfferStatesRequest {
    ...
    #[serde(default)]
    pub requests: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<UpdateOneTimeProductOfferStateRequest>>,
    >,
}
...
pub struct BatchUpdateOneTimeProductOffersRequest {
    ...
    #[serde(default)]
    pub requests: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<UpdateOneTimeProductOfferRequest>>,
    >,
}
...
pub struct BatchUpdateOneTimeProductsRequest {
    ...
    #[serde(default)]
    pub requests:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<UpdateOneTimeProductRequest>>>,
}
...
pub struct BatchUpdatePurchaseOptionStatesRequest {
    ...
    #[serde(default)]
    pub requests: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<UpdatePurchaseOptionStateRequest>>,
    >,
}
...
pub struct BatchUpdateSubscriptionOfferStatesRequest {
    ...
    #[serde(default)]
    pub requests: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<UpdateSubscriptionOfferStateRequest>>,
    >,
}
...
pub struct BatchUpdateSubscriptionOffersRequest {
    ...
    #[serde(default)]
    pub requests:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<UpdateSubscriptionOfferRequest>>>,
}
...
pub struct BatchUpdateSubscriptionsRequest {
    ...
    #[serde(default)]
    pub requests:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<UpdateSubscriptionRequest>>>,
}
...
pub struct BundlesListResponse {
    /// All app bundles.
    #[serde(default)]
    pub bundles: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Bundle>>>,
...
pub struct CancelSubscriptionPurchaseRequest {
    ...
    pub cancellation_context: ::core::option::Option<::std::boxed::Box<CancellationContext>>,
}
...
pub struct CanceledStateContext {
    ...
    pub user_initiated_cancellation:
        ::core::option::Option<::std::boxed::Box<UserInitiatedCancellation>>,
}
...
pub struct Comment {
    ...
    pub developer_comment: ::core::option::Option<::std::boxed::Box<DeveloperComment>>,
    /// A comment from a user.
    #[serde(default, rename = "userComment")]
    pub user_comment: ::core::option::Option<::std::boxed::Box<UserComment>>,
}
...
pub struct ConvertRegionPricesResponse {
    ...
    pub converted_other_regions_price:
        ::core::option::Option<::std::boxed::Box<ConvertedOtherRegionsPrice>>,
    ...
    pub region_version: ::core::option::Option<::std::boxed::Box<RegionsVersion>>,
}
...
pub struct ConvertedOtherRegionsPrice {
    ...
    pub eur_price: ::core::option::Option<::std::boxed::Box<Money>>,
    /// Price in USD to use for the "Other regions" location exclusive of taxes.
    #[serde(default, rename = "usdPrice")]
    pub usd_price: ::core::option::Option<::std::boxed::Box<Money>>,
}
...
pub struct ConvertedRegionPrice {
    ...
    pub tax_amount: ::core::option::Option<::std::boxed::Box<Money>>,
}
...
pub struct CreateDraftAppRecoveryRequest {
    ...
    pub remote_in_app_update: ::core::option::Option<::std::boxed::Box<RemoteInAppUpdate>>,
    /// Specifies targeting criteria for the recovery action such as regions, android sdk versions, app versions etc.
    #[serde(default)]
    pub targeting: ::core::option::Option<::std::boxed::Box<Targeting>>,
}
...
pub struct DeferSubscriptionPurchaseRequest {
    ...
    pub deferral_context: ::core::option::Option<::std::boxed::Box<DeferralContext>>,
}
...
pub struct DeferSubscriptionPurchaseResponse {
    ...
    pub item_expiry_time_details:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ItemExpiryTimeDetails>>>,
}
...
pub struct DeobfuscationFilesUploadResponse {
    ...
    pub deobfuscation_file: ::core::option::Option<::std::boxed::Box<DeobfuscationFile>>,
}
...
pub struct DeveloperComment {
    ...
    pub last_modified: ::core::option::Option<::std::boxed::Box<Timestamp>>,
...
pub struct DeviceFeatureTargeting {
    ...
    pub required_feature: ::core::option::Option<::std::boxed::Box<DeviceFeature>>,
}
...
pub struct DeviceGroup {
    ...
    pub device_selectors:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DeviceSelector>>>,
...
pub struct DeviceSelector {
    ...
    pub device_ram: ::core::option::Option<::std::boxed::Box<DeviceRam>>,
    /// Device models excluded by this selector, even if they match all other conditions.
    #[serde(default, rename = "excludedDeviceIds")]
    pub excluded_device_ids: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DeviceId>>>,
    ...
    pub forbidden_system_features:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SystemFeature>>>,
    /// Device models included by this selector.
    #[serde(default, rename = "includedDeviceIds")]
    pub included_device_ids: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DeviceId>>>,
...
pub struct DeviceTierConfig {
    ...
    pub device_groups: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DeviceGroup>>>,
    ...
    pub device_tier_set: ::core::option::Option<::std::boxed::Box<DeviceTierSet>>,
    /// Definition of user country sets for the app.
    #[serde(default, rename = "userCountrySets")]
    pub user_country_sets:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<UserCountrySet>>>,
}
...
pub struct DeviceTierSet {
    ...
    pub device_tiers: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DeviceTier>>>,
}
...
pub struct ExpansionFilesUploadResponse {
    ...
    pub expansion_file: ::core::option::Option<::std::boxed::Box<ExpansionFile>>,
}
...
pub struct ExternalTransaction {
    ...
    pub current_pre_tax_amount: ::core::option::Option<::std::boxed::Box<Price>>,
    ...
    pub current_tax_amount: ::core::option::Option<::std::boxed::Box<Price>>,
    /// Optional. Details necessary to accurately report external offers transactions.
    #[serde(default, rename = "externalOfferDetails")]
    pub external_offer_details: ::core::option::Option<::std::boxed::Box<ExternalOfferDetails>>,
    ...
    pub one_time_transaction: ::core::option::Option<::std::boxed::Box<OneTimeExternalTransaction>>,
    ...
    pub original_pre_tax_amount: ::core::option::Option<::std::boxed::Box<Price>>,
    ...
    pub original_tax_amount: ::core::option::Option<::std::boxed::Box<Price>>,
    ...
    pub recurring_transaction:
        ::core::option::Option<::std::boxed::Box<RecurringExternalTransaction>>,
    ...
    pub user_tax_address: ::core::option::Option<::std::boxed::Box<ExternalTransactionAddress>>,
}
...
pub struct ExternallyHostedApk {
    ...
    pub uses_permissions:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<UsesPermission>>>,
...
pub struct GeneratedApksListResponse {
    ...
    pub generated_apks:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GeneratedApksPerSigningKey>>>,
}
...
pub struct GeneratedApksPerSigningKey {
    ...
    pub generated_asset_pack_slices:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GeneratedAssetPackSlice>>>,
    ...
    pub generated_recovery_modules:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GeneratedRecoveryApk>>>,
    ...
    pub generated_split_apks:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GeneratedSplitApk>>>,
    ...
    pub generated_standalone_apks:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GeneratedStandaloneApk>>>,
    ...
    pub generated_universal_apk: ::core::option::Option<::std::boxed::Box<GeneratedUniversalApk>>,
    /// Contains targeting information about the generated apks.
    #[serde(default, rename = "targetingInfo")]
    pub targeting_info: ::core::option::Option<::std::boxed::Box<TargetingInfo>>,
}
...
pub struct ImagesDeleteAllResponse {
    /// The deleted images.
    #[serde(default)]
    pub deleted: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Image>>>,
}
...
pub struct ImagesListResponse {
    /// All listed Images.
    #[serde(default)]
    pub images: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Image>>>,
}
...
pub struct InAppProduct {
    ...
    pub default_price: ::core::option::Option<::std::boxed::Box<Price>>,
    ...
    pub managed_product_taxes_and_compliance_settings:
        ::core::option::Option<::std::boxed::Box<ManagedProductTaxAndComplianceSettings>>,
    ...
    pub subscription_taxes_and_compliance_settings:
        ::core::option::Option<::std::boxed::Box<SubscriptionTaxAndComplianceSettings>>,
...
pub struct InappproductsBatchDeleteRequest {
    ...
    #[serde(default)]
    pub requests:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<InappproductsDeleteRequest>>>,
}
...
pub struct InappproductsBatchGetResponse {
    ...
    #[serde(default)]
    pub inappproduct: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<InAppProduct>>>,
}
...
pub struct InappproductsBatchUpdateRequest {
    ...
    #[serde(default)]
    pub requests:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<InappproductsUpdateRequest>>>,
}
...
pub struct InappproductsBatchUpdateResponse {
    ...
    #[serde(default)]
    pub inappproducts: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<InAppProduct>>>,
}
...
pub struct InappproductsUpdateRequest {
    ...
    #[serde(default)]
    pub inappproduct: ::core::option::Option<::std::boxed::Box<InAppProduct>>,
    /// Optional. The latency tolerance for the propagation of this product update. Defaults to latency-sensitive. // TODO: enum values: ["PRODUCT_UPDATE_LATENCY_TOLERANCE_UNSPECIFIED", "PRODUCT_UPDATE_LATENCY_TOLERANCE_LATENCY_SENSITIVE", "PRODUCT_UPDATE_LATENCY_TOLERANCE_LATENCY_TOLERANT"]
    #[serde(default, rename = "latencyTolerance")]
    pub latency_tolerance: ::core::option::Option<String>,
    /// Package name of the app.
...
pub struct LineItem {
    ...
    pub listing_price: ::core::option::Option<::std::boxed::Box<Money>>,
    /// Details of a one-time purchase.
    #[serde(default, rename = "oneTimePurchaseDetails")]
    pub one_time_purchase_details:
        ::core::option::Option<::std::boxed::Box<OneTimePurchaseDetails>>,
    ...
    pub subscription_details: ::core::option::Option<::std::boxed::Box<SubscriptionDetails>>,
    /// The tax paid for this line item.
    #[serde(default)]
    pub tax: ::core::option::Option<::std::boxed::Box<Money>>,
    /// The total amount paid by the user for this line item, taking into account discounts and tax.
    #[serde(default)]
    pub total: ::core::option::Option<::std::boxed::Box<Money>>,
}
...
pub struct ListAppRecoveriesResponse {
    ...
    pub recovery_actions:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AppRecoveryAction>>>,
}
...
pub struct ListDeviceTierConfigsResponse {
    ...
    pub device_tier_configs:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DeviceTierConfig>>>,
...
pub struct ListReleaseSummariesResponse {
    ...
    #[serde(default)]
    pub releases: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ReleaseSummary>>>,
}
...
pub struct ListingsListResponse {
    ...
    #[serde(default)]
    pub listings: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Listing>>>,
}
...
pub struct ManagedProductTaxAndComplianceSettings {
    ...
    pub regional_product_age_rating_infos:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<RegionalProductAgeRatingInfo>>>,
...
pub struct MigrateBasePlanPricesRequest {
    ...
    pub regional_price_migrations:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<RegionalPriceMigrationConfig>>>,
    ...
    pub regions_version: ::core::option::Option<::std::boxed::Box<RegionsVersion>>,
}
...
pub struct ModuleMetadata {
    ...
    #[serde(default)]
    pub targeting: ::core::option::Option<::std::boxed::Box<ModuleTargeting>>,
}
...
pub struct ModuleTargeting {
    ...
    pub device_feature_targeting:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DeviceFeatureTargeting>>>,
    /// The sdk version that the variant targets
    #[serde(default, rename = "sdkVersionTargeting")]
    pub sdk_version_targeting: ::core::option::Option<::std::boxed::Box<SdkVersionTargeting>>,
    /// Countries-level targeting
    #[serde(default, rename = "userCountriesTargeting")]
    pub user_countries_targeting: ::core::option::Option<::std::boxed::Box<UserCountriesTargeting>>,
}
...
pub struct MultiAbi {
    ...
    #[serde(default)]
    pub abi: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Abi>>>,
}
...
pub struct MultiAbiTargeting {
    /// Targeting of other sibling directories that were in the Bundle. For main splits this is targeting of other main splits.
    #[serde(default)]
    pub alternatives: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<MultiAbi>>>,
    /// Value of a multi abi.
    #[serde(default)]
    pub value: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<MultiAbi>>>,
}
...
pub struct OfferPhase {
    ...
    pub proration_period: ::core::option::Option<::std::boxed::Box<ProrationPeriodOfferPhase>>,
}
...
pub struct OfferPhaseDetails {
    ...
    pub proration_period_details: ::core::option::Option<::std::boxed::Box<ProrationPeriodDetails>>,
}
...
pub struct OneTimeProduct {
    ...
    #[serde(default)]
    pub listings: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<OneTimeProductListing>>>,
    ...
    pub purchase_options:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<OneTimeProductPurchaseOption>>>,
    ...
    pub restricted_payment_countries:
        ::core::option::Option<::std::boxed::Box<RestrictedPaymentCountries>>,
    /// Details about taxes and legal compliance.
    #[serde(default, rename = "taxAndComplianceSettings")]
    pub tax_and_compliance_settings:
        ::core::option::Option<::std::boxed::Box<OneTimeProductTaxAndComplianceSettings>>,
}
...
pub struct OneTimeProductOffer {
    ...
    pub discounted_offer: ::core::option::Option<::std::boxed::Box<OneTimeProductDiscountedOffer>>,
    ...
    pub pre_order_offer: ::core::option::Option<::std::boxed::Box<OneTimeProductPreOrderOffer>>,
    ...
    pub regional_pricing_and_availability_configs: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<OneTimeProductOfferRegionalPricingAndAvailabilityConfig>>,
    >,
...
pub struct OneTimeProductOfferRegionalPricingAndAvailabilityConfig {
    ...
    pub absolute_discount: ::core::option::Option<::std::boxed::Box<Money>>,
...
pub struct OneTimeProductPurchaseOption {
    ...
    pub buy_option: ::core::option::Option<::std::boxed::Box<OneTimeProductBuyPurchaseOption>>,
    ...
    pub new_regions_config:
        ::core::option::Option<::std::boxed::Box<OneTimeProductPurchaseOptionNewRegionsConfig>>,
    ...
    pub regional_pricing_and_availability_configs: ::core::option::Option<
        ::std::vec::Vec<
            ::std::boxed::Box<OneTimeProductPurchaseOptionRegionalPricingAndAvailabilityConfig>,
        >,
    >,
    /// A purchase option that can be rented.
    #[serde(default, rename = "rentOption")]
    pub rent_option: ::core::option::Option<::std::boxed::Box<OneTimeProductRentPurchaseOption>>,
    ...
    #[serde(default, rename = "taxAndComplianceSettings")]
    pub tax_and_compliance_settings:
        ::core::option::Option<::std::boxed::Box<PurchaseOptionTaxAndComplianceSettings>>,
}
...
pub struct OneTimeProductTaxAndComplianceSettings {
    ...
    pub regional_tax_configs:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<RegionalTaxConfig>>>,
}
...
pub struct Order {
    ...
    pub buyer_address: ::core::option::Option<::std::boxed::Box<BuyerAddress>>,
    ...
    pub developer_revenue_in_buyer_currency: ::core::option::Option<::std::boxed::Box<Money>>,
    ...
    pub order_details: ::core::option::Option<::std::boxed::Box<OrderDetails>>,
    /// Details about events which modified the order.
    #[serde(default, rename = "orderHistory")]
    pub order_history: ::core::option::Option<::std::boxed::Box<OrderHistory>>,
    /// The order ID.
    ...
    pub points_details: ::core::option::Option<::std::boxed::Box<PointsDetails>>,
...
pub struct OrderHistory {
    ...
    pub cancellation_event: ::core::option::Option<::std::boxed::Box<CancellationEvent>>,
    /// Details of the partial refund events for this order.
    #[serde(default, rename = "partialRefundEvents")]
    pub partial_refund_events:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PartialRefundEvent>>>,
    /// Details of when the order was processed.
    #[serde(default, rename = "processedEvent")]
    pub processed_event: ::core::option::Option<::std::boxed::Box<ProcessedEvent>>,
    /// Details of when the order was fully refunded.
    #[serde(default, rename = "refundEvent")]
    pub refund_event: ::core::option::Option<::std::boxed::Box<RefundEvent>>,
}
...
pub struct OtherRegionsSubscriptionOfferPhaseConfig {
    ...
    pub absolute_discounts:
        ::core::option::Option<::std::boxed::Box<OtherRegionsSubscriptionOfferPhasePrices>>,
...
pub struct OutOfAppPurchaseContext {
    ...
    pub expired_external_account_identifiers:
        ::core::option::Option<::std::boxed::Box<ExternalAccountIdentifiers>>,
...
pub struct PartialRefund {
    ...
    pub refund_pre_tax_amount: ::core::option::Option<::std::boxed::Box<Price>>,
}
...
pub struct PartialRefundEvent {
    ...
    pub refund_details: ::core::option::Option<::std::boxed::Box<RefundDetails>>,
...
pub struct PointsDetails {
    ...
    pub points_coupon_value: ::core::option::Option<::std::boxed::Box<Money>>,
...
pub struct PriceStepUpConsentDetails {
    ...
    pub new_price: ::core::option::Option<::std::boxed::Box<Money>>,
...
pub struct ProductLineItem {
    ...
    pub product_offer_details: ::core::option::Option<::std::boxed::Box<ProductOfferDetails>>,
}
...
pub struct ProductOfferDetails {
    ...
    pub preorder_offer_details: ::core::option::Option<::std::boxed::Box<PreorderOfferDetails>>,
...
pub struct ProductPurchaseV2 {
    ...
    pub product_line_item:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ProductLineItem>>>,
    ...
    pub purchase_state_context: ::core::option::Option<::std::boxed::Box<PurchaseStateContext>>,
    /// ISO 3166-1 alpha-2 billing region code of the user at the time the product was granted.
    #[serde(default, rename = "regionCode")]
    pub region_code: ::core::option::Option<String>,
    /// Information related to test purchases. This will only be set for test purchases.
    #[serde(default, rename = "testPurchaseContext")]
    pub test_purchase_context: ::core::option::Option<::std::boxed::Box<TestPurchaseContext>>,
}
...
pub struct RecurringExternalTransaction {
    ...
    pub external_subscription: ::core::option::Option<::std::boxed::Box<ExternalSubscription>>,
...
pub struct RefundExternalTransactionRequest {
    ...
    pub partial_refund: ::core::option::Option<::std::boxed::Box<PartialRefund>>,
...
pub struct ReleaseSummary {
    ...
    pub active_artifacts:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ArtifactSummary>>>,
...
pub struct RemoteInAppUpdateData {
    ...
    pub remote_app_update_data_per_bundle:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<RemoteInAppUpdateDataPerBundle>>>,
}
...
pub struct ReviewReplyResult {
    ...
    pub last_edited: ::core::option::Option<::std::boxed::Box<Timestamp>>,
...
pub struct ReviewsListResponse {
    ...
    /// List of reviews.
    #[serde(default)]
    pub reviews: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Review>>>,
    /// Pagination token, to handle a number of products that is over one page.
    #[serde(default, rename = "tokenPagination")]
    pub token_pagination: ::core::option::Option<::std::boxed::Box<TokenPagination>>,
}
...
pub struct ReviewsReplyResponse {
    /// The result of replying/updating a reply to review.
    #[serde(default)]
    pub result: ::core::option::Option<::std::boxed::Box<ReviewReplyResult>>,
}
...
pub struct RevocationContext {
    ...
    pub item_based_refund:
        ::core::option::Option<::std::boxed::Box<RevocationContextItemBasedRefund>>,
...
pub struct RevokeSubscriptionPurchaseRequest {
    ...
    pub revocation_context: ::core::option::Option<::std::boxed::Box<RevocationContext>>,
}
...
pub struct ScreenDensityTargeting {
    /// Targeting of other sibling directories that were in the Bundle. For main splits this is targeting of other main splits.
    #[serde(default)]
    pub alternatives: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ScreenDensity>>>,
    /// Value of a screen density.
    #[serde(default)]
    pub value: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ScreenDensity>>>,
}
...
pub struct SdkVersionTargeting {
    /// Targeting of other sibling directories that were in the Bundle. For main splits this is targeting of other main splits.
    #[serde(default)]
    pub alternatives: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SdkVersion>>>,
    /// Value of an sdk version.
    #[serde(default)]
    pub value: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SdkVersion>>>,
}
...
pub struct SignupPromotion {
    ...
    pub vanity_code: ::core::option::Option<::std::boxed::Box<VanityCode>>,
}
...
pub struct SplitApkVariant {
    ...
    pub apk_set: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ApkSet>>>,
    /// Variant-level targeting.
    #[serde(default)]
    pub targeting: ::core::option::Option<::std::boxed::Box<VariantTargeting>>,
...
pub struct Subscription {
    ...
    pub base_plans: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<BasePlan>>>,
    ...
    #[serde(default)]
    pub listings: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SubscriptionListing>>>,
...
pub struct SubscriptionDetails {
    ...
    pub offer_phase_details: ::core::option::Option<::std::boxed::Box<OfferPhaseDetails>>,
...
pub struct SubscriptionOffer {
    ...
    pub other_regions_config:
        ::core::option::Option<::std::boxed::Box<OtherRegionsSubscriptionOfferConfig>>,
    ...
    #[serde(default)]
    pub phases: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SubscriptionOfferPhase>>>,
    ...
    #[serde(default, rename = "regionalConfigs")]
    pub regional_configs:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<RegionalSubscriptionOfferConfig>>>,
    ...
    #[serde(default)]
    pub targeting: ::core::option::Option<::std::boxed::Box<SubscriptionOfferTargeting>>,
}
...
pub struct SubscriptionOfferPhase {
    ...
    #[serde(default, rename = "otherRegionsConfig")]
    pub other_regions_config:
        ::core::option::Option<::std::boxed::Box<OtherRegionsSubscriptionOfferPhaseConfig>>,
    ...
    #[serde(default, rename = "regionalConfigs")]
    pub regional_configs: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<RegionalSubscriptionOfferPhaseConfig>>,
    >,
}
...
pub struct SubscriptionOfferTargeting {
    ...
    pub acquisition_rule: ::core::option::Option<::std::boxed::Box<AcquisitionTargetingRule>>,
    /// Offer targeting rule for upgrading users'' existing plans.
    #[serde(default, rename = "upgradeRule")]
    pub upgrade_rule: ::core::option::Option<::std::boxed::Box<UpgradeTargetingRule>>,
}
...
pub struct SubscriptionPriceChange {
    ...
    #[serde(default, rename = "newPrice")]
    pub new_price: ::core::option::Option<::std::boxed::Box<Price>>,
...
pub struct SubscriptionPurchase {
    ...
    pub cancel_survey_result:
        ::core::option::Option<::std::boxed::Box<SubscriptionCancelSurveyResult>>,
    ...
    pub introductory_price_info: ::core::option::Option<::std::boxed::Box<IntroductoryPriceInfo>>,
    ...
    pub price_change: ::core::option::Option<::std::boxed::Box<SubscriptionPriceChange>>,
...
pub struct SubscriptionPurchaseLineItem {
    ...
    pub auto_renewing_plan: ::core::option::Option<::std::boxed::Box<AutoRenewingPlan>>,
    ...
    pub deferred_item_replacement:
        ::core::option::Option<::std::boxed::Box<DeferredItemReplacement>>,
    ...
    pub item_replacement: ::core::option::Option<::std::boxed::Box<ItemReplacement>>,
    ...
    pub offer_details: ::core::option::Option<::std::boxed::Box<OfferDetails>>,
    /// Current offer phase details for this item.
    #[serde(default, rename = "offerPhase")]
    pub offer_phase: ::core::option::Option<::std::boxed::Box<OfferPhase>>,
    /// The item is prepaid.
    #[serde(default, rename = "prepaidPlan")]
    pub prepaid_plan: ::core::option::Option<::std::boxed::Box<PrepaidPlan>>,
    /// The purchased product ID (for example, ''monthly001'').
    #[serde(default, rename = "productId")]
    pub product_id: ::core::option::Option<String>,
    /// Promotion details about this item. Only set if a promotion was applied during signup.
    #[serde(default, rename = "signupPromotion")]
    pub signup_promotion: ::core::option::Option<::std::boxed::Box<SignupPromotion>>,
}
...
pub struct SubscriptionPurchaseV2 {
    ...
    pub canceled_state_context: ::core::option::Option<::std::boxed::Box<CanceledStateContext>>,
    ...
    #[serde(default, rename = "lineItems")]
    pub line_items:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SubscriptionPurchaseLineItem>>>,
    ...
    pub out_of_app_purchase_context:
        ::core::option::Option<::std::boxed::Box<OutOfAppPurchaseContext>>,
    ...
    pub paused_state_context: ::core::option::Option<::std::boxed::Box<PausedStateContext>>,
    /// ISO 3166-1 alpha-2 billing country/region code of the user at the time the subscription was granted.
    #[serde(default, rename = "regionCode")]
    pub region_code: ::core::option::Option<String>,
    ...
    pub subscribe_with_google_info:
        ::core::option::Option<::std::boxed::Box<SubscribeWithGoogleInfo>>,
...
pub struct SubscriptionPurchasesAcknowledgeRequest {
    ...
    pub external_account_ids: ::core::option::Option<::std::boxed::Box<ExternalAccountIds>>,
}
...
pub struct SubscriptionPurchasesDeferRequest {
    ...
    pub deferral_info: ::core::option::Option<::std::boxed::Box<SubscriptionDeferralInfo>>,
}
...
pub struct SystemApksListResponse {
    ...
    #[serde(default)]
    pub variants: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Variant>>>,
}
...
pub struct Targeting {
    ...
    pub all_users: ::core::option::Option<::std::boxed::Box<AllUsers>>,
    /// Targeting is based on android api levels of devices.
    #[serde(default, rename = "androidSdks")]
    pub android_sdks: ::core::option::Option<::std::boxed::Box<AndroidSdks>>,
    /// Targeting is based on the user account region.
    #[serde(default)]
    pub regions: ::core::option::Option<::std::boxed::Box<Regions>>,
    /// Target version codes as a list.
    #[serde(default, rename = "versionList")]
    pub version_list: ::core::option::Option<::std::boxed::Box<AppVersionList>>,
    /// Target version codes as a range.
    #[serde(default, rename = "versionRange")]
    pub version_range: ::core::option::Option<::std::boxed::Box<AppVersionRange>>,
}
...
pub struct TargetingInfo {
    ...
    pub asset_slice_set: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AssetSliceSet>>>,
    /// The package name of this app.
    #[serde(default, rename = "packageName")]
    pub package_name: ::core::option::Option<String>,
    /// List of the created variants.
    #[serde(default)]
    pub variant: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SplitApkVariant>>>,
}
...
pub struct TextureCompressionFormatTargeting {
    ...
    #[serde(default)]
    pub alternatives:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TextureCompressionFormat>>>,
    /// The list of targeted TCFs. Should not be empty.
    #[serde(default)]
    pub value: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TextureCompressionFormat>>>,
}
...
pub struct Track {
    ...
    #[serde(default)]
    pub releases: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TrackRelease>>>,
...
pub struct TrackCountryAvailability {
    ...
    #[serde(default)]
    pub countries: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TrackTargetedCountry>>>,
...
pub struct TrackRelease {
    ...
    pub country_targeting: ::core::option::Option<::std::boxed::Box<CountryTargeting>>,
    ...
    pub release_notes: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<LocalizedText>>>,
...
pub struct TracksListResponse {
    ...
    #[serde(default)]
    pub tracks: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Track>>>,
}
...
pub struct UpdateBasePlanStateRequest {
    ...
    pub activate_base_plan_request:
        ::core::option::Option<::std::boxed::Box<ActivateBasePlanRequest>>,
    /// Deactivates a base plan. Once deactivated, the base plan will become unavailable to new subscribers, but existing subscribers will maintain their subscription
    #[serde(default, rename = "deactivateBasePlanRequest")]
    pub deactivate_base_plan_request:
        ::core::option::Option<::std::boxed::Box<DeactivateBasePlanRequest>>,
}
...
pub struct UpdateOneTimeProductOfferRequest {
    ...
    pub one_time_product_offer: ::core::option::Option<::std::boxed::Box<OneTimeProductOffer>>,
...
pub struct UpdateOneTimeProductOfferStateRequest {
    ...
    pub activate_one_time_product_offer_request:
        ::core::option::Option<::std::boxed::Box<ActivateOneTimeProductOfferRequest>>,
    ...
    pub cancel_one_time_product_offer_request:
        ::core::option::Option<::std::boxed::Box<CancelOneTimeProductOfferRequest>>,
    ...
    pub deactivate_one_time_product_offer_request:
        ::core::option::Option<::std::boxed::Box<DeactivateOneTimeProductOfferRequest>>,
}
...
pub struct UpdateOneTimeProductRequest {
    ...
    pub one_time_product: ::core::option::Option<::std::boxed::Box<OneTimeProduct>>,
...
pub struct UpdatePurchaseOptionStateRequest {
    ...
    pub activate_purchase_option_request:
        ::core::option::Option<::std::boxed::Box<ActivatePurchaseOptionRequest>>,
    ...
    pub deactivate_purchase_option_request:
        ::core::option::Option<::std::boxed::Box<DeactivatePurchaseOptionRequest>>,
}
...
pub struct UpdateSubscriptionOfferRequest {
    ...
    pub subscription_offer: ::core::option::Option<::std::boxed::Box<SubscriptionOffer>>,
    /// Required. The list of fields to be updated.
    #[serde(default, rename = "updateMask")]
    pub update_mask: ::core::option::Option<String>,
}
...
pub struct UpdateSubscriptionOfferStateRequest {
    ...
    pub activate_subscription_offer_request:
        ::core::option::Option<::std::boxed::Box<ActivateSubscriptionOfferRequest>>,
    ...
    pub deactivate_subscription_offer_request:
        ::core::option::Option<::std::boxed::Box<DeactivateSubscriptionOfferRequest>>,
}
...
pub struct UpdateSubscriptionRequest {
    ...
    #[serde(default)]
    pub subscription: ::core::option::Option<::std::boxed::Box<Subscription>>,
    /// Required. The list of fields to be updated.
    #[serde(default, rename = "updateMask")]
    pub update_mask: ::core::option::Option<String>,
}
...
pub struct User {
    ...
    #[serde(default)]
    pub grants: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Grant>>>,
...
pub struct UserComment {
    ...
    pub device_metadata: ::core::option::Option<::std::boxed::Box<DeviceMetadata>>,
    /// The last time at which this comment was updated.
    #[serde(default, rename = "lastModified")]
    pub last_modified: ::core::option::Option<::std::boxed::Box<Timestamp>>,
...
pub struct UserInitiatedCancellation {
    /// Information provided by the user when they complete the subscription cancellation flow (cancellation reason survey).
    #[serde(default, rename = "cancelSurveyResult")]
    pub cancel_survey_result: ::core::option::Option<::std::boxed::Box<CancelSurveyResult>>,
...
pub struct Variant {
    ...
    pub device_spec: ::core::option::Option<::std::boxed::Box<DeviceSpec>>,
    /// Optional. Options applied to the generated APK.
    #[serde(default)]
    pub options: ::core::option::Option<::std::boxed::Box<SystemApkOptions>>,
...
pub struct VoidedPurchasesListResponse {
    ...
    pub voided_purchases:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<VoidedPurchase>>>,
}
