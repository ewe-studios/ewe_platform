...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/slides/openapi.json`.
...
pub struct BatchUpdatePresentationRequest {
    ...
    pub write_control: ::core::option::Option<::std::boxed::Box<WriteControl>>,
}
...
pub struct ColorScheme {
    ...
    #[serde(default)]
    pub colors: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ThemeColorPair>>>,
}
...
pub struct CreateImageRequest {
    ...
    pub element_properties: ::core::option::Option<::std::boxed::Box<PageElementProperties>>,
...
pub struct CreateParagraphBulletsRequest {
    ...
    pub text_range: ::core::option::Option<::std::boxed::Box<Range>>,
}
...
pub struct CreateSlideRequest {
    ...
    pub placeholder_id_mappings:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<LayoutPlaceholderIdMapping>>>,
    ...
    pub slide_layout_reference: ::core::option::Option<::std::boxed::Box<LayoutReference>>,
}
...
pub struct Group {
    ...
    #[serde(default)]
    pub children: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PageElement>>>,
}
...
pub struct MergeTableCellsRequest {
    ...
    pub table_range: ::core::option::Option<::std::boxed::Box<TableRange>>,
}
...
pub struct Page {
    ...
    pub page_elements: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PageElement>>>,
...
pub struct Presentation {
    ...
    #[serde(default)]
    pub layouts: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Page>>>,
    ...
    #[serde(default)]
    pub masters: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Page>>>,
    ...
    #[serde(default)]
    pub slides: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Page>>>,
...
pub struct Recolor {
    ...
    pub recolor_stops: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ColorStop>>>,
}
...
pub struct ReplaceAllShapesWithImageRequest {
    ...
    pub contains_text: ::core::option::Option<::std::boxed::Box<SubstringMatchCriteria>>,
...
pub struct Request {
    ...
    pub create_image: ::core::option::Option<::std::boxed::Box<CreateImageRequest>>,
    /// Creates a line.
    #[serde(default, rename = "createLine")]
    pub create_line: ::core::option::Option<::std::boxed::Box<CreateLineRequest>>,
    /// Creates bullets for paragraphs.
    #[serde(default, rename = "createParagraphBullets")]
    pub create_paragraph_bullets:
        ::core::option::Option<::std::boxed::Box<CreateParagraphBulletsRequest>>,
    /// Creates a new shape.
    #[serde(default, rename = "createShape")]
    pub create_shape: ::core::option::Option<::std::boxed::Box<CreateShapeRequest>>,
    /// Creates an embedded Google Sheets chart.
    #[serde(default, rename = "createSheetsChart")]
    pub create_sheets_chart: ::core::option::Option<::std::boxed::Box<CreateSheetsChartRequest>>,
    /// Creates a new slide.
    #[serde(default, rename = "createSlide")]
    pub create_slide: ::core::option::Option<::std::boxed::Box<CreateSlideRequest>>,
    /// Creates a new table.
    #[serde(default, rename = "createTable")]
    pub create_table: ::core::option::Option<::std::boxed::Box<CreateTableRequest>>,
    /// Creates a video.
    #[serde(default, rename = "createVideo")]
    pub create_video: ::core::option::Option<::std::boxed::Box<CreateVideoRequest>>,
    /// Deletes a page or page element from the presentation.
    #[serde(default, rename = "deleteObject")]
    pub delete_object: ::core::option::Option<::std::boxed::Box<DeleteObjectRequest>>,
    /// Deletes bullets from paragraphs.
    #[serde(default, rename = "deleteParagraphBullets")]
    pub delete_paragraph_bullets:
        ::core::option::Option<::std::boxed::Box<DeleteParagraphBulletsRequest>>,
    /// Deletes a column from a table.
    #[serde(default, rename = "deleteTableColumn")]
    pub delete_table_column: ::core::option::Option<::std::boxed::Box<DeleteTableColumnRequest>>,
    /// Deletes a row from a table.
    #[serde(default, rename = "deleteTableRow")]
    pub delete_table_row: ::core::option::Option<::std::boxed::Box<DeleteTableRowRequest>>,
    /// Deletes text from a shape or a table cell.
    #[serde(default, rename = "deleteText")]
    pub delete_text: ::core::option::Option<::std::boxed::Box<DeleteTextRequest>>,
    /// Duplicates a slide or page element.
    #[serde(default, rename = "duplicateObject")]
    pub duplicate_object: ::core::option::Option<::std::boxed::Box<DuplicateObjectRequest>>,
    /// Groups objects, such as page elements.
    #[serde(default, rename = "groupObjects")]
    pub group_objects: ::core::option::Option<::std::boxed::Box<GroupObjectsRequest>>,
    /// Inserts columns into a table.
    #[serde(default, rename = "insertTableColumns")]
    pub insert_table_columns: ::core::option::Option<::std::boxed::Box<InsertTableColumnsRequest>>,
    /// Inserts rows into a table.
    #[serde(default, rename = "insertTableRows")]
    pub insert_table_rows: ::core::option::Option<::std::boxed::Box<InsertTableRowsRequest>>,
    /// Inserts text into a shape or table cell.
    #[serde(default, rename = "insertText")]
    pub insert_text: ::core::option::Option<::std::boxed::Box<InsertTextRequest>>,
    /// Merges cells in a Table.
    #[serde(default, rename = "mergeTableCells")]
    pub merge_table_cells: ::core::option::Option<::std::boxed::Box<MergeTableCellsRequest>>,
    /// Refreshes a Google Sheets chart.
    #[serde(default, rename = "refreshSheetsChart")]
    pub refresh_sheets_chart: ::core::option::Option<::std::boxed::Box<RefreshSheetsChartRequest>>,
    /// Replaces all shapes matching some criteria with an image.
    #[serde(default, rename = "replaceAllShapesWithImage")]
    pub replace_all_shapes_with_image:
        ::core::option::Option<::std::boxed::Box<ReplaceAllShapesWithImageRequest>>,
    /// Replaces all shapes matching some criteria with a Google Sheets chart.
    #[serde(default, rename = "replaceAllShapesWithSheetsChart")]
    pub replace_all_shapes_with_sheets_chart:
        ::core::option::Option<::std::boxed::Box<ReplaceAllShapesWithSheetsChartRequest>>,
    /// Replaces all instances of specified text.
    #[serde(default, rename = "replaceAllText")]
    pub replace_all_text: ::core::option::Option<::std::boxed::Box<ReplaceAllTextRequest>>,
    /// Replaces an existing image with a new image.
    #[serde(default, rename = "replaceImage")]
    pub replace_image: ::core::option::Option<::std::boxed::Box<ReplaceImageRequest>>,
    /// Reroutes a line such that it''s connected at the two closest connection sites on the connected page elements.
    #[serde(default, rename = "rerouteLine")]
    pub reroute_line: ::core::option::Option<::std::boxed::Box<RerouteLineRequest>>,
    /// Ungroups objects, such as groups.
    #[serde(default, rename = "ungroupObjects")]
    pub ungroup_objects: ::core::option::Option<::std::boxed::Box<UngroupObjectsRequest>>,
    /// Unmerges cells in a Table.
    #[serde(default, rename = "unmergeTableCells")]
    pub unmerge_table_cells: ::core::option::Option<::std::boxed::Box<UnmergeTableCellsRequest>>,
    /// Updates the properties of an Image.
    #[serde(default, rename = "updateImageProperties")]
    pub update_image_properties:
        ::core::option::Option<::std::boxed::Box<UpdateImagePropertiesRequest>>,
    /// Updates the category of a line.
    #[serde(default, rename = "updateLineCategory")]
    pub update_line_category: ::core::option::Option<::std::boxed::Box<UpdateLineCategoryRequest>>,
    /// Updates the properties of a Line.
    #[serde(default, rename = "updateLineProperties")]
    pub update_line_properties:
        ::core::option::Option<::std::boxed::Box<UpdateLinePropertiesRequest>>,
    /// Updates the alt text title and/or description of a page element.
    #[serde(default, rename = "updatePageElementAltText")]
    pub update_page_element_alt_text:
        ::core::option::Option<::std::boxed::Box<UpdatePageElementAltTextRequest>>,
    /// Updates the transform of a page element.
    #[serde(default, rename = "updatePageElementTransform")]
    pub update_page_element_transform:
        ::core::option::Option<::std::boxed::Box<UpdatePageElementTransformRequest>>,
    /// Updates the Z-order of page elements.
    #[serde(default, rename = "updatePageElementsZOrder")]
    pub update_page_elements_z_order:
        ::core::option::Option<::std::boxed::Box<UpdatePageElementsZOrderRequest>>,
    /// Updates the properties of a Page.
    #[serde(default, rename = "updatePageProperties")]
    pub update_page_properties:
        ::core::option::Option<::std::boxed::Box<UpdatePagePropertiesRequest>>,
    /// Updates the styling of paragraphs within a Shape or Table.
    #[serde(default, rename = "updateParagraphStyle")]
    pub update_paragraph_style:
        ::core::option::Option<::std::boxed::Box<UpdateParagraphStyleRequest>>,
    /// Updates the properties of a Shape.
    #[serde(default, rename = "updateShapeProperties")]
    pub update_shape_properties:
        ::core::option::Option<::std::boxed::Box<UpdateShapePropertiesRequest>>,
    /// Updates the properties of a Slide
    #[serde(default, rename = "updateSlideProperties")]
    pub update_slide_properties:
        ::core::option::Option<::std::boxed::Box<UpdateSlidePropertiesRequest>>,
    /// Updates the position of a set of slides in the presentation.
    #[serde(default, rename = "updateSlidesPosition")]
    pub update_slides_position:
        ::core::option::Option<::std::boxed::Box<UpdateSlidesPositionRequest>>,
    /// Updates the properties of the table borders in a Table.
    #[serde(default, rename = "updateTableBorderProperties")]
    pub update_table_border_properties:
        ::core::option::Option<::std::boxed::Box<UpdateTableBorderPropertiesRequest>>,
    /// Updates the properties of a TableCell.
    #[serde(default, rename = "updateTableCellProperties")]
    pub update_table_cell_properties:
        ::core::option::Option<::std::boxed::Box<UpdateTableCellPropertiesRequest>>,
    /// Updates the properties of a Table column.
    #[serde(default, rename = "updateTableColumnProperties")]
    pub update_table_column_properties:
        ::core::option::Option<::std::boxed::Box<UpdateTableColumnPropertiesRequest>>,
    /// Updates the properties of a Table row.
    #[serde(default, rename = "updateTableRowProperties")]
    pub update_table_row_properties:
        ::core::option::Option<::std::boxed::Box<UpdateTableRowPropertiesRequest>>,
    /// Updates the styling of text within a Shape or Table.
    #[serde(default, rename = "updateTextStyle")]
    pub update_text_style: ::core::option::Option<::std::boxed::Box<UpdateTextStyleRequest>>,
    /// Updates the properties of a Video.
    #[serde(default, rename = "updateVideoProperties")]
    pub update_video_properties:
        ::core::option::Option<::std::boxed::Box<UpdateVideoPropertiesRequest>>,
}
...
pub struct Response {
    /// The result of creating an image.
    #[serde(default, rename = "createImage")]
    pub create_image: ::core::option::Option<::std::boxed::Box<CreateImageResponse>>,
    /// The result of creating a line.
    #[serde(default, rename = "createLine")]
    pub create_line: ::core::option::Option<::std::boxed::Box<CreateLineResponse>>,
    /// The result of creating a shape.
    #[serde(default, rename = "createShape")]
    pub create_shape: ::core::option::Option<::std::boxed::Box<CreateShapeResponse>>,
    /// The result of creating a Google Sheets chart.
    #[serde(default, rename = "createSheetsChart")]
    pub create_sheets_chart: ::core::option::Option<::std::boxed::Box<CreateSheetsChartResponse>>,
    /// The result of creating a slide.
    #[serde(default, rename = "createSlide")]
    pub create_slide: ::core::option::Option<::std::boxed::Box<CreateSlideResponse>>,
    /// The result of creating a table.
    #[serde(default, rename = "createTable")]
    pub create_table: ::core::option::Option<::std::boxed::Box<CreateTableResponse>>,
    /// The result of creating a video.
    #[serde(default, rename = "createVideo")]
    pub create_video: ::core::option::Option<::std::boxed::Box<CreateVideoResponse>>,
    /// The result of duplicating an object.
    #[serde(default, rename = "duplicateObject")]
    pub duplicate_object: ::core::option::Option<::std::boxed::Box<DuplicateObjectResponse>>,
    /// The result of grouping objects.
    #[serde(default, rename = "groupObjects")]
    pub group_objects: ::core::option::Option<::std::boxed::Box<GroupObjectsResponse>>,
    /// The result of replacing all shapes matching some criteria with an image.
    #[serde(default, rename = "replaceAllShapesWithImage")]
    pub replace_all_shapes_with_image:
        ::core::option::Option<::std::boxed::Box<ReplaceAllShapesWithImageResponse>>,
    /// The result of replacing all shapes matching some criteria with a Google Sheets chart.
    #[serde(default, rename = "replaceAllShapesWithSheetsChart")]
    pub replace_all_shapes_with_sheets_chart:
        ::core::option::Option<::std::boxed::Box<ReplaceAllShapesWithSheetsChartResponse>>,
    /// The result of replacing text.
    #[serde(default, rename = "replaceAllText")]
    pub replace_all_text: ::core::option::Option<::std::boxed::Box<ReplaceAllTextResponse>>,
}
...
pub struct Table {
    ...
    pub horizontal_border_rows:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TableBorderRow>>>,
    /// Number of rows in the table.
    #[serde(default)]
    pub rows: ::core::option::Option<i32>,
    ...
    pub table_rows: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TableRow>>>,
...
pub struct TableBorderRow {
    ...
    pub table_border_cells:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TableBorderCell>>>,
}
...
pub struct TableRow {
    ...
    pub table_cells: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TableCell>>>,
...
pub struct TextContent {
    ...
    pub text_elements: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TextElement>>>,
}
