...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/privateca/openapi.json`.
...
pub struct ActivateCertificateAuthorityRequest {
    ...
    pub subordinate_config: ::core::option::Option<::std::boxed::Box<SubordinateConfig>>,
}
...
pub struct AllowedKeyType {
    ...
    pub elliptic_curve: ::core::option::Option<::std::boxed::Box<EcKeyType>>,
    /// Represents an allowed RSA key type.
    #[serde(default)]
    pub rsa: ::core::option::Option<::std::boxed::Box<RsaKeyType>>,
}
...
pub struct CaPool {
    ...
    pub issuance_policy: ::core::option::Option<::std::boxed::Box<IssuancePolicy>>,
    ...
    pub publishing_options: ::core::option::Option<::std::boxed::Box<PublishingOptions>>,
...
pub struct Certificate {
    ...
    pub certificate_description: ::core::option::Option<::std::boxed::Box<CertificateDescription>>,
    ...
    #[serde(default)]
    pub config: ::core::option::Option<::std::boxed::Box<CertificateConfig>>,
    ...
    pub revocation_details: ::core::option::Option<::std::boxed::Box<RevocationDetails>>,
...
pub struct CertificateAuthority {
    ...
    pub access_urls: ::core::option::Option<::std::boxed::Box<AccessUrls>>,
    /// Output only. A structured description of this CertificateAuthority''s CA certificate and its issuers. Ordered as self-to-root.
    #[serde(default, rename = "caCertificateDescriptions")]
    pub ca_certificate_descriptions:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<CertificateDescription>>>,
    ...
    pub key_spec: ::core::option::Option<::std::boxed::Box<KeyVersionSpec>>,
    /// Optional. Labels with user-defined metadata.
    #[serde(default)]
    pub labels: ::core::option::Option<serde_json::Value>,
    ...
    pub user_defined_access_urls: ::core::option::Option<::std::boxed::Box<UserDefinedAccessUrls>>,
}
...
pub struct CertificateConfig {
    ...
    pub public_key: ::core::option::Option<::std::boxed::Box<PublicKey>>,
    /// Required. Specifies some of the values in a certificate that are related to the subject.
    #[serde(default, rename = "subjectConfig")]
    pub subject_config: ::core::option::Option<::std::boxed::Box<SubjectConfig>>,
    ...
    pub subject_key_id: ::core::option::Option<::std::boxed::Box<CertificateConfigKeyId>>,
    ...
    pub x509_config: ::core::option::Option<::std::boxed::Box<X509Parameters>>,
}
...
pub struct CertificateDescription {
    ...
    pub authority_key_id: ::core::option::Option<::std::boxed::Box<KeyId>>,
    /// The hash of the x.509 certificate.
    #[serde(default, rename = "certFingerprint")]
    pub cert_fingerprint: ::core::option::Option<::std::boxed::Box<CertificateFingerprint>>,
    ...
    pub subject_description: ::core::option::Option<::std::boxed::Box<SubjectDescription>>,
    /// Provides a means of identifiying certificates that contain a particular public key, per https://tools.ietf.org/html/rfc5280#section-4.2.1.2.
    #[serde(default, rename = "subjectKeyId")]
    pub subject_key_id: ::core::option::Option<::std::boxed::Box<KeyId>>,
    ...
    pub x509_description: ::core::option::Option<::std::boxed::Box<X509Parameters>>,
}
...
pub struct CertificateExtensionConstraints {
    ...
    pub additional_extensions: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ObjectId>>>,
...
pub struct CertificateIdentityConstraints {
    ...
    pub cel_expression: ::core::option::Option<::std::boxed::Box<Expr>>,
}
...
pub struct CertificateRevocationList {
    ...
    pub revoked_certificates:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<RevokedCertificate>>>,
...
pub struct CertificateTemplate {
    ...
    pub identity_constraints:
        ::core::option::Option<::std::boxed::Box<CertificateIdentityConstraints>>,
    /// Optional. Labels with user-defined metadata.
    #[serde(default)]
    pub labels: ::core::option::Option<serde_json::Value>,
    ...
    pub passthrough_extensions:
        ::core::option::Option<::std::boxed::Box<CertificateExtensionConstraints>>,
    /// Optional. A set of X.509 values that will be applied to all issued certificates that use this template. If the certificate request includes conflicting values for the same properties, they will be overwritten by the values defined here. If the issuing CaPool''s IssuancePolicy defines conflicting baseline_values for the same properties, the certificate issuance request will fail.
    #[serde(default, rename = "predefinedValues")]
    pub predefined_values: ::core::option::Option<::std::boxed::Box<X509Parameters>>,
...
pub struct IssuancePolicy {
    ...
    pub allowed_issuance_modes: ::core::option::Option<::std::boxed::Box<IssuanceModes>>,
    /// Optional. If any AllowedKeyType is specified, then the certificate request''s public key must match one of the key types listed here. Otherwise, any key may be used.
    #[serde(default, rename = "allowedKeyTypes")]
    pub allowed_key_types:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AllowedKeyType>>>,
    ...
    pub baseline_values: ::core::option::Option<::std::boxed::Box<X509Parameters>>,
...
pub struct KeyUsage {
    ...
    pub base_key_usage: ::core::option::Option<::std::boxed::Box<KeyUsageOptions>>,
    /// Detailed scenarios in which a key may be used.
    #[serde(default, rename = "extendedKeyUsage")]
    pub extended_key_usage: ::core::option::Option<::std::boxed::Box<ExtendedKeyUsageOptions>>,
    /// Used to describe extended key usages that are not listed in the KeyUsage.ExtendedKeyUsageOptions message.
    #[serde(default, rename = "unknownExtendedKeyUsages")]
    pub unknown_extended_key_usages:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ObjectId>>>,
}
...
pub struct ListCaPoolsResponse {
    ...
    pub ca_pools: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<CaPool>>>,
...
pub struct ListCertificateAuthoritiesResponse {
    ...
    pub certificate_authorities:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<CertificateAuthority>>>,
    /// A token to retrieve next page of results. Pass this value in ListCertificateAuthoritiesRequest.page_token to retrieve the next page of results.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// A list of locations (e.g. "us-west1") that could not be reached.
...
pub struct ListCertificateRevocationListsResponse {
    ...
    pub certificate_revocation_lists:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<CertificateRevocationList>>>,
...
pub struct ListCertificateTemplatesResponse {
    ...
    pub certificate_templates:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<CertificateTemplate>>>,
...
pub struct RelativeDistinguishedName {
    ...
    #[serde(default)]
    pub attributes:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AttributeTypeAndValue>>>,
}
...
pub struct Subject {
    ...
    pub rdn_sequence:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<RelativeDistinguishedName>>>,
...
pub struct SubjectAltNames {
    ...
    pub custom_sans: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<X509Extension>>>,
...
pub struct SubjectConfig {
    ...
    #[serde(default)]
    pub subject: ::core::option::Option<::std::boxed::Box<Subject>>,
    /// Optional. The subject alternative name fields.
    #[serde(default, rename = "subjectAltName")]
    pub subject_alt_name: ::core::option::Option<::std::boxed::Box<SubjectAltNames>>,
}
...
pub struct SubordinateConfig {
    ...
    pub pem_issuer_chain: ::core::option::Option<::std::boxed::Box<SubordinateConfigChain>>,
}
...
pub struct X509Parameters {
    ...
    pub additional_extensions:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<X509Extension>>>,
    ...
    pub ca_options: ::core::option::Option<::std::boxed::Box<CaOptions>>,
    /// Optional. Indicates the intended use for keys that correspond to a certificate.
    #[serde(default, rename = "keyUsage")]
    pub key_usage: ::core::option::Option<::std::boxed::Box<KeyUsage>>,
    /// Optional. Describes the X.509 name constraints extension.
    #[serde(default, rename = "nameConstraints")]
    pub name_constraints: ::core::option::Option<::std::boxed::Box<NameConstraints>>,
    /// Optional. Describes the X.509 certificate policy object identifiers, per https://tools.ietf.org/html/rfc5280#section-4.2.1.4.
    #[serde(default, rename = "policyIds")]
    pub policy_ids: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ObjectId>>>,
}
