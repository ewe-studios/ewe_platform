...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/networkmanagement/openapi.json`.
...
pub struct ConnectivityTest {
    ...
    #[serde(default)]
    pub destination: ::core::option::Option<::std::boxed::Box<Endpoint>>,
    ...
    pub probing_details: ::core::option::Option<::std::boxed::Box<ProbingDetails>>,
    ...
    pub reachability_details: ::core::option::Option<::std::boxed::Box<ReachabilityDetails>>,
    ...
    pub return_reachability_details: ::core::option::Option<::std::boxed::Box<ReachabilityDetails>>,
    ...
    #[serde(default)]
    pub source: ::core::option::Option<::std::boxed::Box<Endpoint>>,
...
pub struct Endpoint {
    ...
    pub app_engine_version: ::core::option::Option<::std::boxed::Box<AppEngineVersionEndpoint>>,
    /// A [Cloud Function](https://cloud.google.com/functions). Applicable only to source endpoint.
    #[serde(default, rename = "cloudFunction")]
    pub cloud_function: ::core::option::Option<::std::boxed::Box<CloudFunctionEndpoint>>,
    ...
    pub cloud_run_revision: ::core::option::Option<::std::boxed::Box<CloudRunRevisionEndpoint>>,
...
pub struct LatencyDistribution {
    ...
    pub latency_percentiles:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<LatencyPercentile>>>,
}
...
pub struct ListConnectivityTestsResponse {
    ...
    #[serde(default)]
    pub resources: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ConnectivityTest>>>,
...
pub struct ListVpcFlowLogsConfigsResponse {
    ...
    pub vpc_flow_logs_configs:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<VpcFlowLogsConfig>>>,
}
...
pub struct LoadBalancerInfo {
    ...
    #[serde(default)]
    pub backends: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<LoadBalancerBackend>>>,
...
pub struct ProbingDetails {
    ...
    pub destination_egress_location: ::core::option::Option<::std::boxed::Box<EdgeLocation>>,
    /// Probing results for all edge devices.
    #[serde(default, rename = "edgeResponses")]
    pub edge_responses:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SingleEdgeResponse>>>,
    /// The source and destination endpoints derived from the test input and used for active probing.
    #[serde(default, rename = "endpointInfo")]
    pub endpoint_info: ::core::option::Option<::std::boxed::Box<EndpointInfo>>,
    ...
    pub probing_latency: ::core::option::Option<::std::boxed::Box<LatencyDistribution>>,
...
pub struct ReachabilityDetails {
    ...
    #[serde(default)]
    pub traces: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Trace>>>,
...
pub struct ShowEffectiveFlowLogsConfigsResponse {
    ...
    pub effective_flow_logs_configs:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<EffectiveVpcFlowLogsConfig>>>,
    /// Page token to fetch the next set of configurations.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
    /// Locations that could not be reached (when querying all locations with -).
...
pub struct Step {
    ...
    #[serde(default)]
    pub abort: ::core::option::Option<::std::boxed::Box<AbortInfo>>,
    /// Display information of an App Engine service version.
    #[serde(default, rename = "appEngineVersion")]
    pub app_engine_version: ::core::option::Option<::std::boxed::Box<AppEngineVersionInfo>>,
    /// This is a step that leads to the final state Drop.
    #[serde(default, rename = "causesDrop")]
    pub causes_drop: ::core::option::Option<bool>,
    /// Display information of a Cloud Function.
    #[serde(default, rename = "cloudFunction")]
    pub cloud_function: ::core::option::Option<::std::boxed::Box<CloudFunctionInfo>>,
    /// Display information of a Cloud Run revision.
    #[serde(default, rename = "cloudRunRevision")]
    pub cloud_run_revision: ::core::option::Option<::std::boxed::Box<CloudRunRevisionInfo>>,
    /// Display information of a Cloud SQL instance.
    #[serde(default, rename = "cloudSqlInstance")]
    pub cloud_sql_instance: ::core::option::Option<::std::boxed::Box<CloudSQLInstanceInfo>>,
    /// Display information of the final state "deliver" and reason.
    #[serde(default)]
    pub deliver: ::core::option::Option<::std::boxed::Box<DeliverInfo>>,
    ...
    pub direct_vpc_egress_connection:
        ::core::option::Option<::std::boxed::Box<DirectVpcEgressConnectionInfo>>,
    /// Display information of the final state "drop" and reason.
    #[serde(default)]
    pub drop: ::core::option::Option<::std::boxed::Box<DropInfo>>,
    /// Display information of the source and destination under analysis. The endpoint information in an intermediate state may differ with the initial input, as it might be modified by state like NAT, or Connection Proxy.
    #[serde(default)]
    pub endpoint: ::core::option::Option<::std::boxed::Box<EndpointInfo>>,
    /// Display information of a Compute Engine firewall rule.
    #[serde(default)]
    pub firewall: ::core::option::Option<::std::boxed::Box<FirewallInfo>>,
    /// Display information of the final state "forward" and reason.
    #[serde(default)]
    pub forward: ::core::option::Option<::std::boxed::Box<ForwardInfo>>,
    /// Display information of a Compute Engine forwarding rule.
    #[serde(default, rename = "forwardingRule")]
    pub forwarding_rule: ::core::option::Option<::std::boxed::Box<ForwardingRuleInfo>>,
    /// Display information of a Google Kubernetes Engine cluster master.
    #[serde(default, rename = "gkeMaster")]
    pub gke_master: ::core::option::Option<::std::boxed::Box<GKEMasterInfo>>,
    /// Display information of a GKE Network Policy.
    #[serde(default, rename = "gkeNetworkPolicy")]
    pub gke_network_policy: ::core::option::Option<::std::boxed::Box<GkeNetworkPolicyInfo>>,
    ...
    pub gke_network_policy_skipped:
        ::core::option::Option<::std::boxed::Box<GkeNetworkPolicySkippedInfo>>,
    /// Display information of a Google Kubernetes Engine Pod.
    #[serde(default, rename = "gkePod")]
    pub gke_pod: ::core::option::Option<::std::boxed::Box<GkePodInfo>>,
    /// Display information of a Google service
    #[serde(default, rename = "googleService")]
    pub google_service: ::core::option::Option<::std::boxed::Box<GoogleServiceInfo>>,
    /// Display information of a hybrid subnet.
    #[serde(default, rename = "hybridSubnet")]
    pub hybrid_subnet: ::core::option::Option<::std::boxed::Box<HybridSubnetInfo>>,
    /// Display information of a Compute Engine instance.
    #[serde(default)]
    pub instance: ::core::option::Option<::std::boxed::Box<InstanceInfo>>,
    /// Display information of an interconnect attachment.
    #[serde(default, rename = "interconnectAttachment")]
    pub interconnect_attachment:
        ::core::option::Option<::std::boxed::Box<InterconnectAttachmentInfo>>,
    /// Display information of the reason why GKE Pod IP masquerading was skipped.
    #[serde(default, rename = "ipMasqueradingSkipped")]
    pub ip_masquerading_skipped:
        ::core::option::Option<::std::boxed::Box<IpMasqueradingSkippedInfo>>,
    ...
    pub load_balancer: ::core::option::Option<::std::boxed::Box<LoadBalancerInfo>>,
    /// Display information of a specific load balancer backend.
    #[serde(default, rename = "loadBalancerBackendInfo")]
    pub load_balancer_backend_info:
        ::core::option::Option<::std::boxed::Box<LoadBalancerBackendInfo>>,
    /// Display information of a NAT.
    #[serde(default)]
    pub nat: ::core::option::Option<::std::boxed::Box<NatInfo>>,
    /// Display information of a Google Cloud network.
    #[serde(default)]
    pub network: ::core::option::Option<::std::boxed::Box<NetworkInfo>>,
    /// Display information of a layer 7 packet inspection by the firewall.
    #[serde(default, rename = "ngfwPacketInspection")]
    pub ngfw_packet_inspection: ::core::option::Option<::std::boxed::Box<NgfwPacketInspectionInfo>>,
    /// Project ID that contains the configuration this step is validating.
    #[serde(default, rename = "projectId")]
    pub project_id: ::core::option::Option<String>,
    /// Display information of a ProxyConnection.
    #[serde(default, rename = "proxyConnection")]
    pub proxy_connection: ::core::option::Option<::std::boxed::Box<ProxyConnectionInfo>>,
    /// Display information of a Redis Cluster.
    #[serde(default, rename = "redisCluster")]
    pub redis_cluster: ::core::option::Option<::std::boxed::Box<RedisClusterInfo>>,
    /// Display information of a Redis Instance.
    #[serde(default, rename = "redisInstance")]
    pub redis_instance: ::core::option::Option<::std::boxed::Box<RedisInstanceInfo>>,
    /// Display information of a Compute Engine route.
    #[serde(default)]
    pub route: ::core::option::Option<::std::boxed::Box<RouteInfo>>,
    /// Display information of a serverless public (external) connection.
    #[serde(default, rename = "serverlessExternalConnection")]
    pub serverless_external_connection:
        ::core::option::Option<::std::boxed::Box<ServerlessExternalConnectionInfo>>,
    ...
    pub serverless_neg: ::core::option::Option<::std::boxed::Box<ServerlessNegInfo>>,
    ...
    #[serde(default, rename = "storageBucket")]
    pub storage_bucket: ::core::option::Option<::std::boxed::Box<StorageBucketInfo>>,
    /// Display information of a VPC connector.
    #[serde(default, rename = "vpcConnector")]
    pub vpc_connector: ::core::option::Option<::std::boxed::Box<VpcConnectorInfo>>,
    /// Display information of a Compute Engine VPN gateway.
    #[serde(default, rename = "vpnGateway")]
    pub vpn_gateway: ::core::option::Option<::std::boxed::Box<VpnGatewayInfo>>,
    /// Display information of a Compute Engine VPN tunnel.
    #[serde(default, rename = "vpnTunnel")]
    pub vpn_tunnel: ::core::option::Option<::std::boxed::Box<VpnTunnelInfo>>,
}
