...
pub struct DnsKeysListResponse {
    ...
    pub dns_keys: ::core::option::Option<::std::vec::Vec<DnsKey>>,
    /// Type of resource.
    #[serde(default)]
    pub kind: ::core::option::Option<String>,
    /// This field indicates that more results are available beyond the last page displayed. To fetch the results, make another list request and use this value as your page token. This lets you retrieve the complete contents of a very large collection one page at a time. However, if the contents of the collection change between the first and last paginated list request, the set of all elements returned are an inconsistent view of the collection. You can''t retrieve a consistent snapshot of a collection larger than the maximum page size.
...
pub struct GoogleIamV1GetIamPolicyRequest {
    ...
    #[serde(default)]
    pub options: ::core::option::Option<GoogleIamV1GetPolicyOptions>,
}
...
pub struct ManagedZonesListResponse {
    ...
    pub managed_zones: ::core::option::Option<::std::vec::Vec<ManagedZone>>,
    /// This field indicates that more results are available beyond the last page displayed. To fetch the results, make another list request and use this value as your page token. This lets you retrieve the complete contents of a very large collection one page at a time. However, if the contents of the collection change between the first and last paginated list request, the set of all elements returned are an inconsistent view of the collection. You can''t retrieve a consistent snapshot of a collection larger than the maximum page size.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct ResourceRecordSetsListResponse {
    ...
    #[serde(default)]
    pub rrsets: ::core::option::Option<::std::vec::Vec<ResourceRecordSet>>,
}
...
pub struct ResponsePoliciesListResponse {
    ...
    pub response_policies: ::core::option::Option<::std::vec::Vec<ResponsePolicy>>,
}
...
pub struct ResponsePolicyRulesListResponse {
    ...
    pub response_policy_rules: ::core::option::Option<::std::vec::Vec<ResponsePolicyRule>>,
}
...
pub struct Change {
    ...
    #[serde(default)]
    pub additions: ::core::option::Option<::std::vec::Vec<ResourceRecordSet>>,
    /// Which ResourceRecordSets to remove? Must match existing data exactly.
    #[serde(default)]
    pub deletions: ::core::option::Option<::std::vec::Vec<ResourceRecordSet>>,
...
pub struct Operation {
    ...
    pub dns_key_context: ::core::option::Option<OperationDnsKeyContext>,
    ...
    pub zone_context: ::core::option::Option<OperationManagedZoneContext>,
}
...
pub struct Policy {
    ...
    pub alternative_name_server_config: ::core::option::Option<PolicyAlternativeNameServerConfig>,
    /// A mutable string of at most 1024 characters associated with this resource for the user''s convenience. Has no effect on the policy''s function.
    #[serde(default)]
    pub description: ::core::option::Option<String>,
    /// Configurations related to DNS64 for this policy.
    #[serde(default, rename = "dns64Config")]
    pub dns64_config: ::core::option::Option<PolicyDns64Config>,
    ...
    #[serde(default)]
    pub networks: ::core::option::Option<::std::vec::Vec<PolicyNetwork>>,
}
...
pub struct Quota {
    ...
    pub whitelisted_key_specs: ::core::option::Option<::std::vec::Vec<DnsKeySpec>>,
}
...
pub struct ResponsePolicy {
    ...
    pub gke_clusters: ::core::option::Option<::std::vec::Vec<ResponsePolicyGKECluster>>,
    /// Unique identifier for the resource; defined by the server (output only).
    #[serde(default)]
    pub id: ::core::option::Option<String>,
    #[serde(default)]
    ...
    /// List of network names specifying networks to which this policy is applied.
    #[serde(default)]
    pub networks: ::core::option::Option<::std::vec::Vec<ResponsePolicyNetwork>>,
...
pub struct ResponsePolicyRule {
    ...
    pub local_data: ::core::option::Option<ResponsePolicyRuleLocalData>,
...
pub struct OperationDnsKeyContext {
    ...
    pub new_value: ::core::option::Option<DnsKey>,
    /// The pre-operation DnsKey resource.
    #[serde(default, rename = "oldValue")]
    pub old_value: ::core::option::Option<DnsKey>,
}
...
pub struct OperationManagedZoneContext {
    ...
    #[serde(default, rename = "newValue")]
    pub new_value: ::core::option::Option<ManagedZone>,
    /// The pre-operation ManagedZone resource.
    #[serde(default, rename = "oldValue")]
    pub old_value: ::core::option::Option<ManagedZone>,
}
...
pub struct PolicyAlternativeNameServerConfig {
    ...
    pub target_name_servers:
        ::core::option::Option<::std::vec::Vec<PolicyAlternativeNameServerConfigTargetNameServer>>,
}
...
pub struct PolicyDns64Config {
    ...
    #[serde(default)]
    pub scope: ::core::option::Option<PolicyDns64ConfigScope>,
}
...
pub struct ResponsePolicyRuleLocalData {
    ...
    pub local_datas: ::core::option::Option<::std::vec::Vec<ResourceRecordSet>>,
}
...
pub struct DnsKey {
    ...
    #[serde(default)]
    pub digests: ::core::option::Option<::std::vec::Vec<DnsKeyDigest>>,
    /// Unique identifier for the resource; defined by the server (output only).
    #[serde(default)]
    pub id: ::core::option::Option<String>,
...
pub struct ManagedZone {
    ...
    pub dnssec_config: ::core::option::Option<ManagedZoneDnsSecConfig>,
    /// The presence for this field indicates that outbound forwarding is enabled for this zone. The value of this field contains the set of destinations to forward to.
    #[serde(default, rename = "forwardingConfig")]
    pub forwarding_config: ::core::option::Option<ManagedZoneForwardingConfig>,
    /// Unique identifier for the resource; defined by the server (output only)
    #[serde(default)]
    pub id: ::core::option::Option<String>,
    #[serde(default)]
    ...
    pub peering_config: ::core::option::Option<ManagedZonePeeringConfig>,
    /// For privately visible zones, the set of Virtual Private Cloud resources that the zone is visible from.
    #[serde(default, rename = "privateVisibilityConfig")]
    pub private_visibility_config: ::core::option::Option<ManagedZonePrivateVisibilityConfig>,
    /// The presence of this field indicates that this is a managed reverse lookup zone and Cloud DNS resolves reverse lookup queries using automatically configured records for VPC resources. This only applies to networks listed under private_visibility_config.
    #[serde(default, rename = "reverseLookupConfig")]
    pub reverse_lookup_config: ::core::option::Option<ManagedZoneReverseLookupConfig>,
    /// This field links to the associated service directory namespace. Do not set this field for public zones or forwarding zones.
    #[serde(default, rename = "serviceDirectoryConfig")]
    pub service_directory_config: ::core::option::Option<ManagedZoneServiceDirectoryConfig>,
...
pub struct ManagedZoneDnsSecConfig {
    ...
    pub default_key_specs: ::core::option::Option<::std::vec::Vec<DnsKeySpec>>,
    #[serde(default)]
    pub kind: ::core::option::Option<String>,
...
pub struct ManagedZoneForwardingConfig {
    ...
    #[serde(default, rename = "targetNameServers")]
    pub target_name_servers:
        ::core::option::Option<::std::vec::Vec<ManagedZoneForwardingConfigNameServerTarget>>,
}
...
pub struct ManagedZonePeeringConfig {
    ...
    pub target_network: ::core::option::Option<ManagedZonePeeringConfigTargetNetwork>,
}
...
pub struct ManagedZonePrivateVisibilityConfig {
    ...
    #[serde(default, rename = "gkeClusters")]
    pub gke_clusters:
        ::core::option::Option<::std::vec::Vec<ManagedZonePrivateVisibilityConfigGKECluster>>,
    #[serde(default)]
    pub kind: ::core::option::Option<String>,
    /// The list of VPC networks that can see this zone.
    #[serde(default)]
    pub networks:
        ::core::option::Option<::std::vec::Vec<ManagedZonePrivateVisibilityConfigNetwork>>,
}
...
pub struct ManagedZoneServiceDirectoryConfig {
    ...
    #[serde(default)]
    pub namespace: ::core::option::Option<ManagedZoneServiceDirectoryConfigNamespace>,
}
...
pub struct RRSetRoutingPolicy {
    ...
    pub primary_backup: ::core::option::Option<RRSetRoutingPolicyPrimaryBackupPolicy>,
    #[serde(default)]
    pub wrr: ::core::option::Option<RRSetRoutingPolicyWrrPolicy>,
}
...
pub struct RRSetRoutingPolicyPrimaryBackupPolicy {
    ...
    pub backup_geo_targets: ::core::option::Option<RRSetRoutingPolicyGeoPolicy>,
    #[serde(default)]
    pub kind: ::core::option::Option<String>,
    ...
    pub primary_targets: ::core::option::Option<RRSetRoutingPolicyHealthCheckTargets>,
...
pub struct RRSetRoutingPolicyGeoPolicy {
    ...
    #[serde(default)]
    pub items: ::core::option::Option<::std::vec::Vec<RRSetRoutingPolicyGeoPolicyGeoPolicyItem>>,
    #[serde(default)]
    pub kind: ::core::option::Option<String>,
}
...
pub struct RRSetRoutingPolicyWrrPolicyWrrPolicyItem {
    ...
    pub health_checked_targets: ::core::option::Option<RRSetRoutingPolicyHealthCheckTargets>,
    #[serde(default)]
    pub kind: ::core::option::Option<String>,
    #[serde(default)]
    pub rrdatas: ::core::option::Option<::std::vec::Vec<String>>,
...
pub struct RRSetRoutingPolicyHealthCheckTargets {
    ...
    pub internal_load_balancers:
        ::core::option::Option<::std::vec::Vec<RRSetRoutingPolicyLoadBalancerTarget>>,
}
