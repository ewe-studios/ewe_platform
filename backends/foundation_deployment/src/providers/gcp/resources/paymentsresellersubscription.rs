...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/paymentsresellersubscription/openapi.json`.
...
pub struct CreateSubscriptionIntent {
    ...
    pub cycle_options: ::core::option::Option<::std::boxed::Box<CycleOptions>>,
...
pub struct CycleOptions {
    ...
    pub initial_cycle_duration: ::core::option::Option<::std::boxed::Box<Duration>>,
}
...
pub struct EntitleSubscriptionRequest {
    ...
    pub line_item_entitlement_details: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<EntitleSubscriptionRequestLineItemEntitlementDetails>>,
    >,
}
...
pub struct ExtendSubscriptionRequest {
    ...
    #[serde(default)]
    pub extension: ::core::option::Option<::std::boxed::Box<Extension>>,
...
pub struct GenerateUserSessionRequest {
    ...
    pub intent_payload: ::core::option::Option<::std::boxed::Box<IntentPayload>>,
}
...
pub struct GenerateUserSessionResponse {
    ...
    pub user_session: ::core::option::Option<::std::boxed::Box<UserSession>>,
}
...
pub struct IntentPayload {
    ...
    pub create_intent: ::core::option::Option<::std::boxed::Box<CreateSubscriptionIntent>>,
    /// The request to entitle a subscription.
    #[serde(default, rename = "entitleIntent")]
    pub entitle_intent: ::core::option::Option<::std::boxed::Box<EntitleSubscriptionIntent>>,
    /// Optional. The additional features for the intent.
    #[serde(default, rename = "intentOptions")]
    pub intent_options: ::core::option::Option<::std::boxed::Box<IntentPayloadIntentOptions>>,
}
...
pub struct Product {
    ...
    pub bundle_details: ::core::option::Option<::std::boxed::Box<ProductBundleDetails>>,
    ...
    pub finite_billing_cycle_details:
        ::core::option::Option<::std::boxed::Box<FiniteBillingCycleDetails>>,
    ...
    pub price_configs:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ProductPriceConfig>>>,
    ...
    pub subscription_billing_cycle_duration: ::core::option::Option<::std::boxed::Box<Duration>>,
    /// Output only. Localized human readable name of the product.
    #[serde(default)]
    pub titles: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleTypeLocalizedText>>>,
}
...
pub struct ProductBundleDetails {
    ...
    pub bundle_elements: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<ProductBundleDetailsBundleElement>>,
    >,
...
pub struct ProductPayload {
    ...
    pub google_home_payload: ::core::option::Option<::std::boxed::Box<GoogleHomePayload>>,
    /// Product-specific payloads. Payload specific to Google One products.
    #[serde(default, rename = "googleOnePayload")]
    pub google_one_payload: ::core::option::Option<::std::boxed::Box<GoogleOnePayload>>,
    /// Payload specific to Youtube products.
    #[serde(default, rename = "youtubePayload")]
    pub youtube_payload: ::core::option::Option<::std::boxed::Box<YoutubePayload>>,
}
...
pub struct ProductPriceConfig {
    ...
    #[serde(default)]
    pub amount: ::core::option::Option<::std::boxed::Box<Amount>>,
...
pub struct Promotion {
    ...
    pub free_trial_duration: ::core::option::Option<::std::boxed::Box<Duration>>,
    ...
    pub introductory_pricing_details:
        ::core::option::Option<::std::boxed::Box<PromotionIntroductoryPricingDetails>>,
...
pub struct PromotionIntroductoryPricingDetails {
    ...
    pub introductory_pricing_specs: ::core::option::Option<
        ::std::vec::Vec<
            ::std::boxed::Box<PromotionIntroductoryPricingDetailsIntroductoryPricingSpec>,
        >,
    >,
}
...
pub struct PromotionIntroductoryPricingDetailsIntroductoryPricingSpec {
    ...
    pub discount_amount: ::core::option::Option<::std::boxed::Box<Amount>>,
...
pub struct Subscription {
    ...
    pub cancellation_details:
        ::core::option::Option<::std::boxed::Box<SubscriptionCancellationDetails>>,
    ...
    pub line_items:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SubscriptionLineItem>>>,
    ...
    pub migration_details: ::core::option::Option<::std::boxed::Box<SubscriptionMigrationDetails>>,
    ...
    pub promotion_specs:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SubscriptionPromotionSpec>>>,
    ...
    pub service_location: ::core::option::Option<::std::boxed::Box<Location>>,
    ...
    pub upgrade_downgrade_details:
        ::core::option::Option<::std::boxed::Box<SubscriptionUpgradeDowngradeDetails>>,
}
...
pub struct SubscriptionLineItem {
    ...
    #[serde(default, rename = "bundleDetails")]
    pub bundle_details:
        ::core::option::Option<::std::boxed::Box<SubscriptionLineItemBundleDetails>>,
    ...
    pub one_time_recurrence_details:
        ::core::option::Option<::std::boxed::Box<SubscriptionLineItemOneTimeRecurrenceDetails>>,
    ...
    pub product_payload: ::core::option::Option<::std::boxed::Box<ProductPayload>>,
...
pub struct SubscriptionLineItemBundleDetails {
    ...
    pub bundle_element_details: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<SubscriptionLineItemBundleDetailsBundleElementDetails>>,
    >,
}
...
pub struct SubscriptionLineItemOneTimeRecurrenceDetails {
    ...
    pub service_period: ::core::option::Option<::std::boxed::Box<ServicePeriod>>,
}
