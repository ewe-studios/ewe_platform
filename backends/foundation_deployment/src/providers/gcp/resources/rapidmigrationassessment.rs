...
pub struct Collector {
    ...
    pub guest_os_scan: ::core::option::Option<::std::boxed::Box<GuestOsScan>>,
    /// Labels as key value pairs.
    #[serde(default)]
    pub labels: ::core::option::Option<serde_json::Value>,
    /// name of resource.
    ...
    pub vsphere_scan: ::core::option::Option<::std::boxed::Box<VSphereScan>>,
}
...
pub struct ListCollectorsResponse {
    ...
    #[serde(default)]
    pub collectors: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Collector>>>,
