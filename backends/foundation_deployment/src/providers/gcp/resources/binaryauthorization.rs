//! Auto-generated resource types for Google Cloud Platform - binaryauthorization.
//!
//! This file is generated by `cargo run --bin ewe_platform gen_resource_types`.
//! DO NOT EDIT MANUALLY.
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/binaryauthorization/openapi.json`.
...
pub struct AttestationAuthenticator {
    ...
    pub pkix_public_key_set: ::core::option::Option<::std::boxed::Box<PkixPublicKeySet>>,
}
...
pub struct Attestor {
    ...
    pub user_owned_grafeas_note: ::core::option::Option<::std::boxed::Box<UserOwnedGrafeasNote>>,
}
...
pub struct AttestorPublicKey {
    ...
    pub pkix_public_key: ::core::option::Option<::std::boxed::Box<PkixPublicKey>>,
}
...
pub struct Check {
    ...
    pub image_allowlist: ::core::option::Option<::std::boxed::Box<ImageAllowlist>>,
    ...
    pub image_freshness_check: ::core::option::Option<::std::boxed::Box<ImageFreshnessCheck>>,
    ...
    pub sigstore_signature_check: ::core::option::Option<::std::boxed::Box<SigstoreSignatureCheck>>,
    ...
    pub simple_signing_attestation_check:
        ::core::option::Option<::std::boxed::Box<SimpleSigningAttestationCheck>>,
    ...
    pub slsa_check: ::core::option::Option<::std::boxed::Box<SlsaCheck>>,
    /// Optional. Require that an image lives in a trusted directory.
    #[serde(default, rename = "trustedDirectoryCheck")]
    pub trusted_directory_check: ::core::option::Option<::std::boxed::Box<TrustedDirectoryCheck>>,
    ...
    pub vulnerability_check: ::core::option::Option<::std::boxed::Box<VulnerabilityCheck>>,
}
...
pub struct CheckResult {
    ...
    pub allowlist_result: ::core::option::Option<::std::boxed::Box<AllowlistResult>>,
    /// The name of the check.
    #[serde(default, rename = "displayName")]
    pub display_name: ::core::option::Option<String>,
    /// If a check was evaluated, contains the result of the check.
    #[serde(default, rename = "evaluationResult")]
    pub evaluation_result: ::core::option::Option<::std::boxed::Box<EvaluationResult>>,
...
pub struct CheckResults {
    /// Per-check details.
    #[serde(default)]
    pub results: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<CheckResult>>>,
}
...
pub struct CheckSet {
    ...
    #[serde(default)]
    pub checks: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Check>>>,
    ...
    #[serde(default)]
    pub scope: ::core::option::Option<::std::boxed::Box<Scope>>,
}
...
pub struct CheckSetResult {
    ...
    pub check_results: ::core::option::Option<::std::boxed::Box<CheckResults>>,
...
pub struct EvaluateGkePolicyResponse {
    ...
    #[serde(default)]
    pub results: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PodResult>>>,
...
pub struct GkePolicy {
    ...
    pub check_sets: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<CheckSet>>>,
...
pub struct ImageResult {
    ...
    pub check_set_result: ::core::option::Option<::std::boxed::Box<CheckSetResult>>,
...
pub struct ListAttestorsResponse {
    ...
    #[serde(default)]
    pub attestors: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Attestor>>>,
...
pub struct ListPlatformPoliciesResponse {
    ...
    pub platform_policies:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PlatformPolicy>>>,
}
...
pub struct PkixPublicKeySet {
    ...
    pub pkix_public_keys: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PkixPublicKey>>>,
}
...
pub struct PlatformPolicy {
    ...
    pub gke_policy: ::core::option::Option<::std::boxed::Box<GkePolicy>>,
...
pub struct PodResult {
    ...
    pub image_results: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ImageResult>>>,
...
pub struct Policy {
    ...
    pub admission_whitelist_patterns:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AdmissionWhitelistPattern>>>,
    ...
    #[serde(default, rename = "clusterAdmissionRules")]
    pub cluster_admission_rules: ::core::option::Option<serde_json::Value>,
    /// Required. Default admission rule for a cluster without a per-cluster, per- kubernetes-service-account, or per-istio-service-identity admission rule.
    #[serde(default, rename = "defaultAdmissionRule")]
    pub default_admission_rule: ::core::option::Option<::std::boxed::Box<AdmissionRule>>,
    ...
    #[serde(default)]
    pub etag: ::core::option::Option<String>,
    /// Optional. Controls the evaluation of a Google-maintained global admission policy for common system-level images. Images not covered by the global policy will be subject to the project admission policy. This setting has no effect when specified inside a global admission policy. // TODO: enum values: ["GLOBAL_POLICY_EVALUATION_MODE_UNSPECIFIED", "ENABLE", "DISABLE"]
    #[serde(default, rename = "globalPolicyEvaluationMode")]
    pub global_policy_evaluation_mode: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "istioServiceIdentityAdmissionRules")]
    pub istio_service_identity_admission_rules: ::core::option::Option<serde_json::Value>,
    /// Optional. Per-kubernetes-namespace admission rules. K8s namespace spec format: [a-z.-]+, e.g. some-namespace
    #[serde(default, rename = "kubernetesNamespaceAdmissionRules")]
    pub kubernetes_namespace_admission_rules: ::core::option::Option<serde_json::Value>,
    ...
    #[serde(default, rename = "kubernetesServiceAccountAdmissionRules")]
    pub kubernetes_service_account_admission_rules: ::core::option::Option<serde_json::Value>,
...
pub struct SetIamPolicyRequest {
    ...
    #[serde(default)]
    pub policy: ::core::option::Option<::std::boxed::Box<IamPolicy>>,
}
...
pub struct SigstoreAuthority {
    ...
    pub public_key_set: ::core::option::Option<::std::boxed::Box<SigstorePublicKeySet>>,
}
...
pub struct SigstorePublicKeySet {
    ...
    pub public_keys: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SigstorePublicKey>>>,
}
...
pub struct SigstoreSignatureCheck {
    ...
    pub sigstore_authorities:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SigstoreAuthority>>>,
}
...
pub struct SimpleSigningAttestationCheck {
    ...
    pub attestation_authenticators:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AttestationAuthenticator>>>,
...
pub struct SlsaCheck {
    ...
    #[serde(default)]
    pub rules: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<VerificationRule>>>,
}
...
pub struct UserOwnedGrafeasNote {
    ...
    #[serde(default, rename = "publicKeys")]
    pub public_keys: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<AttestorPublicKey>>>,
}
...
pub struct VerificationRule {
    ...
    pub attestation_source: ::core::option::Option<::std::boxed::Box<AttestationSource>>,
    ...
    #[serde(default, rename = "configBasedBuildRequired")]
    pub config_based_build_required: ::core::option::Option<bool>,
    ...
    pub custom_constraints: ::core::option::Option<String>,
    /// Each verification rule is used for evaluation against provenances generated by a specific builder (group). For some of the builders, such as the Google Cloud Build, users don''t need to explicitly specify their roots of trust in the policy since the evaluation service can automatically fetch them based on the builder (group). // TODO: enum values: ["BUILDER_UNSPECIFIED", "GOOGLE_CLOUD_BUILD"]
    #[serde(default, rename = "trustedBuilder")]
    pub trusted_builder: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "trustedSourceRepoPatterns")]
