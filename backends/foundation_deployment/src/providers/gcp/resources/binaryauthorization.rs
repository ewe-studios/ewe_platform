...
pub struct EvaluateGkePolicyResponse {
    ...
    #[serde(default)]
    pub results: ::core::option::Option<::std::vec::Vec<PodResult>>,
...
pub struct ListAttestorsResponse {
    ...
    #[serde(default)]
    pub attestors: ::core::option::Option<::std::vec::Vec<Attestor>>,
...
pub struct Policy {
    ...
    pub admission_whitelist_patterns:
        ::core::option::Option<::std::vec::Vec<AdmissionWhitelistPattern>>,
...
pub struct SigstoreSignatureCheck {
    ...
    pub sigstore_authorities: ::core::option::Option<::std::vec::Vec<SigstoreAuthority>>,
}
...
pub struct SimpleSigningAttestationCheck {
    ...
    pub attestation_authenticators:
        ::core::option::Option<::std::vec::Vec<AttestationAuthenticator>>,
...
pub struct VerificationRule {
    ...
    pub attestation_source: ::core::option::Option<AttestationSource>,
