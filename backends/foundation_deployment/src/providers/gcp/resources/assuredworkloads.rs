...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/assuredworkloads/openapi.json`.
...
pub struct GoogleCloudAssuredworkloadsV1AnalyzeWorkloadMoveResponse {
    ...
    pub asset_move_analyses: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudAssuredworkloadsV1AssetMoveAnalysis>>,
    >,
...
pub struct GoogleCloudAssuredworkloadsV1ApplyWorkloadUpdateResponse {
    ...
    pub applied_update:
        ::core::option::Option<::std::boxed::Box<GoogleCloudAssuredworkloadsV1WorkloadUpdate>>,
}
...
pub struct GoogleCloudAssuredworkloadsV1AssetMoveAnalysis {
    ...
    pub analysis_groups: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudAssuredworkloadsV1MoveAnalysisGroup>>,
    >,
...
pub struct GoogleCloudAssuredworkloadsV1ListViolationsResponse {
    ...
    pub violations: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudAssuredworkloadsV1Violation>>,
    >,
}
...
pub struct GoogleCloudAssuredworkloadsV1ListWorkloadUpdatesResponse {
    ...
    pub workload_updates: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudAssuredworkloadsV1WorkloadUpdate>>,
    >,
}
...
pub struct GoogleCloudAssuredworkloadsV1ListWorkloadsResponse {
    ...
    #[serde(default)]
    pub workloads: ::core::option::Option<
...
pub struct GoogleCloudAssuredworkloadsV1MoveAnalysisGroup {
    ...
    pub analysis_result:
        ::core::option::Option<::std::boxed::Box<GoogleCloudAssuredworkloadsV1MoveAnalysisResult>>,
...
pub struct GoogleCloudAssuredworkloadsV1MoveAnalysisResult {
    ...
    #[serde(default)]
    pub blockers: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudAssuredworkloadsV1MoveImpact>>,
    >,
...
pub struct GoogleCloudAssuredworkloadsV1MutatePartnerPermissionsRequest {
    ...
    pub partner_permissions: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudAssuredworkloadsV1WorkloadPartnerPermissions>,
    >,
...
pub struct GoogleCloudAssuredworkloadsV1OrgPolicy {
    ...
    #[serde(default)]
    pub rule:
        ::core::option::Option<::std::boxed::Box<GoogleCloudAssuredworkloadsV1OrgPolicyPolicyRule>>,
}
...
pub struct GoogleCloudAssuredworkloadsV1OrgPolicyPolicyRule {
    ...
    pub values: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudAssuredworkloadsV1OrgPolicyPolicyRuleStringValues>,
    >,
}
...
pub struct GoogleCloudAssuredworkloadsV1UpdateDetails {
    ...
    pub org_policy_update:
        ::core::option::Option<::std::boxed::Box<GoogleCloudAssuredworkloadsV1OrgPolicyUpdate>>,
}
...
pub struct GoogleCloudAssuredworkloadsV1Violation {
    ...
    pub exception_contexts: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudAssuredworkloadsV1ViolationExceptionContext>>,
    >,
    ...
    #[serde(default)]
    pub remediation: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudAssuredworkloadsV1ViolationRemediation>,
    >,
...
pub struct GoogleCloudAssuredworkloadsV1ViolationRemediation {
    ...
    pub instructions: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudAssuredworkloadsV1ViolationRemediationInstructions>,
    >,
...
pub struct GoogleCloudAssuredworkloadsV1ViolationRemediationInstructions {
    ...
    pub console_instructions: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudAssuredworkloadsV1ViolationRemediationInstructionsConsole>,
    >,
    /// Remediation instructions to resolve violation via gcloud cli
    #[serde(default, rename = "gcloudInstructions")]
    pub gcloud_instructions: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudAssuredworkloadsV1ViolationRemediationInstructionsGcloud>,
    >,
}
...
pub struct GoogleCloudAssuredworkloadsV1Workload {
    ...
    pub compliance_status: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudAssuredworkloadsV1WorkloadComplianceStatus>,
    >,
    ...
    pub ekm_provisioning_response: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudAssuredworkloadsV1WorkloadEkmProvisioningResponse>,
    >,
    ...
    pub kms_settings:
        ::core::option::Option<::std::boxed::Box<GoogleCloudAssuredworkloadsV1WorkloadKMSSettings>>,
    ...
    pub resource_settings: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudAssuredworkloadsV1WorkloadResourceSettings>>,
    >,
    ...
    pub saa_enrollment_response: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudAssuredworkloadsV1WorkloadSaaEnrollmentResponse>,
    >,
    ...
    pub workload_options: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudAssuredworkloadsV1WorkloadWorkloadOptions>,
    >,
}
...
pub struct GoogleCloudAssuredworkloadsV1WorkloadUpdate {
    ...
    #[serde(default)]
    pub details:
        ::core::option::Option<::std::boxed::Box<GoogleCloudAssuredworkloadsV1UpdateDetails>>,
