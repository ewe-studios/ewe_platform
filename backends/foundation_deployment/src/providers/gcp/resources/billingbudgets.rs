...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/billingbudgets/openapi.json`.
...
pub struct GoogleCloudBillingBudgetsV1Budget {
    ...
    #[serde(default)]
    pub amount: ::core::option::Option<::std::boxed::Box<GoogleCloudBillingBudgetsV1BudgetAmount>>,
    /// Optional. Filters that define which resources are used to compute the actual spend against the budget amount, such as projects, services, and the budget''s time period, as well as other filters.
    #[serde(default, rename = "budgetFilter")]
    pub budget_filter: ::core::option::Option<::std::boxed::Box<GoogleCloudBillingBudgetsV1Filter>>,
    ...
    pub notifications_rule:
        ::core::option::Option<::std::boxed::Box<GoogleCloudBillingBudgetsV1NotificationsRule>>,
    ...
    pub threshold_rules: ::core::option::Option<
...
pub struct GoogleCloudBillingBudgetsV1BudgetAmount {
    ...
    pub specified_amount: ::core::option::Option<::std::boxed::Box<GoogleTypeMoney>>,
}
...
pub struct GoogleCloudBillingBudgetsV1Filter {
    ...
    pub custom_period:
        ::core::option::Option<::std::boxed::Box<GoogleCloudBillingBudgetsV1CustomPeriod>>,
...
pub struct GoogleCloudBillingBudgetsV1ListBudgetsResponse {
    ...
    #[serde(default)]
    pub budgets: ::core::option::Option<
