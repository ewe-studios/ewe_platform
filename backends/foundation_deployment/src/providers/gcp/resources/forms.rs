...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/forms/openapi.json`.
...
pub struct Answer {
    ...
    pub file_upload_answers: ::core::option::Option<::std::boxed::Box<FileUploadAnswers>>,
    /// Output only. The grade for the answer if the form was a quiz.
    #[serde(default)]
    pub grade: ::core::option::Option<::std::boxed::Box<Grade>>,
    ...
    pub text_answers: ::core::option::Option<::std::boxed::Box<TextAnswers>>,
}
...
pub struct CorrectAnswers {
    ...
    #[serde(default)]
    pub answers: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<CorrectAnswer>>>,
}
...
pub struct CreateWatchRequest {
    ...
    #[serde(default)]
    pub watch: ::core::option::Option<::std::boxed::Box<Watch>>,
...
pub struct ExtraMaterial {
    /// Text feedback.
    #[serde(default)]
    pub link: ::core::option::Option<::std::boxed::Box<TextLink>>,
    /// Video feedback.
    #[serde(default)]
    pub video: ::core::option::Option<::std::boxed::Box<VideoLink>>,
}
...
pub struct Feedback {
    ...
    #[serde(default)]
    pub material: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ExtraMaterial>>>,
...
pub struct FileUploadAnswers {
    ...
    #[serde(default)]
    pub answers: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<FileUploadAnswer>>>,
}
...
pub struct Form {
    ...
    #[serde(default)]
    pub info: ::core::option::Option<::std::boxed::Box<Info>>,
    ...
    pub publish_settings: ::core::option::Option<::std::boxed::Box<PublishSettings>>,
    ...
    #[serde(default)]
    pub settings: ::core::option::Option<::std::boxed::Box<FormSettings>>,
}
...
pub struct FormSettings {
    ...
    pub quiz_settings: ::core::option::Option<::std::boxed::Box<QuizSettings>>,
}
...
pub struct Grade {
    ...
    #[serde(default)]
    pub feedback: ::core::option::Option<::std::boxed::Box<Feedback>>,
...
pub struct Grading {
    ...
    pub correct_answers: ::core::option::Option<::std::boxed::Box<CorrectAnswers>>,
    ...
    pub general_feedback: ::core::option::Option<::std::boxed::Box<Feedback>>,
    ...
    pub when_right: ::core::option::Option<::std::boxed::Box<Feedback>>,
    ...
    pub when_wrong: ::core::option::Option<::std::boxed::Box<Feedback>>,
}
...
pub struct Grid {
    ...
    #[serde(default)]
    pub columns: ::core::option::Option<::std::boxed::Box<ChoiceQuestion>>,
...
pub struct Image {
    ...
    #[serde(default)]
    pub properties: ::core::option::Option<::std::boxed::Box<MediaProperties>>,
...
pub struct Item {
    ...
    pub image_item: ::core::option::Option<::std::boxed::Box<ImageItem>>,
    ...
    pub question_group_item: ::core::option::Option<::std::boxed::Box<QuestionGroupItem>>,
    /// Poses a question to the user.
    #[serde(default, rename = "questionItem")]
    pub question_item: ::core::option::Option<::std::boxed::Box<QuestionItem>>,
    ...
    pub video_item: ::core::option::Option<::std::boxed::Box<VideoItem>>,
}
...
pub struct ListFormResponsesResponse {
    ...
    #[serde(default)]
    pub responses: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<FormResponse>>>,
}
...
pub struct ListWatchesResponse {
    ...
    #[serde(default)]
    pub watches: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Watch>>>,
}
...
pub struct MoveItemRequest {
    ...
    pub new_location: ::core::option::Option<::std::boxed::Box<Location>>,
    /// Required. The location of the item to move.
    #[serde(default, rename = "originalLocation")]
    pub original_location: ::core::option::Option<::std::boxed::Box<Location>>,
}
...
pub struct PublishSettings {
    ...
    pub publish_state: ::core::option::Option<::std::boxed::Box<PublishState>>,
}
...
pub struct Question {
    ...
    pub choice_question: ::core::option::Option<::std::boxed::Box<ChoiceQuestion>>,
    /// A respondent can enter a date.
    #[serde(default, rename = "dateQuestion")]
    pub date_question: ::core::option::Option<::std::boxed::Box<DateQuestion>>,
    /// A respondent can upload one or more files.
    #[serde(default, rename = "fileUploadQuestion")]
    pub file_upload_question: ::core::option::Option<::std::boxed::Box<FileUploadQuestion>>,
    /// Grading setup for the question.
    #[serde(default)]
    pub grading: ::core::option::Option<::std::boxed::Box<Grading>>,
    ...
    pub rating_question: ::core::option::Option<::std::boxed::Box<RatingQuestion>>,
    ...
    pub row_question: ::core::option::Option<::std::boxed::Box<RowQuestion>>,
    /// A respondent can choose a number from a range.
    #[serde(default, rename = "scaleQuestion")]
    pub scale_question: ::core::option::Option<::std::boxed::Box<ScaleQuestion>>,
    /// A respondent can enter a free text response.
    #[serde(default, rename = "textQuestion")]
    pub text_question: ::core::option::Option<::std::boxed::Box<TextQuestion>>,
    /// A respondent can enter a time.
    #[serde(default, rename = "timeQuestion")]
    pub time_question: ::core::option::Option<::std::boxed::Box<TimeQuestion>>,
}
...
pub struct QuestionGroupItem {
    ...
    #[serde(default)]
    pub grid: ::core::option::Option<::std::boxed::Box<Grid>>,
...
pub struct QuestionItem {
    ...
    #[serde(default)]
    pub question: ::core::option::Option<::std::boxed::Box<Question>>,
}
...
pub struct Request {
    ...
    pub create_item: ::core::option::Option<::std::boxed::Box<CreateItemRequest>>,
    /// Delete an item.
    #[serde(default, rename = "deleteItem")]
    pub delete_item: ::core::option::Option<::std::boxed::Box<DeleteItemRequest>>,
    /// Move an item to a specified location.
    #[serde(default, rename = "moveItem")]
    pub move_item: ::core::option::Option<::std::boxed::Box<MoveItemRequest>>,
    /// Update Form''s Info.
    #[serde(default, rename = "updateFormInfo")]
    pub update_form_info: ::core::option::Option<::std::boxed::Box<UpdateFormInfoRequest>>,
    /// Update an item.
    #[serde(default, rename = "updateItem")]
    pub update_item: ::core::option::Option<::std::boxed::Box<UpdateItemRequest>>,
    /// Updates the Form''s settings.
    #[serde(default, rename = "updateSettings")]
    pub update_settings: ::core::option::Option<::std::boxed::Box<UpdateSettingsRequest>>,
}
...
pub struct Response {
    /// The result of creating an item.
    #[serde(default, rename = "createItem")]
    pub create_item: ::core::option::Option<::std::boxed::Box<CreateItemResponse>>,
}
...
pub struct TextAnswers {
    ...
    #[serde(default)]
    pub answers: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TextAnswer>>>,
}
...
pub struct Watch {
    ...
    #[serde(default)]
    pub target: ::core::option::Option<::std::boxed::Box<WatchTarget>>,
}
...
pub struct WatchTarget {
    ...
    #[serde(default)]
    pub topic: ::core::option::Option<::std::boxed::Box<CloudPubsubTopic>>,
}
