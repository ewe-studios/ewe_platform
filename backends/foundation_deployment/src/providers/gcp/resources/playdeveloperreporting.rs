...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/playdeveloperreporting/openapi.json`.
...
pub struct GooglePlayDeveloperReportingV1beta1Anomaly {
    ...
    pub dimensions: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GooglePlayDeveloperReportingV1beta1DimensionValue>>,
    >,
    /// Metric where the anomaly was detected, together with the anomalous value.
    #[serde(default)]
    pub metric:
        ::core::option::Option<::std::boxed::Box<GooglePlayDeveloperReportingV1beta1MetricValue>>,
    ...
    pub timeline_spec:
        ::core::option::Option<::std::boxed::Box<GooglePlayDeveloperReportingV1beta1TimelineSpec>>,
}
...
pub struct GooglePlayDeveloperReportingV1beta1AnrRateMetricSet {
    ...
    pub freshness_info:
        ::core::option::Option<::std::boxed::Box<GooglePlayDeveloperReportingV1beta1FreshnessInfo>>,
...
pub struct GooglePlayDeveloperReportingV1beta1DecimalConfidenceInterval {
    ...
    pub lower_bound: ::core::option::Option<::std::boxed::Box<GoogleTypeDecimal>>,
    /// The confidence interval''s upper bound.
    #[serde(default, rename = "upperBound")]
    pub upper_bound: ::core::option::Option<::std::boxed::Box<GoogleTypeDecimal>>,
}
...
pub struct GooglePlayDeveloperReportingV1beta1DeviceModelSummary {
    ...
    pub device_id:
        ::core::option::Option<::std::boxed::Box<GooglePlayDeveloperReportingV1beta1DeviceId>>,
...
pub struct GooglePlayDeveloperReportingV1beta1ErrorIssue {
    ...
    pub annotations: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GooglePlayDeveloperReportingV1beta1IssueAnnotation>>,
    >,
    ...
    pub distinct_users_percent: ::core::option::Option<::std::boxed::Box<GoogleTypeDecimal>>,
    ...
    pub first_app_version:
        ::core::option::Option<::std::boxed::Box<GooglePlayDeveloperReportingV1beta1AppVersion>>,
    ...
    pub first_os_version:
        ::core::option::Option<::std::boxed::Box<GooglePlayDeveloperReportingV1beta1OsVersion>>,
...
pub struct GooglePlayDeveloperReportingV1beta1ErrorReport {
    ...
    pub device_model: ::core::option::Option<
        ::std::boxed::Box<GooglePlayDeveloperReportingV1beta1DeviceModelSummary>,
    >,
...
pub struct GooglePlayDeveloperReportingV1beta1FreshnessInfo {
    ...
    pub freshnesses: ::core::option::Option<
        ::std::vec::Vec<
            ::std::boxed::Box<GooglePlayDeveloperReportingV1beta1FreshnessInfoFreshness>,
        >,
    >,
}
...
pub struct GooglePlayDeveloperReportingV1beta1FreshnessInfoFreshness {
    ...
    pub latest_end_time: ::core::option::Option<::std::boxed::Box<GoogleTypeDateTime>>,
}
...
pub struct GooglePlayDeveloperReportingV1beta1ListAnomaliesResponse {
    ...
    #[serde(default)]
    pub anomalies: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GooglePlayDeveloperReportingV1beta1Anomaly>>,
    >,
...
pub struct GooglePlayDeveloperReportingV1beta1MetricValue {
    ...
    pub decimal_value_confidence_interval: ::core::option::Option<
        ::std::boxed::Box<GooglePlayDeveloperReportingV1beta1DecimalConfidenceInterval>,
    >,
    /// Name of the metric.
    #[serde(default)]
...
pub struct GooglePlayDeveloperReportingV1beta1MetricsRow {
    ...
    pub metrics: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GooglePlayDeveloperReportingV1beta1MetricValue>>,
    >,
    /// Optional. Starting date (and time for hourly aggregation) of the period covered by this row.
    #[serde(default, rename = "startTime")]
    pub start_time: ::core::option::Option<::std::boxed::Box<GoogleTypeDateTime>>,
}
...
pub struct GooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetResponse {
    ...
    pub rows: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GooglePlayDeveloperReportingV1beta1MetricsRow>>,
    >,
}
...
pub struct GooglePlayDeveloperReportingV1beta1ReleaseFilterOptions {
    ...
    pub tracks: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GooglePlayDeveloperReportingV1beta1Track>>,
    >,
}
...
pub struct GooglePlayDeveloperReportingV1beta1SearchAccessibleAppsResponse {
    ...
    #[serde(default)]
    pub apps: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GooglePlayDeveloperReportingV1beta1App>>,
    >,
...
pub struct GooglePlayDeveloperReportingV1beta1SearchErrorIssuesResponse {
    ...
    pub error_issues: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GooglePlayDeveloperReportingV1beta1ErrorIssue>>,
    >,
    /// Continuation token to fetch the next page of data.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
...
pub struct GooglePlayDeveloperReportingV1beta1SearchErrorReportsResponse {
    ...
    pub error_reports: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GooglePlayDeveloperReportingV1beta1ErrorReport>>,
    >,
...
pub struct GooglePlayDeveloperReportingV1beta1TimelineSpec {
    ...
    pub end_time: ::core::option::Option<::std::boxed::Box<GoogleTypeDateTime>>,
...
pub struct GooglePlayDeveloperReportingV1beta1Track {
    ...
    pub serving_releases: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GooglePlayDeveloperReportingV1beta1Release>>,
    >,
