...
pub struct BatchQueryDomainStatsRequest {
    ...
    #[serde(default)]
    pub requests: ::core::option::Option<::std::vec::Vec<QueryDomainStatsRequest>>,
}
...
pub struct DomainComplianceStatus {
    ...
    pub compliance_data: ::core::option::Option<DomainComplianceData>,
...
pub struct QueryDomainStatsRequest {
    ...
    pub metric_definitions: ::core::option::Option<::std::vec::Vec<MetricDefinition>>,
...
pub struct QueryDomainStatsResponse {
    ...
    pub domain_stats: ::core::option::Option<::std::vec::Vec<DomainStat>>,
    /// Token to retrieve the next page of results, or empty if there are no more results in the list.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
