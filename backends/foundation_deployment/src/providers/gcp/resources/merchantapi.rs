...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/merchantapi/openapi.json`.
...
pub struct ListMerchantReviewsResponse {
    ...
    pub merchant_reviews:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<MerchantReview>>>,
...
pub struct ListProductReviewsResponse {
    ...
    pub product_reviews: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ProductReview>>>,
}
...
pub struct MerchantReview {
    ...
    pub merchant_review_attributes:
        ::core::option::Option<::std::boxed::Box<MerchantReviewAttributes>>,
    ...
    pub merchant_review_status: ::core::option::Option<::std::boxed::Box<MerchantReviewStatus>>,
...
pub struct MerchantReviewStatus {
    ...
    pub destination_statuses:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<MerchantReviewDestinationStatus>>>,
    ...
    pub item_level_issues:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<MerchantReviewItemLevelIssue>>>,
...
pub struct ProductReview {
    ...
    pub product_review_attributes:
        ::core::option::Option<::std::boxed::Box<ProductReviewAttributes>>,
    ...
    pub product_review_status: ::core::option::Option<::std::boxed::Box<ProductReviewStatus>>,
}
...
pub struct ProductReviewAttributes {
    ...
    pub review_link: ::core::option::Option<::std::boxed::Box<ReviewLink>>,
    /// Required. The timestamp indicating when the review was written.
    #[serde(default, rename = "reviewTime")]
    pub review_time: ::core::option::Option<String>,
...
pub struct ProductReviewStatus {
    ...
    #[serde(default, rename = "destinationStatuses")]
    pub destination_statuses:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ProductReviewDestinationStatus>>>,
    /// Output only. A list of all issues associated with the product review.
    #[serde(default, rename = "itemLevelIssues")]
    pub item_level_issues:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ProductReviewItemLevelIssue>>>,
    /// Output only. Date on which the item has been last updated, in [ISO 8601](http://en.wikipedia.org/wiki/ISO_8601) format.
    #[serde(default, rename = "lastUpdateTime")]
    pub last_update_time: ::core::option::Option<String>,
}
...
pub struct ProductStatusChangeMessage {
    ...
    #[serde(default)]
    pub changes: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<ProductChange>>>,
