...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/digitalassetlinks/openapi.json`.
...
pub struct AndroidAppAsset {
    ...
    #[serde(default)]
    pub certificate: ::core::option::Option<::std::boxed::Box<CertificateInfo>>,
...
pub struct Asset {
    ...
    pub android_app: ::core::option::Option<::std::boxed::Box<AndroidAppAsset>>,
    /// Set if this is a web asset.
    #[serde(default)]
    pub web: ::core::option::Option<::std::boxed::Box<WebAsset>>,
}
...
pub struct BulkCheckRequest {
    ...
    pub default_source: ::core::option::Option<::std::boxed::Box<Asset>>,
    ...
    pub default_target: ::core::option::Option<::std::boxed::Box<Asset>>,
    ...
    #[serde(default)]
    pub statements: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<StatementTemplate>>>,
}
...
pub struct BulkCheckResponse {
    ...
    pub check_results: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<CheckResponse>>>,
}
...
pub struct Statement {
    ...
    #[serde(default)]
    pub source: ::core::option::Option<::std::boxed::Box<Asset>>,
    /// Every statement has a target asset. REQUIRED
    #[serde(default)]
    pub target: ::core::option::Option<::std::boxed::Box<Asset>>,
}
