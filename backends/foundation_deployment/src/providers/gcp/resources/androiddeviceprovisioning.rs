...
pub struct CreateCustomerRequest {
    ...
    #[serde(default)]
    pub customer: ::core::option::Option<Company>,
}
...
pub struct CustomerListCustomersResponse {
    ...
    #[serde(default)]
    pub customers: ::core::option::Option<::std::vec::Vec<Company>>,
...
pub struct CustomerListDpcsResponse {
    ...
    #[serde(default)]
    pub dpcs: ::core::option::Option<::std::vec::Vec<Dpc>>,
}
...
pub struct DevicesLongRunningOperationResponse {
    ...
    pub per_device_status: ::core::option::Option<::std::vec::Vec<OperationPerDevice>>,
...
pub struct ListVendorsResponse {
    ...
    #[serde(default)]
    pub vendors: ::core::option::Option<::std::vec::Vec<Company>>,
}
...
pub struct UnclaimDevicesRequest {
    ...
    #[serde(default)]
    pub unclaims: ::core::option::Option<::std::vec::Vec<PartnerUnclaim>>,
}
...
pub struct UpdateDeviceMetadataInBatchRequest {
    ...
    #[serde(default)]
    pub updates: ::core::option::Option<::std::vec::Vec<UpdateMetadataArguments>>,
}
