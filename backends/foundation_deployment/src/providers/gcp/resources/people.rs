...
pub struct BatchCreateContactsRequest {
    ...
    #[serde(default)]
    pub contacts: ::core::option::Option<::std::vec::Vec<ContactToCreate>>,
...
pub struct BatchCreateContactsResponse {
    ...
    pub created_people: ::core::option::Option<::std::vec::Vec<PersonResponse>>,
}
...
pub struct BatchGetContactGroupsResponse {
    ...
    #[serde(default)]
    pub responses: ::core::option::Option<::std::vec::Vec<ContactGroupResponse>>,
}
...
pub struct Membership {
    ...
    pub contact_group_membership: ::core::option::Option<ContactGroupMembership>,
    /// Output only. The domain membership.
    #[serde(default, rename = "domainMembership")]
    pub domain_membership: ::core::option::Option<DomainMembership>,
