...
pub struct GoogleCloudMlV1StudyConfigParameterSpec {
    ...
    pub categorical_value_spec: Option<GoogleCloudMlV1StudyConfigParameterSpecCategoricalValueSpec>,
    /// A child node is active if the parameter''s value matches the child node''s matching_parent_values. If two items in child_parameter_specs have the same name, they must have disjoint matching_parent_values.
    #[serde(default, rename = "childParameterSpecs")]
    pub child_parameter_specs: Option<Vec<GoogleCloudMlV1StudyConfigParameterSpec>>,
    /// The value spec for a ''DISCRETE'' parameter.
    #[serde(default, rename = "discreteValueSpec")]
    pub discrete_value_spec: Option<GoogleCloudMlV1StudyConfigParameterSpecDiscreteValueSpec>,
    /// The value spec for a ''DOUBLE'' parameter.
    #[serde(default, rename = "doubleValueSpec")]
    pub double_value_spec: Option<GoogleCloudMlV1StudyConfigParameterSpecDoubleValueSpec>,
    /// The value spec for an ''INTEGER'' parameter.
    #[serde(default, rename = "integerValueSpec")]
    pub integer_value_spec: Option<GoogleCloudMlV1StudyConfigParameterSpecIntegerValueSpec>,
    /// Required. The parameter name must be unique amongst all ParameterSpecs.
    #[serde(default)]
    pub parameter: Option<String>,
    #[serde(default, rename = "parentCategoricalValues")]
    pub parent_categorical_values:
        Option<GoogleCloudMlV1StudyConfigParameterSpecMatchingParentCategoricalValueSpec>,
    #[serde(default, rename = "parentDiscreteValues")]
    pub parent_discrete_values:
        Option<GoogleCloudMlV1StudyConfigParameterSpecMatchingParentDiscreteValueSpec>,
    #[serde(default, rename = "parentIntValues")]
    pub parent_int_values:
        Option<GoogleCloudMlV1StudyConfigParameterSpecMatchingParentIntValueSpec>,
...
pub struct GoogleCloudMlV1AddTrialMeasurementRequest {
    ...
    #[serde(default)]
    pub measurement: Option<GoogleCloudMlV1Measurement>,
}
...
pub struct GoogleCloudMlV1AutoScaling {
    ...
    #[serde(default)]
    pub metrics: Option<Vec<GoogleCloudMlV1MetricSpec>>,
...
pub struct GoogleCloudMlV1AutomatedStoppingConfig {
    ...
    pub decay_curve_stopping_config:
        Option<GoogleCloudMlV1AutomatedStoppingConfigDecayCurveAutomatedStoppingConfig>,
    #[serde(default, rename = "medianAutomatedStoppingConfig")]
    pub median_automated_stopping_config:
        Option<GoogleCloudMlV1AutomatedStoppingConfigMedianAutomatedStoppingConfig>,
}
...
pub struct GoogleCloudMlV1CompleteTrialRequest {
    ...
    pub final_measurement: Option<GoogleCloudMlV1Measurement>,
...
pub struct GoogleCloudMlV1ContainerSpec {
    ...
    #[serde(default)]
    pub env: Option<Vec<GoogleCloudMlV1EnvVar>>,
    ...
    #[serde(default)]
    pub ports: Option<Vec<GoogleCloudMlV1ContainerPort>>,
}
...
pub struct GoogleCloudMlV1ExplainRequest {
    ...
    pub http_body: Option<GoogleApiHttpBody>,
}
...
pub struct GoogleCloudMlV1ExplanationConfig {
    ...
    pub integrated_gradients_attribution: Option<GoogleCloudMlV1IntegratedGradientsAttribution>,
    /// An attribution method that approximates Shapley values for features that contribute to the label being predicted. A sampling strategy is used to approximate the value rather than considering all subsets of features.
    #[serde(default, rename = "sampledShapleyAttribution")]
    pub sampled_shapley_attribution: Option<GoogleCloudMlV1SampledShapleyAttribution>,
    /// Attributes credit by computing the XRAI taking advantage of the model''s fully differentiable structure. Refer to this paper for more details: https://arxiv.org/abs/1906.02825 Currently only implemented for models with natural image inputs.
    #[serde(default, rename = "xraiAttribution")]
    pub xrai_attribution: Option<GoogleCloudMlV1XraiAttribution>,
}
...
pub struct GoogleCloudMlV1GetConfigResponse {
    #[serde(default)]
    pub config: Option<GoogleCloudMlV1Config>,
...
pub struct GoogleCloudMlV1HyperparameterOutput {
    ...
    pub all_metrics: Option<Vec<GoogleCloudMlV1HyperparameterOutputHyperparameterMetric>>,
    ...
    pub built_in_algorithm_output: Option<GoogleCloudMlV1BuiltInAlgorithmOutput>,
    /// Output only. End time for the trial.
    #[serde(default, rename = "endTime")]
    pub end_time: Option<String>,
    /// The final objective metric seen for this trial.
    #[serde(default, rename = "finalMetric")]
    pub final_metric: Option<GoogleCloudMlV1HyperparameterOutputHyperparameterMetric>,
...
pub struct GoogleCloudMlV1HyperparameterSpec {
    ...
    #[serde(default)]
    pub params: Option<Vec<GoogleCloudMlV1ParameterSpec>>,
...
pub struct GoogleCloudMlV1Job {
    ...
    pub prediction_input: Option<GoogleCloudMlV1PredictionInput>,
    /// The current prediction job result.
    #[serde(default, rename = "predictionOutput")]
    pub prediction_output: Option<GoogleCloudMlV1PredictionOutput>,
    ...
    pub training_input: Option<GoogleCloudMlV1TrainingInput>,
    /// The current training job result.
    #[serde(default, rename = "trainingOutput")]
    pub training_output: Option<GoogleCloudMlV1TrainingOutput>,
}
...
pub struct GoogleCloudMlV1ListJobsResponse {
    /// The list of jobs.
    #[serde(default)]
    pub jobs: Option<Vec<GoogleCloudMlV1Job>>,
...
pub struct GoogleCloudMlV1ListLocationsResponse {
    ...
    #[serde(default)]
    pub locations: Option<Vec<GoogleCloudMlV1Location>>,
    /// Optional. Pass this token as the page_token field of the request for a subsequent call.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: Option<String>,
}
...
pub struct GoogleCloudMlV1ListModelsResponse {
    /// The list of models.
    #[serde(default)]
    pub models: Option<Vec<GoogleCloudMlV1Model>>,
    /// Optional. Pass this token as the page_token field of the request for a subsequent call.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: Option<String>,
}
...
pub struct GoogleCloudMlV1ListOptimalTrialsResponse {
    ...
    #[serde(default)]
    pub trials: Option<Vec<GoogleCloudMlV1Trial>>,
}
...
pub struct GoogleCloudMlV1ListStudiesResponse {
    ...
    #[serde(default)]
    pub studies: Option<Vec<GoogleCloudMlV1Study>>,
}
...
pub struct GoogleCloudMlV1ListVersionsResponse {
    ...
    #[serde(default)]
    pub versions: Option<Vec<GoogleCloudMlV1Version>>,
}
...
pub struct GoogleCloudMlV1Location {
    ...
    #[serde(default)]
    pub capabilities: Option<Vec<GoogleCloudMlV1Capability>>,
    #[serde(default)]
    pub name: Option<String>,
}
...
pub struct GoogleCloudMlV1Measurement {
    ...
    #[serde(default)]
    pub metrics: Option<Vec<GoogleCloudMlV1MeasurementMetric>>,
...
pub struct GoogleCloudMlV1Model {
    ...
    pub default_version: Option<GoogleCloudMlV1Version>,
...
pub struct GoogleCloudMlV1OperationMetadata {
    ...
    #[serde(default)]
    pub version: Option<GoogleCloudMlV1Version>,
}
...
pub struct GoogleCloudMlV1ReplicaConfig {
    ...
    pub accelerator_config: Option<GoogleCloudMlV1AcceleratorConfig>,
    ...
    pub disk_config: Option<GoogleCloudMlV1DiskConfig>,
...
pub struct GoogleCloudMlV1Study {
    ...
    pub study_config: Option<GoogleCloudMlV1StudyConfig>,
}
...
pub struct GoogleCloudMlV1StudyConfig {
    ...
    pub automated_stopping_config: Option<GoogleCloudMlV1AutomatedStoppingConfig>,
    /// Metric specs for the study.
    #[serde(default)]
    pub metrics: Option<Vec<GoogleCloudMlV1StudyConfigMetricSpec>>,
    /// Required. The set of parameters to tune.
    #[serde(default)]
    pub parameters: Option<Vec<GoogleCloudMlV1StudyConfigParameterSpec>>,
}
...
pub struct GoogleCloudMlV1TrainingInput {
    ...
    pub encryption_config: Option<GoogleCloudMlV1EncryptionConfig>,
    ...
    pub evaluator_config: Option<GoogleCloudMlV1ReplicaConfig>,
    ...
    #[serde(default)]
    pub hyperparameters: Option<GoogleCloudMlV1HyperparameterSpec>,
    ...
    pub master_config: Option<GoogleCloudMlV1ReplicaConfig>,
    ...
    pub parameter_server_config: Option<GoogleCloudMlV1ReplicaConfig>,
    ...
    #[serde(default)]
    pub scheduling: Option<GoogleCloudMlV1Scheduling>,
    ...
    pub worker_config: Option<GoogleCloudMlV1ReplicaConfig>,
...
pub struct GoogleCloudMlV1TrainingOutput {
    ...
    pub consumed_m_l_units: Option<f64>,
    ...
    #[serde(default)]
    pub trials: Option<Vec<GoogleCloudMlV1HyperparameterOutput>>,
...
pub struct GoogleCloudMlV1Trial {
    ...
    #[serde(default)]
    pub measurements: Option<Vec<GoogleCloudMlV1Measurement>>,
    /// Output only. Name of the trial assigned by the service.
    #[serde(default)]
    pub name: Option<String>,
    /// The parameters of the trial.
    #[serde(default)]
    pub parameters: Option<Vec<GoogleCloudMlV1TrialParameter>>,
...
pub struct GoogleCloudMlV1Version {
    ...
    pub explanation_config: Option<GoogleCloudMlV1ExplanationConfig>,
    ...
    pub manual_scaling: Option<GoogleCloudMlV1ManualScaling>,
    ...
    pub request_logging_config: Option<GoogleCloudMlV1RequestLoggingConfig>,
    ...
    #[serde(default)]
    pub routes: Option<GoogleCloudMlV1RouteMap>,
