...
pub struct FinancedPurchaseSavings {
    ...
    pub loan_interest_rate: Option<f32>,
...
pub struct FinancialAnalysis {
    ...
    pub average_kwh_per_month: Option<f32>,
...
pub struct FinancialDetails {
    ...
    pub initial_ac_kwh_per_year: Option<f32>,
...
pub struct RoofSegmentSummary {
    ...
    pub yearly_energy_dc_kwh: Option<f32>,
}
...
pub struct SizeAndSunshineStats {
    ...
    pub sunshine_quantiles: Option<Vec<f32>>,
}
...
pub struct SolarPotential {
    ...
    pub carbon_offset_factor_kg_per_mwh: Option<f32>,
    ...
    pub max_array_area_meters2: Option<f32>,
    ...
    pub max_array_panels_count: Option<i32>,
