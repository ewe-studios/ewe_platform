...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/solar/openapi.json`.
...
pub struct BuildingInsights {
    ...
    pub bounding_box: ::core::option::Option<::std::boxed::Box<LatLngBox>>,
    /// A point near the center of the building.
    #[serde(default)]
    pub center: ::core::option::Option<::std::boxed::Box<LatLng>>,
    /// Date that the underlying imagery was acquired. This is approximate.
    #[serde(default, rename = "imageryDate")]
    pub imagery_date: ::core::option::Option<::std::boxed::Box<Date>>,
    /// When processing was completed on this imagery.
    #[serde(default, rename = "imageryProcessedDate")]
    pub imagery_processed_date: ::core::option::Option<::std::boxed::Box<Date>>,
    ...
    pub solar_potential: ::core::option::Option<::std::boxed::Box<SolarPotential>>,
...
pub struct CashPurchaseSavings {
    ...
    pub out_of_pocket_cost: ::core::option::Option<::std::boxed::Box<Money>>,
    ...
    pub rebate_value: ::core::option::Option<::std::boxed::Box<Money>>,
    /// How much is saved (or not) over the lifetime period.
    #[serde(default)]
    pub savings: ::core::option::Option<::std::boxed::Box<SavingsOverTime>>,
    ...
    pub upfront_cost: ::core::option::Option<::std::boxed::Box<Money>>,
}
...
pub struct FinancedPurchaseSavings {
    ...
    pub annual_loan_payment: ::core::option::Option<::std::boxed::Box<Money>>,
...
pub struct FinancialAnalysis {
    ...
    pub cash_purchase_savings: ::core::option::Option<::std::boxed::Box<CashPurchaseSavings>>,
    ...
    pub financed_purchase_savings:
        ::core::option::Option<::std::boxed::Box<FinancedPurchaseSavings>>,
    /// Financial information that applies regardless of the financing method used.
    #[serde(default, rename = "financialDetails")]
    pub financial_details: ::core::option::Option<::std::boxed::Box<FinancialDetails>>,
    /// Cost and benefit of leasing the solar panels.
    #[serde(default, rename = "leasingSavings")]
    pub leasing_savings: ::core::option::Option<::std::boxed::Box<LeasingSavings>>,
    /// The monthly electric bill this analysis assumes.
    #[serde(default, rename = "monthlyBill")]
    pub monthly_bill: ::core::option::Option<::std::boxed::Box<Money>>,
...
pub struct FinancialDetails {
    ...
    pub cost_of_electricity_without_solar: ::core::option::Option<::std::boxed::Box<Money>>,
    ...
    pub federal_incentive: ::core::option::Option<::std::boxed::Box<Money>>,
    ...
    pub lifetime_srec_total: ::core::option::Option<::std::boxed::Box<Money>>,
    ...
    pub remaining_lifetime_utility_bill: ::core::option::Option<::std::boxed::Box<Money>>,
    ...
    pub state_incentive: ::core::option::Option<::std::boxed::Box<Money>>,
    ...
    pub utility_incentive: ::core::option::Option<::std::boxed::Box<Money>>,
}
...
pub struct LatLngBox {
    ...
    #[serde(default)]
    pub ne: ::core::option::Option<::std::boxed::Box<LatLng>>,
    /// The southwest corner of the box.
    #[serde(default)]
    pub sw: ::core::option::Option<::std::boxed::Box<LatLng>>,
}
...
pub struct LeasingSavings {
    ...
    pub annual_leasing_cost: ::core::option::Option<::std::boxed::Box<Money>>,
...
pub struct RoofSegmentSizeAndSunshineStats {
    ...
    #[serde(default)]
    pub stats: ::core::option::Option<::std::boxed::Box<SizeAndSunshineStats>>,
}
...
pub struct SavingsOverTime {
    ...
    pub present_value_of_savings_lifetime: ::core::option::Option<::std::boxed::Box<Money>>,
...
pub struct SolarPanelConfig {
    ...
    pub roof_segment_summaries:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<RoofSegmentSummary>>>,
...
pub struct SolarPotential {
    ...
    pub building_stats: ::core::option::Option<::std::boxed::Box<SizeAndSunshineStats>>,
    ...
    pub financial_analyses:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<FinancialAnalysis>>>,
    ...
    pub roof_segment_stats:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<RoofSegmentSizeAndSunshineStats>>>,
    ...
    pub solar_panel_configs:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SolarPanelConfig>>>,
    ...
    pub solar_panels: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<SolarPanel>>>,
    ...
    pub whole_roof_stats: ::core::option::Option<::std::boxed::Box<SizeAndSunshineStats>>,
}
