...
pub struct BatchCreateRepositoriesRequest {
    ...
    #[serde(default)]
    pub requests: ::core::option::Option<::std::vec::Vec<CreateRepositoryRequest>>,
}
...
pub struct PipelineRun {
    ...
    pub child_references: ::core::option::Option<::std::vec::Vec<ChildStatusReference>>,
    ...
    #[serde(default)]
    pub conditions: ::core::option::Option<::std::vec::Vec<GoogleDevtoolsCloudbuildV2Condition>>,
    ...
    pub pipeline_ref: ::core::option::Option<PipelineRef>,
    ...
    pub pipeline_spec: ::core::option::Option<PipelineSpec>,
    ...
    pub resolved_pipeline_spec: ::core::option::Option<PipelineSpec>,
    /// Optional. Output only. List of results written out by the pipeline''s containers
    #[serde(default)]
    pub results: ::core::option::Option<::std::vec::Vec<PipelineRunResult>>,
    ...
    pub skipped_tasks: ::core::option::Option<::std::vec::Vec<SkippedTask>>,
    ...
    #[serde(default)]
    pub timeouts: ::core::option::Option<TimeoutFields>,
...
pub struct PipelineSpec {
    ...
    pub finally_tasks: ::core::option::Option<::std::vec::Vec<PipelineTask>>,
    ...
    /// Optional. Output only. List of results written out by the pipeline''s containers
    #[serde(default)]
    pub results: ::core::option::Option<::std::vec::Vec<PipelineResult>>,
    /// List of Tasks that execute when this Pipeline is run.
    #[serde(default)]
    pub tasks: ::core::option::Option<::std::vec::Vec<PipelineTask>>,
...
pub struct PipelineTask {
    ...
    pub task_ref: ::core::option::Option<TaskRef>,
    /// Spec to instantiate this TaskRun.
    #[serde(default, rename = "taskSpec")]
    pub task_spec: ::core::option::Option<EmbeddedTask>,
...
pub struct Step {
    ...
    pub ref_: ::core::option::Option<StepRef>,
    /// The contents of an executable file to execute.
    #[serde(default)]
    pub script: ::core::option::Option<String>,
