...
pub struct ChildStatusReference {
    ...
    pub when_expressions: Option<Vec<WhenExpression>>,
}
...
pub struct ParamValue {
    ...
    pub object_val: Option<serde_json::Value>,
...
pub struct PipelineRun {
    ...
    pub child_references: Option<Vec<ChildStatusReference>>,
    ...
    #[serde(default)]
    pub conditions: Option<Vec<GoogleDevtoolsCloudbuildV2Condition>>,
    ...
    pub finally_start_time: Option<String>,
    /// Output only. GCB default params.
    #[serde(default, rename = "gcbParams")]
    pub gcb_params: Option<serde_json::Value>,
    ...
    pub pipeline_run_status: Option<String>,
    ...
    pub pipeline_spec_yaml: Option<String>,
    ...
    pub resolved_pipeline_spec: Option<PipelineSpec>,
    /// Optional. Output only. List of results written out by the pipeline''s containers
    #[serde(default)]
    pub results: Option<Vec<PipelineRunResult>>,
    ...
    pub skipped_tasks: Option<Vec<SkippedTask>>,
...
pub struct PipelineSpec {
    ...
    pub finally_tasks: Option<Vec<PipelineTask>>,
...
pub struct PipelineTask {
    ...
    #[serde(default)]
    pub workspaces: Option<Vec<WorkspacePipelineTaskBinding>>,
}
...
pub struct Security {
    ...
    pub privilege_mode: Option<String>,
...
pub struct TaskSpec {
    ...
    pub managed_sidecars: Option<Vec<String>>,
    /// List of parameters.
    #[serde(default)]
    pub params: Option<Vec<ParamSpec>>,
    ...
    #[serde(default)]
    pub volumes: Option<Vec<VolumeSource>>,
    /// The volumes that this Task requires.
    #[serde(default)]
    pub workspaces: Option<Vec<WorkspaceDeclaration>>,
}
