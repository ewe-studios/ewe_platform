...
pub struct AchievementDefinitionsListResponse {
    ...
    #[serde(default)]
    pub items: ::core::option::Option<::std::vec::Vec<AchievementDefinition>>,
...
pub struct AchievementUpdateMultipleRequest {
    ...
    #[serde(default)]
    pub updates: ::core::option::Option<::std::vec::Vec<AchievementUpdateRequest>>,
}
...
pub struct Application {
    ...
    #[serde(default)]
    pub assets: ::core::option::Option<::std::vec::Vec<ImageAsset>>,
    /// The author of the application.
    #[serde(default)]
    pub author: ::core::option::Option<String>,
    /// The category of the application.
    #[serde(default)]
    pub category: ::core::option::Option<ApplicationCategory>,
...
pub struct CategoryListResponse {
    ...
    #[serde(default)]
    pub items: ::core::option::Option<::std::vec::Vec<Category>>,
...
pub struct EventDefinitionListResponse {
    ...
    #[serde(default)]
    pub items: ::core::option::Option<::std::vec::Vec<EventDefinition>>,
...
pub struct EventRecordRequest {
    ...
    pub time_periods: ::core::option::Option<::std::vec::Vec<EventPeriodUpdate>>,
}
...
pub struct EventUpdateResponse {
    ...
    pub batch_failures: ::core::option::Option<::std::vec::Vec<EventBatchRecordFailure>>,
    /// Any failures updating a particular event.
    #[serde(default, rename = "eventFailures")]
    pub event_failures: ::core::option::Option<::std::vec::Vec<EventRecordFailure>>,
...
pub struct GeneratePlayGroupingApiTokenResponse {
    ...
    #[serde(default)]
    pub token: ::core::option::Option<PlayGroupingApiToken>,
}
...
pub struct LeaderboardListResponse {
    /// The leaderboards.
    #[serde(default)]
    pub items: ::core::option::Option<::std::vec::Vec<Leaderboard>>,
...
pub struct LeaderboardScores {
    ...
    #[serde(default)]
    pub items: ::core::option::Option<::std::vec::Vec<LeaderboardEntry>>,
    ...
    pub player_score: ::core::option::Option<LeaderboardEntry>,
...
pub struct PlayerAchievementListResponse {
    /// The achievements.
    #[serde(default)]
    pub items: ::core::option::Option<::std::vec::Vec<PlayerAchievement>>,
...
pub struct PlayerEventListResponse {
    /// The player events.
    #[serde(default)]
    pub items: ::core::option::Option<::std::vec::Vec<PlayerEvent>>,
...
pub struct PlayerLeaderboardScoreListResponse {
    ...
    #[serde(default)]
    pub items: ::core::option::Option<::std::vec::Vec<PlayerLeaderboardScore>>,
...
pub struct PlayerListResponse {
    /// The players.
    #[serde(default)]
    pub items: ::core::option::Option<::std::vec::Vec<Player>>,
...
pub struct RetrieveDeveloperGamesLastPlayerTokenResponse {
    ...
    pub game_player_token: ::core::option::Option<GamePlayerToken>,
}
...
pub struct RetrieveGamesPlayerTokensResponse {
    ...
    pub game_player_tokens: ::core::option::Option<::std::vec::Vec<GamePlayerToken>>,
}
...
pub struct RetrievePlayerTokensResponse {
    ...
    #[serde(default)]
    pub tokens: ::core::option::Option<::std::vec::Vec<RecallToken>>,
}
