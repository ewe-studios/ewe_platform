...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/chromewebstore/openapi.json`.
...
pub struct FetchItemStatusResponse {
    ...
    pub published_item_revision_status:
        ::core::option::Option<::std::boxed::Box<ItemRevisionStatus>>,
    ...
    pub submitted_item_revision_status:
        ::core::option::Option<::std::boxed::Box<ItemRevisionStatus>>,
...
pub struct ItemRevisionStatus {
    ...
    pub distribution_channels:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DistributionChannel>>>,
...
pub struct PublishItemRequest {
    ...
    pub deploy_infos: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DeployInfo>>>,
