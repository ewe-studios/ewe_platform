...
pub struct Database {
    ...
    pub hive_options: ::core::option::Option<::std::boxed::Box<HiveDatabaseOptions>>,
...
pub struct ListCatalogsResponse {
    ...
    #[serde(default)]
    pub catalogs: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Catalog>>>,
...
pub struct Table {
    ...
    /// Options of a Hive table.
    #[serde(default, rename = "hiveOptions")]
    pub hive_options: ::core::option::Option<::std::boxed::Box<HiveTableOptions>>,
