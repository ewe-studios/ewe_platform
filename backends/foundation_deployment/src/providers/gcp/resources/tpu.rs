...
pub struct ListQueuedResourcesResponse {
    ...
    pub queued_resources: ::core::option::Option<::std::vec::Vec<QueuedResource>>,
    /// Locations that could not be reached.
    #[serde(default)]
    pub unreachable: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct ListRuntimeVersionsResponse {
    ...
    pub runtime_versions: ::core::option::Option<::std::vec::Vec<RuntimeVersion>>,
    /// Locations that could not be reached.
    #[serde(default)]
    pub unreachable: ::core::option::Option<::std::vec::Vec<String>>,
}
...
pub struct Node {
    ...
    pub data_disks: ::core::option::Option<::std::vec::Vec<AttachedDisk>>,
    ...
    #[serde(default)]
    pub symptoms: ::core::option::Option<::std::vec::Vec<Symptom>>,
