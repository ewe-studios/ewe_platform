//! Auto-generated resource types for Google Cloud Platform - cloudtasks.
//!
//! This file is generated by `cargo run --bin ewe_platform gen_resource_types`.
//! DO NOT EDIT MANUALLY.
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/cloudtasks/openapi.json`.
...
pub struct Attempt {
    ...
    pub response_status: ::core::option::Option<::std::boxed::Box<Status>>,
...
pub struct HeaderOverride {
    ...
    #[serde(default)]
    pub header: ::core::option::Option<::std::boxed::Box<Header>>,
}
...
pub struct HttpTarget {
    ...
    pub header_overrides:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<HeaderOverride>>>,
    ...
    pub uri_override: ::core::option::Option<::std::boxed::Box<UriOverride>>,
}
...
pub struct ListQueuesResponse {
    ...
    /// The list of queues.
    #[serde(default)]
    pub queues: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Queue>>>,
}
...
pub struct Queue {
    ...
    #[serde(default, rename = "appEngineRoutingOverride")]
    pub app_engine_routing_override: ::core::option::Option<::std::boxed::Box<AppEngineRouting>>,
    ...
    pub rate_limits: ::core::option::Option<::std::boxed::Box<RateLimits>>,
    ...
    #[serde(default, rename = "stackdriverLoggingConfig")]
    pub stackdriver_logging_config:
        ::core::option::Option<::std::boxed::Box<StackdriverLoggingConfig>>,
...
pub struct Task {
    ...
    #[serde(default, rename = "appEngineHttpRequest")]
    pub app_engine_http_request: ::core::option::Option<::std::boxed::Box<AppEngineHttpRequest>>,
    /// Output only. The time that the task was created. create_time will be truncated to the nearest second.
    #[serde(default, rename = "createTime")]
    pub create_time: ::core::option::Option<String>,
    /// Output only. The number of attempts dispatched. This count includes attempts which have been dispatched but haven''t received a response.
    #[serde(default, rename = "dispatchCount")]
    pub dispatch_count: ::core::option::Option<i32>,
    ...
    #[serde(default, rename = "dispatchDeadline")]
    pub dispatch_deadline: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "firstAttempt")]
    pub first_attempt: ::core::option::Option<::std::boxed::Box<Attempt>>,
    ...
    pub last_attempt: ::core::option::Option<::std::boxed::Box<Attempt>>,
    ...
    #[serde(default, rename = "scheduleTime")]
    pub schedule_time: ::core::option::Option<String>,
    /// Output only. The view specifies which subset of the Task has been returned. // TODO: enum values: ["VIEW_UNSPECIFIED", "BASIC", "FULL"]
    #[serde(default)]
...
pub struct UriOverride {
    ...
    #[serde(default, rename = "pathOverride")]
    pub path_override: ::core::option::Option<::std::boxed::Box<PathOverride>>,
    ...
    #[serde(default, rename = "queryOverride")]
    pub query_override: ::core::option::Option<::std::boxed::Box<QueryOverride>>,
    /// Scheme override. When specified, the task URI scheme is replaced by the provided value (HTTP or HTTPS). // TODO: enum values: ["SCHEME_UNSPECIFIED", "HTTP", "HTTPS"]
    #[serde(default)]
