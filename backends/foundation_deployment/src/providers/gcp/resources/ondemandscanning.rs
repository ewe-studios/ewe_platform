...
pub struct AnalyzePackagesRequestV1 {
    ...
    #[serde(default)]
    pub packages: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<PackageData>>>,
...
pub struct BinarySourceInfo {
    ...
    pub binary_version: ::core::option::Option<::std::boxed::Box<PackageVersion>>,
    ...
    pub source_version: ::core::option::Option<::std::boxed::Box<PackageVersion>>,
}
...
pub struct GrafeasV1FileLocation {
    ...
    #[serde(default, rename = "layerDetails")]
    pub layer_details: ::core::option::Option<::std::boxed::Box<GrafeasV1LayerDetails>>,
...
pub struct GrafeasV1LayerDetails {
    ...
    pub base_images: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GrafeasV1BaseImage>>>,
...
pub struct PackageData {
    ...
    pub binary_source_info:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<BinarySourceInfo>>>,
    /// DEPRECATED
    #[serde(default, rename = "binaryVersion")]
    pub binary_version: ::core::option::Option<::std::boxed::Box<PackageVersion>>,
    ...
    pub dependency_chain:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<LanguagePackageDependency>>>,
    /// The path to the jar file / go binary file.
    #[serde(default, rename = "fileLocation")]
    pub file_location: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<FileLocation>>>,
    ...
    #[serde(default)]
    pub maintainer: ::core::option::Option<::std::boxed::Box<Maintainer>>,
