...
pub struct AnalyzePackagesRequestV1 {
    ...
    pub include_osv_data: ::core::option::Option<bool>,
    /// The packages to analyze.
    #[serde(default)]
    pub packages: ::core::option::Option<::std::vec::Vec<PackageData>>,
...
pub struct AnalyzePackagesResponse {
    ...
    #[serde(default)]
    pub scan: ::core::option::Option<String>,
}
...
pub struct PackageData {
    ...
    pub binary_source_info: ::core::option::Option<::std::vec::Vec<BinarySourceInfo>>,
    /// DEPRECATED
    #[serde(default, rename = "binaryVersion")]
    pub binary_version: ::core::option::Option<PackageVersion>,
    ...
    pub dependency_chain: ::core::option::Option<::std::vec::Vec<LanguagePackageDependency>>,
    /// The path to the jar file / go binary file.
    #[serde(default, rename = "fileLocation")]
    pub file_location: ::core::option::Option<::std::vec::Vec<FileLocation>>,
    ...
    pub hash_digest: ::core::option::Option<String>,
    ...
    #[serde(default)]
    pub maintainer: ::core::option::Option<Maintainer>,
    ...
    pub patched_cve: ::core::option::Option<::std::vec::Vec<String>>,
    /// DEPRECATED
    #[serde(default, rename = "sourceVersion")]
    pub source_version: ::core::option::Option<PackageVersion>,
    #[serde(default)]
    pub unused: ::core::option::Option<String>,
...
pub struct GrafeasV1FileLocation {
    ...
    #[serde(default, rename = "layerDetails")]
    pub layer_details: ::core::option::Option<GrafeasV1LayerDetails>,
...
pub struct GrafeasV1LayerDetails {
    /// The base images the layer is found within.
    #[serde(default, rename = "baseImages")]
    pub base_images: ::core::option::Option<::std::vec::Vec<GrafeasV1BaseImage>>,
    /// The layer chain ID (sha256 hash) of the layer in the container image. https://github.com/opencontainers/image-spec/blob/main/config.md#layer-chainid
    #[serde(default, rename = "chainId")]
    pub chain_id: ::core::option::Option<String>,
    /// The layer build command that was used to build the layer. This may not be found in all layers depending on how the container image is built.
    ...
    for ListVulnerabilitiesResponseV1
{
    fn generate_resource_id(
        ...
        format!("gcp::ListVulnerabilitiesResponseV1/{}", input.parent)
    }

    fn resource_kind(&self) -> &'static str {
        "gcp::ListVulnerabilitiesResponseV1"
    }
