//! Auto-generated resource types for Google Cloud Platform - sts.
//!
//! This file is generated by `cargo run --bin ewe_platform gen_resource_types`.
//! DO NOT EDIT MANUALLY.
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/sts/openapi.json`.
...
pub struct GoogleIdentityStsV1AccessBoundary {
    ...
    pub access_boundary_rules: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleIdentityStsV1AccessBoundaryRule>>,
    >,
}
...
pub struct GoogleIdentityStsV1AccessBoundaryRule {
    ...
    pub availability_condition: ::core::option::Option<::std::boxed::Box<GoogleTypeExpr>>,
...
pub struct GoogleIdentityStsV1ExchangeTokenRequest {
    ...
    #[serde(default, rename = "requestedTokenType")]
    pub requested_token_type: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "subjectToken")]
    pub subject_token: ::core::option::Option<String>,
    ...
    #[serde(default, rename = "subjectTokenType")]
    pub subject_token_type: ::core::option::Option<String>,
}
...
pub struct GoogleIdentityStsV1ExchangeTokenResponse {
    ...
    #[serde(default)]
    pub access_boundary_session_key: ::core::option::Option<String>,
    ...
    #[serde(default)]
    pub issued_token_type: ::core::option::Option<String>,
...
pub struct GoogleIdentityStsV1Options {
    ...
    pub access_boundary:
        ::core::option::Option<::std::boxed::Box<GoogleIdentityStsV1AccessBoundary>>,
    ...
    #[serde(default, rename = "bindCertFingerprint")]
    pub bind_cert_fingerprint: ::core::option::Option<String>,
...
pub struct GoogleIdentityStsV1betaAccessBoundary {
    ...
    #[serde(default, rename = "accessBoundaryRules")]
    pub access_boundary_rules: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleIdentityStsV1betaAccessBoundaryRule>>,
    >,
}
...
pub struct GoogleIdentityStsV1betaOptions {
    ...
    #[serde(default, rename = "accessBoundary")]
    pub access_boundary:
        ::core::option::Option<::std::boxed::Box<GoogleIdentityStsV1betaAccessBoundary>>,
    /// A Google project used for quota and billing purposes when the credential is used to access Google APIs. The provided project overrides the project bound to the credential. The value must be a project number or a project ID. Example: my-sample-project-191923. The maximum length is 32 characters.
    #[serde(default, rename = "userProject")]
    pub user_project: ::core::option::Option<String>,
}
