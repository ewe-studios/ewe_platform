...
pub struct ListHistoriesResponse {
    /// Histories.
    #[serde(default)]
    pub histories: ::core::option::Option<::std::vec::Vec<History>>,
...
pub struct ListPerfSampleSeriesResponse {
    ...
    pub perf_sample_series: ::core::option::Option<::std::vec::Vec<PerfSampleSeries>>,
}
...
pub struct ListScreenshotClustersResponse {
    ...
    #[serde(default)]
    pub clusters: ::core::option::Option<::std::vec::Vec<ScreenshotCluster>>,
}
...
pub struct ListStepAccessibilityClustersResponse {
    ...
    #[serde(default)]
    pub clusters: ::core::option::Option<::std::vec::Vec<SuggestionClusterProto>>,
...
pub struct ListStepThumbnailsResponse {
    ...
    #[serde(default)]
    pub thumbnails: ::core::option::Option<::std::vec::Vec<Image>>,
}
...
pub struct NonSdkApiUsageViolationReport {
    ...
    pub example_apis: ::core::option::Option<::std::vec::Vec<NonSdkApi>>,
...
pub struct PerfMetricsSummary {
    ...
    pub graphics_stats: ::core::option::Option<GraphicsStats>,
    /// A tool results history ID. @OutputOnly
    #[serde(default, rename = "historyId")]
    pub history_id: ::core::option::Option<String>,
    /// Describes the environment in which the performance metrics were collected
    #[serde(default, rename = "perfEnvironment")]
    pub perf_environment: ::core::option::Option<PerfEnvironment>,
...
pub struct PerfSampleSeries {
    ...
    pub basic_perf_sample_series: ::core::option::Option<BasicPerfSampleSeries>,
    /// A tool results execution ID. @OutputOnly
    #[serde(default, rename = "executionId")]
    pub execution_id: ::core::option::Option<String>,
    /// A tool results history ID. @OutputOnly
...
pub struct ScreenshotCluster {
    ...
    pub key_screen: ::core::option::Option<Screen>,
...
pub struct Step {
    ...
    pub device_usage_duration: ::core::option::Option<Duration>,
    ...
    #[serde(default, rename = "dimensionValue")]
    pub dimension_value: ::core::option::Option<::std::vec::Vec<StepDimensionValueEntry>>,
    ...
    #[serde(default)]
    pub labels: ::core::option::Option<::std::vec::Vec<StepLabelsEntry>>,
    ...
    pub multi_step: ::core::option::Option<MultiStep>,
    ...
    pub test_execution_step: ::core::option::Option<TestExecutionStep>,
...
pub struct SuggestionProto {
    ...
    pub long_message: ::core::option::Option<SafeHtmlProto>,
    ...
    #[serde(default)]
    pub region: ::core::option::Option<RegionProto>,
    ...
    pub short_message: ::core::option::Option<SafeHtmlProto>,
...
pub struct TestExecutionStep {
    ...
    pub test_issues: ::core::option::Option<::std::vec::Vec<TestIssue>>,
...
pub struct ToolOutputReference {
    ...
    #[serde(default)]
    pub output: ::core::option::Option<FileReference>,
