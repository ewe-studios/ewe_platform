...
pub struct AndroidTest {
    ...
    pub android_test_loop: Option<serde_json::Value>,
...
pub struct CPUInfo {
    ...
    pub cpu_speed_in_ghz: Option<f32>,
...
pub struct CrashDialogError {
    ...
    pub crash_package: Option<String>,
}
...
pub struct EncounteredLoginScreen {
    ...
    pub distinct_screens: Option<i32>,
    /// Subset of login screens.
    #[serde(default, rename = "screenIds")]
    pub screen_ids: Option<Vec<String>>,
}
...
pub struct Execution {
    ...
    pub dimension_definitions: Option<Vec<serde_json::Value>>,
...
pub struct InAppPurchasesFound {
    ...
    pub in_app_purchases_flows_explored: Option<i32>,
    /// The total number of in-app purchases flows started.
    #[serde(default, rename = "inAppPurchasesFlowsStarted")]
    pub in_app_purchases_flows_started: Option<i32>,
}
...
pub struct IosTest {
    ...
    pub ios_robo_test: Option<serde_json::Value>,
    /// An iOS test loop.
...
pub struct NonSdkApi {
    ...
    pub example_stack_traces: Option<Vec<String>>,
    /// Optional debugging insights for non-SDK API violations.
    #[serde(default)]
    pub insights: Option<Vec<NonSdkApiInsight>>,
...
pub struct NonSdkApiInsight {
    ...
    pub example_trace_messages: Option<Vec<String>>,
    ...
    pub pending_google_update_insight: Option<PendingGoogleUpdateInsight>,
    ...
    pub upgrade_insight: Option<UpgradeInsight>,
}
...
pub struct NonSdkApiUsageViolation {
    ...
    pub api_signatures: Option<Vec<String>>,
    /// Total number of unique hidden API''s accessed.
    #[serde(default, rename = "uniqueApis")]
    pub unique_apis: Option<i32>,
}
...
pub struct NonSdkApiUsageViolationReport {
    ...
    pub example_apis: Option<Vec<NonSdkApi>>,
...
pub struct OverlappingUIElements {
    ...
    pub resource_name: Option<Vec<String>>,
...
pub struct PendingGoogleUpdateInsight {
    ...
    pub name_of_google_library: Option<String>,
}
...
pub struct RoboScriptExecution {
    ...
    pub successful_actions: Option<i32>,
...
pub struct UIElementTooDeep {
    ...
    pub screen_state_id: Option<String>,
}
