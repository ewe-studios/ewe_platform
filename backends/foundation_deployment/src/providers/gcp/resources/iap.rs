...
pub struct ListBrandsResponse {
    ...
    #[serde(default)]
    pub brands: ::core::option::Option<::std::vec::Vec<Brand>>,
}
...
pub struct ListIdentityAwareProxyClientsResponse {
    ...
    pub identity_aware_proxy_clients:
        ::core::option::Option<::std::vec::Vec<IdentityAwareProxyClient>>,
...
pub struct ListTunnelDestGroupsResponse {
    ...
    pub tunnel_dest_groups: ::core::option::Option<::std::vec::Vec<TunnelDestGroup>>,
}
...
pub struct AccessSettings {
    ...
    pub policy_delegation_settings: ::core::option::Option<PolicyDelegationSettings>,
...
pub struct PolicyDelegationSettings {
    ...
    pub policy_name: ::core::option::Option<PolicyName>,
...
pub struct Resource {
    ...
    pub next_state_of_tags: ::core::option::Option<NextStateOfTags>,
...
pub struct NextStateOfTags {
    ...
    pub tags_full_state_for_child_resource: ::core::option::Option<TagsFullStateForChildResource>,
