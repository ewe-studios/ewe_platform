...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/apihub/openapi.json`.
...
pub struct GoogleCloudApihubV1aPIMetadata {
    ...
    #[serde(default)]
    pub api: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1Api>>,
    ...
    pub versions: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1VersionMetadata>>,
    >,
}
...
pub struct GoogleCloudApihubV1AdditionalSpecContent {
    ...
    pub spec_contents: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1SpecContents>>,
...
pub struct GoogleCloudApihubV1Addon {
    ...
    #[serde(default)]
    pub config: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1AddonConfig>>,
...
pub struct GoogleCloudApihubV1AddonConfig {
    ...
    pub all_data_addon_config:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1AllDataAddonConfig>>,
    /// Configuration for gateway plugin addons.
    #[serde(default, rename = "gatewayPluginAddonConfig")]
    pub gateway_plugin_addon_config:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1GatewayPluginAddonConfig>>,
}
...
pub struct GoogleCloudApihubV1Api {
    ...
    #[serde(default)]
    pub documentation: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1Documentation>>,
    ...
    #[serde(default)]
    pub owner: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1Owner>>,
    ...
    pub source_metadata: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1SourceMetadata>>,
    >,
...
pub struct GoogleCloudApihubV1ApiData {
    ...
    pub api_metadata_list:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1ApiMetadataList>>,
}
...
pub struct GoogleCloudApihubV1ApiHubInstance {
    ...
    #[serde(default)]
    pub config: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1Config>>,
...
pub struct GoogleCloudApihubV1ApiHubResource {
    ...
    #[serde(default)]
    pub definition: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1Definition>>,
    ...
    #[serde(default)]
    pub deployment: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1Deployment>>,
    ...
    #[serde(default)]
    pub operation: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1ApiOperation>>,
    ...
    #[serde(default)]
    pub spec: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1Spec>>,
    ...
    #[serde(default)]
    pub version: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1Version>>,
}
...
pub struct GoogleCloudApihubV1ApiKeyConfig {
    ...
    pub api_key: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1Secret>>,
...
pub struct GoogleCloudApihubV1ApiMetadataList {
    ...
    pub api_metadata:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1aPIMetadata>>>,
}
...
pub struct GoogleCloudApihubV1ApiOperation {
    ...
    #[serde(default)]
    pub details: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1OperationDetails>>,
...
pub struct GoogleCloudApihubV1ApiView {
    ...
    pub mcp_server_view: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudApihubV1FlattenedApiVersionDeploymentView>,
    >,
    /// MCP tools view.
    #[serde(default, rename = "mcpToolView")]
    pub mcp_tool_view: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudApihubV1FlattenedApiVersionOperationDeploymentView>,
    >,
}
...
pub struct GoogleCloudApihubV1ApigeeEdgeConfig {
    ...
    pub environment_filter:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1EnvironmentFilter>>,
}
...
pub struct GoogleCloudApihubV1Attribute {
    ...
    pub allowed_values:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1AllowedValue>>>,
...
pub struct GoogleCloudApihubV1AttributeValues {
    ...
    pub enum_values:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1EnumAttributeValues>>,
    /// The attribute values associated with a resource in case attribute data type is JSON.
    #[serde(default, rename = "jsonValues")]
    pub json_values:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1StringAttributeValues>>,
...
pub struct GoogleCloudApihubV1AuthConfig {
    ...
    pub api_key_config: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1ApiKeyConfig>>,
    ...
    pub google_service_account_config:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1GoogleServiceAccountConfig>>,
    /// Oauth2.0 Client Credentials.
    #[serde(default, rename = "oauth2ClientCredentialsConfig")]
    pub oauth2_client_credentials_config:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1Oauth2ClientCredentialsConfig>>,
    /// User Password.
    #[serde(default, rename = "userPasswordConfig")]
    pub user_password_config:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1UserPasswordConfig>>,
}
...
pub struct GoogleCloudApihubV1CollectApiDataRequest {
    ...
    pub api_data: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1ApiData>>,
...
pub struct GoogleCloudApihubV1Config {
    ...
    pub agent_registry_sync_config:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1AgentRegistrySyncConfig>>,
...
pub struct GoogleCloudApihubV1ConfigTemplate {
    ...
    pub additional_config_template: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1ConfigVariableTemplate>>,
    >,
    /// Optional. The authentication template for the plugin.
    #[serde(default, rename = "authConfigTemplate")]
    pub auth_config_template:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1AuthConfigTemplate>>,
}
...
pub struct GoogleCloudApihubV1ConfigVariable {
    ...
    pub enum_value: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1ConfigValueOption>>,
...
pub struct GoogleCloudApihubV1ConfigVariableTemplate {
    ...
    pub enum_options: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1ConfigValueOption>>,
    >,
    ...
    pub multi_select_options: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1ConfigValueOption>>,
    >,
...
pub struct GoogleCloudApihubV1Curation {
    ...
    #[serde(default)]
    pub endpoint: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1Endpoint>>,
    ...
    pub plugin_instance_actions: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1PluginInstanceActionID>>,
    >,
...
pub struct GoogleCloudApihubV1CurationConfig {
    ...
    pub custom_curation:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1CustomCuration>>,
}
...
pub struct GoogleCloudApihubV1Definition {
    ...
    #[serde(default)]
    pub schema: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1Schema>>,
...
pub struct GoogleCloudApihubV1Dependency {
    ...
    #[serde(default)]
    pub consumer:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1DependencyEntityReference>>,
    ...
    pub error_detail:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1DependencyErrorDetail>>,
...
pub struct GoogleCloudApihubV1DiscoveredApiObservation {
    ...
    #[serde(default, rename = "sourceMetadata")]
    pub source_metadata:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1SourceMetadata>>,
...
pub struct GoogleCloudApihubV1DiscoveredApiOperation {
    ...
    pub http_operation:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1HttpOperationDetails>>,
    ...
    pub match_results:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1MatchResult>>>,
...
pub struct GoogleCloudApihubV1Endpoint {
    ...
    pub application_integration_endpoint_details: ::core::option::Option<
        ::std::boxed::Box<GoogleCloudApihubV1ApplicationIntegrationEndpointDetails>,
    >,
}
...
pub struct GoogleCloudApihubV1ExecutePluginInstanceActionRequest {
    ...
    pub action_execution_detail:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1ActionExecutionDetail>>,
}
...
pub struct GoogleCloudApihubV1ExecutionStatus {
    ...
    pub last_execution: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1LastExecution>>,
}
...
pub struct GoogleCloudApihubV1FetchAdditionalSpecContentResponse {
    ...
    pub additional_spec_content:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1AdditionalSpecContent>>,
}
...
pub struct GoogleCloudApihubV1FlattenedApiVersionOperationDeploymentView {
    ...
    pub api_operation: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1ApiOperation>>,
    /// Optional. The deployment.
    #[serde(default)]
    pub deployment: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1Deployment>>,
    /// Optional. The version.
...
pub struct GoogleCloudApihubV1GatewayPluginAddonConfig {
    ...
    pub gateway_plugin_configs: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1GatewayPluginConfig>>,
    >,
}
...
pub struct GoogleCloudApihubV1GatewayPluginConfig {
    ...
    pub apigee_edge_config:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1ApigeeEdgeConfig>>,
    /// Configuration for Apigee OPDK gateways.
    #[serde(default, rename = "apigeeOpdkConfig")]
    pub apigee_opdk_config:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1ApigeeOPDKConfig>>,
    /// Configuration for Apigee X and Apigee Hybrid gateways.
    #[serde(default, rename = "apigeeXHybridConfig")]
    pub apigee_x_hybrid_config:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1ApigeeXHybridConfig>>,
...
pub struct GoogleCloudApihubV1HttpOperation {
    ...
    #[serde(default)]
    pub path: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1Path>>,
}
...
pub struct GoogleCloudApihubV1HttpOperationDetails {
    ...
    #[serde(default, rename = "httpOperation")]
    pub http_operation: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1HttpOperation>>,
    /// Optional. Path params of HttpOperation
    #[serde(default, rename = "pathParams")]
    pub path_params:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1PathParam>>>,
    ...
    #[serde(default)]
    pub request: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1HttpRequest>>,
    /// Optional. Response metadata.
    #[serde(default)]
    pub response: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1HttpResponse>>,
}
...
pub struct GoogleCloudApihubV1Issue {
    ...
    #[serde(default)]
    pub range: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1Range>>,
...
pub struct GoogleCloudApihubV1LintResponse {
    ...
    #[serde(default)]
    pub issues:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1Issue>>>,
    ...
    #[serde(default)]
    pub summary:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1SummaryEntry>>>,
}
...
pub struct GoogleCloudApihubV1ListAddonsResponse {
    ...
    #[serde(default)]
    pub addons:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1Addon>>>,
...
pub struct GoogleCloudApihubV1ListApiOperationsResponse {
    ...
    pub api_operations:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1ApiOperation>>>,
...
pub struct GoogleCloudApihubV1ListApisResponse {
    ...
    #[serde(default)]
    pub apis: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1Api>>>,
    /// A token, which can be sent as page_token to retrieve the next page. If this field is omitted, there are no subsequent pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct GoogleCloudApihubV1ListAttributesResponse {
    ...
    #[serde(default)]
    pub attributes:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1Attribute>>>,
    /// A token, which can be sent as page_token to retrieve the next page. If this field is omitted, there are no subsequent pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct GoogleCloudApihubV1ListCurationsResponse {
    ...
    #[serde(default)]
    pub curations:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1Curation>>>,
    /// A token, which can be sent as page_token to retrieve the next page. If this field is omitted, there are no subsequent pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct GoogleCloudApihubV1ListDependenciesResponse {
    ...
    #[serde(default)]
    pub dependencies:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1Dependency>>>,
    /// A token, which can be sent as page_token to retrieve the next page. If this field is omitted, there are no subsequent pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct GoogleCloudApihubV1ListDeploymentsResponse {
    ...
    #[serde(default)]
    pub deployments:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1Deployment>>>,
    /// A token, which can be sent as page_token to retrieve the next page. If this field is omitted, there are no subsequent pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct GoogleCloudApihubV1ListDiscoveredApiObservationsResponse {
    ...
    pub discovered_api_observations: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1DiscoveredApiObservation>>,
    >,
    /// A token, which can be sent as page_token to retrieve the next page. If this field is omitted, there are no subsequent pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
...
pub struct GoogleCloudApihubV1ListDiscoveredApiOperationsResponse {
    ...
    pub discovered_api_operations: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1DiscoveredApiOperation>>,
    >,
    /// A token, which can be sent as page_token to retrieve the next page. If this field is omitted, there are no subsequent pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
...
pub struct GoogleCloudApihubV1ListExternalApisResponse {
    ...
    pub external_apis:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1ExternalApi>>>,
    /// A token, which can be sent as page_token to retrieve the next page. If this field is omitted, there are no subsequent pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct GoogleCloudApihubV1ListHostProjectRegistrationsResponse {
    ...
    pub host_project_registrations: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1HostProjectRegistration>>,
    >,
    /// A token, which can be sent as page_token to retrieve the next page. If this field is omitted, there are no subsequent pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
...
pub struct GoogleCloudApihubV1ListPluginInstancesResponse {
    ...
    pub plugin_instances: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1PluginInstance>>,
    >,
}
...
pub struct GoogleCloudApihubV1ListPluginsResponse {
    ...
    #[serde(default)]
    pub plugins:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1Plugin>>>,
}
...
pub struct GoogleCloudApihubV1ListRuntimeProjectAttachmentsResponse {
    ...
    pub runtime_project_attachments: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1RuntimeProjectAttachment>>,
    >,
}
...
pub struct GoogleCloudApihubV1ListSpecsResponse {
    ...
    #[serde(default)]
    pub specs: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1Spec>>>,
}
...
pub struct GoogleCloudApihubV1ListVersionsResponse {
    ...
    #[serde(default)]
    pub versions:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1Version>>>,
}
...
pub struct GoogleCloudApihubV1LookupApiHubInstanceResponse {
    ...
    pub api_hub_instance:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1ApiHubInstance>>,
}
...
pub struct GoogleCloudApihubV1LookupRuntimeProjectAttachmentResponse {
    ...
    pub runtime_project_attachment:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1RuntimeProjectAttachment>>,
}
...
pub struct GoogleCloudApihubV1McpTool {
    ...
    #[serde(default)]
    pub annotations: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1ToolAnnotations>>,
    /// Optional. Description of what the tool does.
    #[serde(default)]
    pub description: ::core::option::Option<String>,
    /// Optional. Input schema for the operation. This can be parsed only from MCP schema type.
    #[serde(default, rename = "inputSchema")]
    pub input_schema: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1OperationSchema>>,
    ...
    pub output_schema:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1OperationSchema>>,
...
pub struct GoogleCloudApihubV1Oauth2ClientCredentialsConfig {
    ...
    pub client_secret: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1Secret>>,
}
...
pub struct GoogleCloudApihubV1OperationDetails {
    ...
    pub mcp_tool: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1McpTool>>,
}
...
pub struct GoogleCloudApihubV1Plugin {
    ...
    pub actions_config: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1PluginActionConfig>>,
    >,
    /// Optional. The configuration template for the plugin.
    #[serde(default, rename = "configTemplate")]
    pub config_template:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1ConfigTemplate>>,
    ...
    pub hosting_service:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1HostingService>>,
...
pub struct GoogleCloudApihubV1PluginInstance {
    ...
    pub actions: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1PluginInstanceAction>>,
    >,
    ...
    pub auth_config: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1AuthConfig>>,
...
pub struct GoogleCloudApihubV1PluginInstanceAction {
    ...
    pub curation_config:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1CurationConfig>>,
    ...
    pub hub_instance_action:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1ExecutionStatus>>,
    ...
    pub resource_config:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1ResourceConfig>>,
...
pub struct GoogleCloudApihubV1Range {
    ...
    #[serde(default)]
    pub end: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1Point>>,
    /// Required. Start of the issue.
    #[serde(default)]
    pub start: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1Point>>,
}
...
pub struct GoogleCloudApihubV1RetrieveApiViewsResponse {
    ...
    pub api_views:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1ApiView>>>,
    /// Next page token.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct GoogleCloudApihubV1SearchResourcesResponse {
    ...
    pub search_results:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1SearchResult>>>,
}
...
pub struct GoogleCloudApihubV1SearchResult {
    ...
    #[serde(default)]
    pub resource: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1ApiHubResource>>,
}
...
pub struct GoogleCloudApihubV1SourceMetadata {
    ...
    pub plugin_instance_action_source:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1PluginInstanceActionSource>>,
...
pub struct GoogleCloudApihubV1Spec {
    ...
    pub additional_spec_contents: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1AdditionalSpecContent>>,
    >,
    ...
    #[serde(default)]
    pub contents: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1SpecContents>>,
    /// Output only. The time at which the spec was created.
    #[serde(default, rename = "createTime")]
    pub create_time: ::core::option::Option<String>,
    /// Output only. Details parsed from the spec.
    #[serde(default)]
    pub details: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1SpecDetails>>,
    ...
    pub lint_response: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1LintResponse>>,
...
pub struct GoogleCloudApihubV1SpecDetails {
    ...
    pub open_api_spec_details:
        ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1OpenApiSpecDetails>>,
}
...
pub struct GoogleCloudApihubV1StyleGuide {
    ...
    #[serde(default)]
    pub contents: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1StyleGuideContents>>,
...
pub struct GoogleCloudApihubV1UserPasswordConfig {
    ...
    #[serde(default)]
    pub password: ::core::option::Option<::std::boxed::Box<GoogleCloudApihubV1Secret>>,
    /// Required. Username.
    #[serde(default)]
...
pub struct GoogleCloudApihubV1VersionMetadata {
    ...
    pub deployments: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1DeploymentMetadata>>,
    >,
    ...
    #[serde(default)]
    pub specs:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GoogleCloudApihubV1SpecMetadata>>>,
