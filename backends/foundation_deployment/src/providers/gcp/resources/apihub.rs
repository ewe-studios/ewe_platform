...
pub struct GoogleCloudApihubV1ConfigVariable {
    ...
    pub enum_value: Option<GoogleCloudApihubV1ConfigValueOption>,
...
pub struct GoogleCloudApihubV1MultiSelectValues {
    ...
    #[serde(default)]
    pub values: Option<Vec<GoogleCloudApihubV1ConfigValueOption>>,
}
...
pub struct GoogleCloudApihubV1Plugin {
    ...
    #[serde(default, rename = "type")]
    pub type_: Option<GoogleCloudApihubV1AttributeValues>,
...
pub struct GoogleCloudApihubV1SourceEnvironment {
    ...
    pub source_environment_uri: Option<String>,
