...
pub struct AnnotateFileRequest {
    ...
    #[serde(default)]
    pub features: ::core::option::Option<::std::vec::Vec<Feature>>,
...
pub struct AnnotateFileResponse {
    ...
    #[serde(default)]
    pub responses: ::core::option::Option<::std::vec::Vec<AnnotateImageResponse>>,
...
pub struct AnnotateImageResponse {
    ...
    pub face_annotations: ::core::option::Option<::std::vec::Vec<FaceAnnotation>>,
    ...
    pub label_annotations: ::core::option::Option<::std::vec::Vec<EntityAnnotation>>,
    /// If present, landmark detection has completed successfully.
    #[serde(default, rename = "landmarkAnnotations")]
    pub landmark_annotations: ::core::option::Option<::std::vec::Vec<EntityAnnotation>>,
    /// If present, localized object detection has completed successfully. This will be sorted descending by confidence score.
    #[serde(default, rename = "localizedObjectAnnotations")]
    pub localized_object_annotations:
        ::core::option::Option<::std::vec::Vec<LocalizedObjectAnnotation>>,
    /// If present, logo detection has completed successfully.
    #[serde(default, rename = "logoAnnotations")]
    pub logo_annotations: ::core::option::Option<::std::vec::Vec<EntityAnnotation>>,
    ...
    pub text_annotations: ::core::option::Option<::std::vec::Vec<EntityAnnotation>>,
...
pub struct AsyncBatchAnnotateFilesRequest {
    ...
    #[serde(default)]
    pub requests: ::core::option::Option<::std::vec::Vec<AsyncAnnotateFileRequest>>,
}
...
pub struct AsyncBatchAnnotateFilesResponse {
    ...
    #[serde(default)]
    pub responses: ::core::option::Option<::std::vec::Vec<AsyncAnnotateFileResponse>>,
}
...
pub struct AsyncBatchAnnotateImagesRequest {
    ...
    #[serde(default)]
    pub requests: ::core::option::Option<::std::vec::Vec<AnnotateImageRequest>>,
}
...
pub struct BatchAnnotateFilesRequest {
    ...
    #[serde(default)]
    pub requests: ::core::option::Option<::std::vec::Vec<AnnotateFileRequest>>,
}
...
pub struct BatchAnnotateFilesResponse {
    ...
    #[serde(default)]
    pub responses: ::core::option::Option<::std::vec::Vec<AnnotateFileResponse>>,
}
...
pub struct Block {
    ...
    #[serde(default)]
    pub paragraphs: ::core::option::Option<::std::vec::Vec<Paragraph>>,
    /// Additional information detected for the block.
    #[serde(default)]
    pub property: ::core::option::Option<TextProperty>,
}
...
pub struct BoundingPoly {
    ...
    pub normalized_vertices: ::core::option::Option<::std::vec::Vec<NormalizedVertex>>,
    /// The bounding polygon vertices.
    #[serde(default)]
    pub vertices: ::core::option::Option<::std::vec::Vec<Vertex>>,
}
...
pub struct CropHintsAnnotation {
    ...
    pub crop_hints: ::core::option::Option<::std::vec::Vec<CropHint>>,
}
...
pub struct DominantColorsAnnotation {
    ...
    #[serde(default)]
    pub colors: ::core::option::Option<::std::vec::Vec<ColorInfo>>,
}
...
pub struct EntityAnnotation {
    ...
    #[serde(default)]
    pub locations: ::core::option::Option<::std::vec::Vec<LocationInfo>>,
...
pub struct FaceAnnotation {
    ...
    #[serde(default)]
    pub landmarks: ::core::option::Option<::std::vec::Vec<Landmark>>,
...
pub struct GoogleCloudVisionV1p1beta1AnnotateFileResponse {
    ...
    /// Information about the file for which this response is generated.
    #[serde(default, rename = "inputConfig")]
    pub input_config: ::core::option::Option<GoogleCloudVisionV1p1beta1InputConfig>,
    /// Individual responses to images found within the file. This field will be empty if the error field is set.
    #[serde(default)]
    pub responses:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p1beta1AnnotateImageResponse>>,
    /// This field gives the total number of pages in the file.
    #[serde(default, rename = "totalPages")]
    pub total_pages: ::core::option::Option<i32>,
}
...
pub struct GoogleCloudVisionV1p1beta1AnnotateImageResponse {
    /// If present, contextual information is needed to understand where this image comes from.
    #[serde(default)]
    pub context: ::core::option::Option<GoogleCloudVisionV1p1beta1ImageAnnotationContext>,
    /// If present, crop hints have completed successfully.
    #[serde(default, rename = "cropHintsAnnotation")]
    pub crop_hints_annotation:
        ::core::option::Option<GoogleCloudVisionV1p1beta1CropHintsAnnotation>,
    /// If set, represents the error message for the operation. Note that filled-in image annotations are guaranteed to be correct, even when error is set.
    #[serde(default)]
    pub error: ::core::option::Option<Status>,
    /// If present, face detection has completed successfully.
    ...
    pub face_annotations:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p1beta1FaceAnnotation>>,
    /// If present, text (OCR) detection or document (OCR) text detection has completed successfully. This annotation provides the structural hierarchy for the OCR detected text.
    #[serde(default, rename = "fullTextAnnotation")]
    pub full_text_annotation: ::core::option::Option<GoogleCloudVisionV1p1beta1TextAnnotation>,
    /// If present, image properties were extracted successfully.
    #[serde(default, rename = "imagePropertiesAnnotation")]
    pub image_properties_annotation:
        ::core::option::Option<GoogleCloudVisionV1p1beta1ImageProperties>,
    /// If present, label detection has completed successfully.
    #[serde(default, rename = "labelAnnotations")]
    pub label_annotations:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p1beta1EntityAnnotation>>,
    /// If present, landmark detection has completed successfully.
    #[serde(default, rename = "landmarkAnnotations")]
    ...
    pub localized_object_annotations: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudVisionV1p1beta1LocalizedObjectAnnotation>,
    >,
    /// If present, logo detection has completed successfully.
    #[serde(default, rename = "logoAnnotations")]
    ...
    pub product_search_results:
        ::core::option::Option<GoogleCloudVisionV1p1beta1ProductSearchResults>,
    /// If present, safe-search annotation has completed successfully.
    #[serde(default, rename = "safeSearchAnnotation")]
    pub safe_search_annotation:
        ::core::option::Option<GoogleCloudVisionV1p1beta1SafeSearchAnnotation>,
    /// If present, text (OCR) detection has completed successfully.
    #[serde(default, rename = "textAnnotations")]
    ...
    /// If present, web detection has completed successfully.
    #[serde(default, rename = "webDetection")]
    pub web_detection: ::core::option::Option<GoogleCloudVisionV1p1beta1WebDetection>,
}
...
pub struct GoogleCloudVisionV1p1beta1AsyncAnnotateFileResponse {
    /// The output location and metadata from AsyncAnnotateFileRequest.
    #[serde(default, rename = "outputConfig")]
    pub output_config: ::core::option::Option<GoogleCloudVisionV1p1beta1OutputConfig>,
}
...
pub struct GoogleCloudVisionV1p1beta1AsyncBatchAnnotateFilesResponse {
    ...
    pub responses: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudVisionV1p1beta1AsyncAnnotateFileResponse>,
    >,
}
...
pub struct GoogleCloudVisionV1p1beta1Block {
    ...
    /// The bounding box for the block. The vertices are in the order of top-left, top-right, bottom-right, bottom-left. When a rotation of the bounding box is detected the rotation is represented as around the top-left corner as defined when the text is read in the ''natural'' orientation. For example: * when the text is horizontal it might look like: 0----1 | | 3----2 * when it''s rotated 180 degrees around the top-left corner it becomes: 2----3 | | 1----0 and the vertex order will still be (0, 1, 2, 3).
    #[serde(default, rename = "boundingBox")]
    pub bounding_box: ::core::option::Option<GoogleCloudVisionV1p1beta1BoundingPoly>,
    /// Confidence of the OCR results on the block. Range [0, 1].
    #[serde(default)]
    pub confidence: ::core::option::Option<f32>,
    /// List of paragraphs in this block (if this blocks is of type text).
    #[serde(default)]
    pub paragraphs: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p1beta1Paragraph>>,
    /// Additional information detected for the block.
    #[serde(default)]
    pub property: ::core::option::Option<GoogleCloudVisionV1p1beta1TextAnnotationTextProperty>,
}
...
pub struct GoogleCloudVisionV1p1beta1BoundingPoly {
    ...
    pub normalized_vertices:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p1beta1NormalizedVertex>>,
    /// The bounding polygon vertices.
    #[serde(default)]
    pub vertices: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p1beta1Vertex>>,
}
...
pub struct GoogleCloudVisionV1p1beta1CropHint {
    /// The bounding polygon for the crop region. The coordinates of the bounding box are in the original image''s scale.
    #[serde(default, rename = "boundingPoly")]
    pub bounding_poly: ::core::option::Option<GoogleCloudVisionV1p1beta1BoundingPoly>,
    /// Confidence of this being a salient region. Range [0, 1].
    #[serde(default)]
    pub confidence: ::core::option::Option<f32>,
    /// Fraction of importance of this salient region with respect to the original image.
...
pub struct GoogleCloudVisionV1p1beta1CropHintsAnnotation {
    /// Crop hint results.
    #[serde(default, rename = "cropHints")]
    pub crop_hints: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p1beta1CropHint>>,
}
...
pub struct GoogleCloudVisionV1p1beta1DominantColorsAnnotation {
    /// RGB color values with their score and pixel fraction.
    #[serde(default)]
    pub colors: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p1beta1ColorInfo>>,
}
...
pub struct GoogleCloudVisionV1p1beta1EntityAnnotation {
    ...
    /// The location information for the detected entity. Multiple LocationInfo elements can be present because one location may indicate the location of the scene in the image, and another location may indicate the location of the place where the image was taken. Location information is usually present for landmarks.
    #[serde(default)]
    pub locations: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p1beta1LocationInfo>>,
    /// Opaque entity ID. Some IDs may be available in [Google Knowledge Graph Search API](https://developers.google.com/knowledge-graph/).
    #[serde(default)]
    pub mid: ::core::option::Option<String>,
    /// Some entities may have optional user-supplied Property (name/value) fields, such a score or string that qualifies the entity.
    #[serde(default)]
    pub properties: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p1beta1Property>>,
    /// Overall score of the result. Range [0, 1].
    #[serde(default)]
    pub score: ::core::option::Option<f32>,
    /// The relevancy of the ICA (Image Content Annotation) label to the image. For example, the relevancy of "tower" is likely higher to an image containing the detected "Eiffel Tower" than to an image containing a detected distant towering building, even though the confidence that there is a tower in each image may be the same. Range [0, 1].
...
pub struct GoogleCloudVisionV1p1beta1FaceAnnotation {
    ...
    /// The fd_bounding_poly bounding polygon is tighter than the boundingPoly, and encloses only the skin part of the face. Typically, it is used to eliminate the face from any image analysis that detects the "amount of skin" visible in an image. It is not based on the landmarker results, only on the initial face detection, hence the fd (face detection) prefix.
    #[serde(default, rename = "fdBoundingPoly")]
    pub fd_bounding_poly: ::core::option::Option<GoogleCloudVisionV1p1beta1BoundingPoly>,
    /// Headwear likelihood. // TODO: enum values: ["UNKNOWN", "VERY_UNLIKELY", "UNLIKELY", "POSSIBLE", "LIKELY", "VERY_LIKELY"]
    #[serde(default, rename = "headwearLikelihood")]
    pub headwear_likelihood: ::core::option::Option<String>,
    /// Joy likelihood. // TODO: enum values: ["UNKNOWN", "VERY_UNLIKELY", "UNLIKELY", "POSSIBLE", "LIKELY", "VERY_LIKELY"]
    ...
    #[serde(default)]
    pub landmarks:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p1beta1FaceAnnotationLandmark>>,
    /// Yaw angle, which indicates the leftward/rightward angle that the face is pointing relative to the vertical plane perpendicular to the image. Range [-180,180].
    #[serde(default, rename = "panAngle")]
    pub pan_angle: ::core::option::Option<f32>,
    /// Roll angle, which indicates the amount of clockwise/anti-clockwise rotation of the face relative to the image vertical about the axis perpendicular to the face. Range [-180,180].
...
pub struct GoogleCloudVisionV1p1beta1FaceAnnotationLandmark {
    ...
    #[serde(default)]
    pub position: ::core::option::Option<GoogleCloudVisionV1p1beta1Position>,
...
pub struct GoogleCloudVisionV1p1beta1ImageProperties {
    ...
    pub dominant_colors: ::core::option::Option<GoogleCloudVisionV1p1beta1DominantColorsAnnotation>,
}
...
pub struct GoogleCloudVisionV1p1beta1InputConfig {
    ...
    pub gcs_source: ::core::option::Option<GoogleCloudVisionV1p1beta1GcsSource>,
...
pub struct GoogleCloudVisionV1p1beta1OutputConfig {
    ...
    pub gcs_destination: ::core::option::Option<GoogleCloudVisionV1p1beta1GcsDestination>,
}
...
pub struct GoogleCloudVisionV1p1beta1Page {
    ...
    #[serde(default)]
    pub blocks: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p1beta1Block>>,
...
pub struct GoogleCloudVisionV1p1beta1Paragraph {
    ...
    #[serde(default)]
    pub words: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p1beta1Word>>,
}
...
pub struct GoogleCloudVisionV1p1beta1Product {
    ...
    pub product_labels:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p1beta1ProductKeyValue>>,
}
...
pub struct GoogleCloudVisionV1p1beta1ProductSearchResults {
    ...
    pub product_grouped_results: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudVisionV1p1beta1ProductSearchResultsGroupedResult>,
    >,
    /// List of results, one for each product match.
    #[serde(default)]
    pub results: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudVisionV1p1beta1ProductSearchResultsResult>,
    >,
}
...
pub struct GoogleCloudVisionV1p1beta1ProductSearchResultsGroupedResult {
    ...
    pub object_annotations: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudVisionV1p1beta1ProductSearchResultsObjectAnnotation>,
    >,
    /// List of results, one for each product match.
    #[serde(default)]
    pub results: ::core::option::Option<
...
pub struct GoogleCloudVisionV1p1beta1ProductSearchResultsResult {
    ...
    /// The Product.
    #[serde(default)]
    pub product: ::core::option::Option<GoogleCloudVisionV1p1beta1Product>,
...
pub struct GoogleCloudVisionV1p1beta1TextAnnotation {
    ...
    #[serde(default)]
    pub pages: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p1beta1Page>>,
...
pub struct GoogleCloudVisionV1p1beta1TextAnnotationTextProperty {
    ...
    pub detected_break:
        ::core::option::Option<GoogleCloudVisionV1p1beta1TextAnnotationDetectedBreak>,
    /// A list of detected languages together with confidence.
    #[serde(default, rename = "detectedLanguages")]
    pub detected_languages: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudVisionV1p1beta1TextAnnotationDetectedLanguage>,
    >,
}
...
pub struct GoogleCloudVisionV1p1beta1WebDetection {
    ...
    pub best_guess_labels:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p1beta1WebDetectionWebLabel>>,
    /// Fully matching images from the Internet. Can include resized copies of the query image.
    #[serde(default, rename = "fullMatchingImages")]
    pub full_matching_images:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p1beta1WebDetectionWebImage>>,
    /// Web pages containing the matching images from the Internet.
    #[serde(default, rename = "pagesWithMatchingImages")]
    pub pages_with_matching_images:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p1beta1WebDetectionWebPage>>,
    ...
    pub web_entities:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p1beta1WebDetectionWebEntity>>,
}
...
pub struct GoogleCloudVisionV1p1beta1Word {
    ...
    #[serde(default)]
    pub symbols: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p1beta1Symbol>>,
}
...
pub struct GoogleCloudVisionV1p2beta1AnnotateFileResponse {
    ...
    /// Information about the file for which this response is generated.
    #[serde(default, rename = "inputConfig")]
    pub input_config: ::core::option::Option<GoogleCloudVisionV1p2beta1InputConfig>,
    /// Individual responses to images found within the file. This field will be empty if the error field is set.
    #[serde(default)]
    pub responses:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p2beta1AnnotateImageResponse>>,
    /// This field gives the total number of pages in the file.
    #[serde(default, rename = "totalPages")]
    pub total_pages: ::core::option::Option<i32>,
}
...
pub struct GoogleCloudVisionV1p2beta1AnnotateImageResponse {
    /// If present, contextual information is needed to understand where this image comes from.
    #[serde(default)]
    pub context: ::core::option::Option<GoogleCloudVisionV1p2beta1ImageAnnotationContext>,
    /// If present, crop hints have completed successfully.
    #[serde(default, rename = "cropHintsAnnotation")]
    pub crop_hints_annotation:
        ::core::option::Option<GoogleCloudVisionV1p2beta1CropHintsAnnotation>,
    /// If set, represents the error message for the operation. Note that filled-in image annotations are guaranteed to be correct, even when error is set.
    #[serde(default)]
    pub error: ::core::option::Option<Status>,
    /// If present, face detection has completed successfully.
    #[serde(default, rename = "faceAnnotations")]
    pub face_annotations:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p2beta1FaceAnnotation>>,
    /// If present, text (OCR) detection or document (OCR) text detection has completed successfully. This annotation provides the structural hierarchy for the OCR detected text.
    #[serde(default, rename = "fullTextAnnotation")]
    pub full_text_annotation: ::core::option::Option<GoogleCloudVisionV1p2beta1TextAnnotation>,
    /// If present, image properties were extracted successfully.
    #[serde(default, rename = "imagePropertiesAnnotation")]
    pub image_properties_annotation:
        ::core::option::Option<GoogleCloudVisionV1p2beta1ImageProperties>,
    /// If present, label detection has completed successfully.
    #[serde(default, rename = "labelAnnotations")]
    pub label_annotations:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p2beta1EntityAnnotation>>,
    /// If present, landmark detection has completed successfully.
    #[serde(default, rename = "landmarkAnnotations")]
    pub landmark_annotations:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p2beta1EntityAnnotation>>,
    ...
    #[serde(default, rename = "localizedObjectAnnotations")]
    pub localized_object_annotations: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudVisionV1p2beta1LocalizedObjectAnnotation>,
    >,
    /// If present, logo detection has completed successfully.
    #[serde(default, rename = "logoAnnotations")]
    pub logo_annotations:
    ...
    #[serde(default, rename = "productSearchResults")]
    pub product_search_results:
        ::core::option::Option<GoogleCloudVisionV1p2beta1ProductSearchResults>,
    /// If present, safe-search annotation has completed successfully.
    #[serde(default, rename = "safeSearchAnnotation")]
    pub safe_search_annotation:
        ::core::option::Option<GoogleCloudVisionV1p2beta1SafeSearchAnnotation>,
    /// If present, text (OCR) detection has completed successfully.
    #[serde(default, rename = "textAnnotations")]
    pub text_annotations:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p2beta1EntityAnnotation>>,
    /// If present, web detection has completed successfully.
    #[serde(default, rename = "webDetection")]
    pub web_detection: ::core::option::Option<GoogleCloudVisionV1p2beta1WebDetection>,
}
...
pub struct GoogleCloudVisionV1p2beta1AsyncAnnotateFileResponse {
    /// The output location and metadata from AsyncAnnotateFileRequest.
    #[serde(default, rename = "outputConfig")]
    pub output_config: ::core::option::Option<GoogleCloudVisionV1p2beta1OutputConfig>,
}
...
pub struct GoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesResponse {
    ...
    #[serde(default)]
    pub responses: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudVisionV1p2beta1AsyncAnnotateFileResponse>,
    >,
}
...
pub struct GoogleCloudVisionV1p2beta1Block {
    ...
    /// The bounding box for the block. The vertices are in the order of top-left, top-right, bottom-right, bottom-left. When a rotation of the bounding box is detected the rotation is represented as around the top-left corner as defined when the text is read in the ''natural'' orientation. For example: * when the text is horizontal it might look like: 0----1 | | 3----2 * when it''s rotated 180 degrees around the top-left corner it becomes: 2----3 | | 1----0 and the vertex order will still be (0, 1, 2, 3).
    #[serde(default, rename = "boundingBox")]
    pub bounding_box: ::core::option::Option<GoogleCloudVisionV1p2beta1BoundingPoly>,
    /// Confidence of the OCR results on the block. Range [0, 1].
    #[serde(default)]
    pub confidence: ::core::option::Option<f32>,
    /// List of paragraphs in this block (if this blocks is of type text).
    #[serde(default)]
    pub paragraphs: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p2beta1Paragraph>>,
    /// Additional information detected for the block.
    #[serde(default)]
    pub property: ::core::option::Option<GoogleCloudVisionV1p2beta1TextAnnotationTextProperty>,
}
...
pub struct GoogleCloudVisionV1p2beta1BoundingPoly {
    ...
    #[serde(default, rename = "normalizedVertices")]
    pub normalized_vertices:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p2beta1NormalizedVertex>>,
    /// The bounding polygon vertices.
    #[serde(default)]
    pub vertices: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p2beta1Vertex>>,
}
...
pub struct GoogleCloudVisionV1p2beta1CropHint {
    /// The bounding polygon for the crop region. The coordinates of the bounding box are in the original image''s scale.
    #[serde(default, rename = "boundingPoly")]
    pub bounding_poly: ::core::option::Option<GoogleCloudVisionV1p2beta1BoundingPoly>,
    /// Confidence of this being a salient region. Range [0, 1].
    #[serde(default)]
    pub confidence: ::core::option::Option<f32>,
    /// Fraction of importance of this salient region with respect to the original image.
...
pub struct GoogleCloudVisionV1p2beta1CropHintsAnnotation {
    /// Crop hint results.
    #[serde(default, rename = "cropHints")]
    pub crop_hints: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p2beta1CropHint>>,
}
...
pub struct GoogleCloudVisionV1p2beta1DominantColorsAnnotation {
    /// RGB color values with their score and pixel fraction.
    #[serde(default)]
    pub colors: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p2beta1ColorInfo>>,
}
...
pub struct GoogleCloudVisionV1p2beta1EntityAnnotation {
    ...
    /// The location information for the detected entity. Multiple LocationInfo elements can be present because one location may indicate the location of the scene in the image, and another location may indicate the location of the place where the image was taken. Location information is usually present for landmarks.
    #[serde(default)]
    pub locations: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p2beta1LocationInfo>>,
    /// Opaque entity ID. Some IDs may be available in [Google Knowledge Graph Search API](https://developers.google.com/knowledge-graph/).
    #[serde(default)]
    pub mid: ::core::option::Option<String>,
    /// Some entities may have optional user-supplied Property (name/value) fields, such a score or string that qualifies the entity.
    #[serde(default)]
    pub properties: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p2beta1Property>>,
    /// Overall score of the result. Range [0, 1].
    #[serde(default)]
    pub score: ::core::option::Option<f32>,
    /// The relevancy of the ICA (Image Content Annotation) label to the image. For example, the relevancy of "tower" is likely higher to an image containing the detected "Eiffel Tower" than to an image containing a detected distant towering building, even though the confidence that there is a tower in each image may be the same. Range [0, 1].
...
pub struct GoogleCloudVisionV1p2beta1FaceAnnotation {
    ...
    /// The fd_bounding_poly bounding polygon is tighter than the boundingPoly, and encloses only the skin part of the face. Typically, it is used to eliminate the face from any image analysis that detects the "amount of skin" visible in an image. It is not based on the landmarker results, only on the initial face detection, hence the fd (face detection) prefix.
    #[serde(default, rename = "fdBoundingPoly")]
    pub fd_bounding_poly: ::core::option::Option<GoogleCloudVisionV1p2beta1BoundingPoly>,
    /// Headwear likelihood. // TODO: enum values: ["UNKNOWN", "VERY_UNLIKELY", "UNLIKELY", "POSSIBLE", "LIKELY", "VERY_LIKELY"]
    #[serde(default, rename = "headwearLikelihood")]
    pub headwear_likelihood: ::core::option::Option<String>,
    /// Joy likelihood. // TODO: enum values: ["UNKNOWN", "VERY_UNLIKELY", "UNLIKELY", "POSSIBLE", "LIKELY", "VERY_LIKELY"]
    ...
    #[serde(default)]
    pub landmarks:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p2beta1FaceAnnotationLandmark>>,
    /// Yaw angle, which indicates the leftward/rightward angle that the face is pointing relative to the vertical plane perpendicular to the image. Range [-180,180].
    #[serde(default, rename = "panAngle")]
    pub pan_angle: ::core::option::Option<f32>,
    /// Roll angle, which indicates the amount of clockwise/anti-clockwise rotation of the face relative to the image vertical about the axis perpendicular to the face. Range [-180,180].
...
pub struct GoogleCloudVisionV1p2beta1FaceAnnotationLandmark {
    /// Face landmark position.
    #[serde(default)]
    pub position: ::core::option::Option<GoogleCloudVisionV1p2beta1Position>,
    /// Face landmark type. // TODO: enum values: ["UNKNOWN_LANDMARK", "LEFT_EYE", "RIGHT_EYE", "LEFT_OF_LEFT_EYEBROW", "RIGHT_OF_LEFT_EYEBROW", "LEFT_OF_RIGHT_EYEBROW", "RIGHT_OF_RIGHT_EYEBROW", "MIDPOINT_BETWEEN_EYES", "NOSE_TIP", "UPPER_LIP", "LOWER_LIP", "MOUTH_LEFT", "MOUTH_RIGHT", "MOUTH_CENTER", "NOSE_BOTTOM_RIGHT", "NOSE_BOTTOM_LEFT", "NOSE_BOTTOM_CENTER", "LEFT_EYE_TOP_BOUNDARY", "LEFT_EYE_RIGHT_CORNER", "LEFT_EYE_BOTTOM_BOUNDARY", "LEFT_EYE_LEFT_CORNER", "RIGHT_EYE_TOP_BOUNDARY", "RIGHT_EYE_RIGHT_CORNER", "RIGHT_EYE_BOTTOM_BOUNDARY", "RIGHT_EYE_LEFT_CORNER", "LEFT_EYEBROW_UPPER_MIDPOINT", "RIGHT_EYEBROW_UPPER_MIDPOINT", "LEFT_EAR_TRAGION", "RIGHT_EAR_TRAGION", "LEFT_EYE_PUPIL", "RIGHT_EYE_PUPIL", "FOREHEAD_GLABELLA", "CHIN_GNATHION", "CHIN_LEFT_GONION", "CHIN_RIGHT_GONION", "LEFT_CHEEK_CENTER", "RIGHT_CHEEK_CENTER"]
    #[serde(default, rename = "type")]
    pub type_: ::core::option::Option<String>,
}
...
pub struct GoogleCloudVisionV1p2beta1ImageProperties {
    /// If present, dominant colors completed successfully.
    #[serde(default, rename = "dominantColors")]
    pub dominant_colors: ::core::option::Option<GoogleCloudVisionV1p2beta1DominantColorsAnnotation>,
}
...
pub struct GoogleCloudVisionV1p2beta1InputConfig {
    ...
    /// The Google Cloud Storage location to read the input from.
    #[serde(default, rename = "gcsSource")]
    pub gcs_source: ::core::option::Option<GoogleCloudVisionV1p2beta1GcsSource>,
    /// The type of the file. Currently only "application/pdf", "image/tiff" and "image/gif" are supported. Wildcards are not supported.
    #[serde(default, rename = "mimeType")]
    pub mime_type: ::core::option::Option<String>,
}
...
pub struct GoogleCloudVisionV1p2beta1OutputConfig {
    ...
    /// The Google Cloud Storage location to write the output(s) to.
    #[serde(default, rename = "gcsDestination")]
    pub gcs_destination: ::core::option::Option<GoogleCloudVisionV1p2beta1GcsDestination>,
}
...
pub struct GoogleCloudVisionV1p2beta1Page {
    /// List of blocks of text, images etc on this page.
    #[serde(default)]
    pub blocks: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p2beta1Block>>,
    /// Confidence of the OCR results on the page. Range [0, 1].
    #[serde(default)]
    pub confidence: ::core::option::Option<f32>,
    /// Page height. For PDFs the unit is points. For images (including TIFFs) the unit is pixels.
...
pub struct GoogleCloudVisionV1p2beta1Paragraph {
    ...
    /// List of all words in this paragraph.
    #[serde(default)]
    pub words: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p2beta1Word>>,
}
...
pub struct GoogleCloudVisionV1p2beta1Product {
    ...
    #[serde(default, rename = "productLabels")]
    pub product_labels:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p2beta1ProductKeyValue>>,
}
...
pub struct GoogleCloudVisionV1p2beta1ProductSearchResults {
    ...
    #[serde(default, rename = "productGroupedResults")]
    pub product_grouped_results: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResult>,
    >,
    /// List of results, one for each product match.
    #[serde(default)]
    pub results: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudVisionV1p2beta1ProductSearchResultsResult>,
    >,
}
...
pub struct GoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResult {
    ...
    #[serde(default, rename = "objectAnnotations")]
    pub object_annotations: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudVisionV1p2beta1ProductSearchResultsObjectAnnotation>,
    >,
    /// List of results, one for each product match.
    #[serde(default)]
    pub results: ::core::option::Option<
...
pub struct GoogleCloudVisionV1p2beta1ProductSearchResultsResult {
    ...
    /// The Product.
    #[serde(default)]
    pub product: ::core::option::Option<GoogleCloudVisionV1p2beta1Product>,
    /// A confidence level on the match, ranging from 0 (no confidence) to 1 (full confidence).
    #[serde(default)]
    pub score: ::core::option::Option<f32>,
}
...
pub struct GoogleCloudVisionV1p2beta1TextAnnotation {
    /// List of pages detected by OCR.
    #[serde(default)]
    pub pages: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p2beta1Page>>,
    /// UTF-8 text detected on the pages.
    #[serde(default)]
    pub text: ::core::option::Option<String>,
}
...
pub struct GoogleCloudVisionV1p2beta1TextAnnotationTextProperty {
    ...
    #[serde(default, rename = "detectedBreak")]
    pub detected_break:
        ::core::option::Option<GoogleCloudVisionV1p2beta1TextAnnotationDetectedBreak>,
    /// A list of detected languages together with confidence.
    #[serde(default, rename = "detectedLanguages")]
    pub detected_languages: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudVisionV1p2beta1TextAnnotationDetectedLanguage>,
    >,
}
...
pub struct GoogleCloudVisionV1p2beta1WebDetection {
    ...
    #[serde(default, rename = "bestGuessLabels")]
    pub best_guess_labels:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p2beta1WebDetectionWebLabel>>,
    /// Fully matching images from the Internet. Can include resized copies of the query image.
    #[serde(default, rename = "fullMatchingImages")]
    pub full_matching_images:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p2beta1WebDetectionWebImage>>,
    /// Web pages containing the matching images from the Internet.
    #[serde(default, rename = "pagesWithMatchingImages")]
    pub pages_with_matching_images:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p2beta1WebDetectionWebPage>>,
    /// Partial matching images from the Internet. Those images are similar enough to share some key-point features. For example an original image will likely have partial matching for its crops.
    #[serde(default, rename = "partialMatchingImages")]
    pub partial_matching_images:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p2beta1WebDetectionWebImage>>,
    ...
    #[serde(default, rename = "webEntities")]
    pub web_entities:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p2beta1WebDetectionWebEntity>>,
}
...
pub struct GoogleCloudVisionV1p2beta1Word {
    ...
    /// List of symbols in the word. The order of the symbols follows the natural reading order.
    #[serde(default)]
    pub symbols: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p2beta1Symbol>>,
}
...
pub struct GoogleCloudVisionV1p3beta1AnnotateFileResponse {
    ...
    /// Information about the file for which this response is generated.
    #[serde(default, rename = "inputConfig")]
    pub input_config: ::core::option::Option<GoogleCloudVisionV1p3beta1InputConfig>,
    /// Individual responses to images found within the file. This field will be empty if the error field is set.
    #[serde(default)]
    pub responses:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p3beta1AnnotateImageResponse>>,
    /// This field gives the total number of pages in the file.
    #[serde(default, rename = "totalPages")]
    pub total_pages: ::core::option::Option<i32>,
}
...
pub struct GoogleCloudVisionV1p3beta1AnnotateImageResponse {
    /// If present, contextual information is needed to understand where this image comes from.
    #[serde(default)]
    pub context: ::core::option::Option<GoogleCloudVisionV1p3beta1ImageAnnotationContext>,
    /// If present, crop hints have completed successfully.
    #[serde(default, rename = "cropHintsAnnotation")]
    pub crop_hints_annotation:
        ::core::option::Option<GoogleCloudVisionV1p3beta1CropHintsAnnotation>,
    /// If set, represents the error message for the operation. Note that filled-in image annotations are guaranteed to be correct, even when error is set.
    #[serde(default)]
    pub error: ::core::option::Option<Status>,
    /// If present, face detection has completed successfully.
    #[serde(default, rename = "faceAnnotations")]
    pub face_annotations:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p3beta1FaceAnnotation>>,
    /// If present, text (OCR) detection or document (OCR) text detection has completed successfully. This annotation provides the structural hierarchy for the OCR detected text.
    #[serde(default, rename = "fullTextAnnotation")]
    pub full_text_annotation: ::core::option::Option<GoogleCloudVisionV1p3beta1TextAnnotation>,
    /// If present, image properties were extracted successfully.
    #[serde(default, rename = "imagePropertiesAnnotation")]
    pub image_properties_annotation:
        ::core::option::Option<GoogleCloudVisionV1p3beta1ImageProperties>,
    /// If present, label detection has completed successfully.
    #[serde(default, rename = "labelAnnotations")]
    pub label_annotations:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p3beta1EntityAnnotation>>,
    /// If present, landmark detection has completed successfully.
    #[serde(default, rename = "landmarkAnnotations")]
    pub landmark_annotations:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p3beta1EntityAnnotation>>,
    ...
    #[serde(default, rename = "localizedObjectAnnotations")]
    pub localized_object_annotations: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudVisionV1p3beta1LocalizedObjectAnnotation>,
    >,
    /// If present, logo detection has completed successfully.
    #[serde(default, rename = "logoAnnotations")]
    pub logo_annotations:
    ...
    #[serde(default, rename = "productSearchResults")]
    pub product_search_results:
        ::core::option::Option<GoogleCloudVisionV1p3beta1ProductSearchResults>,
    /// If present, safe-search annotation has completed successfully.
    #[serde(default, rename = "safeSearchAnnotation")]
    pub safe_search_annotation:
        ::core::option::Option<GoogleCloudVisionV1p3beta1SafeSearchAnnotation>,
    /// If present, text (OCR) detection has completed successfully.
    #[serde(default, rename = "textAnnotations")]
    pub text_annotations:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p3beta1EntityAnnotation>>,
    /// If present, web detection has completed successfully.
    #[serde(default, rename = "webDetection")]
    pub web_detection: ::core::option::Option<GoogleCloudVisionV1p3beta1WebDetection>,
}
...
pub struct GoogleCloudVisionV1p3beta1AsyncAnnotateFileResponse {
    /// The output location and metadata from AsyncAnnotateFileRequest.
    #[serde(default, rename = "outputConfig")]
    pub output_config: ::core::option::Option<GoogleCloudVisionV1p3beta1OutputConfig>,
}
...
pub struct GoogleCloudVisionV1p3beta1AsyncBatchAnnotateFilesResponse {
    ...
    #[serde(default)]
    pub responses: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudVisionV1p3beta1AsyncAnnotateFileResponse>,
    >,
}
...
pub struct GoogleCloudVisionV1p3beta1Block {
    ...
    /// The bounding box for the block. The vertices are in the order of top-left, top-right, bottom-right, bottom-left. When a rotation of the bounding box is detected the rotation is represented as around the top-left corner as defined when the text is read in the ''natural'' orientation. For example: * when the text is horizontal it might look like: 0----1 | | 3----2 * when it''s rotated 180 degrees around the top-left corner it becomes: 2----3 | | 1----0 and the vertex order will still be (0, 1, 2, 3).
    #[serde(default, rename = "boundingBox")]
    pub bounding_box: ::core::option::Option<GoogleCloudVisionV1p3beta1BoundingPoly>,
    /// Confidence of the OCR results on the block. Range [0, 1].
    #[serde(default)]
    pub confidence: ::core::option::Option<f32>,
    /// List of paragraphs in this block (if this blocks is of type text).
    #[serde(default)]
    pub paragraphs: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p3beta1Paragraph>>,
    /// Additional information detected for the block.
    #[serde(default)]
    pub property: ::core::option::Option<GoogleCloudVisionV1p3beta1TextAnnotationTextProperty>,
}
...
pub struct GoogleCloudVisionV1p3beta1BoundingPoly {
    ...
    #[serde(default, rename = "normalizedVertices")]
    pub normalized_vertices:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p3beta1NormalizedVertex>>,
    /// The bounding polygon vertices.
    #[serde(default)]
    pub vertices: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p3beta1Vertex>>,
}
...
pub struct GoogleCloudVisionV1p3beta1CropHint {
    /// The bounding polygon for the crop region. The coordinates of the bounding box are in the original image''s scale.
    #[serde(default, rename = "boundingPoly")]
    pub bounding_poly: ::core::option::Option<GoogleCloudVisionV1p3beta1BoundingPoly>,
    /// Confidence of this being a salient region. Range [0, 1].
    #[serde(default)]
    pub confidence: ::core::option::Option<f32>,
    /// Fraction of importance of this salient region with respect to the original image.
...
pub struct GoogleCloudVisionV1p3beta1CropHintsAnnotation {
    /// Crop hint results.
    #[serde(default, rename = "cropHints")]
    pub crop_hints: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p3beta1CropHint>>,
}
...
pub struct GoogleCloudVisionV1p3beta1DominantColorsAnnotation {
    /// RGB color values with their score and pixel fraction.
    #[serde(default)]
    pub colors: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p3beta1ColorInfo>>,
}
...
pub struct GoogleCloudVisionV1p3beta1EntityAnnotation {
    ...
    /// The location information for the detected entity. Multiple LocationInfo elements can be present because one location may indicate the location of the scene in the image, and another location may indicate the location of the place where the image was taken. Location information is usually present for landmarks.
    #[serde(default)]
    pub locations: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p3beta1LocationInfo>>,
    /// Opaque entity ID. Some IDs may be available in [Google Knowledge Graph Search API](https://developers.google.com/knowledge-graph/).
    #[serde(default)]
    pub mid: ::core::option::Option<String>,
    /// Some entities may have optional user-supplied Property (name/value) fields, such a score or string that qualifies the entity.
    #[serde(default)]
    pub properties: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p3beta1Property>>,
    /// Overall score of the result. Range [0, 1].
    #[serde(default)]
    pub score: ::core::option::Option<f32>,
    /// The relevancy of the ICA (Image Content Annotation) label to the image. For example, the relevancy of "tower" is likely higher to an image containing the detected "Eiffel Tower" than to an image containing a detected distant towering building, even though the confidence that there is a tower in each image may be the same. Range [0, 1].
...
pub struct GoogleCloudVisionV1p3beta1FaceAnnotation {
    ...
    /// The fd_bounding_poly bounding polygon is tighter than the boundingPoly, and encloses only the skin part of the face. Typically, it is used to eliminate the face from any image analysis that detects the "amount of skin" visible in an image. It is not based on the landmarker results, only on the initial face detection, hence the fd (face detection) prefix.
    #[serde(default, rename = "fdBoundingPoly")]
    pub fd_bounding_poly: ::core::option::Option<GoogleCloudVisionV1p3beta1BoundingPoly>,
    /// Headwear likelihood. // TODO: enum values: ["UNKNOWN", "VERY_UNLIKELY", "UNLIKELY", "POSSIBLE", "LIKELY", "VERY_LIKELY"]
    #[serde(default, rename = "headwearLikelihood")]
    pub headwear_likelihood: ::core::option::Option<String>,
    /// Joy likelihood. // TODO: enum values: ["UNKNOWN", "VERY_UNLIKELY", "UNLIKELY", "POSSIBLE", "LIKELY", "VERY_LIKELY"]
    ...
    #[serde(default)]
    pub landmarks:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p3beta1FaceAnnotationLandmark>>,
    /// Yaw angle, which indicates the leftward/rightward angle that the face is pointing relative to the vertical plane perpendicular to the image. Range [-180,180].
    #[serde(default, rename = "panAngle")]
    pub pan_angle: ::core::option::Option<f32>,
    /// Roll angle, which indicates the amount of clockwise/anti-clockwise rotation of the face relative to the image vertical about the axis perpendicular to the face. Range [-180,180].
...
pub struct GoogleCloudVisionV1p3beta1FaceAnnotationLandmark {
    /// Face landmark position.
    #[serde(default)]
    pub position: ::core::option::Option<GoogleCloudVisionV1p3beta1Position>,
    /// Face landmark type. // TODO: enum values: ["UNKNOWN_LANDMARK", "LEFT_EYE", "RIGHT_EYE", "LEFT_OF_LEFT_EYEBROW", "RIGHT_OF_LEFT_EYEBROW", "LEFT_OF_RIGHT_EYEBROW", "RIGHT_OF_RIGHT_EYEBROW", "MIDPOINT_BETWEEN_EYES", "NOSE_TIP", "UPPER_LIP", "LOWER_LIP", "MOUTH_LEFT", "MOUTH_RIGHT", "MOUTH_CENTER", "NOSE_BOTTOM_RIGHT", "NOSE_BOTTOM_LEFT", "NOSE_BOTTOM_CENTER", "LEFT_EYE_TOP_BOUNDARY", "LEFT_EYE_RIGHT_CORNER", "LEFT_EYE_BOTTOM_BOUNDARY", "LEFT_EYE_LEFT_CORNER", "RIGHT_EYE_TOP_BOUNDARY", "RIGHT_EYE_RIGHT_CORNER", "RIGHT_EYE_BOTTOM_BOUNDARY", "RIGHT_EYE_LEFT_CORNER", "LEFT_EYEBROW_UPPER_MIDPOINT", "RIGHT_EYEBROW_UPPER_MIDPOINT", "LEFT_EAR_TRAGION", "RIGHT_EAR_TRAGION", "LEFT_EYE_PUPIL", "RIGHT_EYE_PUPIL", "FOREHEAD_GLABELLA", "CHIN_GNATHION", "CHIN_LEFT_GONION", "CHIN_RIGHT_GONION", "LEFT_CHEEK_CENTER", "RIGHT_CHEEK_CENTER"]
    #[serde(default, rename = "type")]
    pub type_: ::core::option::Option<String>,
}
...
pub struct GoogleCloudVisionV1p3beta1ImageProperties {
    /// If present, dominant colors completed successfully.
    #[serde(default, rename = "dominantColors")]
    pub dominant_colors: ::core::option::Option<GoogleCloudVisionV1p3beta1DominantColorsAnnotation>,
}
...
pub struct GoogleCloudVisionV1p3beta1ImportProductSetsResponse {
    ...
    pub reference_images:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p3beta1ReferenceImage>>,
...
pub struct GoogleCloudVisionV1p3beta1InputConfig {
    ...
    /// The Google Cloud Storage location to read the input from.
    #[serde(default, rename = "gcsSource")]
    pub gcs_source: ::core::option::Option<GoogleCloudVisionV1p3beta1GcsSource>,
    /// The type of the file. Currently only "application/pdf", "image/tiff" and "image/gif" are supported. Wildcards are not supported.
    #[serde(default, rename = "mimeType")]
    pub mime_type: ::core::option::Option<String>,
}
...
pub struct GoogleCloudVisionV1p3beta1OutputConfig {
    ...
    /// The Google Cloud Storage location to write the output(s) to.
    #[serde(default, rename = "gcsDestination")]
    pub gcs_destination: ::core::option::Option<GoogleCloudVisionV1p3beta1GcsDestination>,
}
...
pub struct GoogleCloudVisionV1p3beta1Page {
    /// List of blocks of text, images etc on this page.
    #[serde(default)]
    pub blocks: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p3beta1Block>>,
    /// Confidence of the OCR results on the page. Range [0, 1].
    #[serde(default)]
    pub confidence: ::core::option::Option<f32>,
    /// Page height. For PDFs the unit is points. For images (including TIFFs) the unit is pixels.
...
pub struct GoogleCloudVisionV1p3beta1Paragraph {
    ...
    /// List of all words in this paragraph.
    #[serde(default)]
    pub words: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p3beta1Word>>,
}
...
pub struct GoogleCloudVisionV1p3beta1Product {
    ...
    #[serde(default, rename = "productLabels")]
    pub product_labels:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p3beta1ProductKeyValue>>,
}
...
pub struct GoogleCloudVisionV1p3beta1ProductSearchResults {
    ...
    #[serde(default, rename = "productGroupedResults")]
    pub product_grouped_results: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudVisionV1p3beta1ProductSearchResultsGroupedResult>,
    >,
    /// List of results, one for each product match.
    #[serde(default)]
    pub results: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudVisionV1p3beta1ProductSearchResultsResult>,
    >,
}
...
pub struct GoogleCloudVisionV1p3beta1ProductSearchResultsGroupedResult {
    ...
    #[serde(default, rename = "objectAnnotations")]
    pub object_annotations: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudVisionV1p3beta1ProductSearchResultsObjectAnnotation>,
    >,
    /// List of results, one for each product match.
    #[serde(default)]
    pub results: ::core::option::Option<
...
pub struct GoogleCloudVisionV1p3beta1ProductSearchResultsResult {
    ...
    /// The Product.
    #[serde(default)]
    pub product: ::core::option::Option<GoogleCloudVisionV1p3beta1Product>,
    /// A confidence level on the match, ranging from 0 (no confidence) to 1 (full confidence).
    #[serde(default)]
    pub score: ::core::option::Option<f32>,
}
...
pub struct GoogleCloudVisionV1p3beta1ReferenceImage {
    ...
    pub bounding_polys:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p3beta1BoundingPoly>>,
...
pub struct GoogleCloudVisionV1p3beta1TextAnnotation {
    /// List of pages detected by OCR.
    #[serde(default)]
    pub pages: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p3beta1Page>>,
    /// UTF-8 text detected on the pages.
    #[serde(default)]
    pub text: ::core::option::Option<String>,
}
...
pub struct GoogleCloudVisionV1p3beta1TextAnnotationTextProperty {
    ...
    #[serde(default, rename = "detectedBreak")]
    pub detected_break:
        ::core::option::Option<GoogleCloudVisionV1p3beta1TextAnnotationDetectedBreak>,
    /// A list of detected languages together with confidence.
    #[serde(default, rename = "detectedLanguages")]
    pub detected_languages: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudVisionV1p3beta1TextAnnotationDetectedLanguage>,
    >,
}
...
pub struct GoogleCloudVisionV1p3beta1WebDetection {
    ...
    #[serde(default, rename = "bestGuessLabels")]
    pub best_guess_labels:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p3beta1WebDetectionWebLabel>>,
    /// Fully matching images from the Internet. Can include resized copies of the query image.
    #[serde(default, rename = "fullMatchingImages")]
    pub full_matching_images:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p3beta1WebDetectionWebImage>>,
    /// Web pages containing the matching images from the Internet.
    #[serde(default, rename = "pagesWithMatchingImages")]
    pub pages_with_matching_images:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p3beta1WebDetectionWebPage>>,
    /// Partial matching images from the Internet. Those images are similar enough to share some key-point features. For example an original image will likely have partial matching for its crops.
    #[serde(default, rename = "partialMatchingImages")]
    pub partial_matching_images:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p3beta1WebDetectionWebImage>>,
    ...
    #[serde(default, rename = "webEntities")]
    pub web_entities:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p3beta1WebDetectionWebEntity>>,
}
...
pub struct GoogleCloudVisionV1p3beta1Word {
    ...
    /// List of symbols in the word. The order of the symbols follows the natural reading order.
    #[serde(default)]
    pub symbols: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p3beta1Symbol>>,
}
...
pub struct GoogleCloudVisionV1p4beta1AnnotateFileResponse {
    ...
    /// Information about the file for which this response is generated.
    #[serde(default, rename = "inputConfig")]
    pub input_config: ::core::option::Option<GoogleCloudVisionV1p4beta1InputConfig>,
    /// Individual responses to images found within the file. This field will be empty if the error field is set.
    #[serde(default)]
    pub responses:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p4beta1AnnotateImageResponse>>,
    /// This field gives the total number of pages in the file.
    #[serde(default, rename = "totalPages")]
    pub total_pages: ::core::option::Option<i32>,
}
...
pub struct GoogleCloudVisionV1p4beta1AnnotateImageResponse {
    /// If present, contextual information is needed to understand where this image comes from.
    #[serde(default)]
    pub context: ::core::option::Option<GoogleCloudVisionV1p4beta1ImageAnnotationContext>,
    /// If present, crop hints have completed successfully.
    #[serde(default, rename = "cropHintsAnnotation")]
    pub crop_hints_annotation:
        ::core::option::Option<GoogleCloudVisionV1p4beta1CropHintsAnnotation>,
    /// If set, represents the error message for the operation. Note that filled-in image annotations are guaranteed to be correct, even when error is set.
    #[serde(default)]
    pub error: ::core::option::Option<Status>,
    /// If present, face detection has completed successfully.
    #[serde(default, rename = "faceAnnotations")]
    pub face_annotations:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p4beta1FaceAnnotation>>,
    /// If present, text (OCR) detection or document (OCR) text detection has completed successfully. This annotation provides the structural hierarchy for the OCR detected text.
    #[serde(default, rename = "fullTextAnnotation")]
    pub full_text_annotation: ::core::option::Option<GoogleCloudVisionV1p4beta1TextAnnotation>,
    /// If present, image properties were extracted successfully.
    #[serde(default, rename = "imagePropertiesAnnotation")]
    pub image_properties_annotation:
        ::core::option::Option<GoogleCloudVisionV1p4beta1ImageProperties>,
    /// If present, label detection has completed successfully.
    #[serde(default, rename = "labelAnnotations")]
    pub label_annotations:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p4beta1EntityAnnotation>>,
    /// If present, landmark detection has completed successfully.
    #[serde(default, rename = "landmarkAnnotations")]
    pub landmark_annotations:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p4beta1EntityAnnotation>>,
    ...
    #[serde(default, rename = "localizedObjectAnnotations")]
    pub localized_object_annotations: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudVisionV1p4beta1LocalizedObjectAnnotation>,
    >,
    /// If present, logo detection has completed successfully.
    #[serde(default, rename = "logoAnnotations")]
    pub logo_annotations:
    ...
    #[serde(default, rename = "productSearchResults")]
    pub product_search_results:
        ::core::option::Option<GoogleCloudVisionV1p4beta1ProductSearchResults>,
    /// If present, safe-search annotation has completed successfully.
    #[serde(default, rename = "safeSearchAnnotation")]
    pub safe_search_annotation:
        ::core::option::Option<GoogleCloudVisionV1p4beta1SafeSearchAnnotation>,
    /// If present, text (OCR) detection has completed successfully.
    #[serde(default, rename = "textAnnotations")]
    pub text_annotations:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p4beta1EntityAnnotation>>,
    /// If present, web detection has completed successfully.
    #[serde(default, rename = "webDetection")]
    pub web_detection: ::core::option::Option<GoogleCloudVisionV1p4beta1WebDetection>,
}
...
pub struct GoogleCloudVisionV1p4beta1AsyncAnnotateFileResponse {
    /// The output location and metadata from AsyncAnnotateFileRequest.
    #[serde(default, rename = "outputConfig")]
    pub output_config: ::core::option::Option<GoogleCloudVisionV1p4beta1OutputConfig>,
}
...
pub struct GoogleCloudVisionV1p4beta1AsyncBatchAnnotateFilesResponse {
    ...
    #[serde(default)]
    pub responses: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudVisionV1p4beta1AsyncAnnotateFileResponse>,
    >,
}
...
pub struct GoogleCloudVisionV1p4beta1BatchAnnotateFilesResponse {
    ...
    #[serde(default)]
    pub responses:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p4beta1AnnotateFileResponse>>,
}
...
pub struct GoogleCloudVisionV1p4beta1Block {
    ...
    /// The bounding box for the block. The vertices are in the order of top-left, top-right, bottom-right, bottom-left. When a rotation of the bounding box is detected the rotation is represented as around the top-left corner as defined when the text is read in the ''natural'' orientation. For example: * when the text is horizontal it might look like: 0----1 | | 3----2 * when it''s rotated 180 degrees around the top-left corner it becomes: 2----3 | | 1----0 and the vertex order will still be (0, 1, 2, 3).
    #[serde(default, rename = "boundingBox")]
    pub bounding_box: ::core::option::Option<GoogleCloudVisionV1p4beta1BoundingPoly>,
    /// Confidence of the OCR results on the block. Range [0, 1].
    #[serde(default)]
    pub confidence: ::core::option::Option<f32>,
    /// List of paragraphs in this block (if this blocks is of type text).
    #[serde(default)]
    pub paragraphs: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p4beta1Paragraph>>,
    /// Additional information detected for the block.
    #[serde(default)]
    pub property: ::core::option::Option<GoogleCloudVisionV1p4beta1TextAnnotationTextProperty>,
}
...
pub struct GoogleCloudVisionV1p4beta1BoundingPoly {
    ...
    #[serde(default, rename = "normalizedVertices")]
    pub normalized_vertices:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p4beta1NormalizedVertex>>,
    /// The bounding polygon vertices.
    #[serde(default)]
    pub vertices: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p4beta1Vertex>>,
}
...
pub struct GoogleCloudVisionV1p4beta1CropHint {
    /// The bounding polygon for the crop region. The coordinates of the bounding box are in the original image''s scale.
    #[serde(default, rename = "boundingPoly")]
    pub bounding_poly: ::core::option::Option<GoogleCloudVisionV1p4beta1BoundingPoly>,
    /// Confidence of this being a salient region. Range [0, 1].
    #[serde(default)]
    pub confidence: ::core::option::Option<f32>,
    /// Fraction of importance of this salient region with respect to the original image.
...
pub struct GoogleCloudVisionV1p4beta1CropHintsAnnotation {
    /// Crop hint results.
    #[serde(default, rename = "cropHints")]
    pub crop_hints: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p4beta1CropHint>>,
}
...
pub struct GoogleCloudVisionV1p4beta1DominantColorsAnnotation {
    /// RGB color values with their score and pixel fraction.
    #[serde(default)]
    pub colors: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p4beta1ColorInfo>>,
}
...
pub struct GoogleCloudVisionV1p4beta1EntityAnnotation {
    ...
    /// The location information for the detected entity. Multiple LocationInfo elements can be present because one location may indicate the location of the scene in the image, and another location may indicate the location of the place where the image was taken. Location information is usually present for landmarks.
    #[serde(default)]
    pub locations: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p4beta1LocationInfo>>,
    /// Opaque entity ID. Some IDs may be available in [Google Knowledge Graph Search API](https://developers.google.com/knowledge-graph/).
    #[serde(default)]
    pub mid: ::core::option::Option<String>,
    /// Some entities may have optional user-supplied Property (name/value) fields, such a score or string that qualifies the entity.
    #[serde(default)]
    pub properties: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p4beta1Property>>,
    /// Overall score of the result. Range [0, 1].
    #[serde(default)]
    pub score: ::core::option::Option<f32>,
    /// The relevancy of the ICA (Image Content Annotation) label to the image. For example, the relevancy of "tower" is likely higher to an image containing the detected "Eiffel Tower" than to an image containing a detected distant towering building, even though the confidence that there is a tower in each image may be the same. Range [0, 1].
...
pub struct GoogleCloudVisionV1p4beta1FaceAnnotation {
    ...
    /// The fd_bounding_poly bounding polygon is tighter than the boundingPoly, and encloses only the skin part of the face. Typically, it is used to eliminate the face from any image analysis that detects the "amount of skin" visible in an image. It is not based on the landmarker results, only on the initial face detection, hence the fd (face detection) prefix.
    #[serde(default, rename = "fdBoundingPoly")]
    pub fd_bounding_poly: ::core::option::Option<GoogleCloudVisionV1p4beta1BoundingPoly>,
    /// Headwear likelihood. // TODO: enum values: ["UNKNOWN", "VERY_UNLIKELY", "UNLIKELY", "POSSIBLE", "LIKELY", "VERY_LIKELY"]
    #[serde(default, rename = "headwearLikelihood")]
    pub headwear_likelihood: ::core::option::Option<String>,
    /// Joy likelihood. // TODO: enum values: ["UNKNOWN", "VERY_UNLIKELY", "UNLIKELY", "POSSIBLE", "LIKELY", "VERY_LIKELY"]
    ...
    #[serde(default)]
    pub landmarks:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p4beta1FaceAnnotationLandmark>>,
    /// Yaw angle, which indicates the leftward/rightward angle that the face is pointing relative to the vertical plane perpendicular to the image. Range [-180,180].
    #[serde(default, rename = "panAngle")]
    pub pan_angle: ::core::option::Option<f32>,
    ...
    pub recognition_result:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p4beta1FaceRecognitionResult>>,
    /// Roll angle, which indicates the amount of clockwise/anti-clockwise rotation of the face relative to the image vertical about the axis perpendicular to the face. Range [-180,180].
    #[serde(default, rename = "rollAngle")]
    pub roll_angle: ::core::option::Option<f32>,
    /// Sorrow likelihood. // TODO: enum values: ["UNKNOWN", "VERY_UNLIKELY", "UNLIKELY", "POSSIBLE", "LIKELY", "VERY_LIKELY"]
...
pub struct GoogleCloudVisionV1p4beta1FaceAnnotationLandmark {
    /// Face landmark position.
    #[serde(default)]
    pub position: ::core::option::Option<GoogleCloudVisionV1p4beta1Position>,
    /// Face landmark type. // TODO: enum values: ["UNKNOWN_LANDMARK", "LEFT_EYE", "RIGHT_EYE", "LEFT_OF_LEFT_EYEBROW", "RIGHT_OF_LEFT_EYEBROW", "LEFT_OF_RIGHT_EYEBROW", "RIGHT_OF_RIGHT_EYEBROW", "MIDPOINT_BETWEEN_EYES", "NOSE_TIP", "UPPER_LIP", "LOWER_LIP", "MOUTH_LEFT", "MOUTH_RIGHT", "MOUTH_CENTER", "NOSE_BOTTOM_RIGHT", "NOSE_BOTTOM_LEFT", "NOSE_BOTTOM_CENTER", "LEFT_EYE_TOP_BOUNDARY", "LEFT_EYE_RIGHT_CORNER", "LEFT_EYE_BOTTOM_BOUNDARY", "LEFT_EYE_LEFT_CORNER", "RIGHT_EYE_TOP_BOUNDARY", "RIGHT_EYE_RIGHT_CORNER", "RIGHT_EYE_BOTTOM_BOUNDARY", "RIGHT_EYE_LEFT_CORNER", "LEFT_EYEBROW_UPPER_MIDPOINT", "RIGHT_EYEBROW_UPPER_MIDPOINT", "LEFT_EAR_TRAGION", "RIGHT_EAR_TRAGION", "LEFT_EYE_PUPIL", "RIGHT_EYE_PUPIL", "FOREHEAD_GLABELLA", "CHIN_GNATHION", "CHIN_LEFT_GONION", "CHIN_RIGHT_GONION", "LEFT_CHEEK_CENTER", "RIGHT_CHEEK_CENTER"]
    #[serde(default, rename = "type")]
    pub type_: ::core::option::Option<String>,
}
...
pub struct GoogleCloudVisionV1p4beta1FaceRecognitionResult {
    ...
    #[serde(default)]
    pub celebrity: ::core::option::Option<GoogleCloudVisionV1p4beta1Celebrity>,
...
pub struct GoogleCloudVisionV1p4beta1ImageProperties {
    /// If present, dominant colors completed successfully.
    #[serde(default, rename = "dominantColors")]
    pub dominant_colors: ::core::option::Option<GoogleCloudVisionV1p4beta1DominantColorsAnnotation>,
}
...
pub struct GoogleCloudVisionV1p4beta1ImportProductSetsResponse {
    ...
    #[serde(default, rename = "referenceImages")]
    pub reference_images:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p4beta1ReferenceImage>>,
    /// The rpc status for each ImportProductSet request, including both successes and errors. The number of statuses here matches the number of lines in the csv file, and statuses[i] stores the success or failure status of processing the i-th line of the csv, starting from line 0.
    #[serde(default)]
    pub statuses: ::core::option::Option<::std::vec::Vec<Status>>,
}
...
pub struct GoogleCloudVisionV1p4beta1InputConfig {
    ...
    /// The Google Cloud Storage location to read the input from.
    #[serde(default, rename = "gcsSource")]
    pub gcs_source: ::core::option::Option<GoogleCloudVisionV1p4beta1GcsSource>,
    /// The type of the file. Currently only "application/pdf", "image/tiff" and "image/gif" are supported. Wildcards are not supported.
    #[serde(default, rename = "mimeType")]
    pub mime_type: ::core::option::Option<String>,
}
...
pub struct GoogleCloudVisionV1p4beta1OutputConfig {
    ...
    /// The Google Cloud Storage location to write the output(s) to.
    #[serde(default, rename = "gcsDestination")]
    pub gcs_destination: ::core::option::Option<GoogleCloudVisionV1p4beta1GcsDestination>,
}
...
pub struct GoogleCloudVisionV1p4beta1Page {
    /// List of blocks of text, images etc on this page.
    #[serde(default)]
    pub blocks: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p4beta1Block>>,
    /// Confidence of the OCR results on the page. Range [0, 1].
    #[serde(default)]
    pub confidence: ::core::option::Option<f32>,
    /// Page height. For PDFs the unit is points. For images (including TIFFs) the unit is pixels.
...
pub struct GoogleCloudVisionV1p4beta1Paragraph {
    ...
    /// List of all words in this paragraph.
    #[serde(default)]
    pub words: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p4beta1Word>>,
}
...
pub struct GoogleCloudVisionV1p4beta1Product {
    ...
    #[serde(default, rename = "productLabels")]
    pub product_labels:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p4beta1ProductKeyValue>>,
}
...
pub struct GoogleCloudVisionV1p4beta1ProductSearchResults {
    ...
    #[serde(default, rename = "productGroupedResults")]
    pub product_grouped_results: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudVisionV1p4beta1ProductSearchResultsGroupedResult>,
    >,
    /// List of results, one for each product match.
    #[serde(default)]
    pub results: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudVisionV1p4beta1ProductSearchResultsResult>,
    >,
}
...
pub struct GoogleCloudVisionV1p4beta1ProductSearchResultsGroupedResult {
    ...
    #[serde(default, rename = "objectAnnotations")]
    pub object_annotations: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudVisionV1p4beta1ProductSearchResultsObjectAnnotation>,
    >,
    /// List of results, one for each product match.
    #[serde(default)]
    pub results: ::core::option::Option<
...
pub struct GoogleCloudVisionV1p4beta1ProductSearchResultsResult {
    ...
    /// The Product.
    #[serde(default)]
    pub product: ::core::option::Option<GoogleCloudVisionV1p4beta1Product>,
    /// A confidence level on the match, ranging from 0 (no confidence) to 1 (full confidence).
    #[serde(default)]
    pub score: ::core::option::Option<f32>,
}
...
pub struct GoogleCloudVisionV1p4beta1ReferenceImage {
    ...
    #[serde(default, rename = "boundingPolys")]
    pub bounding_polys:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p4beta1BoundingPoly>>,
    /// The resource name of the reference image. Format is: projects/PROJECT_ID/locations/LOC_ID/products/PRODUCT_ID/referenceImages/IMAGE_ID. This field is ignored when creating a reference image.
    #[serde(default)]
    pub name: ::core::option::Option<String>,
    /// Required. The Google Cloud Storage URI of the reference image. The URI must start with gs://.
...
pub struct GoogleCloudVisionV1p4beta1TextAnnotation {
    /// List of pages detected by OCR.
    #[serde(default)]
    pub pages: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p4beta1Page>>,
    /// UTF-8 text detected on the pages.
    #[serde(default)]
    pub text: ::core::option::Option<String>,
}
...
pub struct GoogleCloudVisionV1p4beta1TextAnnotationTextProperty {
    ...
    #[serde(default, rename = "detectedBreak")]
    pub detected_break:
        ::core::option::Option<GoogleCloudVisionV1p4beta1TextAnnotationDetectedBreak>,
    /// A list of detected languages together with confidence.
    #[serde(default, rename = "detectedLanguages")]
    pub detected_languages: ::core::option::Option<
        ::std::vec::Vec<GoogleCloudVisionV1p4beta1TextAnnotationDetectedLanguage>,
    >,
}
...
pub struct GoogleCloudVisionV1p4beta1WebDetection {
    ...
    #[serde(default, rename = "bestGuessLabels")]
    pub best_guess_labels:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p4beta1WebDetectionWebLabel>>,
    /// Fully matching images from the Internet. Can include resized copies of the query image.
    #[serde(default, rename = "fullMatchingImages")]
    pub full_matching_images:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p4beta1WebDetectionWebImage>>,
    /// Web pages containing the matching images from the Internet.
    #[serde(default, rename = "pagesWithMatchingImages")]
    pub pages_with_matching_images:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p4beta1WebDetectionWebPage>>,
    /// Partial matching images from the Internet. Those images are similar enough to share some key-point features. For example an original image will likely have partial matching for its crops.
    #[serde(default, rename = "partialMatchingImages")]
    pub partial_matching_images:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p4beta1WebDetectionWebImage>>,
    ...
    #[serde(default, rename = "webEntities")]
    pub web_entities:
        ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p4beta1WebDetectionWebEntity>>,
}
...
pub struct GoogleCloudVisionV1p4beta1Word {
    ...
    /// List of symbols in the word. The order of the symbols follows the natural reading order.
    #[serde(default)]
    pub symbols: ::core::option::Option<::std::vec::Vec<GoogleCloudVisionV1p4beta1Symbol>>,
}
...
pub struct GroupedResult {
    ...
    /// List of generic predictions for the object in the bounding box.
    #[serde(default, rename = "objectAnnotations")]
    pub object_annotations: ::core::option::Option<::std::vec::Vec<ObjectAnnotation>>,
    /// List of results, one for each product match.
    #[serde(default)]
...
pub struct ImportProductSetsInputConfig {
    /// The Google Cloud Storage location for a csv file which preserves a list of ImportProductSetRequests in each line.
    #[serde(default, rename = "gcsSource")]
    pub gcs_source: ::core::option::Option<ImportProductSetsGcsSource>,
}
...
pub struct ImportProductSetsResponse {
    /// The list of reference_images that are imported successfully.
    #[serde(default, rename = "referenceImages")]
    pub reference_images: ::core::option::Option<::std::vec::Vec<ReferenceImage>>,
    /// The rpc status for each ImportProductSet request, including both successes and errors. The number of statuses here matches the number of lines in the csv file, and statuses[i] stores the success or failure status of processing the i-th line of the csv, starting from line 0.
    #[serde(default)]
    pub statuses: ::core::option::Option<::std::vec::Vec<Status>>,
}
...
pub struct LatLongRect {
    ...
    pub max_lat_lng: ::core::option::Option<LatLng>,
    /// Min lat/long pair.
    #[serde(default, rename = "minLatLng")]
    pub min_lat_lng: ::core::option::Option<LatLng>,
}
...
pub struct ListProductSetsResponse {
    ...
    pub product_sets: ::core::option::Option<::std::vec::Vec<ProductSet>>,
}
...
pub struct Page {
    /// List of blocks of text, images etc on this page.
    #[serde(default)]
    pub blocks: ::core::option::Option<::std::vec::Vec<Block>>,
    /// Confidence of the OCR results on the page. Range [0, 1].
    #[serde(default)]
    pub confidence: ::core::option::Option<f32>,
    /// Page height. For PDFs the unit is points. For images (including TIFFs) the unit is pixels.
...
pub struct Paragraph {
    ...
    /// List of all words in this paragraph.
    #[serde(default)]
    pub words: ::core::option::Option<::std::vec::Vec<Word>>,
}
...
pub struct Product {
    ...
    /// Key-value pairs that can be attached to a product. At query time, constraints can be specified based on the product_labels. Note that integer values can be provided as strings, e.g. "1199". Only strings with integer values can match a range-based restriction which is to be supported soon. Multiple values can be assigned to the same key. One product may have up to 500 product_labels. Notice that the total number of distinct product_labels over all products in one ProductSet cannot exceed 1M, otherwise the product search pipeline will refuse to work for that ProductSet.
    #[serde(default, rename = "productLabels")]
    pub product_labels: ::core::option::Option<::std::vec::Vec<KeyValue>>,
}
...
pub struct ProductSearchResults {
    ...
    /// List of results grouped by products detected in the query image. Each entry corresponds to one bounding polygon in the query image, and contains the matching products specific to that region. There may be duplicate product matches in the union of all the per-product results.
    #[serde(default, rename = "productGroupedResults")]
    pub product_grouped_results: ::core::option::Option<::std::vec::Vec<GroupedResult>>,
    /// List of results, one for each product match.
    #[serde(default)]
    pub results: ::core::option::Option<::std::vec::Vec<ApiResult>>,
}
...
pub struct ProductSet {
    ...
    pub index_error: ::core::option::Option<Status>,
...
pub struct PurgeProductsRequest {
    ...
    pub product_set_purge_config: ::core::option::Option<ProductSetPurgeConfig>,
}
...
pub struct ReferenceImage {
    /// Optional. Bounding polygons around the areas of interest in the reference image. If this field is empty, the system will try to detect regions of interest. At most 10 bounding polygons will be used. The provided shape is converted into a non-rotated rectangle. Once converted, the small edge of the rectangle must be greater than or equal to 300 pixels. The aspect ratio must be 1:4 or less (i.e. 1:3 is ok; 1:5 is not).
    #[serde(default, rename = "boundingPolys")]
    pub bounding_polys: ::core::option::Option<::std::vec::Vec<BoundingPoly>>,
    /// The resource name of the reference image. Format is: projects/PROJECT_ID/locations/LOC_ID/products/PRODUCT_ID/referenceImages/IMAGE_ID. This field is ignored when creating a reference image.
    #[serde(default)]
    pub name: ::core::option::Option<String>,
    /// Required. The Google Cloud Storage URI of the reference image. The URI must start with gs://.
...
pub struct TextProperty {
    ...
    /// A list of detected languages together with confidence.
    #[serde(default, rename = "detectedLanguages")]
    pub detected_languages: ::core::option::Option<::std::vec::Vec<DetectedLanguage>>,
}
...
pub struct WebDetection {
    /// The service''s best guess as to the topic of the request image. Inferred from similar images on the open web.
    #[serde(default, rename = "bestGuessLabels")]
    pub best_guess_labels: ::core::option::Option<::std::vec::Vec<WebLabel>>,
    /// Fully matching images from the Internet. Can include resized copies of the query image.
    #[serde(default, rename = "fullMatchingImages")]
    pub full_matching_images: ::core::option::Option<::std::vec::Vec<WebImage>>,
    /// Web pages containing the matching images from the Internet.
    #[serde(default, rename = "pagesWithMatchingImages")]
    pub pages_with_matching_images: ::core::option::Option<::std::vec::Vec<WebPage>>,
    /// Partial matching images from the Internet. Those images are similar enough to share some key-point features. For example an original image will likely have partial matching for its crops.
    #[serde(default, rename = "partialMatchingImages")]
    pub partial_matching_images: ::core::option::Option<::std::vec::Vec<WebImage>>,
    /// The visually similar image results.
    #[serde(default, rename = "visuallySimilarImages")]
    pub visually_similar_images: ::core::option::Option<::std::vec::Vec<WebImage>>,
    /// Deduced entities from similar images on the Internet.
    #[serde(default, rename = "webEntities")]
    pub web_entities: ::core::option::Option<::std::vec::Vec<WebEntity>>,
}
...
pub struct Word {
    ...
    /// List of symbols in the word. The order of the symbols follows the natural reading order.
    #[serde(default)]
    pub symbols: ::core::option::Option<::std::vec::Vec<Symbol>>,
}
