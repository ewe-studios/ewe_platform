...
pub struct GetMembershipGraphResponse {
    ...
    pub adjacency_list: Option<Vec<MembershipAdjacencyList>>,
...
pub struct GoogleAppsCloudidentityDevicesV1ApproveDeviceUserResponse {
    ...
    pub device_user: Option<GoogleAppsCloudidentityDevicesV1DeviceUser>,
}
...
pub struct GoogleAppsCloudidentityDevicesV1CancelWipeDeviceResponse {
    ...
    #[serde(default)]
    pub device: Option<GoogleAppsCloudidentityDevicesV1Device>,
}
...
pub struct MembershipAdjacencyList {
    ...
    #[serde(default)]
    pub edges: Option<Vec<Membership>>,
