...
//!
//! Generated from OpenAPI spec in `artefacts/cloud_providers/gcp/cloudidentity/openapi.json`.
...
pub struct DynamicGroupMetadata {
    ...
    #[serde(default)]
    pub queries: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<DynamicGroupQuery>>>,
    /// Output only. Status of the dynamic group.
    #[serde(default)]
    pub status: ::core::option::Option<::std::boxed::Box<DynamicGroupStatus>>,
}
...
pub struct GetMembershipGraphResponse {
    ...
    pub adjacency_list:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<MembershipAdjacencyList>>>,
...
pub struct GoogleAppsCloudidentityDevicesV1ApproveDeviceUserResponse {
    ...
    pub device_user:
        ::core::option::Option<::std::boxed::Box<GoogleAppsCloudidentityDevicesV1DeviceUser>>,
}
...
pub struct GoogleAppsCloudidentityDevicesV1BrowserAttributes {
    ...
    pub chrome_browser_info:
        ::core::option::Option<::std::boxed::Box<GoogleAppsCloudidentityDevicesV1BrowserInfo>>,
...
pub struct GoogleAppsCloudidentityDevicesV1CancelWipeDeviceResponse {
    ...
    #[serde(default)]
    pub device: ::core::option::Option<::std::boxed::Box<GoogleAppsCloudidentityDevicesV1Device>>,
}
...
pub struct GoogleAppsCloudidentityDevicesV1CertificateAttributes {
    ...
    pub certificate_template: ::core::option::Option<
        ::std::boxed::Box<GoogleAppsCloudidentityDevicesV1CertificateTemplate>,
    >,
...
pub struct GoogleAppsCloudidentityDevicesV1Device {
    ...
    pub android_specific_attributes: ::core::option::Option<
    ...
    pub endpoint_verification_specific_attributes: ::core::option::Option<
        ::std::boxed::Box<GoogleAppsCloudidentityDevicesV1EndpointVerificationSpecificAttributes>,
    >,
...
pub struct GoogleAppsCloudidentityDevicesV1EndpointVerificationSpecificAttributes {
    ...
    pub browser_attributes: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleAppsCloudidentityDevicesV1BrowserAttributes>>,
    >,
    /// Details of certificates.
    #[serde(default, rename = "certificateAttributes")]
    pub certificate_attributes: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleAppsCloudidentityDevicesV1CertificateAttributes>>,
    >,
}
...
pub struct GoogleAppsCloudidentityDevicesV1ListClientStatesResponse {
    ...
    pub client_states: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleAppsCloudidentityDevicesV1ClientState>>,
    >,
...
pub struct GoogleAppsCloudidentityDevicesV1ListDeviceUsersResponse {
    ...
    pub device_users: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleAppsCloudidentityDevicesV1DeviceUser>>,
    >,
    /// Token to retrieve the next page of results. Empty if there are no more results.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
...
pub struct GoogleAppsCloudidentityDevicesV1ListDevicesResponse {
    ...
    pub devices: ::core::option::Option<
        ::std::vec::Vec<::std::boxed::Box<GoogleAppsCloudidentityDevicesV1Device>>,
    >,
    /// Token to retrieve the next page of results. Empty if there are no more results.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
...
pub struct Group {
    ...
    pub additional_group_keys:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<EntityKey>>>,
    ...
    pub dynamic_group_metadata: ::core::option::Option<::std::boxed::Box<DynamicGroupMetadata>>,
    /// Required. The EntityKey of the Group.
    #[serde(default, rename = "groupKey")]
    pub group_key: ::core::option::Option<::std::boxed::Box<EntityKey>>,
...
pub struct GroupRelation {
    ...
    #[serde(default)]
    pub roles: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<TransitiveMembershipRole>>>,
}
...
pub struct IdpCredential {
    ...
    pub dsa_key_info: ::core::option::Option<::std::boxed::Box<DsaPublicKeyInfo>>,
    ...
    pub rsa_key_info: ::core::option::Option<::std::boxed::Box<RsaPublicKeyInfo>>,
...
pub struct InboundOidcSsoProfile {
    ...
    pub idp_config: ::core::option::Option<::std::boxed::Box<OidcIdpConfig>>,
    ...
    pub rp_config: ::core::option::Option<::std::boxed::Box<OidcRpConfig>>,
}
...
pub struct InboundSamlSsoProfile {
    ...
    #[serde(default, rename = "idpConfig")]
    pub idp_config: ::core::option::Option<::std::boxed::Box<SamlIdpConfig>>,
    ...
    pub sp_config: ::core::option::Option<::std::boxed::Box<SamlSpConfig>>,
}
...
pub struct InboundSsoAssignment {
    ...
    pub oidc_sso_info: ::core::option::Option<::std::boxed::Box<OidcSsoInfo>>,
    /// Must be zero (which is the default value so it can be omitted) for assignments with target_org_unit set and must be greater-than-or-equal-to one for assignments with target_group set.
    #[serde(default)]
    pub rank: ::core::option::Option<i32>,
    /// SAML SSO details. Must be set if and only if sso_mode is set to SAML_SSO.
    #[serde(default, rename = "samlSsoInfo")]
    pub saml_sso_info: ::core::option::Option<::std::boxed::Box<SamlSsoInfo>>,
    /// Assertions about users assigned to an IdP will always be accepted from that IdP. This controls whether/when Google should redirect a user to the IdP. Unset (defaults) is the recommended configuration.
    #[serde(default, rename = "signInBehavior")]
    pub sign_in_behavior: ::core::option::Option<::std::boxed::Box<SignInBehavior>>,
...
pub struct ListIdpCredentialsResponse {
    ...
    pub idp_credentials: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<IdpCredential>>>,
...
pub struct ListInboundOidcSsoProfilesResponse {
    ...
    pub inbound_oidc_sso_profiles:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<InboundOidcSsoProfile>>>,
    /// A token, which can be sent as page_token to retrieve the next page. If this field is omitted, there are no subsequent pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct ListInboundSamlSsoProfilesResponse {
    ...
    pub inbound_saml_sso_profiles:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<InboundSamlSsoProfile>>>,
    /// A token, which can be sent as page_token to retrieve the next page. If this field is omitted, there are no subsequent pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct ListInboundSsoAssignmentsResponse {
    ...
    pub inbound_sso_assignments:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<InboundSsoAssignment>>>,
    /// A token, which can be sent as page_token to retrieve the next page. If this field is omitted, there are no subsequent pages.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct ListUserInvitationsResponse {
    ...
    pub user_invitations:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<UserInvitation>>>,
}
...
pub struct MemberRelation {
    ...
    pub preferred_member_key: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<EntityKey>>>,
...
pub struct MemberRestriction {
    ...
    #[serde(default)]
    pub evaluation: ::core::option::Option<::std::boxed::Box<RestrictionEvaluation>>,
...
pub struct Membership {
    ...
    #[serde(default, rename = "preferredMemberKey")]
    pub preferred_member_key: ::core::option::Option<::std::boxed::Box<EntityKey>>,
    ...
    #[serde(default)]
    pub roles: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<MembershipRole>>>,
...
pub struct MembershipAdjacencyList {
    ...
    #[serde(default)]
    pub edges: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<Membership>>>,
...
pub struct MembershipRole {
    ...
    pub expiry_detail: ::core::option::Option<::std::boxed::Box<ExpiryDetail>>,
    /// The name of the MembershipRole. Must be one of OWNER, MANAGER, MEMBER.
    #[serde(default)]
    pub name: ::core::option::Option<String>,
    /// Evaluations of restrictions applied to parent group on this membership.
    #[serde(default, rename = "restrictionEvaluations")]
    pub restriction_evaluations: ::core::option::Option<::std::boxed::Box<RestrictionEvaluations>>,
}
...
pub struct ModifyMembershipRolesRequest {
    ...
    pub add_roles: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<MembershipRole>>>,
    ...
    pub update_roles_params:
        ::core::option::Option<::std::vec::Vec<::std::boxed::Box<UpdateMembershipRolesParams>>>,
}
...
pub struct Policy {
    ...
    pub policy_query: ::core::option::Option<::std::boxed::Box<PolicyQuery>>,
    /// Required. The Setting configured by this Policy.
    #[serde(default)]
    pub setting: ::core::option::Option<::std::boxed::Box<Setting>>,
...
pub struct RestrictionEvaluations {
    ...
    pub member_restriction_evaluation:
        ::core::option::Option<::std::boxed::Box<MembershipRoleRestrictionEvaluation>>,
}
...
pub struct SearchDirectGroupsResponse {
    ...
    #[serde(default)]
    pub memberships: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<MembershipRelation>>>,
    /// Token to retrieve the next page of results, or empty if there are no more results available for listing.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct SearchTransitiveGroupsResponse {
    ...
    #[serde(default)]
    pub memberships: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<GroupRelation>>>,
    /// Token to retrieve the next page of results, or empty if there are no more results available for listing.
    #[serde(default, rename = "nextPageToken")]
    pub next_page_token: ::core::option::Option<String>,
}
...
pub struct SearchTransitiveMembershipsResponse {
    ...
    #[serde(default)]
    pub memberships: ::core::option::Option<::std::vec::Vec<::std::boxed::Box<MemberRelation>>>,
...
pub struct SecuritySettings {
    ...
    pub member_restriction: ::core::option::Option<::std::boxed::Box<MemberRestriction>>,
...
pub struct UpdateMembershipRolesParams {
    ...
    pub membership_role: ::core::option::Option<::std::boxed::Box<MembershipRole>>,
}
