...
pub struct ComputeFlightEmissionsRequest {
    ...
    #[serde(default)]
    pub flights: ::core::option::Option<::std::vec::Vec<Flight>>,
}
...
pub struct ComputeFlightEmissionsResponse {
    ...
    pub flight_emissions: ::core::option::Option<::std::vec::Vec<FlightWithEmissions>>,
    ...
    pub model_version: ::core::option::Option<ModelVersion>,
}
...
pub struct ComputeScope3FlightEmissionsRequest {
    ...
    #[serde(default)]
    pub flights: ::core::option::Option<::std::vec::Vec<Scope3FlightSegment>>,
...
pub struct ComputeScope3FlightEmissionsResponse {
    ...
    #[serde(default, rename = "flightEmissions")]
    pub flight_emissions: ::core::option::Option<::std::vec::Vec<Scope3FlightEmissions>>,
    /// The model version under which emission estimates for all flights in this response were computed.
    #[serde(default, rename = "modelVersion")]
    pub model_version: ::core::option::Option<ModelVersion>,
}
...
pub struct ComputeTypicalFlightEmissionsRequest {
    ...
    #[serde(default)]
    pub markets: ::core::option::Option<::std::vec::Vec<Market>>,
}
...
pub struct FlightWithEmissions {
    ...
    pub easa_label_metadata: ::core::option::Option<EasaLabelMetadata>,
