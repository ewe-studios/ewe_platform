//! Auto-generated API module for gcp/androidmanagement operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_androidmanagement_operations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://androidmanagement.googleapis.com/v1/enterprises/{{enterprisesId}}/devices/{{devicesId}}/operations/{{operationsId}}:cancel",
    );
...
{
    let endpoint_url = format!(
        "https://androidmanagement.googleapis.com/v1/enterprises/{{enterprisesId}}/devices/{{devicesId}}/operations/{{operationsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://androidmanagement.googleapis.com/v1/enterprises/{{enterprisesId}}/devices/{{devicesId}}/operations",
    );
