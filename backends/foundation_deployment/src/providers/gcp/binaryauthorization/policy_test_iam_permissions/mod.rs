//! Auto-generated API module for gcp/binaryauthorization policy:testIamPermissions.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_binaryauthorization_policy_test_iam_permissions `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://binaryauthorization.googleapis.com/v1/projects/{{projectsId}}/policy:testIamPermissions",
    );
