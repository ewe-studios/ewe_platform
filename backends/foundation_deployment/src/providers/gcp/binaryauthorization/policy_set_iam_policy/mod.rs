//! Auto-generated API module for gcp/binaryauthorization policy:setIamPolicy.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_binaryauthorization_policy_set_iam_policy `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://binaryauthorization.googleapis.com/v1/projects/{{projectsId}}/policy:setIamPolicy",
    );
