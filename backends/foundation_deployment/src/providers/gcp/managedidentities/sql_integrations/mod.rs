//! Auto-generated API module for gcp/managedidentities sqlIntegrations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_managedidentities_sql_integrations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://managedidentities.googleapis.com/v1/projects/{{projectsId}}/locations/global/domains/{{domainsId}}/sqlIntegrations/{{sqlIntegrationsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://managedidentities.googleapis.com/v1/projects/{{projectsId}}/locations/global/domains/{{domainsId}}/sqlIntegrations",
    );
