//! Auto-generated API module for gcp/managedidentities operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_managedidentities_operations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://managedidentities.googleapis.com/v1/projects/{{projectsId}}/locations/global/operations/{{operationsId}}:cancel",
    );
...
{
    let endpoint_url = format!(
        "https://managedidentities.googleapis.com/v1/projects/{{projectsId}}/locations/global/operations/{{operationsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://managedidentities.googleapis.com/v1/projects/{{projectsId}}/locations/global/operations",
    );
