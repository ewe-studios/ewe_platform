//! Auto-generated API module for gcp/managedidentities ldapssettings.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_managedidentities_ldapssettings `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://managedidentities.googleapis.com/v1/projects/{{projectsId}}/locations/global/domains/{{domainsId}}/ldapssettings",
    );
