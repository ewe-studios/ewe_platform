//! Auto-generated API module for gcp/bigtableadmin tables:restore.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_bigtableadmin_tables_restore `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://bigtableadmin.googleapis.com/v2/projects/{{projectsId}}/instances/{{instancesId}}/tables:restore",
    );
