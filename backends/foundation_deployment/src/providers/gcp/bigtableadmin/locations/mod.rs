//! Auto-generated API module for gcp/bigtableadmin locations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_bigtableadmin_locations `
...
{
    let endpoint_url =
        format!("https://bigtableadmin.googleapis.com/v2/projects/{{projectsId}}/locations",);
