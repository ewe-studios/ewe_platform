//! Auto-generated API module for gcp/bigtableadmin backups:copy.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_bigtableadmin_backups_copy `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://bigtableadmin.googleapis.com/v2/projects/{{projectsId}}/instances/{{instancesId}}/clusters/{{clustersId}}/backups:copy",
    );
