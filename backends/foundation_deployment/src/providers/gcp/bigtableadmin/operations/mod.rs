//! Auto-generated API module for gcp/bigtableadmin operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_bigtableadmin_operations `
...
{
    let endpoint_url =
        format!("https://bigtableadmin.googleapis.com/v2/operations/{{operationsId}}",);
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://bigtableadmin.googleapis.com/v2/operations/projects/{{projectsId}}/operations",
    );
