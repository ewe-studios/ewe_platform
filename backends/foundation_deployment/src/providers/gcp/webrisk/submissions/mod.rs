//! Auto-generated API module for gcp/webrisk submissions.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_webrisk_submissions `
...
{
    let endpoint_url =
        format!("https://webrisk.googleapis.com/v1/projects/{{projectsId}}/submissions",);
