...
/// let provider = BaremetalsolutionProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct BaremetalsolutionProvider<S, R>
where
...
impl<S, R> BaremetalsolutionProvider<S, R>
where
    S: foundation_db::state::traits::StateStore + Send + Sync + 'static,
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new BaremetalsolutionProvider from ProviderClient, extracting the HTTP client.
    ///
