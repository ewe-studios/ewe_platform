...
/// let provider = CertificatemanagerProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct CertificatemanagerProvider<S, R>
where
...
impl<S, R> CertificatemanagerProvider<S, R>
where
    S: foundation_db::state::traits::StateStore + Send + Sync + 'static,
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new CertificatemanagerProvider from ProviderClient, extracting the HTTP client.
    ///
