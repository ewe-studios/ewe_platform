...
/// let provider = FcmProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct FcmProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new FcmProvider from ProviderClient, extracting the HTTP client.
    ///
