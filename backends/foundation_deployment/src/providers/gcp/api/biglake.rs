...
/// let provider = BiglakeProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct BiglakeProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new BiglakeProvider from ProviderClient, extracting the HTTP client.
    ///
