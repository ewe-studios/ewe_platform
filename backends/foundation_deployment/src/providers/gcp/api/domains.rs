...
/// let provider = DomainsProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct DomainsProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new DomainsProvider from ProviderClient, extracting the HTTP client.
    ///
