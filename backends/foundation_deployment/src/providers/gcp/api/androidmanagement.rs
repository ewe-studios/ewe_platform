...
/// let provider = AndroidmanagementProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct AndroidmanagementProvider<S, R>
where
...
impl<S, R> AndroidmanagementProvider<S, R>
where
    S: foundation_db::state::traits::StateStore + Send + Sync + 'static,
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new AndroidmanagementProvider from ProviderClient, extracting the HTTP client.
    ///
