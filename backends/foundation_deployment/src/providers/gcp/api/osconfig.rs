...
/// let provider = OsconfigProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct OsconfigProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new OsconfigProvider from ProviderClient, extracting the HTTP client.
    ///
