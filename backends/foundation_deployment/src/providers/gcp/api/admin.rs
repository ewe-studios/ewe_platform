...
/// let provider = AdminProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct AdminProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new AdminProvider from ProviderClient, extracting the HTTP client.
    ///
