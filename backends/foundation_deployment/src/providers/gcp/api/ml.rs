...
/// let provider = MlProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct MlProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new MlProvider from ProviderClient, extracting the HTTP client.
    ///
