...
/// let provider = ComposerProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct ComposerProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new ComposerProvider from ProviderClient, extracting the HTTP client.
    ///
