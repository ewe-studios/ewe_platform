...
/// let provider = Adexchangebuyer2Provider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct Adexchangebuyer2Provider<S, R>
where
...
impl<S, R> Adexchangebuyer2Provider<S, R>
where
    S: foundation_db::state::traits::StateStore + Send + Sync + 'static,
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new Adexchangebuyer2Provider from ProviderClient, extracting the HTTP client.
    ///
