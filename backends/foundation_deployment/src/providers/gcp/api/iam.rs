...
/// let provider = IamProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct IamProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new IamProvider from ProviderClient, extracting the HTTP client.
    ///
