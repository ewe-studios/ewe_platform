...
/// let provider = IdsProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct IdsProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new IdsProvider from ProviderClient, extracting the HTTP client.
    ///
