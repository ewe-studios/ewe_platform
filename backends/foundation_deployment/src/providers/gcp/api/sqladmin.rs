...
/// let provider = SqladminProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct SqladminProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new SqladminProvider from ProviderClient, extracting the HTTP client.
    ///
