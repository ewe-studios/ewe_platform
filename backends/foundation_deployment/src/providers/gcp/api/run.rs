...
/// let provider = RunProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct RunProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new RunProvider from ProviderClient, extracting the HTTP client.
    ///
