...
/// let provider = TrafficdirectorProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct TrafficdirectorProvider<S, R>
where
...
impl<S, R> TrafficdirectorProvider<S, R>
where
    S: foundation_db::state::traits::StateStore + Send + Sync + 'static,
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new TrafficdirectorProvider from ProviderClient, extracting the HTTP client.
    ///
