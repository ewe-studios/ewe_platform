...
/// let provider = VaultProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct VaultProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new VaultProvider from ProviderClient, extracting the HTTP client.
    ///
