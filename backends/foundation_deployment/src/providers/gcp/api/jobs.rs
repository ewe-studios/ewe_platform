...
/// let provider = JobsProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct JobsProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new JobsProvider from ProviderClient, extracting the HTTP client.
    ///
