...
/// let provider = FormsProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct FormsProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new FormsProvider from ProviderClient, extracting the HTTP client.
    ///
