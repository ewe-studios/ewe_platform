...
/// let provider = ApikeysProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct ApikeysProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new ApikeysProvider from ProviderClient, extracting the HTTP client.
    ///
