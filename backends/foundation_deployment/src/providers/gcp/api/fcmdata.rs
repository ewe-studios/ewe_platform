...
/// let provider = FcmdataProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct FcmdataProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new FcmdataProvider from ProviderClient, extracting the HTTP client.
    ///
