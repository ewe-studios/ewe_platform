...
/// let provider = HealthProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct HealthProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new HealthProvider from ProviderClient, extracting the HTTP client.
    ///
