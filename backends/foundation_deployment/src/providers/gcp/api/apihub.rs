...
/// let provider = ApihubProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct ApihubProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new ApihubProvider from ProviderClient, extracting the HTTP client.
    ///
