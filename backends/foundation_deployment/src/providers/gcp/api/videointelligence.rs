...
/// let provider = VideointelligenceProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct VideointelligenceProvider<S, R>
where
...
impl<S, R> VideointelligenceProvider<S, R>
where
    S: foundation_db::state::traits::StateStore + Send + Sync + 'static,
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new VideointelligenceProvider from ProviderClient, extracting the HTTP client.
    ///
