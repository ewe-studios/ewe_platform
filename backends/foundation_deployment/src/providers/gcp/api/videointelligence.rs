//! VideointelligenceProvider - State-aware videointelligence API client.
//!
//! WHY: Users need state-aware API clients that automatically track
//!      resource changes in the state store.
//!
//! WHAT: Provider wrapping ProviderClient<S> with methods for
//!       videointelligence API endpoints that auto-store results.
//!
...
/// VideointelligenceProvider with automatic state tracking.
///
/// # Type Parameters
///
...
/// let provider = VideointelligenceProvider::new(client, http_client);
/// ```
#[derive(Clone)]
pub struct VideointelligenceProvider<S>
where
...
impl<S> VideointelligenceProvider<S>
where
    S: foundation_db::state::traits::StateStore + Send + Sync + 'static,
{
    /// Create new VideointelligenceProvider.
    ...
    pub fn videointelligence_projects_locations_operations_delete(
        ...
        ProviderError<ApiError>,
    > {
        let builder = videointelligence_projects_locations_operations_delete_builder(
            &self.http_client,
            &args.name,
        )
        .map_err(ProviderError::Api)?;
    ...
    pub fn videointelligence_videos_annotate(
        ...
        ProviderError<ApiError>,
    > {
        let builder = videointelligence_videos_annotate_builder(
            &self.http_client,
        )
        .map_err(ProviderError::Api)?;
