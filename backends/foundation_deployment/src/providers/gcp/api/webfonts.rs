...
/// let provider = WebfontsProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct WebfontsProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new WebfontsProvider from ProviderClient, extracting the HTTP client.
    ///
