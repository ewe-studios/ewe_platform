...
/// let provider = PlacesProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct PlacesProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new PlacesProvider from ProviderClient, extracting the HTTP client.
    ///
