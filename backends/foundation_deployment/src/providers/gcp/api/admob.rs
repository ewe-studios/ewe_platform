...
/// let provider = AdmobProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct AdmobProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new AdmobProvider from ProviderClient, extracting the HTTP client.
    ///
