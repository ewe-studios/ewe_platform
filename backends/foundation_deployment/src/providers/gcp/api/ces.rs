...
/// let provider = CesProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct CesProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new CesProvider from ProviderClient, extracting the HTTP client.
    ///
