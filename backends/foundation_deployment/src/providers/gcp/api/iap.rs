...
/// let provider = IapProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct IapProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new IapProvider from ProviderClient, extracting the HTTP client.
    ///
