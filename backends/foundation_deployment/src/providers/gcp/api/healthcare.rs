...
/// let provider = HealthcareProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct HealthcareProvider<S, R>
where
...
impl<S, R> HealthcareProvider<S, R>
where
    S: foundation_db::state::traits::StateStore + Send + Sync + 'static,
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new HealthcareProvider from ProviderClient, extracting the HTTP client.
    ///
