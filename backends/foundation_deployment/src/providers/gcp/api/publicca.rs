...
/// let provider = PubliccaProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct PubliccaProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new PubliccaProvider from ProviderClient, extracting the HTTP client.
    ///
