...
/// let provider = NetworksecurityProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct NetworksecurityProvider<S, R>
where
...
impl<S, R> NetworksecurityProvider<S, R>
where
    S: foundation_db::state::traits::StateStore + Send + Sync + 'static,
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new NetworksecurityProvider from ProviderClient, extracting the HTTP client.
    ///
