...
/// let provider = AlloydbProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct AlloydbProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new AlloydbProvider from ProviderClient, extracting the HTTP client.
    ///
