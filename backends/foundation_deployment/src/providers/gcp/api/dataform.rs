...
/// let provider = DataformProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct DataformProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new DataformProvider from ProviderClient, extracting the HTTP client.
    ///
