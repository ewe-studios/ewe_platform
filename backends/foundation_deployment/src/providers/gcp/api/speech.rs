...
/// let provider = SpeechProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct SpeechProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new SpeechProvider from ProviderClient, extracting the HTTP client.
    ///
