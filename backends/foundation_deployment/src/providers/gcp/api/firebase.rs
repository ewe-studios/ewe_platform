...
/// let provider = FirebaseProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct FirebaseProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new FirebaseProvider from ProviderClient, extracting the HTTP client.
    ///
