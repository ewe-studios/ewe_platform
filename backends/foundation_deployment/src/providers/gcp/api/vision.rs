...
/// let provider = VisionProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct VisionProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new VisionProvider from ProviderClient, extracting the HTTP client.
    ///
