...
/// let provider = GmailProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct GmailProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new GmailProvider from ProviderClient, extracting the HTTP client.
    ///
