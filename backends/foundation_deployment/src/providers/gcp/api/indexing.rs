...
/// let provider = IndexingProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct IndexingProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new IndexingProvider from ProviderClient, extracting the HTTP client.
    ///
