...
use crate::providers::gcp::clients::verifiedaccess::VerifiedaccessChallengeGenerateArgs;
use crate::providers::gcp::clients::verifiedaccess::VerifiedaccessChallengeVerifyArgs;
...
/// let provider = VerifiedaccessProvider::new(client, http_client);
/// ```
#[derive(Clone)]
pub struct VerifiedaccessProvider<S>
where
...
impl<S> VerifiedaccessProvider<S>
where
    S: foundation_db::state::traits::StateStore + Send + Sync + 'static,
{
