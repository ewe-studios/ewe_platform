...
/// let provider = OsloginProvider::from_provider_client(client);
/// ```
#[derive(Clone)]
pub struct OsloginProvider<S, R>
where
    ...
    R: foundation_core::wire::simple_http::client::DnsResolver + Clone + 'static,
{
    ...
    /// Create new OsloginProvider from ProviderClient, extracting the HTTP client.
    ///
