//! Auto-generated API module for gcp/serviceusage operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_serviceusage_operations `
...
{
    let endpoint_url =
        format!("https://serviceusage.googleapis.com/v1/operations/{{operationsId}}:cancel",);
...
{
    let endpoint_url =
        format!("https://serviceusage.googleapis.com/v1/operations/{{operationsId}}",);
