//! Auto-generated API module for gcp/serviceusage services:batchEnable.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_serviceusage_services_batch_enable `
...
{
    let endpoint_url =
        format!("https://serviceusage.googleapis.com/v1/{{v1Id}}/{{v1Id1}}/services:batchEnable",);
