//! Auto-generated API module for gcp/managedkafka types.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_managedkafka_types `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://managedkafka.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/schemaRegistries/{{schemaRegistriesId}}/contexts/{{contextsId}}/schemas/types",
    );
...
{
    let endpoint_url = format!(
        "https://managedkafka.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/schemaRegistries/{{schemaRegistriesId}}/schemas/types",
    );
