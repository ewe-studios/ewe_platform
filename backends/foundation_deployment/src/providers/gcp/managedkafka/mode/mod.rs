//! Auto-generated API module for gcp/managedkafka mode.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_managedkafka_mode `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://managedkafka.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/schemaRegistries/{{schemaRegistriesId}}/contexts/{{contextsId}}/mode/{{modeId}}",
    );
...
{
    let endpoint_url = format!(
        "https://managedkafka.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/schemaRegistries/{{schemaRegistriesId}}/mode/{{modeId}}",
    );
