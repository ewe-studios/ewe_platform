//! Auto-generated API module for gcp/managedkafka consumerGroups.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_managedkafka_consumer_groups `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://managedkafka.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/clusters/{{clustersId}}/consumerGroups/{{consumerGroupsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://managedkafka.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/clusters/{{clustersId}}/consumerGroups",
    );
