//! Auto-generated API module for gcp/managedkafka referencedby.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_managedkafka_referencedby `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://managedkafka.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/schemaRegistries/{{schemaRegistriesId}}/contexts/{{contextsId}}/subjects/{{subjectsId}}/versions/{{versionsId}}/referencedby",
    );
...
{
    let endpoint_url = format!(
        "https://managedkafka.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/schemaRegistries/{{schemaRegistriesId}}/subjects/{{subjectsId}}/versions/{{versionsId}}/referencedby",
    );
