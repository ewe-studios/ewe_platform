//! Auto-generated API module for gcp/alloydb instances:createsecondary.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_alloydb_instances_createsecondary `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://alloydb.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/clusters/{{clustersId}}/instances:createsecondary",
    );
