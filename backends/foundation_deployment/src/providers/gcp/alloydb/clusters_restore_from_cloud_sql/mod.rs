//! Auto-generated API module for gcp/alloydb clusters:restoreFromCloudSQL.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_alloydb_clusters_restore_from_cloud_sql `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://alloydb.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/clusters:restoreFromCloudSQL",
    );
