//! Auto-generated API module for gcp/cloudtrace traces:batchWrite.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_cloudtrace_traces_batch_write `
...
{
    let endpoint_url =
        format!("https://cloudtrace.googleapis.com/v2/projects/{{projectsId}}/traces:batchWrite",);
