//! Auto-generated API module for gcp/cloudtrace spans.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_cloudtrace_spans `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://cloudtrace.googleapis.com/v2/projects/{{projectsId}}/traces/{{tracesId}}/spans/{{spansId}}",
    );
