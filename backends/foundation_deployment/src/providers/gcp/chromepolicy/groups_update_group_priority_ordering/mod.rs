//! Auto-generated API module for gcp/chromepolicy groups:updateGroupPriorityOrdering.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_chromepolicy_groups_update_group_priority_ordering `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://chromepolicy.googleapis.com/v1/customers/{{customersId}}/policies/groups:updateGroupPriorityOrdering",
    );
