//! Auto-generated API module for gcp/chromepolicy networks:removeNetwork.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_chromepolicy_networks_remove_network `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://chromepolicy.googleapis.com/v1/customers/{{customersId}}/policies/networks:removeNetwork",
    );
