//! Auto-generated API module for gcp/cloudbilling billingInfo.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_cloudbilling_billing_info `
...
{
    let endpoint_url =
        format!("https://cloudbilling.googleapis.com/v1/projects/{{projectsId}}/billingInfo",);
