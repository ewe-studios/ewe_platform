//! Auto-generated API module for gcp/health identity.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_health_identity `
...
{
    let endpoint_url = format!("https://health.googleapis.com/v4/users/{{usersId}}/identity",);
