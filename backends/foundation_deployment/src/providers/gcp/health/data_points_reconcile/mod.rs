//! Auto-generated API module for gcp/health dataPoints:reconcile.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_health_data_points_reconcile `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://health.googleapis.com/v4/users/{{usersId}}/dataTypes/{{dataTypesId}}/dataPoints:reconcile",
    );
