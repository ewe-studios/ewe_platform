//! Auto-generated API module for gcp/people members:modify.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_people_members_modify `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://people.googleapis.com/v1/contactGroups/{{contactGroupsId}}/members:modify",
    );
