//! Auto-generated API module for gcp/workstations workstations:listUsable.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_workstations_workstations_list_usable `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://workstations.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/workstationClusters/{{workstationClustersId}}/workstationConfigs/{{workstationConfigsId}}/workstations:listUsable",
    );
