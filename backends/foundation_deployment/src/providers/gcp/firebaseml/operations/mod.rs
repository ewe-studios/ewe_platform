//! Auto-generated API module for gcp/firebaseml operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_firebaseml_operations `
...
{
    let endpoint_url =
        format!("https://firebaseml.googleapis.com/v1/operations/{{operationsId}}:cancel",);
...
where
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!("https://firebaseml.googleapis.com/v1/operations/{{operationsId}}",);
