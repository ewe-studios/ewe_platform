//! Auto-generated API module for gcp/policytroubleshooter policytroubleshooter.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_policytroubleshooter_policytroubleshooter `
...
/// `GoogleCloudPolicytroubleshooterIamV3TroubleshootIamPolicyRequest` type.
#[derive(Debug, Clone, Default, Serialize, Deserialize, JsonHash)]
...
/// Arguments for [`policytroubleshooter.iam.troubleshoot_builder`].
