//! Auto-generated API module for gcp/adexperiencereport adexperiencereport.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_adexperiencereport_adexperiencereport `
...
{
    let endpoint_url = format!("https://adexperiencereport.googleapis.com/v1/{}", args.name,);
...
///
/// ```ignore
/// let task = adexperiencereport_violating_sites_list_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn adexperiencereport_violating_sites_list_request<R, F>(
    client: &SimpleHttpClient<R>,
