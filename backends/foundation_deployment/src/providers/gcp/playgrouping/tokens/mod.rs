//! Auto-generated API module for gcp/playgrouping tokens.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_playgrouping_tokens `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://playgrouping.googleapis.com/v1alpha1/apps/{{appsId}}/tokens/{{tokensId}}:verify",
    );
