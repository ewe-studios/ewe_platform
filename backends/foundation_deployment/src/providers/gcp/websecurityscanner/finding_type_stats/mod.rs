//! Auto-generated API module for gcp/websecurityscanner findingTypeStats.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_websecurityscanner_finding_type_stats `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://websecurityscanner.googleapis.com/v1/projects/{{projectsId}}/scanConfigs/{{scanConfigsId}}/scanRuns/{{scanRunsId}}/findingTypeStats",
    );
