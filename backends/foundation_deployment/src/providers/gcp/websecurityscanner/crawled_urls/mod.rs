//! Auto-generated API module for gcp/websecurityscanner crawledUrls.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_websecurityscanner_crawled_urls `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://websecurityscanner.googleapis.com/v1/projects/{{projectsId}}/scanConfigs/{{scanConfigsId}}/scanRuns/{{scanRunsId}}/crawledUrls",
    );
