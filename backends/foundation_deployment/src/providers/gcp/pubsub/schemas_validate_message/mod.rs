//! Auto-generated API module for gcp/pubsub schemas:validateMessage.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_pubsub_schemas_validate_message `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://pubsub.googleapis.com/v1/projects/{{projectsId}}/schemas:validateMessage",
    );
