//! Auto-generated API module for gcp/logging entries:copy.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_logging_entries_copy `
...
///
/// ```ignore
/// let task = logging_entries_copy_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn logging_entries_copy_request<R, F>(
