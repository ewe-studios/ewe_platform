//! Auto-generated API module for gcp/documentai schemaVersions.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_documentai_schema_versions `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://documentai.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/schemas/{{schemasId}}/schemaVersions",
    );
...
{
    let endpoint_url = format!(
        "https://documentai.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/schemas/{{schemasId}}/schemaVersions/{{schemaVersionsId}}",
    );
