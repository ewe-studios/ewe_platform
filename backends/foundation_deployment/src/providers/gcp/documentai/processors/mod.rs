//! Auto-generated API module for gcp/documentai processors.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_documentai_processors `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://documentai.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/processors/{{processorsId}}:batchProcess",
    );
...
{
    let endpoint_url = format!(
        "https://documentai.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/processors",
    );
...
{
    let endpoint_url = format!(
        "https://documentai.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/processors/{{processorsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://documentai.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/processors/{{processorsId}}:disable",
    );
...
{
    let endpoint_url = format!(
        "https://documentai.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/processors/{{processorsId}}:enable",
    );
...
{
    let endpoint_url = format!(
        "https://documentai.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/processors/{{processorsId}}:process",
    );
...
{
    let endpoint_url = format!(
        "https://documentai.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/processors/{{processorsId}}:setDefaultProcessorVersion",
    );
