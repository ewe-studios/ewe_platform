//! Auto-generated API module for gcp/documentai processorVersions:train.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_documentai_processor_versions_train `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://documentai.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/processors/{{processorsId}}/processorVersions:train",
    );
