//! Auto-generated API module for gcp/documentai humanReviewConfig:reviewDocument.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_documentai_human_review_config_review_document `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://documentai.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/processors/{{processorsId}}/humanReviewConfig:reviewDocument",
    );
