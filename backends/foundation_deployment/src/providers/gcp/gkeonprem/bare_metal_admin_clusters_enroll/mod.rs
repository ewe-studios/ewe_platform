//! Auto-generated API module for gcp/gkeonprem bareMetalAdminClusters:enroll.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_gkeonprem_bare_metal_admin_clusters_enroll `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://gkeonprem.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/bareMetalAdminClusters:enroll",
    );
