//! Auto-generated API module for gcp/gkeonprem vmwareNodePools:enroll.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_gkeonprem_vmware_node_pools_enroll `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://gkeonprem.googleapis.com/v1/projects/{{projectsId}}/locations/{{locationsId}}/vmwareClusters/{{vmwareClustersId}}/vmwareNodePools:enroll",
    );
