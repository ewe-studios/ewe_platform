//! Auto-generated API module for gcp/mybusinessqanda answers:delete.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_mybusinessqanda_answers_delete `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://mybusinessqanda.googleapis.com/v1/locations/{{locationsId}}/questions/{{questionsId}}/answers:delete",
    );
