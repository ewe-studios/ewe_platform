//! Auto-generated API module for gcp/css labels.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_css_labels `
...
{
    let endpoint_url = format!("https://css.googleapis.com/v1/accounts/{{accountsId}}/labels",);
...
{
    let endpoint_url =
        format!("https://css.googleapis.com/v1/accounts/{{accountsId}}/labels/{{labelsId}}",);
