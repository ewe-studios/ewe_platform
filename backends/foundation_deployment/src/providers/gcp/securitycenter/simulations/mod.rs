//! Auto-generated API module for gcp/securitycenter simulations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_securitycenter_simulations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://securitycenter.googleapis.com/v1/organizations/{{organizationsId}}/simulations/{{simulationsId}}",
    );
