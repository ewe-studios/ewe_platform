//! Auto-generated API module for gcp/securitycenter operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_securitycenter_operations `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://securitycenter.googleapis.com/v1/organizations/{{organizationsId}}/operations/{{operationsId}}:cancel",
    );
...
{
    let endpoint_url = format!(
        "https://securitycenter.googleapis.com/v1/organizations/{{organizationsId}}/operations/{{operationsId}}",
    );
...
{
    let endpoint_url = format!(
        "https://securitycenter.googleapis.com/v1/organizations/{{organizationsId}}/operations",
    );
