//! Auto-generated API module for gcp/securitycenter assets:runDiscovery.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_securitycenter_assets_run_discovery `
...
// -----------------------------------------------------------------------------
// POST v1/organizations/{organizationsId}/assets:runDiscovery
// -----------------------------------------------------------------------------
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://securitycenter.googleapis.com/v1/organizations/{{organizationsId}}/assets:runDiscovery",
    );
