//! Auto-generated API module for gcp/securitycenter findings:bulkMute.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_securitycenter_findings_bulk_mute `
...
// -----------------------------------------------------------------------------
// POST v1/folders/{foldersId}/findings:bulkMute
// -----------------------------------------------------------------------------
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://securitycenter.googleapis.com/v1/folders/{{foldersId}}/findings:bulkMute",
    );
...
// -----------------------------------------------------------------------------
// POST v1/organizations/{organizationsId}/findings:bulkMute
// -----------------------------------------------------------------------------
...
{
    let endpoint_url = format!(
        "https://securitycenter.googleapis.com/v1/organizations/{{organizationsId}}/findings:bulkMute",
    );
...
// -----------------------------------------------------------------------------
// POST v1/projects/{projectsId}/findings:bulkMute
// -----------------------------------------------------------------------------
...
{
    let endpoint_url = format!(
        "https://securitycenter.googleapis.com/v1/projects/{{projectsId}}/findings:bulkMute",
    );
