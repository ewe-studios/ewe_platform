//! Auto-generated API module for gcp/securitycenter valuedResources.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `gcp_securitycenter_valued_resources `
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    let endpoint_url = format!(
        "https://securitycenter.googleapis.com/v1/organizations/{{organizationsId}}/simulations/{{simulationsId}}/attackExposureResults/{{attackExposureResultsId}}/valuedResources",
    );
...
{
    let endpoint_url = format!(
        "https://securitycenter.googleapis.com/v1/organizations/{{organizationsId}}/simulations/{{simulationsId}}/valuedResources/{{valuedResourcesId}}",
    );
...
{
    let endpoint_url = format!(
        "https://securitycenter.googleapis.com/v1/organizations/{{organizationsId}}/simulations/{{simulationsId}}/valuedResources",
    );
...
{
    let endpoint_url = format!(
        "https://securitycenter.googleapis.com/v1/organizations/{{organizationsId}}/valuedResources",
    );
