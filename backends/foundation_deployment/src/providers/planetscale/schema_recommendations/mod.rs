//! Auto-generated API module for planetscale schema-recommendations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_schema_recommendations `
...
/// Arguments for [`list_schema_recommendations_builder`].
...
/// Arguments for [`get_schema_recommendation_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
///
/// ```ignore
/// let task = list_schema_recommendations_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn list_schema_recommendations_request<R, F>(
...
///
/// ```ignore
/// let task = get_schema_recommendation_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_schema_recommendation_request<R, F>(
    client: &SimpleHttpClient<R>,
