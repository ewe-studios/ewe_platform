//! Auto-generated API module for planetscale operations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_operations `
...
/// Arguments for [`list_deploy_operations_builder`].
...
///
/// ```ignore
/// let task = list_deploy_operations_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn list_deploy_operations_request<R, F>(
