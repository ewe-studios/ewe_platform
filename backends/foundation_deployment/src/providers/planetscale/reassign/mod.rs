//! Auto-generated API module for planetscale reassign.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_reassign `
...
/// Arguments for [`reassign_role_objects_builder`].
...
///
/// ```ignore
/// let task = reassign_role_objects_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn reassign_role_objects_request<R, F>(
