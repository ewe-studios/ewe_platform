//! Auto-generated API module for planetscale test.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_test `
...
/// Arguments for [`test_webhook_builder`].
...
///
/// ```ignore
/// let task = test_webhook_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn test_webhook_request<R, F>(
