//! Auto-generated API module for planetscale backup-policies.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_backup_policies `
...
/// Arguments for [`list_backup_policies_builder`].
...
/// Arguments for [`create_backup_policy_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
/// Arguments for [`get_backup_policy_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
/// Arguments for [`update_backup_policy_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
/// Arguments for [`delete_backup_policy_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
///
/// ```ignore
/// let task = list_backup_policies_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn list_backup_policies_request<R, F>(
...
///
/// ```ignore
/// let task = create_backup_policy_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn create_backup_policy_request<R, F>(
    client: &SimpleHttpClient<R>,
...
///
/// ```ignore
/// let task = get_backup_policy_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_backup_policy_request<R, F>(
    client: &SimpleHttpClient<R>,
...
///
/// ```ignore
/// let task = update_backup_policy_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn update_backup_policy_request<R, F>(
    client: &SimpleHttpClient<R>,
...
///
/// ```ignore
/// let task = delete_backup_policy_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn delete_backup_policy_request<R, F>(
    client: &SimpleHttpClient<R>,
