//! Auto-generated API module for planetscale promote.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_promote `
...
/// Arguments for [`promote_branch_builder`].
...
///
/// ```ignore
/// let task = promote_branch_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn promote_branch_request<R, F>(
