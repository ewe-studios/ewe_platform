//! Auto-generated API module for planetscale switch-replicas.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_switch_replicas `
...
/// Arguments for [`workflow_switch_replicas_builder`].
...
///
/// ```ignore
/// let task = workflow_switch_replicas_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn workflow_switch_replicas_request<R, F>(
