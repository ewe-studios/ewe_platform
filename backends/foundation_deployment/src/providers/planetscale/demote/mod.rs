//! Auto-generated API module for planetscale demote.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_demote `
...
/// Arguments for [`demote_branch_builder`].
...
///
/// ```ignore
/// let task = demote_branch_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn demote_branch_request<R, F>(
