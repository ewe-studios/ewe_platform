//! Auto-generated API module for planetscale deploy.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_deploy `
...
/// Arguments for [`queue_deploy_request_builder`].
...
///
/// ```ignore
/// let task = queue_deploy_request_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn queue_deploy_request_request<R, F>(
