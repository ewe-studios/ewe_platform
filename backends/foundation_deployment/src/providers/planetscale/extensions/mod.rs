//! Auto-generated API module for planetscale extensions.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_extensions `
...
/// Arguments for [`list_extensions_builder`].
...
///
/// ```ignore
/// let task = list_extensions_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn list_extensions_request<R, F>(
