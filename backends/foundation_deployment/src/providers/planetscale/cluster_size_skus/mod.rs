//! Auto-generated API module for planetscale cluster-size-skus.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_cluster_size_skus `
...
/// Arguments for [`list_cluster_size_skus_builder`].
...
///
/// ```ignore
/// let task = list_cluster_size_skus_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn list_cluster_size_skus_request<R, F>(
