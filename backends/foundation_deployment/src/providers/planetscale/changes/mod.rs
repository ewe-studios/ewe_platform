//! Auto-generated API module for planetscale changes.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_changes `
...
/// Arguments for [`list_branch_change_requests_builder`].
...
/// Arguments for [`update_branch_change_request_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
/// Arguments for [`get_branch_change_request_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
///
/// ```ignore
/// let task = list_branch_change_requests_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn list_branch_change_requests_request<R, F>(
...
///
/// ```ignore
/// let task = update_branch_change_request_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn update_branch_change_request_request<R, F>(
    client: &SimpleHttpClient<R>,
...
///
/// ```ignore
/// let task = get_branch_change_request_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_branch_change_request_request<R, F>(
    client: &SimpleHttpClient<R>,
