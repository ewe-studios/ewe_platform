//! Auto-generated API module for planetscale parameters.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_parameters `
...
/// Arguments for [`list_parameters_builder`].
...
///
/// ```ignore
/// let task = list_parameters_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn list_parameters_request<R, F>(
