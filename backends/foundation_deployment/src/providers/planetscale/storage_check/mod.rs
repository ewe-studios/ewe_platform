//! Auto-generated API module for planetscale storage-check.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_storage_check `
...
/// Arguments for [`check_deploy_request_storage_builder`].
...
///
/// ```ignore
/// let task = check_deploy_request_storage_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn check_deploy_request_storage_request<R, F>(
