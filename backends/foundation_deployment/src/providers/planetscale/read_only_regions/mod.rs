//! Auto-generated API module for planetscale read-only-regions.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_read_only_regions `
...
/// Arguments for [`list_read_only_regions_builder`].
...
///
/// ```ignore
/// let task = list_read_only_regions_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn list_read_only_regions_request<R, F>(
