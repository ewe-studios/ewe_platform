//! Auto-generated API module for planetscale default.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_default `
...
/// Arguments for [`get_default_role_builder`].
...
///
/// ```ignore
/// let task = get_default_role_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_default_role_request<R, F>(
