//! Auto-generated API module for planetscale bouncer-resizes.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_bouncer_resizes `
...
/// Arguments for [`list_branch_bouncer_resize_requests_builder`].
...
///
/// ```ignore
/// let task = list_branch_bouncer_resize_requests_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn list_branch_bouncer_resize_requests_request<R, F>(
