//! Auto-generated API module for planetscale regions.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_regions `
...
/// Arguments for [`list_database_regions_builder`].
...
/// Arguments for [`list_regions_for_organization_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
/// Arguments for [`list_public_regions_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
///
/// ```ignore
/// let task = list_database_regions_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn list_database_regions_request<R, F>(
...
///
/// ```ignore
/// let task = list_regions_for_organization_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn list_regions_for_organization_request<R, F>(
    client: &SimpleHttpClient<R>,
...
///
/// ```ignore
/// let task = list_public_regions_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn list_public_regions_request<R, F>(
    client: &SimpleHttpClient<R>,
    builder_mod: Option<F>,
) -> Result<
    impl TaskIterator<
