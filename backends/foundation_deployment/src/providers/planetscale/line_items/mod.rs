//! Auto-generated API module for planetscale line-items.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_line_items `
...
/// Arguments for [`get_invoice_line_items_builder`].
...
///
/// ```ignore
/// let task = get_invoice_line_items_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_invoice_line_items_request<R, F>(
