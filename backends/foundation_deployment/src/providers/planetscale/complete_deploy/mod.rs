//! Auto-generated API module for planetscale complete-deploy.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_complete_deploy `
...
/// Arguments for [`complete_errored_deploy_builder`].
...
///
/// ```ignore
/// let task = complete_errored_deploy_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn complete_errored_deploy_request<R, F>(
