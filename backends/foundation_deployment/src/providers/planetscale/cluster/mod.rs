//! Auto-generated API module for planetscale cluster.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_cluster `
...
/// Arguments for [`update_branch_cluster_config_builder`].
...
///
/// ```ignore
/// let task = update_branch_cluster_config_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn update_branch_cluster_config_request<R, F>(
