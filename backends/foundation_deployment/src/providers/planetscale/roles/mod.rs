//! Auto-generated API module for planetscale roles.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_roles `
...
/// Arguments for [`list_roles_builder`].
...
/// Arguments for [`create_role_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
/// Arguments for [`get_role_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
/// Arguments for [`update_role_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
/// Arguments for [`delete_role_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
///
/// ```ignore
/// let task = list_roles_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn list_roles_request<R, F>(
...
///
/// ```ignore
/// let task = create_role_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn create_role_request<R, F>(
    client: &SimpleHttpClient<R>,
    args: &CreateRoleArgs,
    builder_mod: Option<F>,
) -> Result<
...
///
/// ```ignore
/// let task = get_role_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_role_request<R, F>(
    client: &SimpleHttpClient<R>,
    args: &GetRoleArgs,
    builder_mod: Option<F>,
) -> Result<
...
///
/// ```ignore
/// let task = update_role_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn update_role_request<R, F>(
    client: &SimpleHttpClient<R>,
    args: &UpdateRoleArgs,
    builder_mod: Option<F>,
) -> Result<
...
///
/// ```ignore
/// let task = delete_role_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn delete_role_request<R, F>(
    client: &SimpleHttpClient<R>,
    args: &DeleteRoleArgs,
    builder_mod: Option<F>,
) -> Result<
