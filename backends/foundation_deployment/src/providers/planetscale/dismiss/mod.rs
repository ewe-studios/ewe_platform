//! Auto-generated API module for planetscale dismiss.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_dismiss `
...
/// Arguments for [`dismiss_schema_recommendation_builder`].
...
///
/// ```ignore
/// let task = dismiss_schema_recommendation_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn dismiss_schema_recommendation_request<R, F>(
