//! Auto-generated API module for planetscale reviews.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_reviews `
...
/// Arguments for [`list_deploy_request_reviews_builder`].
...
/// Arguments for [`review_deploy_request_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
///
/// ```ignore
/// let task = list_deploy_request_reviews_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn list_deploy_request_reviews_request<R, F>(
...
///
/// ```ignore
/// let task = review_deploy_request_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn review_deploy_request_request<R, F>(
    client: &SimpleHttpClient<R>,
