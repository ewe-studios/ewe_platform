//! Auto-generated API module for planetscale cancel.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_cancel `
...
/// Arguments for [`cancel_deploy_request_builder`].
...
///
/// ```ignore
/// let task = cancel_deploy_request_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn cancel_deploy_request_request<R, F>(
