//! Auto-generated API module for planetscale skip-revert.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_skip_revert `
...
/// Arguments for [`skip_revert_period_builder`].
...
///
/// ```ignore
/// let task = skip_revert_period_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn skip_revert_period_request<R, F>(
