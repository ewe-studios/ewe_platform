//! Auto-generated API module for planetscale download.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_download `
...
/// Arguments for [`get_query_patterns_report_builder`].
...
///
/// ```ignore
/// let task = get_query_patterns_report_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_query_patterns_report_request<R, F>(
