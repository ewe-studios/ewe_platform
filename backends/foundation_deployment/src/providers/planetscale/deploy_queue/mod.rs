//! Auto-generated API module for planetscale deploy-queue.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_deploy_queue `
...
/// Arguments for [`get_deploy_queue_builder`].
...
///
/// ```ignore
/// let task = get_deploy_queue_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_deploy_queue_request<R, F>(
