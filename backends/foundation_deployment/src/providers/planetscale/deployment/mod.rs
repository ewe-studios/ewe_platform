//! Auto-generated API module for planetscale deployment.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_deployment `
...
/// Arguments for [`get_deployment_builder`].
...
///
/// ```ignore
/// let task = get_deployment_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_deployment_request<R, F>(
