//! Auto-generated API module for planetscale retry.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_retry `
...
/// Arguments for [`workflow_retry_builder`].
...
///
/// ```ignore
/// let task = workflow_retry_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn workflow_retry_request<R, F>(
