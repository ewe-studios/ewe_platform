//! Auto-generated API module for planetscale reverse-traffic.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_reverse_traffic `
...
/// Arguments for [`workflow_reverse_traffic_builder`].
...
///
/// ```ignore
/// let task = workflow_reverse_traffic_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn workflow_reverse_traffic_request<R, F>(
