//! Auto-generated API module for planetscale revert.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_revert `
...
/// Arguments for [`complete_revert_builder`].
...
///
/// ```ignore
/// let task = complete_revert_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn complete_revert_request<R, F>(
