//! Auto-generated API module for planetscale apply-deploy.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_apply_deploy `
...
/// Arguments for [`complete_gated_deploy_request_builder`].
...
///
/// ```ignore
/// let task = complete_gated_deploy_request_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn complete_gated_deploy_request_request<R, F>(
