//! Auto-generated API module for planetscale reverse-cutover.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_reverse_cutover `
...
/// Arguments for [`workflow_reverse_cutover_builder`].
...
///
/// ```ignore
/// let task = workflow_reverse_cutover_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn workflow_reverse_cutover_request<R, F>(
