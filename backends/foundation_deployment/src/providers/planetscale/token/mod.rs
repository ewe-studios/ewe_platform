//! Auto-generated API module for planetscale token.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_token `
...
/// Arguments for [`create_oauth_token_builder`].
...
///
/// ```ignore
/// let task = create_oauth_token_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn create_oauth_token_request<R, F>(
