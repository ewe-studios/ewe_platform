//! Auto-generated API module for planetscale invoices.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_invoices `
...
/// Arguments for [`list_invoices_builder`].
...
/// Arguments for [`get_invoice_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
///
/// ```ignore
/// let task = list_invoices_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn list_invoices_request<R, F>(
...
///
/// ```ignore
/// let task = get_invoice_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_invoice_request<R, F>(
    client: &SimpleHttpClient<R>,
    args: &GetInvoiceArgs,
    builder_mod: Option<F>,
) -> Result<
