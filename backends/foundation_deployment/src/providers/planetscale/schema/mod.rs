//! Auto-generated API module for planetscale schema.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_schema `
...
/// Arguments for [`get_branch_schema_builder`].
...
///
/// ```ignore
/// let task = get_branch_schema_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_branch_schema_request<R, F>(
