//! Auto-generated API module for planetscale verify-data.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_verify_data `
...
/// Arguments for [`verify_workflow_builder`].
...
///
/// ```ignore
/// let task = verify_workflow_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn verify_workflow_request<R, F>(
