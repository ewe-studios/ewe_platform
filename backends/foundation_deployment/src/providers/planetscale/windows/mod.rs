//! Auto-generated API module for planetscale windows.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_windows `
...
/// Arguments for [`list_maintenance_windows_builder`].
...
///
/// ```ignore
/// let task = list_maintenance_windows_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn list_maintenance_windows_request<R, F>(
