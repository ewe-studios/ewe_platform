//! Auto-generated API module for planetscale lint.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_lint `
...
/// Arguments for [`lint_branch_schema_builder`].
...
///
/// ```ignore
/// let task = lint_branch_schema_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn lint_branch_schema_request<R, F>(
