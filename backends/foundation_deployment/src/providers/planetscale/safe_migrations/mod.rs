//! Auto-generated API module for planetscale safe-migrations.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_safe_migrations `
...
/// Arguments for [`enable_safe_migrations_builder`].
...
/// Arguments for [`disable_safe_migrations_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
///
/// ```ignore
/// let task = enable_safe_migrations_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn enable_safe_migrations_request<R, F>(
...
///
/// ```ignore
/// let task = disable_safe_migrations_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn disable_safe_migrations_request<R, F>(
    client: &SimpleHttpClient<R>,
