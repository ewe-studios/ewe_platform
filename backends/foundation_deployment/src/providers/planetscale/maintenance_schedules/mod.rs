//! Auto-generated API module for planetscale maintenance-schedules.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_maintenance_schedules `
...
/// Arguments for [`list_maintenance_schedules_builder`].
...
/// Arguments for [`get_maintenance_schedule_builder`].
#[derive(Debug, Clone, Serialize, JsonHash)]
...
///
/// ```ignore
/// let task = list_maintenance_schedules_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn list_maintenance_schedules_request<R, F>(
...
///
/// ```ignore
/// let task = get_maintenance_schedule_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn get_maintenance_schedule_request<R, F>(
    client: &SimpleHttpClient<R>,
