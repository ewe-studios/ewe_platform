//! Auto-generated API module for planetscale reset.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_reset `
...
/// Arguments for [`reset_role_builder`].
...
///
/// ```ignore
/// let task = reset_role_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn reset_role_request<R, F>(
