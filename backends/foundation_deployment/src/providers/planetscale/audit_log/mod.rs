//! Auto-generated API module for planetscale audit-log.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_audit_log `
...
/// Arguments for [`list_audit_logs_builder`].
...
///
/// ```ignore
/// let task = list_audit_logs_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn list_audit_logs_request<R, F>(
