//! Auto-generated API module for planetscale switch-primaries.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_switch_primaries `
...
/// Arguments for [`workflow_switch_primaries_builder`].
...
///
/// ```ignore
/// let task = workflow_switch_primaries_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn workflow_switch_primaries_request<R, F>(
