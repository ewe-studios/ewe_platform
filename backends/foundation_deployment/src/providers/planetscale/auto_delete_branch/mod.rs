//! Auto-generated API module for planetscale auto-delete-branch.
//!
//! Generated by `cargo run --bin ewe_platform gen_api`.
//! DO NOT EDIT MANUALLY.
//!
//! Feature flag: `planetscale_auto_delete_branch `
...
/// Arguments for [`update_auto_delete_branch_builder`].
...
///
/// ```ignore
/// let task = update_auto_delete_branch_request(&client, &args, Some(|b| {
///     b.header("X-Custom-Header", "value")
/// }))?;
/// ```
#[inline]
pub fn update_auto_delete_branch_request<R, F>(
