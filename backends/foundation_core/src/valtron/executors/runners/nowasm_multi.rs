...
//!
//! This module provides a NoOp wrapper as when using multi-threading,
//! there is no way to control the threading execution by design and hence
//! these operations should not perform or incur any CPU time since its
//! already handled in a multi-threaded scope.
//!
//! ## Usage
//!
//! ```ignore
