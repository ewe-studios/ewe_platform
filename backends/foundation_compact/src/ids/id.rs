...
use super::{MAX_COUNTER_HI, MAX_COUNTER_LO, MAX_TIMESTAMP};
use fstr::FStr;
...
///
/// ```rust,ignore
/// let x = "036z968fu2tugy7svkfznewkk".parse::<foundation_compact::ids::Id>()?;
/// assert_eq!(x.to_string(), "036z968fu2tugy7svkfznewkk");
///
/// let y = foundation_compact::ids::Id::from(0x017fa1de51a80fd992f9e8cc2d5eb88eu128);
