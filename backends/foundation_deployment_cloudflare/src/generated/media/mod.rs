    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    ...
    let endpoint_url = {
        ...
        let mut first = true;
        if let Some(ref v) = args.cache_ttl {
            if first {
                url.push('?');
                first = false;
            } else {
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    ...
    let endpoint_url = {
        let mut url = endpoint_url;
        let mut first = true;
        if let Some(ref v) = args.continuation_token {
            if first {
                url.push('?');
                first = false;
            } else {
            ...
            url.push_str("continuation_token=");
            url.push_str(&urlencoding::encode(v));
        }
        ...
        if let Some(ref v) = args.meta_field_operator {
            if first {
                url.push('?');
                first = false;
            } else {
            ...
            url.push_str("meta.<field>[<operator>]=");
            url.push_str(&urlencoding::encode(v));
        }
        url
    };
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    ...
    let endpoint_url = {
        let mut url = endpoint_url;
        let mut first = true;
        if let Some(ref v) = args.exclude_meetings {
            if first {
                url.push('?');
                first = false;
            } else {
        ...
        if let Some(ref v) = args.page_no {
            if first {
                url.push('?');
                first = false;
            } else {
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    ...
    let endpoint_url = {
        let mut url = endpoint_url;
        let mut first = true;
        if let Some(ref v) = args.meeting_id {
            if first {
                url.push('?');
                first = false;
            } else {
            ...
            url.push_str("meeting_id=");
            url.push_str(&urlencoding::encode(v));
        }
        if let Some(ref v) = args.expired {
            if first {
                url.push('?');
                first = false;
            } else {
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    ...
    let endpoint_url = {
        ...
        if let Some(ref v) = args.associated_id {
            if first {
                url.push('?');
                first = false;
            } else {
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    ...
    let endpoint_url = {
        let mut url = endpoint_url;
        let mut first = true;
        if let Some(ref v) = args.include_breakout_rooms {
            if first {
                url.push('?');
                first = false;
            } else {
            ...
            url.push_str("include_breakout_rooms=");
            url.push_str(&urlencoding::encode(v));
        }
        url
    };
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    ...
    let endpoint_url = {
        let mut url = endpoint_url;
        let mut first = true;
        if let Some(ref v) = args.include_peer_events {
            if first {
                url.push('?');
                first = false;
            } else {
            ...
            url.push_str("include_peer_events=");
            url.push_str(&urlencoding::encode(v));
        }
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    ...
    let endpoint_url = {
        ...
        if let Some(ref v) = args.video_name {
            if first {
                url.push('?');
                first = false;
            } else {
        ...
        if let Some(ref v) = args.include_counts {
            if first {
                url.push('?');
                first = false;
            } else {
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    ...
    let endpoint_url = {
        let mut url = endpoint_url;
        let mut first = true;
        if let Some(ref v) = args.direct_user {
            if first {
                url.push('?');
                first = false;
            } else {
