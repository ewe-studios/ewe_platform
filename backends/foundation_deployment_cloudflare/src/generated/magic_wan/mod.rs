    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    ...
    let endpoint_url = {
        ...
        if let Some(ref v) = args.post_apply_resources {
            if first {
                url.push('?');
                first = false;
            } else {
            ...
            url.push_str("post_apply_resources=");
            url.push_str(&urlencoding::encode(v));
        }
        if let Some(ref v) = args.planned_resources {
            if first {
                url.push('?');
                first = false;
            } else {
            ...
            url.push_str("planned_resources=");
            url.push_str(&urlencoding::encode(v));
        }
        url
    };
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    ...
    let endpoint_url = {
        let mut url = endpoint_url;
        let mut first = true;
        if let Some(ref v) = args.destroy {
            if first {
                url.push('?');
                first = false;
            } else {
    ...
    F: FnOnce(&mut ClientRequestBuilder<R>),
{
    ...
    let endpoint_url = {
        let mut url = endpoint_url;
        let mut first = true;
        if let Some(ref v) = args.connectorid {
            if first {
                url.push('?');
                first = false;
            } else {
