...
use crate::wasm::builtins::Blob;
use crate::wasm::io::{Decode, DecodeError, DecodeErrorKind, Encode, Wasmbin, encode_decode_as};
use crate::wasm::sections::{Section, StdPayload};
use crate::wasm::visit::Visit;
...
impl Module {
    ...
    ///
    /// # fn main() -> Result<(), foundation_codegen::wasm::io::DecodeError> {
    ...
    /// ```
    /// use foundation_codegen::wasm::Module;
    /// use foundation_codegen::wasm::sections::{payload, Import, ImportPath, ImportDesc};
    ///
    /// # fn main() -> Result<(), foundation_codegen::wasm::io::DecodeError> {
    ...
    /// use foundation_codegen::wasm::Module;
    /// use foundation_codegen::wasm::sections::{payload, Import, ImportPath, ImportDesc};
    /// use foundation_codegen::wasm::indices::TypeId;
    ///
    /// # fn main() -> Result<(), foundation_codegen::wasm::io::DecodeError> {
    /// # let mut module = Module::default();
    /// module
