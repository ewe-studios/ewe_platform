...
use crate::wasm::builtins::{Blob, Lazy, UnparsedBytes, WasmbinCountable};
#[cfg(feature = "extended-name-section")]
use crate::wasm::indices::{DataId, ElemId, LabelId};
use crate::wasm::indices::{ExceptionId, FuncId, GlobalId, LocalId, MemId, TableId, TypeId};
use crate::wasm::instructions::Expression;
use crate::wasm::io::{Decode, DecodeError, DecodeWithDiscriminant, Encode, PathItem, Wasmbin};
