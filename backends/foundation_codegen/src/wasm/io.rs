...
use crate::wasm::sections::SectionOrderError;
use thiserror::Error;
pub use foundation_macros::Wasmbin;
...
pub enum DecodeErrorKind {
    ...
    /// Unrecognized data at the end of a stream or a [`Blob`](crate::wasm::builtins::Blob).
...
macro_rules! encode_decode_as {
    ($ty:ty, {
        ...
        impl $crate::wasm::io::Encode for $ty {
            #[allow(unused_parens)]
            fn encode(&self, w: &mut impl std::io::Write) -> std::io::Result<()> {
                match *self {
                    $($lhs => $rhs,)*
        ...
        impl $crate::wasm::io::Decode for $ty {
            #[allow(unused_parens)]
            fn decode(r: &mut impl std::io::Read) -> Result<Self, $crate::wasm::io::DecodeError> {
                Ok(match $crate::wasm::io::Decode::decode(r)? {
                    $($rhs => $lhs,)*
