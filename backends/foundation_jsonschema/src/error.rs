...
pub enum ValidationErrorKind {
    ...
    // Enum/const
    InvalidConst { expected: Value },
    InvalidEnum { options: Vec<Value> },
...
mod tests {
    ...
    fn test_validation_error_builder() {
        let error = ValidationErrorBuilder::new(Location::new(), Location::new())
        ...
        assert_eq!(failure.kind, ValidationErrorKind::Required { property: "x".into() });
    }
}
