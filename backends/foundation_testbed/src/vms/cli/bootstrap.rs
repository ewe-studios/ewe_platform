...
use crate::vms::bootstrap;
use crate::vms::bootstrap::BootstrapLogger;
use crate::vms::config::{get_profile, GuestOs, DisplayMode};
...
fn bootstrap_ssh(profile: &crate::vms::config::VmProfile, name: &str, logger: &BootstrapLogger, ports: &ResolvedPorts) -> Result<(), BoxedError> {
...
fn bootstrap_windows(profile: &crate::vms::config::VmProfile, name: &str, logger: &BootstrapLogger, progress: ProgressCallback<'_>, force_vsbuild: bool, ports: &ResolvedPorts) -> Result<(), BoxedError> {
