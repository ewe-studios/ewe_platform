...
impl HTMLParser {
        ...
        'c: 'd,
    {
        ...
        while let Some(_next) = acc.peek_next() {
            tracing::debug!("parse_comment: saw character: {}", _next);
        ...
        'c: 'd,
    {
        ...
        while let Some(next) = acc.peek_next() {
            tracing::debug!("parse_text_block: saw character: {}", next);
        ...
        'c: 'd,
    {
        ...
        while let Some(next) = acc.peek_next() {
            tracing::debug!("parse_element_text_block: saw character: {}", next);
        ...
        'c: 'd,
    {
        ...
        while let Some(next) = acc.peek_next() {
            tracing::debug!("parse_doc_type: saw character: {}", next);
        ...
        'c: 'd,
    {
        ...
        while let Some(next) = acc.peek_next() {
            tracing::debug!("parse_xml_elem: saw character: {}", next);
        ...
        'c: 'd,
    {
        ...
        while let Some(next) = acc.peek_next() {
            tracing::debug!("parse_elem: saw character: {}", next);
        ...
        'c: 'd,
    {
        ...
        while let Some(next) = acc.peek_next() {
            tracing::debug!("parse_closing_tag: saw character: {}", next);
