...
use foundation_openapi::{
    spec::Schema,
    to_pascal_case, to_snake_case, sanitize_field_name, sanitize_identifier,
...
impl ResourceGenerator {
            ...
            Ok(processor) => {
                ...
                let result = endpoints
                    ...
                    .map(|ep| {
                        ...
                        let has_params = !ep.path_params.is_empty() || !ep.query_params.is_empty() || ep.request_type.is_some();
                        CodegenEndpoint {
    ...
    fn generate_rust(
        ...
        // NOTE: ResourceIdentifier impls are now generated by the clients generator
        // to ensure Args type names are consistent
    ...
    fn generate_resource_identifier_impls(
        ...
        for endpoint in endpoints {
            ...
            // Generate Args type name from operation_id - use same naming as clients generator
            let args_type = format!("{}Args", to_pascal_case(&to_snake_case(&sanitize_identifier(&endpoint.operation_id))));
