...
use foundation_wasm::{
    ...
    ReturnTypeId, ReturnValues, Returns, ThreeState,
};
    ...
    instructions
        .invoke(
            ...
            ReturnTypeHints::Multi(vec![
                ThreeState::One(ReturnTypeId::Uint8),
                ThreeState::Two(ReturnTypeId::Bool, ReturnTypeId::Int8),
                ThreeState::Three(ReturnTypeId::Bool, ReturnTypeId::Int8, ReturnTypeId::Uint8),
            ]),
        )
