...
impl LlamaTokenDataArray {
    ...
    ///
    /// ```
    /// # use infrastructure_llama_cpp::token::data::LlamaTokenData;
    /// # use infrastructure_llama_cpp::token::data_array::LlamaTokenDataArray;
...
impl LlamaTokenDataArray {
    ...
    pub(crate) unsafe fn modify_as_c_llama_token_data_array<T>(
        ...
        let data = self
            .data
            .as_mut_ptr()
            .cast::<infrastructure_llama_bindings::llama_token_data>();

        let mut c_llama_token_data_array = infrastructure_llama_bindings::llama_token_data_array {
            data,
            size,
