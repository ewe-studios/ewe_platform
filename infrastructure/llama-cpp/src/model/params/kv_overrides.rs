...
impl From<&infrastructure_llama_bindings::llama_model_kv_override> for ParamOverrideValue {
    fn from(
        infrastructure_llama_bindings::llama_model_kv_override {
            key: _,
            tag,
            __bindgen_anon_1,
        }: &infrastructure_llama_bindings::llama_model_kv_override,
        ...
        match *tag {
            infrastructure_llama_bindings::LLAMA_KV_OVERRIDE_TYPE_INT => {
            ...
            infrastructure_llama_bindings::LLAMA_KV_OVERRIDE_TYPE_STR => {
