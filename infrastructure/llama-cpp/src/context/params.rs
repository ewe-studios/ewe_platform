...
impl From<KvCacheType> for infrastructure_llama_bindings::ggml_type {
    fn from(value: KvCacheType) -> Self {
        match value {
            KvCacheType::Unknown(raw) => raw,
            KvCacheType::F32 => infrastructure_llama_bindings::GGML_TYPE_F32,
            KvCacheType::F16 => infrastructure_llama_bindings::GGML_TYPE_F16,
            KvCacheType::Q4_0 => infrastructure_llama_bindings::GGML_TYPE_Q4_0,
            KvCacheType::Q4_1 => infrastructure_llama_bindings::GGML_TYPE_Q4_1,
            KvCacheType::Q5_0 => infrastructure_llama_bindings::GGML_TYPE_Q5_0,
            KvCacheType::Q5_1 => infrastructure_llama_bindings::GGML_TYPE_Q5_1,
            KvCacheType::Q8_0 => infrastructure_llama_bindings::GGML_TYPE_Q8_0,
            KvCacheType::Q8_1 => infrastructure_llama_bindings::GGML_TYPE_Q8_1,
            KvCacheType::Q2_K => infrastructure_llama_bindings::GGML_TYPE_Q2_K,
            KvCacheType::Q3_K => infrastructure_llama_bindings::GGML_TYPE_Q3_K,
            KvCacheType::Q4_K => infrastructure_llama_bindings::GGML_TYPE_Q4_K,
            KvCacheType::Q5_K => infrastructure_llama_bindings::GGML_TYPE_Q5_K,
            KvCacheType::Q6_K => infrastructure_llama_bindings::GGML_TYPE_Q6_K,
            KvCacheType::Q8_K => infrastructure_llama_bindings::GGML_TYPE_Q8_K,
            KvCacheType::IQ2_XXS => infrastructure_llama_bindings::GGML_TYPE_IQ2_XXS,
            KvCacheType::IQ2_XS => infrastructure_llama_bindings::GGML_TYPE_IQ2_XS,
            KvCacheType::IQ3_XXS => infrastructure_llama_bindings::GGML_TYPE_IQ3_XXS,
            KvCacheType::IQ1_S => infrastructure_llama_bindings::GGML_TYPE_IQ1_S,
            KvCacheType::IQ4_NL => infrastructure_llama_bindings::GGML_TYPE_IQ4_NL,
            KvCacheType::IQ3_S => infrastructure_llama_bindings::GGML_TYPE_IQ3_S,
            KvCacheType::IQ2_S => infrastructure_llama_bindings::GGML_TYPE_IQ2_S,
            KvCacheType::IQ4_XS => infrastructure_llama_bindings::GGML_TYPE_IQ4_XS,
            KvCacheType::I8 => infrastructure_llama_bindings::GGML_TYPE_I8,
            KvCacheType::I16 => infrastructure_llama_bindings::GGML_TYPE_I16,
            KvCacheType::I32 => infrastructure_llama_bindings::GGML_TYPE_I32,
            KvCacheType::I64 => infrastructure_llama_bindings::GGML_TYPE_I64,
            KvCacheType::F64 => infrastructure_llama_bindings::GGML_TYPE_F64,
            KvCacheType::IQ1_M => infrastructure_llama_bindings::GGML_TYPE_IQ1_M,
            KvCacheType::BF16 => infrastructure_llama_bindings::GGML_TYPE_BF16,
            KvCacheType::TQ1_0 => infrastructure_llama_bindings::GGML_TYPE_TQ1_0,
            KvCacheType::TQ2_0 => infrastructure_llama_bindings::GGML_TYPE_TQ2_0,
            KvCacheType::MXFP4 => infrastructure_llama_bindings::GGML_TYPE_MXFP4,
        }
    }
}

impl From<infrastructure_llama_bindings::ggml_type> for KvCacheType {
    fn from(value: infrastructure_llama_bindings::ggml_type) -> Self {
        match value {
            x if x == infrastructure_llama_bindings::GGML_TYPE_F32 => KvCacheType::F32,
            x if x == infrastructure_llama_bindings::GGML_TYPE_F16 => KvCacheType::F16,
            x if x == infrastructure_llama_bindings::GGML_TYPE_Q4_0 => KvCacheType::Q4_0,
            x if x == infrastructure_llama_bindings::GGML_TYPE_Q4_1 => KvCacheType::Q4_1,
            x if x == infrastructure_llama_bindings::GGML_TYPE_Q5_0 => KvCacheType::Q5_0,
            x if x == infrastructure_llama_bindings::GGML_TYPE_Q5_1 => KvCacheType::Q5_1,
            x if x == infrastructure_llama_bindings::GGML_TYPE_Q8_0 => KvCacheType::Q8_0,
            x if x == infrastructure_llama_bindings::GGML_TYPE_Q8_1 => KvCacheType::Q8_1,
            x if x == infrastructure_llama_bindings::GGML_TYPE_Q2_K => KvCacheType::Q2_K,
            x if x == infrastructure_llama_bindings::GGML_TYPE_Q3_K => KvCacheType::Q3_K,
            x if x == infrastructure_llama_bindings::GGML_TYPE_Q4_K => KvCacheType::Q4_K,
            x if x == infrastructure_llama_bindings::GGML_TYPE_Q5_K => KvCacheType::Q5_K,
            x if x == infrastructure_llama_bindings::GGML_TYPE_Q6_K => KvCacheType::Q6_K,
            x if x == infrastructure_llama_bindings::GGML_TYPE_Q8_K => KvCacheType::Q8_K,
            x if x == infrastructure_llama_bindings::GGML_TYPE_IQ2_XXS => KvCacheType::IQ2_XXS,
            x if x == infrastructure_llama_bindings::GGML_TYPE_IQ2_XS => KvCacheType::IQ2_XS,
            x if x == infrastructure_llama_bindings::GGML_TYPE_IQ3_XXS => KvCacheType::IQ3_XXS,
            x if x == infrastructure_llama_bindings::GGML_TYPE_IQ1_S => KvCacheType::IQ1_S,
            x if x == infrastructure_llama_bindings::GGML_TYPE_IQ4_NL => KvCacheType::IQ4_NL,
            x if x == infrastructure_llama_bindings::GGML_TYPE_IQ3_S => KvCacheType::IQ3_S,
            x if x == infrastructure_llama_bindings::GGML_TYPE_IQ2_S => KvCacheType::IQ2_S,
            x if x == infrastructure_llama_bindings::GGML_TYPE_IQ4_XS => KvCacheType::IQ4_XS,
            x if x == infrastructure_llama_bindings::GGML_TYPE_I8 => KvCacheType::I8,
            x if x == infrastructure_llama_bindings::GGML_TYPE_I16 => KvCacheType::I16,
            x if x == infrastructure_llama_bindings::GGML_TYPE_I32 => KvCacheType::I32,
            x if x == infrastructure_llama_bindings::GGML_TYPE_I64 => KvCacheType::I64,
            x if x == infrastructure_llama_bindings::GGML_TYPE_F64 => KvCacheType::F64,
            x if x == infrastructure_llama_bindings::GGML_TYPE_IQ1_M => KvCacheType::IQ1_M,
            x if x == infrastructure_llama_bindings::GGML_TYPE_BF16 => KvCacheType::BF16,
            x if x == infrastructure_llama_bindings::GGML_TYPE_TQ1_0 => KvCacheType::TQ1_0,
            x if x == infrastructure_llama_bindings::GGML_TYPE_TQ2_0 => KvCacheType::TQ2_0,
            x if x == infrastructure_llama_bindings::GGML_TYPE_MXFP4 => KvCacheType::MXFP4,
...
impl LlamaContextParams {
    ...
    pub fn with_flash_attention_policy(
        mut self,
        policy: infrastructure_llama_bindings::llama_flash_attn_type,
    ) -> Self {
    ...
    #[must_use]
    pub fn flash_attention_policy(&self) -> infrastructure_llama_bindings::llama_flash_attn_type {
    ...
    ///     t: *mut infrastructure_llama_bindings::ggml_tensor,
    ///     ask: bool,
    ...
    pub fn with_cb_eval(
        mut self,
        cb_eval: infrastructure_llama_bindings::ggml_backend_sched_eval_callback,
    ) -> Self {
