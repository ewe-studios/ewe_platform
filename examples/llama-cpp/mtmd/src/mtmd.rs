...
use infrastructure_llama_cpp::model::{LlamaChatMessage, LlamaChatTemplate, LlamaModel, Special};
        ...
        let mtmd_params = MtmdContextParams {
            ...
            media_marker: CString::new(
                params
                    .media_marker
                    .as_ref()
                    .unwrap_or(&infrastructure_llama_cpp::mtmd::mtmd_default_marker().to_string())
                    .clone(),
            )?,
        };
...
fn run_single_turn(
    ...
    let default_marker = infrastructure_llama_cpp::mtmd::mtmd_default_marker().to_string();
